...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.commands.JsonTransformMediatorInputConnectorCreateCommand;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.commands.JsonTransformMediatorOutputConnectorCreateCommand;
...
public class JsonTransformMediatorItemSemanticEditPolicy extends EsbBaseItemSemanticEditPolicy {
    ...
    */
    protected Command getCreateCommand(CreateElementRequest req) {
        ...
        if (EsbElementTypes.JsonTransformMediatorOutputConnector_3793 == req.getElementType()) {
            return getGEFWrapper(new JsonTransformMediatorOutputConnectorCreateCommand(req));
        }
