...
public class PayloadFactoryMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public PayloadFactoryMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject payloadFactoryMediator, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.PayloadFactoryMediator.Properties.payloadFormat)) {
                basePart.initPayloadFormat(
                        EEFUtils.choiceOfValues(payloadFactoryMediator,
                                EsbPackage.eINSTANCE.getPayloadFactoryMediator_PayloadFormat()),
                        payloadFactoryMediator.getPayloadFormat());
            }
            ...
            if (isAccessible(EsbViewsRepository.PayloadFactoryMediator.Properties.payload))
                basePart.setPayload(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        payloadFactoryMediator.getPayload()));

            if (isAccessible(EsbViewsRepository.PayloadFactoryMediator.Properties.args)) {
                argsSettings = new ReferencesTableSettings(payloadFactoryMediator,
            ...
            if (isAccessible(EsbViewsRepository.PayloadFactoryMediator.Properties.mediaType)) {
                basePart.initMediaType(
                        EEFUtils.choiceOfValues(payloadFactoryMediator,
                                EsbPackage.eINSTANCE.getPayloadFactoryMediator_MediaType()),
                        payloadFactoryMediator.getMediaType());
            }
            if (isAccessible(EsbViewsRepository.PayloadFactoryMediator.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        payloadFactoryMediator.getDescription()));
                ...
                basePart.addFilterToArgs(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof PayloadFactoryArgument);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.PayloadFactoryMediator.Properties.payload == event.getAffectedEditor()) {
            payloadFactoryMediator.setPayload((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.PayloadFactoryMediator.Properties.args == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, argsSettings, editingContext.getAdapterFactory());
        ...
        if (EsbViewsRepository.PayloadFactoryMediator.Properties.description == event.getAffectedEditor()) {
            payloadFactoryMediator.setDescription((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getPayloadFactoryMediator_PayloadFormat().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.PayloadFactoryMediator.Properties.payloadFormat))
                basePart.setPayloadFormat((PayloadFormatType) msg.getNewValue());

            // Start of user code for payloadKey live update
            if (EsbPackage.eINSTANCE.getPayloadFactoryMediator_PayloadKey().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.PayloadFactoryMediator.Properties.payloadKey)) {
            ...
            if (EsbPackage.eINSTANCE.getPayloadFactoryMediator_Payload().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PayloadFactoryMediator.Properties.payload)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getPayloadFactoryMediator_Args().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.PayloadFactoryMediator.Properties.args))
                basePart.updateArgs();
            if (EsbPackage.eINSTANCE.getPayloadFactoryMediator_MediaType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.PayloadFactoryMediator.Properties.mediaType))
                basePart.setMediaType((MediaType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PayloadFactoryMediator.Properties.description)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PayloadFactoryMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PayloadFactoryMediator.Properties.reverse))
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.PayloadFactoryMediator.Properties.payloadFormat == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPayloadFactoryMediator_PayloadFormat().getEAttributeType(),
                                (String) newValue);
                    }
                ...
                if (EsbViewsRepository.PayloadFactoryMediator.Properties.payload == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPayloadFactoryMediator_Payload().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPayloadFactoryMediator_Payload().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PayloadFactoryMediator.Properties.mediaType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPayloadFactoryMediator_MediaType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPayloadFactoryMediator_MediaType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PayloadFactoryMediator.Properties.description == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
