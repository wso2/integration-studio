...
public class JsonTransformMediatorPropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public JsonTransformMediatorPropertyPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject jsonTransformMediatorProperty, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyName))
                basePart.setPropertyName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        jsonTransformMediatorProperty.getPropertyName()));
            ...
            if (isAccessible(EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyValue))
                basePart.setPropertyValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        jsonTransformMediatorProperty.getPropertyValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyName == event.getAffectedEditor()) {
            jsonTransformMediatorProperty.setPropertyName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyValue == event.getAffectedEditor()) {
            jsonTransformMediatorProperty.setPropertyValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueProperty_PropertyName().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyName)) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueProperty_PropertyValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyValue)) {
                if (msg.getNewValue() != null) {
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyName == event
                        .getAffectedEditor()) {
                ...
                if (EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyValue == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
