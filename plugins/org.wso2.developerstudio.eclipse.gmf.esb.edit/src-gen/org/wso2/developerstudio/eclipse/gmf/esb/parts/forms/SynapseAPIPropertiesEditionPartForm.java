 ...
 * 
 */
public class SynapseAPIPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, SynapseAPIPropertiesEditionPart {
     ...
     */
    public SynapseAPIPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createHandlerGroup(FormToolkit widgetFactory, final Composite parent) {
        Section handlerSection = widgetFactory.createSection(parent,
    ...
    protected Composite createHandlersTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.handlers = new ReferencesTable(getDescription(EsbViewsRepository.SynapseAPI.Handler.handlers,
                EsbMessages.SynapseAPIPropertiesEditionPart_HandlersLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(SynapseAPIPropertiesEditionPartForm.this,
                                        EsbViewsRepository.SynapseAPI.Handler.handlers, PropertiesEditionEvent.COMMIT,
        ...
        this.handlers.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SynapseAPI.Handler.handlers, EsbViewsRepository.FORM_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SynapseAPIPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SynapseAPI.Handler.handlers, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.SynapseAPI.Handler.Properties.commentsList,
                        EsbMessages.SynapseAPIPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
             ...
             */
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "SynapseAPI", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SynapseAPIPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SynapseAPI.Handler.Properties.commentsList,
    ...
    protected Composite createApiNameText(FormToolkit widgetFactory, Composite parent) {
        Control apiNameLabel = createDescription(parent, EsbViewsRepository.SynapseAPI.Handler.Properties.apiName,
                EsbMessages.SynapseAPIPropertiesEditionPart_ApiNameLabel);
        ...
        apiName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.SynapseAPI.Handler.Properties.apiName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, apiName.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SynapseAPIPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SynapseAPIPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control apiNameHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.SynapseAPI.Handler.Properties.apiName, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createContextText(FormToolkit widgetFactory, Composite parent) {
        Control contextLabel = createDescription(parent, EsbViewsRepository.SynapseAPI.Handler.Properties.context,
                EsbMessages.SynapseAPIPropertiesEditionPart_ContextLabel);
        ...
        context.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SynapseAPIPropertiesEditionPartForm.this,
                            EsbViewsRepository.SynapseAPI.Handler.Properties.context, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, context.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SynapseAPIPropertiesEditionPartForm.this,
        ...
        Control contextHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.SynapseAPI.Handler.Properties.context, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createHostNameText(FormToolkit widgetFactory, Composite parent) {
        Control hostLabel = createDescription(parent, EsbViewsRepository.SynapseAPI.Handler.Properties.hostName,
                EsbMessages.SynapseAPIPropertiesEditionPart_HostNameLabel);
        ...
        hostName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SynapseAPIPropertiesEditionPartForm.this,
                            EsbViewsRepository.SynapseAPI.Handler.Properties.hostName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, hostName.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SynapseAPIPropertiesEditionPartForm.this,
        ...
        Control hostHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SynapseAPI.Handler.Properties.hostName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPortText(FormToolkit widgetFactory, Composite parent) {
        Control portLabel = createDescription(parent, EsbViewsRepository.SynapseAPI.Handler.Properties.port,
                EsbMessages.SynapseAPIPropertiesEditionPart_PortLabel);
        ...
        port.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SynapseAPIPropertiesEditionPartForm.this,
                            EsbViewsRepository.SynapseAPI.Handler.Properties.port, PropertiesEditionEvent.FOCUS_CHANGED,
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                SynapseAPIPropertiesEditionPartForm.this,
                                EsbViewsRepository.SynapseAPI.Handler.Properties.port, PropertiesEditionEvent.COMMIT,
                                PropertiesEditionEvent.SET, null, port.getText()));
                }
            }
        });
        ...
        Control portHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SynapseAPI.Handler.Properties.port, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResourcesTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.resources = new ReferencesTable(getDescription(EsbViewsRepository.SynapseAPI.Handler.Properties.resources,
                EsbMessages.SynapseAPIPropertiesEditionPart_ResourcesLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(SynapseAPIPropertiesEditionPartForm.this,
                                        EsbViewsRepository.SynapseAPI.Handler.Properties.resources,
        ...
        this.resources.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SynapseAPI.Handler.Properties.resources, EsbViewsRepository.FORM_KIND));
        ...
        this.resources.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SynapseAPIPropertiesEditionPartForm.this,
                            EsbViewsRepository.SynapseAPI.Handler.Properties.resources, PropertiesEditionEvent.CHANGE,
                            PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
    ...
    protected Composite createVersionTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control versionTypeLabel = createDescription(parent,
                EsbViewsRepository.SynapseAPI.Handler.Properties.versionType,
                EsbMessages.SynapseAPIPropertiesEditionPart_VersionTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SynapseAPIPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SynapseAPI.Handler.Properties.versionType,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVersionType()));
                refresh();
            }

        });
        versionType.setID(EsbViewsRepository.SynapseAPI.Handler.Properties.versionType);
        Control versionTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.SynapseAPI.Handler.Properties.versionType,
    ...
    protected Composite createVersionText(FormToolkit widgetFactory, Composite parent) {
        Control versionLabel = createDescription(parent, EsbViewsRepository.SynapseAPI.Handler.Properties.version,
                EsbMessages.SynapseAPIPropertiesEditionPart_VersionLabel);
        ...
        version.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SynapseAPIPropertiesEditionPartForm.this,
                            EsbViewsRepository.SynapseAPI.Handler.Properties.version, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, version.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SynapseAPIPropertiesEditionPartForm.this,
        ...
        Control versionHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.SynapseAPI.Handler.Properties.version, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createTraceEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        traceEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.SynapseAPI.Handler.Properties.traceEnabled,
                        EsbMessages.SynapseAPIPropertiesEditionPart_TraceEnabledLabel),
                SWT.CHECK);
        traceEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SynapseAPIPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SynapseAPI.Handler.Properties.traceEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
        ...
        Control traceEnabledHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.SynapseAPI.Handler.Properties.traceEnabled,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createStatisticsEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        statisticsEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.SynapseAPI.Handler.Properties.statisticsEnabled,
                        EsbMessages.SynapseAPIPropertiesEditionPart_StatisticsEnabledLabel),
                SWT.CHECK);
        statisticsEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SynapseAPIPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SynapseAPI.Handler.Properties.statisticsEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
        ...
        Control statisticsEnabledHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.SynapseAPI.Handler.Properties.statisticsEnabled,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent,
                ...
                EsbMessages.SynapseAPIPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SynapseAPIPropertiesEditionPartForm.this,
                            EsbViewsRepository.SynapseAPI.Handler.Properties.description, PropertiesEditionEvent.COMMIT,
        ...
        Control descriptionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.SynapseAPI.Handler.Properties.description,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SynapseAPIPropertiesEditionPart#initHandlers(EObject current,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SynapseAPIPropertiesEditionPart#addFilterHandlers(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SynapseAPIPropertiesEditionPart#addBusinessFilterHandlers(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SynapseAPIPropertiesEditionPart#isContainedInHandlersTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SynapseAPIPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SynapseAPIPropertiesEditionPart#initResources(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SynapseAPIPropertiesEditionPart#addFilterResources(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SynapseAPIPropertiesEditionPart#addBusinessFilterResources(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SynapseAPIPropertiesEditionPart#isContainedInResourcesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SynapseAPIPropertiesEditionPart#initVersionType(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SynapseAPIPropertiesEditionPart#setVersionType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SynapseAPIPropertiesEditionPart#setTraceEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SynapseAPIPropertiesEditionPart#setStatisticsEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SynapseAPIPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
    ...
    protected Composite createPublishSwaggerWidget(FormToolkit widgetFactory, Composite parent) {
        Control publishSwaggerLabel = createDescription(parent,
                ...
                EsbMessages.SynapseAPIPropertiesEditionPart_PublishSwaggerLabel);
        widgetFactory.paintBordersFor(parent);
        if (publishSwagger == null) {
            publishSwagger = EsbFactoryImpl.eINSTANCE.createRegistryKeyProperty();
        }
        String initValueExpression = publishSwagger.getKeyValue().isEmpty() ? "" : publishSwagger.getKeyValue();
        ...
        publishSwaggerText.addMouseListener(new MouseAdapter() {
            ...
            public void mouseDown(MouseEvent event) {
                ...
                propertiesEditionComponent
                        .firePropertiesChanged(new PropertiesEditionEvent(SynapseAPIPropertiesEditionPartForm.this,
                                EsbViewsRepository.SynapseAPI.Handler.Properties.publishSwagger,
                                PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPublishSwagger()));
            }
        ...
        EditingUtils.setID(publishSwaggerText, EsbViewsRepository.SynapseAPI.Handler.Properties.publishSwagger);
        ...
        Control publishSwaggerHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.SynapseAPI.Handler.Properties.publishSwagger, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        publishSwaggerElements = new Control[] { publishSwaggerLabel, publishSwaggerText, publishSwaggerHelp };
        return parent;
    }
