 ...
 * 
 */
public class DBReportMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, DBReportMediatorPropertiesEditionPart {
     ...
     */
    public DBReportMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createConnectionGroup(FormToolkit widgetFactory, final Composite parent) {
        Section connectionSection = widgetFactory.createSection(parent,
    ...
    protected Composite createConnectionTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control connectionTypeLabel = createDescription(parent,
        ...
        Control connectionTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Connection.connectionType,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createConnectionDsTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control connectionDsTypeLabel = createDescription(parent,
        ...
        Control connectionDsTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Connection.connectionDsType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createConnectionDsTypeEMFComboViewer
        connectionDsTypeElements = new Control[] { connectionDsTypeLabel, connectionDsType.getCombo(),
                connectionDsTypeHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createConnectionDbTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control connectionDbTypeLabel = createDescription(parent,
                EsbViewsRepository.DBReportMediator.Connection.connectionDbType,
        ...
        Control connectionDbTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Connection.connectionDbType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createConnectionDbTypeEMFComboViewer
        connectionDbTypeElements = new Control[] { connectionDbTypeLabel, connectionDbType.getCombo(),
                connectionDbTypeHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createConnectionDbDriverText(FormToolkit widgetFactory, Composite parent) {
        Control connectionDbDriverLabel = createDescription(parent,
                EsbViewsRepository.DBReportMediator.Connection.connectionDbDriver,
        ...
        connectionDbDriver.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            DBReportMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control connectionDbDriverHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Connection.connectionDbDriver,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createConnectionDbDriverText
        connectionDbDriverElements = new Control[] { connectionDbDriverLabel, connectionDbDriver,
                connectionDbDriverHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createConnectionDsInitialContextText(FormToolkit widgetFactory, Composite parent) {
        Control connectionDsInitialContextLabel = createDescription(parent,
        ...
        Control connectionDsInitialContextHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Connection.connectionDsInitialContext,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createConnectionDsInitialContextText
        connectionDsInitialContextElements = new Control[] { connectionDsInitialContextLabel,
                connectionDsInitialContext, connectionDsInitialContextHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createConnectionDsNameText(FormToolkit widgetFactory, Composite parent) {
        Control connectionDsNameLabel = createDescription(parent,
        ...
        Control connectionDsNameHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Connection.connectionDsName, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createConnectionURLText(FormToolkit widgetFactory, Composite parent) {
        Control connectionURLLabel = createDescription(parent,
                EsbViewsRepository.DBReportMediator.Connection.connectionURL,
        ...
        Control connectionURLHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Connection.connectionURL,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createConnectionUsernameText(FormToolkit widgetFactory, Composite parent) {
        Control connectionUsernameLabel = createDescription(parent,
                EsbViewsRepository.DBReportMediator.Connection.connectionUsername,
        ...
        Control connectionUsernameHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Connection.connectionUsername,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createConnectionUsernameText
        connectionUsernameElements = new Control[] { connectionUsernameLabel, connectionUsername,
                connectionUsernameHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createConnectionPasswordText(FormToolkit widgetFactory, Composite parent) {
        Control connectionPasswordLabel = createDescription(parent,
                EsbViewsRepository.DBReportMediator.Connection.connectionPassword,
        ...
        Control connectionPasswordHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Connection.connectionPassword,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createConnectionPasswordText
        connectionPasswordElements = new Control[] { connectionPasswordLabel, connectionPassword,
    ...
    protected Composite createConnectionUseTransactionCheckbox(FormToolkit widgetFactory, Composite parent) {
        Control connectionUserTransactionLabel = connectionUseTransaction = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.DBReportMediator.Connection.connectionUseTransaction,
        ...
        Control connectionUserTransactionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Connection.connectionUseTransaction,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createConnectionUseTransactionCheckbox
        connectionUserTransactionElements = new Control[] { connectionUserTransactionLabel, connectionUseTransaction,
                connectionUserTransactionHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createStatementsGroup(FormToolkit widgetFactory, final Composite parent) {
        Section statementsSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createSqlStatementsTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.sqlStatements.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DBReportMediator.Statements.sqlStatements, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.DBReportMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.DBReportMediator.Properties.reverse,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DBReportMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertyAutocommitEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control propertyAutoCommitLabel = createDescription(parent,
        ...
        Control propertyAutoCommitHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Properties.propertyAutocommit,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createPropertyAutocommitEMFComboViewer
        propertyAutoCommitElements = new Control[] { propertyAutoCommitLabel, propertyAutocommit.getCombo(),
                propertyAutoCommitHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createPropertyIsolationEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control propertyIsolationLabel = createDescription(parent,
        ...
        Control propertyIsolationHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Properties.propertyIsolation, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createPropertyIsolationEMFComboViewer
        propertyIsolationElements = new Control[] { propertyIsolationLabel, propertyIsolation.getCombo(),
                propertyIsolationHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createPropertyMaxactiveText(FormToolkit widgetFactory, Composite parent) {
        Control propertyMaxActiveLabel = createDescription(parent,
        ...
        Control propertyMaxActiveHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Properties.propertyMaxactive, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertyMaxidleText(FormToolkit widgetFactory, Composite parent) {
        Control propertyMaxIdleLabel = createDescription(parent,
        ...
        Control propertyMaxIdleHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Properties.propertyMaxidle, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertyMaxopenstatementsText(FormToolkit widgetFactory, Composite parent) {
        Control propertyMaxOpenStatementsLabel = createDescription(parent,
        ...
        Control propertyMaxOpenStatementsHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Properties.propertyMaxopenstatements,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createPropertyMaxopenstatementsText
        propertyMaxOpenStatementsElements = new Control[] { propertyMaxOpenStatementsLabel, propertyMaxopenstatements,
                propertyMaxOpenStatementsHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createPropertyMaxwaitText(FormToolkit widgetFactory, Composite parent) {
        Control propertyMaxWaitLabel = createDescription(parent,
        ...
        Control propertyMaxWaitHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Properties.propertyMaxwait, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertyMinidleText(FormToolkit widgetFactory, Composite parent) {
        Control propertyMinIdelLabel = createDescription(parent,
        ...
        Control propertyMinIdelHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Properties.propertyMinidle, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertyPoolstatementsEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control propertyPoolstatementsLabel = createDescription(parent,
        ...
        Control propertyPoolstatementsHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Properties.propertyPoolstatements,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createPropertyPoolstatementsEMFComboViewer
        propertyPoolstatementsElements = new Control[] { propertyPoolstatementsLabel, propertyPoolstatements.getCombo(),
                propertyPoolstatementsHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createPropertyTestonborrowEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control propertyTestOnBorrowLabel = createDescription(parent,
        ...
        Control propertyTestOnBorrowHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Properties.propertyTestonborrow,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createPropertyTestonborrowEMFComboViewer
        propertyTestOnBorrowElements = new Control[] { propertyTestOnBorrowLabel, propertyTestonborrow.getCombo(),
                propertyTestOnBorrowHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createPropertyTestwhileidleEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control propertyTestWhileIdelLabel = createDescription(parent,
        ...
        Control propertyTestWhileIdelHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Properties.propertyTestwhileidle,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createPropertyTestwhileidleEMFComboViewer
        propertyTestWhileIdelElements = new Control[] { propertyTestWhileIdelLabel, propertyTestwhileidle.getCombo(),
                propertyTestWhileIdelHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createPropertyValidationqueryText(FormToolkit widgetFactory, Composite parent) {
        Control propertyValidationQueryLabel = createDescription(parent,
        ...
        Control propertyValidationQueryHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Properties.propertyValidationquery,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createPropertyValidationqueryText
        propertyValidationQueryElements = new Control[] { propertyValidationQueryLabel, propertyValidationquery,
                propertyValidationQueryHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createPropertyInitialsizeText(FormToolkit widgetFactory, Composite parent) {
        Control propertyInitialSizeLabel = createDescription(parent,
        ...
        Control propertyInitialSizeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DBReportMediator.Properties.propertyInitialsize,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createPropertyInitialsizeText
        propertyInitialSizeElements = new Control[] { propertyInitialSizeLabel, propertyInitialsize,
                propertyInitialSizeHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.DBReportMediator.Misc.description,
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            DBReportMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.DBReportMediator.Misc.description, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control descriptionHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.DBReportMediator.Misc.description, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#initConnectionType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setConnectionType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#initConnectionDsType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setConnectionDsType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#initConnectionDbType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setConnectionDbType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setConnectionDbDriver(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setConnectionDsInitialContext(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setConnectionDsName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setConnectionURL(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setConnectionUsername(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setConnectionPassword(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setConnectionUseTransaction(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#getIsRegistryBasedDriverConfig()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setIsRegistryBasedDriverConfig(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#getIsRegistryBasedUrlConfig()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setIsRegistryBasedUrlConfig(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#getIsRegistryBasedUserConfig()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setIsRegistryBasedUserConfig(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#getIsRegistryBasedPassConfig()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setIsRegistryBasedPassConfig(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#initSqlStatements(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#addFilterSqlStatements(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#addBusinessFilterSqlStatements(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#isContainedInSqlStatementsTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#initPropertyAutocommit(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setPropertyAutocommit(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#initPropertyIsolation(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setPropertyIsolation(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setPropertyMaxactive(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setPropertyMaxidle(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setPropertyMaxopenstatements(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setPropertyMaxwait(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setPropertyMinidle(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#initPropertyPoolstatements(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setPropertyPoolstatements(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#initPropertyTestonborrow(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setPropertyTestonborrow(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#initPropertyTestwhileidle(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setPropertyTestwhileidle(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setPropertyValidationquery(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setPropertyInitialsize(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DBReportMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
    ...
    public void validate() {
        ...
        if (getConnectionType() != null
                && getConnectionType().getName().equals(SqlExecutorConnectionType.DATA_SOURCE.getName())) {
            eu.showEntry(connectionDsTypeElements, false);

            if (getConnectionDsType() != null
                    && getConnectionDsType().getName().equals(SqlExecutorDatasourceType.EXTERNAL.getName())) {
            ...
            } else if (getConnectionDsType() != null
                    && getConnectionDsType().getName().equals(SqlExecutorDatasourceType.CARBON.getName())) {
        ...
        } else if (getConnectionType() != null
                && getConnectionType().getName().equals(SqlExecutorConnectionType.DB_CONNECTION.getName())) {
    ...
    private void fillDbConnectionDefaultValues() {
        ...
        propertiesEditionComponent
                .firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.DBReportMediator.Connection.connectionDbDriver,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, dbDriver));
        propertiesEditionComponent
                .firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.DBReportMediator.Connection.connectionDbDriver,
                        PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null, dbDriver));

        // db url
        propertiesEditionComponent
                .firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.DBReportMediator.Connection.connectionURL, PropertiesEditionEvent.COMMIT,
                        PropertiesEditionEvent.SET, null, dbURL));
        propertiesEditionComponent
                .firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.DBReportMediator.Connection.connectionURL,
                        PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null, dbURL));
        ...
        propertiesEditionComponent
                .firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.DBReportMediator.Connection.connectionUsername,
                        PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null, dbUsername));
