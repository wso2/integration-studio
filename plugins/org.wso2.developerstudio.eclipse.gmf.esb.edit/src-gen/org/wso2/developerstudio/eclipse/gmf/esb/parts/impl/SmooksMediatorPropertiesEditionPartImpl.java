 ...
 * 
 */
public class SmooksMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, SmooksMediatorPropertiesEditionPart {
    ...
    protected Composite createInputTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.SmooksMediator.Input.inputType,
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SmooksMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SmooksMediator.Input.inputType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutputTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.SmooksMediator.Output.outputType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SmooksMediator.Output.outputType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutputPropertyText(Composite parent) {
        createDescription(parent, EsbViewsRepository.SmooksMediator.Output.outputProperty,
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SmooksMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SmooksMediator.Output.outputProperty, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutputActionEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.SmooksMediator.Output.outputAction,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SmooksMediator.Output.outputAction, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutputMethodEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.SmooksMediator.Output.outputMethod,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SmooksMediator.Output.outputMethod, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.SmooksMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.SmooksMediator.Properties.reverse,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SmooksMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.SmooksMediator.Misc.description,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SmooksMediator.Misc.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
