...
public class DataServiceCallMediatorExtFactory extends AbstractMediatorFactory {

    private static final Log log = LogFactory.getLog(DataServiceCallMediatorExtFactory.class);
    ...
    private static DataServiceCallMediatorExtFactory instance;
    ...
    public static DataServiceCallMediatorExtFactory getInstance() {
		if (instance == null) {
            instance = new DataServiceCallMediatorExtFactory();
        }
        return instance;
    }
    ...
    private Value createDynamicNameValue(String propertyName, OMElement targetElement) {
        ...
        return nameValueFactory.createValue(XMLConfigConstants.ALGORITHM_NAME, targetElement);
    }
