 ...
 * 
 */
public class EntitlementMediatorObligationsOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public EntitlementMediatorObligationsOutputConnectorPropertiesEditionComponent(
            PropertiesEditingContext editingContext, EObject entitlementMediatorObligationsOutputConnector,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(
                ...
                commentMediatorsSettings = new ReferencesTableSettings(entitlementMediatorObligationsOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.EntitlementMediatorObligationsOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
