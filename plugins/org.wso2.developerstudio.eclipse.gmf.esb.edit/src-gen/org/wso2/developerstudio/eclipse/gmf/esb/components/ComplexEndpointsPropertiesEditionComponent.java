...
public class ComplexEndpointsPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ComplexEndpointsPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject complexEndpoints,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ComplexEndpoints.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        complexEndpoints.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.ComplexEndpoints.Properties.outputConnector)) {
                outputConnectorSettings = new ReferencesTableSettings(complexEndpoints,
            ...
            if (isAccessible(EsbViewsRepository.ComplexEndpoints.Properties.name))
                basePart.setName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, complexEndpoints.getName()));
                ...
                basePart.addFilterToOutputConnector(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof ComplexEndpointsOutputConnector);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ComplexEndpoints.Properties.description == event.getAffectedEditor()) {
            complexEndpoints.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.ComplexEndpoints.Properties.outputConnector == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                ...
                outputConnectorSettings.move(event.getNewIndex(),
                        (ComplexEndpointsOutputConnector) event.getNewValue());
            }
        }
        if (EsbViewsRepository.ComplexEndpoints.Properties.name == event.getAffectedEditor()) {
            complexEndpoints.setName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.ComplexEndpoints.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ComplexEndpoints.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getComplexEndpoints_OutputConnector().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.ComplexEndpoints.Properties.outputConnector))
                basePart.updateOutputConnector();
            if (EsbPackage.eINSTANCE.getComplexEndpoints_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ComplexEndpoints.Properties.name)) {
                if (msg.getNewValue() != null) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.ComplexEndpoints.Properties.name == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getComplexEndpoints_Name().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getComplexEndpoints_Name().getEAttributeType(), newValue);
                }
