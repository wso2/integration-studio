 ...
 * 
 */
public class RouterTargetPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, RouterTargetPropertiesEditionPart {
    ...
    protected Composite createSequenceTypeEMFComboViewer(Composite parent) {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RouterTargetPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterTarget.Properties.sequenceType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSequenceFlatComboViewer(Composite parent) {
        ...
        sequence = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
                .isRequired(EsbViewsRepository.RouterTarget.Properties.sequence, EsbViewsRepository.SWT_KIND));
        ...
        sequence.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        RouterTargetPropertiesEditionPartImpl.this, EsbViewsRepository.RouterTarget.Properties.sequence,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterTarget.Properties.sequence, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEndpointTypeEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterTarget.Properties.endpointType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
