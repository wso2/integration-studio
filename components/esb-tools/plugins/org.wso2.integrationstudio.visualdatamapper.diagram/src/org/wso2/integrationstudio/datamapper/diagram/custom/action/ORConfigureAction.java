...
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigureOROperatorDialog;

public class ORConfigureAction extends AbstractActionHandler {
	 ...
	 */
	public ORConfigureAction(IWorkbenchPart part) {
		super(part);
		setId(Messages.ORConfigureAction_ActionID);
		setText(Messages.ORConfigureAction_ActionText);
		setToolTipText(Messages.ORConfigureAction_ToolTip);
	...
	protected void doRun(IProgressMonitor progressMonitor) {
		...
		Dialog configureConstantDialog = new ConfigureOROperatorDialog(Display.getDefault().getActiveShell(),
				(OR) selectedObj, getEditingDomain());
