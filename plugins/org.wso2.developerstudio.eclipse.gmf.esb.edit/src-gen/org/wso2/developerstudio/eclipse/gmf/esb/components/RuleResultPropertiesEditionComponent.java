...
public class RuleResultPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public RuleResultPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject ruleResult,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.RuleResult.Properties.resultType)) {
                basePart.initResultType(
                        EEFUtils.choiceOfValues(ruleResult, EsbPackage.eINSTANCE.getRuleResult_ResultType()),
                        ruleResult.getResultType());
            }
            if (isAccessible(EsbViewsRepository.RuleResult.Properties.resultCustomType))
                basePart.setResultCustomType(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        ruleResult.getResultCustomType()));

            if (isAccessible(EsbViewsRepository.RuleResult.Properties.resultName))
                basePart.setResultName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, ruleResult.getResultName()));

            if (isAccessible(EsbViewsRepository.RuleResult.Properties.valueType)) {
                basePart.initValueType(
                        EEFUtils.choiceOfValues(ruleResult, EsbPackage.eINSTANCE.getRuleResult_ValueType()),
                        ruleResult.getValueType());
            }
            if (isAccessible(EsbViewsRepository.RuleResult.Properties.valueLiteral))
                basePart.setValueLiteral(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, ruleResult.getValueLiteral()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.RuleResult.Properties.resultCustomType == event.getAffectedEditor()) {
            ruleResult.setResultCustomType((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.RuleResult.Properties.resultName == event.getAffectedEditor()) {
            ruleResult.setResultName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
        ...
        if (EsbViewsRepository.RuleResult.Properties.valueLiteral == event.getAffectedEditor()) {
            ruleResult.setValueLiteral((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getRuleResult_ResultType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.RuleResult.Properties.resultType))
                basePart.setResultType((RuleResultType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getRuleResult_ResultCustomType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleResult.Properties.resultCustomType)) {
            ...
            if (EsbPackage.eINSTANCE.getRuleResult_ResultName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleResult.Properties.resultName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRuleResult_ValueType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.RuleResult.Properties.valueType))
                basePart.setValueType((RuleResultValueType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getRuleResult_ValueLiteral().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleResult.Properties.valueLiteral)) {
                if (msg.getNewValue() != null) {
                    basePart.setValueLiteral(
                            EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, msg.getNewValue()));
                } else {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                EsbPackage.eINSTANCE.getRuleResult_ResultType(), EsbPackage.eINSTANCE.getRuleResult_ResultCustomType(),
                EsbPackage.eINSTANCE.getRuleResult_ResultName(), EsbPackage.eINSTANCE.getRuleResult_ValueType(),
                ...
                if (EsbViewsRepository.RuleResult.Properties.resultType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleResult_ResultType().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getRuleResult_ResultType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleResult.Properties.resultCustomType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleResult_ResultCustomType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRuleResult_ResultCustomType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleResult.Properties.resultName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleResult_ResultName().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getRuleResult_ResultName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleResult.Properties.valueType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleResult_ValueType().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getRuleResult_ValueType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleResult.Properties.valueLiteral == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleResult_ValueLiteral().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getRuleResult_ValueLiteral().getEAttributeType(), newValue);
                }
