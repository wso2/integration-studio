 ...
 * 
 */
public class EnrichMediatorInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, EnrichMediatorInputConnectorPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        CompositionSequence enrichMediatorInputConnectorStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        enrichMediatorInputConnectorStep.addStep(EsbViewsRepository.EnrichMediatorInputConnector.Properties.class)
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.EnrichMediatorInputConnector.Properties.incomingLinks,
                EsbMessages.EnrichMediatorInputConnectorPropertiesEditionPart_IncomingLinksLabel);
        ...
        this.incomingLinks.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EnrichMediatorInputConnector.Properties.incomingLinks, EsbViewsRepository.SWT_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(EnrichMediatorInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.EnrichMediatorInputConnector.Properties.incomingLinks,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EnrichMediatorInputConnectorPropertiesEditionPart#addFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EnrichMediatorInputConnectorPropertiesEditionPart#addBusinessFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EnrichMediatorInputConnectorPropertiesEditionPart#isContainedInIncomingLinksTable(EObject
     *      element)
     * 
     */
