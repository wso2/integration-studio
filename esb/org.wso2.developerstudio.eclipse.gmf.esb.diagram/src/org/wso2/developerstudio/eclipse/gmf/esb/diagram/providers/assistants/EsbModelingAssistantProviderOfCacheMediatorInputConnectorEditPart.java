 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfCacheMediatorInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			CacheMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(CacheMediatorInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
