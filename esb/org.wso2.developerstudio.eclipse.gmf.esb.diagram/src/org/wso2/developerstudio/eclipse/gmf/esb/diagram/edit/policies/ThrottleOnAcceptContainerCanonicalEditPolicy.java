 ...
 * @generated
 */
public class ThrottleOnAcceptContainerCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return MediatorFlow9EditPart.VISUAL_ID == EsbVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getThrottleOnAcceptContainer_3584SemanticChildren((View) getHost()
						.getModel());
