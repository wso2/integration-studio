...
public class CloneMediatorTargetOutputConnectorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public CloneMediatorTargetOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject cloneMediatorTargetOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.CloneMediatorTargetOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(cloneMediatorTargetOutputConnector,
            ...
            if (isAccessible(EsbViewsRepository.CloneMediatorTargetOutputConnector.Properties.soapAction))
                basePart.setSoapAction(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        cloneMediatorTargetOutputConnector.getSoapAction()));
            ...
            if (isAccessible(EsbViewsRepository.CloneMediatorTargetOutputConnector.Properties.toAddress))
                basePart.setToAddress(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        cloneMediatorTargetOutputConnector.getToAddress()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.CloneMediatorTargetOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
        ...
        if (EsbViewsRepository.CloneMediatorTargetOutputConnector.Properties.soapAction == event.getAffectedEditor()) {
            cloneMediatorTargetOutputConnector.setSoapAction((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.CloneMediatorTargetOutputConnector.Properties.toAddress == event.getAffectedEditor()) {
            cloneMediatorTargetOutputConnector.setToAddress((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getOutputConnector_CommentMediators().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.CloneMediatorTargetOutputConnector.Properties.commentMediators))
                basePart.updateCommentMediators();
            if (EsbPackage.eINSTANCE.getCloneMediatorTargetOutputConnector_SoapAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CloneMediatorTargetOutputConnector.Properties.soapAction)) {
            ...
            if (EsbPackage.eINSTANCE.getCloneMediatorTargetOutputConnector_ToAddress().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CloneMediatorTargetOutputConnector.Properties.toAddress)) {
                if (msg.getNewValue() != null) {
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.CloneMediatorTargetOutputConnector.Properties.soapAction == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getCloneMediatorTargetOutputConnector_SoapAction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCloneMediatorTargetOutputConnector_SoapAction().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.CloneMediatorTargetOutputConnector.Properties.toAddress == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getCloneMediatorTargetOutputConnector_ToAddress().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCloneMediatorTargetOutputConnector_ToAddress().getEAttributeType(),
                            newValue);
                }
