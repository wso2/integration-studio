 ...
 * 
 */
public class NamespacedPropertyPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, NamespacedPropertyPropertiesEditionPart {
    ...
    protected Composite createPrettyNameText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            NamespacedPropertyPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.NamespacedProperty.Properties.prettyName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertyNameText(Composite parent) {
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(NamespacedPropertyPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.NamespacedProperty.Properties.propertyName,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.NamespacedProperty.Properties.propertyName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertyValueText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.NamespacedProperty.Properties.propertyValue, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createNamespacesText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.NamespacedProperty.Properties.namespaces, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSupportsDynamicXPathsCheckbox(Composite parent) {
        ...
        supportsDynamicXPaths
                .setText(getDescription(EsbViewsRepository.NamespacedProperty.Properties.supportsDynamicXPaths,
    ...
    protected Composite createDynamicCheckbox(Composite parent) {
        ...
        dynamic.setText(getDescription(EsbViewsRepository.NamespacedProperty.Properties.dynamic,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.NamespacedProperty.Properties.dynamic, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
