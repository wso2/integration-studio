...
package org.wso2.integrationstudio.eclipse.artifact.datasource.artifact;
 ...
 * name="testDataService_1" version="1.0.0" type="datasource/datasource"
 * serverRole="DataServicesServer" groupId="org.wso2.carbon.myapp">
 * <file>src\main\datasource\testdatasource_1.xml</file> </artifact> <artifact
 * name="testDataService_2" version="1.0.0" type="datasource/datasource"
 * serverRole="DataServicesServer" groupId="org.wso2.carbon.myapp">
 * <file>src\main\datasource\testdatasource_2.xml</file> </artifact>
 * </artifacts>
 * 
 */
public class DataSourceProjectArtifact extends AbstractXMLDoc implements Observer {
	List<DataSourceArtifact> dssArtifacts = new ArrayList<DataSourceArtifact>();
	...
	public void addDSSArtifact(DataSourceArtifact artifact) {
		dssArtifacts.add(artifact);
	}

	public boolean removeDSSArtifact(DataSourceArtifact artifact) {
		return dssArtifacts.remove(artifact);
	}

	public List<DataSourceArtifact> getAllDSSArtifacts() {
	...
	public OMElement getDocumentElement() {
		...
		for (DataSourceArtifact dssArtifact : dssArtifacts) {
