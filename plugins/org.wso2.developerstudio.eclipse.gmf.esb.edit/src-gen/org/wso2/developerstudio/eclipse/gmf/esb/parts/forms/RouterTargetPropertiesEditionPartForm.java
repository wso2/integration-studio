 ...
 * 
 */
public class RouterTargetPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, RouterTargetPropertiesEditionPart {
     ...
     */
    public RouterTargetPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RouterTarget.Properties.sequenceType,
                EsbMessages.RouterTargetPropertiesEditionPart_SequenceTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RouterTargetPropertiesEditionPartForm.this,
                            EsbViewsRepository.RouterTarget.Properties.sequenceType, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterTarget.Properties.sequenceType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSequenceFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
        createDescription(parent, EsbViewsRepository.RouterTarget.Properties.sequence,
                EsbMessages.RouterTargetPropertiesEditionPart_SequenceLabel);
        sequence = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
                .isRequired(EsbViewsRepository.RouterTarget.Properties.sequence, EsbViewsRepository.FORM_KIND));
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RouterTargetPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RouterTarget.Properties.sequence, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterTarget.Properties.sequence, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEndpointTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RouterTarget.Properties.endpointType,
                EsbMessages.RouterTargetPropertiesEditionPart_EndpointTypeLabel);
        ...
        endpointType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RouterTargetPropertiesEditionPartForm.this,
                            EsbViewsRepository.RouterTarget.Properties.endpointType, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterTarget.Properties.endpointType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterTargetPropertiesEditionPart#initSequenceType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterTargetPropertiesEditionPart#setSequenceType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterTargetPropertiesEditionPart#setSequence(EObject
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterTargetPropertiesEditionPart#setSequenceButtonMode(ButtonsModeEnum
     *      newValue)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterTargetPropertiesEditionPart#addFilterSequence(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterTargetPropertiesEditionPart#addBusinessFilterSequence(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterTargetPropertiesEditionPart#initEndpointType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterTargetPropertiesEditionPart#setEndpointType(Enumerator
     *      newValue)
     * 
     */
