 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RMSequenceMediatorImpl#getRmSpecVersion <em>Rm Spec
 * Version</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RMSequenceMediatorImpl#getSequenceType <em>Sequence
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RMSequenceMediatorImpl#getCorrelationXpath <em>Correlation
 * Xpath</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RMSequenceMediatorImpl#getLastMessageXpath <em>Last Message
 * Xpath</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RMSequenceMediatorImpl#getInputConnector <em>Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RMSequenceMediatorImpl#getOutputConnector <em>Output
 * Connector</em>}</li>
 * </ul>
 *
 * @generated
...
public class RMSequenceMediatorImpl extends MediatorImpl implements RMSequenceMediator {
    ...
    public void setRmSpecVersion(RMSpecVersion newRmSpecVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.RM_SEQUENCE_MEDIATOR__RM_SPEC_VERSION,
                    oldRmSpecVersion, rmSpecVersion));
    }
    ...
    public void setSequenceType(RMSequenceType newSequenceType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.RM_SEQUENCE_MEDIATOR__SEQUENCE_TYPE,
    ...
    public NotificationChain basicSetCorrelationXpath(NamespacedProperty newCorrelationXpath, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.RM_SEQUENCE_MEDIATOR__CORRELATION_XPATH, oldCorrelationXpath, newCorrelationXpath);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setCorrelationXpath(NamespacedProperty newCorrelationXpath) {
        if (newCorrelationXpath != correlationXpath) {
            ...
            if (correlationXpath != null)
                msgs = ((InternalEObject) correlationXpath).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.RM_SEQUENCE_MEDIATOR__CORRELATION_XPATH, null, msgs);
            if (newCorrelationXpath != null)
                msgs = ((InternalEObject) newCorrelationXpath).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.RM_SEQUENCE_MEDIATOR__CORRELATION_XPATH, null, msgs);
            msgs = basicSetCorrelationXpath(newCorrelationXpath, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.RM_SEQUENCE_MEDIATOR__CORRELATION_XPATH,
                    newCorrelationXpath, newCorrelationXpath));
    }
    ...
    public NotificationChain basicSetLastMessageXpath(NamespacedProperty newLastMessageXpath, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.RM_SEQUENCE_MEDIATOR__LAST_MESSAGE_XPATH, oldLastMessageXpath, newLastMessageXpath);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setLastMessageXpath(NamespacedProperty newLastMessageXpath) {
        if (newLastMessageXpath != lastMessageXpath) {
            ...
            if (lastMessageXpath != null)
                msgs = ((InternalEObject) lastMessageXpath).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.RM_SEQUENCE_MEDIATOR__LAST_MESSAGE_XPATH, null, msgs);
            if (newLastMessageXpath != null)
                msgs = ((InternalEObject) newLastMessageXpath).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.RM_SEQUENCE_MEDIATOR__LAST_MESSAGE_XPATH, null, msgs);
            msgs = basicSetLastMessageXpath(newLastMessageXpath, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.RM_SEQUENCE_MEDIATOR__LAST_MESSAGE_XPATH,
                    newLastMessageXpath, newLastMessageXpath));
    }
    ...
    public NotificationChain basicSetInputConnector(RMSequenceMediatorInputConnector newInputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.RM_SEQUENCE_MEDIATOR__INPUT_CONNECTOR, oldInputConnector, newInputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInputConnector != inputConnector) {
            ...
            if (inputConnector != null)
                msgs = ((InternalEObject) inputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.RM_SEQUENCE_MEDIATOR__INPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.RM_SEQUENCE_MEDIATOR__INPUT_CONNECTOR,
    ...
    public NotificationChain basicSetOutputConnector(RMSequenceMediatorOutputConnector newOutputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.RM_SEQUENCE_MEDIATOR__OUTPUT_CONNECTOR, oldOutputConnector, newOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOutputConnector != outputConnector) {
            ...
            if (outputConnector != null)
                msgs = ((InternalEObject) outputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.RM_SEQUENCE_MEDIATOR__OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.RM_SEQUENCE_MEDIATOR__OUTPUT_CONNECTOR,
