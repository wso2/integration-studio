...
import org.wso2.integrationstudio.gmf.esb.parts.MessageStoreParameterPropertiesEditionPart;
 ...
 * 
 */
public class MessageStoreParameterPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, MessageStoreParameterPropertiesEditionPart {
	 ...
	 * 
	 */
	public MessageStoreParameterPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(EsbMessages.MessageStoreParameterPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createParameterNameText(Composite parent) {
		...
		parameterName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageStoreParameterPropertiesEditionPartImpl.this, EsbViewsRepository.MessageStoreParameter.Properties.parameterName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, parameterName.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageStoreParameter.Properties.parameterName, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createParameterValueText(Composite parent) {
		...
		parameterValue.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageStoreParameterPropertiesEditionPartImpl.this, EsbViewsRepository.MessageStoreParameter.Properties.parameterValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, parameterValue.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageStoreParameter.Properties.parameterValue, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.MessageStoreParameterPropertiesEditionPart#getParameterName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.MessageStoreParameterPropertiesEditionPart#setParameterName(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.MessageStoreParameterPropertiesEditionPart#getParameterValue()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.MessageStoreParameterPropertiesEditionPart#setParameterValue(String newValue)
	 * 
	 */
