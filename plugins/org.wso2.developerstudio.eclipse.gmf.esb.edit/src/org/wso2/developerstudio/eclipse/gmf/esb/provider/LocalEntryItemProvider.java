...
public class LocalEntryItemProvider extends EsbElementItemProvider {
    ...
    protected void addEntryNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_LocalEntry_entryName_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_LocalEntry_entryName_feature",
                                "_UI_LocalEntry_type"),
                        EsbPackage.Literals.LOCAL_ENTRY__ENTRY_NAME, true, false, false,
    ...
    protected void addLocalEntryTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_LocalEntry_localEntryType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_LocalEntry_localEntryType_feature",
                                "_UI_LocalEntry_type"),
                        EsbPackage.Literals.LOCAL_ENTRY__LOCAL_ENTRY_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addValueLiteralPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_LocalEntry_valueLiteral_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_LocalEntry_valueLiteral_feature",
                                "_UI_LocalEntry_type"),
                        EsbPackage.Literals.LOCAL_ENTRY__VALUE_LITERAL, true, true, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addValueXMLPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_LocalEntry_valueXML_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_LocalEntry_valueXML_feature",
                                "_UI_LocalEntry_type"),
                        EsbPackage.Literals.LOCAL_ENTRY__VALUE_XML, true, true, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addValueURLPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_LocalEntry_valueURL_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_LocalEntry_valueURL_feature",
                                "_UI_LocalEntry_type"),
                        EsbPackage.Literals.LOCAL_ENTRY__VALUE_URL, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_LocalEntry_type")
