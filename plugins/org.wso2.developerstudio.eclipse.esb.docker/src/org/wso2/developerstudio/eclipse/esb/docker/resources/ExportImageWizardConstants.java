...
public class ExportImageWizardConstants {
    ...
    public static final String EI_DISTRIBUTION_NAME = "wso2ei-6.5.0";
    ...
    public static final String EI_TOOLING_HOME_MACOS = "/Applications/IntegrationStudio.app/Contents/MacOS";
