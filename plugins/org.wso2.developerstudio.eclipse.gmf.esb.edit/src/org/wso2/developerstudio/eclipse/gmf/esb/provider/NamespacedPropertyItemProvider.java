...
public class NamespacedPropertyItemProvider extends EsbNodeItemProvider {
    ...
    protected void addPrettyNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_NamespacedProperty_prettyName_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_NamespacedProperty_prettyName_feature",
                                "_UI_NamespacedProperty_type"),
                        EsbPackage.Literals.NAMESPACED_PROPERTY__PRETTY_NAME, true, false, false,
    ...
    protected void addPropertyNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_NamespacedProperty_propertyName_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_NamespacedProperty_propertyName_feature",
                                "_UI_NamespacedProperty_type"),
                        EsbPackage.Literals.NAMESPACED_PROPERTY__PROPERTY_NAME, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addPropertyValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_NamespacedProperty_propertyValue_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_NamespacedProperty_propertyValue_feature",
                                "_UI_NamespacedProperty_type"),
                        EsbPackage.Literals.NAMESPACED_PROPERTY__PROPERTY_VALUE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addNamespacesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_NamespacedProperty_namespaces_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_NamespacedProperty_namespaces_feature",
                                "_UI_NamespacedProperty_type"),
                        EsbPackage.Literals.NAMESPACED_PROPERTY__NAMESPACES, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addSupportsDynamicXPathsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_NamespacedProperty_supportsDynamicXPaths_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_NamespacedProperty_supportsDynamicXPaths_feature", "_UI_NamespacedProperty_type"),
                        EsbPackage.Literals.NAMESPACED_PROPERTY__SUPPORTS_DYNAMIC_XPATHS, true, false, false,
    ...
    protected void addDynamicPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_NamespacedProperty_dynamic_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_NamespacedProperty_dynamic_feature",
                                "_UI_NamespacedProperty_type"),
                        EsbPackage.Literals.NAMESPACED_PROPERTY__DYNAMIC, true, false, false,
                        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addSupportJsonPathsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_NamespacedProperty_supportJsonPaths_feature",
                        "_UI_NamespacedProperty_type"),
                EsbPackage.Literals.NAMESPACED_PROPERTY__SUPPORT_JSON_PATHS, true, false, false,
                ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
