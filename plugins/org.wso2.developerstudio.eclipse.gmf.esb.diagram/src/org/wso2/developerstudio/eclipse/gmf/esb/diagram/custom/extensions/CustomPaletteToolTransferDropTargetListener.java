...
public class CustomPaletteToolTransferDropTargetListener extends PaletteToolTransferDropTargetListener {
     ...
     * try {
     * cloudConnectorConfigurationParameters =
     * getCloudConnectorDirectoryTraverser(droppedCloudConnector).getCloudConnectorConfigurationParameters();
     * } catch (Exception e) {
     * // TODO Auto-generated catch block
     * e.printStackTrace();
     * }
     * CloudConnectorInitialConfigurationDialog cloudConnectorConfigureDialog = new
     * CloudConnectorInitialConfigurationDialog(PlatformUI.getWorkbench().getDisplay().getActiveShell(),
     * cloudConnectorConfigurationParameters);
     * 
     * cloudConnectorConfigureDialog.setDroppedCloudConnector(droppedCloudConnector);
     * cloudConnectorConfigureDialog.setDroppedCloudConnectorComponentName(getCloudConnectorDirectoryTraverser(
     * droppedCloudConnector).getCloudConnectorName());
     ...
     * try {
     * cloudConnectorConfigurationParameters =
     * getCloudConnectorDirectoryTraverser(addedConnector).getCloudConnectorConfigurationParameters();
     * } catch (Exception e) {
     * // TODO Auto-generated catch block
     * e.printStackTrace();
     * }
     ...
     * cloudConnectorConfigureDialog.setDroppedCloudConnectorComponentName(getCloudConnectorDirectoryTraverser(
     * addedConnector).getCloudConnectorName());
     * cloudConnectorConfigureDialog.setBlockOnOpen(true);
     * cloudConnectorConfigureDialog.open();
     * 
     * 
