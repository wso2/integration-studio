 ...
 * 
 */
public class BuilderMediatorOutputConectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, BuilderMediatorOutputConectorPropertiesEditionPart {
     ...
     */
    public BuilderMediatorOutputConectorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        CompositionSequence builderMediatorOutputConectorStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        builderMediatorOutputConectorStep.addStep(EsbViewsRepository.BuilderMediatorOutputConector.Properties.class)
    ...
    protected Composite createCommentMediatorsTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.commentMediators = new ReferencesTable(
                getDescription(EsbViewsRepository.BuilderMediatorOutputConector.Properties.commentMediators,
                        EsbMessages.BuilderMediatorOutputConectorPropertiesEditionPart_CommentMediatorsLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(BuilderMediatorOutputConectorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.BuilderMediatorOutputConector.Properties.commentMediators,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BuilderMediatorOutputConectorPropertiesEditionPart#initCommentMediators(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BuilderMediatorOutputConectorPropertiesEditionPart#addFilterCommentMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BuilderMediatorOutputConectorPropertiesEditionPart#addBusinessFilterCommentMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BuilderMediatorOutputConectorPropertiesEditionPart#isContainedInCommentMediatorsTable(EObject
     *      element)
     * 
     */
