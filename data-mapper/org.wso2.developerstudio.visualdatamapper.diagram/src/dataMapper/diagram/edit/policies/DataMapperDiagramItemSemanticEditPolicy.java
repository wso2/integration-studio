...
public class DataMapperDiagramItemSemanticEditPolicy extends
	 ...
	 * @generated
	 */
	public DataMapperDiagramItemSemanticEditPolicy() {
		super(
				dataMapper.diagram.providers.DataMapperElementTypes.DataMapperDiagram_2001);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (dataMapper.diagram.providers.DataMapperElementTypes.Input_3001 == req
				.getElementType()) {
