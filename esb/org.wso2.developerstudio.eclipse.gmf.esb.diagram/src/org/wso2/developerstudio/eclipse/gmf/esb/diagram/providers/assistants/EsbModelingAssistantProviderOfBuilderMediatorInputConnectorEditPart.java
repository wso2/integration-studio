 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfBuilderMediatorInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			BuilderMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(BuilderMediatorInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
