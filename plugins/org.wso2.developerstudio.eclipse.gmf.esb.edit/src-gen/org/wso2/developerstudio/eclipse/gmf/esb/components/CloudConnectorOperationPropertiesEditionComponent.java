...
public class CloudConnectorOperationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public CloudConnectorOperationPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject cloudConnectorOperation, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        cloudConnectorOperation.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.connectorParameters)) {
                connectorParametersSettings = new ReferencesTableSettings(cloudConnectorOperation,
            ...
            if (isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.configRef))
                basePart.setConfigRef(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        cloudConnectorOperation.getConfigRef()));

            if (isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.connectorName))
                basePart.setConnectorName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        cloudConnectorOperation.getConnectorName()));

            if (isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.operationName))
                basePart.setOperationName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        cloudConnectorOperation.getOperationName()));

            if (isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.cloudConnectorName))
                basePart.setCloudConnectorName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        cloudConnectorOperation.getCloudConnectorName()));

            if (isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.availableConfigs))
                basePart.setAvailableConfigs(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        cloudConnectorOperation.getAvailableConfigs()));

            if (isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.parameterEditorType)) {
                basePart.initParameterEditorType(
                        EEFUtils.choiceOfValues(cloudConnectorOperation,
                                EsbPackage.eINSTANCE.getCloudConnectorOperation_ParameterEditorType()),
                        cloudConnectorOperation.getParameterEditorType());
            }
            // init filters
                ...
                basePart.addFilterToConnectorParameters(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof CallTemplateParameter);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.CloudConnectorOperation.Properties.description == event.getAffectedEditor()) {
            cloudConnectorOperation.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.CloudConnectorOperation.Properties.connectorParameters == event.getAffectedEditor()) {
            String schemaName = cloudConnectorOperation.getConnectorName().split("connector")[0] + "-"
                    + cloudConnectorOperation.getOperationName();
            if (ConnectorSchemaHolder.getInstance().hasConnectorOperationSchema(schemaName)) {
                ...
                if (event.getKind() == PropertiesEditionEvent.ADD) {
                    EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                            this, connectorParametersSettings, editingContext.getAdapterFactory());
        ...
        if (EsbViewsRepository.CloudConnectorOperation.Properties.parameterEditorType == event.getAffectedEditor()) {
            cloudConnectorOperation
                    .setParameterEditorType((CloudConnectorOperationParamEditorType) event.getNewValue());
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCloudConnectorOperation_ConnectorParameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.connectorParameters))
                basePart.updateConnectorParameters();
            if (EsbPackage.eINSTANCE.getCloudConnectorOperation_ConfigRef().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.configRef)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCloudConnectorOperation_ConnectorName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.connectorName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCloudConnectorOperation_OperationName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.operationName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCloudConnectorOperation_CloudConnectorName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.cloudConnectorName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCloudConnectorOperation_AvailableConfigs().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.availableConfigs)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCloudConnectorOperation_ParameterEditorType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.CloudConnectorOperation.Properties.parameterEditorType))
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.CloudConnectorOperation.Properties.configRef == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCloudConnectorOperation_ConfigRef().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCloudConnectorOperation_ConfigRef().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CloudConnectorOperation.Properties.connectorName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCloudConnectorOperation_ConnectorName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCloudConnectorOperation_ConnectorName().getEAttributeType(),
                ...
                if (EsbViewsRepository.CloudConnectorOperation.Properties.operationName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCloudConnectorOperation_OperationName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCloudConnectorOperation_OperationName().getEAttributeType(),
                ...
                if (EsbViewsRepository.CloudConnectorOperation.Properties.cloudConnectorName == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getCloudConnectorOperation_CloudConnectorName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCloudConnectorOperation_CloudConnectorName().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.CloudConnectorOperation.Properties.availableConfigs == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCloudConnectorOperation_AvailableConfigs().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCloudConnectorOperation_AvailableConfigs().getEAttributeType(),
                ...
                if (EsbViewsRepository.CloudConnectorOperation.Properties.parameterEditorType == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getCloudConnectorOperation_ParameterEditorType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCloudConnectorOperation_ParameterEditorType().getEAttributeType(),
                            newValue);
                }
