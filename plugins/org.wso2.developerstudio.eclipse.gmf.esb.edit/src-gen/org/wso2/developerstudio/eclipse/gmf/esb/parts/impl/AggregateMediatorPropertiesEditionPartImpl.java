 ...
 * 
 */
public class AggregateMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, AggregateMediatorPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AggregateMediatorPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(AggregateMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AggregateMediator.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.AggregateMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.AggregateMediator.Properties.reverse,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AggregateMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAggregateIDText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AggregateMediator.Properties.aggregateID,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AggregateMediator.Properties.aggregateID, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCompletionTimeoutText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AggregateMediator.Properties.completionTimeout,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AggregateMediator.Properties.completionTimeout, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createCompletionMinMessagesTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesType,
    ...
    protected Composite createCompletionMaxMessagesTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesType,
    ...
    protected Composite createCompletionMinMessagesValueText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesValue,
                EsbMessages.AggregateMediatorPropertiesEditionPart_CompletionMinMessagesValueLabel);
    ...
    protected Composite createCompletionMaxMessagesValueText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesValue,
                EsbMessages.AggregateMediatorPropertiesEditionPart_CompletionMaxMessagesValueLabel);
    ...
    protected Composite createEnclosingElementPropertyText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AggregateMediator.Properties.enclosingElementProperty,
    ...
    protected Composite createSequenceTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.AggregateMediator.OnComplete.sequenceType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AggregateMediator.OnComplete.sequenceType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
