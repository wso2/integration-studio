 ...
 * 
 */
public class AddressingEndpointInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, AddressingEndpointInputConnectorPropertiesEditionPart {
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.AddressingEndpointInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressingEndpointInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.AddressingEndpointInputConnector.Properties.incomingLinks,
