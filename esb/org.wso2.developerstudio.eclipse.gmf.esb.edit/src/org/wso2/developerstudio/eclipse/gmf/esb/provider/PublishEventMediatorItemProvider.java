	...
	protected void addAttributesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PublishEventMediator_attributes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PublishEventMediator_attributes_feature", "_UI_PublishEventMediator_type"),
				 EsbPackage.Literals.PUBLISH_EVENT_MEDIATOR__ATTRIBUTES,
				 true,
				 false,
				 true,
				 null,
