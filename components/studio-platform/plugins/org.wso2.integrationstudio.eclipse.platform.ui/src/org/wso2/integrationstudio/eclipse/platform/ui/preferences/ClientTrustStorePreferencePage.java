...
public class ClientTrustStorePreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void init(IWorkbench arg0) {
		...
		setDescription("WSO2 Integration Studio Custom Client Trust Store Preference.");
			...
			public void propertyChange(org.eclipse.jface.util.PropertyChangeEvent arg0) {
				...
				if (TRUST_STORE_LOCATION.equals(arg0.getProperty())) {
					...
					if (!string.equals("") && !string.endsWith(".jks")) {
						MessageDialog.openError(Display.getCurrent().getActiveShell(), "Integration Studio Error Dialog",
						                        "You cannot set non JKS trust stores from Integration Studio");
					}
				}
	...
	public boolean performOk() {
		...
		if (WorkbenchToolkit.showQuestionMessageDialog("Integration Studio Info", message)) {
