...
public class OperatorRightConnectorCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return dataMapper.DataMapperPackage.eINSTANCE.getOperatorRightConnector_OutNode();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<dataMapper.diagram.part.DataMapperNodeDescriptor> childDescriptors = dataMapper.diagram.part.DataMapperDiagramUpdater
				.getOperatorRightConnector_3017SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return dataMapper.diagram.edit.parts.OutNode3EditPart.VISUAL_ID == dataMapper.diagram.part.DataMapperVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<dataMapper.diagram.part.DataMapperNodeDescriptor> childDescriptors = dataMapper.diagram.part.DataMapperDiagramUpdater
				.getOperatorRightConnector_3017SemanticChildren((View) getHost().getModel());
