 ...
 * 
 */
public class SequenceInputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, SequenceInputConnectorPropertiesEditionPart {
     ...
     */
    public SequenceInputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        sequenceInputConnectorStep.addStep(EsbViewsRepository.SequenceInputConnector.Properties.class)
    ...
    protected Composite createIncomingLinksReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.incomingLinks = new ReferencesTable(
                getDescription(EsbViewsRepository.SequenceInputConnector.Properties.incomingLinks,
                        EsbMessages.SequenceInputConnectorPropertiesEditionPart_IncomingLinksLabel),
        ...
        this.incomingLinks.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SequenceInputConnector.Properties.incomingLinks, EsbViewsRepository.FORM_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SequenceInputConnectorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SequenceInputConnector.Properties.incomingLinks,
    ...
    protected void moveIncomingLinks(EObject element, int oldIndex, int newIndex) {
        propertiesEditionComponent
                .firePropertiesChanged(new PropertiesEditionEvent(SequenceInputConnectorPropertiesEditionPartForm.this,
                        EsbViewsRepository.SequenceInputConnector.Properties.incomingLinks,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequenceInputConnectorPropertiesEditionPart#addFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequenceInputConnectorPropertiesEditionPart#addBusinessFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequenceInputConnectorPropertiesEditionPart#isContainedInIncomingLinksTable(EObject
     *      element)
     * 
     */
