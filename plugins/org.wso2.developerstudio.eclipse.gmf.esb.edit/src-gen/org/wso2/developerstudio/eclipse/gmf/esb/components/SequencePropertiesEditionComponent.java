...
public class SequencePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public SequencePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject sequence,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.Sequence.Properties.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, sequence.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.Sequence.Properties.outputConnector)) {
                outputConnectorSettings = new ReferencesTableSettings(sequence,
            ...
            if (isAccessible(EsbViewsRepository.Sequence.Properties.includedMediators)) {
                includedMediatorsSettings = new ReferencesTableSettings(sequence,
            ...
            if (isAccessible(EsbViewsRepository.Sequence.Properties.referringSequenceType)) {
                basePart.initReferringSequenceType(
                        EEFUtils.choiceOfValues(sequence, EsbPackage.eINSTANCE.getSequence_ReferringSequenceType()),
                        sequence.getReferringSequenceType());
            }
                ...
                basePart.addFilterToOutputConnector(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof SequenceOutputConnector);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.Sequence.Properties.description == event.getAffectedEditor()) {
            sequence.setDescription((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
        ...
        if (EsbViewsRepository.Sequence.Properties.name == event.getAffectedEditor()) {
            sequence.setName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.Sequence.Properties.key == event.getAffectedEditor()) {
            sequence.setKey((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.Sequence.Properties.includedMediators == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, includedMediatorsSettings, editingContext.getAdapterFactory());
                PropertiesEditingProvider provider = (PropertiesEditingProvider) editingContext.getAdapterFactory()
                        .adapt(semanticObject, PropertiesEditingProvider.class);
                if (provider != null) {
                    PropertiesEditingPolicy policy = provider.getPolicy(context);
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.Sequence.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Sequence.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Sequence.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getSequence_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Sequence.Properties.name)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getSequence_Key().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Sequence.Properties.key)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getSequence_OutputConnector().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.Sequence.Properties.outputConnector))
                basePart.updateOutputConnector();
            if (EsbPackage.eINSTANCE.getSequence_IncludedMediators().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.Sequence.Properties.includedMediators))
                basePart.updateIncludedMediators();
            if (EsbPackage.eINSTANCE.getSequence_ReceiveSequence().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Sequence.Properties.receiveSequence))
                basePart.setReceiveSequence((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getSequence_Duplicate().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Sequence.Properties.duplicate))
                basePart.setDuplicate((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getSequence_ReferringSequenceType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.Sequence.Properties.referringSequenceType))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getSequence_Name(),
                EsbPackage.eINSTANCE.getSequence_Key(), EsbPackage.eINSTANCE.getSequence_OutputConnector(),
                EsbPackage.eINSTANCE.getSequence_IncludedMediators(),
                EsbPackage.eINSTANCE.getSequence_ReceiveSequence(), EsbPackage.eINSTANCE.getSequence_Duplicate(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.Sequence.Properties.name == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSequence_Name().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getSequence_Name().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.Sequence.Properties.key == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSequence_Key().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getSequence_Key().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.Sequence.Properties.receiveSequence == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSequence_ReceiveSequence().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getSequence_ReceiveSequence().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.Sequence.Properties.duplicate == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSequence_Duplicate().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getSequence_Duplicate().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.Sequence.Properties.referringSequenceType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSequence_ReferringSequenceType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getSequence_ReferringSequenceType().getEAttributeType(), newValue);
                }
