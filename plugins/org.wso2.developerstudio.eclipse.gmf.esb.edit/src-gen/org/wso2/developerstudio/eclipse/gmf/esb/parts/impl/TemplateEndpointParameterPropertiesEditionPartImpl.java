 ...
 * 
 */
public class TemplateEndpointParameterPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, TemplateEndpointParameterPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        CompositionStep propertiesStep = templateEndpointParameterStep
                .addStep(EsbViewsRepository.TemplateEndpointParameter.Properties.class);
    ...
    protected Composite createParameterNameText(Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpointParameter.Properties.parameterName,
                EsbMessages.TemplateEndpointParameterPropertiesEditionPart_ParameterNameLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointParameterPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(TemplateEndpointParameterPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.TemplateEndpointParameter.Properties.parameterName,
    ...
    protected Composite createParameterValueText(Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpointParameter.Properties.parameterValue,
                EsbMessages.TemplateEndpointParameterPropertiesEditionPart_ParameterValueLabel);
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointParameterPropertiesEditionPart#setParameterName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointParameterPropertiesEditionPart#setParameterValue(String
     *      newValue)
     * 
     */
