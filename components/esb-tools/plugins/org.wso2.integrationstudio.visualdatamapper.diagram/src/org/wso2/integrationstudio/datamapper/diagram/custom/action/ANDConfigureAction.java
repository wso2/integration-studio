...
import org.wso2.integrationstudio.datamapper.AND;
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigureAndOperatorDialog;

public class ANDConfigureAction extends AbstractActionHandler {
	 ...
	 */
	public ANDConfigureAction(IWorkbenchPart part) {
		super(part);
		setId(Messages.ANDConfigureAction_ActionID);
		setText(Messages.ANDConfigureAction_ActionText);
		setToolTipText(Messages.ANDConfigureAction_ToolTip);
