...
public class EsbGraphicalShape extends RoundedRectangle {
    ...
    public EsbGraphicalShape() {
        ...
        layoutThis.marginHeight = 0; // if we keep default value (5), then selected border and normal border will not
                                     // coincide
    ...
    private void createContents() {
        ...
        // bottomRondedRect.setBackgroundColor(this.getBackgroundColor()); //do no set background since this will case
        // probs with selection colors
