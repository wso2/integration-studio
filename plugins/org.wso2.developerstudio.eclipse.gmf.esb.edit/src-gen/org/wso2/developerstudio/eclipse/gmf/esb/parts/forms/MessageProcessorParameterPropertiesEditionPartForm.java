 ...
 * 
 */
public class MessageProcessorParameterPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, MessageProcessorParameterPropertiesEditionPart {
     ...
     */
    public MessageProcessorParameterPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = messageProcessorParameterStep
                .addStep(EsbViewsRepository.MessageProcessorParameter.Properties.class);
    ...
    protected Composite createParameterNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageProcessorParameter.Properties.parameterName,
                EsbMessages.MessageProcessorParameterPropertiesEditionPart_ParameterNameLabel);
        ...
        parameterName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageProcessorParameterPropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageProcessorParameter.Properties.parameterName,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageProcessorParameterPropertiesEditionPartForm.this, null,
    ...
    protected Composite createParameterValueText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageProcessorParameter.Properties.parameterValue,
                EsbMessages.MessageProcessorParameterPropertiesEditionPart_ParameterValueLabel);
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorParameterPropertiesEditionPart#setParameterName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorParameterPropertiesEditionPart#setParameterValue(String
     *      newValue)
     * 
     */
