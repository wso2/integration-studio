...
public class TreeNode3EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new dataMapper.diagram.edit.policies.TreeNode3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new dataMapper.diagram.edit.policies.TreeNode3CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof dataMapper.diagram.edit.parts.TreeNodeName3EditPart) {
			((dataMapper.diagram.edit.parts.TreeNodeName3EditPart) childEditPart)
