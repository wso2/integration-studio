 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfFilterMediatorInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			FilterMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(FilterMediatorInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
