 ...
 * class and generate script for instantiate operation
 */
public class InstantiateOperatorTransformer extends AbstractDMOperatorTransformer {
	...
	public String generateScriptForOperation(Class<?> generatorClass, List<DMVariable> inputVariables,
		...
		if (DifferentLevelArrayMappingConfigGenerator.class.equals(generatorClass)) {
			...
			} else if (SchemaDataType.OBJECT.equals(operator.getProperty(TransformerConstants.VARIABLE_TYPE))) {
				operationBuilder.append(" {};");
			}
		} else {
