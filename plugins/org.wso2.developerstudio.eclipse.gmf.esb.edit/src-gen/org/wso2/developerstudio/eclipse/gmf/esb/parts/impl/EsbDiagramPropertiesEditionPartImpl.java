 ...
 * 
 */
public class EsbDiagramPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, EsbDiagramPropertiesEditionPart {
    ...
    protected Composite createTestText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EsbDiagramPropertiesEditionPartImpl.this, EsbViewsRepository.EsbDiagram.Properties.test,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EsbDiagram.Properties.test, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
