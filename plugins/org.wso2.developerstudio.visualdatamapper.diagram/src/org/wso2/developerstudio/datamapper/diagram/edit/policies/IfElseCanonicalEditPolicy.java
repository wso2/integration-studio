 ...
 * @generated
 */
public class IfElseCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater
				.getIfElse_2025SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater
				.getIfElse_2025SemanticChildren((View) getHost().getModel());
