 ...
 * 
 */
public class BeanMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, BeanMediatorPropertiesEditionPart {
     ...
     */
    public BeanMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        ...
        createDescription(parent, EsbViewsRepository.BeanMediator.Properties.description,
                EsbMessages.BeanMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.BeanMediator.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(BeanMediatorPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            BeanMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.BeanMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.BeanMediator.Properties.commentsList,
                        EsbMessages.BeanMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "BeanMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            BeanMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.BeanMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.BeanMediator.Properties.reverse,
                EsbMessages.BeanMediatorPropertiesEditionPart_ReverseLabel), SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(BeanMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.BeanMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.BeanMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createClass_Text(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.BeanMediator.Properties.class_,
                EsbMessages.BeanMediatorPropertiesEditionPart_Class_Label);
        ...
        class_.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(BeanMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.BeanMediator.Properties.class_, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, class_.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            BeanMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.BeanMediator.Properties.class_, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.BeanMediator.Properties.class_, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createActionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.BeanMediator.Properties.action,
                EsbMessages.BeanMediatorPropertiesEditionPart_ActionLabel);
        ...
        action.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(BeanMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.BeanMediator.Properties.action, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getAction()));
            }

        });
        action.setID(EsbViewsRepository.BeanMediator.Properties.action);
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.BeanMediator.Properties.action, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createVarText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.BeanMediator.Properties.var,
                EsbMessages.BeanMediatorPropertiesEditionPart_VarLabel);
        ...
        var.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            BeanMediatorPropertiesEditionPartForm.this, EsbViewsRepository.BeanMediator.Properties.var,
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(BeanMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.BeanMediator.Properties.var, PropertiesEditionEvent.COMMIT,
                                        PropertiesEditionEvent.SET, null, var.getText()));
                }
            }
        });
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.BeanMediator.Properties.var, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertyText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.BeanMediator.Properties.property,
                EsbMessages.BeanMediatorPropertiesEditionPart_PropertyLabel);
        ...
        property.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(BeanMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.BeanMediator.Properties.property, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, property.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            BeanMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.BeanMediator.Properties.property, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, property.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.BeanMediator.Properties.property, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        ...
        createDescription(filterValueSubPropertiesGroup, EsbViewsRepository.BeanMediator.Properties.valueType,
                EsbMessages.BeanMediatorPropertiesEditionPart_ValueTypeLabel);
        ...
        valueType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(BeanMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.BeanMediator.Properties.valueType, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getValueType()));
            }

        });
        valueType.setID(EsbViewsRepository.BeanMediator.Properties.valueType);
        FormUtils.createHelpButton(widgetFactory, filterValueSubPropertiesGroup, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.BeanMediator.Properties.valueType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createValueLiteralText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = filterValueSubPropertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.BeanMediator.Properties.valueLiteral,
                EsbMessages.BeanMediatorPropertiesEditionPart_ValueLiteralLabel);
        ...
        valueLiteral.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            BeanMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.BeanMediator.Properties.valueLiteral, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, valueLiteral.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(BeanMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.BeanMediator.Properties.valueLiteral,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    valueLiteral.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.BeanMediator.Properties.valueLiteral, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTargetTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        filterTargetSubPropertiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent, "Target",
                true);
        Control[] previousControls = filterTargetSubPropertiesGroup.getChildren();
        createDescription(filterTargetSubPropertiesGroup, EsbViewsRepository.BeanMediator.Properties.targetType,
                EsbMessages.BeanMediatorPropertiesEditionPart_TargetTypeLabel);
        ...
        targetType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(BeanMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.BeanMediator.Properties.targetType,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getTargetType()));
            }

        });
        targetType.setID(EsbViewsRepository.BeanMediator.Properties.targetType);
        FormUtils.createHelpButton(widgetFactory, filterTargetSubPropertiesGroup, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.BeanMediator.Properties.targetType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createTargetLiteralText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = filterTargetSubPropertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.BeanMediator.Properties.targetLiteral,
                EsbMessages.BeanMediatorPropertiesEditionPart_TargetLiteralLabel);
        ...
        targetLiteral.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            BeanMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.BeanMediator.Properties.targetLiteral, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, targetLiteral.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(BeanMediatorPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.BeanMediator.Properties.targetLiteral, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BeanMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BeanMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BeanMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BeanMediatorPropertiesEditionPart#initAction(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BeanMediatorPropertiesEditionPart#setAction(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BeanMediatorPropertiesEditionPart#setProperty(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BeanMediatorPropertiesEditionPart#initValueType(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BeanMediatorPropertiesEditionPart#setValueType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BeanMediatorPropertiesEditionPart#setValueLiteral(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BeanMediatorPropertiesEditionPart#initTargetType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BeanMediatorPropertiesEditionPart#setTargetType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BeanMediatorPropertiesEditionPart#setTargetLiteral(String
     *      newValue)
     * 
     */
    ...
    protected Composite createValueExpressionWidget(FormToolkit widgetFactory, final Composite parent) {
        Control valueExpressionLabel = createDescription(parent,
                EsbViewsRepository.BeanMediator.Properties.valueExpression,
                EsbMessages.BeanMediatorPropertiesEditionPart_ValueExpressionLabel);
        widgetFactory.paintBordersFor(parent);
        ...
        Control valueExpressionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.BeanMediator.Properties.valueExpression,
    ...
    protected Composite createTargetExpressionWidget(FormToolkit widgetFactory, final Composite parent) {
        Control targetExpressionLabel = createDescription(parent,
                EsbViewsRepository.BeanMediator.Properties.targetExpression,
                EsbMessages.BeanMediatorPropertiesEditionPart_TargetExpressionLabel);
        widgetFactory.paintBordersFor(parent);
        if (targetExpression == null) {
            targetExpression = EsbFactoryImpl.eINSTANCE.createNamespacedProperty();
        }
        String initValueExpression = targetExpression.getPropertyValue().isEmpty() ? ""
                : targetExpression.getPropertyValue();
        ...
        Control targetExpressionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.BeanMediator.Properties.targetExpression,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    private void openValueExpressionWidgetNamespacedPropertyEditor(final Composite parent) {
        ...
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                BeanMediatorPropertiesEditionPartForm.this, EsbViewsRepository.BeanMediator.Properties.valueExpression,
    ...
    private void openTargetExpressionWidgetNamespacedPropertyEditor(final Composite parent) {
        ...
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                BeanMediatorPropertiesEditionPartForm.this, EsbViewsRepository.BeanMediator.Properties.targetExpression,
                PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getValueExpression()));
    }
