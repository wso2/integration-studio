...
public class JsonTransformMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public JsonTransformMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject jsonTransformMediator, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.JsonTransformMediator.Properties.jsonTransformProperties)) {
                jsonTransformPropertiesSettings = new ReferencesTableSettings(jsonTransformMediator,
            ...
            if (isAccessible(EsbViewsRepository.JsonTransformMediator.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        jsonTransformMediator.getDescription()));
                ...
                basePart.addFilterToJsonTransformProperties(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof JsonTransformMediatorProperty);
                    }
        ...
        if (EsbViewsRepository.JsonTransformMediator.Properties.jsonTransformProperties == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, jsonTransformPropertiesSettings, editingContext.getAdapterFactory());
                ...
                jsonTransformPropertiesSettings.move(event.getNewIndex(),
                        (JsonTransformMediatorProperty) event.getNewValue());
            }
        }
        if (EsbViewsRepository.JsonTransformMediator.Properties.description == event.getAffectedEditor()) {
            jsonTransformMediator.setDescription((java.lang.String) EEFConverterUtil
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.JsonTransformMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.JsonTransformMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            // Start of user code for schema live update
            if (EsbPackage.eINSTANCE.getJsonTransformMediator_Schema().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.JsonTransformMediator.Properties.schema)) {
            ...
            if (EsbPackage.eINSTANCE.getJsonTransformMediator_JsonTransformProperties().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.JsonTransformMediator.Properties.jsonTransformProperties))
                basePart.updateJsonTransformProperties();
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.JsonTransformMediator.Properties.description)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                EsbPackage.eINSTANCE.getEsbElement_CommentsList(), EsbPackage.eINSTANCE.getMediator_Reverse(),
