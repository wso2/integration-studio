 ...
 * 
 */
public class MessageStoreParameterPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, MessageStoreParameterPropertiesEditionPart {
     ...
     */
    public MessageStoreParameterPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createParameterNameText(FormToolkit widgetFactory, Composite parent) {
        ...
        parameterName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStoreParameterPropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStoreParameter.Properties.parameterName,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStoreParameterPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStoreParameter.Properties.parameterName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
