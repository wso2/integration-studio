...
public class DBLookupMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public DBLookupMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject dBLookupMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Misc.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBLookupMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionType)) {
                basePart.initConnectionType(
                        EEFUtils.choiceOfValues(dBLookupMediator,
                                EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionType()),
                        dBLookupMediator.getConnectionType());
            }
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionDsType)) {
                basePart.initConnectionDsType(
                        EEFUtils.choiceOfValues(dBLookupMediator,
                                EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDsType()),
                        dBLookupMediator.getConnectionDsType());
            }
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionDbType)) {
                basePart.initConnectionDbType(
                        EEFUtils.choiceOfValues(dBLookupMediator,
                                EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDbType()),
                        dBLookupMediator.getConnectionDbType());
            }
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionDbDriver))
                basePart.setConnectionDbDriver(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBLookupMediator.getConnectionDbDriver()));

            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionDsInitialContext))
                basePart.setConnectionDsInitialContext(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBLookupMediator.getConnectionDsInitialContext()));

            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionDsName))
                basePart.setConnectionDsName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBLookupMediator.getConnectionDsName()));

            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionURL))
                basePart.setConnectionURL(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBLookupMediator.getConnectionURL()));

            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionUsername))
                basePart.setConnectionUsername(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBLookupMediator.getConnectionUsername()));

            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionPassword))
                basePart.setConnectionPassword(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBLookupMediator.getConnectionPassword()));

            if (isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyAutocommit)) {
                basePart.initPropertyAutocommit(
                        EEFUtils.choiceOfValues(dBLookupMediator,
                                EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyAutocommit()),
                        dBLookupMediator.getPropertyAutocommit());
            }
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyIsolation)) {
                basePart.initPropertyIsolation(
                        EEFUtils.choiceOfValues(dBLookupMediator,
                                EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyIsolation()),
                        dBLookupMediator.getPropertyIsolation());
            }
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyMaxactive)) {
                basePart.setPropertyMaxactive(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        dBLookupMediator.getPropertyMaxactive()));
            }

            if (isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyMaxidle)) {
                basePart.setPropertyMaxidle(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        dBLookupMediator.getPropertyMaxidle()));
            }

            if (isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyMaxopenstatements)) {
                basePart.setPropertyMaxopenstatements(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        dBLookupMediator.getPropertyMaxopenstatements()));
            }

            if (isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyMaxwait)) {
                basePart.setPropertyMaxwait(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        dBLookupMediator.getPropertyMaxwait()));
            }

            if (isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyMinidle)) {
                basePart.setPropertyMinidle(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        dBLookupMediator.getPropertyMinidle()));
            }

            if (isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyPoolstatements)) {
                basePart.initPropertyPoolstatements(
                        EEFUtils.choiceOfValues(dBLookupMediator,
                                EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyPoolstatements()),
                        dBLookupMediator.getPropertyPoolstatements());
            }
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyTestonborrow)) {
                basePart.initPropertyTestonborrow(
                        EEFUtils.choiceOfValues(dBLookupMediator,
                                EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyTestonborrow()),
                        dBLookupMediator.getPropertyTestonborrow());
            }
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyTestwhileidle)) {
                basePart.initPropertyTestwhileidle(
                        EEFUtils.choiceOfValues(dBLookupMediator,
                                EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyTestwhileidle()),
                        dBLookupMediator.getPropertyTestwhileidle());
            }
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyValidationquery))
                basePart.setPropertyValidationquery(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBLookupMediator.getPropertyValidationquery()));

            if (isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyInitialsize)) {
                basePart.setPropertyInitialsize(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        dBLookupMediator.getPropertyInitialsize()));
            }

            if (isAccessible(EsbViewsRepository.DBLookupMediator.Statements.sqlStatements)) {
                sqlStatementsSettings = new ReferencesTableSettings(dBLookupMediator,
            ...
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedDriverConfig)) {
                basePart.setIsRegistryBasedDriverConfig(dBLookupMediator.isIsRegistryBasedDriverConfig());
            }
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedUrlConfig)) {
                basePart.setIsRegistryBasedUrlConfig(dBLookupMediator.isIsRegistryBasedUrlConfig());
            }
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedUserConfig)) {
                basePart.setIsRegistryBasedUserConfig(dBLookupMediator.isIsRegistryBasedUserConfig());
            }
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedPassConfig)) {
                basePart.setIsRegistryBasedPassConfig(dBLookupMediator.isIsRegistryBasedPassConfig());
            }
            // Start of user code for registryBasedDriverConfigKey command update
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.registryBasedDriverConfigKey)) {
                basePart.setRegistryBasedDriverConfigKey(dBLookupMediator.getRegistryBasedDriverConfigKey());
            }
            // End of user code

            // Start of user code for registryBasedUrlConfigKey command update
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.registryBasedUrlConfigKey)) {
                basePart.setRegistryBasedUrlConfigKey(dBLookupMediator.getRegistryBasedUrlConfigKey());
            }
            // End of user code

            // Start of user code for registryBasedUserConfigKey command update
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.registryBasedUserConfigKey)) {
                basePart.setRegistryBasedUserConfigKey(dBLookupMediator.getRegistryBasedUserConfigKey());
            }
            // End of user code

            // Start of user code for registryBasedPassConfigKey command update
            if (isAccessible(EsbViewsRepository.DBLookupMediator.Connection.registryBasedPassConfigKey)) {
                basePart.setRegistryBasedPassConfigKey(dBLookupMediator.getRegistryBasedPassConfigKey());
            }
            // End of user code
    ...
    public EStructuralFeature associatedFeature(Object editorKey) {
        ...
        if (editorKey == EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedDriverConfig) {
            return EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_IsRegistryBasedDriverConfig();
        }
        if (editorKey == EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedUrlConfig) {
            return EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_IsRegistryBasedUrlConfig();
        }
        if (editorKey == EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedUserConfig) {
            return EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_IsRegistryBasedUserConfig();
        }
        if (editorKey == EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedPassConfig) {
            return EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_IsRegistryBasedPassConfig();
        }
        if (editorKey == EsbViewsRepository.DBLookupMediator.Connection.registryBasedDriverConfigKey) {
            return EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_RegistryBasedDriverConfigKey();
        }
        if (editorKey == EsbViewsRepository.DBLookupMediator.Connection.registryBasedUrlConfigKey) {
            return EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_RegistryBasedUrlConfigKey();
        }
        if (editorKey == EsbViewsRepository.DBLookupMediator.Connection.registryBasedUserConfigKey) {
            return EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_RegistryBasedUserConfigKey();
        }
        if (editorKey == EsbViewsRepository.DBLookupMediator.Connection.registryBasedPassConfigKey) {
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.DBLookupMediator.Misc.description == event.getAffectedEditor()) {
            dBLookupMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.DBLookupMediator.Properties.propertyMaxactive == event.getAffectedEditor()) {
            dBLookupMediator.setPropertyMaxactive(
        ...
        if (EsbViewsRepository.DBLookupMediator.Properties.propertyValidationquery == event.getAffectedEditor()) {
            dBLookupMediator.setPropertyValidationquery((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.DBLookupMediator.Properties.propertyInitialsize == event.getAffectedEditor()) {
            dBLookupMediator.setPropertyInitialsize(
                    (EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String) event.getNewValue())));
        }
        if (EsbViewsRepository.DBLookupMediator.Statements.sqlStatements == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, sqlStatementsSettings, editingContext.getAdapterFactory());
        ...
        if (EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedDriverConfig == event.getAffectedEditor()) {
            dBLookupMediator.setIsRegistryBasedDriverConfig((Boolean) event.getNewValue());
        }
        if (EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedUrlConfig == event.getAffectedEditor()) {
            dBLookupMediator.setIsRegistryBasedUrlConfig((Boolean) event.getNewValue());
        }
        if (EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedUserConfig == event.getAffectedEditor()) {
            dBLookupMediator.setIsRegistryBasedUserConfig((Boolean) event.getNewValue());
        }
        if (EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedPassConfig == event.getAffectedEditor()) {
            dBLookupMediator.setIsRegistryBasedPassConfig((Boolean) event.getNewValue());
        }
        if (EsbViewsRepository.DBLookupMediator.Connection.registryBasedDriverConfigKey == event.getAffectedEditor()) {
            // Start of user code for updateRegistryBasedDriverConfigKey method body
            if (event.getNewValue() != null) {
                RegistryKeyProperty rkp = (RegistryKeyProperty) event.getNewValue();
                dBLookupMediator.setRegistryBasedDriverConfigKey(rkp);
            } else {
                dBLookupMediator.setRegistryBasedDriverConfigKey(EsbFactoryImpl.eINSTANCE.createRegistryKeyProperty());
            }
            // End of user code

        }
        if (EsbViewsRepository.DBLookupMediator.Connection.registryBasedUrlConfigKey == event.getAffectedEditor()) {
            // Start of user code for updateRegistryBasedUrlConfigKey method body
            if (event.getNewValue() != null) {
                RegistryKeyProperty rkp = (RegistryKeyProperty) event.getNewValue();
                dBLookupMediator.setRegistryBasedUrlConfigKey(rkp);
            } else {
                dBLookupMediator.setRegistryBasedUrlConfigKey(EsbFactoryImpl.eINSTANCE.createRegistryKeyProperty());
            }
            // End of user code

        }
        if (EsbViewsRepository.DBLookupMediator.Connection.registryBasedUserConfigKey == event.getAffectedEditor()) {
            // Start of user code for updateRegistryBasedUserConfigKey method body
            if (event.getNewValue() != null) {
                RegistryKeyProperty rkp = (RegistryKeyProperty) event.getNewValue();
                dBLookupMediator.setRegistryBasedUserConfigKey(rkp);
            } else {
                dBLookupMediator.setRegistryBasedUserConfigKey(EsbFactoryImpl.eINSTANCE.createRegistryKeyProperty());
            }
            // End of user code

        }
        if (EsbViewsRepository.DBLookupMediator.Connection.registryBasedPassConfigKey == event.getAffectedEditor()) {
            // Start of user code for updateRegistryBasedPassConfigKey method body
            if (event.getNewValue() != null) {
                RegistryKeyProperty rkp = (RegistryKeyProperty) event.getNewValue();
                dBLookupMediator.setRegistryBasedPassConfigKey(rkp);
            } else {
                dBLookupMediator.setRegistryBasedPassConfigKey(EsbFactoryImpl.eINSTANCE.createRegistryKeyProperty());
            }
            // End of user code
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Misc.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionType))
                basePart.setConnectionType((SqlExecutorConnectionType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDsType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionDsType))
                basePart.setConnectionDsType((SqlExecutorDatasourceType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDbType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionDbType))
                basePart.setConnectionDbType((SqlDatabaseType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDbDriver().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionDbDriver)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDsInitialContext()
                    .equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionDsInitialContext)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDsName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionDsName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionURL().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionURL)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionUsername().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionUsername)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionPassword().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.connectionPassword)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyAutocommit().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyAutocommit))
                basePart.setPropertyAutocommit((SqlExecutorBooleanValue) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyIsolation().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyIsolation))
                basePart.setPropertyIsolation((SqlExecutorIsolationLevel) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyMaxactive().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyMaxactive)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyMaxidle().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyMaxidle)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyMaxopenstatements().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyMaxopenstatements)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyMaxwait().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyMaxwait)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyMinidle().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyMinidle)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyPoolstatements().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyPoolstatements))
                basePart.setPropertyPoolstatements((SqlExecutorBooleanValue) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyTestonborrow().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyTestonborrow))
                basePart.setPropertyTestonborrow((SqlExecutorBooleanValue) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyTestwhileidle().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyTestwhileidle))
                basePart.setPropertyTestwhileidle((SqlExecutorBooleanValue) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyValidationquery().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyValidationquery)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyInitialsize().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Properties.propertyInitialsize)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_SqlStatements().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Statements.sqlStatements))
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_IsRegistryBasedDriverConfig()
                    .equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedDriverConfig))
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_IsRegistryBasedUrlConfig().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedUrlConfig))
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_IsRegistryBasedUserConfig().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedUserConfig))
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_IsRegistryBasedPassConfig().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedPassConfig))
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_RegistryBasedDriverConfigKey()
                    .equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.registryBasedDriverConfigKey)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_RegistryBasedUrlConfigKey().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.registryBasedUrlConfigKey)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_RegistryBasedUserConfigKey()
                    .equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.registryBasedUserConfigKey)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_RegistryBasedPassConfigKey()
                    .equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBLookupMediator.Connection.registryBasedPassConfigKey)) {
                if (msg.getNewValue() != null) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.DBLookupMediator.Connection.connectionType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_ConnectionType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionType().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Connection.connectionDsType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_ConnectionDsType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDsType().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Connection.connectionDbType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_ConnectionDbType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDbType().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Connection.connectionDbDriver == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_ConnectionDbDriver().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractSqlExecutorMediator_ConnectionDbDriver().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Connection.connectionDsInitialContext == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_ConnectionDsInitialContext().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractSqlExecutorMediator_ConnectionDsInitialContext().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Connection.connectionDsName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_ConnectionDsName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDsName().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Connection.connectionURL == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionURL().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionURL().getEAttributeType(),
                ...
                if (EsbViewsRepository.DBLookupMediator.Connection.connectionUsername == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_ConnectionUsername().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractSqlExecutorMediator_ConnectionUsername().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Connection.connectionPassword == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_ConnectionPassword().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractSqlExecutorMediator_ConnectionPassword().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Properties.propertyAutocommit == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_PropertyAutocommit().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractSqlExecutorMediator_PropertyAutocommit().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Properties.propertyIsolation == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_PropertyIsolation().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyIsolation().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Properties.propertyMaxactive == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_PropertyMaxactive().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyMaxactive().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Properties.propertyMaxidle == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_PropertyMaxidle().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyMaxidle().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Properties.propertyMaxopenstatements == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_PropertyMaxopenstatements().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractSqlExecutorMediator_PropertyMaxopenstatements().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Properties.propertyMaxwait == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_PropertyMaxwait().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyMaxwait().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Properties.propertyMinidle == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_PropertyMinidle().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyMinidle().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Properties.propertyPoolstatements == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_PropertyPoolstatements().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractSqlExecutorMediator_PropertyPoolstatements().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Properties.propertyTestonborrow == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_PropertyTestonborrow().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractSqlExecutorMediator_PropertyTestonborrow().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Properties.propertyTestwhileidle == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_PropertyTestwhileidle().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractSqlExecutorMediator_PropertyTestwhileidle().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Properties.propertyValidationquery == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_PropertyValidationquery().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractSqlExecutorMediator_PropertyValidationquery().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Properties.propertyInitialsize == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAbstractSqlExecutorMediator_PropertyInitialsize().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getAbstractSqlExecutorMediator_PropertyInitialsize().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.DBLookupMediator.Connection.databaseConfiguration == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                ...
                if (EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedDriverConfig == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                ...
                if (EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedUrlConfig == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                ...
                if (EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedUserConfig == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                ...
                if (EsbViewsRepository.DBLookupMediator.Connection.isRegistryBasedPassConfig == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
