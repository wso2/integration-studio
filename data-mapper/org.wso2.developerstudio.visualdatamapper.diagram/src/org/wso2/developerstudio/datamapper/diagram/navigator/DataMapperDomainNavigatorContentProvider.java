...
public class DataMapperDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	public DataMapperDomainNavigatorContentProvider() {
		myAdapterFctoryContentProvier = new AdapterFactoryContentProvider(DataMapperDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory());
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof DataMapperDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(((DataMapperDomainNavigatorItem) parentElement).getEObject()), parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new DataMapperDomainNavigatorItem((EObject) objects[i], parentElement, myAdapterFctoryContentProvier));
			}
		}
