...
public class ExcelQueryItemProvider extends ItemProviderAdapter implements
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DsPackage.Literals.EXCEL_QUERY__MIXED,
		...
		newChildDescriptors.add(createChildParameter(DsPackage.Literals.EXCEL_QUERY__MIXED,
		                                             FeatureMapUtil.createEntry(DsPackage.Literals.EXCEL_QUERY__WORKBOOKNAME,
		                                                                        DsFactory.eINSTANCE.createWorkBookName())));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.EXCEL_QUERY__MIXED,
		                                             FeatureMapUtil.createEntry(DsPackage.Literals.EXCEL_QUERY__HASHEADER,
		                                                                        DsFactory.eINSTANCE.createHasHeader())));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.EXCEL_QUERY__MIXED,
		                                             FeatureMapUtil.createEntry(DsPackage.Literals.EXCEL_QUERY__STARTINGROW,
		                                                                        DsFactory.eINSTANCE.createStartingRow())));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.EXCEL_QUERY__MIXED,
		                                             FeatureMapUtil.createEntry(DsPackage.Literals.EXCEL_QUERY__MAXROWCOUNT,
		                                                                        DsFactory.eINSTANCE.createMaxRowCount())));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.EXCEL_QUERY__WORKBOOKNAME,
		                                             DsFactory.eINSTANCE.createWorkBookName()));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.EXCEL_QUERY__HASHEADER,
		                                             DsFactory.eINSTANCE.createHasHeader()));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.EXCEL_QUERY__STARTINGROW,
		                                             DsFactory.eINSTANCE.createStartingRow()));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.EXCEL_QUERY__MAXROWCOUNT,
		                                             DsFactory.eINSTANCE.createMaxRowCount()));
	}
