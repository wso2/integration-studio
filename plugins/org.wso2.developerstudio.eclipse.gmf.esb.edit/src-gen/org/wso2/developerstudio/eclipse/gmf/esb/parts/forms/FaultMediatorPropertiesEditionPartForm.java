 ...
 * 
 */
public class FaultMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, FaultMediatorPropertiesEditionPart {
     ...
     */
    public FaultMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.FaultMediator.Properties.description,
                EsbMessages.FaultMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.FaultMediator.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FaultMediatorPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control descriptionHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.FaultMediator.Properties.description, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.FaultMediator.Properties.commentsList,
                        EsbMessages.FaultMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "FaultMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.FaultMediator.Properties.reverse,
                EsbMessages.FaultMediatorPropertiesEditionPart_ReverseLabel), SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FaultMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.FaultMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSoapVersionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control soapVersionLabel = createDescription(parent, EsbViewsRepository.FaultMediator.Properties.soapVersion,
                EsbMessages.FaultMediatorPropertiesEditionPart_SoapVersionLabel);
        ...
        soapVersion.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FaultMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.FaultMediator.Properties.soapVersion,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getSoapVersion()));
            }

        });
        soapVersion.setID(EsbViewsRepository.FaultMediator.Properties.soapVersion);
        Control soapVersionHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.FaultMediator.Properties.soapVersion, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createSerializeResponseCheckbox(FormToolkit widgetFactory, Composite parent) {
        serializeResponse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.FaultMediator.Properties.serializeResponse,
                        EsbMessages.FaultMediatorPropertiesEditionPart_SerializeResponseLabel),
                SWT.CHECK);
        serializeResponse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FaultMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.FaultMediator.Properties.serializeResponse,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(serializeResponse.getSelection())));
            }
        ...
        Control serializeResponseHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.FaultMediator.Properties.serializeResponse,
    ...
    protected Composite createMarkAsResponseCheckbox(FormToolkit widgetFactory, Composite parent) {
        markAsResponse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.FaultMediator.Properties.markAsResponse,
                        EsbMessages.FaultMediatorPropertiesEditionPart_MarkAsResponseLabel),
                SWT.CHECK);
        markAsResponse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.markAsResponse, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new Boolean(markAsResponse.getSelection())));
            }
        ...
        Control markAsResponseHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.FaultMediator.Properties.markAsResponse,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createFaultCodeSoap11EMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control faultCodeSoapLabel = createDescription(parent,
                EsbViewsRepository.FaultMediator.Properties.faultCodeSoap11,
                EsbMessages.FaultMediatorPropertiesEditionPart_FaultCodeSoap11Label);
        ...
        faultCodeSoap11.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.faultCodeSoap11, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getFaultCodeSoap11()));
            }

        });
        faultCodeSoap11.setID(EsbViewsRepository.FaultMediator.Properties.faultCodeSoap11);
        Control faultCodeSoapHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.FaultMediator.Properties.faultCodeSoap11,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        ...
        faultCodeType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.faultCodeType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getFaultCodeType()));
            }

        });
        faultCodeType.setID(EsbViewsRepository.FaultMediator.Properties.faultCodeType);
        Control faultCodeTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.FaultMediator.Properties.faultCodeType,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        ...
        faultStringType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.faultStringType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getFaultStringType()));
            }

        });
        faultStringType.setID(EsbViewsRepository.FaultMediator.Properties.faultStringType);
        Control faultStringTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.FaultMediator.Properties.faultStringType,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createFaultStringTypeEMFComboViewer
        faultStringTypeElements = new Control[] { faultStringTypeLabel, faultStringTypeHelp,
                faultStringType.getCombo() };
        faultStringType.addSelectionChangedListener(new ISelectionChangedListener() {
    ...
    protected Composite createFaultStringValueText(FormToolkit widgetFactory, Composite parent) {
        ...
        faultStringValue.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.faultStringValue, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, faultStringValue.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FaultMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.FaultMediator.Properties.faultStringValue,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    faultStringValue.getText()));
                }
            }
        ...
        Control faultStringValueHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.FaultMediator.Properties.faultStringValue,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createFaultActorText(FormToolkit widgetFactory, Composite parent) {
        Control faultActorLabel = createDescription(parent, EsbViewsRepository.FaultMediator.Properties.faultActor,
                EsbMessages.FaultMediatorPropertiesEditionPart_FaultActorLabel);
        ...
        faultActor.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.faultActor, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, faultActor.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FaultMediatorPropertiesEditionPartForm.this,
        ...
        Control faultActorHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.FaultMediator.Properties.faultActor, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createFaultCodeSoap12EMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control faultCodeSoap12Label = createDescription(parent,
                EsbViewsRepository.FaultMediator.Properties.faultCodeSoap12,
                EsbMessages.FaultMediatorPropertiesEditionPart_FaultCodeSoap12Label);
        ...
        faultCodeSoap12.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.faultCodeSoap12, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getFaultCodeSoap12()));
            }

        });
        faultCodeSoap12.setID(EsbViewsRepository.FaultMediator.Properties.faultCodeSoap12);
        Control faultCodeSoap12Help = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.FaultMediator.Properties.faultCodeSoap12,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createFaultCodeSoap12EMFComboViewer
        faultCodeSoap12Elements = new Control[] { faultCodeSoap12Label, faultCodeSoap12Help,
                faultCodeSoap12.getCombo() };
        // End of user code
        return parent;
    }
    ...
    protected Composite createFaultReasonTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        filterReasonSubPropertiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent, "Reason",
                true);
        ...
        faultReasonType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.faultReasonType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getFaultReasonType()));
            }

        });
        faultReasonType.setID(EsbViewsRepository.FaultMediator.Properties.faultReasonType);
        Control faultReasonTypeHelp = FormUtils.createHelpButton(widgetFactory, filterReasonSubPropertiesGroup,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.FaultMediator.Properties.faultReasonType,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createFaultReasonTypeEMFComboViewer
        faultReasonTypeElements = new Control[] { faultReasonTypeLabel, faultReasonTypeHelp,
                faultReasonType.getCombo() };
        faultReasonType.addSelectionChangedListener(new ISelectionChangedListener() {
    ...
    protected Composite createFaultReasonValueText(FormToolkit widgetFactory, Composite parent) {
        ...
        faultReasonValue.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.faultReasonValue, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, faultReasonValue.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FaultMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.FaultMediator.Properties.faultReasonValue,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    faultReasonValue.getText()));
                }
            }
        ...
        Control faultReasonValueHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.FaultMediator.Properties.faultReasonValue,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRoleNameText(FormToolkit widgetFactory, Composite parent) {
        Control roleNameLabel = createDescription(parent, EsbViewsRepository.FaultMediator.Properties.roleName,
                EsbMessages.FaultMediatorPropertiesEditionPart_RoleNameLabel);
        ...
        roleName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FaultMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.FaultMediator.Properties.roleName, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, roleName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.roleName, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, roleName.getText()));
                }
            }
        ...
        Control roleNameHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.FaultMediator.Properties.roleName, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createNodeNameText(FormToolkit widgetFactory, Composite parent) {
        Control nodeNameLabel = createDescription(parent, EsbViewsRepository.FaultMediator.Properties.nodeName,
                EsbMessages.FaultMediatorPropertiesEditionPart_NodeNameLabel);
        ...
        nodeName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FaultMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.FaultMediator.Properties.nodeName, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, nodeName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.nodeName, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, nodeName.getText()));
                }
            }
        ...
        Control nodeNameHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.FaultMediator.Properties.nodeName, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createFaultDetailTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        filterDetailSubPropertiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent, "Detail",
                true);
        ...
        faultDetailType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.faultDetailType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getFaultDetailType()));
            }

        });
        faultDetailType.setID(EsbViewsRepository.FaultMediator.Properties.faultDetailType);
        Control faultDetailTypeHelp = FormUtils.createHelpButton(widgetFactory, filterDetailSubPropertiesGroup,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.FaultMediator.Properties.faultDetailType,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createFaultDetailTypeEMFComboViewer
        faultDetailTypeElements = new Control[] { faultDetailTypeLabel, faultDetailTypeHelp,
                faultDetailType.getCombo() };
        faultDetailType.addSelectionChangedListener(new ISelectionChangedListener() {
    ...
    protected Composite createFaultDetailValueText(FormToolkit widgetFactory, Composite parent) {
        ...
        faultDetailValue.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.faultDetailValue, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, faultDetailValue.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FaultMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.FaultMediator.Properties.faultDetailValue,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    faultDetailValue.getText()));
                }
            }
        ...
        Control FaultDetailValueHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.FaultMediator.Properties.faultDetailValue,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#initSoapVersion(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setSoapVersion(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setSerializeResponse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setMarkAsResponse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#initFaultCodeSoap11(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setFaultCodeSoap11(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#initFaultCodeType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setFaultCodeType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#initFaultStringType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setFaultStringType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setFaultStringValue(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setFaultActor(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#initFaultCodeSoap12(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setFaultCodeSoap12(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#initFaultReasonType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setFaultReasonType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setFaultReasonValue(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setRoleName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setNodeName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#initFaultDetailType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setFaultDetailType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FaultMediatorPropertiesEditionPart#setFaultDetailValue(String
     *      newValue)
     * 
     */
    ...
    protected Composite createFaultDetailExpressionText(FormToolkit widgetFactory, final Composite parent) {
        ...
        faultDetailExpressionText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        FaultMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.FaultMediator.Properties.faultDetailExpression,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getFaultDetailExpression()));
            }
        ...
        EditingUtils.setID(faultDetailExpressionText,
                EsbViewsRepository.FaultMediator.Properties.faultDetailExpression);
    ...
    protected Composite createFaultReasonExpressionText(FormToolkit widgetFactory, final Composite parent) {
        ...
        faultReasonExpressionText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        FaultMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.FaultMediator.Properties.faultReasonExpression,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getFaultReasonExpression()));
            }
        ...
        EditingUtils.setID(faultReasonExpressionText,
                EsbViewsRepository.FaultMediator.Properties.faultReasonExpression);
    ...
    protected Composite createFaultStringExpressionText(FormToolkit widgetFactory, final Composite parent) {
        ...
        faultStringExpressionText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        FaultMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.FaultMediator.Properties.faultStringExpression,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getFaultStringExpression()));
            }
        ...
        EditingUtils.setID(faultStringExpressionText,
                EsbViewsRepository.FaultMediator.Properties.faultStringExpression);
        ...
        faultCodeExpressionText.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.FaultMediator.Properties.faultCodeExpression,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getFaultCodeExpression()));
                }
            }
