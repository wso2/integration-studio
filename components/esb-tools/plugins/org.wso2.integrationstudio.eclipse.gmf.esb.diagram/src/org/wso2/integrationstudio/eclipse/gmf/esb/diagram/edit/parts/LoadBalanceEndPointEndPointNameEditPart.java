 ...
 * @generated
 */
public class LoadBalanceEndPointEndPointNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
        ...
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.LoadBalanceEndPoint_3613, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.LoadBalanceEndPointEndPointNameEditPart.VISUAL_ID));
        }
        return parser;
    }
