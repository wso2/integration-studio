 ...
 * 
 */
public class CacheMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, CacheMediatorPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        cacheMediatorStep.addStep(EsbViewsRepository.CacheMediator.Type.class)
        ...
        CompositionStep implementationStep = cacheMediatorStep
    ...
    protected Composite createCacheMediatorImplementationEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Type.cacheMediatorImplementation,
                EsbMessages.CacheMediatorPropertiesEditionPart_CacheMediatorImplementationLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CacheMediatorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.CacheMediator.Type.cacheMediatorImplementation,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    getCacheMediatorImplementation()));
            }
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CacheMediator.Type.cacheMediatorImplementation, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createIdText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Properties.id,
                EsbMessages.CacheMediatorPropertiesEditionPart_IdLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CacheMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.CacheMediator.Properties.id,
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(CacheMediatorPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.CacheMediator.Properties.id, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CacheMediator.Properties.id, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCacheTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Properties.cacheType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CacheMediator.Properties.cacheType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createScopeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Properties.scope,
                EsbMessages.CacheMediatorPropertiesEditionPart_ScopeLabel);
        ...
        scope.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CacheMediatorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.CacheMediator.Properties.scope, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getScope()));
            }

        });
        scope.setID(EsbViewsRepository.CacheMediator.Properties.scope);
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CacheMediator.Properties.scope, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createHashGeneratorAttributeText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Properties.hashGeneratorAttribute,
                EsbMessages.CacheMediatorPropertiesEditionPart_HashGeneratorAttributeLabel);
                ...
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CacheMediatorPropertiesEditionPartImpl.this,
                                    ...
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    hashGeneratorAttribute.getText()));
            }
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CacheMediator.Properties.hashGeneratorAttribute, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCacheTimeoutText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Properties.cacheTimeout,
        ...
        cacheTimeout.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CacheMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CacheMediator.Properties.cacheTimeout, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMaxMessageSizeText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Properties.maxMessageSize,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CacheMediator.Properties.maxMessageSize, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.CacheMediator.Properties.commentsList,
                EsbMessages.CacheMediatorPropertiesEditionPart_CommentsListLabel));
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "CacheMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CacheMediatorPropertiesEditionPartImpl.this,
                            EsbViewsRepository.CacheMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.CacheMediator.Properties.reverse,
                EsbMessages.CacheMediatorPropertiesEditionPart_ReverseLabel));
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CacheMediatorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.CacheMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CacheMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMaxEntryCountText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Implementation.maxEntryCount,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CacheMediator.Implementation.maxEntryCount, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createImplementationTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Implementation.implementationType,
                EsbMessages.CacheMediatorPropertiesEditionPart_ImplementationTypeLabel);
        ...
        implementationType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CacheMediatorPropertiesEditionPartImpl.this,
                            EsbViewsRepository.CacheMediator.Implementation.implementationType,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getImplementationType()));
            }

        });
        implementationType.setID(EsbViewsRepository.CacheMediator.Implementation.implementationType);
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CacheMediator.Implementation.implementationType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSequenceTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.OnCacheHit.sequenceType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CacheMediator.OnCacheHit.sequenceType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCacheProtocolTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Protocol.cacheProtocolType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CacheMediator.Protocol.cacheProtocolType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCacheProtocolMethodsText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Protocol.cacheProtocolMethods,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CacheMediator.Protocol.cacheProtocolMethods, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createHeadersToExcludeInHashText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Protocol.headersToExcludeInHash,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CacheMediator.Protocol.headersToExcludeInHash, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createResponseCodesText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Protocol.responseCodes,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CacheMediator.Protocol.responseCodes, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEnableCacheControlCheckbox(Composite parent) {
        ...
        enableCacheControl.setText(getDescription(EsbViewsRepository.CacheMediator.Protocol.enableCacheControl,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CacheMediator.Protocol.enableCacheControl, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createIncludeAgeHeaderCheckbox(Composite parent) {
        ...
        includeAgeHeader.setText(getDescription(EsbViewsRepository.CacheMediator.Protocol.includeAgeHeader,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CacheMediator.Protocol.includeAgeHeader, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createHashGeneratorText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Protocol.hashGenerator,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CacheMediator.Protocol.hashGenerator, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CacheMediator.Misc.description,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CacheMediator.Misc.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    public Enumerator getCacheMediatorImplementation() {
        Enumerator selection = (Enumerator) ((StructuredSelection) cacheMediatorImplementation.getSelection())
                .getFirstElement();
        return selection;
    }
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CacheMediatorPropertiesEditionPart#initCacheMediatorImplementation(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CacheMediatorPropertiesEditionPart#setCacheMediatorImplementation(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CacheMediatorPropertiesEditionPart#initScope(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CacheMediatorPropertiesEditionPart#setScope(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CacheMediatorPropertiesEditionPart#setHashGeneratorAttribute(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CacheMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CacheMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CacheMediatorPropertiesEditionPart#initImplementationType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CacheMediatorPropertiesEditionPart#setImplementationType(Enumerator
     *      newValue)
     * 
     */
