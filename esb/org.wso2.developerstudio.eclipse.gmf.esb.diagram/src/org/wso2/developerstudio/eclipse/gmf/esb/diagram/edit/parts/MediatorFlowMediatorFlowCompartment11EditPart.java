...
public void connectNormally(EditPart child) {
	...
	private CloneMediatorTargetOutputConnectorEditPart getCloneMediatorTargetOutputConnector(
		...
		CloneMediatorContainerEditPart cloneMediatorContainerEditPart  = (CloneMediatorContainerEditPart)this.getParent().getParent().getParent();
		...
		if(children.get(i) instanceof CloneMediatorTargetOutputConnectorEditPart){
			...
			CloneMediatorTargetOutputConnectorEditPart cloneMediatorTargetOutputConnectorEditPart = (CloneMediatorTargetOutputConnectorEditPart) children.get(i);
		...
		CloneMediatorTargetOutputConnectorEditPart relevantTargetOutputConnector = targetOutputConnectorList.get(targetIndex);
