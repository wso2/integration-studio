...
public class EEFNameSpacedPropertyEditorDialog extends Dialog {
    ...
    public static void main(String[] args) {
        ...
        EEFNameSpacedPropertyEditorDialog dialog = new EEFNameSpacedPropertyEditorDialog(shell, SWT.NULL,
    ...
    private void initActions() {
        selectXpathButton.addListener(SWT.Selection, new Listener() {
            public void handleEvent(Event event) {
                EEFXpathSelectorDialog xpathEditorDialog = new EEFXpathSelectorDialog(dialogShell);
        ...
        okButton.addListener(SWT.Selection, new Listener() {
            public void handleEvent(Event event) {
                if (EEFXpathValidator.isValidConfiguration(dialogShell, propertyTextField.getText(),
                        collectedNamespaces)) {
                    try {
                        saveConfiguration();
                        setSaved(true);
