 ...
 * 
 */
public class CallTemplateMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, CallTemplateMediatorPropertiesEditionPart {
     ...
     */
    public CallTemplateMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = callTemplateMediatorStep
                .addStep(EsbViewsRepository.CallTemplateMediator.Properties.class);
        // Start of user code
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        ...
        createDescription(parent, EsbViewsRepository.CallTemplateMediator.Properties.description,
                EsbMessages.CallTemplateMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CallTemplateMediatorPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CallTemplateMediator.Properties.description, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.CallTemplateMediator.Properties.commentsList,
                        EsbMessages.CallTemplateMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(),
                        "CallTemplateMediator", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CallTemplateMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CallTemplateMediator.Properties.commentsList,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.CallTemplateMediator.Properties.reverse,
                        EsbMessages.CallTemplateMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CallTemplateMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.CallTemplateMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        Control reverseHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.CallTemplateMediator.Properties.reverse,
    ...
    protected Composite createAvailableTemplatesText(FormToolkit widgetFactory, Composite parent) {
        Control availableTemplatesLabel = createDescription(parent,
                EsbViewsRepository.CallTemplateMediator.Properties.availableTemplates,
                EsbMessages.CallTemplateMediatorPropertiesEditionPart_AvailableTemplatesLabel);
        ...
        String[] availableTemplateNameList = Arrays.copyOf(availableTemplateList, availableTemplateList.length,
                String[].class);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CallTemplateMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.CallTemplateMediator.Properties.availableTemplates,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getAvailableTemplates()));
            }

        });
        availableTemplates.setID(EsbViewsRepository.CallTemplateMediator.Properties.availableTemplates);
        Control availableTemplatesHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CallTemplateMediator.Properties.availableTemplates,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createAvailableTemplatesText
        availableTemplatesElements = new Control[] { availableTemplatesLabel, availableTemplates.getCombo(),
                availableTemplatesHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createTemplateParametersTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.templateParameters = new ReferencesTable(
                getDescription(EsbViewsRepository.CallTemplateMediator.Properties.templateParameters,
                        EsbMessages.CallTemplateMediatorPropertiesEditionPart_TemplateParametersLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(CallTemplateMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.CallTemplateMediator.Properties.templateParameters,
        ...
        this.templateParameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CallTemplateMediator.Properties.templateParameters, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createTargetTemplateText(FormToolkit widgetFactory, Composite parent) {
        Control targeTemplateLabel = createDescription(parent,
                EsbViewsRepository.CallTemplateMediator.Properties.targetTemplate,
                EsbMessages.CallTemplateMediatorPropertiesEditionPart_TargetTemplateLabel);
        ...
        Control targeTemplateHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CallTemplateMediator.Properties.targetTemplate,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateMediatorPropertiesEditionPart#setAvailableTemplates(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateMediatorPropertiesEditionPart#initTemplateParameters(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateMediatorPropertiesEditionPart#addFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateMediatorPropertiesEditionPart#addBusinessFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateMediatorPropertiesEditionPart#isContainedInTemplateParametersTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateMediatorPropertiesEditionPart#setTargetTemplate(String
     *      newValue)
     * 
     */
