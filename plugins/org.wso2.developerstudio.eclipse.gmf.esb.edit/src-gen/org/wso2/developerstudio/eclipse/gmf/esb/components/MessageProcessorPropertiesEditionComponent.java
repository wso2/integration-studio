...
public class MessageProcessorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public MessageProcessorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject messageProcessor,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessor.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.processorName))
                basePart.setProcessorName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessor.getProcessorName()));

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.processorType)) {
                basePart.initProcessorType(
                        EEFUtils.choiceOfValues(messageProcessor,
                                EsbPackage.eINSTANCE.getMessageProcessor_ProcessorType()),
                        messageProcessor.getProcessorType());
            }
            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.messageProcessorProvider))
                basePart.setMessageProcessorProvider(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessor.getMessageProcessorProvider()));
            ...
            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.messageStore))
                basePart.setMessageStore(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessor.getMessageStore()));

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.sourceMessageStore))
                basePart.setSourceMessageStore(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessor.getSourceMessageStore()));

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.targetMessageStore))
                basePart.setTargetMessageStore(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessor.getTargetMessageStore()));

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.processorState)) {
                basePart.initProcessorState(
                        EEFUtils.choiceOfValues(messageProcessor,
                                EsbPackage.eINSTANCE.getMessageProcessor_ProcessorState()),
                        messageProcessor.getProcessorState());
            }
            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.retryInterval)) {
                basePart.setRetryInterval(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        messageProcessor.getRetryInterval()));
            }

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.forwardingInterval)) {
                basePart.setForwardingInterval(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        messageProcessor.getForwardingInterval()));
            }

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.samplingInterval)) {
                basePart.setSamplingInterval(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        messageProcessor.getSamplingInterval()));
            }

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.samplingConcurrency)) {
                basePart.setSamplingConcurrency(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        messageProcessor.getSamplingConcurrency()));
            }

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.maxDeliveryAttempts)) {
                basePart.setMaxDeliveryAttempts(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        messageProcessor.getMaxDeliveryAttempts()));
            }

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.dropMessageAfterMaximumDeliveryAttempts)) {
                basePart.initDropMessageAfterMaximumDeliveryAttempts(
                        EEFUtils.choiceOfValues(messageProcessor,
                                EsbPackage.eINSTANCE.getMessageProcessor_DropMessageAfterMaximumDeliveryAttempts()),
                        messageProcessor.getDropMessageAfterMaximumDeliveryAttempts());
            }
            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.axis2ClientRepository))
                basePart.setAxis2ClientRepository(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessor.getAxis2ClientRepository()));

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.axis2Configuration))
                basePart.setAxis2Configuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessor.getAxis2Configuration()));

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.quartzConfigFilePath))
                basePart.setQuartzConfigFilePath(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessor.getQuartzConfigFilePath()));

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.cronExpression))
                basePart.setCronExpression(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessor.getCronExpression()));

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.nonRetryHttpStatusCodes))
                basePart.setNonRetryHttpStatusCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessor.getNonRetryHttpStatusCodes()));

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.parameters)) {
                parametersSettings = new ReferencesTableSettings(messageProcessor,
            ...
            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.taskCount))
                basePart.setTaskCount(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessor.getTaskCount()));

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.maxStoreConnectionAttempts)) {
                basePart.setMaxStoreConnectionAttempts(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        messageProcessor.getMaxStoreConnectionAttempts()));
            }

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.storeConnectionInterval)) {
                basePart.setStoreConnectionInterval(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        messageProcessor.getStoreConnectionInterval()));
            }

            if (isAccessible(EsbViewsRepository.MessageProcessor.Properties.failMessagesStore))
                basePart.setFailMessagesStore(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessor.getFailMessagesStore()));
                ...
                basePart.addFilterToParameters(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof MessageProcessorParameter);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.MessageProcessor.Properties.description == event.getAffectedEditor()) {
            messageProcessor.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.MessageProcessor.Properties.processorName == event.getAffectedEditor()) {
            messageProcessor.setProcessorName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.MessageProcessor.Properties.messageProcessorProvider == event.getAffectedEditor()) {
            messageProcessor.setMessageProcessorProvider((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageProcessor.Properties.messageStore == event.getAffectedEditor()) {
            messageProcessor.setMessageStore((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageProcessor.Properties.sourceMessageStore == event.getAffectedEditor()) {
            messageProcessor.setSourceMessageStore((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageProcessor.Properties.targetMessageStore == event.getAffectedEditor()) {
            messageProcessor.setTargetMessageStore((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.MessageProcessor.Properties.retryInterval == event.getAffectedEditor()) {
            messageProcessor.setRetryInterval(
        ...
        if (EsbViewsRepository.MessageProcessor.Properties.maxDeliveryAttempts == event.getAffectedEditor()) {
            messageProcessor.setMaxDeliveryAttempts(
                    (EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String) event.getNewValue())));
        }
        if (EsbViewsRepository.MessageProcessor.Properties.dropMessageAfterMaximumDeliveryAttempts == event
                .getAffectedEditor()) {
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_ProcessorName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.processorName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_ProcessorType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.processorType))
                basePart.setProcessorType((MessageProcessorType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getMessageProcessor_MessageProcessorProvider().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.messageProcessorProvider)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_MessageStore().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.messageStore)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_SourceMessageStore().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.sourceMessageStore)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_TargetMessageStore().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.targetMessageStore)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_ProcessorState().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.processorState))
                basePart.setProcessorState((ProcessorState) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getMessageProcessor_RetryInterval().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.retryInterval)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_ForwardingInterval().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.forwardingInterval)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_SamplingInterval().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.samplingInterval)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_SamplingConcurrency().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.samplingConcurrency)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_MaxDeliveryAttempts().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.maxDeliveryAttempts)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_DropMessageAfterMaximumDeliveryAttempts()
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_Axis2ClientRepository().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.axis2ClientRepository)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_Axis2Configuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.axis2Configuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_QuartzConfigFilePath().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.quartzConfigFilePath)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_CronExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.cronExpression)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_NonRetryHttpStatusCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.nonRetryHttpStatusCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_Parameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.parameters))
                basePart.updateParameters();
            if (EsbPackage.eINSTANCE.getMessageProcessor_TaskCount().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.taskCount)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_MaxStoreConnectionAttempts().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.maxStoreConnectionAttempts)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_StoreConnectionInterval().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.storeConnectionInterval)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessor_FailMessagesStore().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessor.Properties.failMessagesStore)) {
                if (msg.getNewValue() != null) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.MessageProcessor.Properties.processorName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_ProcessorName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_ProcessorName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageProcessor.Properties.processorType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_ProcessorType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_ProcessorType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageProcessor.Properties.messageProcessorProvider == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_MessageProcessorProvider().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_MessageProcessorProvider().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageProcessor.Properties.messageStore == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_MessageStore().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_MessageStore().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageProcessor.Properties.sourceMessageStore == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_SourceMessageStore().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_SourceMessageStore().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageProcessor.Properties.targetMessageStore == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_TargetMessageStore().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_TargetMessageStore().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageProcessor.Properties.processorState == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_ProcessorState().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_ProcessorState().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageProcessor.Properties.retryInterval == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_RetryInterval().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_RetryInterval().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageProcessor.Properties.forwardingInterval == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_ForwardingInterval().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_ForwardingInterval().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageProcessor.Properties.samplingInterval == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_SamplingInterval().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_SamplingInterval().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageProcessor.Properties.samplingConcurrency == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_SamplingConcurrency().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_SamplingConcurrency().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageProcessor.Properties.maxDeliveryAttempts == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_MaxDeliveryAttempts().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_MaxDeliveryAttempts().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageProcessor.Properties.dropMessageAfterMaximumDeliveryAttempts == event
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getMessageProcessor_DropMessageAfterMaximumDeliveryAttempts().getEAttributeType(),
                                (String) newValue);
                    }
                ...
                if (EsbViewsRepository.MessageProcessor.Properties.axis2ClientRepository == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_Axis2ClientRepository().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_Axis2ClientRepository().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageProcessor.Properties.axis2Configuration == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_Axis2Configuration().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_Axis2Configuration().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageProcessor.Properties.quartzConfigFilePath == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_QuartzConfigFilePath().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_QuartzConfigFilePath().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageProcessor.Properties.cronExpression == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_CronExpression().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_CronExpression().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageProcessor.Properties.nonRetryHttpStatusCodes == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_NonRetryHttpStatusCodes().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_NonRetryHttpStatusCodes().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageProcessor.Properties.taskCount == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_TaskCount().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_TaskCount().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageProcessor.Properties.maxStoreConnectionAttempts == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getMessageProcessor_MaxStoreConnectionAttempts().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_MaxStoreConnectionAttempts().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.MessageProcessor.Properties.storeConnectionInterval == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_StoreConnectionInterval().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_StoreConnectionInterval().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageProcessor.Properties.failMessagesStore == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessor_FailMessagesStore().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessor_FailMessagesStore().getEAttributeType(), newValue);
                }
