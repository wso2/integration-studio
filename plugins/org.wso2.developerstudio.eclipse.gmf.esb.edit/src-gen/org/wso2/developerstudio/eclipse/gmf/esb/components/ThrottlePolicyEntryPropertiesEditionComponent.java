...
public class ThrottlePolicyEntryPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ThrottlePolicyEntryPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject throttlePolicyEntry, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleType)) {
                basePart.initThrottleType(
                        EEFUtils.choiceOfValues(throttlePolicyEntry,
                                EsbPackage.eINSTANCE.getThrottlePolicyEntry_ThrottleType()),
                        throttlePolicyEntry.getThrottleType());
            }
            if (isAccessible(EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleRange))
                basePart.setThrottleRange(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        throttlePolicyEntry.getThrottleRange()));

            if (isAccessible(EsbViewsRepository.ThrottlePolicyEntry.Properties.accessType)) {
                basePart.initAccessType(
                        EEFUtils.choiceOfValues(throttlePolicyEntry,
                                EsbPackage.eINSTANCE.getThrottlePolicyEntry_AccessType()),
                        throttlePolicyEntry.getAccessType());
            }
            if (isAccessible(EsbViewsRepository.ThrottlePolicyEntry.Properties.maxRequestCount)) {
                basePart.setMaxRequestCount(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        throttlePolicyEntry.getMaxRequestCount()));
            }

            if (isAccessible(EsbViewsRepository.ThrottlePolicyEntry.Properties.unitTime)) {
                basePart.setUnitTime(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        throttlePolicyEntry.getUnitTime()));
            }

            if (isAccessible(EsbViewsRepository.ThrottlePolicyEntry.Properties.prohibitPeriod)) {
                basePart.setProhibitPeriod(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        throttlePolicyEntry.getProhibitPeriod()));
            }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleRange == event.getAffectedEditor()) {
            throttlePolicyEntry.setThrottleRange((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.ThrottlePolicyEntry.Properties.maxRequestCount == event.getAffectedEditor()) {
            throttlePolicyEntry.setMaxRequestCount(
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getThrottlePolicyEntry_ThrottleType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleType))
                basePart.setThrottleType((ThrottleConditionType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getThrottlePolicyEntry_ThrottleRange().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleRange)) {
            ...
            if (EsbPackage.eINSTANCE.getThrottlePolicyEntry_AccessType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ThrottlePolicyEntry.Properties.accessType))
                basePart.setAccessType((ThrottleAccessType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getThrottlePolicyEntry_MaxRequestCount().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ThrottlePolicyEntry.Properties.maxRequestCount)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getThrottlePolicyEntry_UnitTime().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ThrottlePolicyEntry.Properties.unitTime)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getThrottlePolicyEntry_ProhibitPeriod().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ThrottlePolicyEntry.Properties.prohibitPeriod)) {
                if (msg.getNewValue() != null) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getThrottlePolicyEntry_ThrottleType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getThrottlePolicyEntry_ThrottleType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleRange == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getThrottlePolicyEntry_ThrottleRange().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getThrottlePolicyEntry_ThrottleRange().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ThrottlePolicyEntry.Properties.accessType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getThrottlePolicyEntry_AccessType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getThrottlePolicyEntry_AccessType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ThrottlePolicyEntry.Properties.maxRequestCount == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getThrottlePolicyEntry_MaxRequestCount().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getThrottlePolicyEntry_MaxRequestCount().getEAttributeType(),
                ...
                if (EsbViewsRepository.ThrottlePolicyEntry.Properties.unitTime == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getThrottlePolicyEntry_UnitTime().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getThrottlePolicyEntry_UnitTime().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ThrottlePolicyEntry.Properties.prohibitPeriod == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getThrottlePolicyEntry_ProhibitPeriod().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getThrottlePolicyEntry_ProhibitPeriod().getEAttributeType(), newValue);
                }
