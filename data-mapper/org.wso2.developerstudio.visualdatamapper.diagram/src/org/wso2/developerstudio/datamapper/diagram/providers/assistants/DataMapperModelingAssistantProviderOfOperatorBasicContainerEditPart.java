 ...
 * @generated
 */
public class DataMapperModelingAssistantProviderOfOperatorBasicContainerEditPart extends DataMapperModelingAssistantProvider {
	...
	public List<IElementType> getTypesForPopupBar(IAdaptable host) {
		...
		types.add(DataMapperElementTypes.OperatorLeftContainer_3013);
		types.add(DataMapperElementTypes.OperatorRightContainer_3016);
		return types;
	}
