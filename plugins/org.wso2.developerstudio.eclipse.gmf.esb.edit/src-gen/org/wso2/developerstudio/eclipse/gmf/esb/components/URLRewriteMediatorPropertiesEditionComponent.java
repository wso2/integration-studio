...
public class URLRewriteMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public URLRewriteMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject uRLRewriteMediator, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.URLRewriteMediator.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        uRLRewriteMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.URLRewriteMediator.Properties.urlRewriteRules)) {
                urlRewriteRulesSettings = new ReferencesTableSettings(uRLRewriteMediator,
            ...
            if (isAccessible(EsbViewsRepository.URLRewriteMediator.Properties.inProperty))
                basePart.setInProperty(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        uRLRewriteMediator.getInProperty()));

            if (isAccessible(EsbViewsRepository.URLRewriteMediator.Properties.outProperty))
                basePart.setOutProperty(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.URLRewriteMediator.Properties.description == event.getAffectedEditor()) {
            uRLRewriteMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.URLRewriteMediator.Properties.urlRewriteRules == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, urlRewriteRulesSettings, editingContext.getAdapterFactory());
        ...
        if (EsbViewsRepository.URLRewriteMediator.Properties.inProperty == event.getAffectedEditor()) {
            uRLRewriteMediator.setInProperty((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.URLRewriteMediator.Properties.outProperty == event.getAffectedEditor()) {
            uRLRewriteMediator.setOutProperty((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.URLRewriteMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.URLRewriteMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.URLRewriteMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getURLRewriteMediator_UrlRewriteRules().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.URLRewriteMediator.Properties.urlRewriteRules))
                basePart.updateUrlRewriteRules();
            if (EsbPackage.eINSTANCE.getURLRewriteMediator_InProperty().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.URLRewriteMediator.Properties.inProperty)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getURLRewriteMediator_OutProperty().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.URLRewriteMediator.Properties.outProperty)) {
                if (msg.getNewValue() != null) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.URLRewriteMediator.Properties.inProperty == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getURLRewriteMediator_InProperty().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getURLRewriteMediator_InProperty().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.URLRewriteMediator.Properties.outProperty == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getURLRewriteMediator_OutProperty().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getURLRewriteMediator_OutProperty().getEAttributeType(), newValue);
                }
