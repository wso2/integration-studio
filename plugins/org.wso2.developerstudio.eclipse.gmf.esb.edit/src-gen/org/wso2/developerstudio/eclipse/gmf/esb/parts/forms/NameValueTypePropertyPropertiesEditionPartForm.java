 ...
 * 
 */
public class NameValueTypePropertyPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, NameValueTypePropertyPropertiesEditionPart {
     ...
     */
    public NameValueTypePropertyPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = nameValueTypePropertyStep
                .addStep(EsbViewsRepository.NameValueTypeProperty.Properties.class);
    ...
    protected Composite createPropertyNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.NameValueTypeProperty.Properties.propertyName,
                EsbMessages.NameValueTypePropertyPropertiesEditionPart_PropertyNameLabel);
        ...
        propertyName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(NameValueTypePropertyPropertiesEditionPartForm.this,
                                    EsbViewsRepository.NameValueTypeProperty.Properties.propertyName,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            NameValueTypePropertyPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.NameValueTypeProperty.Properties.propertyName, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertyValueText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.NameValueTypeProperty.Properties.propertyValue,
                EsbMessages.NameValueTypePropertyPropertiesEditionPart_PropertyValueLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.NameValueTypeProperty.Properties.propertyValue, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertyTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.NameValueTypeProperty.Properties.propertyType,
                EsbMessages.NameValueTypePropertyPropertiesEditionPart_PropertyTypeLabel);
        ...
        propertyType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            NameValueTypePropertyPropertiesEditionPartForm.this,
                            EsbViewsRepository.NameValueTypeProperty.Properties.propertyType,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPropertyType()));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.NameValueTypeProperty.Properties.propertyType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.NameValueTypePropertyPropertiesEditionPart#setPropertyName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.NameValueTypePropertyPropertiesEditionPart#setPropertyValue(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.NameValueTypePropertyPropertiesEditionPart#initPropertyType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.NameValueTypePropertyPropertiesEditionPart#setPropertyType(Enumerator
     *      newValue)
     * 
     */
