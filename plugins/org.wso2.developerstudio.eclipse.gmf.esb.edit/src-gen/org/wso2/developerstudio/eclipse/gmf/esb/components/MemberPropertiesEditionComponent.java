...
public class MemberPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public MemberPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject member,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.Member.Properties.hostName))
                basePart.setHostName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, member.getHostName()));

            if (isAccessible(EsbViewsRepository.Member.Properties.httpPort))
                basePart.setHttpPort(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, member.getHttpPort()));

            if (isAccessible(EsbViewsRepository.Member.Properties.httpsPort))
                basePart.setHttpsPort(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, member.getHttpsPort()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.Member.Properties.hostName == event.getAffectedEditor()) {
            member.setHostName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.Member.Properties.httpPort == event.getAffectedEditor()) {
            member.setHttpPort((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.Member.Properties.httpsPort == event.getAffectedEditor()) {
            member.setHttpsPort((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getMember_HostName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Member.Properties.hostName)) {
            ...
            if (EsbPackage.eINSTANCE.getMember_HttpPort().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Member.Properties.httpPort)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMember_HttpsPort().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Member.Properties.httpsPort)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(EsbPackage.eINSTANCE.getMember_HostName(),
                EsbPackage.eINSTANCE.getMember_HttpPort(), EsbPackage.eINSTANCE.getMember_HttpsPort());
                ...
                if (EsbViewsRepository.Member.Properties.hostName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMember_HostName().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getMember_HostName().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.Member.Properties.httpPort == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMember_HttpPort().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getMember_HttpPort().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.Member.Properties.httpsPort == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMember_HttpsPort().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getMember_HttpsPort().getEAttributeType(), newValue);
                }
