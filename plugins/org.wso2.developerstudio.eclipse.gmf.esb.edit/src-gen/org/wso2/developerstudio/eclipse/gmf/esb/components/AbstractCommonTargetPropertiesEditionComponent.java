...
public class AbstractCommonTargetPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public AbstractCommonTargetPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject abstractCommonTarget, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.AbstractCommonTarget.Properties.sequenceType)) {
                basePart.initSequenceType(
                        EEFUtils.choiceOfValues(abstractCommonTarget,
                                EsbPackage.eINSTANCE.getAbstractCommonTarget_SequenceType()),
                        abstractCommonTarget.getSequenceType());
            }
            if (isAccessible(EsbViewsRepository.AbstractCommonTarget.Properties.sequence)) {
                // init part
                sequenceSettings = new EObjectFlatComboSettings(abstractCommonTarget,
            ...
            if (isAccessible(EsbViewsRepository.AbstractCommonTarget.Properties.endpointType)) {
                basePart.initEndpointType(
                        ...
                        abstractCommonTarget.getEndpointType());
            }
            // init filters
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractCommonTarget_SequenceType().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.AbstractCommonTarget.Properties.sequenceType))
            ...
            if (EsbPackage.eINSTANCE.getAbstractCommonTarget_Sequence().equals(msg.getFeature()) && basePart != null
                    && isAccessible(EsbViewsRepository.AbstractCommonTarget.Properties.sequence))
            ...
            if (EsbPackage.eINSTANCE.getAbstractCommonTarget_EndpointType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.AbstractCommonTarget.Properties.endpointType))
