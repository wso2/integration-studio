 ...
 * @generated
 */
public class LogMediatorLogCategoryEditPart extends CompartmentEditPart implements ITextAwareEditPart {
        ...
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.LogMediator_3495, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.LogMediatorLogCategoryEditPart.VISUAL_ID));
        }
        return parser;
    }
