 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfFaultMediatorOutputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnSource(
			FaultMediatorOutputConnectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(FaultMediatorOutputConnectorEditPart) sourceEditPart,
				targetEditPart);
	}
