 ...
 * @generated
 */
public class TreeNodeName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TreeNodeName2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = DataMapperParserProvider.getParser(DataMapperElementTypes.TreeNode_3003, getParserElement(),
					DataMapperVisualIDRegistry.getType(
							org.wso2.integrationstudio.datamapper.diagram.edit.parts.TreeNodeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
