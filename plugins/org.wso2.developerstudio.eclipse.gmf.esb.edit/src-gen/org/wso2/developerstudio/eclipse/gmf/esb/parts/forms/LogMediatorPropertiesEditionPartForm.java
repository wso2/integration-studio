 ...
 * 
 */
public class LogMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, LogMediatorPropertiesEditionPart {
     ...
     */
    public LogMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createLogCategoryEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.LogMediator.Properties.logCategory,
                EsbMessages.LogMediatorPropertiesEditionPart_LogCategoryLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(LogMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.LogMediator.Properties.logCategory,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLogCategory()));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LogMediator.Properties.logCategory, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createLogLevelEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.LogMediator.Properties.logLevel,
                EsbMessages.LogMediatorPropertiesEditionPart_LogLevelLabel);
        ...
        logLevel.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(LogMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.LogMediator.Properties.logLevel, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getLogLevel()));
            }

        });
        logLevel.setID(EsbViewsRepository.LogMediator.Properties.logLevel);
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LogMediator.Properties.logLevel, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createLogSeparatorText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.LogMediator.Properties.logSeparator,
                EsbMessages.LogMediatorPropertiesEditionPart_LogSeparatorLabel);
        ...
        logSeparator.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.LogMediator.Properties.logSeparator, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, logSeparator.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(LogMediatorPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LogMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LogMediator.Properties.logSeparator, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.properties = new ReferencesTable(getDescription(EsbViewsRepository.LogMediator.Properties.properties_,
                EsbMessages.LogMediatorPropertiesEditionPart_PropertiesLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(LogMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.LogMediator.Properties.properties_,
        ...
        this.properties.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.LogMediator.Properties.properties_, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.LogMediator.Properties.description,
                EsbMessages.LogMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LogMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.LogMediator.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LogMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.LogMediator.Properties.description, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LogMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LogMediatorPropertiesEditionPart#initLogCategory(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LogMediatorPropertiesEditionPart#setLogCategory(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LogMediatorPropertiesEditionPart#initLogLevel(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LogMediatorPropertiesEditionPart#setLogLevel(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LogMediatorPropertiesEditionPart#setLogSeparator(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LogMediatorPropertiesEditionPart#initProperties(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LogMediatorPropertiesEditionPart#addFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LogMediatorPropertiesEditionPart#addBusinessFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LogMediatorPropertiesEditionPart#isContainedInPropertiesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LogMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
