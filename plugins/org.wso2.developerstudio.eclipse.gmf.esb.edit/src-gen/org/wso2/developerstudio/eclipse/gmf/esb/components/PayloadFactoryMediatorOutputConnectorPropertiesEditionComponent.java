 ...
 * 
 */
public class PayloadFactoryMediatorOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public PayloadFactoryMediatorOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject payloadFactoryMediatorOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.PayloadFactoryMediatorOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(payloadFactoryMediatorOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.PayloadFactoryMediatorOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
