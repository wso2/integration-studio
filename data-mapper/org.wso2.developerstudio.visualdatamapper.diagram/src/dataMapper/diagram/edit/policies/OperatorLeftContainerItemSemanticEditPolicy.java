 ...
 * @generated
 */
public class OperatorLeftContainerItemSemanticEditPolicy extends
	...
	public OperatorLeftContainerItemSemanticEditPolicy() {
		super(dataMapper.diagram.providers.DataMapperElementTypes.OperatorLeftContainer_3013);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (dataMapper.diagram.providers.DataMapperElementTypes.OperatorLeftConnector_3014 == req
				.getElementType()) {
			return getGEFWrapper(new dataMapper.diagram.edit.commands.OperatorLeftConnectorCreateCommand(
					req));
		}
