 ...
 * 
 */
public class PublishEventMediatorAttributePropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, PublishEventMediatorAttributePropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        CompositionSequence publishEventMediatorAttributeStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        CompositionStep propertiesStep = publishEventMediatorAttributeStep
                .addStep(EsbViewsRepository.PublishEventMediatorAttribute.Properties.class);
    ...
    protected Composite createAttributeNameText(Composite parent) {
        Control attributeNameLabel = createDescription(parent,
                EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeName,
                EsbMessages.PublishEventMediatorAttributePropertiesEditionPart_AttributeNameLabel);
        ...
        Control attributeNameHelp = SWTUtils.createHelpButton(parent,
    ...
    protected Composite createAttributeValueTypeEMFComboViewer(Composite parent) {
        Control attributeValueTypeLabel = createDescription(parent,
                EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeValueType,
                EsbMessages.PublishEventMediatorAttributePropertiesEditionPart_AttributeValueTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PublishEventMediatorAttributePropertiesEditionPartImpl.this,
                            EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeValueType,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getAttributeValueType()));
            }

        });
        attributeValueType.setID(EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeValueType);
        Control attributeValeTypeHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeValueType,
                        EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAttributeValueText(Composite parent) {
        Control attributeValueLabel = createDescription(parent,
                EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeValue,
                EsbMessages.PublishEventMediatorAttributePropertiesEditionPart_AttributeValueLabel);
        ...
        Control attributeValueHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeValue,
                        EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAttributeTypeEMFComboViewer(Composite parent) {
        Control attributeTypeLabel = createDescription(parent,
                EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeType,
                EsbMessages.PublishEventMediatorAttributePropertiesEditionPart_AttributeTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PublishEventMediatorAttributePropertiesEditionPartImpl.this,
                            EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeType,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getAttributeType()));
            }

        });
        attributeType.setID(EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeType);
        Control attributeTypeHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeType,
                        EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createDefaultValueText(Composite parent) {
        Control defaultValueLabel = createDescription(parent,
                EsbViewsRepository.PublishEventMediatorAttribute.Properties.defaultValue,
                EsbMessages.PublishEventMediatorAttributePropertiesEditionPart_DefaultValueLabel);
        ...
        Control defaultValueHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PublishEventMediatorAttribute.Properties.defaultValue,
                        EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorAttributePropertiesEditionPart#setAttributeName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorAttributePropertiesEditionPart#initAttributeValueType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorAttributePropertiesEditionPart#setAttributeValueType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorAttributePropertiesEditionPart#setAttributeValue(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorAttributePropertiesEditionPart#initAttributeType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorAttributePropertiesEditionPart#setAttributeType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorAttributePropertiesEditionPart#setDefaultValue(String
     *      newValue)
     * 
     */
    ...
    protected Composite createAttributeExpressionText(final Composite parent) {
        ...
        attributeExpressionText.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PublishEventMediatorAttributePropertiesEditionPartImpl.this,
                            EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeExpression,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getAttributeExpression()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(PublishEventMediatorAttributePropertiesEditionPartImpl.this,
                                    EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeExpression,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PublishEventMediatorAttributePropertiesEditionPartImpl.this, null,
        ...
        EditingUtils.setID(attributeExpressionText,
                EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeExpression);
        EditingUtils.setEEFtype(attributeExpressionText, "eef::Text"); //$NON-NLS-1$
        Control attributeExpressionHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PublishEventMediatorAttribute.Properties.attributeExpression,
