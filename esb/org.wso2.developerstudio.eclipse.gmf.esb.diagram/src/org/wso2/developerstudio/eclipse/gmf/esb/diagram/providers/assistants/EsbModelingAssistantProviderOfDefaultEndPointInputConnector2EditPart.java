 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfDefaultEndPointInputConnector2EditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			DefaultEndPointInputConnector2EditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(DefaultEndPointInputConnector2EditPart) targetEditPart,
				relationshipType);
	}
