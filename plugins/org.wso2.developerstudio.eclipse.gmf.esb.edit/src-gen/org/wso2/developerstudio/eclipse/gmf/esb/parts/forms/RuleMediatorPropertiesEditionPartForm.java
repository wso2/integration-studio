 ...
 * 
 */
public class RuleMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, RuleMediatorPropertiesEditionPart {
     ...
     */
    public RuleMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        ...
        createDescription(parent, EsbViewsRepository.RuleMediator.Misc.description,
                EsbMessages.RuleMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleMediator.Misc.description, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleMediator.Misc.description, PropertiesEditionEvent.FOCUS_CHANGED,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.RuleMediator.Misc.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.RuleMediator.Misc.commentsList,
                        EsbMessages.RuleMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "RuleMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleMediator.Misc.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.RuleMediator.Misc.reverse,
                EsbMessages.RuleMediatorPropertiesEditionPart_ReverseLabel), SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleMediator.Misc.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.RuleMediator.Misc.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStatefulSessionCheckbox(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = miscGroup.getChildren();
        statefulSession = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.RuleMediator.Misc.statefulSession,
                        EsbMessages.RuleMediatorPropertiesEditionPart_StatefulSessionLabel),
                SWT.CHECK);
        statefulSession.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleMediator.Misc.statefulSession, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, new Boolean(statefulSession.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.Misc.statefulSession, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleSessionPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = miscGroup.getChildren();
        this.ruleSessionProperties = new ReferencesTable(
                getDescription(EsbViewsRepository.RuleMediator.Misc.ruleSessionProperties,
                        EsbMessages.RuleMediatorPropertiesEditionPart_RuleSessionPropertiesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.RuleMediator.Misc.ruleSessionProperties,
        ...
        this.ruleSessionProperties.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.Misc.ruleSessionProperties, EsbViewsRepository.FORM_KIND));
        ...
        this.ruleSessionProperties.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleMediator.Misc.ruleSessionProperties, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createInputFactsGroup(FormToolkit widgetFactory, final Composite parent) {
        Section inputFactsSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createInputWrapperNameText(FormToolkit widgetFactory, Composite parent) {
        ...
        createDescription(parent, EsbViewsRepository.RuleMediator.InputFacts.inputWrapperName,
                EsbMessages.RuleMediatorPropertiesEditionPart_InputWrapperNameLabel);
        ...
        inputWrapperName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleMediator.InputFacts.inputWrapperName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, inputWrapperName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.InputFacts.inputWrapperName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInputNameSpaceText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = inputFactsGroup.getChildren();
        createDescription(parent, EsbViewsRepository.RuleMediator.InputFacts.inputNameSpace,
                EsbMessages.RuleMediatorPropertiesEditionPart_InputNameSpaceLabel);
        ...
        inputNameSpace.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleMediator.InputFacts.inputNameSpace, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, inputNameSpace.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleMediator.InputFacts.inputNameSpace,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    inputNameSpace.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.InputFacts.inputNameSpace, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleFactsConfigurationTableComposition(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = inputFactsGroup.getChildren();
        this.ruleFactsConfiguration = new ReferencesTable(
                getDescription(EsbViewsRepository.RuleMediator.InputFacts.ruleFactsConfiguration,
                        EsbMessages.RuleMediatorPropertiesEditionPart_RuleFactsConfigurationLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.RuleMediator.InputFacts.ruleFactsConfiguration,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.ruleFactsConfiguration.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.InputFacts.ruleFactsConfiguration, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createOutputFactsGroup(FormToolkit widgetFactory, final Composite parent) {
        Section outputFactsSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createOutputWrapperNameText(FormToolkit widgetFactory, Composite parent) {
        ...
        createDescription(parent, EsbViewsRepository.RuleMediator.OutputFacts.outputWrapperName,
                EsbMessages.RuleMediatorPropertiesEditionPart_OutputWrapperNameLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.OutputFacts.outputWrapperName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutputNameSpaceText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = outputFactsGroup.getChildren();
        createDescription(parent, EsbViewsRepository.RuleMediator.OutputFacts.outputNameSpace,
                EsbMessages.RuleMediatorPropertiesEditionPart_OutputNameSpaceLabel);
        ...
        outputNameSpace.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleMediator.OutputFacts.outputNameSpace, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, outputNameSpace.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleMediator.OutputFacts.outputNameSpace,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    outputNameSpace.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.OutputFacts.outputNameSpace, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleResultsConfigurationTableComposition(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = outputFactsGroup.getChildren();
        this.ruleResultsConfiguration = new ReferencesTable(
                getDescription(EsbViewsRepository.RuleMediator.OutputFacts.ruleResultsConfiguration,
                        EsbMessages.RuleMediatorPropertiesEditionPart_RuleResultsConfigurationLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.RuleMediator.OutputFacts.ruleResultsConfiguration,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.ruleResultsConfiguration.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.OutputFacts.ruleResultsConfiguration, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createSourceValueText(FormToolkit widgetFactory, Composite parent) {
        ...
        createDescription(parent, EsbViewsRepository.RuleMediator.Source.sourceValue,
                EsbMessages.RuleMediatorPropertiesEditionPart_SourceValueLabel);
        ...
        sourceValue.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleMediator.Source.sourceValue, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, sourceValue.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleMediator.Source.sourceValue, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, sourceValue.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.Source.sourceValue, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTargetValueText(FormToolkit widgetFactory, Composite parent) {
        ...
        createDescription(parent, EsbViewsRepository.RuleMediator.Target.targetValue,
                EsbMessages.RuleMediatorPropertiesEditionPart_TargetValueLabel);
        ...
        targetValue.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleMediator.Target.targetValue, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, targetValue.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleMediator.Target.targetValue, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, targetValue.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.Target.targetValue, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTargetActionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = targetGroup.getChildren();
        createDescription(parent, EsbViewsRepository.RuleMediator.Target.targetAction,
                EsbMessages.RuleMediatorPropertiesEditionPart_TargetActionLabel);
        ...
        targetAction.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleMediator.Target.targetAction, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.Target.targetAction, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleSetGroup(FormToolkit widgetFactory, final Composite parent) {
        Section ruleSetSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createRuleSetTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        ...
        createDescription(parent, EsbViewsRepository.RuleMediator.RuleSet.ruleSetType,
                EsbMessages.RuleMediatorPropertiesEditionPart_RuleSetTypeLabel);
        ...
        ruleSetType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleMediator.RuleSet.ruleSetType, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getRuleSetType()));
            }

        });
        ruleSetType.setID(EsbViewsRepository.RuleMediator.RuleSet.ruleSetType);
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.RuleSet.ruleSetType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleSetURLText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = ruleSetGroup.getChildren();
        createDescription(parent, EsbViewsRepository.RuleMediator.RuleSet.ruleSetURL,
                EsbMessages.RuleMediatorPropertiesEditionPart_RuleSetURLLabel);
        ...
        ruleSetURL.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleMediator.RuleSet.ruleSetURL, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, ruleSetURL.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleMediator.RuleSet.ruleSetURL, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, ruleSetURL.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.RuleSet.ruleSetURL, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleSetSourceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = ruleSetGroup.getChildren();
        createDescription(parent, EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceType,
                EsbMessages.RuleMediatorPropertiesEditionPart_RuleSetSourceTypeLabel);
        ...
        ruleSetSourceType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getRuleSetSourceType()));
            }

        });
        ruleSetSourceType.setID(EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceType);
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleSetSourceCodeText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = ruleSetGroup.getChildren();
        createDescription(parent, EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceCode,
                EsbMessages.RuleMediatorPropertiesEditionPart_RuleSetSourceCodeLabel);
        ...
        ruleSetSourceCode.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceCode, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, ruleSetSourceCode.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceCode,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    ruleSetSourceCode.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceCode, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setStatefulSession(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#initRuleSessionProperties(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#addFilterRuleSessionProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#addBusinessFilterRuleSessionProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#isContainedInRuleSessionPropertiesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setInputWrapperName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setInputNameSpace(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#initRuleFactsConfiguration(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#addFilterRuleFactsConfiguration(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#addBusinessFilterRuleFactsConfiguration(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#isContainedInRuleFactsConfigurationTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setOutputWrapperName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setOutputNameSpace(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#initRuleResultsConfiguration(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#addFilterRuleResultsConfiguration(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#addBusinessFilterRuleResultsConfiguration(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#isContainedInRuleResultsConfigurationTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setSourceValue(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setTargetValue(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#initTargetAction(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setTargetAction(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#initRuleSetType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setRuleSetType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setRuleSetURL(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#initRuleSetSourceType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setRuleSetSourceType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleMediatorPropertiesEditionPart#setRuleSetSourceCode(String
     *      newValue)
     * 
     */
    ...
    protected Composite createsourceXPathWidget(FormToolkit widgetFactory, final Composite parent) {
        ...
        sourceXPathText.addMouseListener(new MouseAdapter() {
            ...
            public void mouseDown(MouseEvent event) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        RuleMediatorPropertiesEditionPartForm.this, EsbViewsRepository.RuleMediator.Source.sourceXPath,
    ...
    protected Composite createtargetXPathWidget(FormToolkit widgetFactory, final Composite parent) {
        ...
        targetXPathText.addMouseListener(new MouseAdapter() {
            ...
            public void mouseDown(MouseEvent event) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        RuleMediatorPropertiesEditionPartForm.this, EsbViewsRepository.RuleMediator.Target.targetXPath,
    ...
    protected Composite createtargetResultXPathWidget(FormToolkit widgetFactory, final Composite parent) {
        Control targetResultXPathLabel = createDescription(parent,
                EsbViewsRepository.RuleMediator.Target.targetResultXPath,
        ...
        Control targetResultXPathHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.RuleMediator.Target.targetResultXPath, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
        targetResultXPathElements = new Control[] { targetResultXPathLabel, targetResultXPathText,
                targetResultXPathHelp };
        return parent;
    }
    ...
    public void validate() {
        ...
        epv.clearElements(new Composite[] { miscGroup, inputFactsGroup, outputFactsGroup, sourceGroup, targetGroup,
                ruleSetGroup });
