 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfNamedEndpointInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			NamedEndpointInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(NamedEndpointInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
