...
public class RMSequenceMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public RMSequenceMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject rMSequenceMediator, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.RMSequenceMediator.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        rMSequenceMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.RMSequenceMediator.Properties.rmSpecVersion)) {
                basePart.initRmSpecVersion(
                        EEFUtils.choiceOfValues(rMSequenceMediator,
                                EsbPackage.eINSTANCE.getRMSequenceMediator_RmSpecVersion()),
                        rMSequenceMediator.getRmSpecVersion());
            }
            if (isAccessible(EsbViewsRepository.RMSequenceMediator.Properties.sequenceType)) {
                basePart.initSequenceType(
                        ...
                        rMSequenceMediator.getSequenceType());
            }
            // init filters
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.RMSequenceMediator.Properties.description == event.getAffectedEditor()) {
            rMSequenceMediator.setDescription((java.lang.String) EEFConverterUtil
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.RMSequenceMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RMSequenceMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RMSequenceMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getRMSequenceMediator_RmSpecVersion().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.RMSequenceMediator.Properties.rmSpecVersion))
                basePart.setRmSpecVersion((RMSpecVersion) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getRMSequenceMediator_SequenceType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.RMSequenceMediator.Properties.sequenceType))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getRMSequenceMediator_RmSpecVersion(),
                EsbPackage.eINSTANCE.getRMSequenceMediator_SequenceType());
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.RMSequenceMediator.Properties.rmSpecVersion == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRMSequenceMediator_RmSpecVersion().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRMSequenceMediator_RmSpecVersion().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RMSequenceMediator.Properties.sequenceType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRMSequenceMediator_SequenceType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRMSequenceMediator_SequenceType().getEAttributeType(), newValue);
                }
