 ...
 * 
 */
public class RMSequenceMediatorInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, RMSequenceMediatorInputConnectorPropertiesEditionPart {
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.RMSequenceMediatorInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RMSequenceMediatorInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.RMSequenceMediatorInputConnector.Properties.incomingLinks,
