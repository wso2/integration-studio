...
public class InboundEndpointGroupBox extends RoundedRectangle {
    ...
    private void createContents() {
        ...
        esbNodeTypeNameRectangle.setBackgroundColor(new Color(null, 34, 49, 63));
    ...
    private RoundedRectangle createInnerRectangle(RoundedRectangle leftRectangle) {
        ...
        LineBorder innerRectBorder = new LineBorder(new Color(null, 34, 49, 63), 2, SWT.BORDER_SOLID);
        ...
        innerRect.setBackgroundColor(new Color(null, 34, 49, 63));
