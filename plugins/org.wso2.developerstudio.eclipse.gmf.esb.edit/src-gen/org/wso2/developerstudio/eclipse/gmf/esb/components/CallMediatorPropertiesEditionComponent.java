...
public class CallMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public CallMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject callMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.CallMediator.Properties.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, callMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.CallMediator.Properties.endpoint)) {
                endpointSettings = new ReferencesTableSettings(callMediator,
            ...
            if (isAccessible(EsbViewsRepository.CallMediator.Properties.endpointType)) {
                basePart.initEndpointType(
                        EEFUtils.choiceOfValues(callMediator, EsbPackage.eINSTANCE.getCallMediator_EndpointType()),
                        callMediator.getEndpointType());
            }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.CallMediator.Properties.description == event.getAffectedEditor()) {
            callMediator.setDescription((java.lang.String) EEFConverterUtil
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.CallMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CallMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CallMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCallMediator_Endpoint().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.CallMediator.Properties.endpoint))
                basePart.updateEndpoint();
            if (EsbPackage.eINSTANCE.getCallMediator_EndpointType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.CallMediator.Properties.endpointType))
                basePart.setEndpointType((CallMediatorEndpointType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCallMediator_EnableBlockingCalls().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CallMediator.Properties.enableBlockingCalls))
                basePart.setEnableBlockingCalls((Boolean) msg.getNewValue());

            // Start of user code for endpointXPath live update
            if (EsbPackage.eINSTANCE.getCallMediator_EndpointXpath().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CallMediator.Properties.endpointXpath)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCallMediator_EndpointRegistrykey().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CallMediator.Properties.endpointRegistryKey)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getCallMediator_Endpoint(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.CallMediator.Properties.endpointType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCallMediator_EndpointType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCallMediator_EndpointType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CallMediator.Properties.enableBlockingCalls == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCallMediator_EnableBlockingCalls().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCallMediator_EnableBlockingCalls().getEAttributeType(), newValue);
                }
