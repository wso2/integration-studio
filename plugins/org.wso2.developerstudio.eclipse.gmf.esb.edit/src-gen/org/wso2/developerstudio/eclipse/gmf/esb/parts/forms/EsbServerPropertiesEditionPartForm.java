 ...
 * 
 */
public class EsbServerPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, EsbServerPropertiesEditionPart {
	 ...
	 */
	public EsbServerPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public EsbServerPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(EsbMessages.EsbServerPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createChildrenTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.children = new ReferencesTable(getDescription(EsbViewsRepository.EsbServer.Properties.children, EsbMessages.EsbServerPropertiesEditionPart_ChildrenLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EsbServerPropertiesEditionPartForm.this, EsbViewsRepository.EsbServer.Properties.children, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				children.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EsbServerPropertiesEditionPartForm.this, EsbViewsRepository.EsbServer.Properties.children, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				children.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EsbServerPropertiesEditionPartForm.this, EsbViewsRepository.EsbServer.Properties.children, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				children.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EsbServerPropertiesEditionPartForm.this, EsbViewsRepository.EsbServer.Properties.children, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				children.refresh();
			}
		...
		this.children.setHelpText(propertiesEditionComponent.getHelpContent(EsbViewsRepository.EsbServer.Properties.children, EsbViewsRepository.FORM_KIND));
		...
		this.children.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EsbServerPropertiesEditionPartForm.this, EsbViewsRepository.EsbServer.Properties.children, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		type.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EsbServerPropertiesEditionPartForm.this, EsbViewsRepository.EsbServer.Properties.type, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getType()));
			}

		});
		type.setID(EsbViewsRepository.EsbServer.Properties.type);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EsbServer.Properties.type, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbServerPropertiesEditionPart#initChildren(EObject current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbServerPropertiesEditionPart#updateChildren()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbServerPropertiesEditionPart#addFilterChildren(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbServerPropertiesEditionPart#addBusinessFilterChildren(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbServerPropertiesEditionPart#isContainedInChildrenTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbServerPropertiesEditionPart#getType()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbServerPropertiesEditionPart#initType(Object input, Enumerator current)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbServerPropertiesEditionPart#setType(Enumerator newValue)
	 * 
	 */
