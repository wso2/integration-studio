 ...
 * 
 */
public class APIResourcePropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, APIResourcePropertiesEditionPart {
    ...
    protected Composite createInSequenceInputConnectorsAdvancedTableComposition(Composite parent) {
                ...
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(APIResourcePropertiesEditionPartImpl.this,
        ...
        this.inSequenceInputConnectors.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResource.Properties.inSequenceInputConnectors, EsbViewsRepository.SWT_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(APIResourcePropertiesEditionPartImpl.this,
                                    EsbViewsRepository.APIResource.Properties.inSequenceInputConnectors,
    ...
    protected Composite createUrlStyleEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResource.Basic.urlStyle,
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourcePropertiesEditionPartImpl.this, EsbViewsRepository.APIResource.Basic.urlStyle,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Basic.urlStyle, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createUriTemplateText(Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResource.Basic.uriTemplate,
        ...
        uriTemplate.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourcePropertiesEditionPartImpl.this, EsbViewsRepository.APIResource.Basic.uriTemplate,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Basic.uriTemplate, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createUrlMappingText(Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResource.Basic.urlMapping,
        ...
        urlMapping.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourcePropertiesEditionPartImpl.this, EsbViewsRepository.APIResource.Basic.urlMapping,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Basic.urlMapping, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createProtocolEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResource.Basic.protocol,
        ...
        protocol.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourcePropertiesEditionPartImpl.this, EsbViewsRepository.APIResource.Basic.protocol,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Basic.protocol, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAllowGetCheckbox(Composite parent) {
        ...
        allowGet.setText(getDescription(EsbViewsRepository.APIResource.Methods.allowGet,
                EsbMessages.APIResourcePropertiesEditionPart_AllowGetLabel));
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Methods.allowGet, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAllowPostCheckbox(Composite parent) {
        ...
        allowPost.setText(getDescription(EsbViewsRepository.APIResource.Methods.allowPost,
                EsbMessages.APIResourcePropertiesEditionPart_AllowPostLabel));
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Methods.allowPost, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAllowPutCheckbox(Composite parent) {
        ...
        allowPut.setText(getDescription(EsbViewsRepository.APIResource.Methods.allowPut,
                EsbMessages.APIResourcePropertiesEditionPart_AllowPutLabel));
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Methods.allowPut, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAllowDeleteCheckbox(Composite parent) {
        ...
        allowDelete.setText(getDescription(EsbViewsRepository.APIResource.Methods.allowDelete,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Methods.allowDelete, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAllowOptionsCheckbox(Composite parent) {
        ...
        allowOptions.setText(getDescription(EsbViewsRepository.APIResource.Methods.allowOptions,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResource.Methods.allowOptions, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAllowHeadCheckbox(Composite parent) {
        ...
        allowHead.setText(getDescription(EsbViewsRepository.APIResource.Methods.allowHead,
                EsbMessages.APIResourcePropertiesEditionPart_AllowHeadLabel));
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Methods.allowHead, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAllowPatchCheckbox(Composite parent) {
        ...
        allowPatch.setText(getDescription(EsbViewsRepository.APIResource.Methods.allowPatch,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Methods.allowPatch, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInSequenceTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResource.InSequence.inSequenceType,
        ...
        inSequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourcePropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResource.InSequence.inSequenceType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInSequenceNameText(Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResource.InSequence.inSequenceName,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResource.InSequence.inSequenceName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutSequenceTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResource.OutSequence.outSequenceType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResource.OutSequence.outSequenceType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutSequenceNameText(Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResource.OutSequence.outSequenceName,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResource.OutSequence.outSequenceName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFaultSequenceTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResource.FaultSequence.faultSequenceType,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.APIResource.FaultSequence.faultSequenceType, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createFaultSequenceNameText(Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResource.FaultSequence.faultSequenceName,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.APIResource.FaultSequence.faultSequenceName, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
