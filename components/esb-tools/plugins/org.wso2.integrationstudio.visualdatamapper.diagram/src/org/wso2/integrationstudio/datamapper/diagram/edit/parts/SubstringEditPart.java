...
import org.wso2.integrationstudio.datamapper.diagram.edit.policies.SubstringCanonicalEditPolicy;
import org.wso2.integrationstudio.datamapper.diagram.edit.policies.SubstringItemSemanticEditPolicy;
import org.wso2.integrationstudio.datamapper.impl.EndsWithImpl;
import org.wso2.integrationstudio.datamapper.impl.SubstringImpl;

/**
 * @generated NOT
 */
public class SubstringEditPart extends AbstractOperatorEditPart {
	 ...
	 * @generated
	 */
	public SubstringEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SubstringItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new SubstringCanonicalEditPolicy());
	...
	public class SubstringFigure extends OperatorRectangle {

		public SubstringFigure() {
			super("Substring");
		...
		public IFigure getToolTip() {
			return new Label("Substring Operation");
		}
