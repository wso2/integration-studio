 ...
 * 
 */
public class APIResourceEndpointInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, APIResourceEndpointInputConnectorPropertiesEditionPart {
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.APIResourceEndpointInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(APIResourceEndpointInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.APIResourceEndpointInputConnector.Properties.incomingLinks,
