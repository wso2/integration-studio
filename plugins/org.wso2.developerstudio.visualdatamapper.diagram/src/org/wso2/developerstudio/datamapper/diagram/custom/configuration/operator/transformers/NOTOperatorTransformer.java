...
import static org.wso2.developerstudio.datamapper.diagram.custom.model.transformers.TransformerConstants.CONSTANT_NOT_OPERATOR;
...
/**
 * This class extended from the {@link AbstractDMOperatorTransformer} abstract class and generate script for NOT
 * operation
 */
	...
	public String generateScriptForOperation(Class<?> generatorClass, List<DMVariable> inputVariables,
		...
		if (DifferentLevelArrayMappingConfigGenerator.class.equals(generatorClass)) {
			if (inputVariables.size() == 0) {
				...
				operationBuilder
						.append(CONSTANT_NOT_OPERATOR + "(" + ScriptGenerationUtil.getPrettyVariableNameInForOperation(
