 ...
 * 
 */
public class InboundEndpointSequenceOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public InboundEndpointSequenceOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject inboundEndpointSequenceOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.InboundEndpointSequenceOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(inboundEndpointSequenceOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.InboundEndpointSequenceOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
