 ...
 * 
 */
public class FastXSLTMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, FastXSLTMediatorPropertiesEditionPart {
	 ...
	 */
	public FastXSLTMediatorPropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							EsbViewsRepository.FastXSLTMediator.Properties.description,
		...
		description.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FastXSLTMediatorPropertiesEditionPartForm.this, EsbViewsRepository.FastXSLTMediator.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
				}
			}
		});
		EditingUtils.setID(description, EsbViewsRepository.FastXSLTMediator.Properties.description);
		EditingUtils.setEEFtype(description, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.FastXSLTMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editCommentsList = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.FastXSLTMediator.Properties.commentsList, EsbMessages.FastXSLTMediatorPropertiesEditionPart_CommentsListLabel), SWT.NONE);
		...
		editCommentsList.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FastXSLTMediatorPropertiesEditionPartForm.this, EsbViewsRepository.FastXSLTMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(commentsListList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
		reverse = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.FastXSLTMediator.Properties.reverse, EsbMessages.FastXSLTMediatorPropertiesEditionPart_ReverseLabel), SWT.CHECK);
		reverse.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FastXSLTMediatorPropertiesEditionPartForm.this, EsbViewsRepository.FastXSLTMediator.Properties.reverse, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(reverse.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.FastXSLTMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createFastXsltSchemaKeyTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		fastXsltSchemaKeyType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FastXSLTMediatorPropertiesEditionPartForm.this, EsbViewsRepository.FastXSLTMediator.Properties.fastXsltSchemaKeyType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getFastXsltSchemaKeyType()));
			}

		});
		fastXsltSchemaKeyType.setID(EsbViewsRepository.FastXSLTMediator.Properties.fastXsltSchemaKeyType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.FastXSLTMediator.Properties.fastXsltSchemaKeyType, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FastXSLTMediatorPropertiesEditionPart#setCommentsList(EList newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FastXSLTMediatorPropertiesEditionPart#setReverse(Boolean newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FastXSLTMediatorPropertiesEditionPart#initFastXsltSchemaKeyType(Object input, Enumerator current)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FastXSLTMediatorPropertiesEditionPart#setFastXsltSchemaKeyType(Enumerator newValue)
	 * 
	 */
