...
public class CalloutMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public CalloutMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject calloutMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.CalloutMediator.Misc.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        calloutMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.CalloutMediator.Service.serviceURL))
                basePart.setServiceURL(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        calloutMediator.getServiceURL()));

            if (isAccessible(EsbViewsRepository.CalloutMediator.Service.soapAction))
                basePart.setSoapAction(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        calloutMediator.getSoapAction()));

            if (isAccessible(EsbViewsRepository.CalloutMediator.Service.pathToAxis2xml))
                basePart.setPathToAxis2xml(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        calloutMediator.getPathToAxis2xml()));

            if (isAccessible(EsbViewsRepository.CalloutMediator.Service.pathToAxis2Repository))
                basePart.setPathToAxis2Repository(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        calloutMediator.getPathToAxis2Repository()));

            if (isAccessible(EsbViewsRepository.CalloutMediator.Source.payloadType)) {
                basePart.initPayloadType(
                        EEFUtils.choiceOfValues(calloutMediator, EsbPackage.eINSTANCE.getCalloutMediator_PayloadType()),
                        calloutMediator.getPayloadType());
            }
            if (isAccessible(EsbViewsRepository.CalloutMediator.Target.resultType)) {
                basePart.initResultType(
                        EEFUtils.choiceOfValues(calloutMediator, EsbPackage.eINSTANCE.getCalloutMediator_ResultType()),
                        calloutMediator.getResultType());
            }
            if (isAccessible(EsbViewsRepository.CalloutMediator.Target.resultContextProperty))
                basePart.setResultContextProperty(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        calloutMediator.getResultContextProperty()));
            ...
            if (isAccessible(EsbViewsRepository.CalloutMediator.Service.endpointType)) {
                basePart.initEndpointType(
                        EEFUtils.choiceOfValues(calloutMediator,
                                EsbPackage.eINSTANCE.getCalloutMediator_EndpointType()),
                        calloutMediator.getEndpointType());
            }
            if (isAccessible(EsbViewsRepository.CalloutMediator.Source.payloadProperty))
                basePart.setPayloadProperty(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        calloutMediator.getPayloadProperty()));

            if (isAccessible(EsbViewsRepository.CalloutMediator.WS.securityType)) {
                basePart.initSecurityType(
                        EEFUtils.choiceOfValues(calloutMediator,
                                EsbPackage.eINSTANCE.getCalloutMediator_SecurityType()),
                        calloutMediator.getSecurityType());
            }
            if (isAccessible(EsbViewsRepository.CalloutMediator.WS.policies)) {
                basePart.initPolicies(
                        EEFUtils.choiceOfValues(calloutMediator, EsbPackage.eINSTANCE.getCalloutMediator_Policies()),
                        calloutMediator.getPolicies());
            }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.CalloutMediator.Misc.description == event.getAffectedEditor()) {
            calloutMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.CalloutMediator.Service.serviceURL == event.getAffectedEditor()) {
            calloutMediator.setServiceURL((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.CalloutMediator.Service.soapAction == event.getAffectedEditor()) {
            calloutMediator.setSoapAction((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.CalloutMediator.Service.pathToAxis2xml == event.getAffectedEditor()) {
            calloutMediator.setPathToAxis2xml((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.CalloutMediator.Service.pathToAxis2Repository == event.getAffectedEditor()) {
            calloutMediator.setPathToAxis2Repository((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.CalloutMediator.Target.resultContextProperty == event.getAffectedEditor()) {
            calloutMediator.setResultContextProperty((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.CalloutMediator.Source.payloadProperty == event.getAffectedEditor()) {
            calloutMediator.setPayloadProperty((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.CalloutMediator.Misc.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CalloutMediator.Misc.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CalloutMediator.Misc.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCalloutMediator_ServiceURL().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CalloutMediator.Service.serviceURL)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCalloutMediator_SoapAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CalloutMediator.Service.soapAction)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCalloutMediator_PathToAxis2xml().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CalloutMediator.Service.pathToAxis2xml)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCalloutMediator_PathToAxis2Repository().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CalloutMediator.Service.pathToAxis2Repository)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCalloutMediator_PayloadType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.CalloutMediator.Source.payloadType))
                basePart.setPayloadType((CalloutPayloadType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCalloutMediator_ResultType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.CalloutMediator.Target.resultType))
                basePart.setResultType((CalloutResultType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCalloutMediator_ResultContextProperty().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CalloutMediator.Target.resultContextProperty)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCalloutMediator_PassHeaders().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CalloutMediator.Misc.passHeaders))
                basePart.setPassHeaders((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCalloutMediator_EndpointType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.CalloutMediator.Service.endpointType))
                basePart.setEndpointType((CalloutEndpointType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCalloutMediator_PayloadProperty().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CalloutMediator.Source.payloadProperty)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCalloutMediator_SecurityType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.CalloutMediator.WS.securityType))
                basePart.setSecurityType((CalloutSecurityType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCalloutMediator_Policies().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.CalloutMediator.WS.policies))
                basePart.setPolicies((CalloutSecurityPolicies) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCalloutMediator_InitAxis2ClientOptions().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CalloutMediator.Service.initAxis2ClientOptions))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getCalloutMediator_ServiceURL(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.CalloutMediator.Service.serviceURL == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCalloutMediator_ServiceURL().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCalloutMediator_ServiceURL().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CalloutMediator.Service.soapAction == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCalloutMediator_SoapAction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCalloutMediator_SoapAction().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CalloutMediator.Service.pathToAxis2xml == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCalloutMediator_PathToAxis2xml().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCalloutMediator_PathToAxis2xml().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CalloutMediator.Service.pathToAxis2Repository == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCalloutMediator_PathToAxis2Repository().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCalloutMediator_PathToAxis2Repository().getEAttributeType(),
                ...
                if (EsbViewsRepository.CalloutMediator.Source.payloadType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCalloutMediator_PayloadType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCalloutMediator_PayloadType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CalloutMediator.Target.resultType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCalloutMediator_ResultType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCalloutMediator_ResultType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CalloutMediator.Target.resultContextProperty == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCalloutMediator_ResultContextProperty().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCalloutMediator_ResultContextProperty().getEAttributeType(),
                ...
                if (EsbViewsRepository.CalloutMediator.Misc.passHeaders == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCalloutMediator_PassHeaders().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCalloutMediator_PassHeaders().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CalloutMediator.Service.endpointType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCalloutMediator_EndpointType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCalloutMediator_EndpointType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CalloutMediator.Source.payloadProperty == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCalloutMediator_PayloadProperty().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCalloutMediator_PayloadProperty().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CalloutMediator.WS.securityType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCalloutMediator_SecurityType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCalloutMediator_SecurityType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CalloutMediator.WS.policies == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCalloutMediator_Policies().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getCalloutMediator_Policies().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CalloutMediator.Service.initAxis2ClientOptions == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCalloutMediator_InitAxis2ClientOptions().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCalloutMediator_InitAxis2ClientOptions().getEAttributeType(),
