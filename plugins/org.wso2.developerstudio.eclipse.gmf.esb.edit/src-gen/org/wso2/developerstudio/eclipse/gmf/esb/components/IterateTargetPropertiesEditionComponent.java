...
public class IterateTargetPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public IterateTargetPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject iterateTarget,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.IterateTarget.Properties.sequenceType)) {
                basePart.initSequenceType(
                        EEFUtils.choiceOfValues(iterateTarget,
                                EsbPackage.eINSTANCE.getAbstractCommonTarget_SequenceType()),
                        iterateTarget.getSequenceType());
            }
            if (isAccessible(EsbViewsRepository.IterateTarget.Properties.sequence)) {
                // init part
                sequenceSettings = new EObjectFlatComboSettings(iterateTarget,
            ...
            if (isAccessible(EsbViewsRepository.IterateTarget.Properties.endpointType)) {
                basePart.initEndpointType(
                        ...
                        iterateTarget.getEndpointType());
            }
            if (isAccessible(EsbViewsRepository.IterateTarget.Properties.soapAction))
                basePart.setSoapAction(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, iterateTarget.getSoapAction()));

            if (isAccessible(EsbViewsRepository.IterateTarget.Properties.toAddress))
                basePart.setToAddress(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, iterateTarget.getToAddress()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.IterateTarget.Properties.soapAction == event.getAffectedEditor()) {
            iterateTarget.setSoapAction((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.IterateTarget.Properties.toAddress == event.getAffectedEditor()) {
            iterateTarget.setToAddress((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractCommonTarget_SequenceType().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.IterateTarget.Properties.sequenceType))
            ...
            if (EsbPackage.eINSTANCE.getAbstractCommonTarget_Sequence().equals(msg.getFeature()) && basePart != null
                    && isAccessible(EsbViewsRepository.IterateTarget.Properties.sequence))
            ...
            if (EsbPackage.eINSTANCE.getAbstractCommonTarget_EndpointType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.IterateTarget.Properties.endpointType))
                basePart.setEndpointType((TargetEndpointType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getIterateTarget_SoapAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.IterateTarget.Properties.soapAction)) {
            ...
            if (EsbPackage.eINSTANCE.getIterateTarget_ToAddress().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.IterateTarget.Properties.toAddress)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getAbstractCommonTarget_Sequence(),
                EsbPackage.eINSTANCE.getAbstractCommonTarget_EndpointType(),
                EsbPackage.eINSTANCE.getIterateTarget_SoapAction(), EsbPackage.eINSTANCE.getIterateTarget_ToAddress());
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.IterateTarget.Properties.soapAction == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getIterateTarget_SoapAction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getIterateTarget_SoapAction().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.IterateTarget.Properties.toAddress == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getIterateTarget_ToAddress().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getIterateTarget_ToAddress().getEAttributeType(), newValue);
                }
