...
/**
 * Class is responsible to create a custom parameter table.
 */
public class CustomParametersComposite extends AbstractComposite {
    private Table tblParameters;
    private Button btnRemove;
    private Button btnAdd;
    private DockerModel model;

    public CustomParametersComposite(Composite parent, int style, ProjectDataModel model, ProjectOptionData optionData,
            WizardPage wizardPage) {
        super(parent, style, model, optionData, wizardPage);
        setLayout(new GridLayout(2, false));
        this.model = (DockerModel) model;
