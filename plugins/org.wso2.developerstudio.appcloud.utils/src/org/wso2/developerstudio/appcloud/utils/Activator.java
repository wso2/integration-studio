...
package org.wso2.developerstudio.appcloud.utils;
...
public class Activator implements BundleActivator {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.wso2.developerstudio.appcloud.utils"; //$NON-NLS-1$
	...
	private static boolean loadJKSfromEclipsePrefernaces() {
		 ...
		 * org.wso2.developerstudio.eclipse.platform.ui.Activator.getDefault()
		 * .getPreferenceStore();
		 * 
		 ...
		 * Logger.getLog(org.wso2.developerstudio.eclipse.platform.ui.Activator.
		 * PLUGIN_ID); log.error(
