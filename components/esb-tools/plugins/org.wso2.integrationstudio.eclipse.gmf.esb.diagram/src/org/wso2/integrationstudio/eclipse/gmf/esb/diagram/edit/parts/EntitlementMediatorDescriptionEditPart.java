 ...
 * @generated
 */
public class EntitlementMediatorDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
     ...
     * @generated
     */
    public EntitlementMediatorDescriptionEditPart(View view) {
        super(view);
    }
        ...
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.EntitlementMediator_3505, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.EntitlementMediatorDescriptionEditPart.VISUAL_ID));
        }
        return parser;
    }
