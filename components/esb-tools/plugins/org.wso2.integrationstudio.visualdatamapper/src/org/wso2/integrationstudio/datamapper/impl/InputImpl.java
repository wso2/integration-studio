 ...
 * </p>
 * <ul>
 *   <li>{@link org.wso2.integrationstudio.datamapper.impl.InputImpl#getTreeNode <em>Tree Node</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputImpl extends DataMapperNodeImpl implements Input {
	/**
	...
	protected EClass eStaticClass() {
		return DataMapperPackage.Literals.INPUT;
	}
	...
	public EList<TreeNode> getTreeNode() {
		if (treeNode == null) {
			treeNode = new EObjectContainmentWithInverseEList<TreeNode>(TreeNode.class, this, DataMapperPackage.INPUT__TREE_NODE, DataMapperPackage.TREE_NODE__INPUT_PARENT);
		}
		return treeNode;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataMapperPackage.INPUT__TREE_NODE:
