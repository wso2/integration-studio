...
public class PublisherArtifactFileChange extends TextFileChange {
	private static IDeveloperStudioLog log = Logger.getLog(Activator.PLUGIN_ID);

	private IFile publisherFile;
	private String newName;
	private String originalName;

	public PublisherArtifactFileChange(String name, IFile file, String originalName, String newName) {
		super(name, file);
		publisherFile = file;
	...
	private void identifyReplaces() throws IOException {
		int fullIndex = 0;
		FileReader fileReader = new FileReader(publisherFile.getLocation().toFile());
