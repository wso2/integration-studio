 ...
 * 
 */
public class MessageStoreParameterPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, MessageStoreParameterPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        CompositionStep propertiesStep = messageStoreParameterStep
                .addStep(EsbViewsRepository.MessageStoreParameter.Properties.class);
    ...
    protected Composite createParameterNameText(Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStoreParameter.Properties.parameterName,
                EsbMessages.MessageStoreParameterPropertiesEditionPart_ParameterNameLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStoreParameterPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(MessageStoreParameterPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.MessageStoreParameter.Properties.parameterName,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.MessageStoreParameter.Properties.parameterName, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createParameterValueText(Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStoreParameter.Properties.parameterValue,
                EsbMessages.MessageStoreParameterPropertiesEditionPart_ParameterValueLabel);
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStoreParameter.Properties.parameterValue, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStoreParameterPropertiesEditionPart#setParameterName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStoreParameterPropertiesEditionPart#setParameterValue(String
     *      newValue)
     * 
     */
