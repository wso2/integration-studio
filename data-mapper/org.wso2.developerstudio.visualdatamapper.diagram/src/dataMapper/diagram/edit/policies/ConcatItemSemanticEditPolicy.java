...
public class ConcatItemSemanticEditPolicy extends
	...
	public ConcatItemSemanticEditPolicy() {
		super(dataMapper.diagram.providers.DataMapperElementTypes.Concat_3013);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (dataMapper.diagram.providers.DataMapperElementTypes.InNode_3014 == req.getElementType()) {
		...
		if (dataMapper.diagram.providers.DataMapperElementTypes.OutNode_3015 == req
				.getElementType()) {
			return getGEFWrapper(new dataMapper.diagram.edit.commands.OutNode3CreateCommand(req));
		}
