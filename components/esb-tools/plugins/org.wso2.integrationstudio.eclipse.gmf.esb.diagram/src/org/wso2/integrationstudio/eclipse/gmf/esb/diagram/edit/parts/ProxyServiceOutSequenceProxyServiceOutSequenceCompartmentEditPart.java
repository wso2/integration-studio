 ...
 *//**
    ...
    *//*
       ...
       * ((ProxyServiceOutSequenceEditPart)child.getParent().getParent()).refreshInputConnector(child.getParent().
       * getParent().getParent().getParent().getParent().getParent());
       * ((ProxyServiceInSequenceEditPart)child.getParent().getParent().getParent().getChildren().get(0)).
       * refreshOutputConnector(child.getParent().getParent().getParent().getParent().getParent().getParent());
       * if(((ProxyServiceContainerEditPart)child.getParent().getParent().getParent().getParent().getParent().getParent(
       * ).getChildren().get(4)).getChildren().size()==2)
       * ((ProxyServiceFaultContainerEditPart)((ProxyServiceContainerEditPart)child.getParent().getParent().getParent().
       * getParent().getParent().getParent().getChildren().get(4)).getChildren().get(1)).refreshInputConnector(child.
       ...
       * outputConnectorEditPart=((ProxyOutputConnectorEditPart)this.getParent().getParent().getParent().getChildren().
       * get(1));
       * System.out.println(outputConnectorEditPart.getFigure().getClass());
       * //((IFigure)(((IFigure)((IFigure)editPart.getFigure().getChildren().get(0)).getChildren().get(0))).getChildren(
       * ).get(0)).getChildren().get(1);
       * //System.out.println(((IFigure)(((IFigure)((IFigure)editPart.getFigure().getChildren().get(0)).getChildren().
       * get(0))).getChildren().get(0)).getClass());
       ...
       * // .getChildren().get(0)
       * //System.out.println("Class parent  "+mediator.getFigure().getParent().getParent().getParent().getParent().
       * getParent().getParent().getParent().getParent().getParent().getParent().getParent().getChildren().get(1).
       * getClass());
       * 
       * CompoundCommand cc = new CompoundCommand("Create Link");
       * 
       * ICommand createSubTopicsCmd = new DeferredCreateConnectionViewAndElementCommand(new
       * CreateConnectionViewAndElementRequest(EsbElementTypes.EsbLink_4001,
       * ((IHintedType) EsbElementTypes.EsbLink_4001).getSemanticHint(),
       * proxyServiceEditPart.getDiagramPreferencesHint()), new EObjectAdapter((EObject)
       * outputConnectorEditPart.getModel()),
