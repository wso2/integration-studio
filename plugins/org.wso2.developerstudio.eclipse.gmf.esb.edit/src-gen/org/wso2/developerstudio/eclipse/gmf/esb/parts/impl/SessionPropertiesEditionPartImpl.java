 ...
 * 
 */
public class SessionPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, SessionPropertiesEditionPart {
    ...
    protected Composite createTypeEMFComboViewer(Composite parent) {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SessionPropertiesEditionPartImpl.this, EsbViewsRepository.Session.Properties.type,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Session.Properties.type, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
