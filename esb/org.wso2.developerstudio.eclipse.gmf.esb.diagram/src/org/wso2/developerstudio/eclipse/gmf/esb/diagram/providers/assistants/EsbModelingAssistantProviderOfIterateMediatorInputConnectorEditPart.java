 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfIterateMediatorInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			IterateMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(IterateMediatorInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
