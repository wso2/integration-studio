...
public class ProxyServicePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ProxyServicePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject proxyService,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.Properties.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, proxyService.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.Properties.inSequenceInputConnectors)) {
                inSequenceInputConnectorsSettings = new ReferencesTableSettings(proxyService,
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.Basic.name))
                basePart.setName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, proxyService.getName()));

            if (isAccessible(EsbViewsRepository.ProxyService.Basic.pinnedServers))
                basePart.setPinnedServers(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        proxyService.getPinnedServers()));

            if (isAccessible(EsbViewsRepository.ProxyService.Basic.serviceGroup))
                basePart.setServiceGroup(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        proxyService.getServiceGroup()));
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.Basic.transports))
                basePart.setTransports(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, proxyService.getTransports()));
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.Parameters.serviceParameters)) {
                serviceParametersSettings = new ReferencesTableSettings(proxyService,
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.Security.servicePolicies)) {
                servicePoliciesSettings = new ReferencesTableSettings(proxyService,
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.InSequence.inSequenceType)) {
                basePart.initInSequenceType(
                        EEFUtils.choiceOfValues(proxyService, EsbPackage.eINSTANCE.getProxyService_InSequenceType()),
                        proxyService.getInSequenceType());
            }
            if (isAccessible(EsbViewsRepository.ProxyService.InSequence.inSequenceName))
                basePart.setInSequenceName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        proxyService.getInSequenceName()));
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.OutSequence.outSequenceType)) {
                basePart.initOutSequenceType(
                        EEFUtils.choiceOfValues(proxyService, EsbPackage.eINSTANCE.getProxyService_OutSequenceType()),
                        proxyService.getOutSequenceType());
            }
            if (isAccessible(EsbViewsRepository.ProxyService.OutSequence.outSequenceName))
                basePart.setOutSequenceName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        proxyService.getOutSequenceName()));
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.FaultSequence.faultSequenceType)) {
                basePart.initFaultSequenceType(
                        EEFUtils.choiceOfValues(proxyService, EsbPackage.eINSTANCE.getProxyService_FaultSequenceType()),
                        proxyService.getFaultSequenceType());
            }
            if (isAccessible(EsbViewsRepository.ProxyService.FaultSequence.faultSequenceName))
                basePart.setFaultSequenceName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        proxyService.getFaultSequenceName()));
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.Endpoint.endpointType)) {
                basePart.initEndpointType(
                        EEFUtils.choiceOfValues(proxyService, EsbPackage.eINSTANCE.getProxyService_EndpointType()),
                        proxyService.getEndpointType());
            }
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.Wsdl.wsdlType)) {
                basePart.initWsdlType(
                        EEFUtils.choiceOfValues(proxyService, EsbPackage.eINSTANCE.getProxyService_WsdlType()),
                        proxyService.getWsdlType());
            }
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.Wsdl.wsdlXML))
                basePart.setWsdlXML(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, proxyService.getWsdlXML()));

            if (isAccessible(EsbViewsRepository.ProxyService.Wsdl.wsdlURL))
                basePart.setWsdlURL(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, proxyService.getWsdlURL()));

            if (isAccessible(EsbViewsRepository.ProxyService.Wsdl.wsdlResources)) {
                wsdlResourcesSettings = new ReferencesTableSettings(proxyService,
                ...
                basePart.addFilterToInSequenceInputConnectors(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof ProxyInSequenceInputConnector);
                    }
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.Parameters.serviceParameters)) {
                basePart.addFilterToServiceParameters(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof ProxyServiceParameter);
                    }
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.Security.servicePolicies)) {
                basePart.addFilterToServicePolicies(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof ProxyServicePolicy);
                    }
            ...
            if (isAccessible(EsbViewsRepository.ProxyService.Wsdl.wsdlResources)) {
                basePart.addFilterToWsdlResources(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof ProxyWSDLResource);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ProxyService.Properties.description == event.getAffectedEditor()) {
            proxyService.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.ProxyService.Properties.inSequenceInputConnectors == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, inSequenceInputConnectorsSettings, editingContext.getAdapterFactory());
                ...
                inSequenceInputConnectorsSettings.move(event.getNewIndex(),
                        (ProxyInSequenceInputConnector) event.getNewValue());
            }
        }
        if (EsbViewsRepository.ProxyService.Basic.name == event.getAffectedEditor()) {
            proxyService.setName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.ProxyService.Basic.pinnedServers == event.getAffectedEditor()) {
            proxyService.setPinnedServers((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.ProxyService.Basic.serviceGroup == event.getAffectedEditor()) {
            proxyService.setServiceGroup((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.ProxyService.Basic.transports == event.getAffectedEditor()) {
            proxyService.setTransports((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.ProxyService.Security.servicePolicies == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, servicePoliciesSettings, editingContext.getAdapterFactory());
                PropertiesEditingProvider provider = (PropertiesEditingProvider) editingContext.getAdapterFactory()
                        .adapt(semanticObject, PropertiesEditingProvider.class);
                if (provider != null) {
                    PropertiesEditingPolicy policy = provider.getPolicy(context);
        ...
        if (EsbViewsRepository.ProxyService.InSequence.inSequenceName == event.getAffectedEditor()) {
            proxyService.setInSequenceName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.ProxyService.OutSequence.outSequenceName == event.getAffectedEditor()) {
            proxyService.setOutSequenceName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.ProxyService.FaultSequence.faultSequenceName == event.getAffectedEditor()) {
            proxyService.setFaultSequenceName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.ProxyService.Endpoint.endpointName == event.getAffectedEditor()) {
            proxyService.setEndpointName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.ProxyService.Wsdl.wsdlXML == event.getAffectedEditor()) {
            proxyService.setWsdlXML((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.ProxyService.Wsdl.wsdlURL == event.getAffectedEditor()) {
            proxyService.setWsdlURL((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.ProxyService.Wsdl.wsdlResources == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, wsdlResourcesSettings, editingContext.getAdapterFactory());
                PropertiesEditingProvider provider = (PropertiesEditingProvider) editingContext.getAdapterFactory()
                        .adapt(semanticObject, PropertiesEditingProvider.class);
                if (provider != null) {
                    PropertiesEditingPolicy policy = provider.getPolicy(context);
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.ProxyService.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getProxyService_InSequenceInputConnectors().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.ProxyService.Properties.inSequenceInputConnectors))
                basePart.updateInSequenceInputConnectors();
            if (EsbPackage.eINSTANCE.getProxyService_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.Basic.name)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getProxyService_PinnedServers().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.Basic.pinnedServers)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getProxyService_ServiceGroup().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.Basic.serviceGroup)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getProxyService_TraceEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.Basic.traceEnabled))
                basePart.setTraceEnabled((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getProxyService_StatisticsEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.Basic.statisticsEnabled))
                basePart.setStatisticsEnabled((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getProxyService_StartOnLoad().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.Basic.startOnLoad))
                basePart.setStartOnLoad((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getProxyService_Transports().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.Basic.transports)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getProxyService_ReliableMessagingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.ReliableMessaging.reliableMessagingEnabled))
                basePart.setReliableMessagingEnabled((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getProxyService_SecurityEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.Security.securityEnabled))
                basePart.setSecurityEnabled((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getProxyService_ServiceParameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.ProxyService.Parameters.serviceParameters))
                basePart.updateServiceParameters();
            if (EsbPackage.eINSTANCE.getProxyService_ServicePolicies().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.ProxyService.Security.servicePolicies))
                basePart.updateServicePolicies();
            if (EsbPackage.eINSTANCE.getProxyService_InSequenceType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ProxyService.InSequence.inSequenceType))
                basePart.setInSequenceType((SequenceType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getProxyService_InSequenceName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.InSequence.inSequenceName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getProxyService_OutSequenceType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ProxyService.OutSequence.outSequenceType))
                basePart.setOutSequenceType((SequenceType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getProxyService_OutSequenceName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.OutSequence.outSequenceName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getProxyService_FaultSequenceType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ProxyService.FaultSequence.faultSequenceType))
                basePart.setFaultSequenceType((SequenceType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getProxyService_FaultSequenceName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.FaultSequence.faultSequenceName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getProxyService_EndpointType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ProxyService.Endpoint.endpointType))
                basePart.setEndpointType((SequenceType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getProxyService_EndpointName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.Endpoint.endpointName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getProxyService_MainSequence().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.Properties.mainSequence))
                basePart.setMainSequence((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getProxyService_WsdlType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ProxyService.Wsdl.wsdlType))
                basePart.setWsdlType((ProxyWsdlType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getProxyService_PreservePolicy().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.Wsdl.preservePolicy))
                basePart.setPreservePolicy((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getProxyService_WsdlXML().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.Wsdl.wsdlXML)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getProxyService_WsdlURL().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyService.Wsdl.wsdlURL)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getProxyService_WsdlResources().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.ProxyService.Wsdl.wsdlResources))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getProxyService_InSequenceInputConnectors(),
                EsbPackage.eINSTANCE.getProxyService_Name(), EsbPackage.eINSTANCE.getProxyService_PinnedServers(),
                ...
                EsbPackage.eINSTANCE.getProxyService_StartOnLoad(), EsbPackage.eINSTANCE.getProxyService_Transports(),
                ...
                EsbPackage.eINSTANCE.getProxyService_EndpointName(), EsbPackage.eINSTANCE.getProxyService_EndpointKey(),
                EsbPackage.eINSTANCE.getProxyService_MainSequence(), EsbPackage.eINSTANCE.getProxyService_WsdlType(),
                EsbPackage.eINSTANCE.getProxyService_PreservePolicy(), EsbPackage.eINSTANCE.getProxyService_WsdlXML(),
                EsbPackage.eINSTANCE.getProxyService_WsdlURL(), EsbPackage.eINSTANCE.getProxyService_WsdlResources(),
                EsbPackage.eINSTANCE.getProxyService_WsdlKey(), EsbPackage.eINSTANCE.getProxyService_WsdlEndpoint(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.ProxyService.Basic.name == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_Name().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getProxyService_Name().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.Basic.pinnedServers == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_PinnedServers().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_PinnedServers().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.Basic.serviceGroup == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_ServiceGroup().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_ServiceGroup().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.Basic.traceEnabled == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_TraceEnabled().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_TraceEnabled().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.Basic.statisticsEnabled == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_StatisticsEnabled().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_StatisticsEnabled().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.Basic.startOnLoad == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_StartOnLoad().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getProxyService_StartOnLoad().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.Basic.transports == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_Transports().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getProxyService_Transports().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.ReliableMessaging.reliableMessagingEnabled == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_ReliableMessagingEnabled().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_ReliableMessagingEnabled().getEAttributeType(),
                ...
                if (EsbViewsRepository.ProxyService.Security.securityEnabled == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_SecurityEnabled().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_SecurityEnabled().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.InSequence.inSequenceType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_InSequenceType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_InSequenceType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.InSequence.inSequenceName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_InSequenceName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_InSequenceName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.OutSequence.outSequenceType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_OutSequenceType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_OutSequenceType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.OutSequence.outSequenceName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_OutSequenceName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_OutSequenceName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.FaultSequence.faultSequenceType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_FaultSequenceType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_FaultSequenceType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.FaultSequence.faultSequenceName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_FaultSequenceName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_FaultSequenceName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.Endpoint.endpointType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_EndpointType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_EndpointType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.Endpoint.endpointName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_EndpointName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_EndpointName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.Properties.mainSequence == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_MainSequence().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_MainSequence().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.Wsdl.wsdlType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_WsdlType().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getProxyService_WsdlType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.Wsdl.preservePolicy == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_PreservePolicy().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyService_PreservePolicy().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.Wsdl.wsdlXML == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_WsdlXML().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getProxyService_WsdlXML().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyService.Wsdl.wsdlURL == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyService_WsdlURL().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getProxyService_WsdlURL().getEAttributeType(), newValue);
                }
