 ...
 * 
 */
public class AggregateMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, AggregateMediatorPropertiesEditionPart {
     ...
     */
    public AggregateMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = aggregateMediatorStep
                .addStep(EsbViewsRepository.AggregateMediator.Properties.class);
        // Start of user code
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.AggregateMediator.Properties.description,
                EsbMessages.AggregateMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.AggregateMediator.Properties.description, PropertiesEditionEvent.COMMIT,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AggregateMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AggregateMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.AggregateMediator.Properties.commentsList,
                        EsbMessages.AggregateMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "AggregateMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AggregateMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.AggregateMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.AggregateMediator.Properties.reverse,
                        EsbMessages.AggregateMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AggregateMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.AggregateMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AggregateMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAggregateIDText(FormToolkit widgetFactory, Composite parent) {
        Control aggregateIDLabel = createDescription(parent,
                EsbViewsRepository.AggregateMediator.Properties.aggregateID,
                EsbMessages.AggregateMediatorPropertiesEditionPart_AggregateIDLabel);
        ...
        aggregateID.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AggregateMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.AggregateMediator.Properties.aggregateID, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, aggregateID.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AggregateMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AggregateMediator.Properties.aggregateID,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
        ...
        Control aggregateIDHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.AggregateMediator.Properties.aggregateID,
    ...
    protected Composite createCompletionTimeoutText(FormToolkit widgetFactory, Composite parent) {
        ...
        Control completionTimeoutLabel = createDescription(completeConditionSubGroup,
                EsbViewsRepository.AggregateMediator.Properties.completionTimeout,
                EsbMessages.AggregateMediatorPropertiesEditionPart_CompletionTimeoutLabel);
        ...
        Control completionTimeoutHelp = FormUtils.createHelpButton(widgetFactory, completeConditionSubGroup,
    ...
    protected Composite createCompletionMinMessagesTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control completionMinMessagesTypeLabel = createDescription(completeConditionSubGroup,
                EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesType,
                EsbMessages.AggregateMediatorPropertiesEditionPart_CompletionMinMessagesTypeLabel);
                ...
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AggregateMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesType,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    getCompletionMinMessagesType()));
            }

        });
        completionMinMessagesType.setID(EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesType);
        Control completionMinMessagesTypeHelp = FormUtils.createHelpButton(widgetFactory, completeConditionSubGroup,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesType,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createCompletionMinMessagesTypeEMFComboViewer
        completionMinMessagesTypeElements = new Control[] { completionMinMessagesTypeLabel,
                completionMinMessagesType.getCombo(), completionMinMessagesTypeHelp };
        completionMinMessagesType.addSelectionChangedListener(new ISelectionChangedListener() {
    ...
    protected Composite createCompletionMaxMessagesTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control completionMaxMessagesTypeLabel = createDescription(completeConditionSubGroup,
                EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesType,
                EsbMessages.AggregateMediatorPropertiesEditionPart_CompletionMaxMessagesTypeLabel);
                ...
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AggregateMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesType,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    getCompletionMaxMessagesType()));
            }

        });
        completionMaxMessagesType.setID(EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesType);
        Control completionMaxMessagesTypeHelp = FormUtils.createHelpButton(widgetFactory, completeConditionSubGroup,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesType,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createCompletionMaxMessagesTypeEMFComboViewer
        completionMaxMessagesTypeElements = new Control[] { completionMaxMessagesTypeLabel,
                completionMaxMessagesType.getCombo(), completionMaxMessagesTypeHelp };
        completionMaxMessagesType.addSelectionChangedListener(new ISelectionChangedListener() {
    ...
    protected Composite createCompletionMinMessagesValueText(FormToolkit widgetFactory, Composite parent) {
        Control completionMinMessagesValueLabel = createDescription(completeConditionSubGroup,
                EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesValue, "Completion Min Messages");
                ...
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AggregateMediatorPropertiesEditionPartForm.this,
                                    ...
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    completionMinMessagesValue.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AggregateMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesValue,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
        ...
        EditingUtils.setID(completionMinMessagesValue,
                EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesValue);
        EditingUtils.setEEFtype(completionMinMessagesValue, "eef::Text"); //$NON-NLS-1$
        Control completionMinMessagesValueHelp = FormUtils.createHelpButton(widgetFactory, completeConditionSubGroup,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesValue,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createCompletionMinMessagesValueText
        completionMinMessagesValueElements = new Control[] { completionMinMessagesValueLabel,
                completionMinMessagesValue, completionMinMessagesValueHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createCompletionMaxMessagesValueText(FormToolkit widgetFactory, Composite parent) {
        Control completionMaxMessagesValueLabel = createDescription(completeConditionSubGroup,
                EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesValue, "Completion Max Messages");
                ...
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AggregateMediatorPropertiesEditionPartForm.this,
                                    ...
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    completionMaxMessagesValue.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AggregateMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesValue,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
        ...
        EditingUtils.setID(completionMaxMessagesValue,
                EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesValue);
        EditingUtils.setEEFtype(completionMaxMessagesValue, "eef::Text"); //$NON-NLS-1$
        Control completionMaxMessagesValueHelp = FormUtils.createHelpButton(widgetFactory, completeConditionSubGroup,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesValue,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createCompletionMaxMessagesValueText
        completionMaxMessagesValueElements = new Control[] { completionMaxMessagesValueLabel,
                completionMaxMessagesValue, completionMaxMessagesValueHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control sequenceTypeLabel = createDescription(parent,
                EsbViewsRepository.AggregateMediator.OnComplete.sequenceType,
                EsbMessages.AggregateMediatorPropertiesEditionPart_SequenceTypeLabel);
        ...
        sequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AggregateMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.AggregateMediator.OnComplete.sequenceType, PropertiesEditionEvent.COMMIT,
        ...
        Control sequenceTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.AggregateMediator.OnComplete.sequenceType,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createEnclosingElementPropertyText(FormToolkit widgetFactory, Composite parent) {
        Control enclosingElementPropertyLabel = createDescription(parent,
                EsbViewsRepository.AggregateMediator.Properties.enclosingElementProperty,
                EsbMessages.AggregateMediatorPropertiesEditionPart_EnclosingElementPropertyLabel);
                ...
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AggregateMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AggregateMediator.Properties.enclosingElementProperty,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    enclosingElementProperty.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AggregateMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AggregateMediator.Properties.enclosingElementProperty,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
        ...
        EditingUtils.setID(enclosingElementProperty,
                EsbViewsRepository.AggregateMediator.Properties.enclosingElementProperty);
        EditingUtils.setEEFtype(enclosingElementProperty, "eef::Text"); //$NON-NLS-1$
        Control enclosingElementPropertyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AggregateMediator.Properties.enclosingElementProperty,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createEnclosingElementPropertyText
        enclosingElementElements = new Control[] { enclosingElementPropertyLabel, enclosingElementProperty,
                enclosingElementPropertyHelp };
    ...
    protected Composite createOnCompleteGroup(FormToolkit widgetFactory, final Composite parent) {
        Section onCompleteSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AggregateMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AggregateMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
    public void setCommentsList(EList newValue) {
        ...
        boolean eefElementEditorReadOnlyState = isReadOnly(
                EsbViewsRepository.AggregateMediator.Properties.commentsList);
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AggregateMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AggregateMediatorPropertiesEditionPart#setAggregateID(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AggregateMediatorPropertiesEditionPart#setCompletionTimeout(String
     *      newValue)
     * 
     */
    ...
    public Enumerator getCompletionMinMessagesType() {
        Enumerator selection = (Enumerator) ((StructuredSelection) completionMinMessagesType.getSelection())
                .getFirstElement();
        return selection;
    }
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AggregateMediatorPropertiesEditionPart#initCompletionMinMessagesType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AggregateMediatorPropertiesEditionPart#setCompletionMinMessagesType(Enumerator
     *      newValue)
     * 
     */
    ...
    public Enumerator getCompletionMaxMessagesType() {
        Enumerator selection = (Enumerator) ((StructuredSelection) completionMaxMessagesType.getSelection())
                .getFirstElement();
        return selection;
    }
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AggregateMediatorPropertiesEditionPart#initCompletionMaxMessagesType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AggregateMediatorPropertiesEditionPart#setCompletionMaxMessagesType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AggregateMediatorPropertiesEditionPart#setCompletionMinMessagesValue(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AggregateMediatorPropertiesEditionPart#setCompletionMaxMessagesValue(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AggregateMediatorPropertiesEditionPart#initSequenceType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AggregateMediatorPropertiesEditionPart#setSequenceType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AggregateMediatorPropertiesEditionPart#setEnclosingElementProperty(String
     *      newValue)
     * 
     */
    ...
    protected Composite createsequenceKeyWidget(FormToolkit widgetFactory, Composite parent) {
        Control sequenceKeyLabel = createDescription(parent,
                ...
                EsbMessages.AggregateMediatorPropertiesEditionPart_SequenceKeyLabel);
        widgetFactory.paintBordersFor(parent);
        if (sequenceKey == null) {
        ...
        Control sequenceKeyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.AggregateMediator.OnComplete.sequenceKey,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAggregationExpressionWidget(FormToolkit widgetFactory, final Composite parent) {
        Control aggregationExpressionLabel = createDescription(parent,
                EsbViewsRepository.AggregateMediator.OnComplete.aggregationExpression,
                EsbMessages.AggregateMediatorPropertiesEditionPart_AggregationExpressionLabel);
        widgetFactory.paintBordersFor(parent);
        if (aggregationExpression == null) {
            aggregationExpression = EsbFactoryImpl.eINSTANCE.createNamespacedProperty();
        }
        String initValueExpression = aggregationExpression.getPropertyValue().isEmpty() ? "/default/expression"
                : aggregationExpression.getPropertyValue();
        ...
        aggregationExpressionText.addMouseListener(new MouseAdapter() {
            ...
            public void mouseDown(MouseEvent event) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        AggregateMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.AggregateMediator.OnComplete.aggregationExpression,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getAggregationExpression()));
            }
        ...
        EditingUtils.setID(aggregationExpressionText,
                EsbViewsRepository.AggregateMediator.OnComplete.aggregationExpression);
        EditingUtils.setEEFtype(aggregationExpressionText, "eef::Text");
        Control aggregationExpressionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AggregateMediator.OnComplete.aggregationExpression,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createCompletionMaxMessagesExpressionWidget(FormToolkit widgetFactory, final Composite parent) {
        Control completionMaxMessagesExpressionLabel = createDescription(completeConditionSubGroup,
                EsbViewsRepository.AggregateMediator.Properties.completionMaxMessages, "Completion Max Messages");
        widgetFactory.paintBordersFor(completeConditionSubGroup);
        if (completionMaxMessagesExpression == null) {
            completionMaxMessagesExpression = EsbFactoryImpl.eINSTANCE.createNamespacedProperty();
        }
        String initValueExpression = completionMaxMessagesExpression.getPropertyValue().isEmpty() ? ""
                : completionMaxMessagesExpression.getPropertyValue();
        completionMaxMessagesText = widgetFactory.createText(completeConditionSubGroup, initValueExpression,
                SWT.READ_ONLY);
        ...
        EditingUtils.setID(completionMaxMessagesText,
                EsbViewsRepository.AggregateMediator.Properties.completionMaxMessages);
        EditingUtils.setEEFtype(completionMaxMessagesText, "eef::Text");
        Control completionMaxMessagesHelp = FormUtils.createHelpButton(widgetFactory, completeConditionSubGroup,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AggregateMediator.Properties.completionMaxMessages,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        completionMaxMessagesExpressionElements = new Control[] { completionMaxMessagesExpressionLabel,
                completionMaxMessagesText, completionMaxMessagesHelp };
        return parent;
    }

    protected Composite createCompletionMinMessagesExpressionWidget(FormToolkit widgetFactory, final Composite parent) {
        Control completionMinMessagesExpressionLabel = createDescription(completeConditionSubGroup,
                EsbViewsRepository.AggregateMediator.Properties.completionMinMessages, "Completion Min Messages");
        widgetFactory.paintBordersFor(completeConditionSubGroup);
        if (completionMinMessagesExpression == null) {
            completionMinMessagesExpression = EsbFactoryImpl.eINSTANCE.createNamespacedProperty();
        }
        String initValueExpression = completionMinMessagesExpression.getPropertyValue().isEmpty() ? ""
                : completionMinMessagesExpression.getPropertyValue();
        completionMinMessagesText = widgetFactory.createText(completeConditionSubGroup, initValueExpression,
                SWT.READ_ONLY);
        ...
        EditingUtils.setID(completionMinMessagesText,
                EsbViewsRepository.AggregateMediator.Properties.completionMinMessages);
        EditingUtils.setEEFtype(completionMinMessagesText, "eef::Text");
        Control completionMinMessagesHelp = FormUtils.createHelpButton(widgetFactory, completeConditionSubGroup,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AggregateMediator.Properties.completionMinMessages,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        completionMinMessagesExpressionElements = new Control[] { completionMinMessagesExpressionLabel,
                completionMinMessagesText, completionMinMessagesHelp };
        return parent;
    }

    protected Composite createCorrelationExpressionWidget(FormToolkit widgetFactory, final Composite parent) {
        Control correlationExpressionLabel = createDescription(parent,
                EsbViewsRepository.AggregateMediator.Properties.correlationExpression,
                EsbMessages.AggregateMediatorPropertiesEditionPart_CorrelationExpressionLabel);
        widgetFactory.paintBordersFor(parent);
        if (correlationExpression == null) {
            correlationExpression = EsbFactoryImpl.eINSTANCE.createNamespacedProperty();
        }
        String initValueExpression = correlationExpression.getPropertyValue().isEmpty() ? ""
                : correlationExpression.getPropertyValue();
        ...
        correlationExpressionText.addMouseListener(new MouseAdapter() {
            ...
            public void mouseDown(MouseEvent event) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        AggregateMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.AggregateMediator.Properties.correlationExpression,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getCorrelationExpression()));
            }
        ...
        EditingUtils.setID(correlationExpressionText,
                EsbViewsRepository.AggregateMediator.Properties.correlationExpression);
        EditingUtils.setEEFtype(correlationExpressionText, "eef::Text");
        Control correlationExpressionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AggregateMediator.Properties.correlationExpression,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        correlationExpressionElements = new Control[] { correlationExpressionLabel, correlationExpressionText,
                correlationExpressionHelp };
        return parent;
    }
