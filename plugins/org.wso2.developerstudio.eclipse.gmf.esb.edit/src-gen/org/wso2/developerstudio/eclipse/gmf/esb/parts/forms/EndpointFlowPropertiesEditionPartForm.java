 ...
 * 
 */
public class EndpointFlowPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, EndpointFlowPropertiesEditionPart {
     ...
     */
    public EndpointFlowPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        endpointFlowStep.addStep(EsbViewsRepository.EndpointFlow.Properties.class)
    ...
    protected Composite createChildrenTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.children = new ReferencesTable(getDescription(EsbViewsRepository.EndpointFlow.Properties.children,
                EsbMessages.EndpointFlowPropertiesEditionPart_ChildrenLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(EndpointFlowPropertiesEditionPartForm.this,
                                        EsbViewsRepository.EndpointFlow.Properties.children,
        ...
        this.children.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EndpointFlow.Properties.children, EsbViewsRepository.FORM_KIND));
        ...
        this.children.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(EndpointFlowPropertiesEditionPartForm.this,
                                    EsbViewsRepository.EndpointFlow.Properties.children, PropertiesEditionEvent.CHANGE,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EndpointFlowPropertiesEditionPart#initChildren(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EndpointFlowPropertiesEditionPart#addFilterChildren(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EndpointFlowPropertiesEditionPart#addBusinessFilterChildren(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EndpointFlowPropertiesEditionPart#isContainedInChildrenTable(EObject
     *      element)
     * 
     */
