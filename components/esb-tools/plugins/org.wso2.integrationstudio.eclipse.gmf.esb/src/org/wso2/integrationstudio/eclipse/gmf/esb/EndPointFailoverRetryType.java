 ...
 * <!-- end-user-doc -->
 * @see org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage#getEndPointFailoverRetryType()
 * @model
 * @generated
 */
public enum EndPointFailoverRetryType implements Enumerator {
    /**
     ...
     * @ordered
     */
    RETRY_ERROR_CODES(0, "RETRY_ERROR_CODES", "RETRY_ERROR_CODES"),
     ...
     * @ordered
     */
    NON_RETRY_ERROR_CODES(1, "NON_RETRY_ERROR_CODES", "NON_RETRY_ERROR_CODES");

    /**
     * The '<em><b>RETRY ERROR CODES</b></em>' literal value.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>RETRY ERROR CODES</b></em>' literal object isn't clear,
     ...
     * @ordered
     */
    public static final int RETRY_ERROR_CODES_VALUE = 0;

    /**
     * The '<em><b>NON RETRY ERROR CODES</b></em>' literal value.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>NON RETRY ERROR CODES</b></em>' literal object isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     ...
     * @ordered
     */
    public static final int NON_RETRY_ERROR_CODES_VALUE = 1;
     ...
     * @generated
     */
    public static EndPointFailoverRetryType get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            EndPointFailoverRetryType result = VALUES_ARRAY[i];
     ...
     * @generated
     */
    public static EndPointFailoverRetryType getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            EndPointFailoverRetryType result = VALUES_ARRAY[i];
