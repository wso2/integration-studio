 ...
 * 
 */
public class ValidateMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ValidateMediatorPropertiesEditionPart {
     ...
     */
    public ValidateMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = validateMediatorStep
                .addStep(EsbViewsRepository.ValidateMediator.Properties.class);
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.ValidateMediator.Properties.description,
                EsbMessages.ValidateMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.ValidateMediator.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ValidateMediatorPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ValidateMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control descriptionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.ValidateMediator.Properties.description,
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ValidateMediator.Properties.commentsList,
                        EsbMessages.ValidateMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "ValidateMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ValidateMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ValidateMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ValidateMediator.Properties.reverse,
                        EsbMessages.ValidateMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ValidateMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ValidateMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFeaturesTableComposition(FormToolkit widgetFactory, Composite parent) {
        filterFeaturesSubPropertiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent, "Features",
                true);
        Control[] previousControls = filterFeaturesSubPropertiesGroup.getChildren();
        this.features = new ReferencesTable(
                getDescription(EsbViewsRepository.ValidateMediator.Properties.features,
                        EsbMessages.ValidateMediatorPropertiesEditionPart_FeaturesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ValidateMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.ValidateMediator.Properties.features,
        ...
        this.features.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ValidateMediator.Properties.features, EsbViewsRepository.FORM_KIND));
        ...
        this.features.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ValidateMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ValidateMediator.Properties.features, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createSchemasTableComposition(FormToolkit widgetFactory, Composite parent) {
        filterSchemasSubPropertiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent, "Schemas",
                true);
        Control[] previousControls = filterSchemasSubPropertiesGroup.getChildren();
        this.schemas = new ReferencesTable(getDescription(EsbViewsRepository.ValidateMediator.Properties.schemas,
                EsbMessages.ValidateMediatorPropertiesEditionPart_SchemasLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ValidateMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.ValidateMediator.Properties.schemas,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
                        schemas.refresh();
                    }
        ...
        this.schemas.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ValidateMediator.Properties.schemas, EsbViewsRepository.FORM_KIND));
        ...
        this.schemas.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ValidateMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ValidateMediator.Properties.schemas, PropertiesEditionEvent.CHANGE,
                            PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
    ...
    protected Composite createResourcesTableComposition(FormToolkit widgetFactory, Composite parent) {
        filterResourcesSubPropertiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent,
                "Resources", true);
        Control[] previousControls = filterResourcesSubPropertiesGroup.getChildren();
        this.resources = new ReferencesTable(
                getDescription(EsbViewsRepository.ValidateMediator.Properties.resources,
                        EsbMessages.ValidateMediatorPropertiesEditionPart_ResourcesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ValidateMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.ValidateMediator.Properties.resources,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
                        resources.refresh();
                    }
        ...
        this.resources.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateMediator.Properties.resources, EsbViewsRepository.FORM_KIND));
        ...
        this.resources.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ValidateMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ValidateMediator.Properties.resources, PropertiesEditionEvent.CHANGE,
                            PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
    ...
    protected Composite createEnableCacheSchemaCheckbox(FormToolkit widgetFactory, Composite parent) {
        enableCacheSchema = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ValidateMediator.Properties.enableCacheSchema,
                        EsbMessages.ValidateMediatorPropertiesEditionPart_EnableCacheSchemaLabel),
                SWT.CHECK);
        enableCacheSchema.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ValidateMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ValidateMediator.Properties.enableCacheSchema,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(enableCacheSchema.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.ValidateMediator.Properties.enableCacheSchema, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#initFeatures(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#addFilterFeatures(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#addBusinessFilterFeatures(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#isContainedInFeaturesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#initSchemas(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#addFilterSchemas(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#addBusinessFilterSchemas(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#isContainedInSchemasTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#initResources(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#addFilterResources(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#addBusinessFilterResources(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#isContainedInResourcesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateMediatorPropertiesEditionPart#setEnableCacheSchema(Boolean
     *      newValue)
     * 
     */
    ...
    private void openSourceWidgetNamespacedPropertyEditor(final Composite parent) {
        ...
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                ValidateMediatorPropertiesEditionPartForm.this, EsbViewsRepository.ValidateMediator.Properties.source,
