...
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigureReplaceOperatorDialog;

public class ReplaceConfigureAction extends AbstractActionHandler {
	...
	protected void doRun(IProgressMonitor progressMonitor) {
		...
		Dialog configureMatchDialog = new ConfigureReplaceOperatorDialog(Display.getDefault().getActiveShell(),
				(Replace) selectedObj, getEditingDomain(), selectedEP);
