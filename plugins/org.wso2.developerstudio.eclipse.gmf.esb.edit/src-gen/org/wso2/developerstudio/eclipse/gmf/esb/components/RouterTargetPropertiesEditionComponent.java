...
public class RouterTargetPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public RouterTargetPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject routerTarget,
            String editing_mode) {
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractCommonTarget_SequenceType().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.RouterTarget.Properties.sequenceType))
            ...
            if (EsbPackage.eINSTANCE.getAbstractCommonTarget_Sequence().equals(msg.getFeature()) && basePart != null
                    && isAccessible(EsbViewsRepository.RouterTarget.Properties.sequence))
            ...
            if (EsbPackage.eINSTANCE.getAbstractCommonTarget_EndpointType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.RouterTarget.Properties.endpointType))
