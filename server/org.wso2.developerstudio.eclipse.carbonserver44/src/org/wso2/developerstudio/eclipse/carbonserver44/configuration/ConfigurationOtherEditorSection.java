	...
	public void createSection(Composite parent) {
		...
		startWSASCheck.addSelectionListener(new SelectionAdapter(){
			public void widgetSelected(SelectionEvent arg0) {
				CarbonServer44Utils.setServerStartBrowserPopup(server.getOriginal(),startWSASCheck.getSelection());
			}
		});
		...
		hotupdateCheck.addSelectionListener(new SelectionAdapter(){
			public void widgetSelected(SelectionEvent arg0) {
				CarbonServer44Utils.setServerHotUpdate(server.getOriginal(), hotupdateCheck.getSelection());
			}
		...
		osgiConsoleCheck.addSelectionListener(new SelectionAdapter(){
			public void widgetSelected(SelectionEvent arg0) {
				CarbonServer44Utils.setServerStartWithOSGiConsole(server.getOriginal(),osgiConsoleCheck.getSelection());
			}
		});
...
//		axis2FileMonitor.stopMonitoring();
	...
	protected void initialize() {
		Display.getDefault().asyncExec(new Runnable(){
            public void run() {
            	while(true){
            		Boolean serverConfigMapValue = CarbonServer44Utils.isServerStartBrowserPopup(server.getOriginal());
            		...
            		boolean enableAxis2Hotupdate=CarbonServer44Utils.isServerHotUpdate(server.getOriginal());
            		boolean enableOSGIConsole=CarbonServer44Utils.isServerStartWithOSGiConsole(server.getOriginal());
