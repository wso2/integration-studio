 ...
 * 
 */
public class LoadBalanceEndPointPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, LoadBalanceEndPointPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LoadBalanceEndPointPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(LoadBalanceEndPointPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.LoadBalanceEndPoint.Properties.description,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.commentsList,
    ...
    protected Composite createEndPointNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.LoadBalanceEndPoint.Properties.endPointName, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAnonymousCheckbox(Composite parent) {
        ...
        anonymous.setText(getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.anonymous,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.anonymous, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInLineCheckbox(Composite parent) {
        ...
        inLine.setText(getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.inLine,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.inLine, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(Composite parent) {
        ...
        duplicate.setText(getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.duplicate,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.duplicate, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesAdvancedTableComposition(Composite parent) {
        ...
        this.properties.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.properties_, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createReversedCheckbox(Composite parent) {
        ...
        reversed.setText(getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.reversed,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.reversed, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createChildrenAdvancedTableComposition(Composite parent) {
        ...
        this.children.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.children, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.name, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFailoverCheckbox(Composite parent) {
        ...
        failover.setText(getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.failover,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.failover, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPolicyText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.policy, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutputConnectorAdvancedTableComposition(Composite parent) {
        ...
        this.outputConnector.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.outputConnector, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createSessionTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAlgorithmText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.algorithm, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSessionTimeoutText(Composite parent) {
        createDescription(parent, EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionTimeout,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionTimeout, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createBuildMessageCheckbox(Composite parent) {
        ...
        buildMessage.setText(getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.buildMessage,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.LoadBalanceEndPoint.Properties.buildMessage, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createMembersAdvancedTableComposition(Composite parent) {
        ...
        this.members.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.members, EsbViewsRepository.SWT_KIND));
