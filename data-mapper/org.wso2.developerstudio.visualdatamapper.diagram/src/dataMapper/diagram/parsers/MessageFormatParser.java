package dataMapper.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(dataMapper.diagram.part.DataMapperDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE, NLS.bind(
							dataMapper.diagram.part.Messages.MessageFormatParser_InvalidInputError,
