 ...
 * @generated
 */
public class FailoverEndPointEndPointNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
        ...
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.FailoverEndPoint_3611, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.FailoverEndPointEndPointNameEditPart.VISUAL_ID));
        }
        return parser;
    }
