 ...
 * 
 */
public class MessageStorePropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, MessageStorePropertiesEditionPart {
     ...
     */
    public MessageStorePropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.description,
                EsbMessages.MessageStorePropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.MessageStore.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.MessageStore.Properties.commentsList,
                        EsbMessages.MessageStorePropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "MessageStore", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createStoreNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.storeName,
                EsbMessages.MessageStorePropertiesEditionPart_StoreNameLabel);
        ...
        storeName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.storeName, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, storeName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.storeName, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, storeName.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.storeName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStoreTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.storeType,
                EsbMessages.MessageStorePropertiesEditionPart_StoreTypeLabel);
        ...
        storeType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.storeType, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getStoreType()));
            }

        });
        storeType.setID(EsbViewsRepository.MessageStore.Properties.storeType);
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.storeType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInitialContextFactoryText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.initialContextFactory,
                EsbMessages.MessageStorePropertiesEditionPart_InitialContextFactoryLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.MessageStore.Properties.initialContextFactory, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createProviderURLText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.providerURL,
                EsbMessages.MessageStorePropertiesEditionPart_ProviderURLLabel);
        ...
        providerURL.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.providerURL, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, providerURL.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.providerURL, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJndiQueueNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.jndiQueueName,
                EsbMessages.MessageStorePropertiesEditionPart_JndiQueueNameLabel);
        ...
        jndiQueueName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.jndiQueueName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, jndiQueueName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.jndiQueueName,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    jndiQueueName.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jndiQueueName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createConnectionFactoryText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.connectionFactory,
                EsbMessages.MessageStorePropertiesEditionPart_ConnectionFactoryLabel);
        ...
        connectionFactory.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.connectionFactory, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, connectionFactory.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.connectionFactory,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    connectionFactory.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.connectionFactory, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createUserNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.userName,
                EsbMessages.MessageStorePropertiesEditionPart_UserNameLabel);
        ...
        userName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.userName, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, userName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.userName, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, userName.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.userName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPasswordText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.password,
                EsbMessages.MessageStorePropertiesEditionPart_PasswordLabel);
        ...
        password.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.password, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, password.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.password, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, password.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.password, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCacheConnectionCheckbox(FormToolkit widgetFactory, Composite parent) {
        cacheConnection = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.MessageStore.Properties.cacheConnection,
                        EsbMessages.MessageStorePropertiesEditionPart_CacheConnectionLabel),
                SWT.CHECK);
        cacheConnection.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.cacheConnection, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new Boolean(cacheConnection.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.cacheConnection, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJmsSpecVersionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.jmsSpecVersion,
                EsbMessages.MessageStorePropertiesEditionPart_JmsSpecVersionLabel);
        ...
        jmsSpecVersion.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.jmsSpecVersion, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getJmsSpecVersion()));
            }

        });
        jmsSpecVersion.setID(EsbViewsRepository.MessageStore.Properties.jmsSpecVersion);
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jmsSpecVersion, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEnableCachingCheckbox(FormToolkit widgetFactory, Composite parent) {
        enableCaching = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.MessageStore.Properties.enableCaching,
                        EsbMessages.MessageStorePropertiesEditionPart_EnableCachingLabel),
                SWT.CHECK);
        enableCaching.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.enableCaching, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new Boolean(enableCaching.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.enableCaching, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createProviderClassText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.providerClass,
                EsbMessages.MessageStorePropertiesEditionPart_ProviderClassLabel);
        ...
        providerClass.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.providerClass, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, providerClass.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.providerClass,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    providerClass.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.providerClass, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRabbitMQServerHostNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.rabbitMQServerHostName,
                EsbMessages.MessageStorePropertiesEditionPart_RabbitMQServerHostNameLabel);
                ...
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    ...
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    rabbitMQServerHostName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.rabbitMQServerHostName,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.rabbitMQServerHostName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRabbitMQServerHostPortText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.rabbitMQServerHostPort,
                EsbMessages.MessageStorePropertiesEditionPart_RabbitMQServerHostPortLabel);
                ...
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    ...
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    rabbitMQServerHostPort.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.rabbitMQServerHostPort,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.rabbitMQServerHostPort, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRabbitMQQueueNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.rabbitMQQueueName,
                EsbMessages.MessageStorePropertiesEditionPart_RabbitMQQueueNameLabel);
        ...
        rabbitMQQueueName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.rabbitMQQueueName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, rabbitMQQueueName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.rabbitMQQueueName,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    rabbitMQQueueName.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.rabbitMQQueueName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRabbitMQExchangeNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.rabbitMQExchangeName,
                EsbMessages.MessageStorePropertiesEditionPart_RabbitMQExchangeNameLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.MessageStore.Properties.rabbitMQExchangeName, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRoutingKeyText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.routingKey,
                EsbMessages.MessageStorePropertiesEditionPart_RoutingKeyLabel);
        ...
        routingKey.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.routingKey, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, routingKey.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.routingKey, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, routingKey.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.routingKey, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRabbitMQUserNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.rabbitMQUserName,
                EsbMessages.MessageStorePropertiesEditionPart_RabbitMQUserNameLabel);
        ...
        rabbitMQUserName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.rabbitMQUserName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, rabbitMQUserName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.rabbitMQUserName,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    rabbitMQUserName.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.rabbitMQUserName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRabbitMQPasswordText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.rabbitMQPassword,
                EsbMessages.MessageStorePropertiesEditionPart_RabbitMQPasswordLabel);
        ...
        rabbitMQPassword.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.rabbitMQPassword, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, rabbitMQPassword.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.rabbitMQPassword,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    rabbitMQPassword.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.rabbitMQPassword, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createVirtualHostText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.virtualHost,
                EsbMessages.MessageStorePropertiesEditionPart_VirtualHostLabel);
        ...
        virtualHost.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.virtualHost, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, virtualHost.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.virtualHost, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJdbcDatabaseTableText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.jdbcDatabaseTable,
                EsbMessages.MessageStorePropertiesEditionPart_JdbcDatabaseTableLabel);
        ...
        jdbcDatabaseTable.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.jdbcDatabaseTable, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, jdbcDatabaseTable.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.jdbcDatabaseTable,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    jdbcDatabaseTable.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jdbcDatabaseTable, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJdbcConnectionInformationEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.jdbcConnectionInformation,
                EsbMessages.MessageStorePropertiesEditionPart_JdbcConnectionInformationLabel);
        ...
        jdbcConnectionInformation.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.jdbcConnectionInformation,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    getJdbcConnectionInformation()));
            }
    ...
    protected Composite createJdbcDriverText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.jdbcDriver,
                EsbMessages.MessageStorePropertiesEditionPart_JdbcDriverLabel);
        ...
        jdbcDriver.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.jdbcDriver, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, jdbcDriver.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.jdbcDriver, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, jdbcDriver.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jdbcDriver, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJdbcURLText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.jdbcURL,
                EsbMessages.MessageStorePropertiesEditionPart_JdbcURLLabel);
        ...
        jdbcURL.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.jdbcURL, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, jdbcURL.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.jdbcURL, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, jdbcURL.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jdbcURL, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJdbcUserText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.jdbcUser,
                EsbMessages.MessageStorePropertiesEditionPart_JdbcUserLabel);
        ...
        jdbcUser.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.jdbcUser, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, jdbcUser.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.jdbcUser, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, jdbcUser.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jdbcUser, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJdbcPasswordText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.jdbcPassword,
                EsbMessages.MessageStorePropertiesEditionPart_JdbcPasswordLabel);
        ...
        jdbcPassword.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.jdbcPassword, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, jdbcPassword.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.jdbcPassword,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    jdbcPassword.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jdbcPassword, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJdbcDatasourceNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.jdbcDatasourceName,
                EsbMessages.MessageStorePropertiesEditionPart_JdbcDatasourceNameLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jdbcDatasourceName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createParametersTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.parameters = new ReferencesTable(getDescription(EsbViewsRepository.MessageStore.Properties.parameters,
                EsbMessages.MessageStorePropertiesEditionPart_ParametersLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                        EsbViewsRepository.MessageStore.Properties.parameters,
        ...
        this.parameters.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.MessageStore.Properties.parameters, EsbViewsRepository.FORM_KIND));
        ...
        this.parameters.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.parameters, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createEnableProducerGuaranteedDeliveryCheckbox(FormToolkit widgetFactory, Composite parent) {
        enableProducerGuaranteedDelivery = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.MessageStore.Properties.enableProducerGuaranteedDelivery,
                        EsbMessages.MessageStorePropertiesEditionPart_EnableProducerGuaranteedDeliveryLabel),
                SWT.CHECK);
        enableProducerGuaranteedDelivery.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.enableProducerGuaranteedDelivery,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(enableProducerGuaranteedDelivery.getSelection())));
            }
        ...
        EditingUtils.setID(enableProducerGuaranteedDelivery,
                EsbViewsRepository.MessageStore.Properties.enableProducerGuaranteedDelivery);
    ...
    protected Composite createFailoverMessageStoreText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.failoverMessageStore,
                EsbMessages.MessageStorePropertiesEditionPart_FailoverMessageStoreLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.MessageStore.Properties.failoverMessageStore, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createResequencepollingText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.resequencepolling,
                EsbMessages.MessageStorePropertiesEditionPart_ResequencepollingLabel);
        ...
        resequencepolling.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.resequencepolling, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, resequencepolling.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.resequencepolling,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    resequencepolling.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.resequencepolling, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResequenceDatabaseTableText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.resequenceDatabaseTable,
                EsbMessages.MessageStorePropertiesEditionPart_ResequenceDatabaseTableLabel);
                ...
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    ...
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    resequenceDatabaseTable.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.resequenceDatabaseTable,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
     ...
     * @generated NOT
     */
    protected Composite createResequenceConnectionInformationEMFComboViewer(FormToolkit widgetFactory,
            Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.resequenceConnectionInformation,
                EsbMessages.MessageStorePropertiesEditionPart_ResequenceConnectionInformationLabel);
        ...
        resequenceConnectionInformation.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.resequenceConnectionInformation,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    getResequenceConnectionInformation()));
            }

        });
        resequenceConnectionInformation
                .setID(EsbViewsRepository.MessageStore.Properties.resequenceConnectionInformation);
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.MessageStore.Properties.resequenceConnectionInformation,
                        EsbViewsRepository.FORM_KIND),
    ...
    protected Composite createResequenceDriverText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.resequenceDriver,
                EsbMessages.MessageStorePropertiesEditionPart_ResequenceDriverLabel);
        ...
        resequenceDriver.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.resequenceDriver, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, resequenceDriver.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.resequenceDriver,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    resequenceDriver.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.resequenceDriver, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResequenceURLText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.resequenceURL,
                EsbMessages.MessageStorePropertiesEditionPart_ResequenceURLLabel);
        ...
        resequenceURL.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.resequenceURL, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, resequenceURL.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.resequenceURL,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    resequenceURL.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.resequenceURL, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResequenceUserText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.resequenceUser,
                EsbMessages.MessageStorePropertiesEditionPart_ResequenceUserLabel);
        ...
        resequenceUser.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.resequenceUser, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, resequenceUser.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.resequenceUser,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    resequenceUser.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.resequenceUser, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResequencePasswordText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.resequencePassword,
                EsbMessages.MessageStorePropertiesEditionPart_ResequencePasswordLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.resequencePassword, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResequenceDatasourceNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.resequenceDatasourceName,
                EsbMessages.MessageStorePropertiesEditionPart_ResequenceDatasourceNameLabel);
                ...
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    ...
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    resequenceDatasourceName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.resequenceDatasourceName,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
        ...
        EditingUtils.setID(resequenceDatasourceName,
                EsbViewsRepository.MessageStore.Properties.resequenceDatasourceName);
    ...
    protected Composite createResequenceXpathText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.resequenceXpath,
                EsbMessages.MessageStorePropertiesEditionPart_ResequenceXpathLabel);
        ...
        resequenceXpath.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.resequenceXpath, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, resequenceXpath.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MessageStore.Properties.resequenceXpath,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    resequenceXpath.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.resequenceXpath, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResequenceXpathAttrFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
        createDescription(parent, EsbViewsRepository.MessageStore.Properties.resequenceXpathAttr,
                EsbMessages.MessageStorePropertiesEditionPart_ResequenceXpathAttrLabel);
        resequenceXpathAttr = new EObjectFlatComboViewer(parent,
                !propertiesEditionComponent.isRequired(EsbViewsRepository.MessageStore.Properties.resequenceXpathAttr,
                        EsbViewsRepository.FORM_KIND));
        ...
        resequenceXpathAttr.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartForm.this,
                            EsbViewsRepository.MessageStore.Properties.resequenceXpathAttr,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getResequenceXpathAttr()));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.MessageStore.Properties.resequenceXpathAttr, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setStoreName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#initStoreType(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setStoreType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setInitialContextFactory(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setProviderURL(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setJndiQueueName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setConnectionFactory(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setUserName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setPassword(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setCacheConnection(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#initJmsSpecVersion(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setJmsSpecVersion(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setEnableCaching(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setProviderClass(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setRabbitMQServerHostName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setRabbitMQServerHostPort(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setRabbitMQQueueName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setRabbitMQExchangeName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setRoutingKey(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setRabbitMQUserName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setRabbitMQPassword(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setVirtualHost(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setJdbcDatabaseTable(String
     *      newValue)
     * 
     */
    ...
    public Enumerator getJdbcConnectionInformation() {
        Enumerator selection = (Enumerator) ((StructuredSelection) jdbcConnectionInformation.getSelection())
                .getFirstElement();
        return selection;
    }
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#initJdbcConnectionInformation(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setJdbcConnectionInformation(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setJdbcDriver(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setJdbcUser(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setJdbcPassword(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setJdbcDatasourceName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#initParameters(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#addFilterParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#addBusinessFilterParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#isContainedInParametersTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setEnableProducerGuaranteedDelivery(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setFailoverMessageStore(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setResequencepolling(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setResequenceDatabaseTable(String
     *      newValue)
     * 
     */
    ...
    public Enumerator getResequenceConnectionInformation() {
        Enumerator selection = (Enumerator) ((StructuredSelection) resequenceConnectionInformation.getSelection())
                .getFirstElement();
        return selection;
    }
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#initResequenceConnectionInformation(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setResequenceConnectionInformation(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setResequenceDriver(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setResequenceURL(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setResequenceUser(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setResequencePassword(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setResequenceDatasourceName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setResequenceXpath(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setResequenceXpathAttr(EObject
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#setResequenceXpathAttrButtonMode(ButtonsModeEnum
     *      newValue)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#addFilterResequenceXpathAttr(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageStorePropertiesEditionPart#addBusinessFilterResequenceXpathAttr(ViewerFilter
     *      filter)
     * 
     */
