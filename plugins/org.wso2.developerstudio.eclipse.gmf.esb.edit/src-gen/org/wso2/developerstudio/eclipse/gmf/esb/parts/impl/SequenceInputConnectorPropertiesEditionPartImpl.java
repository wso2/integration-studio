 ...
 * 
 */
public class SequenceInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, SequenceInputConnectorPropertiesEditionPart {
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.SequenceInputConnector.Properties.incomingLinks,
        ...
        this.incomingLinks.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SequenceInputConnector.Properties.incomingLinks, EsbViewsRepository.SWT_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SequenceInputConnectorPropertiesEditionPartImpl.this,
    ...
    protected void moveIncomingLinks(EObject element, int oldIndex, int newIndex) {
        propertiesEditionComponent
                .firePropertiesChanged(new PropertiesEditionEvent(SequenceInputConnectorPropertiesEditionPartImpl.this,
                        EsbViewsRepository.SequenceInputConnector.Properties.incomingLinks,
