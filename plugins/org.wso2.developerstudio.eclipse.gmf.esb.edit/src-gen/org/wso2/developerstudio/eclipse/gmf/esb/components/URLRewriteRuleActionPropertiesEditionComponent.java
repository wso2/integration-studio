...
public class URLRewriteRuleActionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public URLRewriteRuleActionPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject uRLRewriteRuleAction, String editing_mode) {
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.URLRewriteRuleAction.Properties.actionValue == event.getAffectedEditor()) {
            uRLRewriteRuleAction.setActionValue((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.URLRewriteRuleAction.Properties.actionRegex == event.getAffectedEditor()) {
            uRLRewriteRuleAction.setActionRegex((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getURLRewriteRuleAction_RuleAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.URLRewriteRuleAction.Properties.ruleAction))
                basePart.setRuleAction((RuleActionType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getURLRewriteRuleAction_RuleFragment().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.URLRewriteRuleAction.Properties.ruleFragment))
                basePart.setRuleFragment((RuleFragmentType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getURLRewriteRuleAction_RuleOption().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.URLRewriteRuleAction.Properties.ruleOption))
                basePart.setRuleOption((RuleOptionType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getURLRewriteRuleAction_ActionValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.URLRewriteRuleAction.Properties.actionValue)) {
            ...
            if (EsbPackage.eINSTANCE.getURLRewriteRuleAction_ActionRegex().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.URLRewriteRuleAction.Properties.actionRegex)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getURLRewriteRuleAction_ActionExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.URLRewriteRuleAction.Properties.actionExpression)) {
                if (msg.getNewValue() != null) {
                ...
                if (EsbViewsRepository.URLRewriteRuleAction.Properties.ruleAction == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getURLRewriteRuleAction_RuleAction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getURLRewriteRuleAction_RuleAction().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.URLRewriteRuleAction.Properties.ruleFragment == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getURLRewriteRuleAction_RuleFragment().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getURLRewriteRuleAction_RuleFragment().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.URLRewriteRuleAction.Properties.ruleOption == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getURLRewriteRuleAction_RuleOption().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getURLRewriteRuleAction_RuleOption().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.URLRewriteRuleAction.Properties.actionValue == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getURLRewriteRuleAction_ActionValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getURLRewriteRuleAction_ActionValue().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.URLRewriteRuleAction.Properties.actionRegex == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getURLRewriteRuleAction_ActionRegex().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getURLRewriteRuleAction_ActionRegex().getEAttributeType(), newValue);
                }
