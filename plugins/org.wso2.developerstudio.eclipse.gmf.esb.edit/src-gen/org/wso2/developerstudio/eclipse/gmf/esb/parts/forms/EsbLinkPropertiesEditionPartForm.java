 ...
 * 
 */
public class EsbLinkPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, EsbLinkPropertiesEditionPart {
	 ...
	 */
	public EsbLinkPropertiesEditionPartForm() { super(); }
	...
	protected Composite createSourceFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		source = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(EsbViewsRepository.EsbLink.Properties.source, EsbViewsRepository.FORM_KIND));
		...
		source.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EsbLinkPropertiesEditionPartForm.this, EsbViewsRepository.EsbLink.Properties.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getSource()));
			}

		});
		source.setID(EsbViewsRepository.EsbLink.Properties.source);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EsbLink.Properties.source, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTargetFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		target = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(EsbViewsRepository.EsbLink.Properties.target, EsbViewsRepository.FORM_KIND));
		...
		target.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EsbLinkPropertiesEditionPartForm.this, EsbViewsRepository.EsbLink.Properties.target, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getTarget()));
			}

		});
		target.setID(EsbViewsRepository.EsbLink.Properties.target);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EsbLink.Properties.target, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbLinkPropertiesEditionPart#setSourceButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbLinkPropertiesEditionPart#addFilterSource(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbLinkPropertiesEditionPart#addBusinessFilterSource(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbLinkPropertiesEditionPart#setTargetButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbLinkPropertiesEditionPart#addFilterTarget(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbLinkPropertiesEditionPart#addBusinessFilterTarget(ViewerFilter filter)
	 * 
	 */
