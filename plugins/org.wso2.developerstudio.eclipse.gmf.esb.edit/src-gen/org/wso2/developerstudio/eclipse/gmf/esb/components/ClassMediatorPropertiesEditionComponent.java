...
public class ClassMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ClassMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject classMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ClassMediator.Properties.className))
                basePart.setClassName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, classMediator.getClassName()));

            if (isAccessible(EsbViewsRepository.ClassMediator.Properties.properties_)) {
                propertiesSettings = new ReferencesTableSettings(classMediator,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ClassMediator.Properties.description == event.getAffectedEditor()) {
            classMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.ClassMediator.Properties.className == event.getAffectedEditor()) {
            classMediator.setClassName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.ClassMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ClassMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ClassMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getClassMediator_ClassName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ClassMediator.Properties.className)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getClassMediator_Properties().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.ClassMediator.Properties.properties_))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getClassMediator_ClassName(),
                EsbPackage.eINSTANCE.getClassMediator_Properties());
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.ClassMediator.Properties.className == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getClassMediator_ClassName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getClassMediator_ClassName().getEAttributeType(), newValue);
                }
