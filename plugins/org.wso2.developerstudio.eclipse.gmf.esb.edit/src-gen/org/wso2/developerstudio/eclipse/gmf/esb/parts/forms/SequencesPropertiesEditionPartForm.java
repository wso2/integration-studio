 ...
 * 
 */
public class SequencesPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, SequencesPropertiesEditionPart {
     ...
     */
    public SequencesPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Sequences.Properties.description,
                EsbMessages.SequencesPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SequencesPropertiesEditionPartForm.this,
                                    EsbViewsRepository.Sequences.Properties.description, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencesPropertiesEditionPartForm.this,
                            EsbViewsRepository.Sequences.Properties.description, PropertiesEditionEvent.FOCUS_CHANGED,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencesPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.Sequences.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.Sequences.Properties.commentsList,
                        EsbMessages.SequencesPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "Sequences", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SequencesPropertiesEditionPartForm.this,
                                    EsbViewsRepository.Sequences.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
        Control nameLabel = createDescription(parent, EsbViewsRepository.Sequences.Properties.name,
                EsbMessages.SequencesPropertiesEditionPart_NameLabel);
        ...
        name.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencesPropertiesEditionPartForm.this, EsbViewsRepository.Sequences.Properties.name,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SequencesPropertiesEditionPartForm.this,
                                    EsbViewsRepository.Sequences.Properties.name, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control nameHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Sequences.Properties.name, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRecieveSequenceCheckbox(FormToolkit widgetFactory, Composite parent) {
        recieveSequence = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.Sequences.Properties.recieveSequence,
                        EsbMessages.SequencesPropertiesEditionPart_RecieveSequenceLabel),
                SWT.CHECK);
        recieveSequence.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencesPropertiesEditionPartForm.this,
                            EsbViewsRepository.Sequences.Properties.recieveSequence, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new Boolean(recieveSequence.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.Sequences.Properties.recieveSequence, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAssociatedProxyMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editAssociatedProxy = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.Sequences.Properties.associatedProxy,
                        EsbMessages.SequencesPropertiesEditionPart_AssociatedProxyLabel),
                SWT.NONE);
        ...
        editAssociatedProxy.addSelectionListener(new SelectionAdapter() {
             ...
             */
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(associatedProxy.getShell(), "Sequences", //$NON-NLS-1$
                        new AdapterFactoryLabelProvider(adapterFactory), associatedProxyList, EsbPackage.eINSTANCE.getSequences_AssociatedProxy().getEType(), null,
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencesPropertiesEditionPartForm.this,
                            EsbViewsRepository.Sequences.Properties.associatedProxy, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new BasicEList(associatedProxyList)));
                    setHasChanged(true);
                }
            }
        });
    ...
    protected Composite createTemplateParametersTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.templateParameters = new ReferencesTable(
                getDescription(EsbViewsRepository.Sequences.Properties.templateParameters,
                        EsbMessages.SequencesPropertiesEditionPart_TemplateParametersLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(SequencesPropertiesEditionPartForm.this,
                                        EsbViewsRepository.Sequences.Properties.templateParameters,
        ...
        this.templateParameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.Sequences.Properties.templateParameters, EsbViewsRepository.FORM_KIND));
        ...
        this.templateParameters.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencesPropertiesEditionPartForm.this,
                            EsbViewsRepository.Sequences.Properties.templateParameters, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createTraceEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        traceEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.Sequences.Properties.traceEnabled,
                        EsbMessages.SequencesPropertiesEditionPart_TraceEnabledLabel),
                SWT.CHECK);
        traceEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SequencesPropertiesEditionPartForm.this,
                                    EsbViewsRepository.Sequences.Properties.traceEnabled, PropertiesEditionEvent.COMMIT,
        ...
        Control traceEnabledHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Sequences.Properties.traceEnabled, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createStatisticsEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        statisticsEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.Sequences.Properties.statisticsEnabled,
                        EsbMessages.SequencesPropertiesEditionPart_StatisticsEnabledLabel),
                SWT.CHECK);
        statisticsEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencesPropertiesEditionPartForm.this,
                            EsbViewsRepository.Sequences.Properties.statisticsEnabled, PropertiesEditionEvent.COMMIT,
        ...
        Control statEnableHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.Sequences.Properties.statisticsEnabled,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencesPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencesPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencesPropertiesEditionPart#setRecieveSequence(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencesPropertiesEditionPart#setAssociatedProxy(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencesPropertiesEditionPart#initTemplateParameters(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencesPropertiesEditionPart#addFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencesPropertiesEditionPart#addBusinessFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencesPropertiesEditionPart#isContainedInTemplateParametersTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencesPropertiesEditionPart#setTraceEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencesPropertiesEditionPart#setStatisticsEnabled(Boolean
     *      newValue)
     * 
     */
    ...
    protected Composite createOnError(FormToolkit widgetFactory, Composite parent) {
        Control onErrorLabel = createDescription(parent, EsbViewsRepository.Sequences.Properties.onError,
        ...
        onErrorText.addMouseListener(new MouseAdapter() {
            ...
            public void mouseDown(MouseEvent event) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        SequencesPropertiesEditionPartForm.this, EsbViewsRepository.Sequences.Properties.onError,
        ...
        Control onErrorHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Sequences.Properties.onError, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
