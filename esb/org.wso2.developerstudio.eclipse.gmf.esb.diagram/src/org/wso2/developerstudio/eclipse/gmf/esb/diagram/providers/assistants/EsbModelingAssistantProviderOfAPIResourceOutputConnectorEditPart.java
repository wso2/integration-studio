 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfAPIResourceOutputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnSource(
			APIResourceOutputConnectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(APIResourceOutputConnectorEditPart) sourceEditPart,
				targetEditPart);
	}
