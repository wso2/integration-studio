...
public class XSLTResourcePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public XSLTResourcePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject xSLTResource,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.XSLTResource.Properties.location))
                basePart.setLocation(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, xSLTResource.getLocation()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.XSLTResource.Properties.location == event.getAffectedEditor()) {
            xSLTResource.setLocation((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractLocationKeyResource_Location().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.XSLTResource.Properties.location)) {
