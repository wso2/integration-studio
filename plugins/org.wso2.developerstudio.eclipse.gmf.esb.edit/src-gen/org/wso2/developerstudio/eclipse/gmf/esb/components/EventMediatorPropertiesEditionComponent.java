...
public class EventMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public EventMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject eventMediator,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.EventMediator.Properties.topicType)) {
                basePart.initTopicType(
                        EEFUtils.choiceOfValues(eventMediator, EsbPackage.eINSTANCE.getEventMediator_TopicType()),
                        eventMediator.getTopicType());
            }
            if (isAccessible(EsbViewsRepository.EventMediator.Properties.staticTopic))
                basePart.setStaticTopic(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        eventMediator.getStaticTopic()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.EventMediator.Properties.description == event.getAffectedEditor()) {
            eventMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.EventMediator.Properties.staticTopic == event.getAffectedEditor()) {
            eventMediator.setStaticTopic((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.EventMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EventMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EventMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEventMediator_TopicType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.EventMediator.Properties.topicType))
                basePart.setTopicType((EventTopicType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEventMediator_StaticTopic().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EventMediator.Properties.staticTopic)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getEventMediator_TopicType(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.EventMediator.Properties.topicType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEventMediator_TopicType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getEventMediator_TopicType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EventMediator.Properties.staticTopic == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEventMediator_StaticTopic().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getEventMediator_StaticTopic().getEAttributeType(), newValue);
                }
