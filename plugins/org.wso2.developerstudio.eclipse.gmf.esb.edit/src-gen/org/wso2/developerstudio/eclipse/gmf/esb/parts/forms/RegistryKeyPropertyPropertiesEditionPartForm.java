 ...
 * 
 */
public class RegistryKeyPropertyPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, RegistryKeyPropertyPropertiesEditionPart {
     ...
     */
    public RegistryKeyPropertyPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = registryKeyPropertyStep
                .addStep(EsbViewsRepository.RegistryKeyProperty.Properties.class);
    ...
    protected Composite createPrettyNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RegistryKeyProperty.Properties.prettyName,
                EsbMessages.RegistryKeyPropertyPropertiesEditionPart_PrettyNameLabel);
        ...
        prettyName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.RegistryKeyProperty.Properties.prettyName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, prettyName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RegistryKeyPropertyPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RegistryKeyPropertyPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RegistryKeyProperty.Properties.prettyName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createKeyNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RegistryKeyProperty.Properties.keyName,
                EsbMessages.RegistryKeyPropertyPropertiesEditionPart_KeyNameLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RegistryKeyProperty.Properties.keyName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createKeyValueText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RegistryKeyProperty.Properties.keyValue,
                EsbMessages.RegistryKeyPropertyPropertiesEditionPart_KeyValueLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RegistryKeyProperty.Properties.keyValue, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFiltersText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RegistryKeyProperty.Properties.filters,
                EsbMessages.RegistryKeyPropertyPropertiesEditionPart_FiltersLabel);
        ...
        filters.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RegistryKeyPropertyPropertiesEditionPartForm.this,
                            EsbViewsRepository.RegistryKeyProperty.Properties.filters, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, filters.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RegistryKeyPropertyPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RegistryKeyProperty.Properties.filters, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RegistryKeyPropertyPropertiesEditionPart#setPrettyName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RegistryKeyPropertyPropertiesEditionPart#setKeyName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RegistryKeyPropertyPropertiesEditionPart#setKeyValue(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RegistryKeyPropertyPropertiesEditionPart#setFilters(String
     *      newValue)
     * 
     */
