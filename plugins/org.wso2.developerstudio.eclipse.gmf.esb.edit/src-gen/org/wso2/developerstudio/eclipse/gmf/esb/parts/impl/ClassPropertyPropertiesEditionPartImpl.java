 ...
 * 
 */
public class ClassPropertyPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ClassPropertyPropertiesEditionPart {
    ...
    protected Composite createPropertyNameText(Composite parent) {
        Control propertyNameText = createDescription(parent, EsbViewsRepository.ClassProperty.Properties.propertyName,
                EsbMessages.ClassPropertyPropertiesEditionPart_PropertyNameLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ClassPropertyPropertiesEditionPartImpl.this,
                            EsbViewsRepository.ClassProperty.Properties.propertyName, PropertiesEditionEvent.COMMIT,
        ...
        Control propertyNameHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ClassProperty.Properties.propertyName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertyValueTypeEMFComboViewer(Composite parent) {
        Control propertyValueTypeLabel = createDescription(parent,
                EsbViewsRepository.ClassProperty.Properties.propertyValueType,
                EsbMessages.ClassPropertyPropertiesEditionPart_PropertyValueTypeLabel);
        ...
        Control propertyValueTypeHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ClassProperty.Properties.propertyValueType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertyValueText(Composite parent) {
        Control propertyValueTextLabel = createDescription(parent,
                ...
                EsbMessages.ClassPropertyPropertiesEditionPart_PropertyValueLabel);
        ...
        propertyValue.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ClassPropertyPropertiesEditionPartImpl.this,
                            EsbViewsRepository.ClassProperty.Properties.propertyValue, PropertiesEditionEvent.COMMIT,
        ...
        Control propertyValueHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ClassProperty.Properties.propertyValue, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ClassPropertyPropertiesEditionPart#setPropertyName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ClassPropertyPropertiesEditionPart#initPropertyValueType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ClassPropertyPropertiesEditionPart#setPropertyValueType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ClassPropertyPropertiesEditionPart#setPropertyValue(String
     *      newValue)
     * 
     */
