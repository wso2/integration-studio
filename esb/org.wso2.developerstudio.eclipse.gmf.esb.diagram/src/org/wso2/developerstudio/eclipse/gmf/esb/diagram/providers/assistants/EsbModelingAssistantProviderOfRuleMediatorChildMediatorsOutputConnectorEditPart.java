 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfRuleMediatorChildMediatorsOutputConnectorEditPart extends
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((RuleMediatorChildMediatorsOutputConnectorEditPart) sourceEditPart, relationshipType);
	}
