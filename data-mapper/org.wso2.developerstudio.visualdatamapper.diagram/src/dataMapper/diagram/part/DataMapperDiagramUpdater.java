...
public class DataMapperDiagramUpdater {
	...
	public static List<dataMapper.diagram.part.DataMapperNodeDescriptor> getDataMapperRoot_1000SemanticChildren(
		...
		for (Iterator<?> it = modelElement.getOperators().iterator(); it.hasNext();) {
			...
			if (visualID == dataMapper.diagram.edit.parts.ConstantEditPart.VISUAL_ID) {
				result.add(new dataMapper.diagram.part.DataMapperNodeDescriptor(childElement,
						visualID));
				continue;
			}
			if (visualID == dataMapper.diagram.edit.parts.LowerCaseEditPart.VISUAL_ID) {
				result.add(new dataMapper.diagram.part.DataMapperNodeDescriptor(childElement,
						visualID));
				continue;
			}
			if (visualID == dataMapper.diagram.edit.parts.ContainsEditPart.VISUAL_ID) {
				result.add(new dataMapper.diagram.part.DataMapperNodeDescriptor(childElement,
						visualID));
				continue;
			}
			if (visualID == dataMapper.diagram.edit.parts.UpperCaseEditPart.VISUAL_ID) {
				result.add(new dataMapper.diagram.part.DataMapperNodeDescriptor(childElement,
						visualID));
				continue;
			}
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperNodeDescriptor> getConcat_2006SemanticChildren(
			View view) {
		if (!view.isSetElement()) {
			return Collections.emptyList();
		}
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperNodeDescriptor> getConstant_2008SemanticChildren(
			View view) {
		if (!view.isSetElement()) {
			return Collections.emptyList();
		}
		dataMapper.Constant modelElement = (dataMapper.Constant) view.getElement();
		LinkedList<dataMapper.diagram.part.DataMapperNodeDescriptor> result = new LinkedList<dataMapper.diagram.part.DataMapperNodeDescriptor>();
		{
			dataMapper.OperatorBasicContainer childElement = modelElement.getBasicContainer();
			int visualID = dataMapper.diagram.part.DataMapperVisualIDRegistry.getNodeVisualID(view,
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperNodeDescriptor> getLowerCase_2009SemanticChildren(
			View view) {
		if (!view.isSetElement()) {
			return Collections.emptyList();
		}
		dataMapper.LowerCase modelElement = (dataMapper.LowerCase) view.getElement();
		LinkedList<dataMapper.diagram.part.DataMapperNodeDescriptor> result = new LinkedList<dataMapper.diagram.part.DataMapperNodeDescriptor>();
		{
			dataMapper.OperatorBasicContainer childElement = modelElement.getBasicContainer();
			int visualID = dataMapper.diagram.part.DataMapperVisualIDRegistry.getNodeVisualID(view,
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperNodeDescriptor> getContains_2010SemanticChildren(
			View view) {
		if (!view.isSetElement()) {
			return Collections.emptyList();
		}
		dataMapper.Contains modelElement = (dataMapper.Contains) view.getElement();
		LinkedList<dataMapper.diagram.part.DataMapperNodeDescriptor> result = new LinkedList<dataMapper.diagram.part.DataMapperNodeDescriptor>();
		{
			dataMapper.OperatorBasicContainer childElement = modelElement.getBasicContainer();
			int visualID = dataMapper.diagram.part.DataMapperVisualIDRegistry.getNodeVisualID(view,
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperNodeDescriptor> getUpperCase_2011SemanticChildren(
			View view) {
		if (!view.isSetElement()) {
			return Collections.emptyList();
		}
		dataMapper.UpperCase modelElement = (dataMapper.UpperCase) view.getElement();
		LinkedList<dataMapper.diagram.part.DataMapperNodeDescriptor> result = new LinkedList<dataMapper.diagram.part.DataMapperNodeDescriptor>();
		{
			dataMapper.OperatorBasicContainer childElement = modelElement.getBasicContainer();
			int visualID = dataMapper.diagram.part.DataMapperVisualIDRegistry.getNodeVisualID(view,
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperLinkDescriptor> getConstant_2008ContainedLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperLinkDescriptor> getLowerCase_2009ContainedLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperLinkDescriptor> getContains_2010ContainedLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperLinkDescriptor> getUpperCase_2011ContainedLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperLinkDescriptor> getConstant_2008IncomingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperLinkDescriptor> getLowerCase_2009IncomingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperLinkDescriptor> getContains_2010IncomingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperLinkDescriptor> getUpperCase_2011IncomingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperLinkDescriptor> getConstant_2008OutgoingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperLinkDescriptor> getLowerCase_2009OutgoingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperLinkDescriptor> getContains_2010OutgoingLinks(
			View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<dataMapper.diagram.part.DataMapperLinkDescriptor> getUpperCase_2011OutgoingLinks(
			View view) {
		return Collections.emptyList();
	}
