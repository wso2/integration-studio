 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfLogMediatorOutputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnSource(
			LogMediatorOutputConnectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(LogMediatorOutputConnectorEditPart) sourceEditPart,
				targetEditPart);
	}
