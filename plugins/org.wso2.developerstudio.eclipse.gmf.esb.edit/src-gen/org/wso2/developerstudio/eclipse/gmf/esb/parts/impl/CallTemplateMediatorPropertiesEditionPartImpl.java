 ...
 * 
 */
public class CallTemplateMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, CallTemplateMediatorPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CallTemplateMediatorPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(CallTemplateMediatorPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.CallTemplateMediator.Properties.description,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CallTemplateMediator.Properties.description, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.CallTemplateMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.CallTemplateMediator.Properties.reverse,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CallTemplateMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAvailableTemplatesText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CallTemplateMediator.Properties.availableTemplates,
    ...
    protected Composite createTemplateParametersAdvancedTableComposition(Composite parent) {
        ...
        this.templateParameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CallTemplateMediator.Properties.templateParameters, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createTargetTemplateText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CallTemplateMediator.Properties.targetTemplate,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CallTemplateMediator.Properties.targetTemplate, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
