 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfCloneMediatorInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			CloneMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(CloneMediatorInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
