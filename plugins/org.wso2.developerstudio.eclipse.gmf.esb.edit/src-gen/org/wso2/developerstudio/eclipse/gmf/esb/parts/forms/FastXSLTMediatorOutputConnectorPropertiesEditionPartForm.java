 ...
 * 
 */
public class FastXSLTMediatorOutputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, FastXSLTMediatorOutputConnectorPropertiesEditionPart {
     ...
     */
    public FastXSLTMediatorOutputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        propertiesSection
                .setText(EsbMessages.FastXSLTMediatorOutputConnectorPropertiesEditionPart_PropertiesGroupLabel);
                ...
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                FastXSLTMediatorOutputConnectorPropertiesEditionPartForm.this,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FastXSLTMediatorOutputConnectorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.FastXSLTMediatorOutputConnector.Properties.commentMediators,
