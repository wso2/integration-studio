 ...
 * 
 */
public class APIResourceOutSequenceOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public APIResourceOutSequenceOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject aPIResourceOutSequenceOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.APIResourceOutSequenceOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(aPIResourceOutSequenceOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.APIResourceOutSequenceOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
