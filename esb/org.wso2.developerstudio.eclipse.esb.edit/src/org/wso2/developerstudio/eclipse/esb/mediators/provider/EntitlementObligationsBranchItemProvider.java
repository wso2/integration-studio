...
/**
 * This is the item provider adapter for a {@link org.wso2.developerstudio.eclipse.esb.mediators.EntitlementObligationsBranch} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntitlementObligationsBranchItemProvider
	 ...
	 * @generated
	 */
	public EntitlementObligationsBranchItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		 EntitlementObligationsBranch branch = (EntitlementObligationsBranch)object;
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EntitlementObligationsBranch_sequenceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EntitlementObligationsBranch_sequenceType_feature", "_UI_EntitlementObligationsBranch_type"),
				 MediatorsPackage.Literals.ENTITLEMENT_OBLIGATIONS_BRANCH__SEQUENCE_TYPE,
				 true,
				 false,
				 false,
	...
	protected void addSequenceKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EntitlementObligationsBranch_sequenceKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EntitlementObligationsBranch_sequenceKey_feature", "_UI_EntitlementObligationsBranch_type"),
				 MediatorsPackage.Literals.ENTITLEMENT_OBLIGATIONS_BRANCH__SEQUENCE_KEY,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns EntitlementObligationsBranch.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EntitlementObligationsBranch"));
	}
	...
	public String getText(Object object) {
		return  getString("_UI_EntitlementObligationsBranch_type");
	}
	...
	protected Command createCreateChildCommand(EditingDomain domain, EObject owner, EStructuralFeature feature,
		...
		EntitlementObligationsBranch brach = (EntitlementObligationsBranch) owner;

		if (value instanceof Mediator) {
			if (!brach.getSequenceType().equals(EntitlementSequence.ANONYMOUS)) {				
