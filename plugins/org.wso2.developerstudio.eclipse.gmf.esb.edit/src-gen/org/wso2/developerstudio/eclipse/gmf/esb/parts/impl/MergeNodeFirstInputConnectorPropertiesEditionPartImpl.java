 ...
 * 
 */
public class MergeNodeFirstInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, MergeNodeFirstInputConnectorPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        CompositionSequence mergeNodeFirstInputConnectorStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        mergeNodeFirstInputConnectorStep.addStep(EsbViewsRepository.MergeNodeFirstInputConnector.Properties.class)
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.MergeNodeFirstInputConnector.Properties.incomingLinks,
                EsbMessages.MergeNodeFirstInputConnectorPropertiesEditionPart_IncomingLinksLabel);
        ...
        this.incomingLinks.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MergeNodeFirstInputConnector.Properties.incomingLinks, EsbViewsRepository.SWT_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MergeNodeFirstInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.MergeNodeFirstInputConnector.Properties.incomingLinks,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MergeNodeFirstInputConnectorPropertiesEditionPart#addFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MergeNodeFirstInputConnectorPropertiesEditionPart#addBusinessFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MergeNodeFirstInputConnectorPropertiesEditionPart#isContainedInIncomingLinksTable(EObject
     *      element)
     * 
     */
