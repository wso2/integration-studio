 ...
 * 
 */
public class ValidateFeaturePropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ValidateFeaturePropertiesEditionPart {
    ...
    protected Composite createFeatureNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateFeature.Properties.featureName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFeatureEnabledCheckbox(Composite parent) {
        ...
        featureEnabled.setText(getDescription(EsbViewsRepository.ValidateFeature.Properties.featureEnabled,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ValidateFeaturePropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateFeature.Properties.featureEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
