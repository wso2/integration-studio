 ...
 * 
 */
public class AddressEndPointOutputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, AddressEndPointOutputConnectorPropertiesEditionPart {
     ...
     */
    public AddressEndPointOutputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        CompositionSequence addressEndPointOutputConnectorStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        addressEndPointOutputConnectorStep.addStep(EsbViewsRepository.AddressEndPointOutputConnector.Properties.class)
    ...
    protected Composite createCommentMediatorsTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.commentMediators = new ReferencesTable(
                getDescription(EsbViewsRepository.AddressEndPointOutputConnector.Properties.commentMediators,
                        EsbMessages.AddressEndPointOutputConnectorPropertiesEditionPart_CommentMediatorsLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(AddressEndPointOutputConnectorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.AddressEndPointOutputConnector.Properties.commentMediators,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointOutputConnectorPropertiesEditionPart#initCommentMediators(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointOutputConnectorPropertiesEditionPart#addFilterCommentMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointOutputConnectorPropertiesEditionPart#addBusinessFilterCommentMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointOutputConnectorPropertiesEditionPart#isContainedInCommentMediatorsTable(EObject
     *      element)
     * 
     */
