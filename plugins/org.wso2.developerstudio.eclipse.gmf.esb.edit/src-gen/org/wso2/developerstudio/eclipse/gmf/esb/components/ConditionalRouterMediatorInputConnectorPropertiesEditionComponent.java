 ...
 * 
 */
public class ConditionalRouterMediatorInputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public ConditionalRouterMediatorInputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject conditionalRouterMediatorInputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ConditionalRouterMediatorInputConnector.Properties.incomingLinks)) {
                incomingLinksSettings = new ReferencesTableSettings(conditionalRouterMediatorInputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ConditionalRouterMediatorInputConnector.Properties.incomingLinks == event
                .getAffectedEditor()) {
