 ...
 * @generated
 */
public class HTTPEndpointDescriptionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.HTTPEndpointDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
