 ...
 * @since 3.1
 */
public class WizardArchiveFileResourceExportPage extends WizardFileSystemResourceExportPage {
	 ...
	 *            java.lang.String
	 */
	protected WizardArchiveFileResourceExportPage(String name, IStructuredSelection selection) {
	 ...
	 *            the selection
	 */
	public WizardArchiveFileResourceExportPage(IStructuredSelection selection) {
