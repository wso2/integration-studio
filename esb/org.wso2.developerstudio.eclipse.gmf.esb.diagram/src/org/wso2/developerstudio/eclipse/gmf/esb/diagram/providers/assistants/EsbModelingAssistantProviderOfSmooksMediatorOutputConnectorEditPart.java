 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfSmooksMediatorOutputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnSource(
			SmooksMediatorOutputConnectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(SmooksMediatorOutputConnectorEditPart) sourceEditPart,
				targetEditPart);
	}
