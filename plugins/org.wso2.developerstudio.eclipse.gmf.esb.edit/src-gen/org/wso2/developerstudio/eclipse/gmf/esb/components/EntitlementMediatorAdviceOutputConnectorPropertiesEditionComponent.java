 ...
 * 
 */
public class EntitlementMediatorAdviceOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public EntitlementMediatorAdviceOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject entitlementMediatorAdviceOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.EntitlementMediatorAdviceOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(entitlementMediatorAdviceOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.EntitlementMediatorAdviceOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
