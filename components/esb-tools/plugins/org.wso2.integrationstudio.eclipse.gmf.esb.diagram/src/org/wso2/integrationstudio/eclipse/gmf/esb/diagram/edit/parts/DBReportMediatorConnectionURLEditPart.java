 ...
 * @generated
 */
public class DBReportMediatorConnectionURLEditPart extends CompartmentEditPart implements ITextAwareEditPart {
        ...
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.DBReportMediator_3513, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.DBReportMediatorConnectionURLEditPart.VISUAL_ID));
        }
        return parser;
    }
