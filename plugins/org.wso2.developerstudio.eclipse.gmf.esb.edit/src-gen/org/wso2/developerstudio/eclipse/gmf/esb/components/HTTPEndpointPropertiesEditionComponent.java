...
public class HTTPEndpointPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public HTTPEndpointPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hTTPEndpoint,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointDescription.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, hTTPEndpoint.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointProperties.properties)) {
                propertiesSettings = new ReferencesTableSettings(hTTPEndpoint,
            ...
            if (isAccessible(EsbViewsRepository.HTTPEndpoint.Properties.addressingVersion)) {
                basePart.initAddressingVersion(
                        EEFUtils.choiceOfValues(hTTPEndpoint,
                                EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingVersion()),
                        hTTPEndpoint.getAddressingVersion());
            }
            ...
            if (isAccessible(EsbViewsRepository.HTTPEndpoint.Timeout.timeOutDuration))
                basePart.setTimeOutDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        hTTPEndpoint.getTimeOutDuration()));

            if (isAccessible(EsbViewsRepository.HTTPEndpoint.Timeout.timeOutAction)) {
                basePart.initTimeOutAction(
                        EEFUtils.choiceOfValues(hTTPEndpoint, EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutAction()),
                        hTTPEndpoint.getTimeOutAction());
            }
            if (isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointTimeoutState.retryErrorCodes))
                basePart.setRetryErrorCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        hTTPEndpoint.getRetryErrorCodes()));

            if (isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointTimeoutState.retryCount)) {
                basePart.setRetryCount(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hTTPEndpoint.getRetryCount()));
            }

            if (isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointTimeoutState.retryDelay)) {
                basePart.setRetryDelay(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG, hTTPEndpoint.getRetryDelay()));
            }
            ...
            if (isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendErrorCodes))
                basePart.setSuspendErrorCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        hTTPEndpoint.getSuspendErrorCodes()));
            ...
            if (isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendInitialDuration)) {
                basePart.setSuspendInitialDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        hTTPEndpoint.getSuspendInitialDuration()));
            }
            ...
            if (isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendMaximumDuration)) {
                basePart.setSuspendMaximumDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        hTTPEndpoint.getSuspendMaximumDuration()));
            }
            ...
            if (isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendProgressionFactor)) {
                basePart.setSuspendProgressionFactor(EEFConverterUtil.convertToString(EcorePackage.Literals.EFLOAT,
                        hTTPEndpoint.getSuspendProgressionFactor()));
            }

            if (isAccessible(EsbViewsRepository.HTTPEndpoint.Properties.format)) {
                basePart.initFormat(
                        EEFUtils.choiceOfValues(hTTPEndpoint, EsbPackage.eINSTANCE.getAbstractEndPoint_Format()),
                        hTTPEndpoint.getFormat());
            }
            if (isAccessible(EsbViewsRepository.HTTPEndpoint.Properties.optimize)) {
                basePart.initOptimize(
                        EEFUtils.choiceOfValues(hTTPEndpoint, EsbPackage.eINSTANCE.getAbstractEndPoint_Optimize()),
                        hTTPEndpoint.getOptimize());
            }
            if (isAccessible(EsbViewsRepository.HTTPEndpoint.Properties.templateParameters)) {
                templateParametersSettings = new ReferencesTableSettings(hTTPEndpoint,
            ...
            if (isAccessible(EsbViewsRepository.HTTPEndpoint.Basic.uRITemplate))
                basePart.setURITemplate(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, hTTPEndpoint.getURITemplate()));

            if (isAccessible(EsbViewsRepository.HTTPEndpoint.Basic.httpMethod)) {
                basePart.initHttpMethod(
                        EEFUtils.choiceOfValues(hTTPEndpoint, EsbPackage.eINSTANCE.getHTTPEndpoint_HttpMethod()),
                        hTTPEndpoint.getHttpMethod());
            }
            // init filters
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.HTTPEndpoint.EndpointDescription.description == event.getAffectedEditor()) {
            hTTPEndpoint.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.HTTPEndpoint.Properties.endPointName == event.getAffectedEditor()) {
            hTTPEndpoint.setEndPointName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.HTTPEndpoint.Timeout.timeOutDuration == event.getAffectedEditor()) {
            hTTPEndpoint.setTimeOutDuration((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendErrorCodes == event.getAffectedEditor()) {
            hTTPEndpoint.setSuspendErrorCodes((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendInitialDuration == event.getAffectedEditor()) {
            hTTPEndpoint.setSuspendInitialDuration((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendMaximumDuration == event.getAffectedEditor()) {
            hTTPEndpoint.setSuspendMaximumDuration(
                    (EEFConverterUtil.createLongFromString(EcorePackage.Literals.ELONG, (String) event.getNewValue())));
        }
        if (EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendProgressionFactor == event
                .getAffectedEditor()) {
            hTTPEndpoint.setSuspendProgressionFactor((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.HTTPEndpoint.Basic.uRITemplate == event.getAffectedEditor()) {
            hTTPEndpoint.setURITemplate((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointDescription.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getEndPoint_EndPointName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Properties.endPointName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_ReliableMessagingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Properties.reliableMessagingEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SecurityEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Properties.securityEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Properties.addressingEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingVersion().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Properties.addressingVersion))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingSeparateListener().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Properties.addressingSeparateListener))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Timeout.timeOutDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Timeout.timeOutAction))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryErrorCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointTimeoutState.retryErrorCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryCount().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointTimeoutState.retryCount)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryDelay().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointTimeoutState.retryDelay)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendErrorCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendErrorCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendInitialDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendInitialDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendMaximumDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendMaximumDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendProgressionFactor().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendProgressionFactor)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_Format().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Properties.format))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_Optimize().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Properties.optimize))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TemplateParameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Properties.templateParameters))
                basePart.updateTemplateParameters();
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_StatisticsEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Basic.statisticsEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TraceEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Basic.traceEnabled))
                basePart.setTraceEnabled((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getHTTPEndpoint_URITemplate().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Basic.uRITemplate)) {
                if (msg.getNewValue() != null) {
                    basePart.setURITemplate(
                            EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, msg.getNewValue()));
                } else {
            ...
            if (EsbPackage.eINSTANCE.getHTTPEndpoint_HttpMethod().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.HTTPEndpoint.Basic.httpMethod))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getHTTPEndpoint_URITemplate(), EsbPackage.eINSTANCE.getHTTPEndpoint_HttpMethod(),
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.HTTPEndpoint.Properties.addressingSeparateListener == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                ...
                if (EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendErrorCodes == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendInitialDuration == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.HTTPEndpoint.EndpointSuspendState.suspendMaximumDuration == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.HTTPEndpoint.Basic.uRITemplate == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getHTTPEndpoint_URITemplate().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getHTTPEndpoint_URITemplate().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.HTTPEndpoint.Basic.httpMethod == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getHTTPEndpoint_HttpMethod().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getHTTPEndpoint_HttpMethod().getEAttributeType(), newValue);
                }
                // Start of user code for failover error codes
                if (EsbViewsRepository.HTTPEndpoint.FailoverErrorCodes.failoverNonRetryErrorCodes == event
                        .getAffectedEditor()) {
