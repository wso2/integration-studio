...
public class DataMapperMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public DataMapperMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject dataMapperMediator, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.DataMapperMediator.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dataMapperMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.DataMapperMediator.Properties.inputType)) {
                basePart.initInputType(
                        EEFUtils.choiceOfValues(dataMapperMediator,
            ...
            if (isAccessible(EsbViewsRepository.DataMapperMediator.Properties.configurationLocalPath))
                basePart.setConfigurationLocalPath(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dataMapperMediator.getConfiguration().getKeyValue()));

            if (isAccessible(EsbViewsRepository.DataMapperMediator.Properties.inputSchemaLocalPath))
                basePart.setInputSchemaLocalPath(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dataMapperMediator.getInputSchema().getKeyValue()));

            if (isAccessible(EsbViewsRepository.DataMapperMediator.Properties.outputSchemaLocalPath))
                basePart.setOutputSchemaLocalPath(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dataMapperMediator.getOutputSchema().getKeyValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.DataMapperMediator.Properties.description == event.getAffectedEditor()) {
            dataMapperMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.DataMapperMediator.Properties.configurationLocalPath == event.getAffectedEditor()) {
            dataMapperMediator.setConfigurationLocalPath((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.DataMapperMediator.Properties.inputSchemaLocalPath == event.getAffectedEditor()) {
            dataMapperMediator.setInputSchemaLocalPath((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.DataMapperMediator.Properties.outputSchemaLocalPath == event.getAffectedEditor()) {
            dataMapperMediator.setOutputSchemaLocalPath((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.DataMapperMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DataMapperMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DataMapperMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getDataMapperMediator_InputType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DataMapperMediator.Properties.inputType))
                basePart.setInputType((DataMapperMediatorDataTypes) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getDataMapperMediator_ConfigurationLocalPath().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DataMapperMediator.Properties.configurationLocalPath)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getDataMapperMediator_InputSchemaLocalPath().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DataMapperMediator.Properties.inputSchemaLocalPath)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getDataMapperMediator_OutputSchemaLocalPath().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DataMapperMediator.Properties.outputSchemaLocalPath)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getDataMapperMediator_OutputType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DataMapperMediator.Properties.outputType))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getDataMapperMediator_InputType(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.DataMapperMediator.Properties.inputType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getDataMapperMediator_InputType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getDataMapperMediator_InputType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.DataMapperMediator.Properties.configurationLocalPath == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getDataMapperMediator_ConfigurationLocalPath().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getDataMapperMediator_ConfigurationLocalPath().getEAttributeType(),
                ...
                if (EsbViewsRepository.DataMapperMediator.Properties.inputSchemaLocalPath == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getDataMapperMediator_InputSchemaLocalPath().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getDataMapperMediator_InputSchemaLocalPath().getEAttributeType(),
                ...
                if (EsbViewsRepository.DataMapperMediator.Properties.outputSchemaLocalPath == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getDataMapperMediator_OutputSchemaLocalPath().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getDataMapperMediator_OutputSchemaLocalPath().getEAttributeType(),
                ...
                if (EsbViewsRepository.DataMapperMediator.Properties.outputType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getDataMapperMediator_OutputType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getDataMapperMediator_OutputType().getEAttributeType(), newValue);
                }
