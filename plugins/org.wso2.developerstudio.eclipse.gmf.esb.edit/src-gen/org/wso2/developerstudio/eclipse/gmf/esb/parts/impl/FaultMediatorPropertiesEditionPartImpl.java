 ...
 * 
 */
public class FaultMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, FaultMediatorPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.FaultMediator.Properties.description,
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FaultMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.FaultMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.FaultMediator.Properties.reverse,
                EsbMessages.FaultMediatorPropertiesEditionPart_ReverseLabel));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FaultMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSoapVersionEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.FaultMediator.Properties.soapVersion,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.soapVersion, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSerializeResponseCheckbox(Composite parent) {
        ...
        serializeResponse.setText(getDescription(EsbViewsRepository.FaultMediator.Properties.serializeResponse,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.serializeResponse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMarkAsResponseCheckbox(Composite parent) {
        ...
        markAsResponse.setText(getDescription(EsbViewsRepository.FaultMediator.Properties.markAsResponse,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.markAsResponse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFaultCodeSoap11EMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.FaultMediator.Properties.faultCodeSoap11,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.faultCodeSoap11, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFaultCodeTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.FaultMediator.Properties.faultCodeType,
                EsbMessages.FaultMediatorPropertiesEditionPart_FaultCodeTypeLabel);
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.faultCodeType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFaultStringTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.FaultMediator.Properties.faultStringType,
                EsbMessages.FaultMediatorPropertiesEditionPart_FaultStringTypeLabel);
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.faultStringType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFaultStringValueText(Composite parent) {
        createDescription(parent, EsbViewsRepository.FaultMediator.Properties.faultStringValue,
                EsbMessages.FaultMediatorPropertiesEditionPart_FaultStringValueLabel);
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.faultStringValue, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFaultActorText(Composite parent) {
        createDescription(parent, EsbViewsRepository.FaultMediator.Properties.faultActor,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.faultActor, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFaultCodeSoap12EMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.FaultMediator.Properties.faultCodeSoap12,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.faultCodeSoap12, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFaultReasonTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.FaultMediator.Properties.faultReasonType,
                EsbMessages.FaultMediatorPropertiesEditionPart_FaultReasonTypeLabel);
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.faultReasonType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFaultReasonValueText(Composite parent) {
        createDescription(parent, EsbViewsRepository.FaultMediator.Properties.faultReasonValue,
                EsbMessages.FaultMediatorPropertiesEditionPart_FaultReasonValueLabel);
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.faultReasonValue, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRoleNameText(Composite parent) {
        createDescription(parent, EsbViewsRepository.FaultMediator.Properties.roleName,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.roleName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createNodeNameText(Composite parent) {
        createDescription(parent, EsbViewsRepository.FaultMediator.Properties.nodeName,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.nodeName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFaultDetailTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.FaultMediator.Properties.faultDetailType,
                EsbMessages.FaultMediatorPropertiesEditionPart_FaultDetailTypeLabel);
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.faultDetailType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFaultDetailValueText(Composite parent) {
        createDescription(parent, EsbViewsRepository.FaultMediator.Properties.faultDetailValue,
                EsbMessages.FaultMediatorPropertiesEditionPart_FaultDetailValueLabel);
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FaultMediator.Properties.faultDetailValue, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
