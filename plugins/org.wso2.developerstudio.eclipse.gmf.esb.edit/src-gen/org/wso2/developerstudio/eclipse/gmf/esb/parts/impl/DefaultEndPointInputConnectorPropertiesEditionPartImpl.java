 ...
 * 
 */
public class DefaultEndPointInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, DefaultEndPointInputConnectorPropertiesEditionPart {
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.DefaultEndPointInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DefaultEndPointInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.DefaultEndPointInputConnector.Properties.incomingLinks,
