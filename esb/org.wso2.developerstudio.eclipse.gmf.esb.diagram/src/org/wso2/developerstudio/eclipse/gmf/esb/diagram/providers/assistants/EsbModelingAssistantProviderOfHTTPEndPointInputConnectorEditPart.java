 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfHTTPEndPointInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			HTTPEndPointInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(HTTPEndPointInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
