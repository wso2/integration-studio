...
/**
 * This is the item provider adapter for a {@link org.wso2.integrationstudio.datamapper.Compare} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompareItemProvider extends OperatorItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Compare_comparisonOperator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Compare_comparisonOperator_feature", "_UI_Compare_type"),
				 DataMapperPackage.Literals.COMPARE__COMPARISON_OPERATOR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Compare_type") + " " + compare.isSerialized();
	}
