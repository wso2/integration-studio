 ...
 * 
 */
public class ProxyWSDLResourcePropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ProxyWSDLResourcePropertiesEditionPart {
     ...
     */
    public ProxyWSDLResourcePropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createLocationText(FormToolkit widgetFactory, Composite parent) {
        ...
        location.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyWSDLResourcePropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyWSDLResourcePropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyWSDLResource.Properties.location, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
