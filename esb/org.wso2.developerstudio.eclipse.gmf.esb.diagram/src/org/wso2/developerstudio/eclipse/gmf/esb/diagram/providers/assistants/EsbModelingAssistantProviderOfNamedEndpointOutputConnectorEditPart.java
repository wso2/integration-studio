 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfNamedEndpointOutputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnSource(
			NamedEndpointOutputConnectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(NamedEndpointOutputConnectorEditPart) sourceEditPart,
				targetEditPart);
	}
