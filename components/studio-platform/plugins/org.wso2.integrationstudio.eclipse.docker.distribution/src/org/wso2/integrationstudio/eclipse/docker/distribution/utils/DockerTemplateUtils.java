...
public class DockerTemplateUtils extends TemplateUtil {

	private static DockerTemplateUtils instance;

	protected Bundle getBundle() {
		return Platform.getBundle(Activator.PLUGIN_ID);
	}

	public static DockerTemplateUtils getInstance() {
		if (instance == null) {
			instance = new DockerTemplateUtils();
		}
		return instance;
	}
