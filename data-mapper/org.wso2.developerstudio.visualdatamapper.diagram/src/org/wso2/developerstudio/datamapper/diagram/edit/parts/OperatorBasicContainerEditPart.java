...
import org.wso2.developerstudio.datamapper.diagram.edit.parts.EqualEditPart.EqualFigure;
...
public class OperatorBasicContainerEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OperatorBasicContainerItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new OperatorBasicContainerCanonicalEditPolicy());
