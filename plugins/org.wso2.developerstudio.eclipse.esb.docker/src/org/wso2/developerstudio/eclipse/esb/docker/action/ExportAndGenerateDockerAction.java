...
import org.wso2.developerstudio.eclipse.docker.distribution.action.ContainerProceedWizardDialog;
import org.wso2.developerstudio.eclipse.esb.docker.wizard.GenerateDockerImageWizard;
...
public class ExportAndGenerateDockerAction implements IActionDelegate {
    ...
    public void run(IAction action) {
        if (selection != null) {
            GenerateDockerImageWizard wizard = new GenerateDockerImageWizard();
