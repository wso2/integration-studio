...
import org.wso2.integrationstudio.datamapper.diagram.edit.policies.StartsWithCanonicalEditPolicy;
import org.wso2.integrationstudio.datamapper.diagram.edit.policies.StartsWithItemSemanticEditPolicy;
import org.wso2.integrationstudio.datamapper.impl.StartsWithImpl;

/**
 * @generated NOT
 */
public class StartsWithEditPart extends AbstractOperatorEditPart {
	 ...
	 * @generated
	 */
	public StartsWithEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StartsWithItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new StartsWithCanonicalEditPolicy());
	...
	public class StartsWithFigure extends OperatorRectangle {

		private String figureHeaderLabel;

		public StartsWithFigure(String pattern) {
			super("StartsWith");
			if (StringUtils.isNotEmpty(pattern)) {
				this.figureHeaderLabel = "StartsWith : \"" + pattern + "\"";
	...
	public OperatorRectangle getStartsWithFigure() {
