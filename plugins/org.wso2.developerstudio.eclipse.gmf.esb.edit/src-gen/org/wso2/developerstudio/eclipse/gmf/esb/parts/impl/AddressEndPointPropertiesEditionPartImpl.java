 ...
 * 
 */
public class AddressEndPointPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, AddressEndPointPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        CompositionStep failoverErrorCodesStep = addressEndPointStep
        ...
        failoverErrorCodesStep
                .addStep(EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.failoverNonRetryErrorCodes);
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.AddressEndPoint.Basic.commentsList,
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartImpl.this,
    ...
    protected Composite createEndPointNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.Basic.endPointName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAnonymousCheckbox(Composite parent) {
        ...
        anonymous.setText(getDescription(EsbViewsRepository.AddressEndPoint.Basic.anonymous,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Basic.anonymous, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInLineCheckbox(Composite parent) {
        ...
        inLine.setText(getDescription(EsbViewsRepository.AddressEndPoint.Basic.inLine,
                EsbMessages.AddressEndPointPropertiesEditionPart_InLineLabel));
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Basic.inLine, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(Composite parent) {
        ...
        duplicate.setText(getDescription(EsbViewsRepository.AddressEndPoint.Basic.duplicate,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Basic.duplicate, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createReversedCheckbox(Composite parent) {
        ...
        reversed.setText(getDescription(EsbViewsRepository.AddressEndPoint.Basic.reversed,
                EsbMessages.AddressEndPointPropertiesEditionPart_ReversedLabel));
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Basic.reversed, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFormatEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.Basic.format,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Basic.format, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTemplateParametersAdvancedTableComposition(Composite parent) {
        ...
        this.templateParameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.Basic.templateParameters, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createStatisticsEnabledCheckbox(Composite parent) {
        ...
        statisticsEnabled.setText(getDescription(EsbViewsRepository.AddressEndPoint.Basic.statisticsEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.Basic.statisticsEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTraceEnabledCheckbox(Composite parent) {
        ...
        traceEnabled.setText(getDescription(EsbViewsRepository.AddressEndPoint.Basic.traceEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.Basic.traceEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createURIText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.Basic.uRI,
        ...
        uRI.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartImpl.this, EsbViewsRepository.AddressEndPoint.Basic.uRI,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Basic.uRI, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSuspendErrorCodesText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendErrorCodes,
    ...
    protected Composite createSuspendInitialDurationText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendInitialDuration,
    ...
    protected Composite createSuspendMaximumDurationText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendMaximumDuration,
    ...
    protected Composite createSuspendProgressionFactorText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendProgressionFactor,
    ...
    protected Composite createRetryErrorCodesText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.EndpointTimeoutState.retryErrorCodes,
    ...
    protected Composite createRetryCountText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.EndpointTimeoutState.retryCount,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.EndpointTimeoutState.retryCount, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRetryDelayText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.EndpointTimeoutState.retryDelay,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.EndpointTimeoutState.retryDelay, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesAdvancedTableComposition(Composite parent) {
        ...
        this.properties.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Misc.properties, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createOptimizeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.Misc.optimize,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Misc.optimize, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.Misc.description,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.Misc.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createReliableMessagingEnabledCheckbox(Composite parent) {
        ...
        reliableMessagingEnabled.setText(getDescription(EsbViewsRepository.AddressEndPoint.QoS.reliableMessagingEnabled,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressEndPoint.QoS.reliableMessagingEnabled, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createSecurityEnabledCheckbox(Composite parent) {
        ...
        securityEnabled.setText(getDescription(EsbViewsRepository.AddressEndPoint.QoS.securityEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.QoS.securityEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressingEnabledCheckbox(Composite parent) {
        ...
        addressingEnabled.setText(getDescription(EsbViewsRepository.AddressEndPoint.QoS.addressingEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.QoS.addressingEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressingVersionEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.QoS.addressingVersion,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.QoS.addressingVersion, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressingSeparateListenerCheckbox(Composite parent) {
        ...
        addressingSeparateListener
                .setText(getDescription(EsbViewsRepository.AddressEndPoint.QoS.addressingSeparateListener,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressEndPoint.QoS.addressingSeparateListener, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createTimeOutDurationText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.Timeout.timeOutDuration,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.Timeout.timeOutDuration, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTimeOutActionEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.Timeout.timeOutAction,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.Timeout.timeOutAction, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFailoverTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.failoverType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.failoverType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFailoverRetryErrorCodesText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.failoverRetryErrorCodes,
    ...
    protected Composite createFailoverNonRetryErrorCodesText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.failoverNonRetryErrorCodes,
