...
package org.wso2.developerstudio.eclipse.artifact.cep.receiver.project.export;
...
public class ReceiverArtfactExportHandler extends ProjectArtifactHandler{
    ...
    private boolean isReceiver(File xmlFile){
		try {
