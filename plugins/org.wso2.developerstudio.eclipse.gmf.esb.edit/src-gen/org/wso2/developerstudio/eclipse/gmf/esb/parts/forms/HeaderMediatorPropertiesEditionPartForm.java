 ...
 * @generated NOT
 */
public class HeaderMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, HeaderMediatorPropertiesEditionPart {
     ...
     */
    public HeaderMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createHeaderActionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control headerActionLabel = createDescription(parent, EsbViewsRepository.HeaderMediator.Properties.headerAction,
                EsbMessages.HeaderMediatorPropertiesEditionPart_HeaderActionLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.HeaderMediator.Properties.headerAction, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getHeaderAction()));
            }

        });
        headerAction.setID(EsbViewsRepository.HeaderMediator.Properties.headerAction);
        Control headerActionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.HeaderMediator.Properties.headerAction,
    ...
    protected Composite createValueTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        headerValueSubsectionGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent, "Header Value",
                true);
        Control valueTypeLabel = createDescription(headerValueSubsectionGroup,
                EsbViewsRepository.HeaderMediator.Properties.valueType,
                EsbMessages.HeaderMediatorPropertiesEditionPart_ValueTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(HeaderMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.HeaderMediator.Properties.valueType,
        ...
        Control valueTypeHelp = FormUtils
                .createHelpButton(widgetFactory, headerValueSubsectionGroup,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.HeaderMediator.Properties.valueType, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createScopeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control scopeLabel = createDescription(parent, EsbViewsRepository.HeaderMediator.Properties.scope,
                EsbMessages.HeaderMediatorPropertiesEditionPart_ScopeLabel);
        ...
        scope.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(HeaderMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.HeaderMediator.Properties.scope, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getScope()));
            }

        });
        scope.setID(EsbViewsRepository.HeaderMediator.Properties.scope);
        Control scopeHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.HeaderMediator.Properties.scope, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueLiteralText(FormToolkit widgetFactory, Composite parent) {
        Control valueLiteralLabel = createDescription(parent, EsbViewsRepository.HeaderMediator.Properties.valueLiteral,
                EsbMessages.HeaderMediatorPropertiesEditionPart_ValueLiteralLabel);
        ...
        valueLiteral.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            HeaderMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.HeaderMediator.Properties.valueLiteral, PropertiesEditionEvent.COMMIT,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            HeaderMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control valueLiteralHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.HeaderMediator.Properties.valueLiteral,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createValueInlineText(FormToolkit widgetFactory, Composite parent) {
        Control valueInlineLabel = createDescription(parent, EsbViewsRepository.HeaderMediator.Properties.valueInline,
                EsbMessages.HeaderMediatorPropertiesEditionPart_ValueInlineLabel);
        ...
        valueInline.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            HeaderMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.HeaderMediator.Properties.valueInline, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, valueInline.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(HeaderMediatorPropertiesEditionPartForm.this,
        ...
        Control valueInlineHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.HeaderMediator.Properties.valueInline, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.HeaderMediator.Properties.description,
                EsbMessages.HeaderMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            HeaderMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.HeaderMediator.Properties.description, PropertiesEditionEvent.COMMIT,
        ...
        Control descriptionHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.HeaderMediator.Properties.description, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.HeaderMediatorPropertiesEditionPart#initHeaderAction(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.HeaderMediatorPropertiesEditionPart#setHeaderAction(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.HeaderMediatorPropertiesEditionPart#initValueType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.HeaderMediatorPropertiesEditionPart#setValueType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.HeaderMediatorPropertiesEditionPart#initScope(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.HeaderMediatorPropertiesEditionPart#setScope(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.HeaderMediatorPropertiesEditionPart#setValueLiteral(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.HeaderMediatorPropertiesEditionPart#setValueInline(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.HeaderMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.HeaderMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.HeaderMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
    ...
    protected Composite createHeaderName(FormToolkit widgetFactory, final Composite parent) {
        Control headerNameLabel = createDescription(parent, EsbViewsRepository.HeaderMediator.Properties.headerName,
                EsbMessages.HeaderMediatorPropertiesEditionPart_HeaderNameLabel);
        widgetFactory.paintBordersFor(parent);
        if (headerName == null) {
        ...
        Control headerNameHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
    ...
    private void openNamespacedPropertyEditorValueExpression(final Composite parent) {
        ...
        propertiesEditionComponent
                .firePropertiesChanged(new PropertiesEditionEvent(HeaderMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.HeaderMediator.Properties.valueExpression, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createValueExpression(FormToolkit widgetFactory, final Composite parent) {
        Control valueExpressionLabel = createDescription(parent,
                EsbViewsRepository.HeaderMediator.Properties.valueExpression,
                EsbMessages.HeaderMediatorPropertiesEditionPart_ValueExpressionLabel);
        widgetFactory.paintBordersFor(parent);
        ...
        Control valueExpressionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.HeaderMediator.Properties.valueExpression,
                        EsbViewsRepository.FORM_KIND),
                null);
        ...
        if (getHeaderAction().getName().equals(HeaderAction.SET.getName())) {
            ...
            if (getValueType() != null && getValueType().getName().equals(HeaderValueType.INLINE.getName())) {
                ...
                eu.showEntry(valueInlineElements, false);
                    ...
                    && getValueType().getName().equals(HeaderValueType.EXPRESSION.getName())) {
                // expression
