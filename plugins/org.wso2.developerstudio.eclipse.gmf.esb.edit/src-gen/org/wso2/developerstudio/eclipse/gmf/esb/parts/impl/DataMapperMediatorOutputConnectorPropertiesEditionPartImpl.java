 ...
 * 
 */
public class DataMapperMediatorOutputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, DataMapperMediatorOutputConnectorPropertiesEditionPart {
                ...
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                DataMapperMediatorOutputConnectorPropertiesEditionPartImpl.this,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DataMapperMediatorOutputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.DataMapperMediatorOutputConnector.Properties.commentMediators,
