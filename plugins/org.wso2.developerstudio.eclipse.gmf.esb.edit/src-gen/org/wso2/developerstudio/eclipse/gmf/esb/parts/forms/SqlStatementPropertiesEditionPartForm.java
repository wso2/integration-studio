 ...
 * 
 */
public class SqlStatementPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, SqlStatementPropertiesEditionPart {
     ...
     */
    public SqlStatementPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createQueryStringText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.SqlStatement.Properties.queryString,
                EsbMessages.SqlStatementPropertiesEditionPart_QueryStringLabel);
        ...
        queryString.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.SqlStatement.Properties.queryString, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, queryString.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SqlStatementPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SqlStatementPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SqlStatement.Properties.queryString, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createParametersTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.parameters = new ReferencesTable(getDescription(EsbViewsRepository.SqlStatement.Properties.parameters,
                EsbMessages.SqlStatementPropertiesEditionPart_ParametersLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(SqlStatementPropertiesEditionPartForm.this,
                                        EsbViewsRepository.SqlStatement.Properties.parameters,
        ...
        this.parameters.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SqlStatement.Properties.parameters, EsbViewsRepository.FORM_KIND));
        ...
        this.parameters.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SqlStatementPropertiesEditionPartForm.this,
                            EsbViewsRepository.SqlStatement.Properties.parameters, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createResultsEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        resultsEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.SqlStatement.Properties.resultsEnabled,
                        EsbMessages.SqlStatementPropertiesEditionPart_ResultsEnabledLabel),
                SWT.CHECK);
        resultsEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SqlStatementPropertiesEditionPartForm.this,
                            EsbViewsRepository.SqlStatement.Properties.resultsEnabled, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new Boolean(resultsEnabled.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SqlStatement.Properties.resultsEnabled, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResultsTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.results = new ReferencesTable(getDescription(EsbViewsRepository.SqlStatement.Properties.results,
                EsbMessages.SqlStatementPropertiesEditionPart_ResultsLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(SqlStatementPropertiesEditionPartForm.this,
                                        EsbViewsRepository.SqlStatement.Properties.results,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
                        results.refresh();
                    }
        ...
        this.results.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SqlStatement.Properties.results, EsbViewsRepository.FORM_KIND));
        ...
        this.results.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SqlStatementPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SqlStatement.Properties.results, PropertiesEditionEvent.CHANGE,
                                    PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlStatementPropertiesEditionPart#setQueryString(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlStatementPropertiesEditionPart#initParameters(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlStatementPropertiesEditionPart#addFilterParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlStatementPropertiesEditionPart#addBusinessFilterParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlStatementPropertiesEditionPart#isContainedInParametersTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlStatementPropertiesEditionPart#setResultsEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlStatementPropertiesEditionPart#initResults(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlStatementPropertiesEditionPart#addFilterResults(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlStatementPropertiesEditionPart#addBusinessFilterResults(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlStatementPropertiesEditionPart#isContainedInResultsTable(EObject
     *      element)
     * 
     */
