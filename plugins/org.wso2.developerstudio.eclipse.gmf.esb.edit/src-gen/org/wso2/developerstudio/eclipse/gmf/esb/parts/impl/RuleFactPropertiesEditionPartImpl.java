 ...
 * 
 */
public class RuleFactPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, RuleFactPropertiesEditionPart {
    ...
    protected Composite createFactTypeEMFComboViewer(Composite parent) {
        Control factTypeLabel = createDescription(parent, EsbViewsRepository.RuleFact.Properties.factType,
                EsbMessages.RuleFactPropertiesEditionPart_FactTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleFactPropertiesEditionPartImpl.this, EsbViewsRepository.RuleFact.Properties.factType,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getFactType()));
            }

        });
        factType.setID(EsbViewsRepository.RuleFact.Properties.factType);
        Control factTypeHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.RuleFact.Properties.factType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFactCustomTypeText(Composite parent) {
        Control factCustomTypeLabel = createDescription(parent, EsbViewsRepository.RuleFact.Properties.factCustomType,
                EsbMessages.RuleFactPropertiesEditionPart_FactCustomTypeLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.RuleFact.Properties.factCustomType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, factCustomType.getText()));
            }
        ...
        Control factCustomTypeHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleFact.Properties.factCustomType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFactNameText(Composite parent) {
        Control factNameLabel = createDescription(parent, EsbViewsRepository.RuleFact.Properties.factName,
                EsbMessages.RuleFactPropertiesEditionPart_FactNameLabel);
        ...
        factName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleFactPropertiesEditionPartImpl.this, EsbViewsRepository.RuleFact.Properties.factName,
        ...
        Control factNameHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.RuleFact.Properties.factName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueTypeEMFComboViewer(Composite parent) {
        Control valueTypeLabel = createDescription(parent, EsbViewsRepository.RuleFact.Properties.valueType,
                EsbMessages.RuleFactPropertiesEditionPart_ValueTypeLabel);
        ...
        valueType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleFactPropertiesEditionPartImpl.this, EsbViewsRepository.RuleFact.Properties.valueType,
        ...
        Control valueTypeHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.RuleFact.Properties.valueType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueLiteralText(Composite parent) {
        Control valueLiteralLabel = createDescription(parent, EsbViewsRepository.RuleFact.Properties.valueLiteral,
                EsbMessages.RuleFactPropertiesEditionPart_ValueLiteralLabel);
        ...
        valueLiteral.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleFactPropertiesEditionPartImpl.this, EsbViewsRepository.RuleFact.Properties.valueLiteral,
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                RuleFactPropertiesEditionPartImpl.this,
                                EsbViewsRepository.RuleFact.Properties.valueLiteral, PropertiesEditionEvent.COMMIT,
        ...
        Control valueLiteralHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleFact.Properties.valueLiteral, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleFactPropertiesEditionPart#initFactType(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleFactPropertiesEditionPart#setFactType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleFactPropertiesEditionPart#setFactCustomType(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleFactPropertiesEditionPart#initValueType(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleFactPropertiesEditionPart#setValueType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleFactPropertiesEditionPart#setValueLiteral(String
     *      newValue)
     * 
     */
    ...
    protected Composite createPropertyExpressionText(final Composite parent) {
        ...
        Control propertyExpressionHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleFact.Properties.propertyExpression, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    public void openPropertyExpressionNSPEDialog(final Composite parent) {
        ...
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                RuleFactPropertiesEditionPartImpl.this, EsbViewsRepository.RuleFact.Properties.propertyExpression,
                PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPropertyExpression()));
    }

    protected Composite createValueReferenceKeyWidget(Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.RuleFact.Properties.valueReferenceKey,
                EsbMessages.RuleFactPropertiesEditionPart_ValueReferenceKeyLabel);
        ...
        Control itemHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleFact.Properties.valueReferenceKey, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    public void validate() {
        ...
        } else if (getValueType() != null && getValueType().getName().equals("REGISTRY_REFERENCE")) {
