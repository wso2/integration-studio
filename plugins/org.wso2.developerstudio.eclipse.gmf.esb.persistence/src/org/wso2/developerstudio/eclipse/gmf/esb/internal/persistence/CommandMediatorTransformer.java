...
public class CommandMediatorTransformer extends AbstractEsbNodeTransformer {
    ...
    public void transform(TransformationInfo information, EsbNode subject) throws TransformerException {
        try {
            ...
            doTransform(information, ((CommandMediator) subject).getOutputConnector());
    ...
    public void transformWithinSequence(TransformationInfo information, EsbNode subject, SequenceMediator sequence)
        ...
        try {
            ...
            doTransformWithinSequence(information, ((CommandMediator) subject).getOutputConnector().getOutgoingLink(),
                    sequence);
        } catch (JaxenException e) {
            throw new TransformerException(e);
        }
    ...
    public static POJOCommandMediator createCommandMediator(TransformationInfo information, EsbNode subject)
        ...
        for (CommandProperty property : visualCommand.getProperties()) {
            if (property.getValueType().equals(CommandPropertyValueType.MESSAGE_ELEMENT)) {
                ...
                commandMediator.addStaticSetterProperty(property.getPropertyName(), property.getValueLiteral());
            }
        }
