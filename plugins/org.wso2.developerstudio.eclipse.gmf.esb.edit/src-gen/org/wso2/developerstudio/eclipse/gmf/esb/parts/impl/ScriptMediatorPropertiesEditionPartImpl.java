 ...
 * 
 */
public class ScriptMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ScriptMediatorPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.ScriptMediator.Properties.description,
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ScriptMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ScriptMediator.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.ScriptMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.ScriptMediator.Properties.reverse,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ScriptMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ScriptMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createScriptTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.ScriptMediator.Properties.scriptType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ScriptMediator.Properties.scriptType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createScriptLanguageEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.ScriptMediator.Properties.scriptLanguage,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ScriptMediator.Properties.scriptLanguage, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMediateFunctionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.ScriptMediator.Properties.mediateFunction,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ScriptMediator.Properties.mediateFunction, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createScriptBodyText(Composite parent) {
        createDescription(parent, EsbViewsRepository.ScriptMediator.Properties.scriptBody,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ScriptMediator.Properties.scriptBody, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createKeyTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.ScriptMediator.Properties.keyType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ScriptMediator.Properties.keyType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createScriptKeysAdvancedTableComposition(Composite parent) {
        ...
        this.scriptKeys.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ScriptMediator.Properties.scriptKeys, EsbViewsRepository.SWT_KIND));
