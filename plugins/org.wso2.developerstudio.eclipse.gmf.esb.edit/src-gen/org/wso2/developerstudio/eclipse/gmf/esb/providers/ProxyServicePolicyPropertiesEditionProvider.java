...
import org.wso2.developerstudio.eclipse.gmf.esb.components.ProxyServicePolicyPropertiesEditionComponent;
...
public class ProxyServicePolicyPropertiesEditionProvider extends PropertiesEditingProviderImpl {
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part) {
        return (editingContext.getEObject() instanceof ProxyServicePolicy)
                && (ProxyServicePolicyPropertiesEditionComponent.BASE_PART.equals(part));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
        ...
        if (editingContext.getEObject() instanceof ProxyServicePolicy) {
            if (ProxyServicePolicyPropertiesEditionComponent.BASE_PART.equals(part))
                return new ProxyServicePolicyPropertiesEditionComponent(editingContext, editingContext.getEObject(),
                        mode);
        }
