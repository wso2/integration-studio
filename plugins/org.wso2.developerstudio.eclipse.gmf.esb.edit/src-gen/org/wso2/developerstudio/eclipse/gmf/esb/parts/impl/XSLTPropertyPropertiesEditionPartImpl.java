 ...
 * 
 */
public class XSLTPropertyPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, XSLTPropertyPropertiesEditionPart {
    ...
    protected Composite createPropertyNameText(Composite parent) {
        Control propertyNameLabel = createDescription(parent, EsbViewsRepository.XSLTProperty.Properties.propertyName,
                EsbMessages.XSLTPropertyPropertiesEditionPart_PropertyNameLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.XSLTProperty.Properties.propertyName, PropertiesEditionEvent.COMMIT,
        ...
        Control propertyNameHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.XSLTProperty.Properties.propertyName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertyValueTypeEMFComboViewer(Composite parent) {
        Control propertyValueTypeLabel = createDescription(parent,
                EsbViewsRepository.XSLTProperty.Properties.propertyValueType,
                EsbMessages.XSLTPropertyPropertiesEditionPart_PropertyValueTypeLabel);
        ...
        propertyValueType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            XSLTPropertyPropertiesEditionPartImpl.this,
                            EsbViewsRepository.XSLTProperty.Properties.propertyValueType, PropertiesEditionEvent.COMMIT,
        ...
        Control propertyValueTypeHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.XSLTProperty.Properties.propertyValueType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertyValueText(Composite parent) {
        Control properyValueTextLabel = createDescription(parent,
                EsbViewsRepository.XSLTProperty.Properties.propertyValue,
                EsbMessages.XSLTPropertyPropertiesEditionPart_PropertyValueLabel);
        ...
        propertyValue.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            XSLTPropertyPropertiesEditionPartImpl.this,
                            EsbViewsRepository.XSLTProperty.Properties.propertyValue, PropertiesEditionEvent.COMMIT,
        ...
        Control propertyTextHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.XSLTProperty.Properties.propertyValue, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTPropertyPropertiesEditionPart#setPropertyName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTPropertyPropertiesEditionPart#initPropertyValueType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTPropertyPropertiesEditionPart#setPropertyValueType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTPropertyPropertiesEditionPart#setPropertyValue(String
     *      newValue)
     * 
     */
