 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfBAMMediatorInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			BAMMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(BAMMediatorInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
