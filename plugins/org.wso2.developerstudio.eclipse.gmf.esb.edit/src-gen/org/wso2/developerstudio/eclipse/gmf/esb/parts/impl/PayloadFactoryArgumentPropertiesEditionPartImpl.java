 ...
 * 
 */
public class PayloadFactoryArgumentPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, PayloadFactoryArgumentPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        CompositionStep propertiesStep = payloadFactoryArgumentStep
                .addStep(EsbViewsRepository.PayloadFactoryArgument.Properties.class);
    ...
    protected Composite createArgumentTypeEMFComboViewer(Composite parent) {
        Control argumentTypeLabel = createDescription(parent,
                EsbViewsRepository.PayloadFactoryArgument.Properties.argumentType,
                EsbMessages.PayloadFactoryArgumentPropertiesEditionPart_ArgumentTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PayloadFactoryArgumentPropertiesEditionPartImpl.this,
                            EsbViewsRepository.PayloadFactoryArgument.Properties.argumentType,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getArgumentType()));
                }
                validate();
            }
        ...
        Control argumentTypeHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PayloadFactoryArgument.Properties.argumentType, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createArgumentValueText(Composite parent) {
        Control argumentValueLabel = createDescription(parent,
                EsbViewsRepository.PayloadFactoryArgument.Properties.argumentValue,
                EsbMessages.PayloadFactoryArgumentPropertiesEditionPart_ArgumentValueLabel);
        ...
        Control argumentValueHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PayloadFactoryArgument.Properties.argumentValue, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEvaluatorEMFComboViewer(Composite parent) {
        Control evaluatorLabel = createDescription(parent,
                EsbViewsRepository.PayloadFactoryArgument.Properties.evaluator,
                EsbMessages.PayloadFactoryArgumentPropertiesEditionPart_EvaluatorLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(PayloadFactoryArgumentPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.PayloadFactoryArgument.Properties.evaluator,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getEvaluator()));
            }

        });
        evaluator.setID(EsbViewsRepository.PayloadFactoryArgument.Properties.evaluator);
        Control evaluatorHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PayloadFactoryArgument.Properties.evaluator, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createLiteralCheckbox(Composite parent) {
        ...
        literal.setText(getDescription(EsbViewsRepository.PayloadFactoryArgument.Properties.literal,
                EsbMessages.PayloadFactoryArgumentPropertiesEditionPart_LiteralLabel));
        literal.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PayloadFactoryArgumentPropertiesEditionPartImpl.this,
                            EsbViewsRepository.PayloadFactoryArgument.Properties.literal, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new Boolean(literal.getSelection())));
            }
        ...
        Control literalHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PayloadFactoryArgument.Properties.literal, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PayloadFactoryArgumentPropertiesEditionPart#initArgumentType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PayloadFactoryArgumentPropertiesEditionPart#setArgumentType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PayloadFactoryArgumentPropertiesEditionPart#setArgumentValue(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PayloadFactoryArgumentPropertiesEditionPart#initEvaluator(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PayloadFactoryArgumentPropertiesEditionPart#setEvaluator(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PayloadFactoryArgumentPropertiesEditionPart#setLiteral(Boolean
     *      newValue)
     * 
     */
    public void setLiteral(Boolean newValue) {
        ...
        boolean eefElementEditorReadOnlyState = isReadOnly(
                EsbViewsRepository.PayloadFactoryArgument.Properties.literal);
    ...
    protected Composite createArgumentExpression(final Composite parent) {
        Control argumentExpressionLabel = createDescription(parent,
                EsbViewsRepository.PayloadFactoryArgument.Properties.argumentExpression,
                EsbMessages.PayloadFactoryArgumentPropertiesEditionPart_ArgumentExpressionLabel);
        ...
        argumentExpressionText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                EEFNameSpacedPropertyEditorDialog nspd = new EEFNameSpacedPropertyEditorDialog(parent.getShell(),
                        SWT.NULL, argumentExpression);
                nspd.open();
                argumentExpressionText.setText(argumentExpression.getPropertyValue());
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        PayloadFactoryArgumentPropertiesEditionPartImpl.this,
                        EsbViewsRepository.PayloadFactoryArgument.Properties.argumentExpression,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getArgumentExpression()));
            }
        ...
        EditingUtils.setID(argumentExpressionText,
                EsbViewsRepository.PayloadFactoryArgument.Properties.argumentExpression);
        EditingUtils.setEEFtype(argumentExpressionText, "eef::Text");
        Control argumentExpressionHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PayloadFactoryArgument.Properties.argumentExpression,
                        EsbViewsRepository.SWT_KIND),
                null);
        argumentExpressionElements = new Control[] { argumentExpressionLabel, argumentExpressionText,
                argumentExpressionHelp };
        return parent;
