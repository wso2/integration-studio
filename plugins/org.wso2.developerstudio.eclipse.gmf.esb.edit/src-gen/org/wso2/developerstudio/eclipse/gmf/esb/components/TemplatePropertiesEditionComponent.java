...
public class TemplatePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public TemplatePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject template,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.Template.Properties.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, template.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.Template.Properties.templateType)) {
                basePart.initTemplateType(
                        EEFUtils.choiceOfValues(template, EsbPackage.eINSTANCE.getTemplate_TemplateType()),
                        template.getTemplateType());
            }
            if (isAccessible(EsbViewsRepository.Template.Properties.parameters)) {
                parametersSettings = new ReferencesTableSettings(template,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.Template.Properties.description == event.getAffectedEditor()) {
            template.setDescription((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
        ...
        if (EsbViewsRepository.Template.Properties.name == event.getAffectedEditor()) {
            template.setName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.Template.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Template.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getTemplate_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Template.Properties.name)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getTemplate_TemplateType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.Template.Properties.templateType))
                basePart.setTemplateType((TemplateType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getTemplate_Parameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.Template.Properties.parameters))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getTemplate_Name(), EsbPackage.eINSTANCE.getTemplate_TemplateType(),
                EsbPackage.eINSTANCE.getTemplate_Parameters());
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.Template.Properties.name == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTemplate_Name().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getTemplate_Name().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.Template.Properties.templateType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTemplate_TemplateType().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getTemplate_TemplateType().getEAttributeType(), newValue);
                }
