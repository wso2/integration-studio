 ...
 * 
 */
public class ForEachMediatorTargetOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public ForEachMediatorTargetOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject forEachMediatorTargetOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ForEachMediatorTargetOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(forEachMediatorTargetOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ForEachMediatorTargetOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
