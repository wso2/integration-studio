 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfIterateMediatorOutputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnSource(
			IterateMediatorOutputConnectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(IterateMediatorOutputConnectorEditPart) sourceEditPart,
				targetEditPart);
	}
