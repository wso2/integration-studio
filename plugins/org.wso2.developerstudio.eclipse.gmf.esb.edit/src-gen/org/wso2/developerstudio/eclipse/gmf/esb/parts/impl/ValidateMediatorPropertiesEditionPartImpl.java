 ...
 * 
 */
public class ValidateMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ValidateMediatorPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.ValidateMediator.Properties.description,
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ValidateMediatorPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ValidateMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateMediator.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.ValidateMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.ValidateMediator.Properties.reverse,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFeaturesAdvancedTableComposition(Composite parent) {
        ...
        this.features.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ValidateMediator.Properties.features, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createSchemasAdvancedTableComposition(Composite parent) {
        ...
        this.schemas.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ValidateMediator.Properties.schemas, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createResourcesAdvancedTableComposition(Composite parent) {
        ...
        this.resources.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ValidateMediator.Properties.resources, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createEnableCacheSchemaCheckbox(Composite parent) {
        ...
        enableCacheSchema.setText(getDescription(EsbViewsRepository.ValidateMediator.Properties.enableCacheSchema,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.ValidateMediator.Properties.enableCacheSchema, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
