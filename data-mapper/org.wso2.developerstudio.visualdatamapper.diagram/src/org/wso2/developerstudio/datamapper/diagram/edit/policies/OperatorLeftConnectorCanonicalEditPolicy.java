 ...
 * @generated
 */
public class OperatorLeftConnectorCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DataMapperPackage.eINSTANCE.getOperatorLeftConnector_InNode();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater.getOperatorLeftConnector_3014SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return InNode3EditPart.VISUAL_ID == DataMapperVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater.getOperatorLeftConnector_3014SemanticChildren((View) getHost().getModel());
