 ...
 * @generated
 */
public class ProxyServiceFaultContainerCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return EsbPackage.eINSTANCE
				.getProxyServiceFaultContainer_MediatorFlow();
	}
	...
	private boolean isMyDiagramElement(View view) {
		return MediatorFlow6EditPart.VISUAL_ID == EsbVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getProxyServiceFaultContainer_3488SemanticChildren((View) getHost()
						.getModel());
