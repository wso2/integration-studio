    ...
    public NotificationChain basicSetConnector(EsbSequenceInputConnector newConnector, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.ESB_SEQUENCE_INPUT__CONNECTOR, oldConnector, newConnector);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newConnector != connector) {
            ...
            if (connector != null)
                msgs = ((InternalEObject) connector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.ESB_SEQUENCE_INPUT__CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.ESB_SEQUENCE_INPUT__CONNECTOR,
