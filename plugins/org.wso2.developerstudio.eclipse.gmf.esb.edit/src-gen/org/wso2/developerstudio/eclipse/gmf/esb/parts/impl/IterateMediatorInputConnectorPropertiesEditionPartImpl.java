 ...
 * 
 */
public class IterateMediatorInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, IterateMediatorInputConnectorPropertiesEditionPart {
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.IterateMediatorInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(IterateMediatorInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.IterateMediatorInputConnector.Properties.incomingLinks,
