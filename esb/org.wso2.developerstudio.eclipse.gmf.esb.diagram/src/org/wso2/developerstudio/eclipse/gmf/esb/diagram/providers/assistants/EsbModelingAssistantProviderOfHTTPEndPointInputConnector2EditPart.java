 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfHTTPEndPointInputConnector2EditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			HTTPEndPointInputConnector2EditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(HTTPEndPointInputConnector2EditPart) targetEditPart,
				relationshipType);
	}
