...
public class WSDLEndPoint2ItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.WSDLEndPointInputConnector_3654 == req
				.getElementType()) {
			return getGEFWrapper(new WSDLEndPointInputConnector2CreateCommand(
					req));
		}
		if (EsbElementTypes.WSDLEndPointOutputConnector_3655 == req
				.getElementType()) {
			return getGEFWrapper(new WSDLEndPointOutputConnector2CreateCommand(
					req));
		}
