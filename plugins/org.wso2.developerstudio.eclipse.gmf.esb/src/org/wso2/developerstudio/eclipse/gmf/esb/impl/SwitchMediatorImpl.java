 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SwitchMediatorImpl#getSourceXpath <em>Source
 * Xpath</em>}</li>
 ...
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SwitchMediatorImpl#getNamespacePrefix <em>Namespace
 * Prefix</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SwitchMediatorImpl#getCaseBranches <em>Case
 * Branches</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SwitchMediatorImpl#getDefaultBranch <em>Default
 * Branch</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SwitchMediatorImpl#getInputConnector <em>Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SwitchMediatorImpl#getOutputConnector <em>Output
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SwitchMediatorImpl#getSwitchContainer <em>Switch
 * Container</em>}</li>
 * </ul>
 *
 * @generated
...
public class SwitchMediatorImpl extends MediatorImpl implements SwitchMediator {
    ...
    public NotificationChain basicSetSourceXpath(NamespacedProperty newSourceXpath, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SWITCH_MEDIATOR__SOURCE_XPATH, oldSourceXpath, newSourceXpath);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newSourceXpath != sourceXpath) {
            ...
            if (sourceXpath != null)
                msgs = ((InternalEObject) sourceXpath).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SWITCH_MEDIATOR__SOURCE_XPATH, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SWITCH_MEDIATOR__SOURCE_XPATH,
    ...
    public void setSource(String newSource) {
        ...
        source = newSource;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SWITCH_MEDIATOR__SOURCE, oldSource,
                    source));
    }
    ...
    public void setNamespace(String newNamespace) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SWITCH_MEDIATOR__NAMESPACE, oldNamespace,
                    namespace));
    }
    ...
    public void setNamespacePrefix(String newNamespacePrefix) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SWITCH_MEDIATOR__NAMESPACE_PREFIX,
    ...
    public EList<SwitchCaseBranchOutputConnector> getCaseBranches() {
        if (caseBranches == null) {
            caseBranches = new EObjectContainmentEList<SwitchCaseBranchOutputConnector>(
                    SwitchCaseBranchOutputConnector.class, this, EsbPackage.SWITCH_MEDIATOR__CASE_BRANCHES);
        }
        return caseBranches;
    }
    ...
    public NotificationChain basicSetDefaultBranch(SwitchDefaultBranchOutputConnector newDefaultBranch,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SWITCH_MEDIATOR__DEFAULT_BRANCH, oldDefaultBranch, newDefaultBranch);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setDefaultBranch(SwitchDefaultBranchOutputConnector newDefaultBranch) {
        if (newDefaultBranch != defaultBranch) {
            ...
            if (defaultBranch != null)
                msgs = ((InternalEObject) defaultBranch).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SWITCH_MEDIATOR__DEFAULT_BRANCH, null, msgs);
            if (newDefaultBranch != null)
                msgs = ((InternalEObject) newDefaultBranch).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SWITCH_MEDIATOR__DEFAULT_BRANCH, null, msgs);
            msgs = basicSetDefaultBranch(newDefaultBranch, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SWITCH_MEDIATOR__DEFAULT_BRANCH,
    ...
    public NotificationChain basicSetInputConnector(SwitchMediatorInputConnector newInputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SWITCH_MEDIATOR__INPUT_CONNECTOR, oldInputConnector, newInputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInputConnector != inputConnector) {
            ...
            if (inputConnector != null)
                msgs = ((InternalEObject) inputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SWITCH_MEDIATOR__INPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SWITCH_MEDIATOR__INPUT_CONNECTOR,
    ...
    public NotificationChain basicSetOutputConnector(SwitchMediatorOutputConnector newOutputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SWITCH_MEDIATOR__OUTPUT_CONNECTOR, oldOutputConnector, newOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOutputConnector != outputConnector) {
            ...
            if (outputConnector != null)
                msgs = ((InternalEObject) outputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SWITCH_MEDIATOR__OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SWITCH_MEDIATOR__OUTPUT_CONNECTOR,
    ...
    public NotificationChain basicSetSwitchContainer(SwitchMediatorContainer newSwitchContainer,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SWITCH_MEDIATOR__SWITCH_CONTAINER, oldSwitchContainer, newSwitchContainer);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setSwitchContainer(SwitchMediatorContainer newSwitchContainer) {
        if (newSwitchContainer != switchContainer) {
            ...
            if (switchContainer != null)
                msgs = ((InternalEObject) switchContainer).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SWITCH_MEDIATOR__SWITCH_CONTAINER, null, msgs);
            if (newSwitchContainer != null)
                msgs = ((InternalEObject) newSwitchContainer).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SWITCH_MEDIATOR__SWITCH_CONTAINER, null, msgs);
            msgs = basicSetSwitchContainer(newSwitchContainer, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SWITCH_MEDIATOR__SWITCH_CONTAINER,
                    newSwitchContainer, newSwitchContainer));
    }
