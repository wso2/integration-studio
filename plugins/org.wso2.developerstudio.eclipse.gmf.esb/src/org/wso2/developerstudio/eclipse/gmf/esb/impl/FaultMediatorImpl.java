 ...
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#isSerializeResponse <em>Serialize
 * Response</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#isMarkAsResponse <em>Mark As
 * Response</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getFaultCodeSoap11 <em>Fault Code
 * Soap11</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getFaultCodeType <em>Fault Code
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getFaultCodeExpression <em>Fault Code
 * Expression</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getFaultStringType <em>Fault String
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getFaultStringValue <em>Fault String
 * Value</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getFaultStringExpression <em>Fault String
 * Expression</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getFaultActor <em>Fault Actor</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getFaultCodeSoap12 <em>Fault Code
 * Soap12</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getFaultReasonType <em>Fault Reason
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getFaultReasonValue <em>Fault Reason
 * Value</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getFaultReasonExpression <em>Fault Reason
 * Expression</em>}</li>
 ...
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getFaultDetailType <em>Fault Detail
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getFaultDetailValue <em>Fault Detail
 * Value</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getFaultDetailExpression <em>Fault Detail
 * Expression</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getInputConnector <em>Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FaultMediatorImpl#getOutputConnector <em>Output
 * Connector</em>}</li>
 * </ul>
 *
 * @generated
...
public class FaultMediatorImpl extends MediatorImpl implements FaultMediator {
    ...
    /**
     * The cached value of the '{@link #getFaultStringExpression() <em>Fault String Expression</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getFaultReasonExpression() <em>Fault Reason Expression</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getFaultDetailExpression() <em>Fault Detail Expression</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public void setSoapVersion(FaultSoapVersion newSoapVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__SOAP_VERSION,
                    oldSoapVersion, soapVersion));
    }
    ...
    public void setSerializeResponse(boolean newSerializeResponse) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__SERIALIZE_RESPONSE,
                    oldSerializeResponse, serializeResponse));
    }
    ...
    public void setMarkAsResponse(boolean newMarkAsResponse) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__MARK_AS_RESPONSE,
                    oldMarkAsResponse, markAsResponse));
    }
    ...
    public void setFaultCodeSoap11(FaultCodeSoap11 newFaultCodeSoap11) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__FAULT_CODE_SOAP11,
                    oldFaultCodeSoap11, faultCodeSoap11));
    }
    ...
    public void setFaultCodeType(FaultCodeType newFaultCodeType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__FAULT_CODE_TYPE,
                    oldFaultCodeType, faultCodeType));
    }
    ...
    public NotificationChain basicSetFaultCodeExpression(NamespacedProperty newFaultCodeExpression,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.FAULT_MEDIATOR__FAULT_CODE_EXPRESSION, oldFaultCodeExpression, newFaultCodeExpression);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setFaultCodeExpression(NamespacedProperty newFaultCodeExpression) {
        if (newFaultCodeExpression != faultCodeExpression) {
            ...
            if (faultCodeExpression != null)
                msgs = ((InternalEObject) faultCodeExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.FAULT_MEDIATOR__FAULT_CODE_EXPRESSION, null, msgs);
            if (newFaultCodeExpression != null)
                msgs = ((InternalEObject) newFaultCodeExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.FAULT_MEDIATOR__FAULT_CODE_EXPRESSION, null, msgs);
            msgs = basicSetFaultCodeExpression(newFaultCodeExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__FAULT_CODE_EXPRESSION,
                    newFaultCodeExpression, newFaultCodeExpression));
    }
    ...
    public void setFaultStringType(FaultStringType newFaultStringType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__FAULT_STRING_TYPE,
                    oldFaultStringType, faultStringType));
    }
    ...
    public void setFaultStringValue(String newFaultStringValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__FAULT_STRING_VALUE,
                    oldFaultStringValue, faultStringValue));
    }
    ...
    public NotificationChain basicSetFaultStringExpression(NamespacedProperty newFaultStringExpression,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.FAULT_MEDIATOR__FAULT_STRING_EXPRESSION, oldFaultStringExpression,
                    newFaultStringExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setFaultStringExpression(NamespacedProperty newFaultStringExpression) {
        if (newFaultStringExpression != faultStringExpression) {
            ...
            if (faultStringExpression != null)
                msgs = ((InternalEObject) faultStringExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.FAULT_MEDIATOR__FAULT_STRING_EXPRESSION, null, msgs);
            if (newFaultStringExpression != null)
                msgs = ((InternalEObject) newFaultStringExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.FAULT_MEDIATOR__FAULT_STRING_EXPRESSION, null, msgs);
            msgs = basicSetFaultStringExpression(newFaultStringExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__FAULT_STRING_EXPRESSION,
                    newFaultStringExpression, newFaultStringExpression));
    }
    ...
    public void setFaultActor(String newFaultActor) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__FAULT_ACTOR, oldFaultActor,
                    faultActor));
    }
    ...
    public void setFaultCodeSoap12(FaultCodeSoap12 newFaultCodeSoap12) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__FAULT_CODE_SOAP12,
                    oldFaultCodeSoap12, faultCodeSoap12));
    }
    ...
    public void setFaultReasonType(FaultReasonType newFaultReasonType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__FAULT_REASON_TYPE,
                    oldFaultReasonType, faultReasonType));
    }
    ...
    public void setFaultReasonValue(String newFaultReasonValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__FAULT_REASON_VALUE,
                    oldFaultReasonValue, faultReasonValue));
    }
    ...
    public NotificationChain basicSetFaultReasonExpression(NamespacedProperty newFaultReasonExpression,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.FAULT_MEDIATOR__FAULT_REASON_EXPRESSION, oldFaultReasonExpression,
                    newFaultReasonExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setFaultReasonExpression(NamespacedProperty newFaultReasonExpression) {
        if (newFaultReasonExpression != faultReasonExpression) {
            ...
            if (faultReasonExpression != null)
                msgs = ((InternalEObject) faultReasonExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.FAULT_MEDIATOR__FAULT_REASON_EXPRESSION, null, msgs);
            if (newFaultReasonExpression != null)
                msgs = ((InternalEObject) newFaultReasonExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.FAULT_MEDIATOR__FAULT_REASON_EXPRESSION, null, msgs);
            msgs = basicSetFaultReasonExpression(newFaultReasonExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__FAULT_REASON_EXPRESSION,
                    newFaultReasonExpression, newFaultReasonExpression));
    }
    ...
    public void setRoleName(String newRoleName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__ROLE_NAME, oldRoleName,
                    roleName));
    }
    ...
    public void setNodeName(String newNodeName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__NODE_NAME, oldNodeName,
                    nodeName));
    }
    ...
    public void setFaultDetailType(FaultDetailType newFaultDetailType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__FAULT_DETAIL_TYPE,
                    oldFaultDetailType, faultDetailType));
    }
    ...
    public void setFaultDetailValue(String newFaultDetailValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__FAULT_DETAIL_VALUE,
                    oldFaultDetailValue, faultDetailValue));
    }
    ...
    public NotificationChain basicSetFaultDetailExpression(NamespacedProperty newFaultDetailExpression,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.FAULT_MEDIATOR__FAULT_DETAIL_EXPRESSION, oldFaultDetailExpression,
                    newFaultDetailExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setFaultDetailExpression(NamespacedProperty newFaultDetailExpression) {
        if (newFaultDetailExpression != faultDetailExpression) {
            ...
            if (faultDetailExpression != null)
                msgs = ((InternalEObject) faultDetailExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.FAULT_MEDIATOR__FAULT_DETAIL_EXPRESSION, null, msgs);
            if (newFaultDetailExpression != null)
                msgs = ((InternalEObject) newFaultDetailExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.FAULT_MEDIATOR__FAULT_DETAIL_EXPRESSION, null, msgs);
            msgs = basicSetFaultDetailExpression(newFaultDetailExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__FAULT_DETAIL_EXPRESSION,
                    newFaultDetailExpression, newFaultDetailExpression));
    }
    ...
    public NotificationChain basicSetInputConnector(FaultMediatorInputConnector newInputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.FAULT_MEDIATOR__INPUT_CONNECTOR, oldInputConnector, newInputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInputConnector != inputConnector) {
            ...
            if (inputConnector != null)
                msgs = ((InternalEObject) inputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.FAULT_MEDIATOR__INPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__INPUT_CONNECTOR,
    ...
    public NotificationChain basicSetOutputConnector(FaultMediatorOutputConnector newOutputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.FAULT_MEDIATOR__OUTPUT_CONNECTOR, oldOutputConnector, newOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOutputConnector != outputConnector) {
            ...
            if (outputConnector != null)
                msgs = ((InternalEObject) outputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.FAULT_MEDIATOR__OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FAULT_MEDIATOR__OUTPUT_CONNECTOR,
    ...
    public boolean eIsSet(int featureID) {
        ...
        case EsbPackage.FAULT_MEDIATOR__FAULT_STRING_VALUE:
            return FAULT_STRING_VALUE_EDEFAULT == null ? faultStringValue != null
                    : !FAULT_STRING_VALUE_EDEFAULT.equals(faultStringValue);
        case EsbPackage.FAULT_MEDIATOR__FAULT_STRING_EXPRESSION:
        ...
        case EsbPackage.FAULT_MEDIATOR__FAULT_REASON_VALUE:
            return FAULT_REASON_VALUE_EDEFAULT == null ? faultReasonValue != null
                    : !FAULT_REASON_VALUE_EDEFAULT.equals(faultReasonValue);
        case EsbPackage.FAULT_MEDIATOR__FAULT_REASON_EXPRESSION:
        ...
        case EsbPackage.FAULT_MEDIATOR__FAULT_DETAIL_VALUE:
            return FAULT_DETAIL_VALUE_EDEFAULT == null ? faultDetailValue != null
                    : !FAULT_DETAIL_VALUE_EDEFAULT.equals(faultDetailValue);
        case EsbPackage.FAULT_MEDIATOR__FAULT_DETAIL_EXPRESSION:
