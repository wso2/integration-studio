 ...
 * 
 */
public class CloneMediatorTargetOutputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, CloneMediatorTargetOutputConnectorPropertiesEditionPart {
     ...
     */
    public CloneMediatorTargetOutputConnectorPropertiesEditionPartForm() {
        super();
    }
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CloneMediatorTargetOutputConnectorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CloneMediatorTargetOutputConnector.Properties.commentMediators,
    ...
    protected Composite createSoapActionText(FormToolkit widgetFactory, Composite parent) {
        ...
        soapAction.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CloneMediatorTargetOutputConnectorPropertiesEditionPartForm.this, null,
