...
public class XSLTPropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public XSLTPropertyPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject xSLTProperty,
            String editing_mode) {
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.XSLTProperty.Properties.propertyName == event.getAffectedEditor()) {
            xSLTProperty.setPropertyName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.XSLTProperty.Properties.propertyValue == event.getAffectedEditor()) {
            xSLTProperty.setPropertyValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueExpressionProperty_PropertyName().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.XSLTProperty.Properties.propertyName)) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueExpressionProperty_PropertyValueType().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.XSLTProperty.Properties.propertyValueType))
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueExpressionProperty_PropertyValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.XSLTProperty.Properties.propertyValue)) {
                if (msg.getNewValue() != null) {
