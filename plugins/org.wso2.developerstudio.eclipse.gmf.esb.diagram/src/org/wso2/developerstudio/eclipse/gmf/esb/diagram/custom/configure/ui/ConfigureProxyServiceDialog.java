...
public class ConfigureProxyServiceDialog extends Dialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        proxyParameterLabel = new Label(container, SWT.NONE);
        {
            ...
            proxyParameterLabelLayoutData.top = new FormAttachment(proxySeparatorText, 10);
        ...
        newProxyParameterButton = new Button(container, SWT.NONE);
        {
            ...
            FormData newProxyParameterButtonLayoutData = new FormData(80, SWT.DEFAULT);
            newProxyParameterButtonLayoutData.top = new FormAttachment(proxyParameterLabel, 10);
            ...
            newProxyParameterButton.addListener(SWT.Selection, new Listener() {
                public void handleEvent(Event event) {
                    TableItem item = bindProxyParameter(EsbFactory.eINSTANCE.createProxyServiceParameter());
        ...
        removeProxyParameterButton = new Button(container, SWT.NONE);
        {
            ...
            removeProxyParameterButtonLayoutData.top = new FormAttachment(newProxyParameterButton, 5);
            removeProxyParameterButtonLayoutData.right = new FormAttachment(100);
            removeProxyParameterButtonLayoutData.left = new FormAttachment(newProxyParameterButton, 0, SWT.LEFT);
            removeProxyParameterButton.setLayoutData(removeProxyParameterButtonLayoutData);
        ...
        proxyParametersTable = new Table(container, SWT.BORDER | SWT.FULL_SELECTION | SWT.HIDE_SELECTION);
        {
            TableColumn nameColumn = new TableColumn(proxyParametersTable, SWT.LEFT);
            TableColumn valueColumn = new TableColumn(proxyParametersTable, SWT.LEFT);
            ...
            proxyParametersTable.addListener(SWT.Selection, tblPropertiesListener);
            ...
            for (ProxyServiceParameter parameter : proxyService.getServiceParameters()) {
                if (!StringUtils.isEmpty(parameter.getValue())) {
                    ...
                    RemoveCommand removeCmd = new RemoveCommand(editingDomain, proxyService,
            ...
            // Layout.
            FormData proxyParametersTableLayoutData = new FormData(SWT.DEFAULT, 150);
            proxyParametersTableLayoutData.top = new FormAttachment(newProxyParameterButton, 0, SWT.TOP);
            proxyParametersTableLayoutData.left = new FormAttachment(0);
            proxyParametersTableLayoutData.right = new FormAttachment(newProxyParameterButton, -5);
            ...
            if (null == property.eContainer()) {
                ...
                if (!property.getName().equals(item.getText(0))) {
                    SetCommand setCmd = new SetCommand(editingDomain, property,
                            EsbPackage.Literals.PROXY_SERVICE_PARAMETER__NAME, item.getText(0));
                ...
                if (property.getValue() != null) {
                    if (!property.getValue().equals(item.getText(1))) {
                        SetCommand setCmd = new SetCommand(editingDomain, property,
                                EsbPackage.Literals.PROXY_SERVICE_PARAMETER__VALUE, item.getText(1));
                        getResultCommand().append(setCmd);
                    }
                }
            }
