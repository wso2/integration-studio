 ...
 * 
 */
public class TaskPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, TaskPropertiesEditionPart {
     ...
     */
    public TaskPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Task.Properties.description,
                EsbMessages.TaskPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartForm.this, EsbViewsRepository.Task.Properties.description,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent
                                .firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this,
                                        EsbViewsRepository.Task.Properties.description, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.Task.Properties.commentsList,
                        EsbMessages.TaskPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "Task", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this,
                                    EsbViewsRepository.Task.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createTaskNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Task.Properties.taskName,
                EsbMessages.TaskPropertiesEditionPart_TaskNameLabel);
        ...
        taskName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartForm.this, EsbViewsRepository.Task.Properties.taskName,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, taskName.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this,
                                    EsbViewsRepository.Task.Properties.taskName, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, taskName.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.taskName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTaskGroupText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Task.Properties.taskGroup,
                EsbMessages.TaskPropertiesEditionPart_TaskGroupLabel);
        ...
        taskGroup.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartForm.this, EsbViewsRepository.Task.Properties.taskGroup,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, taskGroup.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this,
                                    EsbViewsRepository.Task.Properties.taskGroup, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, taskGroup.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.taskGroup, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTriggerTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Task.Properties.triggerType,
                EsbMessages.TaskPropertiesEditionPart_TriggerTypeLabel);
        ...
        triggerType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartForm.this, EsbViewsRepository.Task.Properties.triggerType,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getTriggerType()));
            }

        });
        triggerType.setID(EsbViewsRepository.Task.Properties.triggerType);
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.triggerType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCountText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Task.Properties.count,
                EsbMessages.TaskPropertiesEditionPart_CountLabel);
        ...
        count.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartForm.this, EsbViewsRepository.Task.Properties.count,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, count.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this,
                                    EsbViewsRepository.Task.Properties.count, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, count.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.count, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createIntervalText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Task.Properties.interval,
                EsbMessages.TaskPropertiesEditionPart_IntervalLabel);
        ...
        interval.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartForm.this, EsbViewsRepository.Task.Properties.interval,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, interval.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this,
                                    EsbViewsRepository.Task.Properties.interval, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, interval.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.interval, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCronText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Task.Properties.cron,
                EsbMessages.TaskPropertiesEditionPart_CronLabel);
        ...
        cron.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartForm.this, EsbViewsRepository.Task.Properties.cron,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, cron.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this,
                                    EsbViewsRepository.Task.Properties.cron, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, cron.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.cron, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPinnedServersText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Task.Properties.pinnedServers,
                EsbMessages.TaskPropertiesEditionPart_PinnedServersLabel);
        ...
        pinnedServers.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartForm.this, EsbViewsRepository.Task.Properties.pinnedServers,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, pinnedServers.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartForm.this, EsbViewsRepository.Task.Properties.pinnedServers,
                            PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                            pinnedServers.getText()));
                }
            }
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent
                                .firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this,
                                        EsbViewsRepository.Task.Properties.pinnedServers, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.pinnedServers, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTaskImplementationText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Task.Properties.taskImplementation,
                EsbMessages.TaskPropertiesEditionPart_TaskImplementationLabel);
        ...
        taskImplementation.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartForm.this, EsbViewsRepository.Task.Properties.taskImplementation,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                            taskImplementation.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartForm.this, EsbViewsRepository.Task.Properties.taskImplementation,
                            PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                            taskImplementation.getText()));
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                ...
                                EsbViewsRepository.Task.Properties.taskImplementation, PropertiesEditionEvent.COMMIT,
                                PropertiesEditionEvent.SET, null, taskImplementation.getText()));
                }
            }
        });
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.Task.Properties.taskImplementation, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTaskPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.taskProperties = new ReferencesTable(getDescription(EsbViewsRepository.Task.Properties.taskProperties,
                EsbMessages.TaskPropertiesEditionPart_TaskPropertiesLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                TaskPropertiesEditionPartForm.this, EsbViewsRepository.Task.Properties.taskProperties,
        ...
        this.taskProperties.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.taskProperties, EsbViewsRepository.FORM_KIND));
        ...
        this.taskProperties.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this,
                                    EsbViewsRepository.Task.Properties.taskProperties, PropertiesEditionEvent.CHANGE,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TaskPropertiesEditionPart#initTriggerType(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TaskPropertiesEditionPart#setTaskImplementation(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TaskPropertiesEditionPart#initTaskProperties(EObject current,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TaskPropertiesEditionPart#addFilterTaskProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TaskPropertiesEditionPart#addBusinessFilterTaskProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TaskPropertiesEditionPart#isContainedInTaskPropertiesTable(EObject
     *      element)
     * 
     */
