...
public class DataMapperCreationWizard extends Wizard implements INewWizard {
	...
	public void addPages() {
		diagramModelFilePage = new org.wso2.integrationstudio.datamapper.diagram.part.DataMapperCreationWizardPage(
				"DiagramModelFile", getSelection(), "datamapper_diagram"); //$NON-NLS-1$ //$NON-NLS-2$

		diagramModelFilePage.setTitle(
				org.wso2.integrationstudio.datamapper.diagram.part.Messages.DataMapperCreationWizard_DiagramModelFilePageTitle);
		diagramModelFilePage.setDescription(
				org.wso2.integrationstudio.datamapper.diagram.part.Messages.DataMapperCreationWizard_DiagramModelFilePageDescription);
		addPage(diagramModelFilePage);

		domainModelFilePage = new org.wso2.integrationstudio.datamapper.diagram.part.DataMapperCreationWizardPage(
			...
			public void setVisible(boolean visible) {
				if (visible) {
					...
					setFileName(org.wso2.integrationstudio.datamapper.diagram.part.DataMapperDiagramEditorUtil
		...
		domainModelFilePage.setTitle(
				org.wso2.integrationstudio.datamapper.diagram.part.Messages.DataMapperCreationWizard_DomainModelFilePageTitle);
		domainModelFilePage.setDescription(
				org.wso2.integrationstudio.datamapper.diagram.part.Messages.DataMapperCreationWizard_DomainModelFilePageDescription);
