 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfRuleMediatorInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			RuleMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(RuleMediatorInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
