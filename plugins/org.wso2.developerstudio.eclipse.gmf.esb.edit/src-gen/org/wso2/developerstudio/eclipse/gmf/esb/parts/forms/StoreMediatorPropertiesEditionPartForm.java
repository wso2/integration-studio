...
public class StoreMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, StoreMediatorPropertiesEditionPart {
	...
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.StoreMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMessageStoreText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.StoreMediator.Properties.messageStore, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createAvailableMessageStoresText(FormToolkit widgetFactory, Composite parent) {
		...
		availableMessageStores = widgetFactory.createText(parent, ""); //$NON-NLS-1$
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, availableMessageStores.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(
									StoreMediatorPropertiesEditionPartForm.this,
									EsbViewsRepository.StoreMediator.Properties.availableMessageStores,
									PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST,
									null, availableMessageStores.getText()));
				}
			}
		...
		availableMessageStores.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StoreMediatorPropertiesEditionPartForm.this, EsbViewsRepository.StoreMediator.Properties.availableMessageStores, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, availableMessageStores.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.StoreMediator.Properties.availableMessageStores, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createSpecifyAsEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.StoreMediator.Properties.specifyAs, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.StoreMediatorPropertiesEditionPart#setDescription(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.StoreMediatorPropertiesEditionPart#setCommentsList(EList newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.StoreMediatorPropertiesEditionPart#setReverse(Boolean newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.StoreMediatorPropertiesEditionPart#setMessageStore(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.StoreMediatorPropertiesEditionPart#setAvailableMessageStores(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.StoreMediatorPropertiesEditionPart#initSpecifyAs(Object input, Enumerator current)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.StoreMediatorPropertiesEditionPart#setSpecifyAs(Enumerator newValue)
	 * 
	 */
