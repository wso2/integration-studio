 ...
 * @generated
 */
public class RecipientListEndPoint2ItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.RecipientListEndPointInputConnector_3697 == req
				.getElementType()) {
			return getGEFWrapper(new RecipientListEndPointInputConnector2CreateCommand(
					req));
		}
		if (EsbElementTypes.RecipientListEndPointOutputConnector_3698 == req
				.getElementType()) {
			return getGEFWrapper(new RecipientListEndPointOutputConnector2CreateCommand(
					req));
		}
		if (EsbElementTypes.RecipientListEndPointWestOutputConnector_3699 == req
				.getElementType()) {
			return getGEFWrapper(new RecipientListEndPointWestOutputConnector2CreateCommand(
					req));
		}
