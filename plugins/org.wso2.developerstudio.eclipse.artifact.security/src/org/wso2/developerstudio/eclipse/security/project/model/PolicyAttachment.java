...
@XmlRootElement(name = "PolicyAttachment", namespace = "http://schemas.xmlsoap.org/ws/2004/09/policy")
public class PolicyAttachment {
    ...
    @XmlElements({
        @XmlElement(name = "Policy", namespace = "http://schemas.xmlsoap.org/ws/2004/09/policy", type = Policy2 .class),
