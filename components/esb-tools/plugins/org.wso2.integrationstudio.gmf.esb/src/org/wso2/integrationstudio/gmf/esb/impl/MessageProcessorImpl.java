...
public class MessageProcessorImpl extends EsbElementImpl implements MessageProcessor {
    ...
    protected MessageProcessorImpl() {
        ...
        IntegrationStudioProviderUtils.addFilter((Map<String, List<String>>) sequence.getFilters(),
        ...
        IntegrationStudioProviderUtils.addFilter((Map<String, List<String>>) replaySequence.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, ESBMediaTypeConstants.MEDIA_TYPE_SEQUENCE);
        ...
        IntegrationStudioProviderUtils.addFilter((Map<String, List<String>>) faultSequence.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, ESBMediaTypeConstants.MEDIA_TYPE_SEQUENCE);
