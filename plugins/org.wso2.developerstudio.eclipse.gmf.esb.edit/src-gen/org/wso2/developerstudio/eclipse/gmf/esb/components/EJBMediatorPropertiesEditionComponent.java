...
public class EJBMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public EJBMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject eJBMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.EJBMediator.Properties.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, eJBMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.EJBMediator.Properties.beanstalk))
                basePart.setBeanstalk(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, eJBMediator.getBeanstalk()));

            if (isAccessible(EsbViewsRepository.EJBMediator.Properties.class_))
                basePart.setClass_(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, eJBMediator.getClass_()));

            if (isAccessible(EsbViewsRepository.EJBMediator.Properties.method))
                basePart.setMethod(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, eJBMediator.getMethod()));

            if (isAccessible(EsbViewsRepository.EJBMediator.Properties.sessionIdType)) {
                basePart.initSessionIdType(
                        EEFUtils.choiceOfValues(eJBMediator, EsbPackage.eINSTANCE.getEJBMediator_SessionIdType()),
                        eJBMediator.getSessionIdType());
            }
            if (isAccessible(EsbViewsRepository.EJBMediator.Properties.sessionIdLiteral))
                basePart.setSessionIdLiteral(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        eJBMediator.getSessionIdLiteral()));
            ...
            if (isAccessible(EsbViewsRepository.EJBMediator.Properties.target))
                basePart.setTarget(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, eJBMediator.getTarget()));

            if (isAccessible(EsbViewsRepository.EJBMediator.Properties.jNDIName))
                basePart.setJNDIName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, eJBMediator.getJNDIName()));

            if (isAccessible(EsbViewsRepository.EJBMediator.Properties.methodArguments)) {
                methodArgumentsSettings = new ReferencesTableSettings(eJBMediator,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.EJBMediator.Properties.description == event.getAffectedEditor()) {
            eJBMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.EJBMediator.Properties.beanstalk == event.getAffectedEditor()) {
            eJBMediator.setBeanstalk((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.EJBMediator.Properties.class_ == event.getAffectedEditor()) {
            eJBMediator.setClass((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.EJBMediator.Properties.method == event.getAffectedEditor()) {
            eJBMediator.setMethod((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.EJBMediator.Properties.sessionIdLiteral == event.getAffectedEditor()) {
            eJBMediator.setSessionIdLiteral((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.EJBMediator.Properties.target == event.getAffectedEditor()) {
            eJBMediator.setTarget((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.EJBMediator.Properties.jNDIName == event.getAffectedEditor()) {
            eJBMediator.setJNDIName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.EJBMediator.Properties.methodArguments == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, methodArgumentsSettings, editingContext.getAdapterFactory());
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.EJBMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EJBMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EJBMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEJBMediator_Beanstalk().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EJBMediator.Properties.beanstalk)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEJBMediator_Class().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EJBMediator.Properties.class_)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEJBMediator_Method().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EJBMediator.Properties.method)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEJBMediator_SessionIdType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.EJBMediator.Properties.sessionIdType))
                basePart.setSessionIdType((PropertyValueType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEJBMediator_SessionIdLiteral().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EJBMediator.Properties.sessionIdLiteral)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEJBMediator_Remove().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EJBMediator.Properties.remove))
                basePart.setRemove((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEJBMediator_Target().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EJBMediator.Properties.target)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEJBMediator_JNDIName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EJBMediator.Properties.jNDIName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEJBMediator_MethodArguments().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.EJBMediator.Properties.methodArguments))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getEJBMediator_Beanstalk(),
                EsbPackage.eINSTANCE.getEJBMediator_Class(), EsbPackage.eINSTANCE.getEJBMediator_Method(),
                EsbPackage.eINSTANCE.getEJBMediator_SessionIdType(),
                EsbPackage.eINSTANCE.getEJBMediator_SessionIdLiteral(), EsbPackage.eINSTANCE.getEJBMediator_Remove(),
                EsbPackage.eINSTANCE.getEJBMediator_Target(), EsbPackage.eINSTANCE.getEJBMediator_JNDIName(),
                EsbPackage.eINSTANCE.getEJBMediator_MethodArguments(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.EJBMediator.Properties.beanstalk == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEJBMediator_Beanstalk().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getEJBMediator_Beanstalk().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EJBMediator.Properties.class_ == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEJBMediator_Class().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getEJBMediator_Class().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EJBMediator.Properties.method == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEJBMediator_Method().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getEJBMediator_Method().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EJBMediator.Properties.sessionIdType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEJBMediator_SessionIdType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getEJBMediator_SessionIdType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EJBMediator.Properties.sessionIdLiteral == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEJBMediator_SessionIdLiteral().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getEJBMediator_SessionIdLiteral().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EJBMediator.Properties.remove == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEJBMediator_Remove().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getEJBMediator_Remove().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EJBMediator.Properties.target == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEJBMediator_Target().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getEJBMediator_Target().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EJBMediator.Properties.jNDIName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEJBMediator_JNDIName().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getEJBMediator_JNDIName().getEAttributeType(), newValue);
                }
