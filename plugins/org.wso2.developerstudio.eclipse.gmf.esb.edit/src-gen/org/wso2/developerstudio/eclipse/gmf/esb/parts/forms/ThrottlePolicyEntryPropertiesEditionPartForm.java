...
import org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart;
 ...
 * 
 */
public class ThrottlePolicyEntryPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ThrottlePolicyEntryPropertiesEditionPart {
     ...
     */
    public ThrottlePolicyEntryPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = throttlePolicyEntryStep
                .addStep(EsbViewsRepository.ThrottlePolicyEntry.Properties.class);
    ...
    protected Composite createThrottleTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleType,
                EsbMessages.ThrottlePolicyEntryPropertiesEditionPart_ThrottleTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleType,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getThrottleType()));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createThrottleRangeText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleRange,
                EsbMessages.ThrottlePolicyEntryPropertiesEditionPart_ThrottleRangeLabel);
        ...
        throttleRange.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ThrottlePolicyEntryPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleRange,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    throttleRange.getText()));
                }
            }
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ThrottlePolicyEntryPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleRange, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAccessTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ThrottlePolicyEntry.Properties.accessType,
                EsbMessages.ThrottlePolicyEntryPropertiesEditionPart_AccessTypeLabel);
        ...
        accessType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ThrottlePolicyEntryPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ThrottlePolicyEntry.Properties.accessType,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getAccessType()));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottlePolicyEntry.Properties.accessType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMaxRequestCountText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ThrottlePolicyEntry.Properties.maxRequestCount,
                EsbMessages.ThrottlePolicyEntryPropertiesEditionPart_MaxRequestCountLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottlePolicyEntry.Properties.maxRequestCount, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createUnitTimeText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ThrottlePolicyEntry.Properties.unitTime,
                EsbMessages.ThrottlePolicyEntryPropertiesEditionPart_UnitTimeLabel);
        ...
        unitTime.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ThrottlePolicyEntryPropertiesEditionPartForm.this,
                            EsbViewsRepository.ThrottlePolicyEntry.Properties.unitTime, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, unitTime.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ThrottlePolicyEntryPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottlePolicyEntry.Properties.unitTime, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createProhibitPeriodText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ThrottlePolicyEntry.Properties.prohibitPeriod,
                EsbMessages.ThrottlePolicyEntryPropertiesEditionPart_ProhibitPeriodLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.ThrottlePolicyEntry.Properties.prohibitPeriod, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart#getThrottleType()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart#initThrottleType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart#setThrottleType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart#getThrottleRange()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart#setThrottleRange(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart#getAccessType()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart#initAccessType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart#setAccessType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart#getMaxRequestCount()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart#setMaxRequestCount(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart#getUnitTime()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart#setUnitTime(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart#getProhibitPeriod()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottlePolicyEntryPropertiesEditionPart#setProhibitPeriod(String
     *      newValue)
     * 
     */
