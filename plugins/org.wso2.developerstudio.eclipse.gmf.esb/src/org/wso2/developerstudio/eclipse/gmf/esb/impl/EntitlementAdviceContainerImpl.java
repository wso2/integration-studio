 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.EntitlementAdviceContainerImpl#getMediatorFlow <em>Mediator
 * Flow</em>}</li>
 * </ul>
 *
 * @generated
    ...
    public NotificationChain basicSetMediatorFlow(MediatorFlow newMediatorFlow, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.ENTITLEMENT_ADVICE_CONTAINER__MEDIATOR_FLOW, oldMediatorFlow, newMediatorFlow);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newMediatorFlow != mediatorFlow) {
            ...
            if (mediatorFlow != null)
                msgs = ((InternalEObject) mediatorFlow).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.ENTITLEMENT_ADVICE_CONTAINER__MEDIATOR_FLOW, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.ENTITLEMENT_ADVICE_CONTAINER__MEDIATOR_FLOW, newMediatorFlow, newMediatorFlow));
    }
