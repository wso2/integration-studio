 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfCloneMediatorOutputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnSource(
			CloneMediatorOutputConnectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(CloneMediatorOutputConnectorEditPart) sourceEditPart,
				targetEditPart);
	}
