...
public class RegistryKeyPropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public RegistryKeyPropertyPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject registryKeyProperty, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.RegistryKeyProperty.Properties.prettyName))
                basePart.setPrettyName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        registryKeyProperty.getPrettyName()));

            if (isAccessible(EsbViewsRepository.RegistryKeyProperty.Properties.keyName))
                basePart.setKeyName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        registryKeyProperty.getKeyName()));

            if (isAccessible(EsbViewsRepository.RegistryKeyProperty.Properties.keyValue))
                basePart.setKeyValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        registryKeyProperty.getKeyValue()));

            if (isAccessible(EsbViewsRepository.RegistryKeyProperty.Properties.filters))
                basePart.setFilters(
                        EEFConverterUtil.convertToString(EsbPackage.Literals.MAP, registryKeyProperty.getFilters()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.RegistryKeyProperty.Properties.prettyName == event.getAffectedEditor()) {
            registryKeyProperty.setPrettyName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.RegistryKeyProperty.Properties.keyName == event.getAffectedEditor()) {
            registryKeyProperty.setKeyName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.RegistryKeyProperty.Properties.keyValue == event.getAffectedEditor()) {
            registryKeyProperty.setKeyValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.RegistryKeyProperty.Properties.filters == event.getAffectedEditor()) {
            registryKeyProperty.setFilters((java.util.Map) EEFConverterUtil.createFromString(EsbPackage.Literals.MAP,
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getRegistryKeyProperty_PrettyName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RegistryKeyProperty.Properties.prettyName)) {
            ...
            if (EsbPackage.eINSTANCE.getRegistryKeyProperty_KeyName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RegistryKeyProperty.Properties.keyName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRegistryKeyProperty_KeyValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RegistryKeyProperty.Properties.keyValue)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRegistryKeyProperty_Filters().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RegistryKeyProperty.Properties.filters)) {
                if (msg.getNewValue() != null) {
                ...
                if (EsbViewsRepository.RegistryKeyProperty.Properties.prettyName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRegistryKeyProperty_PrettyName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRegistryKeyProperty_PrettyName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RegistryKeyProperty.Properties.keyName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRegistryKeyProperty_KeyName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRegistryKeyProperty_KeyName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RegistryKeyProperty.Properties.keyValue == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRegistryKeyProperty_KeyValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRegistryKeyProperty_KeyValue().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RegistryKeyProperty.Properties.filters == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRegistryKeyProperty_Filters().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRegistryKeyProperty_Filters().getEAttributeType(), newValue);
                }
