 ...
 * 
 */
public class SessionPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, SessionPropertiesEditionPart {
     ...
     */
    public SessionPropertiesEditionPartForm() {
        super();
    }
     ...
     * 
     */
    public SessionPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        sessionStep.addStep(EsbViewsRepository.Session.Properties.class)
    ...
    protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        propertiesSection.setText(EsbMessages.SessionPropertiesEditionPart_PropertiesGroupLabel);
    ...
    protected Composite createTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Session.Properties.type,
                EsbMessages.SessionPropertiesEditionPart_TypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SessionPropertiesEditionPartForm.this, EsbViewsRepository.Session.Properties.type,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Session.Properties.type, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SessionPropertiesEditionPart#initType(Object input,
     *      Enumerator current)
     */
