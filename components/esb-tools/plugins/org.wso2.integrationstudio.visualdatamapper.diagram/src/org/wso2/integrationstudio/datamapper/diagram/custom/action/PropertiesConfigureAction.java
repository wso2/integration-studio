...
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigurePropertiesOperatorDialog;

public class PropertiesConfigureAction extends AbstractActionHandler {
	 ...
	 */
	public PropertiesConfigureAction(IWorkbenchPart part) {
		super(part);
		setId("configure-property-operator-action-id");
		setText("Configure Property Operator");
		setToolTipText("Configure Property Operator Attributes");
	...
	protected void doRun(IProgressMonitor progressMonitor) {
		...
		Dialog configurePropertyDialog = new ConfigurePropertiesOperatorDialog(Display.getDefault().getActiveShell(),
				(Properties) selectedObj, getEditingDomain(),selectedEP);
		configurePropertyDialog.create();
		configurePropertyDialog.open();
	}
