...
public class EEFEvaluatorExpressionEditorDialog extends Dialog {
    ...
    public EEFEvaluatorExpressionEditorDialog(Shell parentShell,
    ...
    private void saveConfiguration() {
        TransactionalEditingDomain domain = TransactionUtil.getEditingDomain(evaluatorExpressionProperty);
        if (domain != null) {
