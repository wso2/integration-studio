...
public class DataModel extends Model{
	...
	private boolean unpackDatabindingClasses;
	private boolean switchOnUnwrapping;
	...
	public void setUnpackDatabindingClasses(boolean unpackDatabindingClasses) {
		this.unpackDatabindingClasses = unpackDatabindingClasses;
	}

	public boolean isUnpackDatabindingClasses() {
		return unpackDatabindingClasses;
	}

	public void setSwitchOnUnwrapping(boolean switchOnUnwrapping) {
		this.switchOnUnwrapping = switchOnUnwrapping;
	}

	public boolean isSwitchOnUnwrapping() {
		return switchOnUnwrapping;
	}
