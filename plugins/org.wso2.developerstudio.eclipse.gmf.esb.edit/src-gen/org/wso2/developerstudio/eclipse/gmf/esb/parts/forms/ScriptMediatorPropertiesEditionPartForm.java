 ...
 * 
 */
public class ScriptMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ScriptMediatorPropertiesEditionPart {
     ...
     */
    public ScriptMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.ScriptMediator.Properties.description,
                EsbMessages.ScriptMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.ScriptMediator.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ScriptMediatorPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ScriptMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control descriptionHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.ScriptMediator.Properties.description, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ScriptMediator.Properties.commentsList,
                        EsbMessages.ScriptMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "ScriptMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ScriptMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ScriptMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ScriptMediator.Properties.reverse,
                        EsbMessages.ScriptMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ScriptMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ScriptMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ScriptMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createScriptTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        filterScriptTypeSubPropertiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent,
                "Script Type", true);
        Control scriptTypeLabel = createDescription(filterScriptTypeSubPropertiesGroup,
                EsbViewsRepository.ScriptMediator.Properties.scriptType,
                EsbMessages.ScriptMediatorPropertiesEditionPart_ScriptTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ScriptMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ScriptMediator.Properties.scriptType,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getScriptType()));
            }

        });
        scriptType.setID(EsbViewsRepository.ScriptMediator.Properties.scriptType);
        Control scriptTypeHelp = FormUtils
                .createHelpButton(widgetFactory, filterScriptTypeSubPropertiesGroup,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.ScriptMediator.Properties.scriptType, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createScriptLanguageEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control scriptLanguageLabel = createDescription(parent,
                EsbViewsRepository.ScriptMediator.Properties.scriptLanguage,
                EsbMessages.ScriptMediatorPropertiesEditionPart_ScriptLanguageLabel);
        ...
        scriptLanguage.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ScriptMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ScriptMediator.Properties.scriptLanguage, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getScriptLanguage()));
            }

        });
        scriptLanguage.setID(EsbViewsRepository.ScriptMediator.Properties.scriptLanguage);
        Control scriptLanguageHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.ScriptMediator.Properties.scriptLanguage,
    ...
    protected Composite createMediateFunctionText(FormToolkit widgetFactory, Composite parent) {
        Control mediateFunctionLabel = createDescription(parent,
                EsbViewsRepository.ScriptMediator.Properties.mediateFunction,
                EsbMessages.ScriptMediatorPropertiesEditionPart_MediateFunctionLabel);
        ...
        mediateFunction.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ScriptMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ScriptMediator.Properties.mediateFunction, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, mediateFunction.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ScriptMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ScriptMediator.Properties.mediateFunction,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    mediateFunction.getText()));
                }
            }
        ...
        Control mediateFunctionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.ScriptMediator.Properties.mediateFunction,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createScriptBodyText(FormToolkit widgetFactory, Composite parent) {
        Control scriptBodyLabel = createDescription(parent, EsbViewsRepository.ScriptMediator.Properties.scriptBody,
                EsbMessages.ScriptMediatorPropertiesEditionPart_ScriptBodyLabel);
        ...
        scriptBody.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ScriptMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ScriptMediator.Properties.scriptBody, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, scriptBody.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ScriptMediatorPropertiesEditionPartForm.this,
        ...
        Control scriptBodyHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.ScriptMediator.Properties.scriptBody, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createKeyTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control keyTypeLabel = createDescription(parent, EsbViewsRepository.ScriptMediator.Properties.keyType,
                EsbMessages.ScriptMediatorPropertiesEditionPart_KeyTypeLabel);
        ...
        keyType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ScriptMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ScriptMediator.Properties.keyType, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getKeyType()));
            }

        });
        keyType.setID(EsbViewsRepository.ScriptMediator.Properties.keyType);
        Control keyTypeHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ScriptMediator.Properties.keyType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createScriptKeysTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.scriptKeys = new ReferencesTable(
                getDescription(EsbViewsRepository.ScriptMediator.Properties.scriptKeys,
                        EsbMessages.ScriptMediatorPropertiesEditionPart_ScriptKeysLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ScriptMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.ScriptMediator.Properties.scriptKeys,
        ...
        this.scriptKeys.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ScriptMediator.Properties.scriptKeys, EsbViewsRepository.FORM_KIND));
        ...
        this.scriptKeys.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ScriptMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ScriptMediator.Properties.scriptKeys, PropertiesEditionEvent.CHANGE,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#initScriptType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#setScriptType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#initScriptLanguage(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#setScriptLanguage(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#setMediateFunction(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#setScriptBody(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#initKeyType(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#setKeyType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#initScriptKeys(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#addFilterScriptKeys(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#addBusinessFilterScriptKeys(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ScriptMediatorPropertiesEditionPart#isContainedInScriptKeysTable(EObject
     *      element)
     * 
     */
    ...
    protected Composite createScriptDynamicKey(FormToolkit widgetFactory, final Composite parent) {
        ...
        EditingUtils.setID(scriptDynamicKeyText, EsbViewsRepository.ScriptMediator.Properties.scriptDynamicKey);
        ...
        Control scriptDynamicKeyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.ScriptMediator.Properties.scriptDynamicKey,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    private void openScriptDynamicKeyNamespacedPropertyEditor(final Composite parent) {
        ...
        propertiesEditionComponent
                .firePropertiesChanged(new PropertiesEditionEvent(ScriptMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.ScriptMediator.Properties.scriptDynamicKey, PropertiesEditionEvent.COMMIT,
                        PropertiesEditionEvent.SET, null, getScriptDynamicKey()));
    }
