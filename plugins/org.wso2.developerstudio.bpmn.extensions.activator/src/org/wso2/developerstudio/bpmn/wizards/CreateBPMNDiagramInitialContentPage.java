...
public class CreateBPMNDiagramInitialContentPage extends WizardPage {
    ...
    public CreateBPMNDiagramInitialContentPage() {
        super(PAGE_NAME);
    ...
    public CreateBPMNDiagramInitialContentPage(String pageName) {
        super(pageName);
    }
