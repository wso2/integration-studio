...
public class MessageStoreParameterPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public MessageStoreParameterPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject messageStoreParameter, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.MessageStoreParameter.Properties.parameterName))
                basePart.setParameterName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStoreParameter.getParameterName()));
            ...
            if (isAccessible(EsbViewsRepository.MessageStoreParameter.Properties.parameterValue))
                basePart.setParameterValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStoreParameter.getParameterValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.MessageStoreParameter.Properties.parameterName == event.getAffectedEditor()) {
            messageStoreParameter.setParameterName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.MessageStoreParameter.Properties.parameterValue == event.getAffectedEditor()) {
            messageStoreParameter.setParameterValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStoreParameter_ParameterName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStoreParameter.Properties.parameterName)) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStoreParameter_ParameterValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStoreParameter.Properties.parameterValue)) {
                if (msg.getNewValue() != null) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.MessageStoreParameter.Properties.parameterName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStoreParameter_ParameterName().getEAttributeType(),
                                (String) newValue);
                    }
                ...
                if (EsbViewsRepository.MessageStoreParameter.Properties.parameterValue == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStoreParameter_ParameterValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStoreParameter_ParameterValue().getEAttributeType(),
