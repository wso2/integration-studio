...
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__ALLOW_DELETE;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__ALLOW_GET;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__ALLOW_HEAD;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__ALLOW_OPTIONS;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__ALLOW_PATCH;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__ALLOW_POST;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__ALLOW_PUT;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__FAULT_SEQUENCE_KEY;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__FAULT_SEQUENCE_NAME;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__FAULT_SEQUENCE_TYPE;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__IN_SEQUENCE_KEY;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__IN_SEQUENCE_NAME;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__IN_SEQUENCE_TYPE;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__OUT_SEQUENCE_KEY;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__OUT_SEQUENCE_NAME;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__OUT_SEQUENCE_TYPE;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__PROTOCOL;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__URI_TEMPLATE;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__URL_MAPPING;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.API_RESOURCE__URL_STYLE;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.SYNAPSE_API__API_NAME;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.SYNAPSE_API__CONTEXT;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.SYNAPSE_API__HOST_NAME;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.SYNAPSE_API__PORT;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.SYNAPSE_API__STATISTICS_ENABLED;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.SYNAPSE_API__TRACE_ENABLED;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.SYNAPSE_API__VERSION;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.SYNAPSE_API__VERSION_TYPE;
import static org.wso2.integrationstudio.eclipse.gmf.esb.EsbPackage.Literals.SYNAPSE_API__PUBLISH_SWAGGER;
...
public class APIDeserializer extends AbstractEsbNodeDeserializer<API, SynapseAPI> {
    ...
    public SynapseAPI createNode(IGraphicalEditPart part, API api) throws DeserializerException {
        ...
        for (int i = 0; i < resources.length; i++) {
            ...
            APIResource resource = (APIResource) DeserializerUtils.createNode(apiCompartment,
            ...
            if (protocol == 2) {
                ...
                executeSetValueCommand(API_RESOURCE__PROTOCOL, Protocol.HTTP_HTTPS);
            }
