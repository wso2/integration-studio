 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.URLRewriteRuleActionImpl#getRuleAction <em>Rule
 * Action</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.URLRewriteRuleActionImpl#getRuleFragment <em>Rule
 * Fragment</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.URLRewriteRuleActionImpl#getRuleOption <em>Rule
 * Option</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.URLRewriteRuleActionImpl#getActionExpression <em>Action
 * Expression</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.URLRewriteRuleActionImpl#getActionValue <em>Action
 * Value</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.URLRewriteRuleActionImpl#getActionRegex <em>Action
 * Regex</em>}</li>
 * </ul>
 *
 * @generated
...
public class URLRewriteRuleActionImpl extends EsbNodeImpl implements URLRewriteRuleAction {
    ...
    public void setRuleAction(RuleActionType newRuleAction) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.URL_REWRITE_RULE_ACTION__RULE_ACTION,
                    oldRuleAction, ruleAction));
    }
    ...
    public void setRuleFragment(RuleFragmentType newRuleFragment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.URL_REWRITE_RULE_ACTION__RULE_FRAGMENT,
                    oldRuleFragment, ruleFragment));
    }
    ...
    public void setRuleOption(RuleOptionType newRuleOption) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.URL_REWRITE_RULE_ACTION__RULE_OPTION,
                    oldRuleOption, ruleOption));
    }
    ...
    public NotificationChain basicSetActionExpression(NamespacedProperty newActionExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.URL_REWRITE_RULE_ACTION__ACTION_EXPRESSION, oldActionExpression, newActionExpression);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setActionExpression(NamespacedProperty newActionExpression) {
        if (newActionExpression != actionExpression) {
            ...
            if (actionExpression != null)
                msgs = ((InternalEObject) actionExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.URL_REWRITE_RULE_ACTION__ACTION_EXPRESSION, null, msgs);
            if (newActionExpression != null)
                msgs = ((InternalEObject) newActionExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.URL_REWRITE_RULE_ACTION__ACTION_EXPRESSION, null, msgs);
            msgs = basicSetActionExpression(newActionExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.URL_REWRITE_RULE_ACTION__ACTION_EXPRESSION,
                    newActionExpression, newActionExpression));
    }
    ...
    public void setActionValue(String newActionValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.URL_REWRITE_RULE_ACTION__ACTION_VALUE,
    ...
    public void setActionRegex(String newActionRegex) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.URL_REWRITE_RULE_ACTION__ACTION_REGEX,
                    oldActionRegex, actionRegex));
    }
