 ...
 * @generated NOT
 */
public class URLRewriteMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, URLRewriteMediatorPropertiesEditionPart {
     ...
     */
    public URLRewriteMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = uRLRewriteMediatorStep
                .addStep(EsbViewsRepository.URLRewriteMediator.Properties.class);
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.URLRewriteMediator.Properties.description,
                EsbMessages.URLRewriteMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.URLRewriteMediator.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(URLRewriteMediatorPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            URLRewriteMediatorPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.URLRewriteMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.URLRewriteMediator.Properties.commentsList,
                        EsbMessages.URLRewriteMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(),
                        "URLRewriteMediator", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(URLRewriteMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.URLRewriteMediator.Properties.commentsList,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.URLRewriteMediator.Properties.reverse,
                        EsbMessages.URLRewriteMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            URLRewriteMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.URLRewriteMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.URLRewriteMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createUrlRewriteRulesTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.urlRewriteRules = new ReferencesTable(
                getDescription(EsbViewsRepository.URLRewriteMediator.Properties.urlRewriteRules,
                        EsbMessages.URLRewriteMediatorPropertiesEditionPart_UrlRewriteRulesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(URLRewriteMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.URLRewriteMediator.Properties.urlRewriteRules,
        ...
        this.urlRewriteRules.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.URLRewriteMediator.Properties.urlRewriteRules, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createInPropertyText(FormToolkit widgetFactory, Composite parent) {
        filterInOutSubPropertiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent,
                "In-Out Properties", true);
        createDescription(filterInOutSubPropertiesGroup, EsbViewsRepository.URLRewriteMediator.Properties.inProperty,
                EsbMessages.URLRewriteMediatorPropertiesEditionPart_InPropertyLabel);
        ...
        inProperty.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            URLRewriteMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.URLRewriteMediator.Properties.inProperty, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, inProperty.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(URLRewriteMediatorPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, filterInOutSubPropertiesGroup,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.URLRewriteMediator.Properties.inProperty,
    ...
    protected Composite createOutPropertyText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.URLRewriteMediator.Properties.outProperty,
                EsbMessages.URLRewriteMediatorPropertiesEditionPart_OutPropertyLabel);
        ...
        outProperty.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            URLRewriteMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.URLRewriteMediator.Properties.outProperty, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, outProperty.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(URLRewriteMediatorPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.URLRewriteMediator.Properties.outProperty, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteMediatorPropertiesEditionPart#initUrlRewriteRules(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteMediatorPropertiesEditionPart#addFilterUrlRewriteRules(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteMediatorPropertiesEditionPart#addBusinessFilterUrlRewriteRules(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteMediatorPropertiesEditionPart#isContainedInUrlRewriteRulesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteMediatorPropertiesEditionPart#setInProperty(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteMediatorPropertiesEditionPart#setOutProperty(String
     *      newValue)
     * 
     */
