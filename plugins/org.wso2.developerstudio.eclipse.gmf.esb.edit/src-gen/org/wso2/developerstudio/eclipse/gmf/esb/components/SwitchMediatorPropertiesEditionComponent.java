...
public class SwitchMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public SwitchMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject switchMediator,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.SwitchMediator.Properties.source))
                basePart.setSource(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, switchMediator.getSource()));

            if (isAccessible(EsbViewsRepository.SwitchMediator.Properties.namespace))
                basePart.setNamespace(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, switchMediator.getNamespace()));
            ...
            if (isAccessible(EsbViewsRepository.SwitchMediator.Properties.namespacePrefix))
                basePart.setNamespacePrefix(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        switchMediator.getNamespacePrefix()));

            if (isAccessible(EsbViewsRepository.SwitchMediator.Properties.caseBranches)) {
                caseBranchesSettings = new ReferencesTableSettings(switchMediator,
                ...
                basePart.addFilterToCaseBranches(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof SwitchCaseBranchOutputConnector);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.SwitchMediator.Properties.description == event.getAffectedEditor()) {
            switchMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.SwitchMediator.Properties.source == event.getAffectedEditor()) {
            switchMediator.setSource((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.SwitchMediator.Properties.namespace == event.getAffectedEditor()) {
            switchMediator.setNamespace((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.SwitchMediator.Properties.namespacePrefix == event.getAffectedEditor()) {
            switchMediator.setNamespacePrefix((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.SwitchMediator.Properties.caseBranches == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, caseBranchesSettings, editingContext.getAdapterFactory());
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.SwitchMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SwitchMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SwitchMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getSwitchMediator_Source().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SwitchMediator.Properties.source)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getSwitchMediator_Namespace().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SwitchMediator.Properties.namespace)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getSwitchMediator_NamespacePrefix().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SwitchMediator.Properties.namespacePrefix)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getSwitchMediator_CaseBranches().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.SwitchMediator.Properties.caseBranches))
                basePart.updateCaseBranches();
            // Start of user code for sourceXPath live update
            if (EsbPackage.eINSTANCE.getSwitchMediator_SourceXpath().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SwitchMediator.Properties.sourceXPath)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getSwitchMediator_Source(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.SwitchMediator.Properties.source == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSwitchMediator_Source().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getSwitchMediator_Source().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SwitchMediator.Properties.namespace == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSwitchMediator_Namespace().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getSwitchMediator_Namespace().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SwitchMediator.Properties.namespacePrefix == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSwitchMediator_NamespacePrefix().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getSwitchMediator_NamespacePrefix().getEAttributeType(), newValue);
                }
