...
public class RecipientListEndPointPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public RecipientListEndPointPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject recipientListEndPoint, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        recipientListEndPoint.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.endPointName))
                basePart.setEndPointName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        recipientListEndPoint.getEndPointName()));
            ...
            if (isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.properties_)) {
                propertiesSettings = new ReferencesTableSettings(recipientListEndPoint,
            ...
            if (isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.children)) {
                childrenSettings = new ReferencesTableSettings(recipientListEndPoint,
            ...
            if (isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.name))
                basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        recipientListEndPoint.getName()));

            if (isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.outputConnector)) {
                outputConnectorSettings = new ReferencesTableSettings(recipientListEndPoint,
            ...
            if (isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.endpointType)) {
                basePart.initEndpointType(
                        EEFUtils.choiceOfValues(recipientListEndPoint,
                                EsbPackage.eINSTANCE.getRecipientListEndPoint_EndpointType()),
                        recipientListEndPoint.getEndpointType());
            }
            if (isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.endpointsValue))
                basePart.setEndpointsValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        recipientListEndPoint.getEndpointsValue()));

            if (isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.maxCache)) {
                basePart.setMaxCache(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        recipientListEndPoint.getMaxCache()));
            }
            ...
            if (isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.outputConnector)) {
                basePart.addFilterToOutputConnector(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof RecipientListEndPointOutputConnector);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.RecipientListEndPoint.Properties.description == event.getAffectedEditor()) {
            recipientListEndPoint.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.RecipientListEndPoint.Properties.endPointName == event.getAffectedEditor()) {
            recipientListEndPoint.setEndPointName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.RecipientListEndPoint.Properties.name == event.getAffectedEditor()) {
            recipientListEndPoint.setName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.RecipientListEndPoint.Properties.outputConnector == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                ...
                outputConnectorSettings.move(event.getNewIndex(),
                        (RecipientListEndPointOutputConnector) event.getNewValue());
            }
        }
        ...
        if (EsbViewsRepository.RecipientListEndPoint.Properties.endpointsValue == event.getAffectedEditor()) {
            recipientListEndPoint.setEndpointsValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.RecipientListEndPoint.Properties.maxCache == event.getAffectedEditor()) {
            recipientListEndPoint.setMaxCache(
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getEndPoint_EndPointName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.endPointName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRecipientListEndPoint_OutputConnector().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.outputConnector))
                basePart.updateOutputConnector();
            if (EsbPackage.eINSTANCE.getRecipientListEndPoint_EndpointType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.endpointType))
                basePart.setEndpointType((RecipientListEndpointType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getRecipientListEndPoint_EndpointsValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.endpointsValue)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRecipientListEndPoint_MaxCache().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RecipientListEndPoint.Properties.maxCache)) {
                if (msg.getNewValue() != null) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.RecipientListEndPoint.Properties.endpointType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRecipientListEndPoint_EndpointType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRecipientListEndPoint_EndpointType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RecipientListEndPoint.Properties.endpointsValue == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRecipientListEndPoint_EndpointsValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRecipientListEndPoint_EndpointsValue().getEAttributeType(),
                ...
                if (EsbViewsRepository.RecipientListEndPoint.Properties.maxCache == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRecipientListEndPoint_MaxCache().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRecipientListEndPoint_MaxCache().getEAttributeType(), newValue);
                }
