 ...
 * @generated NOT
 */
public class TemplateEndpointPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, TemplateEndpointPropertiesEditionPart {
     ...
     */
    public TemplateEndpointPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = templateEndpointStep
                .addStep(EsbViewsRepository.TemplateEndpoint.Properties.class);
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        ...
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.description,
                EsbMessages.TemplateEndpointPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.TemplateEndpoint.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(TemplateEndpointPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.TemplateEndpoint.Properties.commentsList,
                        EsbMessages.TemplateEndpointPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "TemplateEndpoint", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.TemplateEndpoint.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createEndPointNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.endPointName,
                EsbMessages.TemplateEndpointPropertiesEditionPart_EndPointNameLabel);
        ...
        endPointName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.TemplateEndpoint.Properties.endPointName, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.endPointName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAnonymousCheckbox(FormToolkit widgetFactory, Composite parent) {
        anonymous = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.TemplateEndpoint.Properties.anonymous,
                        EsbMessages.TemplateEndpointPropertiesEditionPart_AnonymousLabel),
                SWT.CHECK);
        anonymous.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.TemplateEndpoint.Properties.anonymous, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.anonymous, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInLineCheckbox(FormToolkit widgetFactory, Composite parent) {
        inLine = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.TemplateEndpoint.Properties.inLine,
                        EsbMessages.TemplateEndpointPropertiesEditionPart_InLineLabel),
                SWT.CHECK);
        inLine.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.TemplateEndpoint.Properties.inLine, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.inLine, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(FormToolkit widgetFactory, Composite parent) {
        duplicate = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.TemplateEndpoint.Properties.duplicate,
                        EsbMessages.TemplateEndpointPropertiesEditionPart_DuplicateLabel),
                SWT.CHECK);
        duplicate.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.TemplateEndpoint.Properties.duplicate, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.duplicate, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.properties = new ReferencesTable(
                getDescription(EsbViewsRepository.TemplateEndpoint.Properties.properties_,
                        EsbMessages.TemplateEndpointPropertiesEditionPart_PropertiesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(TemplateEndpointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.TemplateEndpoint.Properties.properties_,
        ...
        this.properties.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.properties_, EsbViewsRepository.FORM_KIND));
        ...
        this.properties.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.TemplateEndpoint.Properties.properties_, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createReversedCheckbox(FormToolkit widgetFactory, Composite parent) {
        reversed = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.TemplateEndpoint.Properties.reversed,
                        EsbMessages.TemplateEndpointPropertiesEditionPart_ReversedLabel),
                SWT.CHECK);
        reversed.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.TemplateEndpoint.Properties.reversed, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.reversed, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createReliableMessagingEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        reliableMessagingEnabled = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.TemplateEndpoint.Properties.reliableMessagingEnabled,
                                EsbMessages.TemplateEndpointPropertiesEditionPart_ReliableMessagingEnabledLabel),
                        SWT.CHECK);
        reliableMessagingEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(TemplateEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.TemplateEndpoint.Properties.reliableMessagingEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createSecurityEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        securityEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.TemplateEndpoint.Properties.securityEnabled,
                        EsbMessages.TemplateEndpointPropertiesEditionPart_SecurityEnabledLabel),
                SWT.CHECK);
        securityEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(TemplateEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.TemplateEndpoint.Properties.securityEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.TemplateEndpoint.Properties.securityEnabled, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAddressingEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        addressingEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.TemplateEndpoint.Properties.addressingEnabled,
                        EsbMessages.TemplateEndpointPropertiesEditionPart_AddressingEnabledLabel),
                SWT.CHECK);
        addressingEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(TemplateEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.TemplateEndpoint.Properties.addressingEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.TemplateEndpoint.Properties.addressingEnabled, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAddressingVersionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.addressingVersion,
                EsbMessages.TemplateEndpointPropertiesEditionPart_AddressingVersionLabel);
        ...
        addressingVersion.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.TemplateEndpoint.Properties.addressingVersion,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.TemplateEndpoint.Properties.addressingVersion, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAddressingSeparateListenerCheckbox(FormToolkit widgetFactory, Composite parent) {
        addressingSeparateListener = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.TemplateEndpoint.Properties.addressingSeparateListener,
                                EsbMessages.TemplateEndpointPropertiesEditionPart_AddressingSeparateListenerLabel),
                        SWT.CHECK);
        addressingSeparateListener.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(TemplateEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.TemplateEndpoint.Properties.addressingSeparateListener,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createTimeOutDurationText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.timeOutDuration,
                EsbMessages.TemplateEndpointPropertiesEditionPart_TimeOutDurationLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.TemplateEndpoint.Properties.timeOutDuration, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createTimeOutActionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.timeOutAction,
                EsbMessages.TemplateEndpointPropertiesEditionPart_TimeOutActionLabel);
        ...
        timeOutAction.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.TemplateEndpoint.Properties.timeOutAction, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.timeOutAction, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRetryErrorCodesText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.retryErrorCodes,
                EsbMessages.TemplateEndpointPropertiesEditionPart_RetryErrorCodesLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.TemplateEndpoint.Properties.retryErrorCodes, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRetryCountText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.retryCount,
                EsbMessages.TemplateEndpointPropertiesEditionPart_RetryCountLabel);
        ...
        retryCount.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.TemplateEndpoint.Properties.retryCount, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.retryCount, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRetryDelayText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.retryDelay,
                EsbMessages.TemplateEndpointPropertiesEditionPart_RetryDelayLabel);
        ...
        retryDelay.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.TemplateEndpoint.Properties.retryDelay, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.retryDelay, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSuspendErrorCodesText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.suspendErrorCodes,
                EsbMessages.TemplateEndpointPropertiesEditionPart_SuspendErrorCodesLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.TemplateEndpoint.Properties.suspendErrorCodes, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createSuspendInitialDurationText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.suspendInitialDuration,
                EsbMessages.TemplateEndpointPropertiesEditionPart_SuspendInitialDurationLabel);
    ...
    protected Composite createSuspendMaximumDurationText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.suspendMaximumDuration,
                EsbMessages.TemplateEndpointPropertiesEditionPart_SuspendMaximumDurationLabel);
    ...
    protected Composite createSuspendProgressionFactorText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.suspendProgressionFactor,
                EsbMessages.TemplateEndpointPropertiesEditionPart_SuspendProgressionFactorLabel);
    ...
    protected Composite createFormatEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.format,
                EsbMessages.TemplateEndpointPropertiesEditionPart_FormatLabel);
        ...
        format.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(TemplateEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.TemplateEndpoint.Properties.format,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.format, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOptimizeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.optimize,
                EsbMessages.TemplateEndpointPropertiesEditionPart_OptimizeLabel);
        ...
        optimize.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(TemplateEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.TemplateEndpoint.Properties.optimize,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.optimize, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTemplateParametersTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.templateParameters = new ReferencesTable(
                getDescription(EsbViewsRepository.TemplateEndpoint.Properties.templateParameters,
                        EsbMessages.TemplateEndpointPropertiesEditionPart_TemplateParametersLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(TemplateEndpointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.TemplateEndpoint.Properties.templateParameters,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.templateParameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.templateParameters, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createStatisticsEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        statisticsEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.TemplateEndpoint.Properties.statisticsEnabled,
                        EsbMessages.TemplateEndpointPropertiesEditionPart_StatisticsEnabledLabel),
                SWT.CHECK);
        statisticsEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(TemplateEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.TemplateEndpoint.Properties.statisticsEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.TemplateEndpoint.Properties.statisticsEnabled, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createTraceEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        traceEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.TemplateEndpoint.Properties.traceEnabled,
                        EsbMessages.TemplateEndpointPropertiesEditionPart_TraceEnabledLabel),
                SWT.CHECK);
        traceEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.TemplateEndpoint.Properties.traceEnabled, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.traceEnabled, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.address,
                EsbMessages.TemplateEndpointPropertiesEditionPart_AddressLabel);
        ...
        address.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.TemplateEndpoint.Properties.address, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, address.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(TemplateEndpointPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.address, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTargetTemplateText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.targetTemplate,
                EsbMessages.TemplateEndpointPropertiesEditionPart_TargetTemplateLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.targetTemplate, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createParametersTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.parameters = new ReferencesTable(
                getDescription(EsbViewsRepository.TemplateEndpoint.Properties.parameters,
                        EsbMessages.TemplateEndpointPropertiesEditionPart_ParametersLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(TemplateEndpointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.TemplateEndpoint.Properties.parameters,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
                        parameters.refresh();
                    }
        ...
        this.parameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.parameters, EsbViewsRepository.FORM_KIND));
        ...
        this.parameters.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplateEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.TemplateEndpoint.Properties.parameters, PropertiesEditionEvent.CHANGE,
                            PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
    ...
    protected Composite createAvailableTemplatesText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.TemplateEndpoint.Properties.availableTemplates,
                EsbMessages.TemplateEndpointPropertiesEditionPart_AvailableTemplatesLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TemplateEndpoint.Properties.availableTemplates, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setEndPointName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setAnonymous(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setInLine(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setDuplicate(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#initProperties(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#addFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#addBusinessFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#isContainedInPropertiesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setReversed(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setReliableMessagingEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setSecurityEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setAddressingEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#initAddressingVersion(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setAddressingVersion(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setAddressingSeparateListener(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setTimeOutDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#initTimeOutAction(Object
     *      input, Enumerator current)
     */
    public void initTimeOutAction(Object input, Enumerator current) {
        ...
        boolean eefElementEditorReadOnlyState = isReadOnly(
                EsbViewsRepository.TemplateEndpoint.Properties.timeOutAction);
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setTimeOutAction(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setRetryErrorCodes(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setRetryCount(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setRetryDelay(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setSuspendErrorCodes(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setSuspendInitialDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setSuspendMaximumDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setSuspendProgressionFactor(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#initFormat(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setFormat(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#initOptimize(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setOptimize(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#initTemplateParameters(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#addFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#addBusinessFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#isContainedInTemplateParametersTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setStatisticsEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setTraceEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setAddress(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setTargetTemplate(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#initParameters(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#addFilterParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#addBusinessFilterParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#isContainedInParametersTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplateEndpointPropertiesEditionPart#setAvailableTemplates(String
     *      newValue)
     * 
     */
