...
public class MediatorFlowPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public MediatorFlowPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject mediatorFlow,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.MediatorFlow.Properties.children)) {
                childrenSettings = new ReferencesTableSettings(mediatorFlow,
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getMediatorFlow_Children().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.MediatorFlow.Properties.children))
