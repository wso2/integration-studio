...
public class ConfigureRuleMediatorSessionPropertyDialog extends Dialog {
    ...
    public ConfigureRuleMediatorSessionPropertyDialog(Shell parentShell, RuleMediator ruleMediator) {
        super(parentShell);
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        sessionPropTable = new Table(container, SWT.BORDER | SWT.FULL_SELECTION | SWT.HIDE_SELECTION);
        ...
        addBtn.addListener(SWT.Selection, new Listener() {
            ...
            public void handleEvent(Event event) {
                ...
                TableItem item = bindSessionProperty(EsbFactory.eINSTANCE.createRuleSessionProperty());
        ...
        for (RuleSessionProperty sessionProp : ruleMediator.getRuleSessionProperties()) {
    ...
    private TableItem bindSessionProperty(RuleSessionProperty sessionProperty) {
        ...
        item.setText(new String[] { sessionProperty.getPropertyName(), sessionProperty.getPropertyValue() });
    ...
    private void unbindSessionProperty(int selectedIndex) {
        ...
        if (null != sessionProp.eContainer()) {
            ...
            RemoveCommand reoveCmd = new RemoveCommand(editingDomain, ruleMediator,
                    EsbPackage.Literals.RULE_MEDIATOR__RULE_SESSION_PROPERTIES, sessionProp);
    ...
    public void okPressed() {
        ...
        for (TableItem item : sessionPropTable.getItems()) {
            ...
            RuleSessionProperty sessionProperty = (RuleSessionProperty) item.getData();
            ...
            if (sessionProperty.eContainer() == null) {
                ...
                AddCommand addCmd = new AddCommand(editingDomain, ruleMediator,
                        EsbPackage.Literals.RULE_MEDIATOR__RULE_SESSION_PROPERTIES, sessionProperty);
                getResultCommand().append(addCmd);
            } else {

                if (!item.getText(0).equals(sessionProperty.getPropertyName())) {
                    SetCommand setTypeCmd = new SetCommand(editingDomain, sessionProperty,
