 ...
 * 
 */
public class CommandPropertyPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, CommandPropertyPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        CompositionStep propertiesStep = commandPropertyStep
                .addStep(EsbViewsRepository.CommandProperty.Properties.class);
    ...
    protected Composite createPropertyNameText(Composite parent) {
        Control propertyNameTextLabel = createDescription(parent,
                EsbViewsRepository.CommandProperty.Properties.propertyName,
                EsbMessages.CommandPropertyPropertiesEditionPart_PropertyNameLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CommandPropertyPropertiesEditionPartImpl.this,
                            EsbViewsRepository.CommandProperty.Properties.propertyName, PropertiesEditionEvent.COMMIT,
                ...
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(CommandPropertyPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.CommandProperty.Properties.propertyName,
        ...
        Control propertyNameTextHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CommandProperty.Properties.propertyName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueTypeEMFComboViewer(Composite parent) {
        Control valueTypeLabel = createDescription(parent, EsbViewsRepository.CommandProperty.Properties.valueType,
                EsbMessages.CommandPropertyPropertiesEditionPart_ValueTypeLabel);
        ...
        valueType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CommandPropertyPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.CommandProperty.Properties.valueType,
        ...
        Control valueTypeHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CommandProperty.Properties.valueType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueLiteralText(Composite parent) {
        Control valueLiteralLabel = createDescription(parent,
                EsbViewsRepository.CommandProperty.Properties.valueLiteral,
                EsbMessages.CommandPropertyPropertiesEditionPart_ValueLiteralLabel);
        ...
        valueLiteral.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CommandPropertyPropertiesEditionPartImpl.this,
                            EsbViewsRepository.CommandProperty.Properties.valueLiteral, PropertiesEditionEvent.COMMIT,
        ...
        Control valueLiteralHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CommandProperty.Properties.valueLiteral, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueContextPropertyNameText(Composite parent) {
        Control valueContextPropertyNameLabel = createDescription(parent,
                EsbViewsRepository.CommandProperty.Properties.valueContextPropertyName,
                EsbMessages.CommandPropertyPropertiesEditionPart_ValueContextPropertyNameLabel);
                ...
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CommandPropertyPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.CommandProperty.Properties.valueContextPropertyName,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    valueContextPropertyName.getText()));
            }
        ...
        EditingUtils.setID(valueContextPropertyName,
                EsbViewsRepository.CommandProperty.Properties.valueContextPropertyName);
        EditingUtils.setEEFtype(valueContextPropertyName, "eef::Text"); //$NON-NLS-1$
        Control valueContextPropertyNameHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CommandProperty.Properties.valueContextPropertyName,
                        EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createValueContextPropertyNameText
        valueContextPropertyNameControls = new Control[] { valueContextPropertyNameLabel, valueContextPropertyName,
                valueContextPropertyNameHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createContextActionEMFComboViewer(Composite parent) {
        Control contextActionLabel = createDescription(parent,
                EsbViewsRepository.CommandProperty.Properties.contextAction,
                EsbMessages.CommandPropertyPropertiesEditionPart_ContextActionLabel);
        ...
        contextAction.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CommandPropertyPropertiesEditionPartImpl.this,
                            EsbViewsRepository.CommandProperty.Properties.contextAction, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getContextAction()));
            }

        });
        contextAction.setID(EsbViewsRepository.CommandProperty.Properties.contextAction);
        Control contextActionHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CommandProperty.Properties.contextAction, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMessageActionEMFComboViewer(Composite parent) {
        Control messageActionLabel = createDescription(parent,
                EsbViewsRepository.CommandProperty.Properties.messageAction,
                EsbMessages.CommandPropertyPropertiesEditionPart_MessageActionLabel);
        ...
        messageAction.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CommandPropertyPropertiesEditionPartImpl.this,
                            EsbViewsRepository.CommandProperty.Properties.messageAction, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getMessageAction()));
            }

        });
        messageAction.setID(EsbViewsRepository.CommandProperty.Properties.messageAction);
        Control messageActionHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CommandProperty.Properties.messageAction, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CommandPropertyPropertiesEditionPart#setPropertyName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CommandPropertyPropertiesEditionPart#initValueType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CommandPropertyPropertiesEditionPart#setValueType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CommandPropertyPropertiesEditionPart#setValueLiteral(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CommandPropertyPropertiesEditionPart#setValueContextPropertyName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CommandPropertyPropertiesEditionPart#initContextAction(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CommandPropertyPropertiesEditionPart#setContextAction(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CommandPropertyPropertiesEditionPart#initMessageAction(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CommandPropertyPropertiesEditionPart#setMessageAction(Enumerator
     *      newValue)
     * 
     */
        ...
        valueMessageElementXpathText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                EEFNameSpacedPropertyEditorDialog nspd = new EEFNameSpacedPropertyEditorDialog(parent.getShell(),
                        SWT.NULL, valueMessageElementXpath);
                nspd.open();
                valueMessageElementXpathText.setText(valueMessageElementXpath.getPropertyValue());
                propertiesEditionComponent
                        .firePropertiesChanged(new PropertiesEditionEvent(CommandPropertyPropertiesEditionPartImpl.this,
                                EsbViewsRepository.CommandProperty.Properties.valueMessageElementXpath,
                                PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                getValueMessageElementXpath()));
            }
