 ...
 * 
 */
public class APIResourceFaultInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, APIResourceFaultInputConnectorPropertiesEditionPart {
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.APIResourceFaultInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(APIResourceFaultInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.APIResourceFaultInputConnector.Properties.incomingLinks,
