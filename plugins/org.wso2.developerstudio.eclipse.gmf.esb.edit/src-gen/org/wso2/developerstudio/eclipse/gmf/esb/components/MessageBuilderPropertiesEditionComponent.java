...
public class MessageBuilderPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public MessageBuilderPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject messageBuilder,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.MessageBuilder.Properties.builderClass))
                basePart.setBuilderClass(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageBuilder.getBuilderClass()));

            if (isAccessible(EsbViewsRepository.MessageBuilder.Properties.formatterClass))
                basePart.setFormatterClass(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.MessageBuilder.Properties.contentType == event.getAffectedEditor()) {
            messageBuilder.setContentType((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.MessageBuilder.Properties.builderClass == event.getAffectedEditor()) {
            messageBuilder.setBuilderClass((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageBuilder.Properties.formatterClass == event.getAffectedEditor()) {
            messageBuilder.setFormatterClass((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getMessageBuilder_ContentType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageBuilder.Properties.contentType)) {
            ...
            if (EsbPackage.eINSTANCE.getMessageBuilder_BuilderClass().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageBuilder.Properties.builderClass)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageBuilder_FormatterClass().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageBuilder.Properties.formatterClass)) {
                if (msg.getNewValue() != null) {
                ...
                if (EsbViewsRepository.MessageBuilder.Properties.contentType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageBuilder_ContentType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageBuilder_ContentType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageBuilder.Properties.builderClass == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageBuilder_BuilderClass().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageBuilder_BuilderClass().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageBuilder.Properties.formatterClass == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageBuilder_FormatterClass().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageBuilder_FormatterClass().getEAttributeType(), newValue);
                }
