...
public class CalloutMediatorDeserializer extends AbstractEsbNodeDeserializer<AbstractMediator, CalloutMediator> {
    ...
    public CalloutMediator createNode(IGraphicalEditPart part, AbstractMediator mediator) {
        Assert.isTrue(mediator instanceof org.apache.synapse.mediators.builtin.CalloutMediator,
        ...
        CalloutMediator visualCalloutMediator = (CalloutMediator) DeserializerUtils.createNode(part,
        ...
        if (calloutMediator.getRequestXPath() != null) {
            executeSetValueCommand(CALLOUT_MEDIATOR__PAYLOAD_MESSAGE_XPATH,
                    createNamespacedProperty(calloutMediator.getRequestXPath()));
        ...
        if (calloutMediator.getTargetXPath() != null) {
            executeSetValueCommand(CALLOUT_MEDIATOR__RESULT_MESSAGE_XPATH,
                    createNamespacedProperty(calloutMediator.getTargetXPath()));
