...
package org.wso2.integrationstudio.carbonserver44microei40.monitoring.dashboard;
        ...
        if (!dashboardStarted) {
            synchronized (lock) {
                if (!dashboardStarted) {
                    ...
                    // set timeout time to 400 seconds
                    long timeoutExpiredMs = System.currentTimeMillis() + 400000;
