 ...
 * 
 */
public class RuleResultPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, RuleResultPropertiesEditionPart {
     ...
     */
    public RuleResultPropertiesEditionPartForm() {
        super();
    }
     ...
     * 
     */
    public RuleResultPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
        ...
        composer = new PartComposer(ruleResultStep) {
            ...
            public Composite addToPart(Composite parent, Object key) {
                ...
                if (key == EsbViewsRepository.RuleResult.Properties.resultCustomType) {
                    return createResultCustomTypeText(widgetFactory, parent);
                }
                if (key == EsbViewsRepository.RuleResult.Properties.resultName) {
                    return createResultNameText(widgetFactory, parent);
                }
    ...
    protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        propertiesSection.setText(EsbMessages.RuleResultPropertiesEditionPart_PropertiesGroupLabel);
    ...
    protected Composite createResultTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RuleResult.Properties.resultType,
                EsbMessages.RuleResultPropertiesEditionPart_ResultTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(RuleResultPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleResult.Properties.resultType, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleResult.Properties.resultType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResultCustomTypeText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RuleResult.Properties.resultCustomType,
                EsbMessages.RuleResultPropertiesEditionPart_ResultCustomTypeLabel);
        resultCustomType = widgetFactory.createText(parent, ""); //$NON-NLS-1$
        resultCustomType.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
        ...
        resultCustomType.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleResultPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleResult.Properties.resultCustomType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, resultCustomType.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(RuleResultPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleResult.Properties.resultCustomType,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    resultCustomType.getText()));
                }
            }
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleResultPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(RuleResultPropertiesEditionPartForm.this,
                                        EsbViewsRepository.RuleResult.Properties.resultCustomType,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleResult.Properties.resultCustomType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResultNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RuleResult.Properties.resultName,
                EsbMessages.RuleResultPropertiesEditionPart_ResultNameLabel);
        resultName = widgetFactory.createText(parent, ""); //$NON-NLS-1$
        resultName.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
        widgetFactory.paintBordersFor(parent);
        ...
        resultName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(RuleResultPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleResult.Properties.resultName, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, resultName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleResultPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleResult.Properties.resultName, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, resultName.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleResult.Properties.resultName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RuleResult.Properties.valueType,
                EsbMessages.RuleResultPropertiesEditionPart_ValueTypeLabel);
        ...
        valueType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(RuleResultPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RuleResult.Properties.valueType, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleResult.Properties.valueType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueLiteralText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RuleResult.Properties.valueLiteral,
                EsbMessages.RuleResultPropertiesEditionPart_ValueLiteralLabel);
        ...
        valueLiteral.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleResultPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleResult.Properties.valueLiteral, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, valueLiteral.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleResultPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleResult.Properties.valueLiteral, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, valueLiteral.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleResult.Properties.valueLiteral, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleResultPropertiesEditionPart#initResultType(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleResultPropertiesEditionPart#setResultType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleResultPropertiesEditionPart#setResultCustomType(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleResultPropertiesEditionPart#setResultName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleResultPropertiesEditionPart#initValueType(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleResultPropertiesEditionPart#setValueType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleResultPropertiesEditionPart#setValueLiteral(String
     *      newValue)
     * 
     */
