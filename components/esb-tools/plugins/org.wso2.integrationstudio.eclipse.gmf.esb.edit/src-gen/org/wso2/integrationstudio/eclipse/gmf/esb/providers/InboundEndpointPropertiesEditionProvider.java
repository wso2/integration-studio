...
import org.wso2.integrationstudio.eclipse.gmf.esb.components.InboundEndpointPropertiesEditionComponent;
...
public class InboundEndpointPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof InboundEndpoint) && (InboundEndpointPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof InboundEndpoint) && (refinement == InboundEndpointPropertiesEditionComponent.class);
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof InboundEndpoint) && ((InboundEndpointPropertiesEditionComponent.BASE_PART.equals(part) && refinement == InboundEndpointPropertiesEditionComponent.class));
	}
