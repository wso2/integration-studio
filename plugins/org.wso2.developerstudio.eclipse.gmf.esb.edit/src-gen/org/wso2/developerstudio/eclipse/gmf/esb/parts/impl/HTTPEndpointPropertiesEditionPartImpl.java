 ...
 * 
 */
public class HTTPEndpointPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, HTTPEndpointPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        hTTPEndpointStep.addStep(EsbViewsRepository.HTTPEndpoint.FailoverErrorCodes.class)
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.HTTPEndpoint.Properties.commentsList,
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            HTTPEndpointPropertiesEditionPartImpl.this,
    ...
    protected Composite createEndPointNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.HTTPEndpoint.Properties.endPointName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAnonymousCheckbox(Composite parent) {
        ...
        anonymous.setText(getDescription(EsbViewsRepository.HTTPEndpoint.Properties.anonymous,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(HTTPEndpointPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.HTTPEndpoint.Properties.anonymous, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInLineCheckbox(Composite parent) {
        ...
        inLine.setText(getDescription(EsbViewsRepository.HTTPEndpoint.Properties.inLine,
                EsbMessages.HTTPEndpointPropertiesEditionPart_InLineLabel));
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.HTTPEndpoint.Properties.inLine, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(Composite parent) {
        ...
        duplicate.setText(getDescription(EsbViewsRepository.HTTPEndpoint.Properties.duplicate,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.HTTPEndpoint.Properties.duplicate, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createReversedCheckbox(Composite parent) {
        ...
        reversed.setText(getDescription(EsbViewsRepository.HTTPEndpoint.Properties.reversed,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.HTTPEndpoint.Properties.reversed, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createReliableMessagingEnabledCheckbox(Composite parent) {
        ...
        reliableMessagingEnabled
                .setText(getDescription(EsbViewsRepository.HTTPEndpoint.Properties.reliableMessagingEnabled,
    ...
    protected Composite createSecurityEnabledCheckbox(Composite parent) {
        ...
        securityEnabled.setText(getDescription(EsbViewsRepository.HTTPEndpoint.Properties.securityEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.HTTPEndpoint.Properties.securityEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressingEnabledCheckbox(Composite parent) {
        ...
        addressingEnabled.setText(getDescription(EsbViewsRepository.HTTPEndpoint.Properties.addressingEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.HTTPEndpoint.Properties.addressingEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressingVersionEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.HTTPEndpoint.Properties.addressingVersion, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressingSeparateListenerCheckbox(Composite parent) {
        ...
        addressingSeparateListener
                .setText(getDescription(EsbViewsRepository.HTTPEndpoint.Properties.addressingSeparateListener,
    ...
    protected Composite createFormatEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.HTTPEndpoint.Properties.format, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOptimizeEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.HTTPEndpoint.Properties.optimize, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTemplateParametersAdvancedTableComposition(Composite parent) {
        ...
        this.templateParameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.HTTPEndpoint.Properties.templateParameters, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createStatisticsEnabledCheckbox(Composite parent) {
        ...
        statisticsEnabled.setText(getDescription(EsbViewsRepository.HTTPEndpoint.Basic.statisticsEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.HTTPEndpoint.Basic.statisticsEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTraceEnabledCheckbox(Composite parent) {
        ...
        traceEnabled.setText(getDescription(EsbViewsRepository.HTTPEndpoint.Basic.traceEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.HTTPEndpoint.Basic.traceEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createURITemplateText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.HTTPEndpoint.Basic.uRITemplate, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createHttpMethodEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.HTTPEndpoint.Basic.httpMethod, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.HTTPEndpoint.EndpointDescription.description, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesAdvancedTableComposition(Composite parent) {
        ...
        this.properties.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.HTTPEndpoint.EndpointProperties.properties, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createRetryCountText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.HTTPEndpoint.EndpointTimeoutState.retryCount, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRetryDelayText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.HTTPEndpoint.EndpointTimeoutState.retryDelay, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createTimeOutDurationText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.HTTPEndpoint.Timeout.timeOutDuration, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTimeOutActionEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.HTTPEndpoint.Timeout.timeOutAction, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFailoverNonRetryErrorCodesText(Composite parent) {
        createDescription(parent, EsbViewsRepository.HTTPEndpoint.FailoverErrorCodes.failoverNonRetryErrorCodes,
