 ...
 * 
 */
public class RuleFactsConfigurationPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, RuleFactsConfigurationPropertiesEditionPart {
    ...
    protected Composite createFactsAdvancedTableComposition(Composite parent) {
                ...
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(RuleFactsConfigurationPropertiesEditionPartImpl.this,
        ...
        this.facts.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleFactsConfiguration.Properties.facts, EsbViewsRepository.SWT_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleFactsConfigurationPropertiesEditionPartImpl.this,
