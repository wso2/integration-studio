...
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigureIfElseOperatorDialog;

public class IfElseConfigureAction extends AbstractActionHandler {
	 ...
	 */
	public IfElseConfigureAction(IWorkbenchPart part) {
		super(part);
		setId(Messages.IfElseConfigureAction_ActionID);
		setText(Messages.IfElseConfigureAction_ActionText);
		setToolTipText(Messages.IfElseConfigureAction_ToolTip);
	...
	protected void doRun(IProgressMonitor progressMonitor) {
		...
		Dialog configureConstantDialog = new ConfigureIfElseOperatorDialog(Display.getDefault().getActiveShell(),
				(IfElse) selectedObj, getEditingDomain(),selectedEP);
