 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getOutputConnector <em>Output
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getInputConnector <em>Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getFaultInputConnector <em>Fault Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getOutSequenceOutputConnector <em>Out
 * Sequence Output Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getInSequenceInputConnectors <em>In
 * Sequence Input Connectors</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getName <em>Name</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getPinnedServers <em>Pinned
 * Servers</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getServiceGroup <em>Service
 * Group</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#isTraceEnabled <em>Trace Enabled</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#isStatisticsEnabled <em>Statistics
 * Enabled</em>}</li>
 ...
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#isReliableMessagingEnabled <em>Reliable
 * Messaging Enabled</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#isSecurityEnabled <em>Security
 * Enabled</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getServiceParameters <em>Service
 * Parameters</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getServicePolicies <em>Service
 * Policies</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getContainer <em>Container</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getInSequenceType <em>In Sequence
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getInSequenceKey <em>In Sequence
 * Key</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getInSequenceName <em>In Sequence
 * Name</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getInSequenceOnError <em>In Sequence On
 * Error</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getOutSequenceType <em>Out Sequence
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getOutSequenceKey <em>Out Sequence
 * Key</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getOutSequenceName <em>Out Sequence
 * Name</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getOutSequenceOnError <em>Out Sequence On
 * Error</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getFaultSequenceType <em>Fault Sequence
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getFaultSequenceKey <em>Fault Sequence
 * Key</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getFaultSequenceName <em>Fault Sequence
 * Name</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getFaultSequenceOnError <em>Fault Sequence
 * On Error</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getEndpointType <em>Endpoint
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getEndpointKey <em>Endpoint Key</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getEndpointName <em>Endpoint
 * Name</em>}</li>
 ...
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#isPreservePolicy <em>Preserve
 * Policy</em>}</li>
 ...
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getWsdlEndpoint <em>Wsdl
 * Endpoint</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceImpl#getWsdlResources <em>Wsdl
 * Resources</em>}</li>
...
public class ProxyServiceImpl extends EsbElementImpl implements ProxyService {
    ...
    /**
     * The cached value of the '{@link #getFaultSequenceOnError() <em>Fault Sequence On Error</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public NotificationChain basicSetOutputConnector(ProxyOutputConnector newOutputConnector, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__OUTPUT_CONNECTOR, oldOutputConnector, newOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newOutputConnector != outputConnector) {
            ...
            if (outputConnector != null)
                msgs = ((InternalEObject) outputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__OUTPUT_CONNECTOR,
    ...
    public NotificationChain basicSetInputConnector(ProxyInputConnector newInputConnector, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__INPUT_CONNECTOR, oldInputConnector, newInputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInputConnector != inputConnector) {
            ...
            if (inputConnector != null)
                msgs = ((InternalEObject) inputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__INPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__INPUT_CONNECTOR,
    ...
    public NotificationChain basicSetFaultInputConnector(ProxyFaultInputConnector newFaultInputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__FAULT_INPUT_CONNECTOR, oldFaultInputConnector, newFaultInputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newFaultInputConnector != faultInputConnector) {
            ...
            if (faultInputConnector != null)
                msgs = ((InternalEObject) faultInputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__FAULT_INPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__FAULT_INPUT_CONNECTOR,
    ...
    public NotificationChain basicSetOutSequenceOutputConnector(
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__OUT_SEQUENCE_OUTPUT_CONNECTOR, oldOutSequenceOutputConnector,
        ...
        if (newOutSequenceOutputConnector != outSequenceOutputConnector) {
            ...
            if (outSequenceOutputConnector != null)
                msgs = ((InternalEObject) outSequenceOutputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__OUT_SEQUENCE_OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__OUT_SEQUENCE_OUTPUT_CONNECTOR, newOutSequenceOutputConnector,
                    newOutSequenceOutputConnector));
    }
    ...
    public EList<ProxyInSequenceInputConnector> getInSequenceInputConnectors() {
        if (inSequenceInputConnectors == null) {
            inSequenceInputConnectors = new EObjectContainmentEList<ProxyInSequenceInputConnector>(
                    ProxyInSequenceInputConnector.class, this, EsbPackage.PROXY_SERVICE__IN_SEQUENCE_INPUT_CONNECTORS);
        }
    ...
    public void setPinnedServers(String newPinnedServers) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__PINNED_SERVERS,
                    oldPinnedServers, pinnedServers));
    }
    ...
    public void setServiceGroup(String newServiceGroup) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__SERVICE_GROUP,
                    oldServiceGroup, serviceGroup));
    }
    ...
    public void setStatisticsEnabled(boolean newStatisticsEnabled) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__STATISTICS_ENABLED,
    ...
    public void setStartOnLoad(boolean newStartOnLoad) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__START_ON_LOAD,
                    oldStartOnLoad, startOnLoad));
    }
    ...
    public void setTransports(String newTransports) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__TRANSPORTS, oldTransports,
                    transports));
    }
    ...
    public void setReliableMessagingEnabled(boolean newReliableMessagingEnabled) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__RELIABLE_MESSAGING_ENABLED,
                    oldReliableMessagingEnabled, reliableMessagingEnabled));
    }
    ...
    public void setSecurityEnabled(boolean newSecurityEnabled) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__SECURITY_ENABLED,
    ...
    public EList<ProxyServiceParameter> getServiceParameters() {
        if (serviceParameters == null) {
            serviceParameters = new EObjectContainmentEList<ProxyServiceParameter>(ProxyServiceParameter.class, this,
                    EsbPackage.PROXY_SERVICE__SERVICE_PARAMETERS);
        }
    ...
    public EList<ProxyServicePolicy> getServicePolicies() {
        if (servicePolicies == null) {
            servicePolicies = new EObjectContainmentEList<ProxyServicePolicy>(ProxyServicePolicy.class, this,
                    EsbPackage.PROXY_SERVICE__SERVICE_POLICIES);
        }
    ...
    public NotificationChain basicSetContainer(ProxyServiceContainer newContainer, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__CONTAINER, oldContainer, newContainer);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newContainer != container) {
            ...
            if (container != null)
                msgs = ((InternalEObject) container).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__CONTAINER, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__CONTAINER, newContainer,
                    newContainer));
    }
    ...
    public void setInSequenceType(SequenceType newInSequenceType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__IN_SEQUENCE_TYPE,
    ...
    public NotificationChain basicSetInSequenceKey(RegistryKeyProperty newInSequenceKey, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__IN_SEQUENCE_KEY, oldInSequenceKey, newInSequenceKey);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInSequenceKey != inSequenceKey) {
            ...
            if (inSequenceKey != null)
                msgs = ((InternalEObject) inSequenceKey).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__IN_SEQUENCE_KEY, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__IN_SEQUENCE_KEY,
    ...
    public void setInSequenceName(String newInSequenceName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__IN_SEQUENCE_NAME,
    ...
    public NotificationChain basicSetInSequenceOnError(RegistryKeyProperty newInSequenceOnError,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__IN_SEQUENCE_ON_ERROR, oldInSequenceOnError, newInSequenceOnError);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setInSequenceOnError(RegistryKeyProperty newInSequenceOnError) {
        if (newInSequenceOnError != inSequenceOnError) {
            ...
            if (inSequenceOnError != null)
                msgs = ((InternalEObject) inSequenceOnError).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__IN_SEQUENCE_ON_ERROR, null, msgs);
            if (newInSequenceOnError != null)
                msgs = ((InternalEObject) newInSequenceOnError).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__IN_SEQUENCE_ON_ERROR, null, msgs);
            msgs = basicSetInSequenceOnError(newInSequenceOnError, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__IN_SEQUENCE_ON_ERROR,
                    newInSequenceOnError, newInSequenceOnError));
    }
    ...
    public void setOutSequenceType(SequenceType newOutSequenceType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__OUT_SEQUENCE_TYPE,
    ...
    public NotificationChain basicSetOutSequenceKey(RegistryKeyProperty newOutSequenceKey, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__OUT_SEQUENCE_KEY, oldOutSequenceKey, newOutSequenceKey);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOutSequenceKey != outSequenceKey) {
            ...
            if (outSequenceKey != null)
                msgs = ((InternalEObject) outSequenceKey).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__OUT_SEQUENCE_KEY, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__OUT_SEQUENCE_KEY,
    ...
    public void setOutSequenceName(String newOutSequenceName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__OUT_SEQUENCE_NAME,
    ...
    public NotificationChain basicSetOutSequenceOnError(RegistryKeyProperty newOutSequenceOnError,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__OUT_SEQUENCE_ON_ERROR, oldOutSequenceOnError, newOutSequenceOnError);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setOutSequenceOnError(RegistryKeyProperty newOutSequenceOnError) {
        if (newOutSequenceOnError != outSequenceOnError) {
            ...
            if (outSequenceOnError != null)
                msgs = ((InternalEObject) outSequenceOnError).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__OUT_SEQUENCE_ON_ERROR, null, msgs);
            if (newOutSequenceOnError != null)
                msgs = ((InternalEObject) newOutSequenceOnError).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__OUT_SEQUENCE_ON_ERROR, null, msgs);
            msgs = basicSetOutSequenceOnError(newOutSequenceOnError, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__OUT_SEQUENCE_ON_ERROR,
                    newOutSequenceOnError, newOutSequenceOnError));
    }
    ...
    public void setFaultSequenceType(SequenceType newFaultSequenceType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__FAULT_SEQUENCE_TYPE,
    ...
    public NotificationChain basicSetFaultSequenceKey(RegistryKeyProperty newFaultSequenceKey, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__FAULT_SEQUENCE_KEY, oldFaultSequenceKey, newFaultSequenceKey);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newFaultSequenceKey != faultSequenceKey) {
            ...
            if (faultSequenceKey != null)
                msgs = ((InternalEObject) faultSequenceKey).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__FAULT_SEQUENCE_KEY, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__FAULT_SEQUENCE_KEY,
    ...
    public void setFaultSequenceName(String newFaultSequenceName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__FAULT_SEQUENCE_NAME,
    ...
    public NotificationChain basicSetFaultSequenceOnError(RegistryKeyProperty newFaultSequenceOnError,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__FAULT_SEQUENCE_ON_ERROR, oldFaultSequenceOnError,
                    newFaultSequenceOnError);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setFaultSequenceOnError(RegistryKeyProperty newFaultSequenceOnError) {
        if (newFaultSequenceOnError != faultSequenceOnError) {
            ...
            if (faultSequenceOnError != null)
                msgs = ((InternalEObject) faultSequenceOnError).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__FAULT_SEQUENCE_ON_ERROR, null, msgs);
            if (newFaultSequenceOnError != null)
                msgs = ((InternalEObject) newFaultSequenceOnError).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__FAULT_SEQUENCE_ON_ERROR, null, msgs);
            msgs = basicSetFaultSequenceOnError(newFaultSequenceOnError, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__FAULT_SEQUENCE_ON_ERROR,
                    newFaultSequenceOnError, newFaultSequenceOnError));
    }
    ...
    public void setEndpointType(SequenceType newEndpointType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__ENDPOINT_TYPE,
                    oldEndpointType, endpointType));
    }
    ...
    public NotificationChain basicSetEndpointKey(RegistryKeyProperty newEndpointKey, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__ENDPOINT_KEY, oldEndpointKey, newEndpointKey);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setEndpointKey(RegistryKeyProperty newEndpointKey) {
        if (newEndpointKey != endpointKey) {
            NotificationChain msgs = null;
            if (endpointKey != null)
                msgs = ((InternalEObject) endpointKey).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__ENDPOINT_KEY, null, msgs);
            if (newEndpointKey != null)
                msgs = ((InternalEObject) newEndpointKey).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__ENDPOINT_KEY, null, msgs);
            msgs = basicSetEndpointKey(newEndpointKey, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__ENDPOINT_KEY,
                    newEndpointKey, newEndpointKey));
    }
    ...
    public void setEndpointName(String newEndpointName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__ENDPOINT_NAME,
    ...
    public void setMainSequence(boolean newMainSequence) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__MAIN_SEQUENCE,
                    oldMainSequence, mainSequence));
    }
    ...
    public void setWsdlType(ProxyWsdlType newWsdlType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__WSDL_TYPE, oldWsdlType,
                    wsdlType));
    }
    ...
    public void setPreservePolicy(boolean newPreservePolicy) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__PRESERVE_POLICY,
                    oldPreservePolicy, preservePolicy));
    }
    ...
    public void setWsdlXML(String newWsdlXML) {
        ...
        wsdlXML = newWsdlXML;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__WSDL_XML, oldWsdlXML,
                    wsdlXML));
    }
    ...
    public void setWsdlURL(String newWsdlURL) {
        ...
        wsdlURL = newWsdlURL;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__WSDL_URL, oldWsdlURL,
                    wsdlURL));
    }
    ...
    public NotificationChain basicSetWsdlKey(RegistryKeyProperty newWsdlKey, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__WSDL_KEY, oldWsdlKey, newWsdlKey);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setWsdlKey(RegistryKeyProperty newWsdlKey) {
        if (newWsdlKey != wsdlKey) {
            NotificationChain msgs = null;
            if (wsdlKey != null)
                msgs = ((InternalEObject) wsdlKey).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__WSDL_KEY, null, msgs);
            if (newWsdlKey != null)
                msgs = ((InternalEObject) newWsdlKey).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__WSDL_KEY, null, msgs);
            msgs = basicSetWsdlKey(newWsdlKey, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__WSDL_KEY, newWsdlKey,
                    newWsdlKey));
    }
    ...
    public NotificationChain basicSetWsdlEndpoint(RegistryKeyProperty newWsdlEndpoint, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__WSDL_ENDPOINT, oldWsdlEndpoint, newWsdlEndpoint);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setWsdlEndpoint(RegistryKeyProperty newWsdlEndpoint) {
        if (newWsdlEndpoint != wsdlEndpoint) {
            ...
            if (wsdlEndpoint != null)
                msgs = ((InternalEObject) wsdlEndpoint).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__WSDL_ENDPOINT, null, msgs);
            if (newWsdlEndpoint != null)
                msgs = ((InternalEObject) newWsdlEndpoint).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__WSDL_ENDPOINT, null, msgs);
            msgs = basicSetWsdlEndpoint(newWsdlEndpoint, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__WSDL_ENDPOINT,
                    newWsdlEndpoint, newWsdlEndpoint));
    }
    ...
    public EList<ProxyWSDLResource> getWsdlResources() {
        if (wsdlResources == null) {
            wsdlResources = new EObjectContainmentEList<ProxyWSDLResource>(ProxyWSDLResource.class, this,
                    EsbPackage.PROXY_SERVICE__WSDL_RESOURCES);
        }
    ...
    public NotificationChain basicSetOnError(RegistryKeyProperty newOnError, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE__ON_ERROR, oldOnError, newOnError);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOnError != onError) {
            ...
            if (onError != null)
                msgs = ((InternalEObject) onError).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROXY_SERVICE__ON_ERROR, null, msgs);
            if (newOnError != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE__ON_ERROR, newOnError,
                    newOnError));
    }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case EsbPackage.PROXY_SERVICE__PINNED_SERVERS:
            return PINNED_SERVERS_EDEFAULT == null ? pinnedServers != null
                    : !PINNED_SERVERS_EDEFAULT.equals(pinnedServers);
        case EsbPackage.PROXY_SERVICE__SERVICE_GROUP:
