...
<%
    ...
    try {
        ...
        DataHandler image = (DataHandler)session.getAttribute("productImage");
        ...
        while (iter.hasNext()) {
            ...
            if (item.isFormField()) {
            	...
            	if(fieldName.equals("imageFile") && item.getSize() > 0) {
        ...
        boolean success = client.updateProduct(productCode, productName, categoryName, productVendor,
