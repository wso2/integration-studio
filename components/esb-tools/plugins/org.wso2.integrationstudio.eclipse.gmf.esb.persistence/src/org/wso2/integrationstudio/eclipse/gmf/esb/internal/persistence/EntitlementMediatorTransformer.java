...
public class EntitlementMediatorTransformer extends AbstractEsbNodeTransformer {
    ...
    public void transform(TransformationInfo information, EsbNode subject) throws TransformerException {
         ...
         */
        doTransform(information, ((EntitlementMediator) subject).getOutputConnector());
    ...
    public void transformWithinSequence(TransformationInfo information, EsbNode subject, SequenceMediator sequence)
        ...
        doTransformWithinSequence(information, ((EntitlementMediator) subject).getOutputConnector().getOutgoingLink(),
                sequence);
    }
