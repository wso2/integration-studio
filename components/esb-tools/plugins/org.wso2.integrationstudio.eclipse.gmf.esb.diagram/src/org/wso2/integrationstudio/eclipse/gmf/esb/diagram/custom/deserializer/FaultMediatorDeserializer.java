...
public class FaultMediatorDeserializer extends AbstractEsbNodeDeserializer<AbstractMediator, FaultMediator> {
    ...
    public FaultMediator createNode(IGraphicalEditPart part, AbstractMediator mediator) {
        ...
        Assert.isTrue(mediator instanceof org.apache.synapse.mediators.transform.FaultMediator,
        ...
        FaultMediator visualFaultMediator = (FaultMediator) DeserializerUtils.createNode(part,
        ...
        case SOAP11:
            ...
            if (faultMediator.getFaultReasonValue() != null) {
                ...
                executeSetValueCommand(FAULT_MEDIATOR__FAULT_STRING_EXPRESSION,
                        createNamespacedProperty(faultMediator.getFaultReasonExpr()));
            ...
            if (faultMediator.getFaultCodeValue() != null) {
                ...
                executeSetValueCommand(FAULT_MEDIATOR__FAULT_CODE_EXPRESSION,
                        createNamespacedProperty(faultMediator.getFaultCodeExpr()));
        ...
        case SOAP12:
            ...
            if (faultMediator.getFaultReasonValue() != null) {
                ...
                executeSetValueCommand(FAULT_MEDIATOR__FAULT_REASON_EXPRESSION,
                        createNamespacedProperty(faultMediator.getFaultReasonExpr()));
        ...
        if (faultMediator.getFaultDetail() != null) {
            ...
            executeSetValueCommand(FAULT_MEDIATOR__FAULT_DETAIL_EXPRESSION,
                    createNamespacedProperty(faultMediator.getFaultDetailExpr()));
