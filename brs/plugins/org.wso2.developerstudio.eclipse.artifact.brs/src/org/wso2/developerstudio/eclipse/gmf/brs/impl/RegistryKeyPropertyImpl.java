 ...
 * <ul>
 *   <li>{@link org.wso2.developerstudio.eclipse.gmf.brs.impl.RegistryKeyPropertyImpl#getPrettyName <em>Pretty Name</em>}</li>
 *   <li>{@link org.wso2.developerstudio.eclipse.gmf.brs.impl.RegistryKeyPropertyImpl#getKeyName <em>Key Name</em>}</li>
 *   <li>{@link org.wso2.developerstudio.eclipse.gmf.brs.impl.RegistryKeyPropertyImpl#getKeyValue <em>Key Value</em>}</li>
 *   <li>{@link org.wso2.developerstudio.eclipse.gmf.brs.impl.RegistryKeyPropertyImpl#getFilters <em>Filters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RegistryKeyPropertyImpl extends EObjectImpl implements RegistryKeyProperty {
	...
	protected EClass eStaticClass() {
		return BrsPackage.Literals.REGISTRY_KEY_PROPERTY;
	}
	...
	public void setPrettyName(String newPrettyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BrsPackage.REGISTRY_KEY_PROPERTY__PRETTY_NAME, oldPrettyName, prettyName));
	}
	...
	public void setKeyName(String newKeyName) {
		...
		keyName = newKeyName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BrsPackage.REGISTRY_KEY_PROPERTY__KEY_NAME, oldKeyName, keyName));
	}
	...
	public void setKeyValue(String newKeyValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BrsPackage.REGISTRY_KEY_PROPERTY__KEY_VALUE, oldKeyValue, keyValue));
	}
	...
	public void setFilters(Map<?, ?> newFilters) {
		...
		filters = newFilters;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BrsPackage.REGISTRY_KEY_PROPERTY__FILTERS, oldFilters, filters));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BrsPackage.REGISTRY_KEY_PROPERTY__PRETTY_NAME:
				return getPrettyName();
			case BrsPackage.REGISTRY_KEY_PROPERTY__KEY_NAME:
				return getKeyName();
			case BrsPackage.REGISTRY_KEY_PROPERTY__KEY_VALUE:
				return getKeyValue();
			case BrsPackage.REGISTRY_KEY_PROPERTY__FILTERS:
				return getFilters();
		}
