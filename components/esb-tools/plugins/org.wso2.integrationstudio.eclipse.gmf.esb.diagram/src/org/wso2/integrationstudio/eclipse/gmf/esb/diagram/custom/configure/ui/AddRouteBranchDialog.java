...
public class AddRouteBranchDialog extends Dialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        count = new Text(container, SWT.NONE);
        {
            ...
            int i = routerMediator.getRouterContainer().getRouterTargetContainer().size();
    ...
    protected void okPressed() {
        int number = Integer.parseInt(count.getText())
                - routerMediator.getRouterContainer().getRouterTargetContainer().size();
        ...
        if (number > 0) {
            ...
            for (int i = 0; i < number; ++i) {
                ...
                AddCommand addTargetOutputConnectorCommand = new AddCommand(editingDomain, routerMediator,
            ...
            for (int i = 0; i < Math.abs(number); ++i) {
                RouterTargetContainer lastTargetContainer = routerMediator.getRouterContainer()
                        .getRouterTargetContainer()
                ...
                RouterMediatorTargetOutputConnector lastTargetOutputConnector = routerMediator
                        .getTargetOutputConnector().get(routerMediator.getTargetOutputConnector().size() - 1);
