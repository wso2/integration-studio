 ...
 * 
 */
public class SequencesPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, SequencesPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SequencesPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                SequencesPropertiesEditionPartImpl.this,
                                EsbViewsRepository.Sequences.Properties.description, PropertiesEditionEvent.COMMIT,
                                PropertiesEditionEvent.SET, null, description.getText()));
                }
            }
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.Sequences.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.Sequences.Properties.commentsList,
    ...
    protected Composite createNameText(Composite parent) {
        createDescription(parent, EsbViewsRepository.Sequences.Properties.name,
        ...
        name.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencesPropertiesEditionPartImpl.this, EsbViewsRepository.Sequences.Properties.name,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Sequences.Properties.name, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRecieveSequenceCheckbox(Composite parent) {
        ...
        recieveSequence.setText(getDescription(EsbViewsRepository.Sequences.Properties.recieveSequence,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.Sequences.Properties.recieveSequence, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAssociatedProxyMultiValuedEditor(Composite parent) {
        ...
        editAssociatedProxy.setText(getDescription(EsbViewsRepository.Sequences.Properties.associatedProxy,
    ...
    protected Composite createTemplateParametersAdvancedTableComposition(Composite parent) {
                ...
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(SequencesPropertiesEditionPartImpl.this,
        ...
        this.templateParameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.Sequences.Properties.templateParameters, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createTraceEnabledCheckbox(Composite parent) {
        ...
        traceEnabled.setText(getDescription(EsbViewsRepository.Sequences.Properties.traceEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.Sequences.Properties.traceEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStatisticsEnabledCheckbox(Composite parent) {
        ...
        statisticsEnabled.setText(getDescription(EsbViewsRepository.Sequences.Properties.statisticsEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.Sequences.Properties.statisticsEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
