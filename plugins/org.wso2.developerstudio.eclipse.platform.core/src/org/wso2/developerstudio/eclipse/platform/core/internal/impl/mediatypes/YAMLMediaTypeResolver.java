/*
 * Copyright (c) 2010-2020, WSO2 Inc. (http://www.wso2.org) All Rights Reserved.
 * 
...
public class YAMLMediaTypeResolver extends AbstractFileNameExtensionMediaTypeResolver {

	public boolean isMediaType(String fileName) {
		return hasExtension(fileName, "yaml");
	}
