 ...
 * 
 */
public class CloneMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, CloneMediatorPropertiesEditionPart {
	 ...
	 */
	public CloneMediatorPropertiesEditionPartForm() { super(); }
		...
		description.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
				}
			}
		});
		EditingUtils.setID(description, EsbViewsRepository.CloneMediator.Properties.description);
		EditingUtils.setEEFtype(description, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.CloneMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editCommentsList = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.CloneMediator.Properties.commentsList, EsbMessages.CloneMediatorPropertiesEditionPart_CommentsListLabel), SWT.NONE);
		...
		editCommentsList.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(commentsListList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
		reverse = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.CloneMediator.Properties.reverse, EsbMessages.CloneMediatorPropertiesEditionPart_ReverseLabel), SWT.CHECK);
		reverse.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.reverse, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(reverse.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.CloneMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCloneIDText(FormToolkit widgetFactory, Composite parent) {
		...
		cloneID.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CloneMediatorPropertiesEditionPartForm.this,
							EsbViewsRepository.CloneMediator.Properties.cloneID,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, cloneID.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(
									CloneMediatorPropertiesEditionPartForm.this,
									EsbViewsRepository.CloneMediator.Properties.cloneID,
									PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST,
									null, cloneID.getText()));
				}
			}
		...
		cloneID.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.cloneID, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, cloneID.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.CloneMediator.Properties.cloneID, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createSequentialMediationCheckbox(FormToolkit widgetFactory, Composite parent) {
		sequentialMediation = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.CloneMediator.Properties.sequentialMediation, EsbMessages.CloneMediatorPropertiesEditionPart_SequentialMediationLabel), SWT.CHECK);
		sequentialMediation.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.sequentialMediation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(sequentialMediation.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.CloneMediator.Properties.sequentialMediation, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createContinueParentCheckbox(FormToolkit widgetFactory, Composite parent) {
		continueParent = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.CloneMediator.Properties.continueParent, EsbMessages.CloneMediatorPropertiesEditionPart_ContinueParentLabel), SWT.CHECK);
		continueParent.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.continueParent, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(continueParent.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.CloneMediator.Properties.continueParent, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTargetsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.targets = new ReferencesTable(getDescription(EsbViewsRepository.CloneMediator.Properties.targets, EsbMessages.CloneMediatorPropertiesEditionPart_TargetsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.targets, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				targets.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.targets, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				targets.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.targets, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				targets.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.targets, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				targets.refresh();
			}
		...
		this.targets.setHelpText(propertiesEditionComponent.getHelpContent(EsbViewsRepository.CloneMediator.Properties.targets, EsbViewsRepository.FORM_KIND));
		this.targets.createControls(parent, widgetFactory);
		this.targets.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.targets, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createTargetsOutputConnectorTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.targetsOutputConnector = new ReferencesTable(getDescription(EsbViewsRepository.CloneMediator.Properties.targetsOutputConnector, EsbMessages.CloneMediatorPropertiesEditionPart_TargetsOutputConnectorLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.targetsOutputConnector, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				targetsOutputConnector.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.targetsOutputConnector, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				targetsOutputConnector.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.targetsOutputConnector, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				targetsOutputConnector.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.targetsOutputConnector, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				targetsOutputConnector.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.targetsOutputConnector.setHelpText(propertiesEditionComponent.getHelpContent(EsbViewsRepository.CloneMediator.Properties.targetsOutputConnector, EsbViewsRepository.FORM_KIND));
		...
		this.targetsOutputConnector.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CloneMediator.Properties.targetsOutputConnector, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
