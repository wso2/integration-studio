 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SwitchMediatorContainerImpl#getSwitchCaseParentContainer
 * <em>Switch Case Parent Container</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SwitchMediatorContainerImpl#getSwitchDefaultParentContainer
 * <em>Switch Default Parent Container</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SwitchMediatorContainerImpl extends EsbNodeImpl implements SwitchMediatorContainer {
    /**
     * The cached value of the '{@link #getSwitchCaseParentContainer() <em>Switch Case Parent Container</em>}'
    ...
    /**
     * The cached value of the '{@link #getSwitchDefaultParentContainer() <em>Switch Default Parent Container</em>}'
     * containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public NotificationChain basicSetSwitchCaseParentContainer(SwitchCaseParentContainer newSwitchCaseParentContainer,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SWITCH_MEDIATOR_CONTAINER__SWITCH_CASE_PARENT_CONTAINER, oldSwitchCaseParentContainer,
                    newSwitchCaseParentContainer);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setSwitchCaseParentContainer(SwitchCaseParentContainer newSwitchCaseParentContainer) {
        if (newSwitchCaseParentContainer != switchCaseParentContainer) {
            ...
            if (switchCaseParentContainer != null)
                msgs = ((InternalEObject) switchCaseParentContainer).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SWITCH_MEDIATOR_CONTAINER__SWITCH_CASE_PARENT_CONTAINER,
                        null, msgs);
            if (newSwitchCaseParentContainer != null)
                msgs = ((InternalEObject) newSwitchCaseParentContainer).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SWITCH_MEDIATOR_CONTAINER__SWITCH_CASE_PARENT_CONTAINER,
                        null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SWITCH_MEDIATOR_CONTAINER__SWITCH_CASE_PARENT_CONTAINER, newSwitchCaseParentContainer,
                    newSwitchCaseParentContainer));
    }
    ...
    public NotificationChain basicSetSwitchDefaultParentContainer(
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SWITCH_MEDIATOR_CONTAINER__SWITCH_DEFAULT_PARENT_CONTAINER,
                    oldSwitchDefaultParentContainer, newSwitchDefaultParentContainer);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setSwitchDefaultParentContainer(SwitchDefaultParentContainer newSwitchDefaultParentContainer) {
        if (newSwitchDefaultParentContainer != switchDefaultParentContainer) {
            ...
            if (switchDefaultParentContainer != null)
                msgs = ((InternalEObject) switchDefaultParentContainer).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SWITCH_MEDIATOR_CONTAINER__SWITCH_DEFAULT_PARENT_CONTAINER,
                        null, msgs);
            if (newSwitchDefaultParentContainer != null)
                msgs = ((InternalEObject) newSwitchDefaultParentContainer).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SWITCH_MEDIATOR_CONTAINER__SWITCH_DEFAULT_PARENT_CONTAINER,
                        null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SWITCH_MEDIATOR_CONTAINER__SWITCH_DEFAULT_PARENT_CONTAINER,
                    newSwitchDefaultParentContainer, newSwitchDefaultParentContainer));
    }
