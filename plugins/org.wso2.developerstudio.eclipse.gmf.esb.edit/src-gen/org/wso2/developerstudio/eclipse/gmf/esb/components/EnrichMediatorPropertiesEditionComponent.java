...
public class EnrichMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public EnrichMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject enrichMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.EnrichMediator.Source.sourceType)) {
                basePart.initSourceType(
                        EEFUtils.choiceOfValues(enrichMediator, EsbPackage.eINSTANCE.getEnrichMediator_SourceType()),
                        enrichMediator.getSourceType());
            }
            if (isAccessible(EsbViewsRepository.EnrichMediator.Source.sourceProperty))
                basePart.setSourceProperty(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        enrichMediator.getSourceProperty()));

            if (isAccessible(EsbViewsRepository.EnrichMediator.Source.sourceXML))
                basePart.setSourceXML(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, enrichMediator.getSourceXML()));

            if (isAccessible(EsbViewsRepository.EnrichMediator.Target.targetAction)) {
                basePart.initTargetAction(
                        EEFUtils.choiceOfValues(enrichMediator, EsbPackage.eINSTANCE.getEnrichMediator_TargetAction()),
                        enrichMediator.getTargetAction());
            }
            if (isAccessible(EsbViewsRepository.EnrichMediator.Target.targetType)) {
                basePart.initTargetType(
                        EEFUtils.choiceOfValues(enrichMediator, EsbPackage.eINSTANCE.getEnrichMediator_TargetType()),
                        enrichMediator.getTargetType());
            }
            if (isAccessible(EsbViewsRepository.EnrichMediator.Target.targetProperty))
                basePart.setTargetProperty(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        enrichMediator.getTargetProperty()));

            if (isAccessible(EsbViewsRepository.EnrichMediator.Source.inlineType)) {
                basePart.initInlineType(
                        EEFUtils.choiceOfValues(enrichMediator, EsbPackage.eINSTANCE.getEnrichMediator_InlineType()),
                        enrichMediator.getInlineType());
            }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.EnrichMediator.Misc.description == event.getAffectedEditor()) {
            enrichMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.EnrichMediator.Source.sourceProperty == event.getAffectedEditor()) {
            enrichMediator.setSourceProperty((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.EnrichMediator.Source.sourceXML == event.getAffectedEditor()) {
            enrichMediator.setSourceXML((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.EnrichMediator.Target.targetProperty == event.getAffectedEditor()) {
            enrichMediator.setTargetProperty((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.EnrichMediator.Misc.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EnrichMediator.Misc.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EnrichMediator.Misc.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEnrichMediator_CloneSource().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EnrichMediator.Source.cloneSource))
                basePart.setCloneSource((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEnrichMediator_SourceType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.EnrichMediator.Source.sourceType))
                basePart.setSourceType((EnrichSourceType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEnrichMediator_SourceProperty().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EnrichMediator.Source.sourceProperty)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEnrichMediator_SourceXML().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EnrichMediator.Source.sourceXML)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEnrichMediator_TargetAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.EnrichMediator.Target.targetAction))
                basePart.setTargetAction((EnrichTargetAction) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEnrichMediator_TargetType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.EnrichMediator.Target.targetType))
                basePart.setTargetType((EnrichTargetType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEnrichMediator_TargetProperty().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EnrichMediator.Target.targetProperty)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEnrichMediator_InlineType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.EnrichMediator.Source.inlineType))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getEnrichMediator_CloneSource(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.EnrichMediator.Source.cloneSource == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEnrichMediator_CloneSource().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getEnrichMediator_CloneSource().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EnrichMediator.Source.sourceType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEnrichMediator_SourceType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getEnrichMediator_SourceType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EnrichMediator.Source.sourceProperty == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEnrichMediator_SourceProperty().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getEnrichMediator_SourceProperty().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EnrichMediator.Source.sourceXML == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEnrichMediator_SourceXML().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getEnrichMediator_SourceXML().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EnrichMediator.Target.targetAction == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEnrichMediator_TargetAction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getEnrichMediator_TargetAction().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EnrichMediator.Target.targetType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEnrichMediator_TargetType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getEnrichMediator_TargetType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EnrichMediator.Target.targetProperty == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEnrichMediator_TargetProperty().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getEnrichMediator_TargetProperty().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EnrichMediator.Source.inlineType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEnrichMediator_InlineType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getEnrichMediator_InlineType().getEAttributeType(), newValue);
                }
