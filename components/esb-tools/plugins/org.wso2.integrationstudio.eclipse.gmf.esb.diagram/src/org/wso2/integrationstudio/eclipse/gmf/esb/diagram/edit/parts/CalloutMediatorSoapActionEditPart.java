 ...
 * @generated
 */
public class CalloutMediatorSoapActionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
        ...
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.CalloutMediator_3520, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.CalloutMediatorSoapActionEditPart.VISUAL_ID));
        }
        return parser;
    }
