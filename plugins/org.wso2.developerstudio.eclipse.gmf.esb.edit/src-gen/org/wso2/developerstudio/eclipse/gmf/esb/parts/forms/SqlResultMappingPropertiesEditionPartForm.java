 ...
 * 
 */
public class SqlResultMappingPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, SqlResultMappingPropertiesEditionPart {
     ...
     */
    public SqlResultMappingPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = sqlResultMappingStep
                .addStep(EsbViewsRepository.SqlResultMapping.Properties.class);
    ...
    protected Composite createPropertyNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.SqlResultMapping.Properties.propertyName,
                EsbMessages.SqlResultMappingPropertiesEditionPart_PropertyNameLabel);
        ...
        propertyName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.SqlResultMapping.Properties.propertyName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, propertyName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SqlResultMappingPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SqlResultMappingPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SqlResultMapping.Properties.propertyName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createColumnIdText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.SqlResultMapping.Properties.columnId,
                EsbMessages.SqlResultMappingPropertiesEditionPart_ColumnIdLabel);
        ...
        columnId.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SqlResultMappingPropertiesEditionPartForm.this,
                            EsbViewsRepository.SqlResultMapping.Properties.columnId, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, columnId.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SqlResultMappingPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SqlResultMapping.Properties.columnId, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlResultMappingPropertiesEditionPart#setPropertyName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlResultMappingPropertiesEditionPart#setColumnId(String
     *      newValue)
     * 
     */
