 ...
 * 
 */
public class ValidateFeaturePropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ValidateFeaturePropertiesEditionPart {
     ...
     */
    public ValidateFeaturePropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = validateFeatureStep
                .addStep(EsbViewsRepository.ValidateFeature.Properties.class);
    ...
    protected Composite createFeatureNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ValidateFeature.Properties.featureName,
                EsbMessages.ValidateFeaturePropertiesEditionPart_FeatureNameLabel);
        ...
        featureName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.ValidateFeature.Properties.featureName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, featureName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ValidateFeaturePropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ValidateFeaturePropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateFeature.Properties.featureName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFeatureEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        featureEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ValidateFeature.Properties.featureEnabled,
                        EsbMessages.ValidateFeaturePropertiesEditionPart_FeatureEnabledLabel),
                SWT.CHECK);
        featureEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ValidateFeaturePropertiesEditionPartForm.this,
                            EsbViewsRepository.ValidateFeature.Properties.featureEnabled, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateFeature.Properties.featureEnabled, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateFeaturePropertiesEditionPart#getFeatureName()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateFeaturePropertiesEditionPart#setFeatureName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateFeaturePropertiesEditionPart#getFeatureEnabled()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateFeaturePropertiesEditionPart#setFeatureEnabled(Boolean
     *      newValue)
     * 
     */
    public void setFeatureEnabled(Boolean newValue) {
        ...
        boolean eefElementEditorReadOnlyState = isReadOnly(
                EsbViewsRepository.ValidateFeature.Properties.featureEnabled);
