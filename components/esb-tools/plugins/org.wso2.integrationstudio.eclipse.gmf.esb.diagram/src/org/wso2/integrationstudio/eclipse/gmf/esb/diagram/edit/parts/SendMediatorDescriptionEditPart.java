 ...
 * @generated
 */
public class SendMediatorDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
     ...
     * @generated
     */
    public SendMediatorDescriptionEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.SendMediator_3515, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.SendMediatorDescriptionEditPart.VISUAL_ID));
        }
        return parser;
    }
