 ...
 * 
 */
public class ConditionalRouterMediatorOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public ConditionalRouterMediatorOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject conditionalRouterMediatorOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ConditionalRouterMediatorOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(conditionalRouterMediatorOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ConditionalRouterMediatorOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
