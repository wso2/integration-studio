 ...
 * @generated
 */
public class NOTCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater
				.getNOT_2028SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater
				.getNOT_2028SemanticChildren((View) getHost().getModel());
