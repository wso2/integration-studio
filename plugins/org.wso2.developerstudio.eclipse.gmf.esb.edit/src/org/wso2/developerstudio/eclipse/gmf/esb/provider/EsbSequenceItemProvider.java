...
public class EsbSequenceItemProvider extends EsbNodeItemProvider {
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EsbSequence_name_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EsbSequence_name_feature",
                                "_UI_EsbSequence_type"),
                        EsbPackage.Literals.ESB_SEQUENCE__NAME, true, false, false,
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_EsbSequence_type")
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.ESB_SEQUENCE__INPUT,
                EsbFactory.eINSTANCE.createEsbSequenceInputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.ESB_SEQUENCE__OUTPUT,
                EsbFactory.eINSTANCE.createEsbSequenceOutputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.ESB_SEQUENCE__CHILD_MEDIATORS,
