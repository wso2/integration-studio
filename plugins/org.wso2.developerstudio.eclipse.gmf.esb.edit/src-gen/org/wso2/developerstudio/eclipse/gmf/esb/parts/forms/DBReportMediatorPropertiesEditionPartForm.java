...
public class DBReportMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, DBReportMediatorPropertiesEditionPart {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		propertiesStep.addStep(EsbViewsRepository.DBReportMediator.Properties.description);
		...
		propertiesStep.addStep(EsbViewsRepository.DBReportMediator.Properties.connectionType);
		propertiesStep.addStep(EsbViewsRepository.DBReportMediator.Properties.connectionDsType);
		propertiesStep.addStep(EsbViewsRepository.DBReportMediator.Properties.connectionDbType);
		propertiesStep.addStep(EsbViewsRepository.DBReportMediator.Properties.connectionDbDriver);
		propertiesStep.addStep(EsbViewsRepository.DBReportMediator.Properties.connectionDsInitialContext);
		propertiesStep.addStep(EsbViewsRepository.DBReportMediator.Properties.connectionDsName);
		propertiesStep.addStep(EsbViewsRepository.DBReportMediator.Properties.connectionURL);
		propertiesStep.addStep(EsbViewsRepository.DBReportMediator.Properties.connectionUsername);
		propertiesStep.addStep(EsbViewsRepository.DBReportMediator.Properties.connectionPassword);
		...
		propertiesStep.addStep(EsbViewsRepository.DBReportMediator.Properties.sqlStatements);
		propertiesStep.addStep(EsbViewsRepository.DBReportMediator.Properties.connectionUseTransaction);
		...
		composer = new PartComposer(dBReportMediatorStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == EsbViewsRepository.DBReportMediator.Properties.description) {
				...
				if (key == EsbViewsRepository.DBReportMediator.Properties.connectionType) {
					return createConnectionTypeEMFComboViewer(widgetFactory, parent);
				}
				if (key == EsbViewsRepository.DBReportMediator.Properties.connectionDsType) {
					return createConnectionDsTypeEMFComboViewer(widgetFactory, parent);
				}
				if (key == EsbViewsRepository.DBReportMediator.Properties.connectionDbType) {
					return createConnectionDbTypeEMFComboViewer(widgetFactory, parent);
				}
				if (key == EsbViewsRepository.DBReportMediator.Properties.connectionDbDriver) {
					return createConnectionDbDriverText(widgetFactory, parent);
				}
				if (key == EsbViewsRepository.DBReportMediator.Properties.connectionDsInitialContext) {
					return createConnectionDsInitialContextText(widgetFactory, parent);
				}
				if (key == EsbViewsRepository.DBReportMediator.Properties.connectionDsName) {
					return createConnectionDsNameText(widgetFactory, parent);
				}
				if (key == EsbViewsRepository.DBReportMediator.Properties.connectionURL) {
					return createConnectionURLText(widgetFactory, parent);
				}
				if (key == EsbViewsRepository.DBReportMediator.Properties.connectionUsername) {
					return createConnectionUsernameText(widgetFactory, parent);
				}
				if (key == EsbViewsRepository.DBReportMediator.Properties.connectionPassword) {
				...
				if (key == EsbViewsRepository.DBReportMediator.Properties.sqlStatements) {
					return createSqlStatementsTableComposition(widgetFactory, parent);
				}
				if (key == EsbViewsRepository.DBReportMediator.Properties.connectionUseTransaction) {
	...
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, EsbViewsRepository.DBReportMediator.Properties.description, EsbMessages.DBReportMediatorPropertiesEditionPart_DescriptionLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							EsbViewsRepository.DBReportMediator.Properties.description,
		...
		description.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
				}
			}
		});
		EditingUtils.setID(description, EsbViewsRepository.DBReportMediator.Properties.description);
		EditingUtils.setEEFtype(description, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createConnectionTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, EsbViewsRepository.DBReportMediator.Properties.connectionType, EsbMessages.DBReportMediatorPropertiesEditionPart_ConnectionTypeLabel);
		...
		connectionType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.connectionType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getConnectionType()));
			}

		});
		connectionType.setID(EsbViewsRepository.DBReportMediator.Properties.connectionType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.connectionType, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createConnectionDsTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, EsbViewsRepository.DBReportMediator.Properties.connectionDsType, EsbMessages.DBReportMediatorPropertiesEditionPart_ConnectionDsTypeLabel);
		...
		connectionDsType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.connectionDsType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getConnectionDsType()));
			}

		});
		connectionDsType.setID(EsbViewsRepository.DBReportMediator.Properties.connectionDsType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.connectionDsType, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createConnectionDbTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, EsbViewsRepository.DBReportMediator.Properties.connectionDbType, EsbMessages.DBReportMediatorPropertiesEditionPart_ConnectionDbTypeLabel);
		...
		connectionDbType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.connectionDbType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getConnectionDbType()));
			}

		});
		connectionDbType.setID(EsbViewsRepository.DBReportMediator.Properties.connectionDbType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.connectionDbType, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createConnectionDbDriverText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, EsbViewsRepository.DBReportMediator.Properties.connectionDbDriver, EsbMessages.DBReportMediatorPropertiesEditionPart_ConnectionDbDriverLabel);
		...
		connectionDbDriver.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DBReportMediatorPropertiesEditionPartForm.this,
							EsbViewsRepository.DBReportMediator.Properties.connectionDbDriver,
		...
		connectionDbDriver.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.connectionDbDriver, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, connectionDbDriver.getText()));
				}
			}
		});
		EditingUtils.setID(connectionDbDriver, EsbViewsRepository.DBReportMediator.Properties.connectionDbDriver);
		EditingUtils.setEEFtype(connectionDbDriver, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.connectionDbDriver, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createConnectionDsInitialContextText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, EsbViewsRepository.DBReportMediator.Properties.connectionDsInitialContext, EsbMessages.DBReportMediatorPropertiesEditionPart_ConnectionDsInitialContextLabel);
		...
		connectionDsInitialContext.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DBReportMediatorPropertiesEditionPartForm.this,
							EsbViewsRepository.DBReportMediator.Properties.connectionDsInitialContext,
		...
		connectionDsInitialContext.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.connectionDsInitialContext, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, connectionDsInitialContext.getText()));
				}
			}
		});
		EditingUtils.setID(connectionDsInitialContext, EsbViewsRepository.DBReportMediator.Properties.connectionDsInitialContext);
		EditingUtils.setEEFtype(connectionDsInitialContext, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.connectionDsInitialContext, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createConnectionDsNameText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, EsbViewsRepository.DBReportMediator.Properties.connectionDsName, EsbMessages.DBReportMediatorPropertiesEditionPart_ConnectionDsNameLabel);
		...
		connectionDsName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DBReportMediatorPropertiesEditionPartForm.this,
							EsbViewsRepository.DBReportMediator.Properties.connectionDsName,
		...
		connectionDsName.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.connectionDsName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, connectionDsName.getText()));
				}
			}
		});
		EditingUtils.setID(connectionDsName, EsbViewsRepository.DBReportMediator.Properties.connectionDsName);
		EditingUtils.setEEFtype(connectionDsName, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.connectionDsName, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createConnectionURLText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, EsbViewsRepository.DBReportMediator.Properties.connectionURL, EsbMessages.DBReportMediatorPropertiesEditionPart_ConnectionURLLabel);
		...
		connectionURL.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DBReportMediatorPropertiesEditionPartForm.this,
							EsbViewsRepository.DBReportMediator.Properties.connectionURL,
		...
		connectionURL.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.connectionURL, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, connectionURL.getText()));
				}
			}
		});
		EditingUtils.setID(connectionURL, EsbViewsRepository.DBReportMediator.Properties.connectionURL);
		EditingUtils.setEEFtype(connectionURL, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.connectionURL, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createConnectionUsernameText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, EsbViewsRepository.DBReportMediator.Properties.connectionUsername, EsbMessages.DBReportMediatorPropertiesEditionPart_ConnectionUsernameLabel);
		...
		connectionUsername.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DBReportMediatorPropertiesEditionPartForm.this,
							EsbViewsRepository.DBReportMediator.Properties.connectionUsername,
		...
		connectionUsername.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.connectionUsername, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, connectionUsername.getText()));
				}
			}
		});
		EditingUtils.setID(connectionUsername, EsbViewsRepository.DBReportMediator.Properties.connectionUsername);
		EditingUtils.setEEFtype(connectionUsername, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.connectionUsername, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createConnectionPasswordText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, EsbViewsRepository.DBReportMediator.Properties.connectionPassword, EsbMessages.DBReportMediatorPropertiesEditionPart_ConnectionPasswordLabel);
		...
		connectionPassword.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DBReportMediatorPropertiesEditionPartForm.this,
							EsbViewsRepository.DBReportMediator.Properties.connectionPassword,
		...
		connectionPassword.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.connectionPassword, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, connectionPassword.getText()));
				}
			}
		});
		EditingUtils.setID(connectionPassword, EsbViewsRepository.DBReportMediator.Properties.connectionPassword);
		EditingUtils.setEEFtype(connectionPassword, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.connectionPassword, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyAutocommitEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.propertyAutocommit, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyIsolationEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.propertyIsolation, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyMaxactiveText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.propertyMaxactive, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyMaxidleText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.propertyMaxidle, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyMaxopenstatementsText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.propertyMaxopenstatements, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyMaxwaitText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.propertyMaxwait, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyMinidleText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.propertyMinidle, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyPoolstatementsEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.propertyPoolstatements, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyTestonborrowEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.propertyTestonborrow, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyTestwhileidleEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.propertyTestwhileidle, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyValidationqueryText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.propertyValidationquery, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyInitialsizeText(FormToolkit widgetFactory, Composite parent) {
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.propertyInitialsize, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createSqlStatementsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.sqlStatements = new ReferencesTable(getDescription(EsbViewsRepository.DBReportMediator.Properties.sqlStatements, EsbMessages.DBReportMediatorPropertiesEditionPart_SqlStatementsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.sqlStatements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				sqlStatements.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.sqlStatements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				sqlStatements.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.sqlStatements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				sqlStatements.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.sqlStatements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				sqlStatements.refresh();
			}
		...
		this.sqlStatements.setHelpText(propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.sqlStatements, EsbViewsRepository.FORM_KIND));
		...
		this.sqlStatements.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.sqlStatements, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		sqlStatements.setID(EsbViewsRepository.DBReportMediator.Properties.sqlStatements);
	...
	protected Composite createConnectionUseTransactionCheckbox(FormToolkit widgetFactory, Composite parent) {
		connectionUseTransaction = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.DBReportMediator.Properties.connectionUseTransaction, EsbMessages.DBReportMediatorPropertiesEditionPart_ConnectionUseTransactionLabel), SWT.CHECK);
		connectionUseTransaction.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DBReportMediatorPropertiesEditionPartForm.this, EsbViewsRepository.DBReportMediator.Properties.connectionUseTransaction, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(connectionUseTransaction.getSelection())));
			}
		...
		EditingUtils.setID(connectionUseTransaction, EsbViewsRepository.DBReportMediator.Properties.connectionUseTransaction);
		EditingUtils.setEEFtype(connectionUseTransaction, "eef::Checkbox"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.DBReportMediator.Properties.connectionUseTransaction, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	public void setDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EsbViewsRepository.DBReportMediator.Properties.description);
	...
	public void initConnectionType(Object input, Enumerator current) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EsbViewsRepository.DBReportMediator.Properties.connectionType);
	...
	public void initConnectionDsType(Object input, Enumerator current) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EsbViewsRepository.DBReportMediator.Properties.connectionDsType);
	...
	public void initConnectionDbType(Object input, Enumerator current) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EsbViewsRepository.DBReportMediator.Properties.connectionDbType);
	...
	public void setConnectionDbDriver(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EsbViewsRepository.DBReportMediator.Properties.connectionDbDriver);
	...
	public void setConnectionDsInitialContext(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EsbViewsRepository.DBReportMediator.Properties.connectionDsInitialContext);
	...
	public void setConnectionDsName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EsbViewsRepository.DBReportMediator.Properties.connectionDsName);
	...
	public void setConnectionURL(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EsbViewsRepository.DBReportMediator.Properties.connectionURL);
	...
	public void setConnectionUsername(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EsbViewsRepository.DBReportMediator.Properties.connectionUsername);
	...
	public void setConnectionPassword(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EsbViewsRepository.DBReportMediator.Properties.connectionPassword);
	...
	public void initSqlStatements(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EsbViewsRepository.DBReportMediator.Properties.sqlStatements);
	...
	public void setConnectionUseTransaction(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EsbViewsRepository.DBReportMediator.Properties.connectionUseTransaction);
