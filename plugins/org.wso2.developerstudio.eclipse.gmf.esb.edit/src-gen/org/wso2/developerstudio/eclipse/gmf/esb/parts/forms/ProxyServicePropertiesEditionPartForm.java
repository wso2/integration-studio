 ...
 * 
 */
public class ProxyServicePropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ProxyServicePropertiesEditionPart {
     ...
     */
    public ProxyServicePropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep faultSequenceStep = proxyServiceStep
                .addStep(EsbViewsRepository.ProxyService.FaultSequence.class);
        ...
        proxyServiceStep.addStep(EsbViewsRepository.ProxyService.Parameters.class)
                .addStep(EsbViewsRepository.ProxyService.Parameters.serviceParameters);

        proxyServiceStep.addStep(EsbViewsRepository.ProxyService.ReliableMessaging.class)
    ...
    protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ProxyService.Basic.name,
                EsbMessages.ProxyServicePropertiesEditionPart_NameLabel);
        ...
        name.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this, EsbViewsRepository.ProxyService.Basic.name,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyService.Basic.name, PropertiesEditionEvent.FOCUS_CHANGED,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ProxyService.Basic.name, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPinnedServersText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ProxyService.Basic.pinnedServers,
                EsbMessages.ProxyServicePropertiesEditionPart_PinnedServersLabel);
        ...
        pinnedServers.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyService.Basic.pinnedServers, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, pinnedServers.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.Basic.pinnedServers, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, pinnedServers.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyService.Basic.pinnedServers, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createServiceGroupText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ProxyService.Basic.serviceGroup,
                EsbMessages.ProxyServicePropertiesEditionPart_ServiceGroupLabel);
        ...
        serviceGroup.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyService.Basic.serviceGroup, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, serviceGroup.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.Basic.serviceGroup, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, serviceGroup.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyService.Basic.serviceGroup, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTraceEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        traceEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ProxyService.Basic.traceEnabled,
                        EsbMessages.ProxyServicePropertiesEditionPart_TraceEnabledLabel),
                SWT.CHECK);
        traceEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyService.Basic.traceEnabled, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyService.Basic.traceEnabled, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStatisticsEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        statisticsEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ProxyService.Basic.statisticsEnabled,
                        EsbMessages.ProxyServicePropertiesEditionPart_StatisticsEnabledLabel),
                SWT.CHECK);
        statisticsEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.Basic.statisticsEnabled, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyService.Basic.statisticsEnabled, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStartOnLoadCheckbox(FormToolkit widgetFactory, Composite parent) {
        startOnLoad = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ProxyService.Basic.startOnLoad,
                        EsbMessages.ProxyServicePropertiesEditionPart_StartOnLoadLabel),
                SWT.CHECK);
        startOnLoad.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyService.Basic.startOnLoad, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, new Boolean(startOnLoad.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ProxyService.Basic.startOnLoad, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTransportsText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ProxyService.Basic.transports,
                EsbMessages.ProxyServicePropertiesEditionPart_TransportsLabel);
        ...
        transports.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyService.Basic.transports, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, transports.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.Basic.transports, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, transports.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ProxyService.Basic.transports, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEndpointGroup(FormToolkit widgetFactory, final Composite parent) {
        Section endpointSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createEndpointTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control endpointTypeLabel = createDescription(parent, EsbViewsRepository.ProxyService.Endpoint.endpointType,
                EsbMessages.ProxyServicePropertiesEditionPart_EndpointTypeLabel);
        ...
        endpointType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                ...
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.Endpoint.endpointType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getEndpointType()));
            }

        });
        endpointType.setID(EsbViewsRepository.ProxyService.Endpoint.endpointType);
        Control endpointTypeHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ProxyService.Endpoint.endpointType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createEndpointNameText(FormToolkit widgetFactory, Composite parent) {
        Control endpointNameLabel = createDescription(parent, EsbViewsRepository.ProxyService.Endpoint.endpointName,
                EsbMessages.ProxyServicePropertiesEditionPart_EndpointNameLabel);
        ...
        endpointName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.Endpoint.endpointName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, endpointName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.Endpoint.endpointName, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, endpointName.getText()));
                }
            }
        ...
        Control endpointNameHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ProxyService.Endpoint.endpointName, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createFaultSequenceGroup(FormToolkit widgetFactory, final Composite parent) {
        Section faultSequenceSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createFaultSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control faultSequenceTypeLabel = createDescription(parent,
                EsbViewsRepository.ProxyService.FaultSequence.faultSequenceType,
                EsbMessages.ProxyServicePropertiesEditionPart_FaultSequenceTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                ...
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.FaultSequence.faultSequenceType,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getFaultSequenceType()));
            }

        });
        faultSequenceType.setID(EsbViewsRepository.ProxyService.FaultSequence.faultSequenceType);
        Control faultSequenceTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.ProxyService.FaultSequence.faultSequenceType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createFaultSequenceTypeEMFComboViewer
        faultSequenceTypeElements = new Control[] { faultSequenceTypeLabel, faultSequenceType.getCombo(),
                faultSequenceTypeHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createFaultSequenceNameText(FormToolkit widgetFactory, Composite parent) {
        Control faultSequenceNameLabel = createDescription(parent,
                EsbViewsRepository.ProxyService.FaultSequence.faultSequenceName,
                EsbMessages.ProxyServicePropertiesEditionPart_FaultSequenceNameLabel);
        ...
        Control faultSequenceNameHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.ProxyService.FaultSequence.faultSequenceName, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createInSequenceGroup(FormToolkit widgetFactory, final Composite parent) {
        Section inSequenceSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createInSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control inSeqTypeLabel = createDescription(parent, EsbViewsRepository.ProxyService.InSequence.inSequenceType,
                EsbMessages.ProxyServicePropertiesEditionPart_InSequenceTypeLabel);
        ...
        inSequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                ...
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.InSequence.inSequenceType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getInSequenceType()));
            }

        });
        inSequenceType.setID(EsbViewsRepository.ProxyService.InSequence.inSequenceType);
        Control inSeqTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.ProxyService.InSequence.inSequenceType,
    ...
    protected Composite createInSequenceNameText(FormToolkit widgetFactory, Composite parent) {
        Control inSeqNameLabel = createDescription(parent, EsbViewsRepository.ProxyService.InSequence.inSequenceName,
                EsbMessages.ProxyServicePropertiesEditionPart_InSequenceNameLabel);
        ...
        inSequenceName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.InSequence.inSequenceName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, inSequenceName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyService.InSequence.inSequenceName,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    inSequenceName.getText()));
                }
            }
        ...
        Control inSeqNameHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.ProxyService.InSequence.inSequenceName,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createOutSequenceGroup(FormToolkit widgetFactory, final Composite parent) {
        Section outSequenceSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createOutSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control outSeqTypeLabel = createDescription(parent, EsbViewsRepository.ProxyService.OutSequence.outSequenceType,
                EsbMessages.ProxyServicePropertiesEditionPart_OutSequenceTypeLabel);
        ...
        outSequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                ...
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.OutSequence.outSequenceType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getOutSequenceType()));
            }

        });
        outSequenceType.setID(EsbViewsRepository.ProxyService.OutSequence.outSequenceType);
        Control outSeqTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.ProxyService.OutSequence.outSequenceType,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createOutSequenceNameText(FormToolkit widgetFactory, Composite parent) {
        Control outSeqNameLabel = createDescription(parent, EsbViewsRepository.ProxyService.OutSequence.outSequenceName,
                EsbMessages.ProxyServicePropertiesEditionPart_OutSequenceNameLabel);
        ...
        outSequenceName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.OutSequence.outSequenceName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, outSequenceName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyService.OutSequence.outSequenceName,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    outSequenceName.getText()));
                }
            }
        ...
        Control outSeqNameHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.ProxyService.OutSequence.outSequenceName,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createParametersGroup(FormToolkit widgetFactory, final Composite parent) {
        Section parametersSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createServiceParametersTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.serviceParameters = new ReferencesTable(
                getDescription(EsbViewsRepository.ProxyService.Parameters.serviceParameters,
                        EsbMessages.ProxyServicePropertiesEditionPart_ServiceParametersLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                        EsbViewsRepository.ProxyService.Parameters.serviceParameters,
        ...
        this.serviceParameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyService.Parameters.serviceParameters, EsbViewsRepository.FORM_KIND));
        ...
        this.serviceParameters.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.Parameters.serviceParameters, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createReliableMessagingGroup(FormToolkit widgetFactory, final Composite parent) {
        Section reliableMessagingSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createReliableMessagingEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        reliableMessagingEnabled = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.ProxyService.ReliableMessaging.reliableMessagingEnabled,
                                EsbMessages.ProxyServicePropertiesEditionPart_ReliableMessagingEnabledLabel),
                        SWT.CHECK);
        reliableMessagingEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyService.ReliableMessaging.reliableMessagingEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createSecurityGroup(FormToolkit widgetFactory, final Composite parent) {
        Section securitySection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createSecurityEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        securityEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ProxyService.Security.securityEnabled,
                        EsbMessages.ProxyServicePropertiesEditionPart_SecurityEnabledLabel),
                SWT.CHECK);
        securityEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.Security.securityEnabled, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyService.Security.securityEnabled, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createServicePoliciesTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.servicePolicies = new ReferencesTable(
                getDescription(EsbViewsRepository.ProxyService.Security.servicePolicies,
                        EsbMessages.ProxyServicePropertiesEditionPart_ServicePoliciesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                        EsbViewsRepository.ProxyService.Security.servicePolicies,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.servicePolicies.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyService.Security.servicePolicies, EsbViewsRepository.FORM_KIND));
        ...
        this.servicePolicies.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.Security.servicePolicies, PropertiesEditionEvent.CHANGE,
                            PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
    ...
    protected Composite createWsdlGroup(FormToolkit widgetFactory, final Composite parent) {
        Section wsdlSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createWsdlTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control wsdlTypeLabel = createDescription(parent, EsbViewsRepository.ProxyService.Wsdl.wsdlType,
                EsbMessages.ProxyServicePropertiesEditionPart_WsdlTypeLabel);
        ...
        wsdlType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                ...
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this, EsbViewsRepository.ProxyService.Wsdl.wsdlType,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getWsdlType()));
            }

        });
        wsdlType.setID(EsbViewsRepository.ProxyService.Wsdl.wsdlType);
        Control wsdlTypeHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ProxyService.Wsdl.wsdlType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createWsdlXMLText(FormToolkit widgetFactory, Composite parent) {
        Control wsdlXMLLabel = createDescription(parent, EsbViewsRepository.ProxyService.Wsdl.wsdlXML,
                EsbMessages.ProxyServicePropertiesEditionPart_WsdlXMLLabel);
        ...
        wsdlXML.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this, EsbViewsRepository.ProxyService.Wsdl.wsdlXML,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, wsdlXML.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyService.Wsdl.wsdlXML, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, wsdlXML.getText()));
                }
            }
        ...
        Control wsdlXMLHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ProxyService.Wsdl.wsdlXML, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createWsdlURLText(FormToolkit widgetFactory, Composite parent) {
        Control wsdlURLLabel = createDescription(parent, EsbViewsRepository.ProxyService.Wsdl.wsdlURL,
                EsbMessages.ProxyServicePropertiesEditionPart_WsdlURLLabel);
        ...
        wsdlURL.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this, EsbViewsRepository.ProxyService.Wsdl.wsdlURL,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, wsdlURL.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyService.Wsdl.wsdlURL, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, wsdlURL.getText()));
                }
            }
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                        EsbViewsRepository.ProxyService.Wsdl.wsdlURL, PropertiesEditionEvent.COMMIT,
                                        PropertiesEditionEvent.SET, null, wsdlURL.getText()));
                }
            }
        });
        ...
        Control wsdlURLHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ProxyService.Wsdl.wsdlURL, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createWsdlResourcesTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.wsdlResources = new ReferencesTable(
                getDescription(EsbViewsRepository.ProxyService.Wsdl.wsdlResources,
                        EsbMessages.ProxyServicePropertiesEditionPart_WsdlResourcesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                        EsbViewsRepository.ProxyService.Wsdl.wsdlResources,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.wsdlResources.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ProxyService.Wsdl.wsdlResources, EsbViewsRepository.FORM_KIND));
        ...
        this.wsdlResources.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyService.Wsdl.wsdlResources, PropertiesEditionEvent.CHANGE,
                                    PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
    ...
    protected Composite createPreservePolicyCheckbox(FormToolkit widgetFactory, Composite parent) {
        preservePolicy = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ProxyService.Wsdl.preservePolicy,
                        EsbMessages.ProxyServicePropertiesEditionPart_PreservePolicyLabel),
                SWT.CHECK);
        preservePolicy.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyService.Wsdl.preservePolicy, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, new Boolean(preservePolicy.getSelection())));
            }
        ...
        Control preservePolicyHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ProxyService.Wsdl.preservePolicy, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ProxyService.Properties.description,
                EsbMessages.ProxyServicePropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.Properties.description, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyService.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ProxyService.Properties.commentsList,
                        EsbMessages.ProxyServicePropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
             ...
             */
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "ProxyService", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createInSequenceInputConnectorsTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.inSequenceInputConnectors = new ReferencesTable(
                getDescription(EsbViewsRepository.ProxyService.Properties.inSequenceInputConnectors,
                        EsbMessages.ProxyServicePropertiesEditionPart_InSequenceInputConnectorsLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                        EsbViewsRepository.ProxyService.Properties.inSequenceInputConnectors,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.inSequenceInputConnectors.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyService.Properties.inSequenceInputConnectors, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createMainSequenceCheckbox(FormToolkit widgetFactory, Composite parent) {
        mainSequence = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ProxyService.Properties.mainSequence,
                        EsbMessages.ProxyServicePropertiesEditionPart_MainSequenceLabel),
                SWT.CHECK);
        mainSequence.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.Properties.mainSequence, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new Boolean(mainSequence.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyService.Properties.mainSequence, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setPinnedServers(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setServiceGroup(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setTraceEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setStatisticsEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setStartOnLoad(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setTransports(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#initEndpointType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setEndpointType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setEndpointName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#initFaultSequenceType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setFaultSequenceType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setFaultSequenceName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#initInSequenceType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setInSequenceType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setInSequenceName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#initOutSequenceType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setOutSequenceType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setOutSequenceName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#initServiceParameters(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#addFilterServiceParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#addBusinessFilterServiceParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#isContainedInServiceParametersTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setReliableMessagingEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setSecurityEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#initServicePolicies(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#addFilterServicePolicies(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#addBusinessFilterServicePolicies(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#isContainedInServicePoliciesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#initWsdlType(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setWsdlType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#initWsdlResources(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#addFilterWsdlResources(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#addBusinessFilterWsdlResources(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#isContainedInWsdlResourcesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setPreservePolicy(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#initInSequenceInputConnectors(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#addFilterInSequenceInputConnectors(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#addBusinessFilterInSequenceInputConnectors(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#isContainedInInSequenceInputConnectorsTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServicePropertiesEditionPart#setMainSequence(Boolean
     *      newValue)
     * 
     */
    ...
    private void validateEndpoint() {
        ...
        } else if (getEndpointType() != null
                && getEndpointType().getName().equals(SequenceType.REGISTRY_REFERENCE.getName())) {
    ...
    private void validateFaultSequence() {
        ...
        if (getFaultSequenceType() != null
                && getFaultSequenceType().getName().equals(SequenceType.NAMED_REFERENCE.getName())) {
            eu.showEntry(faultSequenceNameElements, false);

        } else if (getFaultSequenceType() != null
                && getFaultSequenceType().getName().equals(SequenceType.REGISTRY_REFERENCE.getName())) {
    ...
    private void validateInSequence() {
        ...
        if (getInSequenceType() != null
                && getInSequenceType().getName().equals(SequenceType.NAMED_REFERENCE.getName())) {
            eu.showEntry(inSequenceNameElements, false);

        } else if (getInSequenceType() != null
                && getInSequenceType().getName().equals(SequenceType.REGISTRY_REFERENCE.getName())) {
    ...
    private void validateOutSequence() {
        ...
        if (getOutSequenceType() != null
                && getOutSequenceType().getName().equals(SequenceType.NAMED_REFERENCE.getName())) {
            eu.showEntry(outSequenceNameElements, false);

        } else if (getOutSequenceType() != null
                && getOutSequenceType().getName().equals(SequenceType.REGISTRY_REFERENCE.getName())) {
    ...
    protected Composite createOnError(FormToolkit widgetFactory, final Composite parent) {
        ...
        onErrorText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        ProxyServicePropertiesEditionPartForm.this, EsbViewsRepository.ProxyService.Basic.onError,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getOnError()));
            }
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, onError, new ArrayList<NamedEntityDescriptor>());
                    dialog.open();
                    onErrorText.setText(onError.getKeyValue());
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this, EsbViewsRepository.ProxyService.Basic.onError,
        ...
        Control onErrorHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ProxyService.Basic.onError, EsbViewsRepository.FORM_KIND), null);
    ...
    protected Composite createFaultSequenceKey(FormToolkit widgetFactory, final Composite parent) {
        Control sequenceKeyLabel = createDescription(parent,
                EsbViewsRepository.ProxyService.FaultSequence.faultSequenceKey,
        ...
        faultSequenceKeyText.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, faultSequenceKey, new ArrayList<NamedEntityDescriptor>());
                    dialog.open();
                    faultSequenceKeyText.setText(faultSequenceKey.getKeyValue());
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.FaultSequence.faultSequenceKey,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getFaultSequenceKey()));
                }
            }
    ...
    protected Composite createFaultSequenceOnError(FormToolkit widgetFactory, final Composite parent) {
        Control onErrorLabel = createDescription(parent,
                EsbViewsRepository.ProxyService.FaultSequence.faultSequenceOnError,
        ...
        faultSequenceOnErrorText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        ProxyServicePropertiesEditionPartForm.this,
                        EsbViewsRepository.ProxyService.FaultSequence.faultSequenceOnError,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getFaultSequenceOnError()));
            }
        ...
        faultSequenceOnErrorText.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, faultSequenceOnError, new ArrayList<NamedEntityDescriptor>());
                    dialog.open();
                    faultSequenceOnErrorText.setText(faultSequenceOnError.getKeyValue());
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
        ...
        EditingUtils.setID(faultSequenceOnErrorText,
                EsbViewsRepository.ProxyService.FaultSequence.faultSequenceOnError);
        ...
        Control onErrorHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        ...
                        EsbViewsRepository.FORM_KIND),
                null);
        faultSequenceOnErrorElements = new Control[] { faultSequenceOnErrorText, faultSequenceOnErrorText,
                onErrorHelp };
        return parent;
    }
    ...
    protected Composite createEndpointKey(FormToolkit widgetFactory, final Composite parent) {
        ...
        endpointKeyText.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, endpointKey, new ArrayList<NamedEntityDescriptor>());
                    dialog.open();
                    endpointKeyText.setText(endpointKey.getKeyValue());
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
        ...
        Control endpointKeyHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ProxyService.Endpoint.endpointKey, EsbViewsRepository.FORM_KIND),
                null);
    ...
    protected Composite createInSequenceKey(FormToolkit widgetFactory, final Composite parent) {
        ...
        inSequenceKeyText.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, inSequenceKey, new ArrayList<NamedEntityDescriptor>());
                    dialog.open();
                    inSequenceKeyText.setText(inSequenceKey.getKeyValue());
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
    ...
    protected Composite createInSequenceOnError(FormToolkit widgetFactory, final Composite parent) {
        ...
        inSequenceOnErrorText.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, inSequenceOnError, new ArrayList<NamedEntityDescriptor>());
                    dialog.open();
                    inSequenceOnErrorText.setText(inSequenceOnError.getKeyValue());
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
        ...
        Control sinSequenceOnErrorHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.ProxyService.InSequence.inSequenceOnError,
                        EsbViewsRepository.FORM_KIND),
                null);
    ...
    protected Composite createOutSequenceKey(FormToolkit widgetFactory, final Composite parent) {
        ...
        outSequenceKeyText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent
                        .firePropertiesChanged(new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
                                EsbViewsRepository.ProxyService.OutSequence.outSequenceKey,
                                PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getOutSequenceKey()));
            }
        ...
        outSequenceKeyText.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, outSequenceKey, new ArrayList<NamedEntityDescriptor>());
                    dialog.open();
                    outSequenceKeyText.setText(outSequenceKey.getKeyValue());
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
        ...
        Control sequenceKeyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.ProxyService.OutSequence.outSequenceKey,
                        EsbViewsRepository.FORM_KIND),
                null);
    ...
    protected Composite createOutSequenceOnError(FormToolkit widgetFactory, final Composite parent) {
        ...
        outSequenceOnErrorText.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, outSequenceOnError, new ArrayList<NamedEntityDescriptor>());
                    dialog.open();
                    outSequenceOnErrorText.setText(outSequenceOnError.getKeyValue());
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this,
                            EsbViewsRepository.ProxyService.OutSequence.outSequenceOnError,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getOutSequenceOnError()));
                }
            }
    ...
    protected Composite createWsdlKey(FormToolkit widgetFactory, final Composite parent) {
        ...
        wsdlKeyText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        ProxyServicePropertiesEditionPartForm.this, EsbViewsRepository.ProxyService.Wsdl.wsdlKey,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getWsdlKey()));
            }
        ...
        wsdlKeyText.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, wsdlKey, new ArrayList<NamedEntityDescriptor>());
                    dialog.open();
                    wsdlKeyText.setText(wsdlKey.getKeyValue());
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServicePropertiesEditionPartForm.this, EsbViewsRepository.ProxyService.Wsdl.wsdlKey,
        ...
        Control sequenceKeyHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ProxyService.Wsdl.wsdlKey, EsbViewsRepository.FORM_KIND), null);
    ...
    protected Composite createWsdlEndpoint(FormToolkit widgetFactory, final Composite parent) {
        ...
        wsdlEndpointText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        ProxyServicePropertiesEditionPartForm.this, EsbViewsRepository.ProxyService.Wsdl.wsdlEndpoint,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getWsdlEndpoint()));
            }
        ...
        wsdlEndpointText.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, wsdlEndpoint, new ArrayList<NamedEntityDescriptor>());
                    dialog.open();
                    wsdlEndpointText.setText(wsdlEndpoint.getKeyValue());
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServicePropertiesEditionPartForm.this,
        ...
        Control sequenceKeyHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.ProxyService.Wsdl.wsdlEndpoint, EsbViewsRepository.FORM_KIND), null);
