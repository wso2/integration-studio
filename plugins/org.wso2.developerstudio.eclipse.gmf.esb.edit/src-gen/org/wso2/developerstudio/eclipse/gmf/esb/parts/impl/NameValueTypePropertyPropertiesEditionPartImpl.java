 ...
 * 
 */
public class NameValueTypePropertyPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, NameValueTypePropertyPropertiesEditionPart {
    ...
    protected Composite createPropertyNameText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            NameValueTypePropertyPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(NameValueTypePropertyPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.NameValueTypeProperty.Properties.propertyName,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.NameValueTypeProperty.Properties.propertyName, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertyValueText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.NameValueTypeProperty.Properties.propertyValue, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertyTypeEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.NameValueTypeProperty.Properties.propertyType, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
