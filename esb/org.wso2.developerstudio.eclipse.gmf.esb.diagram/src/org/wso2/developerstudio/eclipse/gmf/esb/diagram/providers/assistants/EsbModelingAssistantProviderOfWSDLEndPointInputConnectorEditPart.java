 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfWSDLEndPointInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			WSDLEndPointInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(WSDLEndPointInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
