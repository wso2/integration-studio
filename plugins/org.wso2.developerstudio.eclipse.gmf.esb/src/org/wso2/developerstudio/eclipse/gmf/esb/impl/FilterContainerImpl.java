 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FilterContainerImpl#getPassContainer <em>Pass
 * Container</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.FilterContainerImpl#getFailContainer <em>Fail
 * Container</em>}</li>
 * </ul>
 *
 * @generated
...
public class FilterContainerImpl extends EsbNodeImpl implements FilterContainer {
    ...
    public NotificationChain basicSetPassContainer(FilterPassContainer newPassContainer, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.FILTER_CONTAINER__PASS_CONTAINER, oldPassContainer, newPassContainer);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setPassContainer(FilterPassContainer newPassContainer) {
        if (newPassContainer != passContainer) {
            ...
            if (passContainer != null)
                msgs = ((InternalEObject) passContainer).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.FILTER_CONTAINER__PASS_CONTAINER, null, msgs);
            if (newPassContainer != null)
                msgs = ((InternalEObject) newPassContainer).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.FILTER_CONTAINER__PASS_CONTAINER, null, msgs);
            msgs = basicSetPassContainer(newPassContainer, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FILTER_CONTAINER__PASS_CONTAINER,
                    newPassContainer, newPassContainer));
    }
    ...
    public NotificationChain basicSetFailContainer(FilterFailContainer newFailContainer, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.FILTER_CONTAINER__FAIL_CONTAINER, oldFailContainer, newFailContainer);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setFailContainer(FilterFailContainer newFailContainer) {
        if (newFailContainer != failContainer) {
            ...
            if (failContainer != null)
                msgs = ((InternalEObject) failContainer).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.FILTER_CONTAINER__FAIL_CONTAINER, null, msgs);
            if (newFailContainer != null)
                msgs = ((InternalEObject) newFailContainer).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.FILTER_CONTAINER__FAIL_CONTAINER, null, msgs);
            msgs = basicSetFailContainer(newFailContainer, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.FILTER_CONTAINER__FAIL_CONTAINER,
                    newFailContainer, newFailContainer));
    }
