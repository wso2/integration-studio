...
public class ProxyServiceItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (EsbElementTypes.ProxyOutSequenceOutputConnector_3729 == req
				.getElementType()) {
			return getGEFWrapper(new ProxyOutSequenceOutputConnectorCreateCommand(
					req));
		}
		...
		if (EsbElementTypes.ProxyInSequenceInputConnector_3731 == req
				.getElementType()) {
			return getGEFWrapper(new ProxyInSequenceInputConnectorCreateCommand(
					req));
		}
