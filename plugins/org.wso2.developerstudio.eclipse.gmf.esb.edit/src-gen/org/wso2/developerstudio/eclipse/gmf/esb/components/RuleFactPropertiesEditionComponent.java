...
public class RuleFactPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public RuleFactPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject ruleFact,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.RuleFact.Properties.factType)) {
                basePart.initFactType(EEFUtils.choiceOfValues(ruleFact, EsbPackage.eINSTANCE.getRuleFact_FactType()),
                        ruleFact.getFactType());
            }
            if (isAccessible(EsbViewsRepository.RuleFact.Properties.factCustomType))
                basePart.setFactCustomType(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, ruleFact.getFactCustomType()));

            if (isAccessible(EsbViewsRepository.RuleFact.Properties.factName))
                basePart.setFactName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, ruleFact.getFactName()));

            if (isAccessible(EsbViewsRepository.RuleFact.Properties.valueType)) {
                basePart.initValueType(EEFUtils.choiceOfValues(ruleFact, EsbPackage.eINSTANCE.getRuleFact_ValueType()),
                        ruleFact.getValueType());
            }
            if (isAccessible(EsbViewsRepository.RuleFact.Properties.valueLiteral))
                basePart.setValueLiteral(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, ruleFact.getValueLiteral()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.RuleFact.Properties.factCustomType == event.getAffectedEditor()) {
            ruleFact.setFactCustomType((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.RuleFact.Properties.factName == event.getAffectedEditor()) {
            ruleFact.setFactName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
        ...
        if (EsbViewsRepository.RuleFact.Properties.valueLiteral == event.getAffectedEditor()) {
            ruleFact.setValueLiteral((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getRuleFact_FactType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.RuleFact.Properties.factType))
                basePart.setFactType((RuleFactType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getRuleFact_FactCustomType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleFact.Properties.factCustomType)) {
            ...
            if (EsbPackage.eINSTANCE.getRuleFact_FactName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleFact.Properties.factName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRuleFact_ValueType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.RuleFact.Properties.valueType))
                basePart.setValueType((RuleFactValueType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getRuleFact_ValueLiteral().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleFact.Properties.valueLiteral)) {
                if (msg.getNewValue() != null) {
                    basePart.setValueLiteral(
                            EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, msg.getNewValue()));
                } else {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                EsbPackage.eINSTANCE.getRuleFact_FactType(), EsbPackage.eINSTANCE.getRuleFact_FactCustomType(),
                EsbPackage.eINSTANCE.getRuleFact_FactName(), EsbPackage.eINSTANCE.getRuleFact_ValueType(),
                EsbPackage.eINSTANCE.getRuleFact_ValueLiteral(), EsbPackage.eINSTANCE.getRuleFact_ValueExpression(),
                ...
                if (EsbViewsRepository.RuleFact.Properties.factType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleFact_FactType().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getRuleFact_FactType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleFact.Properties.factCustomType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleFact_FactCustomType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getRuleFact_FactCustomType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleFact.Properties.factName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleFact_FactName().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getRuleFact_FactName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleFact.Properties.valueType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleFact_ValueType().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getRuleFact_ValueType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleFact.Properties.valueLiteral == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleFact_ValueLiteral().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getRuleFact_ValueLiteral().getEAttributeType(), newValue);
                }
