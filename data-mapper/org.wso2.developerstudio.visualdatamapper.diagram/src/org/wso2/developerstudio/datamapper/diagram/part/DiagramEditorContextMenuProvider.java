...
public class DiagramEditorContextMenuProvider extends DiagramContextMenuProvider {
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part, EditPartViewer viewer) {
		...
		addNewRecordsListContextActions.put(TreeNodeEditPart.class, new AddNewRecordsListAction(part));
		addNewRecordsListContextActions.put(TreeNode2EditPart.class, new AddNewRecordsListAction(part));
		addNewRecordsListContextActions.put(TreeNode3EditPart.class, new AddNewRecordsListAction(part));
	...
	public void buildContextMenu(final IMenuManager menu) {
		...
		try {
				...
				public void run() {
					...
					if (selectedEPs.size() == 1) {
						...
						if (contextObj instanceof EObject) {
							AbstractActionHandler contextAction = contextActions.get(selectedEditorPart.getClass());
							if (null != contextAction) {
								menu.appendToGroup(EDIT_GROUP_ID, contextAction);
							}

							// Append new root item to menu
							AbstractActionHandler addNewRootRecordContextAction = addNewRootRecordContextActions.get(selectedEditorPart.getClass());
							...
							AbstractActionHandler addNewRecordContextAction = addNewRecordContextActions.get(selectedEditorPart.getClass());
							...
							AbstractActionHandler addNewRecordsListContextAction = addNewRecordsListContextActions.get(selectedEditorPart.getClass());
							...
							AbstractActionHandler addNewFieldContextAction = addNewFieldContextActions.get(selectedEditorPart.getClass());
			...
			org.wso2.developerstudio.datamapper.diagram.part.DataMapperDiagramEditorPlugin.getInstance().logError(ERROR_BUILDING_CONTEXT_MENU, e);
		}
	}
}