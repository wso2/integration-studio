 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfDefaultEndPointOutputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnSource(
			DefaultEndPointOutputConnectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(DefaultEndPointOutputConnectorEditPart) sourceEditPart,
				targetEditPart);
	}
