 ...
 * 
 */
public class ProxyServiceParameterPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ProxyServiceParameterPropertiesEditionPart {
     ...
     */
    public ProxyServiceParameterPropertiesEditionPartForm() {
        super();
    }
     ...
     * 
     */
    public ProxyServiceParameterPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = proxyServiceParameterStep
                .addStep(EsbViewsRepository.ProxyServiceParameter.Properties.class);
    ...
    protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        propertiesSection.setText(EsbMessages.ProxyServiceParameterPropertiesEditionPart_PropertiesGroupLabel);
    ...
    protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ProxyServiceParameter.Properties.name,
                EsbMessages.ProxyServiceParameterPropertiesEditionPart_NameLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServiceParameterPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyServiceParameter.Properties.name,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ProxyServiceParameterPropertiesEditionPartForm.this, null,
        ...
        name.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                ProxyServiceParameterPropertiesEditionPartForm.this,
                                EsbViewsRepository.ProxyServiceParameter.Properties.name, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyServiceParameter.Properties.name, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ProxyServiceParameter.Properties.value,
                EsbMessages.ProxyServiceParameterPropertiesEditionPart_ValueLabel);
        ...
        value.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServiceParameterPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyServiceParameter.Properties.value,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyServiceParameter.Properties.value, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServiceParameterPropertiesEditionPart#setName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyServiceParameterPropertiesEditionPart#setValue(String
     *      newValue)
     * 
     */
