 ...
 * @generated NOT
 */
public class LowerCaseEditPart extends AbstractOperatorEditPart {
	 ...
	 * @generated
	 */
	public LowerCaseEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new org.wso2.developerstudio.datamapper.diagram.edit.policies.LowerCaseItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new org.wso2.developerstudio.datamapper.diagram.edit.policies.LowerCaseCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new LowerCaseFigure();
	}
	...
	public class LowerCaseFigure extends RoundedRectangle {
		...
		public IFigure getToolTip() {
			return new Label("To Lower Case Operation");
		}
