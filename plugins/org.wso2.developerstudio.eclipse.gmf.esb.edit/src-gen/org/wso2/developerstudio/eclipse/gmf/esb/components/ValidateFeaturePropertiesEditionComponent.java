...
public class ValidateFeaturePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ValidateFeaturePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject validateFeature,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ValidateFeature.Properties.featureName))
                basePart.setFeatureName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        validateFeature.getFeatureName()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ValidateFeature.Properties.featureName == event.getAffectedEditor()) {
            validateFeature.setFeatureName((java.lang.String) EEFConverterUtil
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractBooleanFeature_FeatureName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ValidateFeature.Properties.featureName)) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractBooleanFeature_FeatureEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ValidateFeature.Properties.featureEnabled))
                ...
                if (EsbViewsRepository.ValidateFeature.Properties.featureName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAbstractBooleanFeature_FeatureName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAbstractBooleanFeature_FeatureName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ValidateFeature.Properties.featureEnabled == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAbstractBooleanFeature_FeatureEnabled().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAbstractBooleanFeature_FeatureEnabled().getEAttributeType(),
