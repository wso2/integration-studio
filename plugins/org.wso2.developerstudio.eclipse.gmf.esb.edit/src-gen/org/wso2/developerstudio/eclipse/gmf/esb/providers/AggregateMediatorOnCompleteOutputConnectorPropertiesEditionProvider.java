...
public class AggregateMediatorOnCompleteOutputConnectorPropertiesEditionProvider extends PropertiesEditingProviderImpl {
    ...
    public boolean provides(PropertiesEditingContext editingContext) {
        return (editingContext.getEObject() instanceof AggregateMediatorOnCompleteOutputConnector)
                && (EsbPackage.Literals.AGGREGATE_MEDIATOR_ON_COMPLETE_OUTPUT_CONNECTOR == editingContext.getEObject()
                        .eClass());
    }
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part) {
        return (editingContext.getEObject() instanceof AggregateMediatorOnCompleteOutputConnector)
                && (AggregateMediatorOnCompleteOutputConnectorPropertiesEditionComponent.BASE_PART.equals(part));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
        ...
        if (editingContext.getEObject() instanceof AggregateMediatorOnCompleteOutputConnector) {
            return new AggregateMediatorOnCompleteOutputConnectorPropertiesEditionComponent(editingContext,
