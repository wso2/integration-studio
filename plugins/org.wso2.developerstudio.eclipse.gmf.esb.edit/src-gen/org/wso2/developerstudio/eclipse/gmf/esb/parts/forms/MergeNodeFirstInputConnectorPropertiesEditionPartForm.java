 ...
 * 
 */
public class MergeNodeFirstInputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, MergeNodeFirstInputConnectorPropertiesEditionPart {
     ...
     */
    public MergeNodeFirstInputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createIncomingLinksReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.incomingLinks = new ReferencesTable(
                getDescription(EsbViewsRepository.MergeNodeFirstInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MergeNodeFirstInputConnectorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.MergeNodeFirstInputConnector.Properties.incomingLinks,
