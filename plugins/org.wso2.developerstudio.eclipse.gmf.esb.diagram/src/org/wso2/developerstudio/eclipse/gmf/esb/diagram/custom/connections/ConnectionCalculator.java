...
public class ConnectionCalculator {
    ...
    public static EsbLinkEditPart getNearestLinkEditPart(ArrayList links, AbstractBorderedShapeEditPart childEditPart) {
        double current = 0.0;
    ...
    public static ShapeNodeEditPart getNearestConnectorEditPart(ArrayList<AbstractConnectorEditPart> connectors,
        ...
        if (childEditPart != null) {
            ...
            for (int i = 0; i < connectors.size(); ++i) {
                ...
                if ((currentConnector != null) && (!connectors.get(i).equals(currentConnector))
                        && (!connectors.get(i).getParent().equals(currentConnector.getParent()))) {
    ...
    private static void updateCurrentStatesForConnectors(ShapeNodeEditPart childEditPart) {
        currentFigureLocation = new Point(childEditPart.getLocation().x, childEditPart.getLocation().y);
    }
}
