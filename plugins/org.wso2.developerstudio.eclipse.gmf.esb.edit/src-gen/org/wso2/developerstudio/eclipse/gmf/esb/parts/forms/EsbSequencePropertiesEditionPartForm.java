 ...
 * 
 */
public class EsbSequencePropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, EsbSequencePropertiesEditionPart {
     ...
     */
    public EsbSequencePropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.EsbSequence.Properties.name,
                EsbMessages.EsbSequencePropertiesEditionPart_NameLabel);
        ...
        name.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EsbSequencePropertiesEditionPartForm.this, EsbViewsRepository.EsbSequence.Properties.name,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EsbSequencePropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(EsbSequencePropertiesEditionPartForm.this,
                                        EsbViewsRepository.EsbSequence.Properties.name, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EsbSequence.Properties.name, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createChildMediatorsTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.childMediators = new ReferencesTable(
                getDescription(EsbViewsRepository.EsbSequence.Properties.childMediators,
                        EsbMessages.EsbSequencePropertiesEditionPart_ChildMediatorsLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(EsbSequencePropertiesEditionPartForm.this,
                                        EsbViewsRepository.EsbSequence.Properties.childMediators,
        ...
        this.childMediators.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EsbSequence.Properties.childMediators, EsbViewsRepository.FORM_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.EsbSequence.Properties.childMediators, PropertiesEditionEvent.CHANGE,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbSequencePropertiesEditionPart#initChildMediators(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbSequencePropertiesEditionPart#addFilterChildMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbSequencePropertiesEditionPart#addBusinessFilterChildMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbSequencePropertiesEditionPart#isContainedInChildMediatorsTable(EObject
     *      element)
     * 
     */
