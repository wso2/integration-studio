...
public class OperatorLeftContainerCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return dataMapper.DataMapperPackage.eINSTANCE.getOperatorLeftContainer_LeftConnectors();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<dataMapper.diagram.part.DataMapperNodeDescriptor> childDescriptors = dataMapper.diagram.part.DataMapperDiagramUpdater
				.getOperatorLeftContainer_3013SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return dataMapper.diagram.edit.parts.OperatorLeftConnectorEditPart.VISUAL_ID == dataMapper.diagram.part.DataMapperVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<dataMapper.diagram.part.DataMapperNodeDescriptor> childDescriptors = dataMapper.diagram.part.DataMapperDiagramUpdater
				.getOperatorLeftContainer_3013SemanticChildren((View) getHost().getModel());
