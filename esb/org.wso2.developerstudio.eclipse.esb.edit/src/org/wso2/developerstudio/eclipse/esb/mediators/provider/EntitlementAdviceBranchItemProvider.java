...
/**
 * This is the item provider adapter for a {@link org.wso2.developerstudio.eclipse.esb.mediators.EntitlementAdviceBranch} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntitlementAdviceBranchItemProvider
	 ...
	 * @generated
	 */
	public EntitlementAdviceBranchItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		 EntitlementAdviceBranch branch = (EntitlementAdviceBranch)object;
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EntitlementAdviceBranch_sequenceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EntitlementAdviceBranch_sequenceType_feature", "_UI_EntitlementAdviceBranch_type"),
				 MediatorsPackage.Literals.ENTITLEMENT_ADVICE_BRANCH__SEQUENCE_TYPE,
				 true,
				 false,
				 false,
	...
	protected void addSequenceKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EntitlementAdviceBranch_sequenceKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EntitlementAdviceBranch_sequenceKey_feature", "_UI_EntitlementAdviceBranch_type"),
				 MediatorsPackage.Literals.ENTITLEMENT_ADVICE_BRANCH__SEQUENCE_KEY,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns EntitlementAdviceBranch.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EntitlementAdviceBranch"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_EntitlementAdviceBranch_type");
	}
	...
	protected Command createCreateChildCommand(EditingDomain domain, EObject owner, EStructuralFeature feature,
		...
		EntitlementAdviceBranch branch = (EntitlementAdviceBranch) owner;
