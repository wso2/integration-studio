...
public class TaskItemProvider extends EsbElementItemProvider {
    ...
    protected void addTaskNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Task_taskName_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Task_taskName_feature", "_UI_Task_type"),
                        EsbPackage.Literals.TASK__TASK_NAME, true, false, false,
    ...
    protected void addTaskGroupPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Task_taskGroup_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Task_taskGroup_feature", "_UI_Task_type"),
                        EsbPackage.Literals.TASK__TASK_GROUP, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_BasicPropertyCategory"), null));
    }
    ...
    protected void addTriggerTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Task_triggerType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Task_triggerType_feature",
                                "_UI_Task_type"),
                        EsbPackage.Literals.TASK__TRIGGER_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_TriggerInformationPropertyCategory"),
                        null));
    }
    ...
    protected void addCountPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                EsbPackage.Literals.TASK__COUNT, true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
                getString("_UI_TriggerInformationPropertyCategory"), null));
    }
    ...
    protected void addIntervalPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                EsbPackage.Literals.TASK__INTERVAL, true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
                getString("_UI_TriggerInformationPropertyCategory"), null));
    }
    ...
    protected void addCronPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Task_cron_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Task_cron_feature", "_UI_Task_type"),
                        EsbPackage.Literals.TASK__CRON, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
                        getString("_UI_TriggerInformationPropertyCategory"), null));
    }
    ...
    protected void addPinnedServersPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Task_pinnedServers_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Task_pinnedServers_feature",
                                "_UI_Task_type"),
                        EsbPackage.Literals.TASK__PINNED_SERVERS, true, false, false,
    ...
    protected void addTaskImplementationPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Task_taskImplementation_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Task_taskImplementation_feature",
                                "_UI_Task_type"),
                        EsbPackage.Literals.TASK__TASK_IMPLEMENTATION, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_TaskImplementationPropertyCategory"),
                        null));
    }
    ...
    protected void addTaskPropertiesPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Task_taskProperties_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Task_taskProperties_feature",
                                "_UI_Task_type"),
                        EsbPackage.Literals.TASK__TASK_PROPERTIES, true, false, false, null,
                        getString("_UI_TaskImplementationPropertyCategory"), null));
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.TASK__TASK_PROPERTIES,
