...
import static org.wso2.developerstudio.eclipse.gmf.esb.diagram.debugger.utils.ESBDebuggerConstants.ESB_SKIPPOINT_ACTION_ID;
import static org.wso2.developerstudio.eclipse.gmf.esb.diagram.debugger.utils.ESBDebuggerConstants.ESB_SKIPPOINT_COMMAND_LABEL;
import static org.wso2.developerstudio.eclipse.gmf.esb.diagram.debugger.utils.ESBDebuggerConstants.ESB_SKIPPOINT_COMMAND_TOOL_TIP;
			...
			if (ESBDebugPointTarget.canToggleDiagramDebugpoints(selectedEP)) {
				try {
					ESBDebugPointTarget.toggleDiagramDebugpoints(
							(AbstractMediator) selectedEP, SKIP_POINT_LABEL);
				} catch (CoreException | ESBDebuggerException e) {
					log.error(
							"Error while registering the skip point"
									+ e.getMessage(), e);
				}
			}
		}
