...
public class ForEachMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ForEachMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject forEachMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ForEachMediator.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        forEachMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.ForEachMediator.Properties.forEachID))
                basePart.setForEachID(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        forEachMediator.getForEachID()));

            if (isAccessible(EsbViewsRepository.ForEachMediator.Sequence.sequenceType)) {
                basePart.initSequenceType(
                        EEFUtils.choiceOfValues(forEachMediator,
                                EsbPackage.eINSTANCE.getForEachMediator_SequenceType()),
                        forEachMediator.getSequenceType());
            }
            if (isAccessible(EsbViewsRepository.ForEachMediator.Sequence.sequenceName))
                basePart.setSequenceName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        forEachMediator.getSequenceName()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ForEachMediator.Properties.description == event.getAffectedEditor()) {
            forEachMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.ForEachMediator.Properties.forEachID == event.getAffectedEditor()) {
            forEachMediator.setForEachID((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.ForEachMediator.Sequence.sequenceName == event.getAffectedEditor()) {
            forEachMediator.setSequenceName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.ForEachMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ForEachMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ForEachMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getForEachMediator_ForEachID().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ForEachMediator.Properties.forEachID)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getForEachMediator_SequenceType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ForEachMediator.Sequence.sequenceType))
                basePart.setSequenceType((SequenceType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getForEachMediator_SequenceName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ForEachMediator.Sequence.sequenceName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getForEachMediator_ForEachExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ForEachMediator.Properties.forEachExpression)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getForEachMediator_SequenceKey().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ForEachMediator.Sequence.sequenceKey)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getForEachMediator_ForEachID(),
                EsbPackage.eINSTANCE.getForEachMediator_SequenceType(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.ForEachMediator.Properties.forEachID == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getForEachMediator_ForEachID().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getForEachMediator_ForEachID().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ForEachMediator.Sequence.sequenceType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getForEachMediator_SequenceType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getForEachMediator_SequenceType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ForEachMediator.Sequence.sequenceName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getForEachMediator_SequenceName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getForEachMediator_SequenceName().getEAttributeType(), newValue);
                }
