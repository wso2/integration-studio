 ...
 * Schema</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.DataMapperMediatorImpl#getXsltStyleSheet <em>Xslt Style
 * Sheet</em>}</li>
 ...
 * Schema Local Path</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.DataMapperMediatorImpl#getXsltStyleSheetLocalPath <em>Xslt
 * Style Sheet Local Path</em>}</li>
...
public class DataMapperMediatorImpl extends MediatorImpl implements DataMapperMediator {
    ...
    public NotificationChain basicSetXsltStyleSheet(RegistryKeyProperty newXsltStyleSheet, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET, oldXsltStyleSheet, newXsltStyleSheet);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setXsltStyleSheet(RegistryKeyProperty newXsltStyleSheet) {
        if (newXsltStyleSheet != xsltStyleSheet) {
            ...
            if (xsltStyleSheet != null)
                msgs = ((InternalEObject) xsltStyleSheet).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET, null, msgs);
            if (newXsltStyleSheet != null)
                msgs = ((InternalEObject) newXsltStyleSheet).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET, null, msgs);
            msgs = basicSetXsltStyleSheet(newXsltStyleSheet, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET,
                    newXsltStyleSheet, newXsltStyleSheet));
    }
    ...
    public void setXsltStyleSheetLocalPath(String newXsltStyleSheetLocalPath) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET_LOCAL_PATH, oldXsltStyleSheetLocalPath,
                    xsltStyleSheetLocalPath));
    }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case EsbPackage.DATA_MAPPER_MEDIATOR__XSLT_STYLE_SHEET_LOCAL_PATH:
            return XSLT_STYLE_SHEET_LOCAL_PATH_EDEFAULT == null ? xsltStyleSheetLocalPath != null
                    : !XSLT_STYLE_SHEET_LOCAL_PATH_EDEFAULT.equals(xsltStyleSheetLocalPath);
        case EsbPackage.DATA_MAPPER_MEDIATOR__OUTPUT_TYPE:
