 ...
 * 
 */
public class PublishEventMediatorOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public PublishEventMediatorOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject publishEventMediatorOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.PublishEventMediatorOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(publishEventMediatorOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.PublishEventMediatorOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getOutputConnector_CommentMediators().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.PublishEventMediatorOutputConnector.Properties.commentMediators))
