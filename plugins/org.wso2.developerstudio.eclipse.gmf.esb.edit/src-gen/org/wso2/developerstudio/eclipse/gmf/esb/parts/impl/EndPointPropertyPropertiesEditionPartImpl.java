 ...
 * 
 */
public class EndPointPropertyPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, EndPointPropertyPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        CompositionStep propertiesStep = endPointPropertyStep
                .addStep(EsbViewsRepository.EndPointProperty.Properties.class);
    ...
    protected Composite createNameText(Composite parent) {
        Control nameLabel = createDescription(parent, EsbViewsRepository.EndPointProperty.Properties.name,
                EsbMessages.EndPointPropertyPropertiesEditionPart_NameLabel);
                ...
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(EndPointPropertyPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.EndPointProperty.Properties.name, PropertiesEditionEvent.COMMIT,
                ...
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                EndPointPropertyPropertiesEditionPartImpl.this,
                                EsbViewsRepository.EndPointProperty.Properties.name, PropertiesEditionEvent.COMMIT,
                                PropertiesEditionEvent.SET, null, name.getText()));
                }
            }
        ...
        Control nameHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EndPointProperty.Properties.name, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueText(Composite parent) {
        Control valueLabel = createDescription(parent, EsbViewsRepository.EndPointProperty.Properties.value,
                EsbMessages.EndPointPropertyPropertiesEditionPart_ValueLabel);
        ...
        value.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(EndPointPropertyPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.EndPointProperty.Properties.value, PropertiesEditionEvent.COMMIT,
        ...
        Control valueHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EndPointProperty.Properties.value, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createScopeEMFComboViewer(Composite parent) {
        Control scopeLabel = createDescription(parent, EsbViewsRepository.EndPointProperty.Properties.scope,
                EsbMessages.EndPointPropertyPropertiesEditionPart_ScopeLabel);
        ...
        scope.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(EndPointPropertyPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.EndPointProperty.Properties.scope, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getScope()));
            }

        });
        scope.setID(EsbViewsRepository.EndPointProperty.Properties.scope);
        Control scopeHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EndPointProperty.Properties.scope, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueTypeEMFComboViewer(Composite parent) {
        Control valueTypeLabel = createDescription(parent, EsbViewsRepository.EndPointProperty.Properties.valueType,
                EsbMessages.EndPointPropertyPropertiesEditionPart_ValueTypeLabel);
        ...
        valueType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(EndPointPropertyPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.EndPointProperty.Properties.valueType,
        ...
        Control valueTypeHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EndPointProperty.Properties.valueType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EndPointPropertyPropertiesEditionPart#setName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EndPointPropertyPropertiesEditionPart#setValue(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EndPointPropertyPropertiesEditionPart#initScope(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EndPointPropertyPropertiesEditionPart#setScope(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EndPointPropertyPropertiesEditionPart#initValueType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EndPointPropertyPropertiesEditionPart#setValueType(Enumerator
     *      newValue)
     * 
     */
