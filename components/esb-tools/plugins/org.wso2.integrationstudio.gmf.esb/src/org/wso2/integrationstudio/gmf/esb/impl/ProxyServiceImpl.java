...
public class ProxyServiceImpl extends EsbElementImpl implements ProxyService {
    ...
    protected ProxyServiceImpl() {
        ...
        IntegrationStudioProviderUtils.addFilter((Map<String, List<String>>) wsdlKey.getFilters(),
        ...
        IntegrationStudioProviderUtils.addFilter((Map<String, List<String>>) wsdlEndpointKey.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, PlatformMediaTypeConstants.MEDIA_TYPE_WSDL);
        ...
        IntegrationStudioProviderUtils.addFilter((Map<String, List<String>>) inSequenceOnErroKey.getFilters(),
        ...
        IntegrationStudioProviderUtils.addFilter((Map<String, List<String>>) outSequenceOnErroKey.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, ESBMediaTypeConstants.MEDIA_TYPE_SEQUENCE);
        ...
        IntegrationStudioProviderUtils.addFilter((Map<String, List<String>>) faultSequenceOnErroKey.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, ESBMediaTypeConstants.MEDIA_TYPE_SEQUENCE);
