 ...
 * 
 */
public class RecipientListEndPointPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, RecipientListEndPointPropertiesEditionPart {
     ...
     */
    public RecipientListEndPointPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = recipientListEndPointStep
                .addStep(EsbViewsRepository.RecipientListEndPoint.Properties.class);
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RecipientListEndPoint.Properties.description,
                EsbMessages.RecipientListEndPointPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RecipientListEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RecipientListEndPoint.Properties.description,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RecipientListEndPointPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.RecipientListEndPoint.Properties.description, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.RecipientListEndPoint.Properties.commentsList,
                        EsbMessages.RecipientListEndPointPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(),
                        "RecipientListEndPoint", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RecipientListEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RecipientListEndPoint.Properties.commentsList,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createEndPointNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RecipientListEndPoint.Properties.endPointName,
                EsbMessages.RecipientListEndPointPropertiesEditionPart_EndPointNameLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.RecipientListEndPoint.Properties.endPointName, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAnonymousCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        anonymous = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.RecipientListEndPoint.Properties.anonymous,
                        EsbMessages.RecipientListEndPointPropertiesEditionPart_AnonymousLabel),
                SWT.CHECK);
        anonymous.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RecipientListEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RecipientListEndPoint.Properties.anonymous,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(anonymous.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.anonymous, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInLineCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        inLine = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.RecipientListEndPoint.Properties.inLine,
                        EsbMessages.RecipientListEndPointPropertiesEditionPart_InLineLabel),
                SWT.CHECK);
        inLine.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RecipientListEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.RecipientListEndPoint.Properties.inLine, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.inLine, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        duplicate = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.RecipientListEndPoint.Properties.duplicate,
                        EsbMessages.RecipientListEndPointPropertiesEditionPart_DuplicateLabel),
                SWT.CHECK);
        duplicate.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RecipientListEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RecipientListEndPoint.Properties.duplicate,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(duplicate.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.duplicate, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.properties = new ReferencesTable(
                getDescription(EsbViewsRepository.RecipientListEndPoint.Properties.properties_,
                        EsbMessages.RecipientListEndPointPropertiesEditionPart_PropertiesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(RecipientListEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.RecipientListEndPoint.Properties.properties_,
        ...
        this.properties.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.properties_, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createReversedCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        reversed = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.RecipientListEndPoint.Properties.reversed,
                        EsbMessages.RecipientListEndPointPropertiesEditionPart_ReversedLabel),
                SWT.CHECK);
        reversed.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RecipientListEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.RecipientListEndPoint.Properties.reversed, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.reversed, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createChildrenTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.children = new ReferencesTable(
                getDescription(EsbViewsRepository.RecipientListEndPoint.Properties.children,
                        EsbMessages.RecipientListEndPointPropertiesEditionPart_ChildrenLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(RecipientListEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.RecipientListEndPoint.Properties.children,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
                        children.refresh();
                    }
        ...
        this.children.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.children, EsbViewsRepository.FORM_KIND));
        ...
        this.children.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RecipientListEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.RecipientListEndPoint.Properties.children, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.RecipientListEndPoint.Properties.name,
                EsbMessages.RecipientListEndPointPropertiesEditionPart_NameLabel);
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                RecipientListEndPointPropertiesEditionPartForm.this,
                                EsbViewsRepository.RecipientListEndPoint.Properties.name, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.name, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutputConnectorTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.outputConnector = new ReferencesTable(
                getDescription(EsbViewsRepository.RecipientListEndPoint.Properties.outputConnector,
                        EsbMessages.RecipientListEndPointPropertiesEditionPart_OutputConnectorLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(RecipientListEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.RecipientListEndPoint.Properties.outputConnector,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.outputConnector.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.outputConnector, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createEndpointTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RecipientListEndPoint.Properties.endpointType,
                EsbMessages.RecipientListEndPointPropertiesEditionPart_EndpointTypeLabel);
        ...
        endpointType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RecipientListEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.RecipientListEndPoint.Properties.endpointType,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getEndpointType()));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.RecipientListEndPoint.Properties.endpointType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createEndpointsValueText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RecipientListEndPoint.Properties.endpointsValue,
                EsbMessages.RecipientListEndPointPropertiesEditionPart_EndpointsValueLabel);
    ...
    protected Composite createMaxCacheText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RecipientListEndPoint.Properties.maxCache,
                EsbMessages.RecipientListEndPointPropertiesEditionPart_MaxCacheLabel);
        ...
        maxCache.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RecipientListEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.RecipientListEndPoint.Properties.maxCache, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, maxCache.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RecipientListEndPointPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.maxCache, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#setEndPointName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#setAnonymous(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#setInLine(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#setDuplicate(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#initProperties(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#addFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#addBusinessFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#isContainedInPropertiesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#setReversed(Boolean
     *      newValue)
     * 
     */
    public void setReversed(Boolean newValue) {
        ...
        boolean eefElementEditorReadOnlyState = isReadOnly(
                EsbViewsRepository.RecipientListEndPoint.Properties.reversed);
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#initChildren(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#addFilterChildren(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#addBusinessFilterChildren(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#isContainedInChildrenTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#setName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#initOutputConnector(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#addFilterOutputConnector(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#addBusinessFilterOutputConnector(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#isContainedInOutputConnectorTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#initEndpointType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#setEndpointType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#setEndpointsValue(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RecipientListEndPointPropertiesEditionPart#setMaxCache(String
     *      newValue)
     * 
     */
