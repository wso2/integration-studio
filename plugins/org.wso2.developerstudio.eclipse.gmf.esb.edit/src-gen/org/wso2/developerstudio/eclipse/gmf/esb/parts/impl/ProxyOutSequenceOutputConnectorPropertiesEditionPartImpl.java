 ...
 * 
 */
public class ProxyOutSequenceOutputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ProxyOutSequenceOutputConnectorPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        CompositionSequence proxyOutSequenceOutputConnectorStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        proxyOutSequenceOutputConnectorStep.addStep(EsbViewsRepository.ProxyOutSequenceOutputConnector.Properties.class)
    ...
    protected Composite createCommentMediatorsAdvancedTableComposition(Composite parent) {
        this.commentMediators = new ReferencesTable(
                getDescription(EsbViewsRepository.ProxyOutSequenceOutputConnector.Properties.commentMediators,
                        EsbMessages.ProxyOutSequenceOutputConnectorPropertiesEditionPart_CommentMediatorsLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                ProxyOutSequenceOutputConnectorPropertiesEditionPartImpl.this,
                                EsbViewsRepository.ProxyOutSequenceOutputConnector.Properties.commentMediators,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyOutSequenceOutputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.ProxyOutSequenceOutputConnector.Properties.commentMediators,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyOutSequenceOutputConnectorPropertiesEditionPart#initCommentMediators(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyOutSequenceOutputConnectorPropertiesEditionPart#addFilterCommentMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyOutSequenceOutputConnectorPropertiesEditionPart#addBusinessFilterCommentMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyOutSequenceOutputConnectorPropertiesEditionPart#isContainedInCommentMediatorsTable(EObject
     *      element)
     * 
     */
