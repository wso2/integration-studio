...
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigureAdvancedCustomFunctionOperatorDialog;
...
public class ConfigureAdvancedCustomFunctionAction extends AbstractActionHandler {
    ...
    protected void doRun(IProgressMonitor progressMonitor) {
        ...
        Dialog configureCustomFunction = new ConfigureAdvancedCustomFunctionOperatorDialog(
                Display.getDefault().getActiveShell(), (AdvancedCustomFunction) selectedObj, getEditingDomain(),
                selectedEP);
