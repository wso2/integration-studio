 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getCacheProtocolType <em>Cache Protocol
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getCacheType <em>Cache Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getHashGenerator <em>Hash
 * Generator</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getCacheTimeout <em>Cache
 * Timeout</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getMaxMessageSize <em>Max Message
 * Size</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getCacheProtocolMethods <em>Cache Protocol
 * Methods</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getMaxEntryCount <em>Max Entry
 * Count</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getSequenceType <em>Sequence
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getSequenceKey <em>Sequence Key</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getInputConnector <em>Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getOutputConnector <em>Output
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getOnHitOutputConnector <em>On Hit Output
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getMediatorFlow <em>Mediator
 * Flow</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getHeadersToExcludeInHash <em>Headers To
 * Exclude In Hash</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getResponseCodes <em>Response
 * Codes</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#isEnableCacheControl <em>Enable Cache
 * Control</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#isIncludeAgeHeader <em>Include Age
 * Header</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getId <em>Id</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getHashGeneratorAttribute <em>Hash
 * Generator Attribute</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getScope <em>Scope</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getImplementationType <em>Implementation
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CacheMediatorImpl#getCacheMediatorImplementation <em>Cache
 * Mediator Implementation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CacheMediatorImpl extends MediatorImpl implements CacheMediator {
    ...
    /**
     * The cached value of the '{@link #getOnHitOutputConnector() <em>On Hit Output Connector</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The default value of the '{@link #getCacheMediatorImplementation() <em>Cache Mediator Implementation</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getCacheMediatorImplementation() <em>Cache Mediator Implementation</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public void setCacheProtocolType(CacheProtocolType newCacheProtocolType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__CACHE_PROTOCOL_TYPE,
                    oldCacheProtocolType, cacheProtocolType));
    }
    ...
    public void setCacheType(CacheType newCacheType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__CACHE_TYPE, oldCacheType,
                    cacheType));
    }
    ...
    public void setHashGenerator(String newHashGenerator) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__HASH_GENERATOR,
                    oldHashGenerator, hashGenerator));
    }
    ...
    public void setCacheTimeout(int newCacheTimeout) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__CACHE_TIMEOUT,
                    oldCacheTimeout, cacheTimeout));
    }
    ...
    public void setMaxMessageSize(int newMaxMessageSize) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__MAX_MESSAGE_SIZE,
    ...
    public void setCacheProtocolMethods(String newCacheProtocolMethods) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__CACHE_PROTOCOL_METHODS,
                    oldCacheProtocolMethods, cacheProtocolMethods));
    }
    ...
    public void setMaxEntryCount(int newMaxEntryCount) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__MAX_ENTRY_COUNT,
                    oldMaxEntryCount, maxEntryCount));
    }
    ...
    public void setSequenceType(CacheSequenceType newSequenceType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__SEQUENCE_TYPE,
    ...
    public NotificationChain basicSetSequenceKey(RegistryKeyProperty newSequenceKey, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CACHE_MEDIATOR__SEQUENCE_KEY, oldSequenceKey, newSequenceKey);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newSequenceKey != sequenceKey) {
            ...
            if (sequenceKey != null)
                msgs = ((InternalEObject) sequenceKey).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CACHE_MEDIATOR__SEQUENCE_KEY, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__SEQUENCE_KEY,
    ...
    public NotificationChain basicSetInputConnector(CacheMediatorInputConnector newInputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CACHE_MEDIATOR__INPUT_CONNECTOR, oldInputConnector, newInputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInputConnector != inputConnector) {
            ...
            if (inputConnector != null)
                msgs = ((InternalEObject) inputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CACHE_MEDIATOR__INPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__INPUT_CONNECTOR,
    ...
    public NotificationChain basicSetOutputConnector(CacheMediatorOutputConnector newOutputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CACHE_MEDIATOR__OUTPUT_CONNECTOR, oldOutputConnector, newOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOutputConnector != outputConnector) {
            ...
            if (outputConnector != null)
                msgs = ((InternalEObject) outputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CACHE_MEDIATOR__OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__OUTPUT_CONNECTOR,
    ...
    public NotificationChain basicSetOnHitOutputConnector(CacheMediatorOnHitOutputConnector newOnHitOutputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CACHE_MEDIATOR__ON_HIT_OUTPUT_CONNECTOR, oldOnHitOutputConnector,
                    newOnHitOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setOnHitOutputConnector(CacheMediatorOnHitOutputConnector newOnHitOutputConnector) {
        if (newOnHitOutputConnector != onHitOutputConnector) {
            ...
            if (onHitOutputConnector != null)
                msgs = ((InternalEObject) onHitOutputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CACHE_MEDIATOR__ON_HIT_OUTPUT_CONNECTOR, null, msgs);
            if (newOnHitOutputConnector != null)
                msgs = ((InternalEObject) newOnHitOutputConnector).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CACHE_MEDIATOR__ON_HIT_OUTPUT_CONNECTOR, null, msgs);
            msgs = basicSetOnHitOutputConnector(newOnHitOutputConnector, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__ON_HIT_OUTPUT_CONNECTOR,
                    newOnHitOutputConnector, newOnHitOutputConnector));
    }
    ...
    public NotificationChain basicSetMediatorFlow(MediatorFlow newMediatorFlow, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CACHE_MEDIATOR__MEDIATOR_FLOW, oldMediatorFlow, newMediatorFlow);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newMediatorFlow != mediatorFlow) {
            ...
            if (mediatorFlow != null)
                msgs = ((InternalEObject) mediatorFlow).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CACHE_MEDIATOR__MEDIATOR_FLOW, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__MEDIATOR_FLOW,
    ...
    public void setHeadersToExcludeInHash(String newHeadersToExcludeInHash) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__HEADERS_TO_EXCLUDE_IN_HASH,
                    oldHeadersToExcludeInHash, headersToExcludeInHash));
    }
    ...
    public void setResponseCodes(String newResponseCodes) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__RESPONSE_CODES,
                    oldResponseCodes, responseCodes));
    }
    ...
    public void setEnableCacheControl(boolean newEnableCacheControl) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__ENABLE_CACHE_CONTROL,
                    oldEnableCacheControl, enableCacheControl));
    }
    ...
    public void setIncludeAgeHeader(boolean newIncludeAgeHeader) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__INCLUDE_AGE_HEADER,
                    oldIncludeAgeHeader, includeAgeHeader));
    }
    ...
    public void setHashGeneratorAttribute(String newHashGeneratorAttribute) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__HASH_GENERATOR_ATTRIBUTE,
                    oldHashGeneratorAttribute, hashGeneratorAttribute));
    }
    ...
    public void setImplementationType(CacheImplementationType newImplementationType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CACHE_MEDIATOR__IMPLEMENTATION_TYPE,
    ...
    public void setCacheMediatorImplementation(CacheMediatorType newCacheMediatorImplementation) {
        ...
        cacheMediatorImplementation = newCacheMediatorImplementation == null ? CACHE_MEDIATOR_IMPLEMENTATION_EDEFAULT
                : newCacheMediatorImplementation;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CACHE_MEDIATOR__CACHE_MEDIATOR_IMPLEMENTATION, oldCacheMediatorImplementation,
    ...
    public boolean eIsSet(int featureID) {
        ...
        case EsbPackage.CACHE_MEDIATOR__HASH_GENERATOR:
            return HASH_GENERATOR_EDEFAULT == null ? hashGenerator != null
                    : !HASH_GENERATOR_EDEFAULT.equals(hashGenerator);
        case EsbPackage.CACHE_MEDIATOR__CACHE_TIMEOUT:
            return cacheTimeout != CACHE_TIMEOUT_EDEFAULT;
        case EsbPackage.CACHE_MEDIATOR__MAX_MESSAGE_SIZE:
            return maxMessageSize != MAX_MESSAGE_SIZE_EDEFAULT;
        case EsbPackage.CACHE_MEDIATOR__CACHE_PROTOCOL_METHODS:
            return CACHE_PROTOCOL_METHODS_EDEFAULT == null ? cacheProtocolMethods != null
                    : !CACHE_PROTOCOL_METHODS_EDEFAULT.equals(cacheProtocolMethods);
        case EsbPackage.CACHE_MEDIATOR__MAX_ENTRY_COUNT:
        ...
        case EsbPackage.CACHE_MEDIATOR__HEADERS_TO_EXCLUDE_IN_HASH:
            return HEADERS_TO_EXCLUDE_IN_HASH_EDEFAULT == null ? headersToExcludeInHash != null
                    : !HEADERS_TO_EXCLUDE_IN_HASH_EDEFAULT.equals(headersToExcludeInHash);
        case EsbPackage.CACHE_MEDIATOR__RESPONSE_CODES:
            return RESPONSE_CODES_EDEFAULT == null ? responseCodes != null
                    : !RESPONSE_CODES_EDEFAULT.equals(responseCodes);
        case EsbPackage.CACHE_MEDIATOR__ENABLE_CACHE_CONTROL:
        ...
        case EsbPackage.CACHE_MEDIATOR__HASH_GENERATOR_ATTRIBUTE:
            return HASH_GENERATOR_ATTRIBUTE_EDEFAULT == null ? hashGeneratorAttribute != null
                    : !HASH_GENERATOR_ATTRIBUTE_EDEFAULT.equals(hashGeneratorAttribute);
        case EsbPackage.CACHE_MEDIATOR__SCOPE:
