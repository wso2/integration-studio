 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ThrottleOnRejectBranchImpl#getSequenceType <em>Sequence
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ThrottleOnRejectBranchImpl#getSequenceKey <em>Sequence
 * Key</em>}</li>
 * </ul>
 *
 * @generated
...
public class ThrottleOnRejectBranchImpl extends EObjectImpl implements ThrottleOnRejectBranch {
    ...
    public void setSequenceType(ThrottleSequenceType newSequenceType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.THROTTLE_ON_REJECT_BRANCH__SEQUENCE_TYPE,
    ...
    public NotificationChain basicSetSequenceKey(RegistryKeyProperty newSequenceKey, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.THROTTLE_ON_REJECT_BRANCH__SEQUENCE_KEY, oldSequenceKey, newSequenceKey);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newSequenceKey != sequenceKey) {
            ...
            if (sequenceKey != null)
                msgs = ((InternalEObject) sequenceKey).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.THROTTLE_ON_REJECT_BRANCH__SEQUENCE_KEY, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.THROTTLE_ON_REJECT_BRANCH__SEQUENCE_KEY,
