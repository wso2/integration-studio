 ...
 * 
 */
public class ValidateResourcePropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ValidateResourcePropertiesEditionPart {
    ...
    protected Composite createLocationText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateResource.Properties.location, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createLocationKeyWidget(Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.ValidateResource.Properties.locationKey,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateResource.Properties.locationKey, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
