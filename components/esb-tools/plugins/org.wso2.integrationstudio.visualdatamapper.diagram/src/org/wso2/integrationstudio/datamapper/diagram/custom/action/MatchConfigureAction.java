...
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigureMatchOperatorDialog;

public class MatchConfigureAction extends AbstractActionHandler {
	 ...
	 */
	public MatchConfigureAction(IWorkbenchPart part) {
		super(part);
		setId("configure-match-operator-action-id");
		setText("Configure Match Operator");
		setToolTipText("Configure Match Operator Attributes");
	...
	protected void doRun(IProgressMonitor progressMonitor) {
		...
		Dialog configureMatchDialog = new ConfigureMatchOperatorDialog(Display.getDefault().getActiveShell(),
				(Match) selectedObj, getEditingDomain(), selectedEP);
		configureMatchDialog.create();
		configureMatchDialog.open();
	}
