...
package org.wso2.integrationstudio.artifact.messageprocessor.wizard;
...
public class CustomParametersComposite extends AbstractComposite{
	...
	private MessageProcessorModel model;
	...
	public CustomParametersComposite(Composite parent, int style,
		...
		this.model = (MessageProcessorModel) model;
	...
	private void updateParameters(){
		model.getCustomProcessorParameters().clear();
		for (TableItem item : tblParameters.getItems()) {
			model.getCustomProcessorParameters().put(item.getText(0), item.getText(1));
		}
	}
