 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfStoreMediatorInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			StoreMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(StoreMediatorInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
