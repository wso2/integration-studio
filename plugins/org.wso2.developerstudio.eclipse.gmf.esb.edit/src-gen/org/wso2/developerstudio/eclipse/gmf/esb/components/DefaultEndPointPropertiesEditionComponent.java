...
public class DefaultEndPointPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public DefaultEndPointPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject defaultEndPoint,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.DefaultEndPoint.Misc.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        defaultEndPoint.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.DefaultEndPoint.Basic.endPointName))
                basePart.setEndPointName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        defaultEndPoint.getEndPointName()));
            ...
            if (isAccessible(EsbViewsRepository.DefaultEndPoint.Misc.properties)) {
                propertiesSettings = new ReferencesTableSettings(defaultEndPoint,
            ...
            if (isAccessible(EsbViewsRepository.DefaultEndPoint.QoS.addressingVersion)) {
                basePart.initAddressingVersion(
                        EEFUtils.choiceOfValues(defaultEndPoint,
                                EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingVersion()),
                        defaultEndPoint.getAddressingVersion());
            }
            ...
            if (isAccessible(EsbViewsRepository.DefaultEndPoint.Timeout.timeOutDuration))
                basePart.setTimeOutDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        defaultEndPoint.getTimeOutDuration()));
            ...
            if (isAccessible(EsbViewsRepository.DefaultEndPoint.Timeout.timeOutAction)) {
                basePart.initTimeOutAction(
                        ...
                        defaultEndPoint.getTimeOutAction());
            }
            if (isAccessible(EsbViewsRepository.DefaultEndPoint.EndpointTimeoutState.retryErrorCodes))
                basePart.setRetryErrorCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        defaultEndPoint.getRetryErrorCodes()));

            if (isAccessible(EsbViewsRepository.DefaultEndPoint.EndpointTimeoutState.retryCount)) {
                basePart.setRetryCount(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, defaultEndPoint.getRetryCount()));
            }

            if (isAccessible(EsbViewsRepository.DefaultEndPoint.EndpointTimeoutState.retryDelay)) {
                basePart.setRetryDelay(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG, defaultEndPoint.getRetryDelay()));
            }
            ...
            if (isAccessible(EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendErrorCodes))
                basePart.setSuspendErrorCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        defaultEndPoint.getSuspendErrorCodes()));
            ...
            if (isAccessible(EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendInitialDuration)) {
                basePart.setSuspendInitialDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        defaultEndPoint.getSuspendInitialDuration()));
            }
            ...
            if (isAccessible(EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendMaximumDuration)) {
                basePart.setSuspendMaximumDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        defaultEndPoint.getSuspendMaximumDuration()));
            }
            ...
            if (isAccessible(EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendProgressionFactor)) {
                basePart.setSuspendProgressionFactor(EEFConverterUtil.convertToString(EcorePackage.Literals.EFLOAT,
                        defaultEndPoint.getSuspendProgressionFactor()));
            }

            if (isAccessible(EsbViewsRepository.DefaultEndPoint.Basic.format)) {
                basePart.initFormat(
                        EEFUtils.choiceOfValues(defaultEndPoint, EsbPackage.eINSTANCE.getAbstractEndPoint_Format()),
                        defaultEndPoint.getFormat());
            }
            if (isAccessible(EsbViewsRepository.DefaultEndPoint.Misc.optimize)) {
                basePart.initOptimize(
                        EEFUtils.choiceOfValues(defaultEndPoint, EsbPackage.eINSTANCE.getAbstractEndPoint_Optimize()),
                        defaultEndPoint.getOptimize());
            }
            if (isAccessible(EsbViewsRepository.DefaultEndPoint.Basic.templateParameters)) {
                templateParametersSettings = new ReferencesTableSettings(defaultEndPoint,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.DefaultEndPoint.Misc.description == event.getAffectedEditor()) {
            defaultEndPoint.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.DefaultEndPoint.Basic.endPointName == event.getAffectedEditor()) {
            defaultEndPoint.setEndPointName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.DefaultEndPoint.Timeout.timeOutDuration == event.getAffectedEditor()) {
            defaultEndPoint.setTimeOutDuration((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendErrorCodes == event.getAffectedEditor()) {
            defaultEndPoint.setSuspendErrorCodes((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendInitialDuration == event
                .getAffectedEditor()) {
            defaultEndPoint.setSuspendInitialDuration((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendMaximumDuration == event
                .getAffectedEditor()) {
            defaultEndPoint.setSuspendMaximumDuration(
                    (EEFConverterUtil.createLongFromString(EcorePackage.Literals.ELONG, (String) event.getNewValue())));
        }
        if (EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendProgressionFactor == event
                .getAffectedEditor()) {
            defaultEndPoint.setSuspendProgressionFactor((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.Misc.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.Basic.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getEndPoint_EndPointName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.Basic.endPointName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_ReliableMessagingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.QoS.reliableMessagingEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SecurityEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.QoS.securityEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.QoS.addressingEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingVersion().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.QoS.addressingVersion))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingSeparateListener().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.QoS.addressingSeparateListener))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.Timeout.timeOutDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.Timeout.timeOutAction))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryErrorCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.EndpointTimeoutState.retryErrorCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryCount().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.EndpointTimeoutState.retryCount)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryDelay().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.EndpointTimeoutState.retryDelay)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendErrorCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendErrorCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendInitialDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendInitialDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendMaximumDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendMaximumDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendProgressionFactor().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendProgressionFactor)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_Format().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.Basic.format))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_Optimize().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.Misc.optimize))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TemplateParameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.Basic.templateParameters))
                basePart.updateTemplateParameters();
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_StatisticsEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.Basic.statisticsEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TraceEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DefaultEndPoint.Basic.traceEnabled))
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.DefaultEndPoint.EndpointTimeoutState.retryErrorCodes == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendErrorCodes == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
