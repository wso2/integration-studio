 ...
 * @generated
 */
public class APIResourceEndpointItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.APIResourceEndpointInputConnector_3675 == req
				.getElementType()) {
			return getGEFWrapper(new APIResourceEndpointInputConnectorCreateCommand(
					req));
		}
		if (EsbElementTypes.APIResourceEndpointOutputConnector_3676 == req
				.getElementType()) {
			return getGEFWrapper(new APIResourceEndpointOutputConnectorCreateCommand(
					req));
		}
