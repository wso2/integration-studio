 ...
 * 
 */
public class FailoverEndPointPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, FailoverEndPointPropertiesEditionPart {
     ...
     */
    public FailoverEndPointPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = failoverEndPointStep
                .addStep(EsbViewsRepository.FailoverEndPoint.Properties.class);
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.FailoverEndPoint.Properties.description,
                EsbMessages.FailoverEndPointPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.FailoverEndPoint.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FailoverEndPointPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FailoverEndPointPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FailoverEndPoint.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.FailoverEndPoint.Properties.commentsList,
                        EsbMessages.FailoverEndPointPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "FailoverEndPoint", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FailoverEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.FailoverEndPoint.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createEndPointNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.FailoverEndPoint.Properties.endPointName,
                EsbMessages.FailoverEndPointPropertiesEditionPart_EndPointNameLabel);
        ...
        endPointName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FailoverEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.FailoverEndPoint.Properties.endPointName, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FailoverEndPoint.Properties.endPointName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAnonymousCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        anonymous = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.FailoverEndPoint.Properties.anonymous,
                        EsbMessages.FailoverEndPointPropertiesEditionPart_AnonymousLabel),
                SWT.CHECK);
        anonymous.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FailoverEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.FailoverEndPoint.Properties.anonymous, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FailoverEndPoint.Properties.anonymous, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInLineCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        inLine = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.FailoverEndPoint.Properties.inLine,
                        EsbMessages.FailoverEndPointPropertiesEditionPart_InLineLabel),
                SWT.CHECK);
        inLine.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FailoverEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.FailoverEndPoint.Properties.inLine, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FailoverEndPoint.Properties.inLine, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        duplicate = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.FailoverEndPoint.Properties.duplicate,
                        EsbMessages.FailoverEndPointPropertiesEditionPart_DuplicateLabel),
                SWT.CHECK);
        duplicate.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FailoverEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.FailoverEndPoint.Properties.duplicate, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FailoverEndPoint.Properties.duplicate, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.properties = new ReferencesTable(
                getDescription(EsbViewsRepository.FailoverEndPoint.Properties.properties_,
                        EsbMessages.FailoverEndPointPropertiesEditionPart_PropertiesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(FailoverEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.FailoverEndPoint.Properties.properties_,
        ...
        this.properties.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FailoverEndPoint.Properties.properties_, EsbViewsRepository.FORM_KIND));
        ...
        this.properties.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FailoverEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.FailoverEndPoint.Properties.properties_, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createReversedCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        reversed = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.FailoverEndPoint.Properties.reversed,
                        EsbMessages.FailoverEndPointPropertiesEditionPart_ReversedLabel),
                SWT.CHECK);
        reversed.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FailoverEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.FailoverEndPoint.Properties.reversed, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FailoverEndPoint.Properties.reversed, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createChildrenTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.children = new ReferencesTable(
                getDescription(EsbViewsRepository.FailoverEndPoint.Properties.children,
                        EsbMessages.FailoverEndPointPropertiesEditionPart_ChildrenLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(FailoverEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.FailoverEndPoint.Properties.children,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
                        children.refresh();
                    }
        ...
        this.children.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.FailoverEndPoint.Properties.children, EsbViewsRepository.FORM_KIND));
        ...
        this.children.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FailoverEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.FailoverEndPoint.Properties.children, PropertiesEditionEvent.CHANGE,
                            PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
    ...
    protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.FailoverEndPoint.Properties.name,
                EsbMessages.FailoverEndPointPropertiesEditionPart_NameLabel);
        ...
        name.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FailoverEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.FailoverEndPoint.Properties.name, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, name.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FailoverEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.FailoverEndPoint.Properties.name, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FailoverEndPoint.Properties.name, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutputConnectorTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.outputConnector = new ReferencesTable(
                getDescription(EsbViewsRepository.FailoverEndPoint.Properties.outputConnector,
                        EsbMessages.FailoverEndPointPropertiesEditionPart_OutputConnectorLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(FailoverEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.FailoverEndPoint.Properties.outputConnector,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.outputConnector.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FailoverEndPoint.Properties.outputConnector, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createBuildMessageCheckbox(FormToolkit widgetFactory, Composite parent) {
        buildMessage = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.FailoverEndPoint.Properties.buildMessage,
                        EsbMessages.FailoverEndPointPropertiesEditionPart_BuildMessageLabel),
                SWT.CHECK);
        buildMessage.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FailoverEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.FailoverEndPoint.Properties.buildMessage, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new Boolean(buildMessage.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FailoverEndPoint.Properties.buildMessage, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#setEndPointName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#setAnonymous(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#setInLine(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#setDuplicate(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#initProperties(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#addFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#addBusinessFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#isContainedInPropertiesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#setReversed(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#initChildren(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#addFilterChildren(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#addBusinessFilterChildren(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#isContainedInChildrenTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#setName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#initOutputConnector(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#addFilterOutputConnector(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#addBusinessFilterOutputConnector(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#isContainedInOutputConnectorTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FailoverEndPointPropertiesEditionPart#setBuildMessage(Boolean
     *      newValue)
     * 
     */
