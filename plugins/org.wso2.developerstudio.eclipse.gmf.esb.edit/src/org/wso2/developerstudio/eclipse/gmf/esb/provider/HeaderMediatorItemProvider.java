...
public class HeaderMediatorItemProvider extends MediatorItemProvider {
    ...
    protected void addHeaderNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_HeaderMediator_headerName_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_HeaderMediator_headerName_feature",
                                "_UI_HeaderMediator_type"),
                        EsbPackage.Literals.HEADER_MEDIATOR__HEADER_NAME, true, false, false, null, null, null));
    }
    ...
    protected void addHeaderActionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_HeaderMediator_headerAction_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_HeaderMediator_headerAction_feature",
                                "_UI_HeaderMediator_type"),
                        EsbPackage.Literals.HEADER_MEDIATOR__HEADER_ACTION, true, false, false,
    ...
    protected void addValueTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_HeaderMediator_valueType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_HeaderMediator_valueType_feature",
                                "_UI_HeaderMediator_type"),
                        EsbPackage.Literals.HEADER_MEDIATOR__VALUE_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addScopePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_HeaderMediator_scope_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_HeaderMediator_scope_feature",
                                "_UI_HeaderMediator_type"),
                        EsbPackage.Literals.HEADER_MEDIATOR__SCOPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addValueLiteralPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_HeaderMediator_valueLiteral_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_HeaderMediator_valueLiteral_feature",
                                "_UI_HeaderMediator_type"),
                        EsbPackage.Literals.HEADER_MEDIATOR__VALUE_LITERAL, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addValueInlinePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_HeaderMediator_valueInline_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_HeaderMediator_valueInline_feature",
                                "_UI_HeaderMediator_type"),
                        EsbPackage.Literals.HEADER_MEDIATOR__VALUE_INLINE, true, true, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_HeaderMediator_type")
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.HEADER_MEDIATOR__HEADER_NAME,
                EsbFactory.eINSTANCE.createNamespacedProperty()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.HEADER_MEDIATOR__VALUE_EXPRESSION,
                EsbFactory.eINSTANCE.createNamespacedProperty()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.HEADER_MEDIATOR__INPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createHeaderMediatorInputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.HEADER_MEDIATOR__OUTPUT_CONNECTOR,
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify = childFeature == EsbPackage.Literals.HEADER_MEDIATOR__HEADER_NAME
