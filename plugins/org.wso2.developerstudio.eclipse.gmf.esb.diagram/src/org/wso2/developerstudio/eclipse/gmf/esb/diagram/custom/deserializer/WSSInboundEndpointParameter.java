...
import static org.wso2.developerstudio.eclipse.gmf.esb.EsbPackage.Literals.INBOUND_ENDPOINT__WS_INBOUND_PORT;
...
/**
 * This Enum represent ws inbound endpoint parameters with parameter name , related EAttribute and boolean value indicating
...
public enum WSSInboundEndpointParameter {
	...
	INBOUND_ENDPOINT__WS_CLIENT_SIDE_BROADCAST_LEVEL_TYPE(InboundEndpointConstants.WS_CLIENT_SIDE_BROADCAST_LEVEL, 
			INBOUND_ENDPOINT__WS_CLIENT_SIDE_BROADCAST_LEVEL,false),
	INBOUND_ENDPOINT__WS_OUTFLOW_DISPATCH_SEQUENCE_TYPE(InboundEndpointConstants.WS_OUTFLOW_DISPATCH_SEQUENCE,
	...
	INBOUND_ENDPOINT__WS_SHUTDOWN_STATUS_CODE_TYPE(InboundEndpointConstants.WS_SHUTDWN_STATUS_CODE,
			INBOUND_ENDPOINT__WS_SHUTDOWN_STATUS_CODE,true),
	INBOUND_ENDPOINT__WS_SHUTDOWN_STATUS_MESSAGE_TYPE(InboundEndpointConstants.WS_SHUTDOWN_STATUS_MESSAGE,
			INBOUND_ENDPOINT__WS_SHUTDOWN_STATUS_MESSAGE,true),
	INBOUND_ENDPOINT__WS_USE_PORT_OFFSET_TYPE(InboundEndpointConstants.WS_USE_PORT_OFFSET,
	        INBOUND_ENDPOINT__WS_USE_PORT_OFFSET,false);
