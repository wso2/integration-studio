 ...
 * 
 */
public class RouterMediatorTargetOutputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, RouterMediatorTargetOutputConnectorPropertiesEditionPart {
     ...
     */
    public RouterMediatorTargetOutputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        CompositionSequence routerMediatorTargetOutputConnectorStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        CompositionStep propertiesStep = routerMediatorTargetOutputConnectorStep
                .addStep(EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.class);
    ...
    protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        propertiesSection
                .setText(EsbMessages.RouterMediatorTargetOutputConnectorPropertiesEditionPart_PropertiesGroupLabel);
    ...
    protected Composite createCommentMediatorsTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.commentMediators = new ReferencesTable(
                getDescription(EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.commentMediators,
                        EsbMessages.RouterMediatorTargetOutputConnectorPropertiesEditionPart_CommentMediatorsLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                RouterMediatorTargetOutputConnectorPropertiesEditionPartForm.this,
                                EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.commentMediators,
    ...
    protected Composite createSoapActionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.soapAction,
                EsbMessages.RouterMediatorTargetOutputConnectorPropertiesEditionPart_SoapActionLabel);
        ...
        soapAction.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RouterMediatorTargetOutputConnectorPropertiesEditionPartForm.this, null,
    ...
    protected Composite createToAddressText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.toAddress,
                EsbMessages.RouterMediatorTargetOutputConnectorPropertiesEditionPart_ToAddressLabel);
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterMediatorTargetOutputConnectorPropertiesEditionPart#initCommentMediators(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterMediatorTargetOutputConnectorPropertiesEditionPart#addFilterCommentMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterMediatorTargetOutputConnectorPropertiesEditionPart#addBusinessFilterCommentMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterMediatorTargetOutputConnectorPropertiesEditionPart#isContainedInCommentMediatorsTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterMediatorTargetOutputConnectorPropertiesEditionPart#setSoapAction(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterMediatorTargetOutputConnectorPropertiesEditionPart#setToAddress(String
     *      newValue)
     * 
     */
