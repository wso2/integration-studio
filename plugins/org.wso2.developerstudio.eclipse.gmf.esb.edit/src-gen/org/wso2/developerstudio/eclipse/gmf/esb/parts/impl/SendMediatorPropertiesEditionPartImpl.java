 ...
 * 
 */
public class SendMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, SendMediatorPropertiesEditionPart {
    ...
    protected Composite createSkipSerializationCheckbox(Composite parent) {
        ...
        skipSerialization.setText(getDescription(EsbViewsRepository.SendMediator.Properties.skipSerialization,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SendMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SendMediator.Properties.skipSerialization, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEndPointAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.SendMediator.Properties.endPoint,
                EsbMessages.SendMediatorPropertiesEditionPart_EndPointLabel);
        ...
        this.endPoint.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SendMediator.Properties.endPoint, EsbViewsRepository.SWT_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SendMediatorPropertiesEditionPartImpl.this,
    ...
    protected void moveEndPoint(EObject element, int oldIndex, int newIndex) {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                SendMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.SendMediator.Properties.endPoint,
    ...
    protected Composite createReceivingSequenceTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.SendMediator.Properties.receivingSequenceType,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.SendMediator.Properties.receivingSequenceType, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createBuildMessageBeforeSendingCheckbox(Composite parent) {
        ...
        buildMessageBeforeSending
                .setText(getDescription(EsbViewsRepository.SendMediator.Properties.buildMessageBeforeSending,
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.SendMediator.Properties.description,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SendMediator.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.SendMediator.Properties.commentsList,
                EsbMessages.SendMediatorPropertiesEditionPart_CommentsListLabel));
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
             ...
             */
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "SendMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SendMediatorPropertiesEditionPartImpl.this,
                            EsbViewsRepository.SendMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.SendMediator.Properties.reverse,
                EsbMessages.SendMediatorPropertiesEditionPart_ReverseLabel));
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SendMediatorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.SendMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SendMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SendMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SendMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
