...
public class InboundEndpointTemplateUtils extends TemplateUtil{
	private static InboundEndpointTemplateUtils instance;
	
	protected Bundle getBundle() {
		return Platform.getBundle(Activator.PLUGIN_ID);
	}
	
	public static InboundEndpointTemplateUtils getInstance(){
		if (instance==null){
			instance=new InboundEndpointTemplateUtils();
		}
		return instance;
	}
}
