 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ConditionalRouterMediatorImpl#isContinueAfterRoute
 * <em>Continue After Route</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ConditionalRouterMediatorImpl#getConditionalRouteBranches
 * <em>Conditional Route Branches</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ConditionalRouterMediatorImpl#getInputConnector <em>Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ConditionalRouterMediatorImpl#getOutputConnector <em>Output
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ConditionalRouterMediatorImpl#getAdditionalOutputConnector
 * <em>Additional Output Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ConditionalRouterMediatorImpl#getMediatorFlow <em>Mediator
 * Flow</em>}</li>
 * </ul>
 *
 * @generated
...
public class ConditionalRouterMediatorImpl extends MediatorImpl implements ConditionalRouterMediator {
    ...
    /**
     * The cached value of the '{@link #getConditionalRouteBranches() <em>Conditional Route Branches</em>}' containment
     * reference list.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getAdditionalOutputConnector() <em>Additional Output Connector</em>}'
    ...
    public void setContinueAfterRoute(boolean newContinueAfterRoute) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__CONTINUE_AFTER_ROUTE, oldContinueAfterRoute,
                    continueAfterRoute));
    }
    ...
    public EList<ConditionalRouteBranch> getConditionalRouteBranches() {
        if (conditionalRouteBranches == null) {
            conditionalRouteBranches = new EObjectContainmentEList<ConditionalRouteBranch>(ConditionalRouteBranch.class,
                    this, EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__CONDITIONAL_ROUTE_BRANCHES);
        }
    ...
    public NotificationChain basicSetInputConnector(ConditionalRouterMediatorInputConnector newInputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__INPUT_CONNECTOR, oldInputConnector, newInputConnector);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newInputConnector != inputConnector) {
            ...
            if (inputConnector != null)
                msgs = ((InternalEObject) inputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__INPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__INPUT_CONNECTOR, newInputConnector, newInputConnector));
    }
    ...
    public NotificationChain basicSetOutputConnector(ConditionalRouterMediatorOutputConnector newOutputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__OUTPUT_CONNECTOR, oldOutputConnector, newOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOutputConnector != outputConnector) {
            ...
            if (outputConnector != null)
                msgs = ((InternalEObject) outputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__OUTPUT_CONNECTOR, newOutputConnector, newOutputConnector));
    }
    ...
    public NotificationChain basicSetAdditionalOutputConnector(
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__ADDITIONAL_OUTPUT_CONNECTOR, oldAdditionalOutputConnector,
                    newAdditionalOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setAdditionalOutputConnector(
        ...
        if (newAdditionalOutputConnector != additionalOutputConnector) {
            ...
            if (additionalOutputConnector != null)
                msgs = ((InternalEObject) additionalOutputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__ADDITIONAL_OUTPUT_CONNECTOR,
                        null, msgs);
            if (newAdditionalOutputConnector != null)
                msgs = ((InternalEObject) newAdditionalOutputConnector).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__ADDITIONAL_OUTPUT_CONNECTOR,
                        null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__ADDITIONAL_OUTPUT_CONNECTOR, newAdditionalOutputConnector,
                    newAdditionalOutputConnector));
    }
    ...
    public NotificationChain basicSetMediatorFlow(MediatorFlow newMediatorFlow, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__MEDIATOR_FLOW, oldMediatorFlow, newMediatorFlow);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newMediatorFlow != mediatorFlow) {
            ...
            if (mediatorFlow != null)
                msgs = ((InternalEObject) mediatorFlow).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__MEDIATOR_FLOW, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CONDITIONAL_ROUTER_MEDIATOR__MEDIATOR_FLOW,
