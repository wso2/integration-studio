 ...
 * 
 */
public class InboundEndpointSequenceInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, InboundEndpointSequenceInputConnectorPropertiesEditionPart {
     ...
     * 
     */
    public InboundEndpointSequenceInputConnectorPropertiesEditionPartImpl(
    ...
    public void createControls(Composite view) {
        CompositionSequence inboundEndpointSequenceInputConnectorStep = new BindingCompositionSequence(
    ...
    protected Composite createPropertiesGroup(Composite parent) {
        ...
        propertiesGroup
                .setText(EsbMessages.InboundEndpointSequenceInputConnectorPropertiesEditionPart_PropertiesGroupLabel);
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.InboundEndpointSequenceInputConnector.Properties.incomingLinks,
                EsbMessages.InboundEndpointSequenceInputConnectorPropertiesEditionPart_IncomingLinksLabel);
        ...
        this.incomingLinks.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.InboundEndpointSequenceInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            InboundEndpointSequenceInputConnectorPropertiesEditionPartImpl.this,
                            EsbViewsRepository.InboundEndpointSequenceInputConnector.Properties.incomingLinks,
    ...
    protected void moveIncomingLinks(EObject element, int oldIndex, int newIndex) {
        propertiesEditionComponent.firePropertiesChanged(
                new PropertiesEditionEvent(InboundEndpointSequenceInputConnectorPropertiesEditionPartImpl.this,
                        EsbViewsRepository.InboundEndpointSequenceInputConnector.Properties.incomingLinks,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.InboundEndpointSequenceInputConnectorPropertiesEditionPart#addFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.InboundEndpointSequenceInputConnectorPropertiesEditionPart#addBusinessFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.InboundEndpointSequenceInputConnectorPropertiesEditionPart#isContainedInIncomingLinksTable(EObject
     *      element)
     * 
     */
