...
import org.wso2.integrationstudio.datamapper.diagram.expressions.DataMapperOCLFactory;
...
import org.wso2.integrationstudio.datamapper.impl.InNodeImpl;

/**
 * @generated
 */
public class DataMapperBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected DataMapperBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(DataMapperVisualIDRegistry.getVisualID((View) view));
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public boolean canCreateDataMapperLink_4001(OutNode container, OutNode source, InNode target) {
