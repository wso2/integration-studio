...
import org.wso2.integrationstudio.eclipse.gmf.esb.parts.MessageProcessorParameterPropertiesEditionPart;
 ...
 * 
 */
public class MessageProcessorParameterPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, MessageProcessorParameterPropertiesEditionPart {
	 ...
	 */
	public MessageProcessorParameterPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public MessageProcessorParameterPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(EsbMessages.MessageProcessorParameterPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createParameterNameText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							MessageProcessorParameterPropertiesEditionPartForm.this,
							EsbViewsRepository.MessageProcessorParameter.Properties.parameterName,
		...
		parameterName.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorParameterPropertiesEditionPartForm.this, EsbViewsRepository.MessageProcessorParameter.Properties.parameterName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, parameterName.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessorParameter.Properties.parameterName, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createParameterValueText(FormToolkit widgetFactory, Composite parent) {
		...
		parameterValue.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							MessageProcessorParameterPropertiesEditionPartForm.this,
							EsbViewsRepository.MessageProcessorParameter.Properties.parameterValue,
		...
		parameterValue.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorParameterPropertiesEditionPartForm.this, EsbViewsRepository.MessageProcessorParameter.Properties.parameterValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, parameterValue.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessorParameter.Properties.parameterValue, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.MessageProcessorParameterPropertiesEditionPart#getParameterName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.MessageProcessorParameterPropertiesEditionPart#setParameterName(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.MessageProcessorParameterPropertiesEditionPart#getParameterValue()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.MessageProcessorParameterPropertiesEditionPart#setParameterValue(String newValue)
	 * 
	 */
