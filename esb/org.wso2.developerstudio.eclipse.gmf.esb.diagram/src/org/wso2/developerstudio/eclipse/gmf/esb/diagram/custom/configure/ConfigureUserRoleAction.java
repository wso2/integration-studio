...
public class ConfigureUserRoleAction extends ConfigureEsbNodeAction{

	public ConfigureUserRoleAction(IWorkbenchPart part) {
		super(part);
		setId("configure-proxy-service-action-id");
		setText("Add User Roles...");
		setToolTipText("Add User Roles");
	...
	protected void doRun(IProgressMonitor progressMonitor) {
		...
		Dialog AddUserRoleDialog = new AddUserRoleDialog(shell,(ProxyService) selectedObj);
		AddUserRoleDialog.setBlockOnOpen(true);
		AddUserRoleDialog.open();
