...
public class WizardFileSystemResourceExportPage extends WizardExportResourcesCustomPage implements Listener {
	// widgets
	 ...
	 */
	protected WizardFileSystemResourceExportPage(String name, IStructuredSelection selection) {
	 ...
	 *            the selection
	 */
	public WizardFileSystemResourceExportPage(IStructuredSelection selection) {
	...
	/**
	 * Create the button for checking if we should ask if we are going to overwrite
	 * existing files.
	 * 
	 * @param optionsGroup
	 * @param font
	...
	public boolean finish() {
		...
		return executeExportOperation(
				new FileSystemExportOperation(null, resourcesToExport, getDestinationValue(), this));
	}
	...
	/**
	 * Hook method for saving widget values for restoration by the next instance of
	 * this class.
	 */
	@Override
