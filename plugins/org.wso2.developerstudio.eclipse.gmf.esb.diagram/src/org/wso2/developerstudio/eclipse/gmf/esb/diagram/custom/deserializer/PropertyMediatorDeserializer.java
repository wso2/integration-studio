...
public class PropertyMediatorDeserializer extends AbstractEsbNodeDeserializer<AbstractMediator, PropertyMediator> {
    ...
    public PropertyMediator createNode(IGraphicalEditPart part, AbstractMediator mediator) {
        ...
        Assert.isTrue(mediator instanceof org.apache.synapse.mediators.builtin.PropertyMediator,
        ...
        org.wso2.developerstudio.eclipse.gmf.esb.PropertyMediator VisualPropertyMediator = (org.wso2.developerstudio.eclipse.gmf.esb.PropertyMediator) DeserializerUtils
