...
public class DBLookupMediatorDeserializer extends AbstractDBMediatorDeserializer {
    ...
    public DBLookupMediator createNode(IGraphicalEditPart part, AbstractMediator mediator) {

        Assert.isTrue(mediator instanceof org.apache.synapse.mediators.db.DBLookupMediator,
        ...
        DBLookupMediator visualDBLookupMediator = (DBLookupMediator) DeserializerUtils.createNode(part,
