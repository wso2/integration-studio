 ...
 * 
 */
public class MediatorSequencePropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, MediatorSequencePropertiesEditionPart {
    ...
    protected Composite createAnonymousCheckbox(Composite parent) {
        ...
        anonymous.setText(getDescription(EsbViewsRepository.MediatorSequence.Properties.anonymous,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MediatorSequencePropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MediatorSequence.Properties.anonymous, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSequenceNameText(Composite parent) {
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(MediatorSequencePropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MediatorSequence.Properties.sequenceName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMediatorsAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.MediatorSequence.Properties.mediators,
        ...
        this.mediators.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.MediatorSequence.Properties.mediators, EsbViewsRepository.SWT_KIND));
    ...
    protected void moveMediators(EObject element, int oldIndex, int newIndex) {
        propertiesEditionComponent
                .firePropertiesChanged(new PropertiesEditionEvent(MediatorSequencePropertiesEditionPartImpl.this,
    ...
    protected Composite createOnErrorFlatComboViewer(Composite parent) {
        ...
        onError = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
                .isRequired(EsbViewsRepository.MediatorSequence.Properties.onError, EsbViewsRepository.SWT_KIND));
        ...
        onError.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                propertiesEditionComponent.firePropertiesChanged(
                        new PropertiesEditionEvent(MediatorSequencePropertiesEditionPartImpl.this,
                                EsbViewsRepository.MediatorSequence.Properties.onError, PropertiesEditionEvent.CHANGE,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MediatorSequence.Properties.onError, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MediatorSequence.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
