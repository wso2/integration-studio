...
public class EEFXpathValidator {

    public static boolean isValidNamespace(Shell activeShell, Map<String, String> namespaceMap, String prefix,
            String uri) {
    ...
    public static boolean isValidXpathSyntax(String string) {
        /*
         * get-property('GET_PROXY_PROPERTIES_RETURN_SEQ') xpath expression is valid. But following logic doesn't
         * recognize it.
         * Hence following logic is commented out by reopening TOOLS-1814.
         */
