 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfFilterMediatorOutputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnSource(
			FilterMediatorOutputConnectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(FilterMediatorOutputConnectorEditPart) sourceEditPart,
				targetEditPart);
	}
