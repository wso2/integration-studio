...
package org.wso2.integrationstudio.carbonserver44microei43.register.product.servers;
...
import org.wso2.integrationstudio.carbonserver44microei43.ServerProperties;
import org.wso2.integrationstudio.carbonserver44microei43.monitor.EmbeddedServerConfigurationUtil;
import org.wso2.integrationstudio.carbonserver44microei43.util.CarbonServer44eiUtils;
...
public class MicroIntegratorInstance {
    ...
    private void setupServer() {
        ...
        IRuntimeType runtimeType430 = ServerCore.findRuntimeType(ServerConstants.WSO2_MI_430_RUNTIME);
        IServerType serverType430 = ServerCore.findServerType(ServerConstants.WSO2_MI_430_SERVER_TYPE);
        ...
        try {
            ...
            for (IServer tempServers : availableServers) {
                if ((tempServers.getServerType().equals(serverType430) && tempServers.getName()
        ...
        try {
            if (!isServerExists) {
                ...
                IRuntimeWorkingCopy runtime = runtimeType430.createRuntime("org.wso2.micro.integrator.runtime43",
                        progressMonitor);
                ...
                server = serverType430.createServer("org.wso2.micro.integrator.server43", null, microIntegratorRuntime,
                        progressMonitor);
