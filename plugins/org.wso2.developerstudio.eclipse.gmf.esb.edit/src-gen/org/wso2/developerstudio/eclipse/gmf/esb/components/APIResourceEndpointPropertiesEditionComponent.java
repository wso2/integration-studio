...
public class APIResourceEndpointPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public APIResourceEndpointPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject aPIResourceEndpoint, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        aPIResourceEndpoint.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.endPointName))
                basePart.setEndPointName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        aPIResourceEndpoint.getEndPointName()));
            ...
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.properties_)) {
                propertiesSettings = new ReferencesTableSettings(aPIResourceEndpoint,
            ...
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.addressingVersion)) {
                basePart.initAddressingVersion(
                        EEFUtils.choiceOfValues(aPIResourceEndpoint,
                                EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingVersion()),
                        aPIResourceEndpoint.getAddressingVersion());
            }
            ...
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.timeOutDuration))
                basePart.setTimeOutDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        aPIResourceEndpoint.getTimeOutDuration()));
            ...
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.timeOutAction)) {
                basePart.initTimeOutAction(
                        ...
                        aPIResourceEndpoint.getTimeOutAction());
            }
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.retryErrorCodes))
                basePart.setRetryErrorCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        aPIResourceEndpoint.getRetryErrorCodes()));
            ...
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.retryCount))
                basePart.setRetryCount(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        aPIResourceEndpoint.getRetryCount()));
            ...
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.retryDelay)) {
                basePart.setRetryDelay(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        aPIResourceEndpoint.getRetryDelay()));
            }
            ...
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.suspendErrorCodes))
                basePart.setSuspendErrorCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        aPIResourceEndpoint.getSuspendErrorCodes()));
            ...
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.suspendInitialDuration))
                basePart.setSuspendInitialDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        aPIResourceEndpoint.getSuspendInitialDuration()));
            ...
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.suspendMaximumDuration)) {
                basePart.setSuspendMaximumDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        aPIResourceEndpoint.getSuspendMaximumDuration()));
            }
            ...
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.suspendProgressionFactor))
                basePart.setSuspendProgressionFactor(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        aPIResourceEndpoint.getSuspendProgressionFactor()));

            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.format)) {
                basePart.initFormat(
                        EEFUtils.choiceOfValues(aPIResourceEndpoint, EsbPackage.eINSTANCE.getAbstractEndPoint_Format()),
                        aPIResourceEndpoint.getFormat());
            }
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.optimize)) {
                basePart.initOptimize(
                        ...
                        aPIResourceEndpoint.getOptimize());
            }
            if (isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.templateParameters)) {
                templateParametersSettings = new ReferencesTableSettings(aPIResourceEndpoint,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.APIResourceEndpoint.Properties.description == event.getAffectedEditor()) {
            aPIResourceEndpoint.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.APIResourceEndpoint.Properties.endPointName == event.getAffectedEditor()) {
            aPIResourceEndpoint.setEndPointName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.APIResourceEndpoint.Properties.timeOutDuration == event.getAffectedEditor()) {
            aPIResourceEndpoint.setTimeOutDuration((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getEndPoint_EndPointName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.endPointName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_ReliableMessagingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.reliableMessagingEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SecurityEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.securityEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.addressingEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingVersion().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.addressingVersion))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingSeparateListener().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.addressingSeparateListener))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.timeOutDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.timeOutAction))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryErrorCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.retryErrorCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryCount().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.retryCount)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryDelay().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.retryDelay)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendErrorCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.suspendErrorCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendInitialDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.suspendInitialDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendMaximumDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.suspendMaximumDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendProgressionFactor().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.suspendProgressionFactor)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_Format().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.format))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_Optimize().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.optimize))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TemplateParameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.templateParameters))
                basePart.updateTemplateParameters();
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_StatisticsEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.statisticsEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TraceEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResourceEndpoint.Properties.traceEnabled))
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.APIResourceEndpoint.Properties.reliableMessagingEnabled == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.APIResourceEndpoint.Properties.addressingSeparateListener == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                ...
                if (EsbViewsRepository.APIResourceEndpoint.Properties.suspendInitialDuration == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.APIResourceEndpoint.Properties.suspendMaximumDuration == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.APIResourceEndpoint.Properties.suspendProgressionFactor == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
