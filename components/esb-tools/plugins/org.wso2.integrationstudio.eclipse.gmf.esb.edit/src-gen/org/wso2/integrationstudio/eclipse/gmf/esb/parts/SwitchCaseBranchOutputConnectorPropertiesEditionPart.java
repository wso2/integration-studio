 ...
 * 
 */
public interface SwitchCaseBranchOutputConnectorPropertiesEditionPart {
	...
	/**
	 * @return the caseRegex
	 * 
	 */
	public String getCaseRegex();

	/**
	 * Defines a new caseRegex
	 * @param newValue the new caseRegex to set
	 * 
	 */
