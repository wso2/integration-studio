 ...
 * 
 */
public class ProxyInSequenceInputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ProxyInSequenceInputConnectorPropertiesEditionPart {
     ...
     */
    public ProxyInSequenceInputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        CompositionSequence proxyInSequenceInputConnectorStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        proxyInSequenceInputConnectorStep.addStep(EsbViewsRepository.ProxyInSequenceInputConnector.Properties.class)
    ...
    protected Composite createIncomingLinksReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.incomingLinks = new ReferencesTable(
                getDescription(EsbViewsRepository.ProxyInSequenceInputConnector.Properties.incomingLinks,
                        EsbMessages.ProxyInSequenceInputConnectorPropertiesEditionPart_IncomingLinksLabel),
        ...
        this.incomingLinks.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyInSequenceInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyInSequenceInputConnectorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ProxyInSequenceInputConnector.Properties.incomingLinks,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyInSequenceInputConnectorPropertiesEditionPart#addFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyInSequenceInputConnectorPropertiesEditionPart#addBusinessFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ProxyInSequenceInputConnectorPropertiesEditionPart#isContainedInIncomingLinksTable(EObject
     *      element)
     * 
     */
