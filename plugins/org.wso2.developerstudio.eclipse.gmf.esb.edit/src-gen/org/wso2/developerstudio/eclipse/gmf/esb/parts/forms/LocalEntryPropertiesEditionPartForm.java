 ...
 * 
 */
public class LocalEntryPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, LocalEntryPropertiesEditionPart {
     ...
     */
    public LocalEntryPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.LocalEntry.Properties.description,
                EsbMessages.LocalEntryPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(LocalEntryPropertiesEditionPartForm.this,
                                    EsbViewsRepository.LocalEntry.Properties.description, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LocalEntryPropertiesEditionPartForm.this,
                            EsbViewsRepository.LocalEntry.Properties.description, PropertiesEditionEvent.FOCUS_CHANGED,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LocalEntryPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LocalEntry.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.LocalEntry.Properties.commentsList,
                        EsbMessages.LocalEntryPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "LocalEntry", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LocalEntryPropertiesEditionPartForm.this,
                            EsbViewsRepository.LocalEntry.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createEntryNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.LocalEntry.Properties.entryName,
                EsbMessages.LocalEntryPropertiesEditionPart_EntryNameLabel);
        ...
        entryName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(LocalEntryPropertiesEditionPartForm.this,
                                    EsbViewsRepository.LocalEntry.Properties.entryName, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, entryName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LocalEntryPropertiesEditionPartForm.this,
                            EsbViewsRepository.LocalEntry.Properties.entryName, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, entryName.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LocalEntry.Properties.entryName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createLocalEntryTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.LocalEntry.Properties.localEntryType,
                EsbMessages.LocalEntryPropertiesEditionPart_LocalEntryTypeLabel);
        ...
        localEntryType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LocalEntryPropertiesEditionPartForm.this,
                            EsbViewsRepository.LocalEntry.Properties.localEntryType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getLocalEntryType()));
            }

        });
        localEntryType.setID(EsbViewsRepository.LocalEntry.Properties.localEntryType);
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LocalEntry.Properties.localEntryType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueLiteralText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.LocalEntry.Properties.valueLiteral,
                EsbMessages.LocalEntryPropertiesEditionPart_ValueLiteralLabel);
        ...
        valueLiteral.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LocalEntryPropertiesEditionPartForm.this,
                            EsbViewsRepository.LocalEntry.Properties.valueLiteral, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, valueLiteral.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LocalEntryPropertiesEditionPartForm.this,
                            EsbViewsRepository.LocalEntry.Properties.valueLiteral, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LocalEntry.Properties.valueLiteral, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueXMLText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.LocalEntry.Properties.valueXML,
                EsbMessages.LocalEntryPropertiesEditionPart_ValueXMLLabel);
        ...
        valueXML.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LocalEntryPropertiesEditionPartForm.this, EsbViewsRepository.LocalEntry.Properties.valueXML,
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                LocalEntryPropertiesEditionPartForm.this,
                                EsbViewsRepository.LocalEntry.Properties.valueXML, PropertiesEditionEvent.COMMIT,
                                PropertiesEditionEvent.SET, null, valueXML.getText()));
                }
            }
        });
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.LocalEntry.Properties.valueXML, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueURLText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.LocalEntry.Properties.valueURL,
                EsbMessages.LocalEntryPropertiesEditionPart_ValueURLLabel);
        ...
        valueURL.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LocalEntryPropertiesEditionPartForm.this, EsbViewsRepository.LocalEntry.Properties.valueURL,
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                LocalEntryPropertiesEditionPartForm.this,
                                EsbViewsRepository.LocalEntry.Properties.valueURL, PropertiesEditionEvent.COMMIT,
                                PropertiesEditionEvent.SET, null, valueURL.getText()));
                }
            }
        });
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.LocalEntry.Properties.valueURL, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LocalEntryPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LocalEntryPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LocalEntryPropertiesEditionPart#initLocalEntryType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LocalEntryPropertiesEditionPart#setLocalEntryType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LocalEntryPropertiesEditionPart#setValueLiteral(String
     *      newValue)
     * 
     */
