...
public class PropertyMediatorOutputConnectorPropertiesEditionProvider extends PropertiesEditingProviderImpl {
    ...
    public boolean provides(PropertiesEditingContext editingContext, String part) {
        return (editingContext.getEObject() instanceof PropertyMediatorOutputConnector)
                && (PropertyMediatorOutputConnectorPropertiesEditionComponent.BASE_PART.equals(part));
    }
    ...
    public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext,
        ...
        if (editingContext.getEObject() instanceof PropertyMediatorOutputConnector) {
            return new PropertyMediatorOutputConnectorPropertiesEditionComponent(editingContext,
