...
public class ForEachTargetPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ForEachTargetPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject forEachTarget,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ForEachTarget.Properties.sequenceType)) {
                basePart.initSequenceType(
                        EEFUtils.choiceOfValues(forEachTarget,
                                EsbPackage.eINSTANCE.getAbstractCommonTarget_SequenceType()),
                        forEachTarget.getSequenceType());
            }
            if (isAccessible(EsbViewsRepository.ForEachTarget.Properties.sequence)) {
                // init part
                sequenceSettings = new EObjectFlatComboSettings(forEachTarget,
            ...
            if (isAccessible(EsbViewsRepository.ForEachTarget.Properties.endpointType)) {
                basePart.initEndpointType(
                        ...
                        forEachTarget.getEndpointType());
            }
            if (isAccessible(EsbViewsRepository.ForEachTarget.Properties.soapAction))
                basePart.setSoapAction(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, forEachTarget.getSoapAction()));

            if (isAccessible(EsbViewsRepository.ForEachTarget.Properties.toAddress))
                basePart.setToAddress(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, forEachTarget.getToAddress()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ForEachTarget.Properties.soapAction == event.getAffectedEditor()) {
            forEachTarget.setSoapAction((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.ForEachTarget.Properties.toAddress == event.getAffectedEditor()) {
            forEachTarget.setToAddress((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractCommonTarget_SequenceType().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.ForEachTarget.Properties.sequenceType))
            ...
            if (EsbPackage.eINSTANCE.getAbstractCommonTarget_Sequence().equals(msg.getFeature()) && basePart != null
                    && isAccessible(EsbViewsRepository.ForEachTarget.Properties.sequence))
            ...
            if (EsbPackage.eINSTANCE.getAbstractCommonTarget_EndpointType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ForEachTarget.Properties.endpointType))
                basePart.setEndpointType((TargetEndpointType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getForEachTarget_SoapAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ForEachTarget.Properties.soapAction)) {
            ...
            if (EsbPackage.eINSTANCE.getForEachTarget_ToAddress().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ForEachTarget.Properties.toAddress)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getAbstractCommonTarget_Sequence(),
                EsbPackage.eINSTANCE.getAbstractCommonTarget_EndpointType(),
                EsbPackage.eINSTANCE.getForEachTarget_SoapAction(), EsbPackage.eINSTANCE.getForEachTarget_ToAddress());
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.ForEachTarget.Properties.soapAction == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getForEachTarget_SoapAction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getForEachTarget_SoapAction().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ForEachTarget.Properties.toAddress == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getForEachTarget_ToAddress().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getForEachTarget_ToAddress().getEAttributeType(), newValue);
                }
