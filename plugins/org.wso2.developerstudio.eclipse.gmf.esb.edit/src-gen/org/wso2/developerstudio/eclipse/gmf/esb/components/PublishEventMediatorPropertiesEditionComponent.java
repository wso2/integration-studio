...
public class PublishEventMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public PublishEventMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject publishEventMediator, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.PublishEventMediator.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        publishEventMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.PublishEventMediator.Properties.streamName))
                basePart.setStreamName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        publishEventMediator.getStreamName()));

            if (isAccessible(EsbViewsRepository.PublishEventMediator.Properties.streamVersion))
                basePart.setStreamVersion(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        publishEventMediator.getStreamVersion()));

            if (isAccessible(EsbViewsRepository.PublishEventMediator.Properties.eventSink))
                basePart.setEventSink(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        publishEventMediator.getEventSink()));

            if (isAccessible(EsbViewsRepository.PublishEventMediator.Properties.metaAttributes)) {
                metaAttributesSettings = new ReferencesTableSettings(publishEventMediator,
            ...
            if (isAccessible(EsbViewsRepository.PublishEventMediator.Properties.correlationAttributes)) {
                correlationAttributesSettings = new ReferencesTableSettings(publishEventMediator,
            ...
            if (isAccessible(EsbViewsRepository.PublishEventMediator.Properties.payloadAttributes)) {
                payloadAttributesSettings = new ReferencesTableSettings(publishEventMediator,
            ...
            if (isAccessible(EsbViewsRepository.PublishEventMediator.Properties.arbitraryAttributes)) {
                arbitraryAttributesSettings = new ReferencesTableSettings(publishEventMediator,
            ...
            if (isAccessible(EsbViewsRepository.PublishEventMediator.Properties.asyncTimeout))
                basePart.setAsyncTimeout(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        publishEventMediator.getAsyncTimeout()));
                ...
                basePart.addFilterToMetaAttributes(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof PublishEventMediatorAttribute);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.PublishEventMediator.Properties.description == event.getAffectedEditor()) {
            publishEventMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.PublishEventMediator.Properties.streamName == event.getAffectedEditor()) {
            publishEventMediator.setStreamName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.PublishEventMediator.Properties.streamVersion == event.getAffectedEditor()) {
            publishEventMediator.setStreamVersion((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.PublishEventMediator.Properties.eventSink == event.getAffectedEditor()) {
            publishEventMediator.setEventSink((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.PublishEventMediator.Properties.metaAttributes == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, metaAttributesSettings, editingContext.getAdapterFactory());
        ...
        if (EsbViewsRepository.PublishEventMediator.Properties.correlationAttributes == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, correlationAttributesSettings, editingContext.getAdapterFactory());
                PropertiesEditingProvider provider = (PropertiesEditingProvider) editingContext.getAdapterFactory()
                        .adapt(semanticObject, PropertiesEditingProvider.class);
                if (provider != null) {
                    PropertiesEditingPolicy policy = provider.getPolicy(context);
                ...
                correlationAttributesSettings.move(event.getNewIndex(),
                        (PublishEventMediatorAttribute) event.getNewValue());
            }
        }
        if (EsbViewsRepository.PublishEventMediator.Properties.payloadAttributes == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, payloadAttributesSettings, editingContext.getAdapterFactory());
                PropertiesEditingProvider provider = (PropertiesEditingProvider) editingContext.getAdapterFactory()
                        .adapt(semanticObject, PropertiesEditingProvider.class);
                if (provider != null) {
                    PropertiesEditingPolicy policy = provider.getPolicy(context);
                ...
                payloadAttributesSettings.move(event.getNewIndex(),
                        (PublishEventMediatorAttribute) event.getNewValue());
            }
        }
        if (EsbViewsRepository.PublishEventMediator.Properties.arbitraryAttributes == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, arbitraryAttributesSettings, editingContext.getAdapterFactory());
                PropertiesEditingProvider provider = (PropertiesEditingProvider) editingContext.getAdapterFactory()
                        .adapt(semanticObject, PropertiesEditingProvider.class);
                if (provider != null) {
                    PropertiesEditingPolicy policy = provider.getPolicy(context);
                ...
                arbitraryAttributesSettings.move(event.getNewIndex(),
                        (PublishEventMediatorAttribute) event.getNewValue());
            }
        }
        ...
        if (EsbViewsRepository.PublishEventMediator.Properties.asyncTimeout == event.getAffectedEditor()) {
            publishEventMediator.setAsyncTimeout((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.PublishEventMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PublishEventMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PublishEventMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getPublishEventMediator_StreamName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PublishEventMediator.Properties.streamName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getPublishEventMediator_StreamVersion().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PublishEventMediator.Properties.streamVersion)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getPublishEventMediator_EventSink().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PublishEventMediator.Properties.eventSink)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getPublishEventMediator_MetaAttributes().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.PublishEventMediator.Properties.metaAttributes))
                basePart.updateMetaAttributes();
            if (EsbPackage.eINSTANCE.getPublishEventMediator_CorrelationAttributes().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.PublishEventMediator.Properties.correlationAttributes))
                basePart.updateCorrelationAttributes();
            if (EsbPackage.eINSTANCE.getPublishEventMediator_PayloadAttributes().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.PublishEventMediator.Properties.payloadAttributes))
                basePart.updatePayloadAttributes();
            if (EsbPackage.eINSTANCE.getPublishEventMediator_ArbitraryAttributes().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.PublishEventMediator.Properties.arbitraryAttributes))
                basePart.updateArbitraryAttributes();
            if (EsbPackage.eINSTANCE.getPublishEventMediator_Async().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PublishEventMediator.Properties.async))
                basePart.setAsync((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getPublishEventMediator_AsyncTimeout().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PublishEventMediator.Properties.asyncTimeout)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getPublishEventMediator_StreamName(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.PublishEventMediator.Properties.streamName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPublishEventMediator_StreamName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPublishEventMediator_StreamName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PublishEventMediator.Properties.streamVersion == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPublishEventMediator_StreamVersion().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPublishEventMediator_StreamVersion().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PublishEventMediator.Properties.eventSink == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPublishEventMediator_EventSink().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPublishEventMediator_EventSink().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PublishEventMediator.Properties.async == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPublishEventMediator_Async().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPublishEventMediator_Async().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PublishEventMediator.Properties.asyncTimeout == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPublishEventMediator_AsyncTimeout().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPublishEventMediator_AsyncTimeout().getEAttributeType(), newValue);
                }
