 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.BAMMediatorImpl#getInputConnector <em>Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.BAMMediatorImpl#getOutputConnector <em>Output
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.BAMMediatorImpl#getServerProfile <em>Server
 * Profile</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.BAMMediatorImpl#getStreamName <em>Stream Name</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.BAMMediatorImpl#getStreamVersion <em>Stream
 * Version</em>}</li>
 * </ul>
 *
 * @generated
...
public class BAMMediatorImpl extends MediatorImpl implements BAMMediator {
    ...
    public NotificationChain basicSetInputConnector(BAMMediatorInputConnector newInputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.BAM_MEDIATOR__INPUT_CONNECTOR, oldInputConnector, newInputConnector);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newInputConnector != inputConnector) {
            ...
            if (inputConnector != null)
                msgs = ((InternalEObject) inputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.BAM_MEDIATOR__INPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.BAM_MEDIATOR__INPUT_CONNECTOR,
    ...
    public NotificationChain basicSetOutputConnector(BAMMediatorOutputConnector newOutputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.BAM_MEDIATOR__OUTPUT_CONNECTOR, oldOutputConnector, newOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOutputConnector != outputConnector) {
            ...
            if (outputConnector != null)
                msgs = ((InternalEObject) outputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.BAM_MEDIATOR__OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.BAM_MEDIATOR__OUTPUT_CONNECTOR,
    ...
    public void setServerProfile(String newServerProfile) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.BAM_MEDIATOR__SERVER_PROFILE,
                    oldServerProfile, serverProfile));
    }
    ...
    public void setStreamName(String newStreamName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.BAM_MEDIATOR__STREAM_NAME, oldStreamName,
                    streamName));
    }
    ...
    public void setStreamVersion(String newStreamVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.BAM_MEDIATOR__STREAM_VERSION,
    ...
    public boolean eIsSet(int featureID) {
        ...
        case EsbPackage.BAM_MEDIATOR__SERVER_PROFILE:
            return SERVER_PROFILE_EDEFAULT == null ? serverProfile != null
                    : !SERVER_PROFILE_EDEFAULT.equals(serverProfile);
        case EsbPackage.BAM_MEDIATOR__STREAM_NAME:
