...
public class BAMMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public BAMMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject bAMMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.BAMMediator.Properties.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, bAMMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.BAMMediator.Properties.serverProfile))
                basePart.setServerProfile(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        bAMMediator.getServerProfile()));

            if (isAccessible(EsbViewsRepository.BAMMediator.Properties.streamName))
                basePart.setStreamName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, bAMMediator.getStreamName()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.BAMMediator.Properties.description == event.getAffectedEditor()) {
            bAMMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.BAMMediator.Properties.serverProfile == event.getAffectedEditor()) {
            bAMMediator.setServerProfile((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.BAMMediator.Properties.streamName == event.getAffectedEditor()) {
            bAMMediator.setStreamName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.BAMMediator.Properties.streamVersion == event.getAffectedEditor()) {
            bAMMediator.setStreamVersion((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.BAMMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.BAMMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.BAMMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getBAMMediator_ServerProfile().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.BAMMediator.Properties.serverProfile)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getBAMMediator_StreamName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.BAMMediator.Properties.streamName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getBAMMediator_StreamVersion().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.BAMMediator.Properties.streamVersion)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getBAMMediator_ServerProfile(),
                EsbPackage.eINSTANCE.getBAMMediator_StreamName(), EsbPackage.eINSTANCE.getBAMMediator_StreamVersion());
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.BAMMediator.Properties.serverProfile == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getBAMMediator_ServerProfile().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getBAMMediator_ServerProfile().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.BAMMediator.Properties.streamName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getBAMMediator_StreamName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getBAMMediator_StreamName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.BAMMediator.Properties.streamVersion == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getBAMMediator_StreamVersion().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getBAMMediator_StreamVersion().getEAttributeType(), newValue);
                }
