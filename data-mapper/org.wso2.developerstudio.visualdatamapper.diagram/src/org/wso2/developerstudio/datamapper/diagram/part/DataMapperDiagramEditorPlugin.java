...
public class DataMapperDiagramEditorPlugin extends AbstractUIPlugin {
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.ERROR, DataMapperDiagramEditorPlugin.ID, IStatus.OK, error, throwable));
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.INFO, DataMapperDiagramEditorPlugin.ID, IStatus.OK, message, throwable));
