...
public class DefaultProjectTemplateManager extends AbstractDefaultProjectTemplateManager implements IProjectTemplateManager {
	
	public boolean executeSelectedProjectTemplate(WSO2PluginSampleExt element, String projectName) {
		return super.executeSelectedProjectTemplate(element, projectName);
	}
