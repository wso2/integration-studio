...
public class ThrottlePolicyConfigurationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ThrottlePolicyConfigurationPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject throttlePolicyConfiguration, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ThrottlePolicyConfiguration.Properties.policyType)) {
                basePart.initPolicyType(
                        EEFUtils.choiceOfValues(throttlePolicyConfiguration,
                                EsbPackage.eINSTANCE.getThrottlePolicyConfiguration_PolicyType()),
                        throttlePolicyConfiguration.getPolicyType());
            }
            if (isAccessible(EsbViewsRepository.ThrottlePolicyConfiguration.Properties.maxConcurrentAccessCount)) {
                basePart.setMaxConcurrentAccessCount(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        throttlePolicyConfiguration.getMaxConcurrentAccessCount()));
            }

            if (isAccessible(EsbViewsRepository.ThrottlePolicyConfiguration.Properties.policyEntries)) {
                policyEntriesSettings = new ReferencesTableSettings(throttlePolicyConfiguration,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ThrottlePolicyConfiguration.Properties.maxConcurrentAccessCount == event
                .getAffectedEditor()) {
            throttlePolicyConfiguration.setMaxConcurrentAccessCount(
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getThrottlePolicyConfiguration_PolicyType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ThrottlePolicyConfiguration.Properties.policyType))
                basePart.setPolicyType((ThrottlePolicyType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getThrottlePolicyConfiguration_MaxConcurrentAccessCount().equals(msg.getFeature())
            ...
            if (EsbPackage.eINSTANCE.getThrottlePolicyConfiguration_PolicyEntries().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.ThrottlePolicyConfiguration.Properties.policyEntries))
                ...
                if (EsbViewsRepository.ThrottlePolicyConfiguration.Properties.policyType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getThrottlePolicyConfiguration_PolicyType().getEAttributeType(),
                                (String) newValue);
                    }
                ...
                if (EsbViewsRepository.ThrottlePolicyConfiguration.Properties.maxConcurrentAccessCount == event
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getThrottlePolicyConfiguration_MaxConcurrentAccessCount().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getThrottlePolicyConfiguration_MaxConcurrentAccessCount().getEAttributeType(), newValue);
                }
