 ...
 * 
 */
public class LoadBalanceEndPointPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, LoadBalanceEndPointPropertiesEditionPart {
     ...
     */
    public LoadBalanceEndPointPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = loadBalanceEndPointStep
                .addStep(EsbViewsRepository.LoadBalanceEndPoint.Properties.class);
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.LoadBalanceEndPoint.Properties.description,
                EsbMessages.LoadBalanceEndPointPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(LoadBalanceEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.LoadBalanceEndPoint.Properties.description,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LoadBalanceEndPointPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.commentsList,
                        EsbMessages.LoadBalanceEndPointPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(),
                        "LoadBalanceEndPoint", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(LoadBalanceEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.LoadBalanceEndPoint.Properties.commentsList,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createEndPointNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.LoadBalanceEndPoint.Properties.endPointName,
                EsbMessages.LoadBalanceEndPointPropertiesEditionPart_EndPointNameLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.LoadBalanceEndPoint.Properties.endPointName, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAnonymousCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        anonymous = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.anonymous,
                        EsbMessages.LoadBalanceEndPointPropertiesEditionPart_AnonymousLabel),
                SWT.CHECK);
        anonymous.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LoadBalanceEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.LoadBalanceEndPoint.Properties.anonymous, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.anonymous, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInLineCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        inLine = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.inLine,
                        EsbMessages.LoadBalanceEndPointPropertiesEditionPart_InLineLabel),
                SWT.CHECK);
        inLine.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LoadBalanceEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.LoadBalanceEndPoint.Properties.inLine, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.inLine, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        duplicate = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.duplicate,
                        EsbMessages.LoadBalanceEndPointPropertiesEditionPart_DuplicateLabel),
                SWT.CHECK);
        duplicate.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LoadBalanceEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.LoadBalanceEndPoint.Properties.duplicate, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.duplicate, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.properties = new ReferencesTable(
                getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.properties_,
                        EsbMessages.LoadBalanceEndPointPropertiesEditionPart_PropertiesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(LoadBalanceEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.LoadBalanceEndPoint.Properties.properties_,
        ...
        this.properties.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.properties_, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createReversedCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        reversed = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.reversed,
                        EsbMessages.LoadBalanceEndPointPropertiesEditionPart_ReversedLabel),
                SWT.CHECK);
        reversed.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LoadBalanceEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.LoadBalanceEndPoint.Properties.reversed, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.reversed, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createChildrenTableComposition(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        this.children = new ReferencesTable(
                getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.children,
                        EsbMessages.LoadBalanceEndPointPropertiesEditionPart_ChildrenLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(LoadBalanceEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.LoadBalanceEndPoint.Properties.children,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
                        children.refresh();
                    }
        ...
        this.children.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.children, EsbViewsRepository.FORM_KIND));
        ...
        this.children.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LoadBalanceEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.LoadBalanceEndPoint.Properties.children, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.LoadBalanceEndPoint.Properties.name,
                EsbMessages.LoadBalanceEndPointPropertiesEditionPart_NameLabel);
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                LoadBalanceEndPointPropertiesEditionPartForm.this,
                                EsbViewsRepository.LoadBalanceEndPoint.Properties.name, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.name, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFailoverCheckbox(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        failover = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.failover,
                        EsbMessages.LoadBalanceEndPointPropertiesEditionPart_FailoverLabel),
                SWT.CHECK);
        failover.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LoadBalanceEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.LoadBalanceEndPoint.Properties.failover, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new Boolean(failover.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.failover, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPolicyText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.LoadBalanceEndPoint.Properties.policy,
                EsbMessages.LoadBalanceEndPointPropertiesEditionPart_PolicyLabel);
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                LoadBalanceEndPointPropertiesEditionPartForm.this,
                                EsbViewsRepository.LoadBalanceEndPoint.Properties.policy, PropertiesEditionEvent.COMMIT,
                                PropertiesEditionEvent.SET, null, policy.getText()));
                }
            }
        });
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.policy, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutputConnectorTableComposition(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        this.outputConnector = new ReferencesTable(
                getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.outputConnector,
                        EsbMessages.LoadBalanceEndPointPropertiesEditionPart_OutputConnectorLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(LoadBalanceEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.LoadBalanceEndPoint.Properties.outputConnector,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.outputConnector.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.outputConnector, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createSessionTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        ...
        createDescription(filterSessionSubPropertiesGroup,
                EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionType,
                EsbMessages.LoadBalanceEndPointPropertiesEditionPart_SessionTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(LoadBalanceEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionType,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getSessionType()));
            }

        });
        sessionType.setID(EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionType);
        FormUtils.createHelpButton(widgetFactory, filterSessionSubPropertiesGroup,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionType,
    ...
    protected Composite createAlgorithmText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.LoadBalanceEndPoint.Properties.algorithm,
                EsbMessages.LoadBalanceEndPointPropertiesEditionPart_AlgorithmLabel);
        ...
        algorithm.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LoadBalanceEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.LoadBalanceEndPoint.Properties.algorithm, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, algorithm.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(LoadBalanceEndPointPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.algorithm, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSessionTimeoutText(FormToolkit widgetFactory, Composite parent) {
        ...
        createDescription(filterSessionSubPropertiesGroup,
                ...
                EsbMessages.LoadBalanceEndPointPropertiesEditionPart_SessionTimeoutLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, filterSessionSubPropertiesGroup,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionTimeout, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createBuildMessageCheckbox(FormToolkit widgetFactory, Composite parent) {
        buildMessage = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.buildMessage,
                        EsbMessages.LoadBalanceEndPointPropertiesEditionPart_BuildMessageLabel),
                SWT.CHECK);
        buildMessage.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(LoadBalanceEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.LoadBalanceEndPoint.Properties.buildMessage,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(buildMessage.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.LoadBalanceEndPoint.Properties.buildMessage, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createMembersTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.members = new ReferencesTable(
                getDescription(EsbViewsRepository.LoadBalanceEndPoint.Properties.members,
                        EsbMessages.LoadBalanceEndPointPropertiesEditionPart_MembersLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(LoadBalanceEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.LoadBalanceEndPoint.Properties.members,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
                        members.refresh();
                    }
        ...
        this.members.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.LoadBalanceEndPoint.Properties.members, EsbViewsRepository.FORM_KIND));
        ...
        this.members.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            LoadBalanceEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.LoadBalanceEndPoint.Properties.members, PropertiesEditionEvent.CHANGE,
                            PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#setEndPointName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#setAnonymous(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#setInLine(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#setDuplicate(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#initProperties(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#addFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#addBusinessFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#isContainedInPropertiesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#setReversed(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#initChildren(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#addFilterChildren(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#addBusinessFilterChildren(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#isContainedInChildrenTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#setName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#setFailover(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#setPolicy(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#initOutputConnector(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#addFilterOutputConnector(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#addBusinessFilterOutputConnector(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#isContainedInOutputConnectorTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#initSessionType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#setSessionType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#setAlgorithm(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#setSessionTimeout(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#setBuildMessage(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#initMembers(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#addFilterMembers(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#addBusinessFilterMembers(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.LoadBalanceEndPointPropertiesEditionPart#isContainedInMembersTable(EObject
     *      element)
     * 
     */
