 ...
 * 
 */
public class InboundEndpointOnErrorSequenceInputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, InboundEndpointOnErrorSequenceInputConnectorPropertiesEditionPart {
     ...
     */
    public InboundEndpointOnErrorSequenceInputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        CompositionSequence inboundEndpointOnErrorSequenceInputConnectorStep = new BindingCompositionSequence(
    ...
    protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        propertiesSection.setText(
                EsbMessages.InboundEndpointOnErrorSequenceInputConnectorPropertiesEditionPart_PropertiesGroupLabel);
    ...
    protected Composite createIncomingLinksReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.incomingLinks = new ReferencesTable(getDescription(
                EsbViewsRepository.InboundEndpointOnErrorSequenceInputConnector.Properties.incomingLinks,
                EsbMessages.InboundEndpointOnErrorSequenceInputConnectorPropertiesEditionPart_IncomingLinksLabel),
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            InboundEndpointOnErrorSequenceInputConnectorPropertiesEditionPartForm.this,
                            EsbViewsRepository.InboundEndpointOnErrorSequenceInputConnector.Properties.incomingLinks,
    ...
    protected void moveIncomingLinks(EObject element, int oldIndex, int newIndex) {
        propertiesEditionComponent.firePropertiesChanged(
                new PropertiesEditionEvent(InboundEndpointOnErrorSequenceInputConnectorPropertiesEditionPartForm.this,
                        EsbViewsRepository.InboundEndpointOnErrorSequenceInputConnector.Properties.incomingLinks,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.InboundEndpointOnErrorSequenceInputConnectorPropertiesEditionPart#addFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.InboundEndpointOnErrorSequenceInputConnectorPropertiesEditionPart#addBusinessFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.InboundEndpointOnErrorSequenceInputConnectorPropertiesEditionPart#isContainedInIncomingLinksTable(EObject
     *      element)
     * 
     */
