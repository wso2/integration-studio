 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RouterTargetContainerImpl#getMediatorFlow <em>Mediator
 * Flow</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RouterTargetContainerImpl#isBreakAfterRoute <em>Break After
 * Route</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RouterTargetContainerImpl#getRouteExpression <em>Route
 * Expression</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RouterTargetContainerImpl#getRoutePattern <em>Route
 * Pattern</em>}</li>
...
public class RouterTargetContainerImpl extends EsbNodeImpl implements RouterTargetContainer {
    ...
    public NotificationChain basicSetMediatorFlow(MediatorFlow newMediatorFlow, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.ROUTER_TARGET_CONTAINER__MEDIATOR_FLOW, oldMediatorFlow, newMediatorFlow);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newMediatorFlow != mediatorFlow) {
            ...
            if (mediatorFlow != null)
                msgs = ((InternalEObject) mediatorFlow).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.ROUTER_TARGET_CONTAINER__MEDIATOR_FLOW, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.ROUTER_TARGET_CONTAINER__MEDIATOR_FLOW,
    ...
    public void setBreakAfterRoute(boolean newBreakAfterRoute) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.ROUTER_TARGET_CONTAINER__BREAK_AFTER_ROUTE,
    ...
    public NotificationChain basicSetRouteExpression(NamespacedProperty newRouteExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.ROUTER_TARGET_CONTAINER__ROUTE_EXPRESSION, oldRouteExpression, newRouteExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setRouteExpression(NamespacedProperty newRouteExpression) {
        if (newRouteExpression != routeExpression) {
            ...
            if (routeExpression != null)
                msgs = ((InternalEObject) routeExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.ROUTER_TARGET_CONTAINER__ROUTE_EXPRESSION, null, msgs);
            if (newRouteExpression != null)
                msgs = ((InternalEObject) newRouteExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.ROUTER_TARGET_CONTAINER__ROUTE_EXPRESSION, null, msgs);
            msgs = basicSetRouteExpression(newRouteExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.ROUTER_TARGET_CONTAINER__ROUTE_EXPRESSION,
                    newRouteExpression, newRouteExpression));
    }
    ...
    public void setRoutePattern(String newRoutePattern) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.ROUTER_TARGET_CONTAINER__ROUTE_PATTERN,
    ...
    public NotificationChain basicSetTarget(RouterTarget newTarget, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.ROUTER_TARGET_CONTAINER__TARGET, oldTarget, newTarget);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newTarget != target) {
            ...
            if (target != null)
                msgs = ((InternalEObject) target).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.ROUTER_TARGET_CONTAINER__TARGET, null, msgs);
            if (newTarget != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.ROUTER_TARGET_CONTAINER__TARGET, newTarget,
                    newTarget));
    }
