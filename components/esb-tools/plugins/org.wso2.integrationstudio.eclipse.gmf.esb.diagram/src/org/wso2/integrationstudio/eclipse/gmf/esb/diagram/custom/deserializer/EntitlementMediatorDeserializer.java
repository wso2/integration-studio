...
public class EntitlementMediatorDeserializer
    ...
    public EntitlementMediator createNode(IGraphicalEditPart part, AbstractMediator mediator)
        ...
        Assert.isTrue(mediator instanceof EntitlementMediatorExt,
        ...
        EntitlementMediator visualEntitlementMediator = (EntitlementMediator) DeserializerUtils.createNode(part,
        ...
        if (entitlementMediator.getCallbackClass() != null) {
            ...
            if (callbackClass != null && !callbackClass.equals("")) {
                if (callbackClass.equalsIgnoreCase(UT)) {
                    executeSetValueCommand(ENTITLEMENT_MEDIATOR__CALLBACK_HANDLER, EntitlementCallbackHandler.UT);
                } else if (callbackClass.equalsIgnoreCase(SAML)) {
                    executeSetValueCommand(ENTITLEMENT_MEDIATOR__CALLBACK_HANDLER, EntitlementCallbackHandler.SAML);
                } else if (callbackClass.equalsIgnoreCase(KERBEROS)) {
                    executeSetValueCommand(ENTITLEMENT_MEDIATOR__CALLBACK_HANDLER, EntitlementCallbackHandler.KERBEROS);
                } else if (callbackClass.equalsIgnoreCase(X509)) {
                    executeSetValueCommand(ENTITLEMENT_MEDIATOR__CALLBACK_HANDLER, EntitlementCallbackHandler.X509);
                } else {
                    executeSetValueCommand(ENTITLEMENT_MEDIATOR__CALLBACK_HANDLER, EntitlementCallbackHandler.CUSTOM);
                    executeSetValueCommand(ENTITLEMENT_MEDIATOR__CALLBACK_CLASS_NAME,
                            entitlementMediator.getCallbackClass());
        ...
        if (entitlementMediator.getClient() != null) {
            ...
            if (clientType != null && !clientType.equals("")) {
                if (clientType.equalsIgnoreCase(BASIC_AUTH)) {
                    ...
                    executeSetValueCommand(ENTITLEMENT_MEDIATOR__ENTITLEMENT_CLIENT_TYPE, EntitlementClientType.THRIFT);
                    ...
                    executeSetValueCommand(ENTITLEMENT_MEDIATOR__ENTITLEMENT_CLIENT_TYPE, EntitlementClientType.SOAP);
        ...
        if (entitlementMediator.getOnRejectMediator() != null) {
            ...
            IGraphicalEditPart compartment = (IGraphicalEditPart) getEditpart(
                    visualEntitlementMediator.getEntitlementContainer().getOnRejectContainer().getMediatorFlow())
                            .getChildren().get(0);
            deserializeSequence(compartment, sequence, visualEntitlementMediator.getOnRejectOutputConnector());
        } else if (entitlementMediator.getOnRejectSeqKey() != null
                && !entitlementMediator.getOnRejectSeqKey().equals("")) {
            executeSetValueCommand(ENTITLEMENT_MEDIATOR__ON_REJECT_SEQUENCE_TYPE,
                    EntitlementSequenceType.REGISTRY_REFERENCE);
        ...
        if (entitlementMediator.getOnAcceptMediator() != null) {
            ...
            IGraphicalEditPart compartment = (IGraphicalEditPart) getEditpart(
                    visualEntitlementMediator.getEntitlementContainer().getOnAcceptContainer().getMediatorFlow())
                            .getChildren().get(0);
            deserializeSequence(compartment, sequence, visualEntitlementMediator.getOnAcceptOutputConnector());
        } else if (entitlementMediator.getOnAcceptSeqKey() != null
                && !entitlementMediator.getOnAcceptSeqKey().equals("")) {
            executeSetValueCommand(ENTITLEMENT_MEDIATOR__ON_ACCEPT_SEQUENCE_TYPE,
                    EntitlementSequenceType.REGISTRY_REFERENCE);
            RegistryKeyProperty regkey = EsbFactory.eINSTANCE.createRegistryKeyProperty();
        ...
        if (entitlementMediator.getAdviceMediator() != null) {
            ...
            IGraphicalEditPart compartment = (IGraphicalEditPart) getEditpart(
                    visualEntitlementMediator.getEntitlementContainer().getAdviceContainer().getMediatorFlow())
                            .getChildren().get(0);
            deserializeSequence(compartment, sequence, visualEntitlementMediator.getAdviceOutputConnector());
        } else if (entitlementMediator.getAdviceSeqKey() != null && !entitlementMediator.getAdviceSeqKey().equals("")) {
            executeSetValueCommand(ENTITLEMENT_MEDIATOR__ADVICE_SEQUENCE_TYPE,
                    EntitlementSequenceType.REGISTRY_REFERENCE);
            RegistryKeyProperty regkey = EsbFactory.eINSTANCE.createRegistryKeyProperty();
        ...
        if (entitlementMediator.getObligationsMediator() != null) {
            ...
            IGraphicalEditPart compartment = (IGraphicalEditPart) getEditpart(
                    visualEntitlementMediator.getEntitlementContainer().getObligationsContainer().getMediatorFlow())
                            .getChildren().get(0);
            deserializeSequence(compartment, sequence, visualEntitlementMediator.getObligationsOutputConnector());
        } else if (entitlementMediator.getObligationsSeqKey() != null
                && !entitlementMediator.getObligationsSeqKey().equals("")) {
            executeSetValueCommand(ENTITLEMENT_MEDIATOR__OBLIGATIONS_SEQUENCE_TYPE,
                    EntitlementSequenceType.REGISTRY_REFERENCE);
            RegistryKeyProperty regkey = EsbFactory.eINSTANCE.createRegistryKeyProperty();
