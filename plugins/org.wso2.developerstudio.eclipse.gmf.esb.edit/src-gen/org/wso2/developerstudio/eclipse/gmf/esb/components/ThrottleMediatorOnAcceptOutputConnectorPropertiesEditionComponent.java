 ...
 * 
 */
public class ThrottleMediatorOnAcceptOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public ThrottleMediatorOnAcceptOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject throttleMediatorOnAcceptOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ThrottleMediatorOnAcceptOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(throttleMediatorOnAcceptOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ThrottleMediatorOnAcceptOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
