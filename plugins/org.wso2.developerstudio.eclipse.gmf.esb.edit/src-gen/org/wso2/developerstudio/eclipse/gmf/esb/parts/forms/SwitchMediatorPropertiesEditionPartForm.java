 ...
 * 
 */
public class SwitchMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, SwitchMediatorPropertiesEditionPart {
     ...
     */
    public SwitchMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.SwitchMediator.Properties.description,
                EsbMessages.SwitchMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.SwitchMediator.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SwitchMediatorPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SwitchMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SwitchMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.SwitchMediator.Properties.commentsList,
                        EsbMessages.SwitchMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "SwitchMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SwitchMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.SwitchMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.SwitchMediator.Properties.reverse,
                        EsbMessages.SwitchMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SwitchMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SwitchMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SwitchMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSourceText(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.SwitchMediator.Properties.source,
                EsbMessages.SwitchMediatorPropertiesEditionPart_SourceLabel);
        ...
        source.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SwitchMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SwitchMediator.Properties.source, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, source.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SwitchMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.SwitchMediator.Properties.source, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, source.getText()));
                }
            }
        ...
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SwitchMediator.Properties.source, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createNamespaceText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.SwitchMediator.Properties.namespace,
                EsbMessages.SwitchMediatorPropertiesEditionPart_NamespaceLabel);
        ...
        namespace.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SwitchMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.SwitchMediator.Properties.namespace, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SwitchMediator.Properties.namespace, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createNamespacePrefixText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.SwitchMediator.Properties.namespacePrefix,
                EsbMessages.SwitchMediatorPropertiesEditionPart_NamespacePrefixLabel);
        ...
        namespacePrefix.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SwitchMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.SwitchMediator.Properties.namespacePrefix, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, namespacePrefix.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SwitchMediatorPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SwitchMediator.Properties.namespacePrefix, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCaseBranchesTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.caseBranches = new ReferencesTable(
                getDescription(EsbViewsRepository.SwitchMediator.Properties.caseBranches,
                        EsbMessages.SwitchMediatorPropertiesEditionPart_CaseBranchesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(SwitchMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.SwitchMediator.Properties.caseBranches,
        ...
        this.caseBranches.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SwitchMediator.Properties.caseBranches, EsbViewsRepository.FORM_KIND));
        ...
        this.caseBranches.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SwitchMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.SwitchMediator.Properties.caseBranches, PropertiesEditionEvent.CHANGE,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SwitchMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SwitchMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SwitchMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SwitchMediatorPropertiesEditionPart#setSource(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SwitchMediatorPropertiesEditionPart#setNamespace(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SwitchMediatorPropertiesEditionPart#setNamespacePrefix(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SwitchMediatorPropertiesEditionPart#initCaseBranches(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SwitchMediatorPropertiesEditionPart#addFilterCaseBranches(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SwitchMediatorPropertiesEditionPart#addBusinessFilterCaseBranches(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SwitchMediatorPropertiesEditionPart#isContainedInCaseBranchesTable(EObject
     *      element)
     * 
     */
    ...
    protected Composite createSourceXPathWidget(FormToolkit widgetFactory, final Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.SwitchMediator.Properties.sourceXPath,
                EsbMessages.SwitchMediatorPropertiesEditionPart_SourceXPathLabel);
        widgetFactory.paintBordersFor(parent);
        if (sourceXPath == null) {
        ...
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SwitchMediator.Properties.sourceXPath, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
