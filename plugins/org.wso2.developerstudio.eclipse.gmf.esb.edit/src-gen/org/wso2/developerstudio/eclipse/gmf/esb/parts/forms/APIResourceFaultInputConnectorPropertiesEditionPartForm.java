...
import org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceFaultInputConnectorPropertiesEditionPart;
 ...
 * 
 */
public class APIResourceFaultInputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, APIResourceFaultInputConnectorPropertiesEditionPart {
	 ...
	 */
	public APIResourceFaultInputConnectorPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public APIResourceFaultInputConnectorPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(EsbMessages.APIResourceFaultInputConnectorPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createIncomingLinksReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.incomingLinks = new ReferencesTable(getDescription(EsbViewsRepository.APIResourceFaultInputConnector.Properties.incomingLinks, EsbMessages.APIResourceFaultInputConnectorPropertiesEditionPart_IncomingLinksLabel), new ReferencesTableListener	() {
		...
		this.incomingLinks.setHelpText(propertiesEditionComponent.getHelpContent(EsbViewsRepository.APIResourceFaultInputConnector.Properties.incomingLinks, EsbViewsRepository.FORM_KIND));
		...
		this.incomingLinks.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(APIResourceFaultInputConnectorPropertiesEditionPartForm.this, EsbViewsRepository.APIResourceFaultInputConnector.Properties.incomingLinks, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"incomingLinks", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(APIResourceFaultInputConnectorPropertiesEditionPartForm.this, EsbViewsRepository.APIResourceFaultInputConnector.Properties.incomingLinks,
	...
	protected void moveIncomingLinks(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(APIResourceFaultInputConnectorPropertiesEditionPartForm.this, EsbViewsRepository.APIResourceFaultInputConnector.Properties.incomingLinks, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		incomingLinks.refresh();
	}
	...
	protected void removeFromIncomingLinks(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(APIResourceFaultInputConnectorPropertiesEditionPartForm.this, EsbViewsRepository.APIResourceFaultInputConnector.Properties.incomingLinks, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		incomingLinks.refresh();
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceFaultInputConnectorPropertiesEditionPart#initIncomingLinks(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceFaultInputConnectorPropertiesEditionPart#updateIncomingLinks()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceFaultInputConnectorPropertiesEditionPart#addFilterIncomingLinks(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceFaultInputConnectorPropertiesEditionPart#addBusinessFilterIncomingLinks(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceFaultInputConnectorPropertiesEditionPart#isContainedInIncomingLinksTable(EObject element)
	 * 
	 */
