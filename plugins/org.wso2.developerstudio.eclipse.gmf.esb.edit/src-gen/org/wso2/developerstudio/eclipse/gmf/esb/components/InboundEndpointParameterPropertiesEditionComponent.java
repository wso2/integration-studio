...
import org.wso2.developerstudio.eclipse.gmf.esb.parts.InboundEndpointParameterPropertiesEditionPart;
...
public class InboundEndpointParameterPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public InboundEndpointParameterPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject inboundEndpointParameter, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.InboundEndpointParameter.Properties.name))
                basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        inboundEndpointParameter.getName()));

            if (isAccessible(EsbViewsRepository.InboundEndpointParameter.Properties.value))
                basePart.setValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        inboundEndpointParameter.getValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.InboundEndpointParameter.Properties.name == event.getAffectedEditor()) {
            inboundEndpointParameter.setName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.InboundEndpointParameter.Properties.value == event.getAffectedEditor()) {
            inboundEndpointParameter.setValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getInboundEndpointParameter_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.InboundEndpointParameter.Properties.name)) {
            ...
            if (EsbPackage.eINSTANCE.getInboundEndpointParameter_Value().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.InboundEndpointParameter.Properties.value)) {
                if (msg.getNewValue() != null) {
                ...
                if (EsbViewsRepository.InboundEndpointParameter.Properties.name == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getInboundEndpointParameter_Name().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getInboundEndpointParameter_Name().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.InboundEndpointParameter.Properties.value == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getInboundEndpointParameter_Value().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getInboundEndpointParameter_Value().getEAttributeType(), newValue);
                }
