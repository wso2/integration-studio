...
public class SplitCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater.getSplit_2007SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater.getSplit_2007SemanticChildren((View) getHost().getModel());
