...
public class CalloutMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(EsbViewsRepository.CalloutMediator.Properties.pathToAxis2Repository))
			...
			if (isAccessible(EsbViewsRepository.CalloutMediator.Properties.payloadType)) {
			...
			if (isAccessible(EsbViewsRepository.CalloutMediator.Properties.resultType)) {
			...
			if (isAccessible(EsbViewsRepository.CalloutMediator.Properties.resultContextProperty))
			...
			if (isAccessible(EsbViewsRepository.CalloutMediator.Properties.passHeaders)) {
				basePart.setPassHeaders(calloutMediator.isPassHeaders());
			}
			if (isAccessible(EsbViewsRepository.CalloutMediator.Properties.endpointType)) {
			...
			if (isAccessible(EsbViewsRepository.CalloutMediator.Properties.payloadProperty))
			...
			if (isAccessible(EsbViewsRepository.CalloutMediator.Properties.securityType)) {
			...
			if (isAccessible(EsbViewsRepository.CalloutMediator.Properties.policies)) {
			...
			if (isAccessible(EsbViewsRepository.CalloutMediator.Properties.initAxis2ClientOptions)) {
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.description) {
			return EsbPackage.eINSTANCE.getEsbElement_Description();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.commentsList) {
			return EsbPackage.eINSTANCE.getEsbElement_CommentsList();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.reverse) {
			return EsbPackage.eINSTANCE.getMediator_Reverse();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.serviceURL) {
			return EsbPackage.eINSTANCE.getCalloutMediator_ServiceURL();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.soapAction) {
			return EsbPackage.eINSTANCE.getCalloutMediator_SoapAction();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.pathToAxis2xml) {
			return EsbPackage.eINSTANCE.getCalloutMediator_PathToAxis2xml();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.pathToAxis2Repository) {
			return EsbPackage.eINSTANCE.getCalloutMediator_PathToAxis2Repository();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.payloadType) {
			return EsbPackage.eINSTANCE.getCalloutMediator_PayloadType();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.resultType) {
			return EsbPackage.eINSTANCE.getCalloutMediator_ResultType();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.resultContextProperty) {
			return EsbPackage.eINSTANCE.getCalloutMediator_ResultContextProperty();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.passHeaders) {
			return EsbPackage.eINSTANCE.getCalloutMediator_PassHeaders();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.endpointType) {
			return EsbPackage.eINSTANCE.getCalloutMediator_EndpointType();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.payloadProperty) {
			return EsbPackage.eINSTANCE.getCalloutMediator_PayloadProperty();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.securityType) {
			return EsbPackage.eINSTANCE.getCalloutMediator_SecurityType();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.policies) {
			return EsbPackage.eINSTANCE.getCalloutMediator_Policies();
		}
		if (editorKey == EsbViewsRepository.CalloutMediator.Properties.initAxis2ClientOptions) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (EsbViewsRepository.CalloutMediator.Properties.description == event.getAffectedEditor()) {
		...
		if (EsbViewsRepository.CalloutMediator.Properties.commentsList == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				calloutMediator.getCommentsList().clear();
				calloutMediator.getCommentsList().addAll(((EList) event.getNewValue()));
			}
		}
		if (EsbViewsRepository.CalloutMediator.Properties.reverse == event.getAffectedEditor()) {
			calloutMediator.setReverse((Boolean)event.getNewValue());
		}
		if (EsbViewsRepository.CalloutMediator.Properties.serviceURL == event.getAffectedEditor()) {
		...
		if (EsbViewsRepository.CalloutMediator.Properties.soapAction == event.getAffectedEditor()) {
		...
		if (EsbViewsRepository.CalloutMediator.Properties.pathToAxis2xml == event.getAffectedEditor()) {
		...
		if (EsbViewsRepository.CalloutMediator.Properties.pathToAxis2Repository == event.getAffectedEditor()) {
		...
		if (EsbViewsRepository.CalloutMediator.Properties.payloadType == event.getAffectedEditor()) {
			calloutMediator.setPayloadType((CalloutPayloadType)event.getNewValue());
		}
		if (EsbViewsRepository.CalloutMediator.Properties.resultType == event.getAffectedEditor()) {
			calloutMediator.setResultType((CalloutResultType)event.getNewValue());
		}
		if (EsbViewsRepository.CalloutMediator.Properties.resultContextProperty == event.getAffectedEditor()) {
		...
		if (EsbViewsRepository.CalloutMediator.Properties.passHeaders == event.getAffectedEditor()) {
			calloutMediator.setPassHeaders((Boolean)event.getNewValue());
		}
		if (EsbViewsRepository.CalloutMediator.Properties.endpointType == event.getAffectedEditor()) {
			calloutMediator.setEndpointType((CalloutEndpointType)event.getNewValue());
		}
		if (EsbViewsRepository.CalloutMediator.Properties.payloadProperty == event.getAffectedEditor()) {
		...
		if (EsbViewsRepository.CalloutMediator.Properties.securityType == event.getAffectedEditor()) {
			calloutMediator.setSecurityType((CalloutSecurityType)event.getNewValue());
		}
		if (EsbViewsRepository.CalloutMediator.Properties.policies == event.getAffectedEditor()) {
			calloutMediator.setPolicies((CalloutSecurityPolicies)event.getNewValue());
		}
		if (EsbViewsRepository.CalloutMediator.Properties.initAxis2ClientOptions == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.CalloutMediator.Properties.description)) {
			...
			if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.CalloutMediator.Properties.commentsList)) {
			...
			if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.CalloutMediator.Properties.reverse))
				basePart.setReverse((Boolean)msg.getNewValue());
			
			if (EsbPackage.eINSTANCE.getCalloutMediator_ServiceURL().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.CalloutMediator.Properties.serviceURL)) {
				if (msg.getNewValue() != null) {
			...
			if (EsbPackage.eINSTANCE.getCalloutMediator_SoapAction().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.CalloutMediator.Properties.soapAction)) {
				if (msg.getNewValue() != null) {
			...
			if (EsbPackage.eINSTANCE.getCalloutMediator_PathToAxis2xml().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.CalloutMediator.Properties.pathToAxis2xml)) {
				if (msg.getNewValue() != null) {
			...
			if (EsbPackage.eINSTANCE.getCalloutMediator_PathToAxis2Repository().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.CalloutMediator.Properties.pathToAxis2Repository)) {
				if (msg.getNewValue() != null) {
			...
			if (EsbPackage.eINSTANCE.getCalloutMediator_PayloadType().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(EsbViewsRepository.CalloutMediator.Properties.payloadType))
				basePart.setPayloadType((CalloutPayloadType)msg.getNewValue());
			
			if (EsbPackage.eINSTANCE.getCalloutMediator_ResultType().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(EsbViewsRepository.CalloutMediator.Properties.resultType))
				basePart.setResultType((CalloutResultType)msg.getNewValue());
			
			if (EsbPackage.eINSTANCE.getCalloutMediator_ResultContextProperty().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.CalloutMediator.Properties.resultContextProperty)) {
				if (msg.getNewValue() != null) {
			...
			if (EsbPackage.eINSTANCE.getCalloutMediator_PassHeaders().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.CalloutMediator.Properties.passHeaders))
				basePart.setPassHeaders((Boolean)msg.getNewValue());
			
			if (EsbPackage.eINSTANCE.getCalloutMediator_EndpointType().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(EsbViewsRepository.CalloutMediator.Properties.endpointType))
				basePart.setEndpointType((CalloutEndpointType)msg.getNewValue());
			
			if (EsbPackage.eINSTANCE.getCalloutMediator_PayloadProperty().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.CalloutMediator.Properties.payloadProperty)) {
				if (msg.getNewValue() != null) {
			...
			if (EsbPackage.eINSTANCE.getCalloutMediator_SecurityType().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(EsbViewsRepository.CalloutMediator.Properties.securityType))
				basePart.setSecurityType((CalloutSecurityType)msg.getNewValue());
			
			if (EsbPackage.eINSTANCE.getCalloutMediator_Policies().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(EsbViewsRepository.CalloutMediator.Properties.policies))
				basePart.setPolicies((CalloutSecurityPolicies)msg.getNewValue());
			
			if (EsbPackage.eINSTANCE.getCalloutMediator_InitAxis2ClientOptions().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.CalloutMediator.Properties.initAxis2ClientOptions))
