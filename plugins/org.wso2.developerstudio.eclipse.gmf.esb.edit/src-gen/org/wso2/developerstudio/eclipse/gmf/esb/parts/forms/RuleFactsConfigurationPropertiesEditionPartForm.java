 ...
 * 
 */
public class RuleFactsConfigurationPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, RuleFactsConfigurationPropertiesEditionPart {
     ...
     */
    public RuleFactsConfigurationPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        ruleFactsConfigurationStep.addStep(EsbViewsRepository.RuleFactsConfiguration.Properties.class)
    ...
    protected Composite createFactsTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.facts = new ReferencesTable(
                getDescription(EsbViewsRepository.RuleFactsConfiguration.Properties.facts,
                        EsbMessages.RuleFactsConfigurationPropertiesEditionPart_FactsLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(RuleFactsConfigurationPropertiesEditionPartForm.this,
                                        EsbViewsRepository.RuleFactsConfiguration.Properties.facts,
        ...
        this.facts.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleFactsConfiguration.Properties.facts, EsbViewsRepository.FORM_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleFactsConfigurationPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleFactsConfiguration.Properties.facts, PropertiesEditionEvent.CHANGE,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleFactsConfigurationPropertiesEditionPart#initFacts(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleFactsConfigurationPropertiesEditionPart#updateFacts()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleFactsConfigurationPropertiesEditionPart#addFilterFacts(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleFactsConfigurationPropertiesEditionPart#addBusinessFilterFacts(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RuleFactsConfigurationPropertiesEditionPart#isContainedInFactsTable(EObject
     *      element)
     * 
     */
