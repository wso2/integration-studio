...
public class DefaultEndPoint2ItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.DefaultEndPointInputConnector_3644 == req
				.getElementType()) {
			return getGEFWrapper(new DefaultEndPointInputConnector2CreateCommand(
					req));
		}
		if (EsbElementTypes.DefaultEndPointOutputConnector_3645 == req
				.getElementType()) {
			return getGEFWrapper(new DefaultEndPointOutputConnector2CreateCommand(
					req));
		}
