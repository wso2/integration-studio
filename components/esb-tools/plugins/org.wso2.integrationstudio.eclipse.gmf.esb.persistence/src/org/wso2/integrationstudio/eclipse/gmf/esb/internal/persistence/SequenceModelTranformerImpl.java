...
public class SequenceModelTranformerImpl implements SequenceModelTransformer {
    ...
    public String designToSource(EsbSequence sequenceModel) throws Exception {
        ...
        OMElement configOM = serializer.serializeConfiguration(transform(sequenceModel));
    ...
    public EsbSequence sourceToDesign(String source, EsbSequence esbServer) throws Exception {
        // TODO Auto-generated method stub
        return null;
    }
     ...
     */
    private SynapseConfiguration transform(EsbSequence sequenceModel) throws Exception {
