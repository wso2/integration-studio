...
public class MessageStorePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public MessageStorePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject messageStore,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.MessageStore.Properties.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, messageStore.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.MessageStore.Properties.storeName))
                basePart.setStoreName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, messageStore.getStoreName()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.storeType)) {
                basePart.initStoreType(
                        EEFUtils.choiceOfValues(messageStore, EsbPackage.eINSTANCE.getMessageStore_StoreType()),
                        messageStore.getStoreType());
            }
            if (isAccessible(EsbViewsRepository.MessageStore.Properties.initialContextFactory))
                basePart.setInitialContextFactory(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getInitialContextFactory()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.providerURL))
                basePart.setProviderURL(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, messageStore.getProviderURL()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.jndiQueueName))
                basePart.setJndiQueueName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getJndiQueueName()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.connectionFactory))
                basePart.setConnectionFactory(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getConnectionFactory()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.userName))
                basePart.setUserName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, messageStore.getUserName()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.password))
                basePart.setPassword(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, messageStore.getPassword()));
            ...
            if (isAccessible(EsbViewsRepository.MessageStore.Properties.jmsSpecVersion)) {
                basePart.initJmsSpecVersion(
                        EEFUtils.choiceOfValues(messageStore, EsbPackage.eINSTANCE.getMessageStore_JmsSpecVersion()),
                        messageStore.getJmsSpecVersion());
            }
            ...
            if (isAccessible(EsbViewsRepository.MessageStore.Properties.providerClass))
                basePart.setProviderClass(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getProviderClass()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.rabbitMQServerHostName))
                basePart.setRabbitMQServerHostName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getRabbitMQServerHostName()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.rabbitMQServerHostPort))
                basePart.setRabbitMQServerHostPort(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getRabbitMQServerHostPort()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.rabbitMQQueueName))
                basePart.setRabbitMQQueueName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getRabbitMQQueueName()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.rabbitMQExchangeName))
                basePart.setRabbitMQExchangeName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getRabbitMQExchangeName()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.routingKey))
                basePart.setRoutingKey(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, messageStore.getRoutingKey()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.rabbitMQUserName))
                basePart.setRabbitMQUserName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getRabbitMQUserName()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.rabbitMQPassword))
                basePart.setRabbitMQPassword(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getRabbitMQPassword()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.virtualHost))
                basePart.setVirtualHost(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, messageStore.getVirtualHost()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.jdbcDatabaseTable))
                basePart.setJdbcDatabaseTable(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getJdbcDatabaseTable()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.jdbcConnectionInformation)) {
                basePart.initJdbcConnectionInformation(
                        EEFUtils.choiceOfValues(messageStore,
                                EsbPackage.eINSTANCE.getMessageStore_JdbcConnectionInformation()),
                        messageStore.getJdbcConnectionInformation());
            }
            if (isAccessible(EsbViewsRepository.MessageStore.Properties.jdbcDriver))
                basePart.setJdbcDriver(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, messageStore.getJdbcDriver()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.jdbcURL))
                basePart.setJdbcURL(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, messageStore.getJdbcURL()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.jdbcUser))
                basePart.setJdbcUser(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, messageStore.getJdbcUser()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.jdbcPassword))
                basePart.setJdbcPassword(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getJdbcPassword()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.jdbcDatasourceName))
                basePart.setJdbcDatasourceName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getJdbcDatasourceName()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.parameters)) {
                parametersSettings = new ReferencesTableSettings(messageStore,
            ...
            if (isAccessible(EsbViewsRepository.MessageStore.Properties.failoverMessageStore))
                basePart.setFailoverMessageStore(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getFailoverMessageStore()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.resequencepolling))
                basePart.setResequencepolling(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getResequencepolling()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceDatabaseTable))
                basePart.setResequenceDatabaseTable(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getResequenceDatabaseTable()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceConnectionInformation)) {
                basePart.initResequenceConnectionInformation(
                        EEFUtils.choiceOfValues(messageStore,
                                EsbPackage.eINSTANCE.getMessageStore_ResequenceConnectionInformation()),
                        messageStore.getResequenceConnectionInformation());
            }
            if (isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceDriver))
                basePart.setResequenceDriver(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getResequenceDriver()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceURL))
                basePart.setResequenceURL(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getResequenceURL()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceUser))
                basePart.setResequenceUser(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getResequenceUser()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.resequencePassword))
                basePart.setResequencePassword(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getResequencePassword()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceDatasourceName))
                basePart.setResequenceDatasourceName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getResequenceDatasourceName()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceXpath))
                basePart.setResequenceXpath(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageStore.getResequenceXpath()));

            if (isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceXpathAttr)) {
                // init part
                resequenceXpathAttrSettings = new EObjectFlatComboSettings(messageStore,
                ...
                basePart.addFilterToParameters(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof MessageStoreParameter);
                    }
            ...
            if (isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceXpathAttr)) {
                basePart.addFilterToResequenceXpathAttr(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof NamespacedProperty);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.MessageStore.Properties.description == event.getAffectedEditor()) {
            messageStore.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.MessageStore.Properties.storeName == event.getAffectedEditor()) {
            messageStore.setStoreName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.MessageStore.Properties.initialContextFactory == event.getAffectedEditor()) {
            messageStore.setInitialContextFactory((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageStore.Properties.providerURL == event.getAffectedEditor()) {
            messageStore.setProviderURL((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageStore.Properties.jndiQueueName == event.getAffectedEditor()) {
            messageStore.setJndiQueueName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageStore.Properties.connectionFactory == event.getAffectedEditor()) {
            messageStore.setConnectionFactory((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageStore.Properties.userName == event.getAffectedEditor()) {
            messageStore.setUserName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageStore.Properties.password == event.getAffectedEditor()) {
            messageStore.setPassword((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.MessageStore.Properties.jdbcDriver == event.getAffectedEditor()) {
            messageStore.setJdbcDriver((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageStore.Properties.jdbcURL == event.getAffectedEditor()) {
            messageStore.setJdbcURL((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageStore.Properties.jdbcUser == event.getAffectedEditor()) {
            messageStore.setJdbcUser((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageStore.Properties.jdbcPassword == event.getAffectedEditor()) {
            messageStore.setJdbcPassword((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageStore.Properties.jdbcDatasourceName == event.getAffectedEditor()) {
            messageStore.setJdbcDatasourceName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.MessageStore.Properties.failoverMessageStore == event.getAffectedEditor()) {
            messageStore.setFailoverMessageStore((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageStore.Properties.resequencepolling == event.getAffectedEditor()) {
            messageStore.setResequencepolling((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.MessageStore.Properties.resequenceDatabaseTable == event.getAffectedEditor()) {
            messageStore.setResequenceDatabaseTable((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_StoreName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.storeName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_StoreType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.storeType))
                basePart.setStoreType((MessageStoreType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getMessageStore_InitialContextFactory().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.initialContextFactory)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_ProviderURL().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.providerURL)) {
                if (msg.getNewValue() != null) {
                    basePart.setProviderURL(
                            EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, msg.getNewValue()));
                } else {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_JndiQueueName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.jndiQueueName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_ConnectionFactory().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.connectionFactory)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_UserName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.userName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_Password().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.password)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_CacheConnection().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.cacheConnection))
                basePart.setCacheConnection((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getMessageStore_JmsSpecVersion().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.jmsSpecVersion))
                basePart.setJmsSpecVersion((JMSSpecVersion) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getMessageStore_EnableCaching().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.enableCaching))
                basePart.setEnableCaching((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getMessageStore_ProviderClass().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.providerClass)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_RabbitMQServerHostName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.rabbitMQServerHostName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_RabbitMQServerHostPort().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.rabbitMQServerHostPort)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_RabbitMQQueueName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.rabbitMQQueueName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_RabbitMQExchangeName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.rabbitMQExchangeName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_RoutingKey().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.routingKey)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_RabbitMQUserName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.rabbitMQUserName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_RabbitMQPassword().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.rabbitMQPassword)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_VirtualHost().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.virtualHost)) {
                if (msg.getNewValue() != null) {
                    basePart.setVirtualHost(
                            EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, msg.getNewValue()));
                } else {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_JdbcDatabaseTable().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.jdbcDatabaseTable)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_JdbcConnectionInformation().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.jdbcConnectionInformation))
                basePart.setJdbcConnectionInformation((JDBCConnectionInformationType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getMessageStore_JdbcDriver().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.jdbcDriver)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_JdbcURL().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.jdbcURL)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_JdbcUser().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.jdbcUser)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_JdbcPassword().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.jdbcPassword)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_JdbcDatasourceName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.jdbcDatasourceName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_Parameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.parameters))
                basePart.updateParameters();
            if (EsbPackage.eINSTANCE.getMessageStore_EnableProducerGuaranteedDelivery().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.enableProducerGuaranteedDelivery))
                basePart.setEnableProducerGuaranteedDelivery((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getMessageStore_FailoverMessageStore().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.failoverMessageStore)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_Resequencepolling().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.resequencepolling)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_ResequenceDatabaseTable().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceDatabaseTable)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_ResequenceConnectionInformation().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceConnectionInformation))
                basePart.setResequenceConnectionInformation((JDBCConnectionInformationType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getMessageStore_ResequenceDriver().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceDriver)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_ResequenceURL().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceURL)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_ResequenceUser().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceUser)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_ResequencePassword().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.resequencePassword)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_ResequenceDatasourceName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceDatasourceName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_ResequenceXpath().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceXpath)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getMessageStore_ResequenceXpathAttr().equals(msg.getFeature()) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageStore.Properties.resequenceXpathAttr))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMessageStore_StoreName(), EsbPackage.eINSTANCE.getMessageStore_StoreType(),
                ...
                EsbPackage.eINSTANCE.getMessageStore_UserName(), EsbPackage.eINSTANCE.getMessageStore_Password(),
                ...
                EsbPackage.eINSTANCE.getMessageStore_JdbcConnectionInformation(),
                EsbPackage.eINSTANCE.getMessageStore_JdbcDriver(), EsbPackage.eINSTANCE.getMessageStore_JdbcURL(),
                EsbPackage.eINSTANCE.getMessageStore_JdbcUser(), EsbPackage.eINSTANCE.getMessageStore_JdbcPassword(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.MessageStore.Properties.storeName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_StoreName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getMessageStore_StoreName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.storeType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_StoreType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getMessageStore_StoreType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.initialContextFactory == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_InitialContextFactory().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_InitialContextFactory().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.providerURL == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_ProviderURL().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getMessageStore_ProviderURL().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.jndiQueueName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_JndiQueueName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_JndiQueueName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.connectionFactory == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_ConnectionFactory().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_ConnectionFactory().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.userName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_UserName().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getMessageStore_UserName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.password == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_Password().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getMessageStore_Password().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.cacheConnection == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_CacheConnection().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_CacheConnection().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.jmsSpecVersion == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_JmsSpecVersion().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_JmsSpecVersion().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.enableCaching == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_EnableCaching().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_EnableCaching().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.providerClass == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_ProviderClass().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_ProviderClass().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.rabbitMQServerHostName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_RabbitMQServerHostName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_RabbitMQServerHostName().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageStore.Properties.rabbitMQServerHostPort == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_RabbitMQServerHostPort().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_RabbitMQServerHostPort().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageStore.Properties.rabbitMQQueueName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_RabbitMQQueueName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_RabbitMQQueueName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.rabbitMQExchangeName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_RabbitMQExchangeName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_RabbitMQExchangeName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.routingKey == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_RoutingKey().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getMessageStore_RoutingKey().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.rabbitMQUserName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_RabbitMQUserName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_RabbitMQUserName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.rabbitMQPassword == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_RabbitMQPassword().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_RabbitMQPassword().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.virtualHost == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_VirtualHost().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getMessageStore_VirtualHost().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.jdbcDatabaseTable == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_JdbcDatabaseTable().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_JdbcDatabaseTable().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.jdbcConnectionInformation == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_JdbcConnectionInformation().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_JdbcConnectionInformation().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageStore.Properties.jdbcDriver == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_JdbcDriver().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getMessageStore_JdbcDriver().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.jdbcURL == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_JdbcURL().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getMessageStore_JdbcURL().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.jdbcUser == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_JdbcUser().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getMessageStore_JdbcUser().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.jdbcPassword == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_JdbcPassword().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_JdbcPassword().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.jdbcDatasourceName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_JdbcDatasourceName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_JdbcDatasourceName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.enableProducerGuaranteedDelivery == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getMessageStore_EnableProducerGuaranteedDelivery().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_EnableProducerGuaranteedDelivery().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.failoverMessageStore == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_FailoverMessageStore().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_FailoverMessageStore().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.resequencepolling == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_Resequencepolling().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_Resequencepolling().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.resequenceDatabaseTable == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_ResequenceDatabaseTable().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_ResequenceDatabaseTable().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageStore.Properties.resequenceConnectionInformation == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getMessageStore_ResequenceConnectionInformation().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_ResequenceConnectionInformation().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.resequenceDriver == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_ResequenceDriver().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_ResequenceDriver().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.resequenceURL == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_ResequenceURL().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_ResequenceURL().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.resequenceUser == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_ResequenceUser().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_ResequenceUser().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.resequencePassword == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_ResequencePassword().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_ResequencePassword().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MessageStore.Properties.resequenceDatasourceName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_ResequenceDatasourceName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_ResequenceDatasourceName().getEAttributeType(),
                ...
                if (EsbViewsRepository.MessageStore.Properties.resequenceXpath == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageStore_ResequenceXpath().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageStore_ResequenceXpath().getEAttributeType(), newValue);
                }
