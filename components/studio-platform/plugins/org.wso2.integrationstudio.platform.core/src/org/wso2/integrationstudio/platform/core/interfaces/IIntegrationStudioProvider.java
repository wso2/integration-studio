...
package org.wso2.integrationstudio.platform.core.interfaces;
...
public interface IIntegrationStudioProvider {
	/**
	 ...
	 * @return
	 */
	public IIntegrationStudioProvider[] getCategories(Map<String, List<String>> filters);
	 ...
	 * @return
	 */
	public IIntegrationStudioElement[] getElements(Map<String, List<String>> filters);
