 ...
 * 
 */
public class ClassMediatorOutputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ClassMediatorOutputConnectorPropertiesEditionPart {
     ...
     */
    public ClassMediatorOutputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        CompositionSequence classMediatorOutputConnectorStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        classMediatorOutputConnectorStep.addStep(EsbViewsRepository.ClassMediatorOutputConnector.Properties.class)
    ...
    protected Composite createCommentMediatorsTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.commentMediators = new ReferencesTable(
                getDescription(EsbViewsRepository.ClassMediatorOutputConnector.Properties.commentMediators,
                        EsbMessages.ClassMediatorOutputConnectorPropertiesEditionPart_CommentMediatorsLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ClassMediatorOutputConnectorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.ClassMediatorOutputConnector.Properties.commentMediators,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ClassMediatorOutputConnectorPropertiesEditionPart#initCommentMediators(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ClassMediatorOutputConnectorPropertiesEditionPart#addFilterCommentMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ClassMediatorOutputConnectorPropertiesEditionPart#addBusinessFilterCommentMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ClassMediatorOutputConnectorPropertiesEditionPart#isContainedInCommentMediatorsTable(EObject
     *      element)
     * 
     */
