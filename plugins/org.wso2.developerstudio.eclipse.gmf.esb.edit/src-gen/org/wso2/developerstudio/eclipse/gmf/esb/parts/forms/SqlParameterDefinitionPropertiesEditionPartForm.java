 ...
 * 
 */
public class SqlParameterDefinitionPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, SqlParameterDefinitionPropertiesEditionPart {
     ...
     */
    public SqlParameterDefinitionPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDataTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.SqlParameterDefinition.Properties.dataType,
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SqlParameterDefinitionPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SqlParameterDefinition.Properties.dataType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.SqlParameterDefinition.Properties.valueType,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.SqlParameterDefinition.Properties.valueType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createValueLiteralText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.SqlParameterDefinition.Properties.valueLiteral,
        ...
        valueLiteral.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SqlParameterDefinitionPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SqlParameterDefinition.Properties.valueLiteral, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
