    ...
    public void notifyChanged(Notification notification) {
        ...
        if (notification.getEventType() == Notification.ADD) {
            if (this.getTargetConnections().size() != 0) {
                ...
                if ((link instanceof AbstractEndpointAdditionalOutputConnector)
                    ...
                    for (int j = 0; j < this.getParent().getChildren().size(); ++j) {
                        if (this.getParent().getChildren().get(j) instanceof AbstractEndpointOutputConnector) {
                            ...
                            collection.add(
                                    ((org.eclipse.gmf.runtime.notation.impl.NodeImpl) ((AbstractEndpointOutputConnector) this
                ...
                if ((sourceOutputConnector != null)
                    ...
                    if (((EsbLinkEditPart) ((AbstractInputConnector) sourceOutputConnector.getParent().getChildren()
                            .get(1)).getTargetConnections().get(0))
                                    .getSource() instanceof AbstractEndpointOutputConnector) {
