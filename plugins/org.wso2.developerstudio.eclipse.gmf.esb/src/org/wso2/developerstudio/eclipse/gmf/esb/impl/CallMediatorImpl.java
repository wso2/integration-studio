 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CallMediatorImpl#getInputConnector <em>Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CallMediatorImpl#getOutputConnector <em>Output
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CallMediatorImpl#getEndpoint <em>Endpoint</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CallMediatorImpl#getEndpointOutputConnector <em>Endpoint
 * Output Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CallMediatorImpl#getMediatorFlow <em>Mediator
 * Flow</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CallMediatorImpl#getEndpointType <em>Endpoint
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CallMediatorImpl#isEnableBlockingCalls <em>Enable Blocking
 * Calls</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CallMediatorImpl#getEndpointRegistrykey <em>Endpoint
 * Registrykey</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CallMediatorImpl#getEndpointXpath <em>Endpoint
 * Xpath</em>}</li>
 * </ul>
 *
 * @generated
...
public class CallMediatorImpl extends MediatorImpl implements CallMediator {
    ...
    public NotificationChain basicSetInputConnector(CallMediatorInputConnector newInputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALL_MEDIATOR__INPUT_CONNECTOR, oldInputConnector, newInputConnector);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newInputConnector != inputConnector) {
            ...
            if (inputConnector != null)
                msgs = ((InternalEObject) inputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALL_MEDIATOR__INPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALL_MEDIATOR__INPUT_CONNECTOR,
    ...
    public NotificationChain basicSetOutputConnector(CallMediatorOutputConnector newOutputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALL_MEDIATOR__OUTPUT_CONNECTOR, oldOutputConnector, newOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOutputConnector != outputConnector) {
            ...
            if (outputConnector != null)
                msgs = ((InternalEObject) outputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALL_MEDIATOR__OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALL_MEDIATOR__OUTPUT_CONNECTOR,
    ...
    public NotificationChain basicSetEndpointOutputConnector(
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALL_MEDIATOR__ENDPOINT_OUTPUT_CONNECTOR, oldEndpointOutputConnector,
        ...
        if (newEndpointOutputConnector != endpointOutputConnector) {
            ...
            if (endpointOutputConnector != null)
                msgs = ((InternalEObject) endpointOutputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALL_MEDIATOR__ENDPOINT_OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALL_MEDIATOR__ENDPOINT_OUTPUT_CONNECTOR,
    ...
    public NotificationChain basicSetMediatorFlow(MediatorFlow newMediatorFlow, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALL_MEDIATOR__MEDIATOR_FLOW, oldMediatorFlow, newMediatorFlow);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newMediatorFlow != mediatorFlow) {
            ...
            if (mediatorFlow != null)
                msgs = ((InternalEObject) mediatorFlow).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALL_MEDIATOR__MEDIATOR_FLOW, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALL_MEDIATOR__MEDIATOR_FLOW,
    ...
    public void setEndpointType(CallMediatorEndpointType newEndpointType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALL_MEDIATOR__ENDPOINT_TYPE,
    ...
    public void setEnableBlockingCalls(boolean newEnableBlockingCalls) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALL_MEDIATOR__ENABLE_BLOCKING_CALLS,
                    oldEnableBlockingCalls, enableBlockingCalls));
    }
    ...
    public NotificationChain basicSetEndpointRegistrykey(RegistryKeyProperty newEndpointRegistrykey,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALL_MEDIATOR__ENDPOINT_REGISTRYKEY, oldEndpointRegistrykey, newEndpointRegistrykey);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setEndpointRegistrykey(RegistryKeyProperty newEndpointRegistrykey) {
        if (newEndpointRegistrykey != endpointRegistrykey) {
            ...
            if (endpointRegistrykey != null)
                msgs = ((InternalEObject) endpointRegistrykey).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALL_MEDIATOR__ENDPOINT_REGISTRYKEY, null, msgs);
            if (newEndpointRegistrykey != null)
                msgs = ((InternalEObject) newEndpointRegistrykey).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALL_MEDIATOR__ENDPOINT_REGISTRYKEY, null, msgs);
            msgs = basicSetEndpointRegistrykey(newEndpointRegistrykey, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALL_MEDIATOR__ENDPOINT_REGISTRYKEY,
                    newEndpointRegistrykey, newEndpointRegistrykey));
    }
    ...
    public NotificationChain basicSetEndpointXpath(NamespacedProperty newEndpointXpath, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALL_MEDIATOR__ENDPOINT_XPATH, oldEndpointXpath, newEndpointXpath);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setEndpointXpath(NamespacedProperty newEndpointXpath) {
        if (newEndpointXpath != endpointXpath) {
            ...
            if (endpointXpath != null)
                msgs = ((InternalEObject) endpointXpath).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALL_MEDIATOR__ENDPOINT_XPATH, null, msgs);
            if (newEndpointXpath != null)
                msgs = ((InternalEObject) newEndpointXpath).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALL_MEDIATOR__ENDPOINT_XPATH, null, msgs);
            msgs = basicSetEndpointXpath(newEndpointXpath, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALL_MEDIATOR__ENDPOINT_XPATH,
                    newEndpointXpath, newEndpointXpath));
    }
