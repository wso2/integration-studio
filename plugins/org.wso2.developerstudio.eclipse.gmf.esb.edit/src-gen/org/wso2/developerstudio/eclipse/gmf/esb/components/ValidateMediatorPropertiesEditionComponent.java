...
public class ValidateMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ValidateMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject validateMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ValidateMediator.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        validateMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.ValidateMediator.Properties.features)) {
                featuresSettings = new ReferencesTableSettings(validateMediator,
            ...
            if (isAccessible(EsbViewsRepository.ValidateMediator.Properties.schemas)) {
                schemasSettings = new ReferencesTableSettings(validateMediator,
            ...
            if (isAccessible(EsbViewsRepository.ValidateMediator.Properties.resources)) {
                resourcesSettings = new ReferencesTableSettings(validateMediator,
                ...
                basePart.addFilterToFeatures(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof ValidateFeature);
                    }
            ...
            if (isAccessible(EsbViewsRepository.ValidateMediator.Properties.resources)) {
                basePart.addFilterToResources(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof ValidateResource);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ValidateMediator.Properties.description == event.getAffectedEditor()) {
            validateMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.ValidateMediator.Properties.schemas == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, schemasSettings, editingContext.getAdapterFactory());
                PropertiesEditingProvider provider = (PropertiesEditingProvider) editingContext.getAdapterFactory()
                        .adapt(semanticObject, PropertiesEditingProvider.class);
                if (provider != null) {
                    PropertiesEditingPolicy policy = provider.getPolicy(context);
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.ValidateMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ValidateMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ValidateMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getValidateMediator_Features().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.ValidateMediator.Properties.features))
                basePart.updateFeatures();
            if (EsbPackage.eINSTANCE.getValidateMediator_Schemas().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.ValidateMediator.Properties.schemas))
                basePart.updateSchemas();
            if (EsbPackage.eINSTANCE.getValidateMediator_Resources().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.ValidateMediator.Properties.resources))
                basePart.updateResources();
            if (EsbPackage.eINSTANCE.getValidateMediator_EnableCacheSchema().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ValidateMediator.Properties.enableCacheSchema))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getValidateMediator_Features(),
                EsbPackage.eINSTANCE.getValidateMediator_Schemas(),
                EsbPackage.eINSTANCE.getValidateMediator_Resources(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.ValidateMediator.Properties.enableCacheSchema == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getValidateMediator_EnableCacheSchema().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getValidateMediator_EnableCacheSchema().getEAttributeType(), newValue);
                }
