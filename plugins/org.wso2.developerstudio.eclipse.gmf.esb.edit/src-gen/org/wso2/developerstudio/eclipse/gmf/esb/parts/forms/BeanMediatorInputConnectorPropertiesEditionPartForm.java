 ...
 * 
 */
public class BeanMediatorInputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, BeanMediatorInputConnectorPropertiesEditionPart {
     ...
     */
    public BeanMediatorInputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createIncomingLinksReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.incomingLinks = new ReferencesTable(
                getDescription(EsbViewsRepository.BeanMediatorInputConnector.Properties.incomingLinks,
        ...
        this.incomingLinks.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.BeanMediatorInputConnector.Properties.incomingLinks, EsbViewsRepository.FORM_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(BeanMediatorInputConnectorPropertiesEditionPartForm.this,
