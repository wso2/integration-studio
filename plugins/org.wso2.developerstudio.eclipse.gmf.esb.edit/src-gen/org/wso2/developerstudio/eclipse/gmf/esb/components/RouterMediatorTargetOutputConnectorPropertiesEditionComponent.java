 ...
 * 
 */
public class RouterMediatorTargetOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public RouterMediatorTargetOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject routerMediatorTargetOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(routerMediatorTargetOutputConnector,
            ...
            if (isAccessible(EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.soapAction))
                basePart.setSoapAction(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        routerMediatorTargetOutputConnector.getSoapAction()));

            if (isAccessible(EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.toAddress))
                basePart.setToAddress(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        routerMediatorTargetOutputConnector.getToAddress()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
        ...
        if (EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.soapAction == event.getAffectedEditor()) {
            routerMediatorTargetOutputConnector.setSoapAction((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.toAddress == event.getAffectedEditor()) {
            routerMediatorTargetOutputConnector.setToAddress((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getOutputConnector_CommentMediators().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.commentMediators))
                basePart.updateCommentMediators();
            if (EsbPackage.eINSTANCE.getRouterMediatorTargetOutputConnector_SoapAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.soapAction)) {
            ...
            if (EsbPackage.eINSTANCE.getRouterMediatorTargetOutputConnector_ToAddress().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.toAddress)) {
                if (msg.getNewValue() != null) {
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.soapAction == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getRouterMediatorTargetOutputConnector_SoapAction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE
                            .getRouterMediatorTargetOutputConnector_SoapAction().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RouterMediatorTargetOutputConnector.Properties.toAddress == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getRouterMediatorTargetOutputConnector_ToAddress().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRouterMediatorTargetOutputConnector_ToAddress().getEAttributeType(),
                            newValue);
                }
