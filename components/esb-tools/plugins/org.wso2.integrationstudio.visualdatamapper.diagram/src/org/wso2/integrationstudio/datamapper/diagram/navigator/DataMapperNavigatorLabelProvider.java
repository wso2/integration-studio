...
import org.wso2.integrationstudio.datamapper.diagram.providers.DataMapperParserProvider;
...
public class DataMapperNavigatorLabelProvider extends LabelProvider
	...
	*/
	private String getAND_2026Text(View view) {
		org.wso2.integrationstudio.datamapper.AND domainModelElement = (org.wso2.integrationstudio.datamapper.AND) view
				.getElement();
		if (domainModelElement != null) {
			return String.valueOf(domainModelElement.isSerialized());
		} else {
	...
	*/
	private String getOR_2027Text(View view) {
		org.wso2.integrationstudio.datamapper.OR domainModelElement = (org.wso2.integrationstudio.datamapper.OR) view
				.getElement();
		if (domainModelElement != null) {
			return String.valueOf(domainModelElement.isSerialized());
		} else {
	...
	*/
	private String getNOT_2028Text(View view) {
		org.wso2.integrationstudio.datamapper.NOT domainModelElement = (org.wso2.integrationstudio.datamapper.NOT) view
				.getElement();
		if (domainModelElement != null) {
			return String.valueOf(domainModelElement.isSerialized());
		} else {
