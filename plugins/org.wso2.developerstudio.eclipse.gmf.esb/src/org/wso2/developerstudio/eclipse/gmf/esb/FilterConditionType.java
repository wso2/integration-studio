...
public enum FilterConditionType implements Enumerator {
     ...
     * @ordered
     */
    SOURCE_AND_REGEX(0, "SOURCE_AND_REGEX", "Source and Regular Expression"),
     ...
     * @generated
     */
    private static final FilterConditionType[] VALUES_ARRAY = new FilterConditionType[] { SOURCE_AND_REGEX, XPATH, };
    ...
    public static FilterConditionType get(int value) {
        switch (value) {
        case SOURCE_AND_REGEX_VALUE:
            return SOURCE_AND_REGEX;
        case XPATH_VALUE:
            return XPATH;
        }
        return null;
