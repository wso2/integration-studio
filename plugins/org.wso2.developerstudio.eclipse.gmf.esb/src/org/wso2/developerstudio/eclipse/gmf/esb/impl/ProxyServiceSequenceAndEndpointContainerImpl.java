 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceSequenceAndEndpointContainerImpl#getMediatorFlow
    ...
    public NotificationChain basicSetMediatorFlow(MediatorFlow newMediatorFlow, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE_SEQUENCE_AND_ENDPOINT_CONTAINER__MEDIATOR_FLOW, oldMediatorFlow,
                    newMediatorFlow);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setMediatorFlow(MediatorFlow newMediatorFlow) {
        if (newMediatorFlow != mediatorFlow) {
            ...
            if (mediatorFlow != null)
                msgs = ((InternalEObject) mediatorFlow).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - EsbPackage.PROXY_SERVICE_SEQUENCE_AND_ENDPOINT_CONTAINER__MEDIATOR_FLOW, null, msgs);
            if (newMediatorFlow != null)
                msgs = ((InternalEObject) newMediatorFlow).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - EsbPackage.PROXY_SERVICE_SEQUENCE_AND_ENDPOINT_CONTAINER__MEDIATOR_FLOW, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROXY_SERVICE_SEQUENCE_AND_ENDPOINT_CONTAINER__MEDIATOR_FLOW, newMediatorFlow,
                    newMediatorFlow));
    }
