...
public class TaskPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.Task.Properties.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, task.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.Task.Properties.taskName))
                basePart.setTaskName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, task.getTaskName()));

            if (isAccessible(EsbViewsRepository.Task.Properties.taskGroup))
                basePart.setTaskGroup(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, task.getTaskGroup()));

            if (isAccessible(EsbViewsRepository.Task.Properties.triggerType)) {
                basePart.initTriggerType(EEFUtils.choiceOfValues(task, EsbPackage.eINSTANCE.getTask_TriggerType()),
                        task.getTriggerType());
            }
            ...
            if (isAccessible(EsbViewsRepository.Task.Properties.pinnedServers))
                basePart.setPinnedServers(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, task.getPinnedServers()));

            if (isAccessible(EsbViewsRepository.Task.Properties.taskImplementation))
                basePart.setTaskImplementation(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, task.getTaskImplementation()));

            if (isAccessible(EsbViewsRepository.Task.Properties.taskProperties)) {
                taskPropertiesSettings = new ReferencesTableSettings(task,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.Task.Properties.description == event.getAffectedEditor()) {
            task.setDescription((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
        ...
        if (EsbViewsRepository.Task.Properties.taskName == event.getAffectedEditor()) {
            task.setTaskName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.Task.Properties.taskGroup == event.getAffectedEditor()) {
            task.setTaskGroup((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.Task.Properties.cron == event.getAffectedEditor()) {
            task.setCron((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.Task.Properties.pinnedServers == event.getAffectedEditor()) {
            task.setPinnedServers((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.Task.Properties.taskImplementation == event.getAffectedEditor()) {
            task.setTaskImplementation((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.Task.Properties.taskProperties == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, taskPropertiesSettings, editingContext.getAdapterFactory());
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.Task.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Task.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getTask_TaskName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Task.Properties.taskName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getTask_TaskGroup().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Task.Properties.taskGroup)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getTask_TriggerType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.Task.Properties.triggerType))
                basePart.setTriggerType((TaskTriggerType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getTask_Count().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Task.Properties.count)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getTask_Interval().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Task.Properties.interval)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getTask_Cron().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject)
                    && basePart != null && isAccessible(EsbViewsRepository.Task.Properties.cron)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getTask_PinnedServers().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Task.Properties.pinnedServers)) {
                if (msg.getNewValue() != null) {
                    basePart.setPinnedServers(
                            EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, msg.getNewValue()));
                } else {
            ...
            if (EsbPackage.eINSTANCE.getTask_TaskImplementation().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.Task.Properties.taskImplementation)) {
                if (msg.getNewValue() != null) {
                    basePart.setTaskImplementation(
                            EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, msg.getNewValue()));
                } else {
            ...
            if (EsbPackage.eINSTANCE.getTask_TaskProperties().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.Task.Properties.taskProperties))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getTask_TaskName(), EsbPackage.eINSTANCE.getTask_TaskGroup(),
                EsbPackage.eINSTANCE.getTask_TriggerType(), EsbPackage.eINSTANCE.getTask_Count(),
                EsbPackage.eINSTANCE.getTask_Interval(), EsbPackage.eINSTANCE.getTask_Cron(),
                EsbPackage.eINSTANCE.getTask_PinnedServers(), EsbPackage.eINSTANCE.getTask_TaskImplementation(),
                EsbPackage.eINSTANCE.getTask_TaskProperties());
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.Task.Properties.taskName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTask_TaskName().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getTask_TaskName().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.Task.Properties.taskGroup == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTask_TaskGroup().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getTask_TaskGroup().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.Task.Properties.triggerType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTask_TriggerType().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getTask_TriggerType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.Task.Properties.count == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTask_Count().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getTask_Count().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.Task.Properties.interval == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTask_Interval().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getTask_Interval().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.Task.Properties.cron == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTask_Cron().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getTask_Cron().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.Task.Properties.pinnedServers == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTask_PinnedServers().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getTask_PinnedServers().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.Task.Properties.taskImplementation == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTask_TaskImplementation().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getTask_TaskImplementation().getEAttributeType(), newValue);
                }
