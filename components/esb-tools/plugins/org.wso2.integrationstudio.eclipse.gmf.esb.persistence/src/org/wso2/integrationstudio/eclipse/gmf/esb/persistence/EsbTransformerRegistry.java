...
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.APIResourceTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.AddresingEndPointTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.AddressEndPointTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.AggregateMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.BAMMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.BeanMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.BuilderMediatorTransformer;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.CallTemplateMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.CalloutMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.ClassMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.CloneMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.CloudConnectorOperationTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.CommandMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.ConditionalRouterMediatorTransformer;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.DataMapperMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.DefaultEndPointTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.DropMediatorTransformer;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.EntitlementMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.EventMediatorTransformer;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.HTTPEndPointTransformer;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.JsonTransformMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.LoadBalanceEndPointTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.LogMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.LoopBackMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.MessageMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.NamedEndPointTransformer;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.PropertyGroupMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.PropertyMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.ProxyServiceTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.PublishEventMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.RecipientListEndPointTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.RespondMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.RouterMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.RuleMediatorTransformer;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.SequenceTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.SmooksMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.SpringMediatorTransformer;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.TemplateTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.ThrottleMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.TransactionMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.URLReWriterMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.ValidateMediatorTransformer;
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.WSDLEndPointTransformer;
...
import org.wso2.integrationstudio.eclipse.gmf.esb.internal.persistence.custom.MediatorSerializerRegister;
