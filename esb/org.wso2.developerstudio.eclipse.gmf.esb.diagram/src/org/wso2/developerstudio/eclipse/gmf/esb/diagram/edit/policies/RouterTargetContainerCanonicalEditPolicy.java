 ...
 * @generated
 */
public class RouterTargetContainerCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return MediatorFlow15EditPart.VISUAL_ID == EsbVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getRouterTargetContainer_3633SemanticChildren((View) getHost()
						.getModel());
