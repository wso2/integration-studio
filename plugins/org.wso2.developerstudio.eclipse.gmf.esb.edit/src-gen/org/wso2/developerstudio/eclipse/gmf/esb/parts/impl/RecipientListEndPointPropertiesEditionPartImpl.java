 ...
 * 
 */
public class RecipientListEndPointPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, RecipientListEndPointPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RecipientListEndPointPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(RecipientListEndPointPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.RecipientListEndPoint.Properties.description,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.RecipientListEndPoint.Properties.description, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.RecipientListEndPoint.Properties.commentsList,
    ...
    protected Composite createEndPointNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.RecipientListEndPoint.Properties.endPointName, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAnonymousCheckbox(Composite parent) {
        ...
        anonymous.setText(getDescription(EsbViewsRepository.RecipientListEndPoint.Properties.anonymous,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.anonymous, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInLineCheckbox(Composite parent) {
        ...
        inLine.setText(getDescription(EsbViewsRepository.RecipientListEndPoint.Properties.inLine,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.inLine, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(Composite parent) {
        ...
        duplicate.setText(getDescription(EsbViewsRepository.RecipientListEndPoint.Properties.duplicate,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.duplicate, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesAdvancedTableComposition(Composite parent) {
        ...
        this.properties.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.properties_, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createReversedCheckbox(Composite parent) {
        ...
        reversed.setText(getDescription(EsbViewsRepository.RecipientListEndPoint.Properties.reversed,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.reversed, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createChildrenAdvancedTableComposition(Composite parent) {
        ...
        this.children.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.children, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.name, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutputConnectorAdvancedTableComposition(Composite parent) {
        ...
        this.outputConnector.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.outputConnector, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createEndpointTypeEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.RecipientListEndPoint.Properties.endpointType, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createEndpointsValueText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.endpointsValue, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMaxCacheText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RecipientListEndPoint.Properties.maxCache, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
