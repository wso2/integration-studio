...
public class AttributeItemSemanticEditPolicy extends
	...
	public AttributeItemSemanticEditPolicy() {
		super(dataMapper.diagram.providers.DataMapperElementTypes.Attribute_3004);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (dataMapper.diagram.providers.DataMapperElementTypes.InNode_3005 == req.getElementType()) {
			return getGEFWrapper(new dataMapper.diagram.edit.commands.InNodeCreateCommand(req));
		}
		if (dataMapper.diagram.providers.DataMapperElementTypes.OutNode_3006 == req
				.getElementType()) {
			return getGEFWrapper(new dataMapper.diagram.edit.commands.OutNodeCreateCommand(req));
		}
