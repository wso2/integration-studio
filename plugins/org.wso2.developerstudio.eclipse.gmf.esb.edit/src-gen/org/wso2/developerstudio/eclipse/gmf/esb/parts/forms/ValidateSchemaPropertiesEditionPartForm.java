 ...
 * 
 */
public class ValidateSchemaPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ValidateSchemaPropertiesEditionPart {
     ...
     */
    public ValidateSchemaPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createValidateSchemaKeyTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ValidateSchema.Properties.validateSchemaKeyType,
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ValidateSchemaPropertiesEditionPartForm.this,
    ...
    protected Composite createSchemaKeyFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
        createDescription(parent, EsbViewsRepository.ValidateSchema.Properties.schemaKey,
        ...
        schemaKey = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
                .isRequired(EsbViewsRepository.ValidateSchema.Properties.schemaKey, EsbViewsRepository.FORM_KIND));
        ...
        schemaKey.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ValidateSchemaPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ValidateSchema.Properties.schemaKey,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getSchemaKey()));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateSchema.Properties.schemaKey, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
