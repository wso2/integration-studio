...
public class DiagramCustomConstants {
    ...
    public static final String BREAKPOINT_IMAGE_LOCATION = "icons/ico20debug/toggle_breakpoint_red.png";
    public static final String SKIP_POINT_IMAGE_LOCATION = "icons/ico20debug/greyImagealphamask_reduced.gif";
    public static final String VALIDATION_MARK_IMAGE_LOCATION = "icons/validation/error-symbol.png";
    public static final String API_ICON_LOCATION = "icons/api/api_icon.png";
