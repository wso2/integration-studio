 ...
 * 
 */
public class CalloutMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, CalloutMediatorPropertiesEditionPart {
     ...
     */
    public CalloutMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.CalloutMediator.Misc.description,
                EsbMessages.CalloutMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
                ...
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CalloutMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CalloutMediator.Misc.description, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CalloutMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.CalloutMediator.Misc.description, PropertiesEditionEvent.FOCUS_CHANGED,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CalloutMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control descriptionHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CalloutMediator.Misc.description, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.CalloutMediator.Misc.commentsList,
                        EsbMessages.CalloutMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "CalloutMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CalloutMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CalloutMediator.Misc.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.CalloutMediator.Misc.reverse,
                EsbMessages.CalloutMediatorPropertiesEditionPart_ReverseLabel), SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CalloutMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CalloutMediator.Misc.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CalloutMediator.Misc.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPassHeadersCheckbox(FormToolkit widgetFactory, Composite parent) {
        passHeaders = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.CalloutMediator.Misc.passHeaders,
                        EsbMessages.CalloutMediatorPropertiesEditionPart_PassHeadersLabel),
                SWT.CHECK);
        passHeaders.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CalloutMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CalloutMediator.Misc.passHeaders, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, new Boolean(passHeaders.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CalloutMediator.Misc.passHeaders, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createServiceGroup(FormToolkit widgetFactory, final Composite parent) {
        Section serviceSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createEndpointTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control endpointTypeLabel = createDescription(parent, EsbViewsRepository.CalloutMediator.Service.endpointType,
                EsbMessages.CalloutMediatorPropertiesEditionPart_EndpointTypeLabel);
        ...
        endpointType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CalloutMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.CalloutMediator.Service.endpointType, PropertiesEditionEvent.COMMIT,
        ...
        Control endpointTypeHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.CalloutMediator.Service.endpointType, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createSoapActionText(FormToolkit widgetFactory, Composite parent) {
        Control soapActionLabel = createDescription(parent, EsbViewsRepository.CalloutMediator.Service.soapAction,
                EsbMessages.CalloutMediatorPropertiesEditionPart_SoapActionLabel);
        ...
        soapAction.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CalloutMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.CalloutMediator.Service.soapAction, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, soapAction.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CalloutMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.CalloutMediator.Service.soapAction, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control soapActionHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CalloutMediator.Service.soapAction, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPathToAxis2RepositoryText(FormToolkit widgetFactory, Composite parent) {
        Control pathToAxis2RepositoryLabel = createDescription(parent,
                EsbViewsRepository.CalloutMediator.Service.pathToAxis2Repository,
                EsbMessages.CalloutMediatorPropertiesEditionPart_PathToAxis2RepositoryLabel);
        ...
        Control pathToAxis2RepositoryHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CalloutMediator.Service.pathToAxis2Repository, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPathToAxis2xmlText(FormToolkit widgetFactory, Composite parent) {
        Control pathToAxis2xmlLabel = createDescription(parent,
                EsbViewsRepository.CalloutMediator.Service.pathToAxis2xml,
                EsbMessages.CalloutMediatorPropertiesEditionPart_PathToAxis2xmlLabel);
        ...
        pathToAxis2xml.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CalloutMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.CalloutMediator.Service.pathToAxis2xml, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, pathToAxis2xml.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CalloutMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CalloutMediator.Service.pathToAxis2xml,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    pathToAxis2xml.getText()));
                }
            }
        ...
        Control pathToAxis2xmlHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.CalloutMediator.Service.pathToAxis2xml,
    ...
    protected Composite createInitAxis2ClientOptionsCheckbox(FormToolkit widgetFactory, Composite parent) {
        initAxis2ClientOptions = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.CalloutMediator.Service.initAxis2ClientOptions,
                                EsbMessages.CalloutMediatorPropertiesEditionPart_InitAxis2ClientOptionsLabel),
                        SWT.CHECK);
        initAxis2ClientOptions.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CalloutMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CalloutMediator.Service.initAxis2ClientOptions,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(initAxis2ClientOptions.getSelection())));
            }
        ...
        Control initAxis2ClientOptionsHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CalloutMediator.Service.initAxis2ClientOptions,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createServiceURLText(FormToolkit widgetFactory, Composite parent) {
        Control serviceURLLabel = createDescription(parent, EsbViewsRepository.CalloutMediator.Service.serviceURL,
                EsbMessages.CalloutMediatorPropertiesEditionPart_ServiceURLLabel);
        ...
        serviceURL.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CalloutMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.CalloutMediator.Service.serviceURL, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, serviceURL.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CalloutMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.CalloutMediator.Service.serviceURL, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, serviceURL.getText()));
                }
            }
        ...
        Control serviceURLHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CalloutMediator.Service.serviceURL, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPayloadTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control payloadTypeLabel = createDescription(parent, EsbViewsRepository.CalloutMediator.Source.payloadType,
                EsbMessages.CalloutMediatorPropertiesEditionPart_PayloadTypeLabel);
        ...
        payloadType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CalloutMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CalloutMediator.Source.payloadType,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPayloadType()));
            }

        });
        payloadType.setID(EsbViewsRepository.CalloutMediator.Source.payloadType);
        Control payloadTypeHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CalloutMediator.Source.payloadType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPayloadPropertyText(FormToolkit widgetFactory, Composite parent) {
        Control payloadPropertyLabel = createDescription(parent,
                EsbViewsRepository.CalloutMediator.Source.payloadProperty,
                EsbMessages.CalloutMediatorPropertiesEditionPart_PayloadPropertyLabel);
        ...
        payloadProperty.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CalloutMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.CalloutMediator.Source.payloadProperty, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, payloadProperty.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CalloutMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CalloutMediator.Source.payloadProperty,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    payloadProperty.getText()));
                }
            }
        ...
        Control payloadPropertyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.CalloutMediator.Source.payloadProperty,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createResultTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control resultTypeLabel = createDescription(parent, EsbViewsRepository.CalloutMediator.Target.resultType,
                EsbMessages.CalloutMediatorPropertiesEditionPart_ResultTypeLabel);
        ...
        resultType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CalloutMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CalloutMediator.Target.resultType, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getResultType()));
            }

        });
        resultType.setID(EsbViewsRepository.CalloutMediator.Target.resultType);
        Control resultTypeHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CalloutMediator.Target.resultType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createResultContextPropertyText(FormToolkit widgetFactory, Composite parent) {
        Control resultContextPropertyLabel = createDescription(parent,
                EsbViewsRepository.CalloutMediator.Target.resultContextProperty,
                EsbMessages.CalloutMediatorPropertiesEditionPart_ResultContextPropertyLabel);
        ...
        Control resultContextPropertyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CalloutMediator.Target.resultContextProperty, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPoliciesEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control policiesLabel = createDescription(parent, EsbViewsRepository.CalloutMediator.WS.policies,
                EsbMessages.CalloutMediatorPropertiesEditionPart_PoliciesLabel);
        ...
        policies.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CalloutMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CalloutMediator.WS.policies, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getPolicies()));
            }

        });
        policies.setID(EsbViewsRepository.CalloutMediator.WS.policies);
        Control policiesHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CalloutMediator.WS.policies, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSecurityTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control securityTypeLabel = createDescription(parent, EsbViewsRepository.CalloutMediator.WS.securityType,
                EsbMessages.CalloutMediatorPropertiesEditionPart_SecurityTypeLabel);
        ...
        securityType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CalloutMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CalloutMediator.WS.securityType, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getSecurityType()));
            }

        });
        securityType.setID(EsbViewsRepository.CalloutMediator.WS.securityType);
        Control securityTypeHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CalloutMediator.WS.securityType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setPassHeaders(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#initEndpointType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setEndpointType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setSoapAction(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setPathToAxis2Repository(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setPathToAxis2xml(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setInitAxis2ClientOptions(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setServiceURL(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#initPayloadType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setPayloadType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setPayloadProperty(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#initResultType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setResultType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setResultContextProperty(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#initPolicies(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setPolicies(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#initSecurityType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CalloutMediatorPropertiesEditionPart#setSecurityType(Enumerator
     *      newValue)
     * 
     */
    ...
    protected Composite createPayloadMessageXpath(FormToolkit widgetFactory, final Composite parent) {
        ...
        EditingUtils.setID(payloadMessageXpathText, EsbViewsRepository.CalloutMediator.Source.payloadMessageXpath);
        ...
        Control payloadMessageXpathHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.CalloutMediator.Source.payloadMessageXpath,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        PayloadMessageXpathElements = new Control[] { payloadMessageXpathLabel, payloadMessageXpathText,
                payloadMessageXpathHelp };
        return parent;
    }
    ...
    protected Composite createResultMessageXpath(FormToolkit widgetFactory, final Composite parent) {
        ...
        EditingUtils.setID(payloadMessageXpathText, EsbViewsRepository.CalloutMediator.Target.resultMessageXpath);
        ...
        Control resultMessageXpathHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.CalloutMediator.Target.resultMessageXpath,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        resultMessageXpathElements = new Control[] { resultMessageXpathLabel, resultMessageXpathText,
                resultMessageXpathHelp };
        return parent;
    }

    protected Composite createPolicyKey(FormToolkit widgetFactory, Composite parent) {
        Control policyKeyLabel = createDescription(parent, EsbViewsRepository.CalloutMediator.WS.policyKey,
        ...
        Control policyKeyHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CalloutMediator.WS.policyKey, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInboundPolicyKey(FormToolkit widgetFactory, Composite parent) {
        ...
        inboundPolicyKeyText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent
                        .firePropertiesChanged(new PropertiesEditionEvent(CalloutMediatorPropertiesEditionPartForm.this,
                                EsbViewsRepository.CalloutMediator.WS.inboundPolicyKey, PropertiesEditionEvent.COMMIT,
                                PropertiesEditionEvent.SET, null, getInboundPolicyKey()));
            }
        ...
        Control inboundPolicyKeyHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.CalloutMediator.WS.inboundPolicyKey, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createOutboundPolicyKey(FormToolkit widgetFactory, Composite parent) {
        ...
        Control outboundPolicyKeyHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.CalloutMediator.WS.outboundPolicyKey, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
