...
public class PropertyGroupMediatorOutputConnectorPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	 ...
	 */
	public PropertyGroupMediatorOutputConnectorPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof PropertyMediatorOutputConnector) && (PropertyGroupMediatorOutputConnectorPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof PropertyMediatorOutputConnector) && (refinement == PropertyGroupMediatorOutputConnectorPropertiesEditionComponent.class);
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof PropertyMediatorOutputConnector) && ((PropertyGroupMediatorOutputConnectorPropertiesEditionComponent.BASE_PART.equals(part) && refinement == PropertyGroupMediatorOutputConnectorPropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode) {
		if (editingContext.getEObject() instanceof PropertyMediatorOutputConnector) {
			return new PropertyGroupMediatorOutputConnectorPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
