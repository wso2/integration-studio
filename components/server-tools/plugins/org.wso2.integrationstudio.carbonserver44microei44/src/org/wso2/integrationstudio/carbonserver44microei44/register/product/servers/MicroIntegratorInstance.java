...
package org.wso2.integrationstudio.carbonserver44microei44.register.product.servers;
...
import org.wso2.integrationstudio.carbonserver44microei44.Activator;
import org.wso2.integrationstudio.carbonserver44microei44.ServerProperties;
import org.wso2.integrationstudio.carbonserver44microei44.monitor.EmbeddedServerConfigurationUtil;
import org.wso2.integrationstudio.carbonserver44microei44.util.CarbonServer44eiUtils;
import org.wso2.integrationstudio.carbonserver44microei44.util.ServerConstants;
...
public class MicroIntegratorInstance {
    ...
    private void setupServer() {
        ...
        IRuntimeType runtimeType440 = ServerCore.findRuntimeType(ServerConstants.WSO2_MI_440_RUNTIME);
        IServerType serverType440 = ServerCore.findServerType(ServerConstants.WSO2_MI_440_SERVER_TYPE);
        ...
        try {
            ...
            for (IServer tempServers : availableServers) {
                if ((tempServers.getServerType().equals(serverType440) && tempServers.getName()
        ...
        try {
            if (!isServerExists) {
                ...
                IRuntimeWorkingCopy runtime = runtimeType440.createRuntime("org.wso2.micro.integrator.runtime44",
                        progressMonitor);
                ...
                server = serverType440.createServer("org.wso2.micro.integrator.server44", null, microIntegratorRuntime,
                        progressMonitor);
