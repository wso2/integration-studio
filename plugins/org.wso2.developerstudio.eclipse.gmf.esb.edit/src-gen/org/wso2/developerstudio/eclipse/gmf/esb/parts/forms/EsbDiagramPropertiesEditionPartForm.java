 ...
 * @generated NOT
 */
public class EsbDiagramPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, EsbDiagramPropertiesEditionPart {
     ...
     */
    public EsbDiagramPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        esbDiagramStep.addStep(EsbViewsRepository.EsbDiagram.Properties.class)
    ...
    protected Composite createTestText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.EsbDiagram.Properties.test,
                EsbMessages.EsbDiagramPropertiesEditionPart_TestLabel);
        ...
        test.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EsbDiagramPropertiesEditionPartForm.this, EsbViewsRepository.EsbDiagram.Properties.test,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, test.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(EsbDiagramPropertiesEditionPartForm.this,
                                    EsbViewsRepository.EsbDiagram.Properties.test, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, test.getText()));
                }
            }
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EsbDiagramPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EsbDiagram.Properties.test, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
