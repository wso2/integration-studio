...
public class LoadBalanceEndPoint2ItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (EsbElementTypes.LoadBalanceEndPointInputConnector_3657 == req
				.getElementType()) {
			return getGEFWrapper(new LoadBalanceEndPointInputConnector2CreateCommand(
					req));
		}
		if (EsbElementTypes.LoadBalanceEndPointOutputConnector_3658 == req
				.getElementType()) {
			return getGEFWrapper(new LoadBalanceEndPointOutputConnector2CreateCommand(
					req));
		}
		if (EsbElementTypes.LoadBalanceEndPointWestOutputConnector_3659 == req
				.getElementType()) {
			return getGEFWrapper(new LoadBalanceEndPointWestOutputConnector2CreateCommand(
					req));
		}
