...
public class AggregateMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public AggregateMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject aggregateMediator, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.AggregateMediator.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        aggregateMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.AggregateMediator.Properties.aggregateID))
                basePart.setAggregateID(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        aggregateMediator.getAggregateID()));

            if (isAccessible(EsbViewsRepository.AggregateMediator.Properties.completionTimeout)) {
                basePart.setCompletionTimeout(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        aggregateMediator.getCompletionTimeout()));
            }

            if (isAccessible(EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesType)) {
                basePart.initCompletionMinMessagesType(
                        EEFUtils.choiceOfValues(aggregateMediator,
                                EsbPackage.eINSTANCE.getAggregateMediator_CompletionMinMessagesType()),
                        aggregateMediator.getCompletionMinMessagesType());
            }
            if (isAccessible(EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesType)) {
                basePart.initCompletionMaxMessagesType(
                        EEFUtils.choiceOfValues(aggregateMediator,
                                EsbPackage.eINSTANCE.getAggregateMediator_CompletionMaxMessagesType()),
                        aggregateMediator.getCompletionMaxMessagesType());
            }
            if (isAccessible(EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesValue)) {
                basePart.setCompletionMinMessagesValue(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        aggregateMediator.getCompletionMinMessagesValue()));
            }

            if (isAccessible(EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesValue)) {
                basePart.setCompletionMaxMessagesValue(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        aggregateMediator.getCompletionMaxMessagesValue()));
            }
            ...
            if (isAccessible(EsbViewsRepository.AggregateMediator.OnComplete.sequenceType)) {
                basePart.initSequenceType(
                        ...
                        aggregateMediator.getSequenceType());
            }
            if (isAccessible(EsbViewsRepository.AggregateMediator.Properties.enclosingElementProperty))
                basePart.setEnclosingElementProperty(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        aggregateMediator.getEnclosingElementProperty()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.AggregateMediator.Properties.description == event.getAffectedEditor()) {
            aggregateMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.AggregateMediator.Properties.aggregateID == event.getAffectedEditor()) {
            aggregateMediator.setAggregateID((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.AggregateMediator.Properties.completionTimeout == event.getAffectedEditor()) {
            aggregateMediator.setCompletionTimeout(
        ...
        if (EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesValue == event.getAffectedEditor()) {
            aggregateMediator.setCompletionMinMessagesValue(
        ...
        if (EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesValue == event.getAffectedEditor()) {
            aggregateMediator.setCompletionMaxMessagesValue(
                    (EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String) event.getNewValue())));
        }
        ...
        if (EsbViewsRepository.AggregateMediator.Properties.enclosingElementProperty == event.getAffectedEditor()) {
            aggregateMediator.setEnclosingElementProperty((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.AggregateMediator.Properties.completionMinMessages == event.getAffectedEditor()) {
            ...
            if (event.getNewValue() != null) {
                ...
                aggregateMediator
                        .setCompletionMinMessagesExpression(EsbFactoryImpl.eINSTANCE.createNamespacedProperty());
            }
            // End of user code
        ...
        if (EsbViewsRepository.AggregateMediator.Properties.completionMaxMessages == event.getAffectedEditor()) {
            ...
            if (event.getNewValue() != null) {
                ...
                aggregateMediator
                        .setCompletionMaxMessagesExpression(EsbFactoryImpl.eINSTANCE.createNamespacedProperty());
            }
            // End of user code
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.AggregateMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AggregateMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AggregateMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAggregateMediator_AggregateID().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AggregateMediator.Properties.aggregateID)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAggregateMediator_CompletionTimeout().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AggregateMediator.Properties.completionTimeout)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAggregateMediator_CompletionMinMessagesType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesType))
                basePart.setCompletionMinMessagesType((CompletionMessagesType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAggregateMediator_CompletionMaxMessagesType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesType))
                basePart.setCompletionMaxMessagesType((CompletionMessagesType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAggregateMediator_CompletionMinMessagesValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesValue)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAggregateMediator_CompletionMaxMessagesValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesValue)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAggregateMediator_SequenceType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.AggregateMediator.OnComplete.sequenceType))
                basePart.setSequenceType((AggregateSequenceType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAggregateMediator_EnclosingElementProperty().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AggregateMediator.Properties.enclosingElementProperty)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAggregateMediator_CorrelationExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AggregateMediator.Properties.correlationExpression)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAggregateMediator_CompletionMinMessagesExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AggregateMediator.Properties.completionMinMessages)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAggregateMediator_CompletionMaxMessagesExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AggregateMediator.Properties.completionMaxMessages)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAggregateMediator_AggregationExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AggregateMediator.OnComplete.aggregationExpression)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAggregateMediator_SequenceKey().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AggregateMediator.OnComplete.sequenceKey)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getAggregateMediator_AggregateID(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.AggregateMediator.Properties.aggregateID == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAggregateMediator_AggregateID().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAggregateMediator_AggregateID().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.AggregateMediator.Properties.completionTimeout == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAggregateMediator_CompletionTimeout().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAggregateMediator_CompletionTimeout().getEAttributeType(),
                ...
                if (EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesType == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAggregateMediator_CompletionMinMessagesType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAggregateMediator_CompletionMinMessagesType().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesType == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAggregateMediator_CompletionMaxMessagesType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAggregateMediator_CompletionMaxMessagesType().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.AggregateMediator.Properties.completionMinMessagesValue == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAggregateMediator_CompletionMinMessagesValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAggregateMediator_CompletionMinMessagesValue().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.AggregateMediator.Properties.completionMaxMessagesValue == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAggregateMediator_CompletionMaxMessagesValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAggregateMediator_CompletionMaxMessagesValue().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.AggregateMediator.OnComplete.sequenceType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAggregateMediator_SequenceType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAggregateMediator_SequenceType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.AggregateMediator.Properties.enclosingElementProperty == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getAggregateMediator_EnclosingElementProperty().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAggregateMediator_EnclosingElementProperty().getEAttributeType(),
                            newValue);
                }
