...
public class SynapseAPIPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public SynapseAPIPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject synapseAPI,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.SynapseAPI.Handler.handlers)) {
                handlersSettings = new ReferencesTableSettings(synapseAPI,
            ...
            if (isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.apiName))
                basePart.setApiName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, synapseAPI.getApiName()));

            if (isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.context))
                basePart.setContext(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, synapseAPI.getContext()));

            if (isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.hostName))
                basePart.setHostName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, synapseAPI.getHostName()));
            ...
            if (isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.resources)) {
                resourcesSettings = new ReferencesTableSettings(synapseAPI,
            ...
            if (isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.versionType)) {
                basePart.initVersionType(
                        EEFUtils.choiceOfValues(synapseAPI, EsbPackage.eINSTANCE.getSynapseAPI_VersionType()),
                        synapseAPI.getVersionType());
            }
            if (isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.version))
                basePart.setVersion(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, synapseAPI.getVersion()));
            ...
            if (isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, synapseAPI.getDescription()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.SynapseAPI.Handler.handlers == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, handlersSettings, editingContext.getAdapterFactory());
        ...
        if (EsbViewsRepository.SynapseAPI.Handler.Properties.apiName == event.getAffectedEditor()) {
            synapseAPI.setApiName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.SynapseAPI.Handler.Properties.context == event.getAffectedEditor()) {
            synapseAPI.setContext((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.SynapseAPI.Handler.Properties.hostName == event.getAffectedEditor()) {
            synapseAPI.setHostName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.SynapseAPI.Handler.Properties.resources == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, resourcesSettings, editingContext.getAdapterFactory());
                PropertiesEditingProvider provider = (PropertiesEditingProvider) editingContext.getAdapterFactory()
                        .adapt(semanticObject, PropertiesEditingProvider.class);
                if (provider != null) {
                    PropertiesEditingPolicy policy = provider.getPolicy(context);
        ...
        if (EsbViewsRepository.SynapseAPI.Handler.Properties.version == event.getAffectedEditor()) {
            synapseAPI.setVersion((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.SynapseAPI.Handler.Properties.description == event.getAffectedEditor()) {
            synapseAPI.setDescription((java.lang.String) EEFConverterUtil
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getSynapseAPI_Handlers().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.SynapseAPI.Handler.handlers))
                basePart.updateHandlers();
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getSynapseAPI_ApiName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.apiName)) {
            ...
            if (EsbPackage.eINSTANCE.getSynapseAPI_Context().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.context)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getSynapseAPI_HostName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.hostName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getSynapseAPI_Port().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.port)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getSynapseAPI_Resources().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.resources))
                basePart.updateResources();
            if (EsbPackage.eINSTANCE.getSynapseAPI_VersionType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.versionType))
                basePart.setVersionType((APIVersionType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getSynapseAPI_Version().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.version)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getSynapseAPI_TraceEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.traceEnabled))
                basePart.setTraceEnabled((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getSynapseAPI_StatisticsEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.statisticsEnabled))
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SynapseAPI.Handler.Properties.description)) {
                if (msg.getNewValue() != null) {
                    basePart.setDescription(
            ...
            if (EsbPackage.eINSTANCE.getSynapseAPI_PublishSwagger().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                EsbPackage.eINSTANCE.getSynapseAPI_Handlers(), EsbPackage.eINSTANCE.getEsbElement_CommentsList(),
                EsbPackage.eINSTANCE.getSynapseAPI_ApiName(), EsbPackage.eINSTANCE.getSynapseAPI_Context(),
                EsbPackage.eINSTANCE.getSynapseAPI_HostName(), EsbPackage.eINSTANCE.getSynapseAPI_Port(),
                EsbPackage.eINSTANCE.getSynapseAPI_Resources(), EsbPackage.eINSTANCE.getSynapseAPI_VersionType(),
                EsbPackage.eINSTANCE.getSynapseAPI_Version(), EsbPackage.eINSTANCE.getSynapseAPI_TraceEnabled(),
                EsbPackage.eINSTANCE.getSynapseAPI_StatisticsEnabled(),
                EsbPackage.eINSTANCE.getEsbElement_Description(), EsbPackage.eINSTANCE.getSynapseAPI_PublishSwagger());
    ...
    public boolean isRequired(Object key, int kind) {
        return key == EsbViewsRepository.SynapseAPI.Handler.Properties.apiName
                || key == EsbViewsRepository.SynapseAPI.Handler.Properties.context;
    }
                ...
                if (EsbViewsRepository.SynapseAPI.Handler.Properties.apiName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSynapseAPI_ApiName().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getSynapseAPI_ApiName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SynapseAPI.Handler.Properties.context == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSynapseAPI_Context().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getSynapseAPI_Context().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SynapseAPI.Handler.Properties.hostName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSynapseAPI_HostName().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getSynapseAPI_HostName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SynapseAPI.Handler.Properties.port == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSynapseAPI_Port().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getSynapseAPI_Port().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.SynapseAPI.Handler.Properties.versionType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSynapseAPI_VersionType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getSynapseAPI_VersionType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SynapseAPI.Handler.Properties.version == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSynapseAPI_Version().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getSynapseAPI_Version().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SynapseAPI.Handler.Properties.traceEnabled == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSynapseAPI_TraceEnabled().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getSynapseAPI_TraceEnabled().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SynapseAPI.Handler.Properties.statisticsEnabled == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSynapseAPI_StatisticsEnabled().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getSynapseAPI_StatisticsEnabled().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SynapseAPI.Handler.Properties.description == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
