...
public class ScriptMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ScriptMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject scriptMediator,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ScriptMediator.Properties.scriptType)) {
                basePart.initScriptType(
                        EEFUtils.choiceOfValues(scriptMediator, EsbPackage.eINSTANCE.getScriptMediator_ScriptType()),
                        scriptMediator.getScriptType());
            }
            if (isAccessible(EsbViewsRepository.ScriptMediator.Properties.scriptLanguage)) {
                basePart.initScriptLanguage(
                        EEFUtils.choiceOfValues(scriptMediator,
                                EsbPackage.eINSTANCE.getScriptMediator_ScriptLanguage()),
                        scriptMediator.getScriptLanguage());
            }
            if (isAccessible(EsbViewsRepository.ScriptMediator.Properties.mediateFunction))
                basePart.setMediateFunction(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        scriptMediator.getMediateFunction()));

            if (isAccessible(EsbViewsRepository.ScriptMediator.Properties.scriptBody))
                basePart.setScriptBody(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        scriptMediator.getScriptBody()));

            if (isAccessible(EsbViewsRepository.ScriptMediator.Properties.keyType)) {
                basePart.initKeyType(
                        EEFUtils.choiceOfValues(scriptMediator, EsbPackage.eINSTANCE.getScriptMediator_KeyType()),
                        scriptMediator.getKeyType());
            }
            if (isAccessible(EsbViewsRepository.ScriptMediator.Properties.scriptKeys)) {
                scriptKeysSettings = new ReferencesTableSettings(scriptMediator,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ScriptMediator.Properties.description == event.getAffectedEditor()) {
            scriptMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.ScriptMediator.Properties.mediateFunction == event.getAffectedEditor()) {
            scriptMediator.setMediateFunction((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.ScriptMediator.Properties.scriptBody == event.getAffectedEditor()) {
            scriptMediator.setScriptBody((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.ScriptMediator.Properties.scriptKeys == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, scriptKeysSettings, editingContext.getAdapterFactory());
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.ScriptMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ScriptMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ScriptMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getScriptMediator_ScriptType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ScriptMediator.Properties.scriptType))
                basePart.setScriptType((ScriptType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getScriptMediator_ScriptLanguage().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ScriptMediator.Properties.scriptLanguage))
                basePart.setScriptLanguage((ScriptLanguage) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getScriptMediator_MediateFunction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ScriptMediator.Properties.mediateFunction)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getScriptMediator_ScriptBody().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ScriptMediator.Properties.scriptBody)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getScriptMediator_KeyType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ScriptMediator.Properties.keyType))
                basePart.setKeyType((scriptKeyTypeEnum) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getScriptMediator_ScriptKeys().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.ScriptMediator.Properties.scriptKeys))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getScriptMediator_ScriptType(),
                EsbPackage.eINSTANCE.getScriptMediator_ScriptLanguage(),
                EsbPackage.eINSTANCE.getScriptMediator_MediateFunction(),
                EsbPackage.eINSTANCE.getScriptMediator_ScriptBody(), EsbPackage.eINSTANCE.getScriptMediator_KeyType(),
                EsbPackage.eINSTANCE.getScriptMediator_ScriptKeys(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.ScriptMediator.Properties.scriptType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getScriptMediator_ScriptType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getScriptMediator_ScriptType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ScriptMediator.Properties.scriptLanguage == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getScriptMediator_ScriptLanguage().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getScriptMediator_ScriptLanguage().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ScriptMediator.Properties.mediateFunction == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getScriptMediator_MediateFunction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getScriptMediator_MediateFunction().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ScriptMediator.Properties.scriptBody == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getScriptMediator_ScriptBody().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getScriptMediator_ScriptBody().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ScriptMediator.Properties.keyType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getScriptMediator_KeyType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getScriptMediator_KeyType().getEAttributeType(), newValue);
                }
