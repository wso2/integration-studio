 ...
 * 
 */
public class ConditionalRouterMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ConditionalRouterMediatorPropertiesEditionPart {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ConditionalRouterMediatorPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ConditionalRouterMediatorPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.ConditionalRouterMediator.Properties.description,
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.ConditionalRouterMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.ConditionalRouterMediator.Properties.reverse,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.ConditionalRouterMediator.Properties.reverse, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createContinueAfterRouteCheckbox(Composite parent) {
        ...
        continueAfterRoute
                .setText(getDescription(EsbViewsRepository.ConditionalRouterMediator.Properties.continueAfterRoute,
