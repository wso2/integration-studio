...
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigureEndsWithOperatorDialog;

public class EndsWithConfigureAction extends AbstractActionHandler {
	 ...
	 */
	public EndsWithConfigureAction(IWorkbenchPart part) {
		super(part);
		setId(Messages.EndsWithConfigureAction_ActionID);
		setText(Messages.EndsWithConfigureAction_ActionText);
		setToolTipText(Messages.EndsWithConfigureAction_ToolTip);
