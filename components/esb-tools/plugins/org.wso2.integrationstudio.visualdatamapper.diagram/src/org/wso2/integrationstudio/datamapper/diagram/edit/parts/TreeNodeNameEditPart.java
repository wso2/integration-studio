 ...
 * @generated
 */
public class TreeNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TreeNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataMapperParserProvider.getParser(DataMapperElementTypes.TreeNode_3002, getParserElement(),
					DataMapperVisualIDRegistry.getType(
							org.wso2.integrationstudio.datamapper.diagram.edit.parts.TreeNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
