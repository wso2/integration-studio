...
public class ThrottleMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ThrottleMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject throttleMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ThrottleMediator.Misc.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        throttleMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.ThrottleMediator.General.groupId))
                basePart.setGroupId(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, throttleMediator.getGroupId()));

            if (isAccessible(EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyType)) {
                basePart.initPolicyType(
                        EEFUtils.choiceOfValues(throttleMediator,
                                EsbPackage.eINSTANCE.getThrottleMediator_PolicyType()),
                        throttleMediator.getPolicyType());
            }
            if (isAccessible(EsbViewsRepository.ThrottleMediator.ThrottlePolicy.maxConcurrentAccessCount)) {
                basePart.setMaxConcurrentAccessCount(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        throttleMediator.getMaxConcurrentAccessCount()));
            }

            if (isAccessible(EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyEntries)) {
                policyEntriesSettings = new ReferencesTableSettings(throttleMediator,
                ...
                basePart.addFilterToPolicyEntries(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof ThrottlePolicyEntry);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ThrottleMediator.Misc.description == event.getAffectedEditor()) {
            throttleMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.ThrottleMediator.General.groupId == event.getAffectedEditor()) {
            throttleMediator.setGroupId((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.ThrottleMediator.ThrottlePolicy.maxConcurrentAccessCount == event.getAffectedEditor()) {
            throttleMediator.setMaxConcurrentAccessCount(
        ...
        if (EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyEntries == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, policyEntriesSettings, editingContext.getAdapterFactory());
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.ThrottleMediator.Misc.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ThrottleMediator.General.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ThrottleMediator.General.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getThrottleMediator_GroupId().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ThrottleMediator.General.groupId)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getThrottleMediator_PolicyType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyType))
                basePart.setPolicyType((ThrottlePolicyType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getThrottleMediator_MaxConcurrentAccessCount().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ThrottleMediator.ThrottlePolicy.maxConcurrentAccessCount)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getThrottleMediator_PolicyEntries().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyEntries))
                basePart.updatePolicyEntries();
            if (EsbPackage.eINSTANCE.getThrottleMediator_OnAcceptBranchsequenceType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ThrottleMediator.OnAccept.onAcceptBranchsequenceType))
                basePart.setOnAcceptBranchsequenceType((ThrottleSequenceType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getThrottleMediator_OnRejectBranchsequenceType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.ThrottleMediator.OnReject.onRejectBranchsequenceType))
            ...
            if (EsbPackage.eINSTANCE.getThrottleMediator_OnAcceptBranchsequenceKey().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ThrottleMediator.OnAccept.onAcceptBranchSequenceKey)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getThrottleMediator_GroupId(),
                EsbPackage.eINSTANCE.getThrottleMediator_PolicyType(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.ThrottleMediator.General.groupId == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getThrottleMediator_GroupId().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getThrottleMediator_GroupId().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getThrottleMediator_PolicyType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getThrottleMediator_PolicyType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ThrottleMediator.ThrottlePolicy.maxConcurrentAccessCount == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getThrottleMediator_MaxConcurrentAccessCount().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getThrottleMediator_MaxConcurrentAccessCount().getEAttributeType(),
                ...
                if (EsbViewsRepository.ThrottleMediator.OnAccept.onAcceptBranchsequenceType == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getThrottleMediator_OnAcceptBranchsequenceType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getThrottleMediator_OnAcceptBranchsequenceType().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.ThrottleMediator.OnReject.onRejectBranchsequenceType == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getThrottleMediator_OnRejectBranchsequenceType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getThrottleMediator_OnRejectBranchsequenceType().getEAttributeType(),
                            newValue);
                }
