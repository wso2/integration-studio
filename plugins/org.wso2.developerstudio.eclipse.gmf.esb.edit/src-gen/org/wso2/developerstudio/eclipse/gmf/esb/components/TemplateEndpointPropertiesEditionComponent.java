...
public class TemplateEndpointPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public TemplateEndpointPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject templateEndpoint,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        templateEndpoint.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.endPointName))
                basePart.setEndPointName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        templateEndpoint.getEndPointName()));
            ...
            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.properties_)) {
                propertiesSettings = new ReferencesTableSettings(templateEndpoint,
            ...
            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.addressingVersion)) {
                basePart.initAddressingVersion(
                        EEFUtils.choiceOfValues(templateEndpoint,
                                EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingVersion()),
                        templateEndpoint.getAddressingVersion());
            }
            ...
            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.timeOutDuration))
                basePart.setTimeOutDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        templateEndpoint.getTimeOutDuration()));
            ...
            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.timeOutAction)) {
                basePart.initTimeOutAction(
                        ...
                        templateEndpoint.getTimeOutAction());
            }
            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.retryErrorCodes))
                basePart.setRetryErrorCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        templateEndpoint.getRetryErrorCodes()));

            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.retryCount))
                basePart.setRetryCount(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        templateEndpoint.getRetryCount()));

            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.retryDelay)) {
                basePart.setRetryDelay(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        templateEndpoint.getRetryDelay()));
            }
            ...
            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.suspendErrorCodes))
                basePart.setSuspendErrorCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        templateEndpoint.getSuspendErrorCodes()));

            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.suspendInitialDuration))
                basePart.setSuspendInitialDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        templateEndpoint.getSuspendInitialDuration()));
            ...
            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.suspendMaximumDuration)) {
                basePart.setSuspendMaximumDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        templateEndpoint.getSuspendMaximumDuration()));
            }

            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.suspendProgressionFactor))
                basePart.setSuspendProgressionFactor(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        templateEndpoint.getSuspendProgressionFactor()));

            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.format)) {
                basePart.initFormat(
                        EEFUtils.choiceOfValues(templateEndpoint, EsbPackage.eINSTANCE.getAbstractEndPoint_Format()),
                        templateEndpoint.getFormat());
            }
            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.optimize)) {
                basePart.initOptimize(
                        EEFUtils.choiceOfValues(templateEndpoint, EsbPackage.eINSTANCE.getAbstractEndPoint_Optimize()),
                        templateEndpoint.getOptimize());
            }
            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.templateParameters)) {
                templateParametersSettings = new ReferencesTableSettings(templateEndpoint,
            ...
            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.address))
                basePart.setAddress(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, templateEndpoint.getAddress()));

            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.targetTemplate))
                basePart.setTargetTemplate(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        templateEndpoint.getTargetTemplate()));

            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.parameters)) {
                parametersSettings = new ReferencesTableSettings(templateEndpoint,
            ...
            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.availableTemplates))
                basePart.setAvailableTemplates(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        templateEndpoint.getAvailableTemplates()));
            ...
            if (isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.parameters)) {
                basePart.addFilterToParameters(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof TemplateEndpointParameter);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.TemplateEndpoint.Properties.description == event.getAffectedEditor()) {
            templateEndpoint.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.TemplateEndpoint.Properties.endPointName == event.getAffectedEditor()) {
            templateEndpoint.setEndPointName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.TemplateEndpoint.Properties.timeOutDuration == event.getAffectedEditor()) {
            templateEndpoint.setTimeOutDuration((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.TemplateEndpoint.Properties.address == event.getAffectedEditor()) {
            templateEndpoint.setAddress((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.TemplateEndpoint.Properties.targetTemplate == event.getAffectedEditor()) {
            templateEndpoint.setTargetTemplate((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.TemplateEndpoint.Properties.availableTemplates == event.getAffectedEditor()) {
            templateEndpoint.setAvailableTemplates((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getEndPoint_EndPointName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.endPointName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_ReliableMessagingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.reliableMessagingEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SecurityEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.securityEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.addressingEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingVersion().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.addressingVersion))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingSeparateListener().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.addressingSeparateListener))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.timeOutDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.timeOutAction))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryErrorCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.retryErrorCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryCount().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.retryCount)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryDelay().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.retryDelay)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendErrorCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.suspendErrorCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendInitialDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.suspendInitialDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendMaximumDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.suspendMaximumDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendProgressionFactor().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.suspendProgressionFactor)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_Format().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.format))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_Optimize().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.optimize))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TemplateParameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.templateParameters))
                basePart.updateTemplateParameters();
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_StatisticsEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.statisticsEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TraceEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.traceEnabled))
                basePart.setTraceEnabled((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getTemplateEndpoint_Address().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.address)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getTemplateEndpoint_TargetTemplate().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.targetTemplate)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getTemplateEndpoint_Parameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.parameters))
                basePart.updateParameters();
            if (EsbPackage.eINSTANCE.getTemplateEndpoint_AvailableTemplates().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpoint.Properties.availableTemplates)) {
                if (msg.getNewValue() != null) {
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.TemplateEndpoint.Properties.reliableMessagingEnabled == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.TemplateEndpoint.Properties.addressingSeparateListener == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                ...
                if (EsbViewsRepository.TemplateEndpoint.Properties.suspendInitialDuration == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.TemplateEndpoint.Properties.suspendMaximumDuration == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.TemplateEndpoint.Properties.suspendProgressionFactor == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.TemplateEndpoint.Properties.address == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTemplateEndpoint_Address().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getTemplateEndpoint_Address().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.TemplateEndpoint.Properties.targetTemplate == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTemplateEndpoint_TargetTemplate().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getTemplateEndpoint_TargetTemplate().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.TemplateEndpoint.Properties.availableTemplates == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTemplateEndpoint_AvailableTemplates().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getTemplateEndpoint_AvailableTemplates().getEAttributeType(),
