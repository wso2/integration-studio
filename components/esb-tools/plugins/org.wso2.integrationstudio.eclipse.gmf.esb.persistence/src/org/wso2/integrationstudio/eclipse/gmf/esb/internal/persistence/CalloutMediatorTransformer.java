...
public class CalloutMediatorTransformer extends AbstractEsbNodeTransformer {
    ...
    public void transform(TransformationInfo information, EsbNode subject) throws TransformerException {
        try {
             ...
             */
            doTransform(information, ((CalloutMediator) subject).getOutputConnector());
    ...
    public void transformWithinSequence(TransformationInfo information, EsbNode subject, SequenceMediator sequence)
        ...
        try {
            ...
            doTransformWithinSequence(information, ((CalloutMediator) subject).getOutputConnector().getOutgoingLink(),
                    sequence);
        } catch (JaxenException e) {
            throw new TransformerException(e);
        }
    ...
    public static org.apache.synapse.mediators.builtin.CalloutMediator createCalloutMediator(EsbNode subject)
        ...
        if (visualCallout.getPayloadType().getValue() == 0) {
            ...
            NamespacedProperty payLoadExp = visualCallout.getPayloadMessageXpath();
            if (payLoadExp != null && !payLoadExp.getPropertyValue().equals("")) {

                SynapseXPath xpath = new SynapseXPath(payLoadExp.getPropertyValue());
        ...
        if (visualCallout.getResultType().getValue() == 0) {
            ...
            NamespacedProperty resultExp = visualCallout.getResultMessageXpath();
            if (resultExp != null && !resultExp.getPropertyValue().equals("")) {

                SynapseXPath resultXPath = new SynapseXPath(resultExp.getPropertyValue());
                Map<String, String> nameSpaceMap = resultExp.getNamespaces();
