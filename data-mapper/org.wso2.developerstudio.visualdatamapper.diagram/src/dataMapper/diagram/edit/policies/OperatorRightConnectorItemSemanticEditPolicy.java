...
public class OperatorRightConnectorItemSemanticEditPolicy extends
	...
	public OperatorRightConnectorItemSemanticEditPolicy() {
		super(dataMapper.diagram.providers.DataMapperElementTypes.OperatorRightConnector_3017);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (dataMapper.diagram.providers.DataMapperElementTypes.OutNode_3018 == req
				.getElementType()) {
