 ...
 * 
 */
public class DataMapperMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, DataMapperMediatorPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.DataMapperMediator.Properties.description,
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            DataMapperMediatorPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(DataMapperMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DataMapperMediator.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.DataMapperMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.DataMapperMediator.Properties.reverse,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DataMapperMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInputTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.DataMapperMediator.Properties.inputType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DataMapperMediator.Properties.inputType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createConfigurationLocalPathText(Composite parent) {
        createDescription(parent, EsbViewsRepository.DataMapperMediator.Properties.configurationLocalPath,
    ...
    protected Composite createInputSchemaLocalPathText(Composite parent) {
        createDescription(parent, EsbViewsRepository.DataMapperMediator.Properties.inputSchemaLocalPath,
    ...
    protected Composite createOutputSchemaLocalPathText(Composite parent) {
        createDescription(parent, EsbViewsRepository.DataMapperMediator.Properties.outputSchemaLocalPath,
    ...
    protected Composite createOutputTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.DataMapperMediator.Properties.outputType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DataMapperMediator.Properties.outputType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
