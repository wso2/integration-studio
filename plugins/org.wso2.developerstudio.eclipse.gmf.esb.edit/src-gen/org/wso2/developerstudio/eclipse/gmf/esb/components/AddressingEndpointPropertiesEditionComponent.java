...
public class AddressingEndpointPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public AddressingEndpointPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject addressingEndpoint, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        addressingEndpoint.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.endPointName))
                basePart.setEndPointName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        addressingEndpoint.getEndPointName()));
            ...
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.properties_)) {
                propertiesSettings = new ReferencesTableSettings(addressingEndpoint,
            ...
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.addressingVersion)) {
                basePart.initAddressingVersion(
                        EEFUtils.choiceOfValues(addressingEndpoint,
                                EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingVersion()),
                        addressingEndpoint.getAddressingVersion());
            }
            ...
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.timeOutDuration))
                basePart.setTimeOutDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        addressingEndpoint.getTimeOutDuration()));
            ...
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.timeOutAction)) {
                basePart.initTimeOutAction(
                        ...
                        addressingEndpoint.getTimeOutAction());
            }
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.retryErrorCodes))
                basePart.setRetryErrorCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        addressingEndpoint.getRetryErrorCodes()));
            ...
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.retryCount))
                basePart.setRetryCount(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        addressingEndpoint.getRetryCount()));
            ...
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.retryDelay)) {
                basePart.setRetryDelay(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        addressingEndpoint.getRetryDelay()));
            }
            ...
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.suspendErrorCodes))
                basePart.setSuspendErrorCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        addressingEndpoint.getSuspendErrorCodes()));
            ...
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.suspendInitialDuration))
                basePart.setSuspendInitialDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        addressingEndpoint.getSuspendInitialDuration()));
            ...
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.suspendMaximumDuration)) {
                basePart.setSuspendMaximumDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        addressingEndpoint.getSuspendMaximumDuration()));
            }
            ...
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.suspendProgressionFactor))
                basePart.setSuspendProgressionFactor(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        addressingEndpoint.getSuspendProgressionFactor()));

            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.format)) {
                basePart.initFormat(
                        EEFUtils.choiceOfValues(addressingEndpoint, EsbPackage.eINSTANCE.getAbstractEndPoint_Format()),
                        addressingEndpoint.getFormat());
            }
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.optimize)) {
                basePart.initOptimize(EEFUtils.choiceOfValues(addressingEndpoint,
                        EsbPackage.eINSTANCE.getAbstractEndPoint_Optimize()), addressingEndpoint.getOptimize());
            }
            if (isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.templateParameters)) {
                templateParametersSettings = new ReferencesTableSettings(addressingEndpoint,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.AddressingEndpoint.Properties.description == event.getAffectedEditor()) {
            addressingEndpoint.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.AddressingEndpoint.Properties.endPointName == event.getAffectedEditor()) {
            addressingEndpoint.setEndPointName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.AddressingEndpoint.Properties.timeOutDuration == event.getAffectedEditor()) {
            addressingEndpoint.setTimeOutDuration((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getEndPoint_EndPointName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.endPointName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_ReliableMessagingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.reliableMessagingEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SecurityEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.securityEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.addressingEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingVersion().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.addressingVersion))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingSeparateListener().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.addressingSeparateListener))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.timeOutDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.timeOutAction))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryErrorCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.retryErrorCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryCount().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.retryCount)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryDelay().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.retryDelay)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendErrorCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.suspendErrorCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendInitialDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.suspendInitialDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendMaximumDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.suspendMaximumDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendProgressionFactor().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.suspendProgressionFactor)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_Format().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.format))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_Optimize().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.optimize))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TemplateParameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.templateParameters))
                basePart.updateTemplateParameters();
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_StatisticsEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.statisticsEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TraceEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.AddressingEndpoint.Properties.traceEnabled))
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.AddressingEndpoint.Properties.reliableMessagingEnabled == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.AddressingEndpoint.Properties.addressingSeparateListener == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                ...
                if (EsbViewsRepository.AddressingEndpoint.Properties.suspendInitialDuration == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.AddressingEndpoint.Properties.suspendMaximumDuration == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.AddressingEndpoint.Properties.suspendProgressionFactor == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
