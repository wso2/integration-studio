...
import org.wso2.integrationstudio.eclipse.gmf.esb.parts.JsonTransformMediatorPropertyPropertiesEditionPart;
 ...
 * 
 */
public class JsonTransformMediatorPropertyPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, JsonTransformMediatorPropertyPropertiesEditionPart {
	 ...
	 */
	public JsonTransformMediatorPropertyPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public JsonTransformMediatorPropertyPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(EsbMessages.JsonTransformMediatorPropertyPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createPropertyNameText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JsonTransformMediatorPropertyPropertiesEditionPartForm.this,
							EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyName,
		...
		propertyName.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JsonTransformMediatorPropertyPropertiesEditionPartForm.this, EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, propertyName.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyName, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyValueText(FormToolkit widgetFactory, Composite parent) {
		...
		propertyValue.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JsonTransformMediatorPropertyPropertiesEditionPartForm.this,
							EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyValue,
		...
		propertyValue.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JsonTransformMediatorPropertyPropertiesEditionPartForm.this, EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, propertyValue.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyValue, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.JsonTransformMediatorPropertyPropertiesEditionPart#getPropertyName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.JsonTransformMediatorPropertyPropertiesEditionPart#setPropertyName(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.JsonTransformMediatorPropertyPropertiesEditionPart#getPropertyValue()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.JsonTransformMediatorPropertyPropertiesEditionPart#setPropertyValue(String newValue)
	 * 
	 */
