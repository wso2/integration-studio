 ...
 * 
 */
public class XQueryVariablePropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, XQueryVariablePropertiesEditionPart {
    ...
    protected Composite createVariableNameText(Composite parent) {
        Control variableNameLabel = createDescription(parent, EsbViewsRepository.XQueryVariable.Properties.variableName,
                EsbMessages.XQueryVariablePropertiesEditionPart_VariableNameLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            XQueryVariablePropertiesEditionPartImpl.this,
                            EsbViewsRepository.XQueryVariable.Properties.variableName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, variableName.getText()));
            }
                ...
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(XQueryVariablePropertiesEditionPartImpl.this,
        ...
        Control variableNameHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.XQueryVariable.Properties.variableName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createVariableTypeEMFComboViewer(Composite parent) {
        Control variableTypeLabel = createDescription(parent, EsbViewsRepository.XQueryVariable.Properties.variableType,
                EsbMessages.XQueryVariablePropertiesEditionPart_VariableTypeLabel);
        ...
        variableType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            XQueryVariablePropertiesEditionPartImpl.this,
                            EsbViewsRepository.XQueryVariable.Properties.variableType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getVariableType()));
            }

        });
        variableType.setID(EsbViewsRepository.XQueryVariable.Properties.variableType);
        Control variableTypeHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.XQueryVariable.Properties.variableType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueTypeEMFComboViewer(Composite parent) {
        Control valueTypeLabel = createDescription(parent, EsbViewsRepository.XQueryVariable.Properties.valueType,
                EsbMessages.XQueryVariablePropertiesEditionPart_ValueTypeLabel);
        ...
        valueType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(XQueryVariablePropertiesEditionPartImpl.this,
                                    EsbViewsRepository.XQueryVariable.Properties.valueType,
        ...
        Control valueTypeHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.XQueryVariable.Properties.valueType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueLiteralText(Composite parent) {
        Control valueLiteralLabel = createDescription(parent, EsbViewsRepository.XQueryVariable.Properties.valueLiteral,
                EsbMessages.XQueryVariablePropertiesEditionPart_ValueLiteralLabel);
        ...
        valueLiteral.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            XQueryVariablePropertiesEditionPartImpl.this,
                            EsbViewsRepository.XQueryVariable.Properties.valueLiteral, PropertiesEditionEvent.COMMIT,
        ...
        Control valueLiteralHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.XQueryVariable.Properties.valueLiteral, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryVariablePropertiesEditionPart#setVariableName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryVariablePropertiesEditionPart#initVariableType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryVariablePropertiesEditionPart#setVariableType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryVariablePropertiesEditionPart#initValueType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryVariablePropertiesEditionPart#setValueType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryVariablePropertiesEditionPart#setValueLiteral(String
     *      newValue)
     * 
     */
    ...
    protected Composite createValueKey(final Composite parent) {
        ...
        Control valueKeyHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.XQueryVariable.Properties.valueKey, EsbViewsRepository.FORM_KIND), null);
    ...
    protected Composite createValueExpression(final Composite parent) {
        Control valueExpressionLabel = createDescription(parent,
                EsbViewsRepository.XQueryVariable.Properties.valueExpression,
        ...
        Control valueExpressionHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.XQueryVariable.Properties.valueExpression, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    public void validate() {
        ...
        if (getValueType() != null && getValueType().getName().equals(XQueryVariableValueType.LITERAL.getName())) {
            eu.showEntry(valueLiteralElements, false);
                ...
                && getValueType().getName().equals(XQueryVariableValueType.EXPRESSION.getName())) {
