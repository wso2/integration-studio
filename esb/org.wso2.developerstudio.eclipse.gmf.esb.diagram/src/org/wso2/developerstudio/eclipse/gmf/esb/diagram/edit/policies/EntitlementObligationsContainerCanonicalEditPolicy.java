 ...
 * @generated
 */
public class EntitlementObligationsContainerCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return EsbPackage.eINSTANCE
				.getEntitlementObligationsContainer_MediatorFlow();
	}
	...
	private boolean isMyDiagramElement(View view) {
		return MediatorFlow24EditPart.VISUAL_ID == EsbVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getEntitlementObligationsContainer_3759SemanticChildren((View) getHost()
						.getModel());
