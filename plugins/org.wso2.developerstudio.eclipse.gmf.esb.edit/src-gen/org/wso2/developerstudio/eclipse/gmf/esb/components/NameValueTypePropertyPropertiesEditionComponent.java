...
public class NameValueTypePropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public NameValueTypePropertyPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject nameValueTypeProperty, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.NameValueTypeProperty.Properties.propertyName))
                basePart.setPropertyName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        nameValueTypeProperty.getPropertyName()));
            ...
            if (isAccessible(EsbViewsRepository.NameValueTypeProperty.Properties.propertyValue))
                basePart.setPropertyValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        nameValueTypeProperty.getPropertyValue()));

            if (isAccessible(EsbViewsRepository.NameValueTypeProperty.Properties.propertyType)) {
                basePart.initPropertyType(
                        EEFUtils.choiceOfValues(nameValueTypeProperty,
                                EsbPackage.eINSTANCE.getNameValueTypeProperty_PropertyType()),
                        nameValueTypeProperty.getPropertyType());
            }
            // init filters
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.NameValueTypeProperty.Properties.propertyName == event.getAffectedEditor()) {
            nameValueTypeProperty.setPropertyName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.NameValueTypeProperty.Properties.propertyValue == event.getAffectedEditor()) {
            nameValueTypeProperty.setPropertyValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getNameValueTypeProperty_PropertyName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NameValueTypeProperty.Properties.propertyName)) {
            ...
            if (EsbPackage.eINSTANCE.getNameValueTypeProperty_PropertyValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NameValueTypeProperty.Properties.propertyValue)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getNameValueTypeProperty_PropertyType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.NameValueTypeProperty.Properties.propertyType))
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.NameValueTypeProperty.Properties.propertyName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getNameValueTypeProperty_PropertyName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getNameValueTypeProperty_PropertyName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.NameValueTypeProperty.Properties.propertyValue == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getNameValueTypeProperty_PropertyValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getNameValueTypeProperty_PropertyValue().getEAttributeType(),
                ...
                if (EsbViewsRepository.NameValueTypeProperty.Properties.propertyType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getNameValueTypeProperty_PropertyType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getNameValueTypeProperty_PropertyType().getEAttributeType(), newValue);
                }
