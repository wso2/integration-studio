...
public class CarbonServerConstants {
	...
	public static final String[] AXIS2_UTIL_LIB_PREFIXES = { //$NON-NLS-1$
	                                                       "axiom-1.2.10", "axis2-transport-base-1.0.0", "axis2-1.6.0",
	                                                               "axis2-transport-jms-1.0.0", "axis2-jibx-1.5.0",
	                                                               "commons-httpclient-3.1.0", "commons-logging-1.1.1",
	                                                               "commons-fileupload-1.2.0", "commons-lang-1.0",
	                                                               "commons-pool-1.3.0", "commons-codec-1.3.0",
	                                                               "commons-el-1.0", "commons-cli-1.0",
	                                                               "commons-dbcp-1.2.2", "commons-modeler-1.1",
	                                                               "neethi-2.0.4", "geronimo-stax-api_1.0_spec-1.0.1",
	                                                               "wsdl4j-1.6.2", "XmlSchema-1.4.2",
	                                                               "woden_1.0.0.M8-wso2v1",
	                                                               "backport-util-concurrent-3.1.0",
	                                                               "org.wso2.carbon.logging-2.0.0", "xmlbeans-2.3.0",
	                                                               "axis2-jaxbri-1.5.0", "jibx-1.2.1",
	                                                               "axis2-jibx-1.5.0",
	                                                               "backport-util-concurrent-3.1.0",
	                                                               "commons-codec-1.3.0",
	                                                               "geronimo-jaxws_2.1_spec-1.0.0" };

	public static final List<String> portCaptions =
	                                                Arrays.asList(new String[] {
	                                                                            "Carbon service port (HTTP)",
	...
	public static final List<String> portIds =
	                                           Arrays.asList(new String[] { "carbon.http", "carbon.https",
	                                                                       "synapse.transport.http",
	                                                                       "synapse.transport.https", "carbon.offset" });
	...
	public static final String CATALINA_XPATH_EXPRESSION_FOR_SSL_ENABLED_PORT =
	                                                                            "/Server/Service/Connector[@SSLEnabled=\"true\"]/@port";
}
