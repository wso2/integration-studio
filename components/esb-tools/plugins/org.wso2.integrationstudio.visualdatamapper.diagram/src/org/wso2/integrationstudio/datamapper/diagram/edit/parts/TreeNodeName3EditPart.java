...
import org.wso2.integrationstudio.datamapper.diagram.edit.policies.DataMapperTextSelectionEditPolicy;
 ...
 * @generated
 */
public class TreeNodeName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TreeNodeName3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new DataMapperTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataMapperParserProvider.getParser(DataMapperElementTypes.TreeNode_3011, getParserElement(),
					DataMapperVisualIDRegistry.getType(
							org.wso2.integrationstudio.datamapper.diagram.edit.parts.TreeNodeName3EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, DataMapperEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
