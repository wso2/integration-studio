	...
	public static Text createWorkspacePathBrowser(Composite container, final Shell shell,
		...
		btnFileBrowse.addSelectionListener(new SelectionListener() {
			...
			public void widgetDefaultSelected(SelectionEvent event) {
				...
				IntegrationStudioRegistryResourceProviderDialog dialog = new IntegrationStudioRegistryResourceProviderDialog(shell, new Class[]{IIntegrationStudioElement.class},filters);
				dialog.create();
