 ...
 * 
 */
public class SqlStatementPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, SqlStatementPropertiesEditionPart {
    ...
    protected Composite createQueryStringText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SqlStatementPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SqlStatement.Properties.queryString, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createParametersAdvancedTableComposition(Composite parent) {
                ...
                EsbMessages.SqlStatementPropertiesEditionPart_ParametersLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(SqlStatementPropertiesEditionPartImpl.this,
        ...
        this.parameters.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SqlStatement.Properties.parameters, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createResultsEnabledCheckbox(Composite parent) {
        ...
        resultsEnabled.setText(getDescription(EsbViewsRepository.SqlStatement.Properties.resultsEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SqlStatement.Properties.resultsEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResultsAdvancedTableComposition(Composite parent) {
        ...
        this.results.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SqlStatement.Properties.results, EsbViewsRepository.SWT_KIND));
