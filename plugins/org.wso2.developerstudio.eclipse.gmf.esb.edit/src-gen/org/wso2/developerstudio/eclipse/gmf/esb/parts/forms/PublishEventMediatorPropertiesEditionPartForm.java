 ...
 * 
 */
public class PublishEventMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, PublishEventMediatorPropertiesEditionPart {
     ...
     */
    public PublishEventMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(PublishEventMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.PublishEventMediator.Properties.description,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PublishEventMediatorPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PublishEventMediator.Properties.description, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.PublishEventMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.PublishEventMediator.Properties.reverse,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStreamNameText(FormToolkit widgetFactory, Composite parent) {
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.streamName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStreamVersionText(FormToolkit widgetFactory, Composite parent) {
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PublishEventMediator.Properties.streamVersion, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createEventSinkText(FormToolkit widgetFactory, Composite parent) {
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.eventSink, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMetaAttributesTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.metaAttributes.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.metaAttributes, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createPayloadAttributesTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.payloadAttributes.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.payloadAttributes, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createArbitraryAttributesTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.arbitraryAttributes.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.arbitraryAttributes, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createAsyncCheckbox(FormToolkit widgetFactory, Composite parent) {
        async = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.PublishEventMediator.Properties.async,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.async, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAsyncTimeoutText(FormToolkit widgetFactory, Composite parent) {
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PublishEventMediator.Properties.asyncTimeout, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
