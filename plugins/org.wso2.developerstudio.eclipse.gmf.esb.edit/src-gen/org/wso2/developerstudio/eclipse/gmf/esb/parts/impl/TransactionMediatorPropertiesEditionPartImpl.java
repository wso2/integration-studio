 ...
 * 
 */
public class TransactionMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, TransactionMediatorPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        CompositionStep propertiesStep = transactionMediatorStep
                .addStep(EsbViewsRepository.TransactionMediator.Properties.class);
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.TransactionMediator.Properties.description,
                EsbMessages.TransactionMediatorPropertiesEditionPart_DescriptionLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TransactionMediatorPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(TransactionMediatorPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.TransactionMediator.Properties.description,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TransactionMediator.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.TransactionMediator.Properties.commentsList,
                EsbMessages.TransactionMediatorPropertiesEditionPart_CommentsListLabel));
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(),
                        "TransactionMediator", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(TransactionMediatorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.TransactionMediator.Properties.commentsList,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.TransactionMediator.Properties.reverse,
                EsbMessages.TransactionMediatorPropertiesEditionPart_ReverseLabel));
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TransactionMediatorPropertiesEditionPartImpl.this,
                            EsbViewsRepository.TransactionMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TransactionMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createActionEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.TransactionMediator.Properties.action,
                EsbMessages.TransactionMediatorPropertiesEditionPart_ActionLabel);
        ...
        action.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(TransactionMediatorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.TransactionMediator.Properties.action,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getAction()));
            }

        });
        action.setID(EsbViewsRepository.TransactionMediator.Properties.action);
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.TransactionMediator.Properties.action, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TransactionMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TransactionMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TransactionMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TransactionMediatorPropertiesEditionPart#initAction(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TransactionMediatorPropertiesEditionPart#setAction(Enumerator
     *      newValue)
     * 
     */
