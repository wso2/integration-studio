...
public class TemplateEndpointItemProvider extends AbstractEndPointItemProvider {
    ...
    protected void addAddressPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_TemplateEndpoint_address_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_TemplateEndpoint_address_feature",
                                "_UI_TemplateEndpoint_type"),
                        EsbPackage.Literals.TEMPLATE_ENDPOINT__ADDRESS, true, false, false,
    ...
    protected void addTargetTemplatePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_TemplateEndpoint_targetTemplate_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_TemplateEndpoint_targetTemplate_feature",
                                "_UI_TemplateEndpoint_type"),
                        EsbPackage.Literals.TEMPLATE_ENDPOINT__TARGET_TEMPLATE, false, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addParametersPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_TemplateEndpoint_parameters_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_TemplateEndpoint_parameters_feature",
                                "_UI_TemplateEndpoint_type"),
                        EsbPackage.Literals.TEMPLATE_ENDPOINT__PARAMETERS, true, false, false, null, null, null));
    }
    ...
    protected void addAvailableTemplatesPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_TemplateEndpoint_availableTemplates_feature",
                        "_UI_TemplateEndpoint_type"),
                EsbPackage.Literals.TEMPLATE_ENDPOINT__AVAILABLE_TEMPLATES, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_TemplateEndpoint_type")
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.TEMPLATE_ENDPOINT__INPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createTemplateEndpointInputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.TEMPLATE_ENDPOINT__OUTPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createTemplateEndpointOutputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.TEMPLATE_ENDPOINT__PARAMETERS,
