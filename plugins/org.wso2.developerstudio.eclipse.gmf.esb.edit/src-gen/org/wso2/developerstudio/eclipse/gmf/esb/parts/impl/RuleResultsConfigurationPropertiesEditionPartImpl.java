 ...
 * 
 */
public class RuleResultsConfigurationPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, RuleResultsConfigurationPropertiesEditionPart {
    ...
    protected Composite createResultsAdvancedTableComposition(Composite parent) {
                ...
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(RuleResultsConfigurationPropertiesEditionPartImpl.this,
        ...
        this.results.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleResultsConfiguration.Properties.results, EsbViewsRepository.SWT_KIND));
