...
public class EndpointDiagramPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public EndpointDiagramPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject endpointDiagram,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.EndpointDiagram.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        endpointDiagram.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.EndpointDiagram.Properties.name))
                basePart.setName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, endpointDiagram.getName()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.EndpointDiagram.Properties.description == event.getAffectedEditor()) {
            endpointDiagram.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.EndpointDiagram.Properties.name == event.getAffectedEditor()) {
            endpointDiagram.setName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.EndpointDiagram.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EndpointDiagram.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getEndpointDiagram_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EndpointDiagram.Properties.name)) {
                if (msg.getNewValue() != null) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.EndpointDiagram.Properties.name == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEndpointDiagram_Name().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getEndpointDiagram_Name().getEAttributeType(), newValue);
                }
