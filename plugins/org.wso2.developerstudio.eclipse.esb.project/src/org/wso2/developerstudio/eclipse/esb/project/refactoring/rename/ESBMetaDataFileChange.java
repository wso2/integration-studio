...
public class ESBMetaDataFileChange extends TextFileChange {
	...
	private void identifyReplaces() throws IOException {
		...
		while (!lineData.isEmpty()) {
			...
			// <artifact name="proxy1" version="1.0.0"
			// type="synapse/proxy-service" serverRole="EnterpriseServiceBus">
			// <file>src/main/synapse-config/proxy-services/proxy1.xml</file>
			// </artifact>
			String[] stringArray = line.split(" ");
			if (line.contains(nameElementEqulasOriginalName)
					&& stringArray[getarrayIndexWithString(nameElement, stringArray)]
							.equals(nameElementEqulasOriginalName)) {
