 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfBeanMediatorOutputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnSource(
			BeanMediatorOutputConnectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(BeanMediatorOutputConnectorEditPart) sourceEditPart,
				targetEditPart);
	}
