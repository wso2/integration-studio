 ...
 * 
 */
public class HeaderMediatorInputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, HeaderMediatorInputConnectorPropertiesEditionPart {
     ...
     */
    public HeaderMediatorInputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createIncomingLinksReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.incomingLinks = new ReferencesTable(
                getDescription(EsbViewsRepository.HeaderMediatorInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(HeaderMediatorInputConnectorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.HeaderMediatorInputConnector.Properties.incomingLinks,
