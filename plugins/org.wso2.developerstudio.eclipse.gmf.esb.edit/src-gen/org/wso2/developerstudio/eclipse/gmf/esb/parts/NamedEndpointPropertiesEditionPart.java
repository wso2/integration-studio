 ...
 * 
 */
public interface NamedEndpointPropertiesEditionPart {
	...
	/**
	 * @return the referringEndpointType
	 * 
	 */
	public Enumerator getReferringEndpointType();

	/**
	 * Init the referringEndpointType
	 * @param input the viewer input
	 * @param current the current value
	 */
	...
	/**
	 * Defines a new referringEndpointType
	 * @param newValue the new referringEndpointType to set
	 * 
	 */
