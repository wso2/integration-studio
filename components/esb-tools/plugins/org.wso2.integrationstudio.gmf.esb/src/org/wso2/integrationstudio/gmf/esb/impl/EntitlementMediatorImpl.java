...
public class EntitlementMediatorImpl extends MediatorImpl implements EntitlementMediator {
    ...
    protected EntitlementMediatorImpl() {
        ...
        IntegrationStudioProviderUtils.addFilter((Map<String, List<String>>) onRejectSequenceKey.getFilters(),
        ...
        IntegrationStudioProviderUtils.addFilter((Map<String, List<String>>) onAcceptSequenceKey.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, ESBMediaTypeConstants.MEDIA_TYPE_SEQUENCE);
        ...
        IntegrationStudioProviderUtils.addFilter((Map<String, List<String>>) adviceSequenceKey.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, ESBMediaTypeConstants.MEDIA_TYPE_SEQUENCE);
        ...
        IntegrationStudioProviderUtils.addFilter((Map<String, List<String>>) obligationsSequenceKey.getFilters(),
                CSProviderConstants.FILTER_MEDIA_TYPE, ESBMediaTypeConstants.MEDIA_TYPE_SEQUENCE);
