 ...
 * 
 */
public class MediatorSequencePropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, MediatorSequencePropertiesEditionPart {
     ...
     */
    public MediatorSequencePropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = mediatorSequenceStep
                .addStep(EsbViewsRepository.MediatorSequence.Properties.class);
    ...
    protected Composite createAnonymousCheckbox(FormToolkit widgetFactory, Composite parent) {
        anonymous = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.MediatorSequence.Properties.anonymous,
                        EsbMessages.MediatorSequencePropertiesEditionPart_AnonymousLabel),
                SWT.CHECK);
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.MediatorSequence.Properties.anonymous, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MediatorSequence.Properties.anonymous, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSequenceNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MediatorSequence.Properties.sequenceName,
                EsbMessages.MediatorSequencePropertiesEditionPart_SequenceNameLabel);
        ...
        sequenceName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MediatorSequencePropertiesEditionPartForm.this,
                            EsbViewsRepository.MediatorSequence.Properties.sequenceName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, sequenceName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MediatorSequencePropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MediatorSequencePropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MediatorSequence.Properties.sequenceName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMediatorsReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.mediators = new ReferencesTable(
                getDescription(EsbViewsRepository.MediatorSequence.Properties.mediators,
                        EsbMessages.MediatorSequencePropertiesEditionPart_MediatorsLabel),
                new ReferencesTableListener() {
                    ...
                    public void handleEdit(EObject element) {
                        editMediators(element);
                    }

                    public void handleMove(EObject element, int oldIndex, int newIndex) {
                        moveMediators(element, oldIndex, newIndex);
                    }

                    public void handleRemove(EObject element) {
                        removeFromMediators(element);
                    }

                    public void navigateTo(EObject element) {
                    }
                });
        this.mediators.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MediatorSequence.Properties.mediators, EsbViewsRepository.FORM_KIND));
        ...
        this.mediators.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MediatorSequencePropertiesEditionPartForm.this,
                            EsbViewsRepository.MediatorSequence.Properties.mediators, PropertiesEditionEvent.CHANGE,
    ...
    protected void addMediators() {
        TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(mediators.getInput(), mediatorsFilters,
                mediatorsBusinessFilters, "mediators",
            ...
            public void process(IStructuredSelection selection) {
                for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MediatorSequencePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MediatorSequence.Properties.mediators,
    ...
    protected void moveMediators(EObject element, int oldIndex, int newIndex) {
        propertiesEditionComponent
                .firePropertiesChanged(new PropertiesEditionEvent(MediatorSequencePropertiesEditionPartForm.this,
                        EsbViewsRepository.MediatorSequence.Properties.mediators, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createOnErrorFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
        createDescription(parent, EsbViewsRepository.MediatorSequence.Properties.onError,
                EsbMessages.MediatorSequencePropertiesEditionPart_OnErrorLabel);
        onError = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
                .isRequired(EsbViewsRepository.MediatorSequence.Properties.onError, EsbViewsRepository.FORM_KIND));
        ...
        onError.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MediatorSequencePropertiesEditionPartForm.this,
                                    EsbViewsRepository.MediatorSequence.Properties.onError,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MediatorSequence.Properties.onError, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MediatorSequence.Properties.description,
                EsbMessages.MediatorSequencePropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MediatorSequencePropertiesEditionPartForm.this,
                            EsbViewsRepository.MediatorSequence.Properties.description, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MediatorSequence.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MediatorSequencePropertiesEditionPart#setAnonymous(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MediatorSequencePropertiesEditionPart#setSequenceName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MediatorSequencePropertiesEditionPart#addFilterMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MediatorSequencePropertiesEditionPart#addBusinessFilterMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MediatorSequencePropertiesEditionPart#isContainedInMediatorsTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MediatorSequencePropertiesEditionPart#setOnError(EObject
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MediatorSequencePropertiesEditionPart#setOnErrorButtonMode(ButtonsModeEnum
     *      newValue)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MediatorSequencePropertiesEditionPart#addFilterOnError(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MediatorSequencePropertiesEditionPart#addBusinessFilterOnError(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MediatorSequencePropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
