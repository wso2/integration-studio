...
public class XQueryVariablePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public XQueryVariablePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject xQueryVariable,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.XQueryVariable.Properties.variableName))
                basePart.setVariableName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        xQueryVariable.getVariableName()));

            if (isAccessible(EsbViewsRepository.XQueryVariable.Properties.variableType)) {
                basePart.initVariableType(
                        EEFUtils.choiceOfValues(xQueryVariable, EsbPackage.eINSTANCE.getXQueryVariable_VariableType()),
                        xQueryVariable.getVariableType());
            }
            if (isAccessible(EsbViewsRepository.XQueryVariable.Properties.valueType)) {
                basePart.initValueType(
                        EEFUtils.choiceOfValues(xQueryVariable, EsbPackage.eINSTANCE.getXQueryVariable_ValueType()),
                        xQueryVariable.getValueType());
            }
            if (isAccessible(EsbViewsRepository.XQueryVariable.Properties.valueLiteral))
                basePart.setValueLiteral(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        xQueryVariable.getValueLiteral()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.XQueryVariable.Properties.variableName == event.getAffectedEditor()) {
            xQueryVariable.setVariableName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.XQueryVariable.Properties.valueLiteral == event.getAffectedEditor()) {
            xQueryVariable.setValueLiteral((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getXQueryVariable_VariableName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.XQueryVariable.Properties.variableName)) {
            ...
            if (EsbPackage.eINSTANCE.getXQueryVariable_VariableType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.XQueryVariable.Properties.variableType))
                basePart.setVariableType((XQueryVariableType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getXQueryVariable_ValueType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.XQueryVariable.Properties.valueType))
                basePart.setValueType((XQueryVariableValueType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getXQueryVariable_ValueLiteral().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.XQueryVariable.Properties.valueLiteral)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getXQueryVariable_ValueExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                ...
                if (EsbViewsRepository.XQueryVariable.Properties.variableName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getXQueryVariable_VariableName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getXQueryVariable_VariableName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.XQueryVariable.Properties.variableType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getXQueryVariable_VariableType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getXQueryVariable_VariableType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.XQueryVariable.Properties.valueType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getXQueryVariable_ValueType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getXQueryVariable_ValueType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.XQueryVariable.Properties.valueLiteral == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getXQueryVariable_ValueLiteral().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getXQueryVariable_ValueLiteral().getEAttributeType(), newValue);
                }
