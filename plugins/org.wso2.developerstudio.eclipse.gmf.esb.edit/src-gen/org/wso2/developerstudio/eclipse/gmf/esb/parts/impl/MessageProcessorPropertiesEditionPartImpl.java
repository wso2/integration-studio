 ...
 * 
 */
public class MessageProcessorPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, MessageProcessorPropertiesEditionPart {
	...
	protected Composite createDescriptionText(Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.description, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCommentsListMultiValuedEditor(Composite parent) {
		...
		editCommentsList.setText(getDescription(EsbViewsRepository.MessageProcessor.Properties.commentsList, EsbMessages.MessageProcessorPropertiesEditionPart_CommentsListLabel));
		...
		editCommentsList.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.commentsList, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(commentsListList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createProcessorNameText(Composite parent) {
		...
		processorName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.processorName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, processorName.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.processorName, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createProcessorTypeEMFComboViewer(Composite parent) {
		...
		processorType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.processorType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getProcessorType()));
			}

		});
		processorType.setID(EsbViewsRepository.MessageProcessor.Properties.processorType);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.processorType, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMessageProcessorProviderText(Composite parent) {
		...
		messageProcessorProvider.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.messageProcessorProvider, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, messageProcessorProvider.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.messageProcessorProvider, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMessageStoreText(Composite parent) {
		...
		messageStore.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.messageStore, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, messageStore.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.messageStore, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createSourceMessageStoreText(Composite parent) {
		...
		sourceMessageStore.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.sourceMessageStore, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, sourceMessageStore.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.sourceMessageStore, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTargetMessageStoreText(Composite parent) {
		...
		targetMessageStore.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.targetMessageStore, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, targetMessageStore.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.targetMessageStore, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createProcessorStateEMFComboViewer(Composite parent) {
		...
		processorState.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.processorState, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getProcessorState()));
			}

		});
		processorState.setID(EsbViewsRepository.MessageProcessor.Properties.processorState);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.processorState, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createRetryIntervalText(Composite parent) {
		...
		retryInterval.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.retryInterval, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, retryInterval.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.retryInterval, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createForwardingIntervalText(Composite parent) {
		...
		forwardingInterval.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.forwardingInterval, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, forwardingInterval.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.forwardingInterval, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createSamplingIntervalText(Composite parent) {
		...
		samplingInterval.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.samplingInterval, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, samplingInterval.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.samplingInterval, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createSamplingConcurrencyText(Composite parent) {
		...
		samplingConcurrency.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.samplingConcurrency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, samplingConcurrency.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.samplingConcurrency, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMaxDeliveryAttemptsText(Composite parent) {
		...
		maxDeliveryAttempts.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.maxDeliveryAttempts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, maxDeliveryAttempts.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.maxDeliveryAttempts, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDropMessageAfterMaximumDeliveryAttemptsEMFComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.dropMessageAfterMaximumDeliveryAttempts, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createAxis2ClientRepositoryText(Composite parent) {
		...
		axis2ClientRepository.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.axis2ClientRepository, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, axis2ClientRepository.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.axis2ClientRepository, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createAxis2ConfigurationText(Composite parent) {
		...
		axis2Configuration.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.axis2Configuration, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, axis2Configuration.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.axis2Configuration, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createQuartzConfigFilePathText(Composite parent) {
		...
		quartzConfigFilePath.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.quartzConfigFilePath, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, quartzConfigFilePath.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.quartzConfigFilePath, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCronExpressionText(Composite parent) {
		...
		cronExpression.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.cronExpression, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, cronExpression.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.cronExpression, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createNonRetryHttpStatusCodesText(Composite parent) {
		...
		nonRetryHttpStatusCodes.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.nonRetryHttpStatusCodes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, nonRetryHttpStatusCodes.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.nonRetryHttpStatusCodes, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createParametersAdvancedTableComposition(Composite parent) {
		this.parameters = new ReferencesTable(getDescription(EsbViewsRepository.MessageProcessor.Properties.parameters, EsbMessages.MessageProcessorPropertiesEditionPart_ParametersLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.parameters, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				parameters.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.parameters, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				parameters.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.parameters, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				parameters.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.parameters, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				parameters.refresh();
			}
		...
		this.parameters.setHelpText(propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.parameters, EsbViewsRepository.SWT_KIND));
		this.parameters.createControls(parent);
		this.parameters.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.parameters, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createTaskCountText(Composite parent) {
		...
		taskCount.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.taskCount, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, taskCount.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.taskCount, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMaxStoreConnectionAttemptsText(Composite parent) {
		...
		maxStoreConnectionAttempts.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.maxStoreConnectionAttempts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, maxStoreConnectionAttempts.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.maxStoreConnectionAttempts, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStoreConnectionIntervalText(Composite parent) {
		...
		storeConnectionInterval.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.storeConnectionInterval, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, storeConnectionInterval.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.storeConnectionInterval, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createFailMessagesStoreText(Composite parent) {
		...
		failMessagesStore.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MessageProcessorPropertiesEditionPartImpl.this, EsbViewsRepository.MessageProcessor.Properties.failMessagesStore, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, failMessagesStore.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MessageProcessor.Properties.failMessagesStore, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setDescription(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setCommentsList(EList newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setProcessorName(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#initProcessorType(Object input, Enumerator current)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setProcessorType(Enumerator newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setMessageProcessorProvider(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setMessageStore(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setSourceMessageStore(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setTargetMessageStore(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#initProcessorState(Object input, Enumerator current)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setProcessorState(Enumerator newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setRetryInterval(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setForwardingInterval(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setSamplingInterval(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setSamplingConcurrency(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setMaxDeliveryAttempts(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#initDropMessageAfterMaximumDeliveryAttempts(Object input, Enumerator current)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setDropMessageAfterMaximumDeliveryAttempts(Enumerator newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setAxis2ClientRepository(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setAxis2Configuration(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setQuartzConfigFilePath(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setCronExpression(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setNonRetryHttpStatusCodes(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#initParameters(EObject current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#addFilterParameters(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#addBusinessFilterParameters(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#isContainedInParametersTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setTaskCount(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setMaxStoreConnectionAttempts(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setStoreConnectionInterval(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MessageProcessorPropertiesEditionPart#setFailMessagesStore(String newValue)
	 * 
	 */
