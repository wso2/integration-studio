...
import org.wso2.integrationstudio.datamapper.diagram.edit.policies.CompareCanonicalEditPolicy;
import org.wso2.integrationstudio.datamapper.diagram.edit.policies.CompareItemSemanticEditPolicy;
import org.wso2.integrationstudio.datamapper.impl.CompareImpl;

/**
 * @generated NOT
 */
public class CompareEditPart extends AbstractOperatorEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CompareItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new CompareCanonicalEditPolicy());
	...
	public class CompareFigure extends OperatorRectangle {
		...
		public IFigure getToolTip() {
			return new Label("Compare Operation");
		}
