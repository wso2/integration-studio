 ...
 */
public class CustomUpdateWizardDialog extends WizardDialog {
    private final String UPDATE_BUTTON = "Update";

    public CustomUpdateWizardDialog(Shell parentShell, IWizard newWizard) {
    ...
    public void createButtonsForButtonBar(Composite parent) {
        ...
        finishButton.setText(UPDATE_BUTTON);
    }
}
