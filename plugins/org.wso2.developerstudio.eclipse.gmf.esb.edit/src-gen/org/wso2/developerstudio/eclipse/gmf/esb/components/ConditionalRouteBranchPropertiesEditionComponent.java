...
public class ConditionalRouteBranchPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ConditionalRouteBranchPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject conditionalRouteBranch, String editing_mode) {
        ...
        if (EsbViewsRepository.ConditionalRouteBranch.evaluatorExpression == event.getAffectedEditor()) {
            ...
            if (event.getNewValue() != null) {
                ...
                conditionalRouteBranch
                        .setEvaluatorExpression(EsbFactoryImpl.eINSTANCE.createEvaluatorExpressionProperty());
            }
            // End of user code
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getConditionalRouteBranch_BreakAfterRoute().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ConditionalRouteBranch.Properties.breakAfterRoute))
                ...
                if (EsbViewsRepository.ConditionalRouteBranch.Properties.breakAfterRoute == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getConditionalRouteBranch_BreakAfterRoute().getEAttributeType(),
                                (String) newValue);
                    }
