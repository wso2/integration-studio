...
public class SendMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
    ...
    protected Composite createReceivingSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        receivingSequenceSubsection = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent,
                "Receiving Sequence", true);
    ...
    */
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.SendMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.SendMediator.Properties.reverse,
                EsbMessages.SendMediatorPropertiesEditionPart_ReverseLabel), SWT.CHECK);
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SendMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDynamicReceivingSequence(FormToolkit widgetFactory, final Composite parent) {
        Control dynamicReceivingSequenceLabel = createDescription(parent,
                EsbViewsRepository.SendMediator.Properties.dynamicReceivingSequence, "Dynamic Receiving Sequence");
        widgetFactory.paintBordersFor(parent);
    ...
    protected Composite createStaticReceivingSequence(FormToolkit widgetFactory, final Composite parent) {
        Control staticReceivingSequenceLabel = createDescription(parent,
                EsbViewsRepository.SendMediator.Properties.staticReceivingSequence, "Static Receiving Sequence");
        widgetFactory.paintBordersFor(parent);
        if (staticReceivingSequence == null) {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, staticReceivingSequence,
    ...
    private void openDynamicReceivingSequenceNamespacedPropertyEditor(final Composite parent) {
        EEFNameSpacedPropertyEditorDialog nspd = new EEFNameSpacedPropertyEditorDialog(parent.getShell(), SWT.NULL,
                dynamicReceivingSequence);
        dynamicReceivingSequence = nspd.open();
        dynamicReceivingSequenceText.setText(dynamicReceivingSequence.getPropertyValue());
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                SendMediatorPropertiesEditionPartForm.this,
                EsbViewsRepository.SendMediator.Properties.dynamicReceivingSequence, PropertiesEditionEvent.COMMIT,
                PropertiesEditionEvent.SET, null, getDynamicReceivingSequence()));
    }
