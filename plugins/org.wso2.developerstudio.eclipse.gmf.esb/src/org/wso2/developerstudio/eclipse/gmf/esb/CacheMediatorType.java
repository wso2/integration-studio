...
public enum CacheMediatorType implements Enumerator {
     ...
     * @generated
     */
    private static final CacheMediatorType[] VALUES_ARRAY = new CacheMediatorType[] { DEFAULT, COMPATIBILITY_611, };
    ...
    public static CacheMediatorType get(int value) {
        ...
        case DEFAULT_VALUE:
            return DEFAULT;
        case COMPATIBILITY_611_VALUE:
            return COMPATIBILITY_611;
        }
        return null;
    }
