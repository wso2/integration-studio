 ...
 * 
 */
public class URLRewriteRuleActionPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, URLRewriteRuleActionPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        CompositionStep propertiesStep = uRLRewriteRuleActionStep
                .addStep(EsbViewsRepository.URLRewriteRuleAction.Properties.class);
    ...
    protected Composite createRuleActionEMFComboViewer(Composite parent) {
        Control ruleActionLabel = createDescription(parent,
                EsbViewsRepository.URLRewriteRuleAction.Properties.ruleAction,
                EsbMessages.URLRewriteRuleActionPropertiesEditionPart_RuleActionLabel);
                ...
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(URLRewriteRuleActionPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.URLRewriteRuleAction.Properties.ruleAction,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getRuleAction()));
            }

        });
        ruleAction.setID(EsbViewsRepository.URLRewriteRuleAction.Properties.ruleAction);
        Control ruleActionHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.URLRewriteRuleAction.Properties.ruleAction, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
        // Start of user code for createRuleActionEMFComboViewer
        ruleActionElements = new Control[] { ruleActionLabel, ruleActionHelp, ruleAction.getCombo() };
        // End of user code
        return parent;
    }
    ...
    protected Composite createRuleFragmentEMFComboViewer(Composite parent) {
        Control ruleFragmentLabel = createDescription(parent,
                EsbViewsRepository.URLRewriteRuleAction.Properties.ruleFragment,
                EsbMessages.URLRewriteRuleActionPropertiesEditionPart_RuleFragmentLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.URLRewriteRuleAction.Properties.ruleFragment,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getRuleFragment()));
            }

        });
        ruleFragment.setID(EsbViewsRepository.URLRewriteRuleAction.Properties.ruleFragment);
        Control ruleFragmentHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.URLRewriteRuleAction.Properties.ruleFragment, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createRuleFragmentEMFComboViewer
        ruleFragmentElements = new Control[] { ruleFragmentLabel, ruleFragmentHelp, ruleFragment.getCombo() };
        // End of user code
        return parent;
    }
    ...
    protected Composite createRuleOptionEMFComboViewer(Composite parent) {
        Control ruleOptionLabel = createDescription(parent,
                EsbViewsRepository.URLRewriteRuleAction.Properties.ruleOption,
                EsbMessages.URLRewriteRuleActionPropertiesEditionPart_RuleOptionLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(URLRewriteRuleActionPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.URLRewriteRuleAction.Properties.ruleOption,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getRuleOption()));
            }

        });
        ruleOption.setID(EsbViewsRepository.URLRewriteRuleAction.Properties.ruleOption);
        Control ruleOptionHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.URLRewriteRuleAction.Properties.ruleOption, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createActionValueText(Composite parent) {
        Control actionValueLabel = createDescription(parent,
                EsbViewsRepository.URLRewriteRuleAction.Properties.actionValue,
                EsbMessages.URLRewriteRuleActionPropertiesEditionPart_ActionValueLabel);
        ...
        Control actionValueHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.URLRewriteRuleAction.Properties.actionValue, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createActionRegexText(Composite parent) {
        Control actionRegexLabel = createDescription(parent,
                EsbViewsRepository.URLRewriteRuleAction.Properties.actionRegex,
                EsbMessages.URLRewriteRuleActionPropertiesEditionPart_ActionRegexLabel);
        ...
        Control actionRegexHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.URLRewriteRuleAction.Properties.actionRegex, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteRuleActionPropertiesEditionPart#initRuleAction(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteRuleActionPropertiesEditionPart#setRuleAction(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteRuleActionPropertiesEditionPart#initRuleFragment(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteRuleActionPropertiesEditionPart#setRuleFragment(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteRuleActionPropertiesEditionPart#initRuleOption(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteRuleActionPropertiesEditionPart#setRuleOption(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteRuleActionPropertiesEditionPart#setActionValue(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.URLRewriteRuleActionPropertiesEditionPart#setActionRegex(String
     *      newValue)
     * 
     */
    ...
    protected Composite createActionExpressionText(final Composite parent) {
        ...
        actionExpressionText.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            URLRewriteRuleActionPropertiesEditionPartImpl.this,
                            EsbViewsRepository.URLRewriteRuleAction.Properties.actionExpression,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getActionExpression()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(URLRewriteRuleActionPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.URLRewriteRuleAction.Properties.actionExpression,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            URLRewriteRuleActionPropertiesEditionPartImpl.this, null,
        ...
        Control actionExpressionHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.URLRewriteRuleAction.Properties.actionExpression,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        actionExpressionElements = new Control[] { actionExpressionLabel, actionExpressionText, actionExpressionHelp };
