...
public class TaskPropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public TaskPropertyPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject taskProperty,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.TaskProperty.Properties.propertyType)) {
                basePart.initPropertyType(
                        EEFUtils.choiceOfValues(taskProperty,
                                EsbPackage.eINSTANCE.getNameValueTypeProperty_PropertyType()),
                        taskProperty.getPropertyType());
            }
            // init filters
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.TaskProperty.Properties.propertyName == event.getAffectedEditor()) {
            taskProperty.setPropertyName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.TaskProperty.Properties.propertyValue == event.getAffectedEditor()) {
            taskProperty.setPropertyValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getNameValueTypeProperty_PropertyName().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.TaskProperty.Properties.propertyName)) {
            ...
            if (EsbPackage.eINSTANCE.getNameValueTypeProperty_PropertyValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TaskProperty.Properties.propertyValue)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getNameValueTypeProperty_PropertyType().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.TaskProperty.Properties.propertyType))
