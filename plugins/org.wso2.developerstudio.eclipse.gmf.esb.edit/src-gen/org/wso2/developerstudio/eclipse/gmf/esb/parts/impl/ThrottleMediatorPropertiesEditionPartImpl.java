 ...
 * 
 */
public class ThrottleMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ThrottleMediatorPropertiesEditionPart {
        ...
        composer = new PartComposer(throttleMediatorStep) {
            ...
            public Composite addToPart(Composite parent, Object key) {
                ...
                if (key == EsbViewsRepository.ThrottleMediator.OnReject.class) {
                    // FIXME INVALID CASE INTO template public implementation(editor : ViewElement) in SWT Impl for
                    // ViewElement onReject
                }
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.ThrottleMediator.General.commentsList,
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ThrottleMediatorPropertiesEditionPartImpl.this,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.ThrottleMediator.General.reverse,
                EsbMessages.ThrottleMediatorPropertiesEditionPart_ReverseLabel));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ThrottleMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottleMediator.General.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createGroupIdText(Composite parent) {
        createDescription(parent, EsbViewsRepository.ThrottleMediator.General.groupId,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottleMediator.General.groupId, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.ThrottleMediator.Misc.description,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottleMediator.Misc.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOnAcceptBranchsequenceTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.ThrottleMediator.OnAccept.onAcceptBranchsequenceType,
    ...
    // PropertiesEditionComponent, inputPEC : PropertiesEditionComponent) in SWT Impl for ViewElement onReject

    /**
     * @generated NOT
     */
    protected Composite createOnRejectBranchsequenceTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.ThrottleMediator.OnReject.onRejectBranchsequenceType,
    ...
    protected Composite createPolicyTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMaxConcurrentAccessCountText(Composite parent) {
        createDescription(parent, EsbViewsRepository.ThrottleMediator.ThrottlePolicy.maxConcurrentAccessCount,
    ...
    protected Composite createPolicyEntriesAdvancedTableComposition(Composite parent) {
        ...
        this.policyEntries.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyEntries, EsbViewsRepository.SWT_KIND));
