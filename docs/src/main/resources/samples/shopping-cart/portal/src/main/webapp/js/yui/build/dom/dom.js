    ...
    Y.Dom = {
            ...
            if (el) {
                ...
                if (typeof el === 'string') { // id
                    ...
                    if (el && attr && attr.id && attr.id.value === id) { // IE: avoid false match on "name" attribute
                        ...
                        if (el && document.all) { // filter by name
                            el = null;
        ...
        _getXY: function() {
            if (document[DOCUMENT_ELEMENT][GET_BOUNDING_CLIENT_RECT]) {
                ...
                return function(
                        node) { // ff2, safari: manually calculate by crawling up offsetParents
        ...
        isAncestor: function(haystack, needle) {
            ...
            if ((haystack && needle) && (haystack[NODE_TYPE] && needle[NODE_TYPE])) {
                if (haystack.contains && haystack !== needle) { // contains returns true when equal
                    ...
                    if (haystack.compareDocumentPosition) { // gecko
                ...
                get: function(el, property) {
                    ...
                    if (property === OPACITY) {
                        ...
                        if (!current || (current.indexOf && current.indexOf(PX) > -1)) { // no need to convert
                            ...
                            if (Y.Dom.IE_COMPUTED[property]) { // use compute function
