 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfMessageInputConnectorEditPart extends
	...
	public List<IElementType> doGetRelTypesOnTarget(
			MessageInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(MessageInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
	...
	public List<IElementType> doGetTypesForSource(
			MessageInputConnectorEditPart target, IElementType relationshipType) {
