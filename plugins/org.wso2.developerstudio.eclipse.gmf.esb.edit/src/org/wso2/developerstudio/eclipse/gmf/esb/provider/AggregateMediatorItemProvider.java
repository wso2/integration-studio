...
public class AggregateMediatorItemProvider extends MediatorItemProvider {
    ...
    protected void addAggregationExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_AggregateMediator_aggregationExpression_feature",
                        "_UI_AggregateMediator_type"),
                EsbPackage.Literals.AGGREGATE_MEDIATOR__AGGREGATION_EXPRESSION, true, false, false, null,
                getString("_UI_onCompletePropertyCategory"), null));
    }
    ...
    protected void addSequenceTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AggregateMediator_sequenceType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_AggregateMediator_sequenceType_feature",
                                "_UI_AggregateMediator_type"),
                        EsbPackage.Literals.AGGREGATE_MEDIATOR__SEQUENCE_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_onCompletePropertyCategory"), null));
    }
    ...
    protected void addSequenceKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AggregateMediator_sequenceKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_AggregateMediator_sequenceKey_feature",
                                "_UI_AggregateMediator_type"),
                        EsbPackage.Literals.AGGREGATE_MEDIATOR__SEQUENCE_KEY, true, false, false, null,
                        getString("_UI_onCompletePropertyCategory"), null));
    }
    ...
    protected void addEnclosingElementPropertyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_AggregateMediator_enclosingElementProperty_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_AggregateMediator_enclosingElementProperty_feature", "_UI_AggregateMediator_type"),
                        EsbPackage.Literals.AGGREGATE_MEDIATOR__ENCLOSING_ELEMENT_PROPERTY, true, false, false,
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.AGGREGATE_MEDIATOR__CORRELATION_EXPRESSION,
                EsbFactory.eINSTANCE.createNamespacedProperty()));

        newChildDescriptors
                .add(createChildParameter(EsbPackage.Literals.AGGREGATE_MEDIATOR__COMPLETION_MIN_MESSAGES_EXPRESSION,
                        EsbFactory.eINSTANCE.createNamespacedProperty()));

        newChildDescriptors
                .add(createChildParameter(EsbPackage.Literals.AGGREGATE_MEDIATOR__COMPLETION_MAX_MESSAGES_EXPRESSION,
                        EsbFactory.eINSTANCE.createNamespacedProperty()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.AGGREGATE_MEDIATOR__INPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createAggregateMediatorInputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.AGGREGATE_MEDIATOR__OUTPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createAggregateMediatorOutputConnector()));

        newChildDescriptors
                .add(createChildParameter(EsbPackage.Literals.AGGREGATE_MEDIATOR__ON_COMPLETE_OUTPUT_CONNECTOR,
                        EsbFactory.eINSTANCE.createAggregateMediatorOnCompleteOutputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.AGGREGATE_MEDIATOR__MEDIATOR_FLOW,
                EsbFactory.eINSTANCE.createMediatorFlow()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.AGGREGATE_MEDIATOR__AGGREGATION_EXPRESSION,
                EsbFactory.eINSTANCE.createNamespacedProperty()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.AGGREGATE_MEDIATOR__SEQUENCE_KEY,
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify = childFeature == EsbPackage.Literals.AGGREGATE_MEDIATOR__CORRELATION_EXPRESSION
