 ...
 * 
 */
public class RouterRoutePropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, RouterRoutePropertiesEditionPart {
     ...
     */
    public RouterRoutePropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createBreakAfterRouteCheckbox(FormToolkit widgetFactory, Composite parent) {
        breakAfterRoute = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.RouterRoute.Properties.breakAfterRoute,
                        EsbMessages.RouterRoutePropertiesEditionPart_BreakAfterRouteLabel),
                SWT.CHECK);
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.RouterRoute.Properties.breakAfterRoute, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new Boolean(breakAfterRoute.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterRoute.Properties.breakAfterRoute, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRouteExpressionFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
        createDescription(parent, EsbViewsRepository.RouterRoute.Properties.routeExpression,
                EsbMessages.RouterRoutePropertiesEditionPart_RouteExpressionLabel);
        routeExpression = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
                .isRequired(EsbViewsRepository.RouterRoute.Properties.routeExpression, EsbViewsRepository.FORM_KIND));
        ...
        routeExpression.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RouterRoutePropertiesEditionPartForm.this,
                            EsbViewsRepository.RouterRoute.Properties.routeExpression, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getRouteExpression()));
            }

        });
        routeExpression.setID(EsbViewsRepository.RouterRoute.Properties.routeExpression);
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterRoute.Properties.routeExpression, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRoutePatternText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RouterRoute.Properties.routePattern,
                EsbMessages.RouterRoutePropertiesEditionPart_RoutePatternLabel);
        ...
        routePattern.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RouterRoutePropertiesEditionPartForm.this,
                            EsbViewsRepository.RouterRoute.Properties.routePattern, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, routePattern.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(RouterRoutePropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RouterRoutePropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterRoute.Properties.routePattern, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterRoutePropertiesEditionPart#setBreakAfterRoute(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterRoutePropertiesEditionPart#setRouteExpression(EObject
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterRoutePropertiesEditionPart#setRouteExpressionButtonMode(ButtonsModeEnum
     *      newValue)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterRoutePropertiesEditionPart#addFilterRouteExpression(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterRoutePropertiesEditionPart#addBusinessFilterRouteExpression(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterRoutePropertiesEditionPart#setRoutePattern(String
     *      newValue)
     * 
     */
