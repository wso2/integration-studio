...
public class CallTemplateMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public CallTemplateMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject callTemplateMediator, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.CallTemplateMediator.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        callTemplateMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.CallTemplateMediator.Properties.availableTemplates))
                basePart.setAvailableTemplates(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        callTemplateMediator.getAvailableTemplates()));

            if (isAccessible(EsbViewsRepository.CallTemplateMediator.Properties.templateParameters)) {
                templateParametersSettings = new ReferencesTableSettings(callTemplateMediator,
            ...
            if (isAccessible(EsbViewsRepository.CallTemplateMediator.Properties.targetTemplate))
                basePart.setTargetTemplate(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        callTemplateMediator.getTargetTemplate()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.CallTemplateMediator.Properties.description == event.getAffectedEditor()) {
            callTemplateMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.CallTemplateMediator.Properties.availableTemplates == event.getAffectedEditor()) {
            callTemplateMediator.setAvailableTemplates((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.CallTemplateMediator.Properties.targetTemplate == event.getAffectedEditor()) {
            callTemplateMediator.setTargetTemplate((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.CallTemplateMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CallTemplateMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CallTemplateMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCallTemplateMediator_AvailableTemplates().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CallTemplateMediator.Properties.availableTemplates)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCallTemplateMediator_TemplateParameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.CallTemplateMediator.Properties.templateParameters))
                basePart.updateTemplateParameters();
            if (EsbPackage.eINSTANCE.getCallTemplateMediator_TargetTemplate().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CallTemplateMediator.Properties.targetTemplate)) {
                if (msg.getNewValue() != null) {
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.CallTemplateMediator.Properties.availableTemplates == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCallTemplateMediator_AvailableTemplates().getEAttributeType(),
                                (String) newValue);
                    }
                ...
                if (EsbViewsRepository.CallTemplateMediator.Properties.targetTemplate == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCallTemplateMediator_TargetTemplate().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCallTemplateMediator_TargetTemplate().getEAttributeType(),
