...
public class LoadBalanceEndPointPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public LoadBalanceEndPointPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject loadBalanceEndPoint, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        loadBalanceEndPoint.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.endPointName))
                basePart.setEndPointName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        loadBalanceEndPoint.getEndPointName()));
            ...
            if (isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.properties_)) {
                propertiesSettings = new ReferencesTableSettings(loadBalanceEndPoint,
            ...
            if (isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.children)) {
                childrenSettings = new ReferencesTableSettings(loadBalanceEndPoint,
            ...
            if (isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.name))
                basePart.setName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, loadBalanceEndPoint.getName()));
            ...
            if (isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.policy))
                basePart.setPolicy(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        loadBalanceEndPoint.getPolicy()));

            if (isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.outputConnector)) {
                outputConnectorSettings = new ReferencesTableSettings(loadBalanceEndPoint,
            ...
            if (isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionType)) {
                basePart.initSessionType(
                        EEFUtils.choiceOfValues(loadBalanceEndPoint,
                                EsbPackage.eINSTANCE.getLoadBalanceEndPoint_SessionType()),
                        loadBalanceEndPoint.getSessionType());
            }
            if (isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.algorithm))
                basePart.setAlgorithm(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        loadBalanceEndPoint.getAlgorithm()));

            if (isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionTimeout)) {
                basePart.setSessionTimeout(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        loadBalanceEndPoint.getSessionTimeout()));
            }
            ...
            if (isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.outputConnector)) {
                basePart.addFilterToOutputConnector(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof LoadBalanceEndPointOutputConnector);
                    }
            ...
            if (isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.members)) {
                membersSettings = new ReferencesTableSettings(loadBalanceEndPoint,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.LoadBalanceEndPoint.Properties.description == event.getAffectedEditor()) {
            loadBalanceEndPoint.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.LoadBalanceEndPoint.Properties.endPointName == event.getAffectedEditor()) {
            loadBalanceEndPoint.setEndPointName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.LoadBalanceEndPoint.Properties.name == event.getAffectedEditor()) {
            loadBalanceEndPoint.setName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.LoadBalanceEndPoint.Properties.policy == event.getAffectedEditor()) {
            loadBalanceEndPoint.setPolicy((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.LoadBalanceEndPoint.Properties.outputConnector == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, outputConnectorSettings, editingContext.getAdapterFactory());
                PropertiesEditingProvider provider = (PropertiesEditingProvider) editingContext.getAdapterFactory()
                        .adapt(semanticObject, PropertiesEditingProvider.class);
                if (provider != null) {
                    PropertiesEditingPolicy policy = provider.getPolicy(context);
                ...
                outputConnectorSettings.move(event.getNewIndex(),
                        (LoadBalanceEndPointOutputConnector) event.getNewValue());
            }
        }
        ...
        if (EsbViewsRepository.LoadBalanceEndPoint.Properties.algorithm == event.getAffectedEditor()) {
            loadBalanceEndPoint.setAlgorithm((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionTimeout == event.getAffectedEditor()) {
            loadBalanceEndPoint.setSessionTimeout(
        ...
        if (EsbViewsRepository.LoadBalanceEndPoint.Properties.members == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, membersSettings, editingContext.getAdapterFactory());
                PropertiesEditingProvider provider = (PropertiesEditingProvider) editingContext.getAdapterFactory()
                        .adapt(semanticObject, PropertiesEditingProvider.class);
                if (provider != null) {
                    PropertiesEditingPolicy policy = provider.getPolicy(context);
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getEndPoint_EndPointName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.endPointName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEndPoint_Anonymous().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.anonymous))
                basePart.setAnonymous((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEndPoint_InLine().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.inLine))
                basePart.setInLine((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEndPoint_Duplicate().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.duplicate))
                basePart.setDuplicate((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEndPoint_Properties().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.properties_))
                basePart.updateProperties();
            if (EsbPackage.eINSTANCE.getEndPoint_Reversed().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.reversed))
                basePart.setReversed((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getParentEndPoint_Children().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.children))
                basePart.updateChildren();
            if (EsbPackage.eINSTANCE.getParentEndPoint_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.name)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getLoadBalanceEndPoint_Failover().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.failover))
                basePart.setFailover((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getLoadBalanceEndPoint_Policy().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.policy)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getLoadBalanceEndPoint_OutputConnector().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.outputConnector))
                basePart.updateOutputConnector();
            if (EsbPackage.eINSTANCE.getLoadBalanceEndPoint_SessionType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionType))
                basePart.setSessionType((LoadBalanceSessionType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getLoadBalanceEndPoint_Algorithm().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.algorithm)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getLoadBalanceEndPoint_SessionTimeout().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionTimeout)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getLoadBalanceEndPoint_BuildMessage().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.buildMessage))
                basePart.setBuildMessage((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getLoadBalanceEndPoint_Member().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.LoadBalanceEndPoint.Properties.members))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getParentEndPoint_Children(), EsbPackage.eINSTANCE.getParentEndPoint_Name(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.LoadBalanceEndPoint.Properties.name == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getParentEndPoint_Name().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getParentEndPoint_Name().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.LoadBalanceEndPoint.Properties.failover == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getLoadBalanceEndPoint_Failover().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getLoadBalanceEndPoint_Failover().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.LoadBalanceEndPoint.Properties.policy == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getLoadBalanceEndPoint_Policy().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getLoadBalanceEndPoint_Policy().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getLoadBalanceEndPoint_SessionType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getLoadBalanceEndPoint_SessionType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.LoadBalanceEndPoint.Properties.algorithm == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getLoadBalanceEndPoint_Algorithm().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getLoadBalanceEndPoint_Algorithm().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.LoadBalanceEndPoint.Properties.sessionTimeout == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getLoadBalanceEndPoint_SessionTimeout().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getLoadBalanceEndPoint_SessionTimeout().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.LoadBalanceEndPoint.Properties.buildMessage == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getLoadBalanceEndPoint_BuildMessage().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getLoadBalanceEndPoint_BuildMessage().getEAttributeType(), newValue);
                }
