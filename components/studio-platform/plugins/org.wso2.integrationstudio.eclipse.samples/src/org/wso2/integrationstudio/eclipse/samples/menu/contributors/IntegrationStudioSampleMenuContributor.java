...
public class IntegrationStudioSampleMenuContributor extends CompoundContributionItem {
	...
	private void addActionContributionItems(List<IContributionItem> actionsList) {
		...
		for (IIntegrationStudioSampleContributor sampleContributor : samples) {
	...
	private IProject getProject(IIntegrationStudioSampleContributor contributor){
...
//			return wizard.getNewProject();
	...
	private String getProjectName(IIntegrationStudioSampleContributor contributor) {
