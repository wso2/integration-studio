...
import org.wso2.integrationstudio.gmf.esb.parts.XSLTResourcePropertiesEditionPart;
...
public class XSLTResourcePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, XSLTResourcePropertiesEditionPart {
	 ...
	 */
	public XSLTResourcePropertiesEditionPartForm() { super(); }
	...
	protected Composite createLocationText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							EsbViewsRepository.XSLTResource.Properties.location,
		...
		location.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(XSLTResourcePropertiesEditionPartForm.this, EsbViewsRepository.XSLTResource.Properties.location, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, location.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.XSLTResource.Properties.location, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.XSLTResourcePropertiesEditionPart#getLocation()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.XSLTResourcePropertiesEditionPart#setLocation(String newValue)
	 * 
	 */
