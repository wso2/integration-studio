...
public class APIHandlerPropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public APIHandlerPropertyPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject aPIHandlerProperty, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.APIHandlerProperty.Properties.name))
                basePart.setName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, aPIHandlerProperty.getName()));

            if (isAccessible(EsbViewsRepository.APIHandlerProperty.Properties.value))
                basePart.setValue(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, aPIHandlerProperty.getValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.APIHandlerProperty.Properties.name == event.getAffectedEditor()) {
            aPIHandlerProperty.setName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.APIHandlerProperty.Properties.value == event.getAffectedEditor()) {
            aPIHandlerProperty.setValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAPIHandlerProperty_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIHandlerProperty.Properties.name)) {
            ...
            if (EsbPackage.eINSTANCE.getAPIHandlerProperty_Value().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIHandlerProperty.Properties.value)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                EsbPackage.eINSTANCE.getAPIHandlerProperty_Name(), EsbPackage.eINSTANCE.getAPIHandlerProperty_Value());
                ...
                if (EsbViewsRepository.APIHandlerProperty.Properties.name == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIHandlerProperty_Name().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getAPIHandlerProperty_Name().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIHandlerProperty.Properties.value == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIHandlerProperty_Value().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getAPIHandlerProperty_Value().getEAttributeType(), newValue);
                }
