...
public class PayloadFactoryArgumentPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public PayloadFactoryArgumentPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject payloadFactoryArgument, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.PayloadFactoryArgument.Properties.argumentType)) {
                basePart.initArgumentType(
                        EEFUtils.choiceOfValues(payloadFactoryArgument,
                                EsbPackage.eINSTANCE.getPayloadFactoryArgument_ArgumentType()),
                        payloadFactoryArgument.getArgumentType());
            }
            if (isAccessible(EsbViewsRepository.PayloadFactoryArgument.Properties.argumentValue))
                basePart.setArgumentValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        payloadFactoryArgument.getArgumentValue()));

            if (isAccessible(EsbViewsRepository.PayloadFactoryArgument.Properties.evaluator)) {
                basePart.initEvaluator(
                        EEFUtils.choiceOfValues(payloadFactoryArgument,
                                EsbPackage.eINSTANCE.getPayloadFactoryArgument_Evaluator()),
                        payloadFactoryArgument.getEvaluator());
            }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.PayloadFactoryArgument.Properties.argumentValue == event.getAffectedEditor()) {
            payloadFactoryArgument.setArgumentValue((java.lang.String) EEFConverterUtil
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getPayloadFactoryArgument_ArgumentType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.PayloadFactoryArgument.Properties.argumentType))
                basePart.setArgumentType((PayloadFactoryArgumentType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getPayloadFactoryArgument_ArgumentValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PayloadFactoryArgument.Properties.argumentValue)) {
            ...
            if (EsbPackage.eINSTANCE.getPayloadFactoryArgument_Evaluator().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.PayloadFactoryArgument.Properties.evaluator))
                basePart.setEvaluator((MediaType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getPayloadFactoryArgument_Literal().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PayloadFactoryArgument.Properties.literal))
                basePart.setLiteral((Boolean) msg.getNewValue());

            // Start of user code for argumentExpression live update
            if (EsbPackage.eINSTANCE.getPayloadFactoryArgument_ArgumentExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.PayloadFactoryArgument.Properties.argumentExpression)) {
                if (msg.getNewValue() != null) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.PayloadFactoryArgument.Properties.argumentType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPayloadFactoryArgument_ArgumentType().getEAttributeType(),
                                (String) newValue);
                    }
                ...
                if (EsbViewsRepository.PayloadFactoryArgument.Properties.argumentValue == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPayloadFactoryArgument_ArgumentValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPayloadFactoryArgument_ArgumentValue().getEAttributeType(),
                ...
                if (EsbViewsRepository.PayloadFactoryArgument.Properties.evaluator == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPayloadFactoryArgument_Evaluator().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPayloadFactoryArgument_Evaluator().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.PayloadFactoryArgument.Properties.literal == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getPayloadFactoryArgument_Literal().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getPayloadFactoryArgument_Literal().getEAttributeType(), newValue);
                }
