 ...
 * {@link org.wso2.developerstudio.eclipse.ds.QueryParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class QueryParameterItemProvider extends ItemProviderAdapter implements
	...
	protected void addDefaultValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
		                                                         ...
		                                                         getString("_UI_PropertyDescriptor_description",
		                                                                   "_UI_QueryParameter_defaultValue_feature",
		                                                                   "_UI_QueryParameter_type"),
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
		                                                         ...
		                                                         getString("_UI_PropertyDescriptor_description",
		                                                                   "_UI_QueryParameter_name_feature",
		                                                                   "_UI_QueryParameter_type"),
	...
	protected void addOrdinalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
		                                                         ...
		                                                         getString("_UI_PropertyDescriptor_description",
		                                                                   "_UI_QueryParameter_ordinal_feature",
		                                                                   "_UI_QueryParameter_type"),
	...
	protected void addParamTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
		                                                         ...
		                                                         getString("_UI_PropertyDescriptor_description",
		                                                                   "_UI_QueryParameter_paramType_feature",
		                                                                   "_UI_QueryParameter_type"),
	...
	protected void addSqlTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
		                                                         ...
		                                                         getString("_UI_PropertyDescriptor_description",
		                                                                   "_UI_QueryParameter_sqlType_feature",
		                                                                   "_UI_QueryParameter_type"),
	...
	protected void addStructTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
		                                                         ...
		                                                         getString("_UI_PropertyDescriptor_description",
		                                                                   "_UI_QueryParameter_structType_feature",
		                                                                   "_UI_QueryParameter_type"),
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
		                                                         ...
		                                                         getString("_UI_PropertyDescriptor_description",
		                                                                   "_UI_QueryParameter_type_feature",
		                                                                   "_UI_QueryParameter_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_QueryParameter_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DsPackage.Literals.QUERY_PARAMETER__MIXED,
		...
		newChildDescriptors.add(createChildParameter(DsPackage.Literals.QUERY_PARAMETER__MIXED,
		                                             FeatureMapUtil.createEntry(DsPackage.Literals.QUERY_PARAMETER__VALIDATE_LONG_RANGE,
		                                                                        DsFactory.eINSTANCE.createLongRangeValidator())));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.QUERY_PARAMETER__MIXED,
		                                             FeatureMapUtil.createEntry(DsPackage.Literals.QUERY_PARAMETER__VALIDATE_DOUBLE_RANGE,
		                                                                        DsFactory.eINSTANCE.createDoubleRangeValidator())));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.QUERY_PARAMETER__MIXED,
		                                             FeatureMapUtil.createEntry(DsPackage.Literals.QUERY_PARAMETER__VALIDATE_LENGTH,
		                                                                        DsFactory.eINSTANCE.createLengthValidator())));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.QUERY_PARAMETER__MIXED,
		                                             FeatureMapUtil.createEntry(DsPackage.Literals.QUERY_PARAMETER__VALIDATE_PATTERN,
		                                                                        DsFactory.eINSTANCE.createPatternValidator())));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.QUERY_PARAMETER__MIXED,
		                                             FeatureMapUtil.createEntry(DsPackage.Literals.QUERY_PARAMETER__VALIDATE_CUSTOM,
		                                                                        DsFactory.eINSTANCE.createCustomValidator())));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.QUERY_PARAMETER__VALIDATE_LONG_RANGE,
		                                             DsFactory.eINSTANCE.createLongRangeValidator()));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.QUERY_PARAMETER__VALIDATE_DOUBLE_RANGE,
		                                             DsFactory.eINSTANCE.createDoubleRangeValidator()));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.QUERY_PARAMETER__VALIDATE_LENGTH,
		                                             DsFactory.eINSTANCE.createLengthValidator()));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.QUERY_PARAMETER__VALIDATE_PATTERN,
		                                             DsFactory.eINSTANCE.createPatternValidator()));

		newChildDescriptors.add(createChildParameter(DsPackage.Literals.QUERY_PARAMETER__VALIDATE_CUSTOM,
		                                             DsFactory.eINSTANCE.createCustomValidator()));
	}
