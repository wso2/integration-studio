...
public class DBReportMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public DBReportMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject dBReportMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.DBReportMediator.Misc.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBReportMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionType)) {
                basePart.initConnectionType(
                        EEFUtils.choiceOfValues(dBReportMediator,
                                EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionType()),
                        dBReportMediator.getConnectionType());
            }
            if (isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionDsType)) {
                basePart.initConnectionDsType(
                        ...
                        dBReportMediator.getConnectionDsType());
            }
            if (isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionDbType)) {
                basePart.initConnectionDbType(
                        ...
                        dBReportMediator.getConnectionDbType());
            }
            if (isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionDbDriver))
                basePart.setConnectionDbDriver(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBReportMediator.getConnectionDbDriver()));
            ...
            if (isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionDsInitialContext))
                basePart.setConnectionDsInitialContext(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBReportMediator.getConnectionDsInitialContext()));
            ...
            if (isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionDsName))
                basePart.setConnectionDsName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBReportMediator.getConnectionDsName()));
            ...
            if (isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionURL))
                basePart.setConnectionURL(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBReportMediator.getConnectionURL()));
            ...
            if (isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionUsername))
                basePart.setConnectionUsername(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBReportMediator.getConnectionUsername()));
            ...
            if (isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionPassword))
                basePart.setConnectionPassword(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBReportMediator.getConnectionPassword()));
            ...
            if (isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyAutocommit)) {
                basePart.initPropertyAutocommit(
                        ...
                        dBReportMediator.getPropertyAutocommit());
            }
            if (isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyIsolation)) {
                basePart.initPropertyIsolation(
                        ...
                        dBReportMediator.getPropertyIsolation());
            }
            if (isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyMaxactive)) {
                basePart.setPropertyMaxactive(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        dBReportMediator.getPropertyMaxactive()));
            }
            ...
            if (isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyMaxidle)) {
                basePart.setPropertyMaxidle(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        dBReportMediator.getPropertyMaxidle()));
            }
            ...
            if (isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyMaxopenstatements)) {
                basePart.setPropertyMaxopenstatements(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        dBReportMediator.getPropertyMaxopenstatements()));
            }
            ...
            if (isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyMaxwait)) {
                basePart.setPropertyMaxwait(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        dBReportMediator.getPropertyMaxwait()));
            }
            ...
            if (isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyMinidle)) {
                basePart.setPropertyMinidle(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        dBReportMediator.getPropertyMinidle()));
            }
            ...
            if (isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyPoolstatements)) {
                basePart.initPropertyPoolstatements(
                        ...
                        dBReportMediator.getPropertyPoolstatements());
            }
            if (isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyTestonborrow)) {
                basePart.initPropertyTestonborrow(
                        ...
                        dBReportMediator.getPropertyTestonborrow());
            }
            if (isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyTestwhileidle)) {
                basePart.initPropertyTestwhileidle(
                        ...
                        dBReportMediator.getPropertyTestwhileidle());
            }
            if (isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyValidationquery))
                basePart.setPropertyValidationquery(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        dBReportMediator.getPropertyValidationquery()));
            ...
            if (isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyInitialsize)) {
                basePart.setPropertyInitialsize(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT,
                        dBReportMediator.getPropertyInitialsize()));
            }

            if (isAccessible(EsbViewsRepository.DBReportMediator.Statements.sqlStatements)) {
                sqlStatementsSettings = new ReferencesTableSettings(dBReportMediator,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.DBReportMediator.Misc.description == event.getAffectedEditor()) {
            dBReportMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.DBReportMediator.Properties.propertyMaxactive == event.getAffectedEditor()) {
            dBReportMediator.setPropertyMaxactive(
        ...
        if (EsbViewsRepository.DBReportMediator.Properties.propertyValidationquery == event.getAffectedEditor()) {
            dBReportMediator.setPropertyValidationquery((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.DBReportMediator.Properties.propertyInitialsize == event.getAffectedEditor()) {
            dBReportMediator.setPropertyInitialsize(
                    (EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String) event.getNewValue())));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.DBReportMediator.Misc.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Properties.reverse))
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionType().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionType))
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDsType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionDsType))
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDbType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionDbType))
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDbDriver().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionDbDriver)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDsInitialContext()
                    ...
                    && isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionDsInitialContext)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionDsName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionDsName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionURL().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionURL)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionUsername().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionUsername)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_ConnectionPassword().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionPassword)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyAutocommit().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyAutocommit))
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyIsolation().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyIsolation))
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyMaxactive().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyMaxactive)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyMaxidle().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyMaxidle)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyMaxopenstatements().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyMaxopenstatements)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyMaxwait().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyMaxwait)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyMinidle().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyMinidle)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyPoolstatements().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyPoolstatements))
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyTestonborrow().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyTestonborrow))
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyTestwhileidle().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyTestwhileidle))
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyValidationquery().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyValidationquery)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractSqlExecutorMediator_PropertyInitialsize().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Properties.propertyInitialsize)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getDBReportMediator_ConnectionUseTransaction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.DBReportMediator.Connection.connectionUseTransaction))
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.DBReportMediator.Connection.connectionDsInitialContext == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                ...
                if (EsbViewsRepository.DBReportMediator.Properties.propertyMaxopenstatements == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                ...
                if (EsbViewsRepository.DBReportMediator.Properties.propertyPoolstatements == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                ...
                if (EsbViewsRepository.DBReportMediator.Properties.propertyValidationquery == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                ...
                if (EsbViewsRepository.DBReportMediator.Connection.connectionUseTransaction == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getDBReportMediator_ConnectionUseTransaction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getDBReportMediator_ConnectionUseTransaction().getEAttributeType(),
