 ...
 * 
 */
public class NamespacedPropertyPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, NamespacedPropertyPropertiesEditionPart {
     ...
     */
    public NamespacedPropertyPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = namespacedPropertyStep
                .addStep(EsbViewsRepository.NamespacedProperty.Properties.class);
    ...
    protected Composite createPrettyNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.NamespacedProperty.Properties.prettyName,
                EsbMessages.NamespacedPropertyPropertiesEditionPart_PrettyNameLabel);
        ...
        prettyName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.NamespacedProperty.Properties.prettyName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, prettyName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(NamespacedPropertyPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            NamespacedPropertyPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.NamespacedProperty.Properties.prettyName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertyNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.NamespacedProperty.Properties.propertyName,
                EsbMessages.NamespacedPropertyPropertiesEditionPart_PropertyNameLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.NamespacedProperty.Properties.propertyName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertyValueText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.NamespacedProperty.Properties.propertyValue,
                EsbMessages.NamespacedPropertyPropertiesEditionPart_PropertyValueLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.NamespacedProperty.Properties.propertyValue, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createNamespacesText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.NamespacedProperty.Properties.namespaces,
                EsbMessages.NamespacedPropertyPropertiesEditionPart_NamespacesLabel);
        ...
        namespaces.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            NamespacedPropertyPropertiesEditionPartForm.this,
                            EsbViewsRepository.NamespacedProperty.Properties.namespaces, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, namespaces.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(NamespacedPropertyPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.NamespacedProperty.Properties.namespaces, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSupportsDynamicXPathsCheckbox(FormToolkit widgetFactory, Composite parent) {
        supportsDynamicXPaths = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.NamespacedProperty.Properties.supportsDynamicXPaths,
                                EsbMessages.NamespacedPropertyPropertiesEditionPart_SupportsDynamicXPathsLabel),
                        SWT.CHECK);
        supportsDynamicXPaths.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(NamespacedPropertyPropertiesEditionPartForm.this,
                                    EsbViewsRepository.NamespacedProperty.Properties.supportsDynamicXPaths,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(supportsDynamicXPaths.getSelection())));
            }
        ...
        EditingUtils.setID(supportsDynamicXPaths,
                EsbViewsRepository.NamespacedProperty.Properties.supportsDynamicXPaths);
    ...
    protected Composite createDynamicCheckbox(FormToolkit widgetFactory, Composite parent) {
        dynamic = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.NamespacedProperty.Properties.dynamic,
                        EsbMessages.NamespacedPropertyPropertiesEditionPart_DynamicLabel),
                SWT.CHECK);
        dynamic.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            NamespacedPropertyPropertiesEditionPartForm.this,
                            EsbViewsRepository.NamespacedProperty.Properties.dynamic, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new Boolean(dynamic.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.NamespacedProperty.Properties.dynamic, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.NamespacedPropertyPropertiesEditionPart#setPrettyName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.NamespacedPropertyPropertiesEditionPart#setPropertyName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.NamespacedPropertyPropertiesEditionPart#setPropertyValue(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.NamespacedPropertyPropertiesEditionPart#setNamespaces(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.NamespacedPropertyPropertiesEditionPart#setSupportsDynamicXPaths(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.NamespacedPropertyPropertiesEditionPart#setDynamic(Boolean
     *      newValue)
     * 
     */
