...
public class ElementNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DataMapperParserProvider.getParser(DataMapperElementTypes.Element_3007, getParserElement(),
					DataMapperVisualIDRegistry.getType(
							org.wso2.integrationstudio.datamapper.diagram.edit.parts.ElementNameEditPart.VISUAL_ID));
		}
		return parser;
	}
