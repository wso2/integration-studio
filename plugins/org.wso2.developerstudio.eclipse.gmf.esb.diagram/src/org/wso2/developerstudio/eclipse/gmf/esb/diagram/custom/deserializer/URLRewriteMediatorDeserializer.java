...
public class URLRewriteMediatorDeserializer extends AbstractEsbNodeDeserializer<AbstractMediator, URLRewriteMediator> {
    ...
    public URLRewriteMediator createNode(IGraphicalEditPart part, AbstractMediator mediator) {
        Assert.isTrue(mediator instanceof org.apache.synapse.mediators.transform.url.URLRewriteMediator,
        ...
        URLRewriteMediator visualURLRewriteMediator = (URLRewriteMediator) DeserializerUtils.createNode(part,
        ...
        for (RewriteRule rewriteRule : urlRewriteMediator.getRules()) {
            ...
            EvaluatorExpressionProperty evaluatorExpressionProperty = EsbFactory.eINSTANCE
