 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ThrottleContainerImpl#getOnAcceptContainer <em>On Accept
 * Container</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ThrottleContainerImpl#getOnRejectContainer <em>On Reject
 * Container</em>}</li>
 * </ul>
 *
 * @generated
...
public class ThrottleContainerImpl extends EsbNodeImpl implements ThrottleContainer {
    ...
    public NotificationChain basicSetOnAcceptContainer(ThrottleOnAcceptContainer newOnAcceptContainer,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.THROTTLE_CONTAINER__ON_ACCEPT_CONTAINER, oldOnAcceptContainer, newOnAcceptContainer);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newOnAcceptContainer != onAcceptContainer) {
            ...
            if (onAcceptContainer != null)
                msgs = ((InternalEObject) onAcceptContainer).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.THROTTLE_CONTAINER__ON_ACCEPT_CONTAINER, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.THROTTLE_CONTAINER__ON_ACCEPT_CONTAINER,
    ...
    public NotificationChain basicSetOnRejectContainer(ThrottleOnRejectContainer newOnRejectContainer,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.THROTTLE_CONTAINER__ON_REJECT_CONTAINER, oldOnRejectContainer, newOnRejectContainer);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOnRejectContainer != onRejectContainer) {
            ...
            if (onRejectContainer != null)
                msgs = ((InternalEObject) onRejectContainer).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.THROTTLE_CONTAINER__ON_REJECT_CONTAINER, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.THROTTLE_CONTAINER__ON_REJECT_CONTAINER,
