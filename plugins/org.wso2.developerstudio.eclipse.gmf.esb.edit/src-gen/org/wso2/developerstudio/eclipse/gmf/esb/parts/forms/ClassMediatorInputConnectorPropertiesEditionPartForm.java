 ...
 * 
 */
public class ClassMediatorInputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ClassMediatorInputConnectorPropertiesEditionPart {
     ...
     */
    public ClassMediatorInputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        CompositionSequence classMediatorInputConnectorStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        classMediatorInputConnectorStep.addStep(EsbViewsRepository.ClassMediatorInputConnector.Properties.class)
    ...
    protected Composite createIncomingLinksReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.incomingLinks = new ReferencesTable(
                getDescription(EsbViewsRepository.ClassMediatorInputConnector.Properties.incomingLinks,
                        EsbMessages.ClassMediatorInputConnectorPropertiesEditionPart_IncomingLinksLabel),
        ...
        this.incomingLinks.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ClassMediatorInputConnector.Properties.incomingLinks, EsbViewsRepository.FORM_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ClassMediatorInputConnectorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ClassMediatorInputConnector.Properties.incomingLinks,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ClassMediatorInputConnectorPropertiesEditionPart#addFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ClassMediatorInputConnectorPropertiesEditionPart#addBusinessFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ClassMediatorInputConnectorPropertiesEditionPart#isContainedInIncomingLinksTable(EObject
     *      element)
     * 
     */
