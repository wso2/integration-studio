 ...
 * 
 */
public class ConditionalRouteBranchPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ConditionalRouteBranchPropertiesEditionPart {
     ...
     */
    public ConditionalRouteBranchPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createBreakAfterRouteCheckbox(FormToolkit widgetFactory, Composite parent) {
        breakAfterRoute = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.ConditionalRouteBranch.Properties.breakAfterRoute,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ConditionalRouteBranchPropertiesEditionPartForm.this,
