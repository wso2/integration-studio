...
public class ProxyServiceParameterPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ProxyServiceParameterPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject proxyServiceParameter, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ProxyServiceParameter.Properties.value))
                basePart.setValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        proxyServiceParameter.getValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ProxyServiceParameter.Properties.name == event.getAffectedEditor()) {
            proxyServiceParameter.setName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.ProxyServiceParameter.Properties.value == event.getAffectedEditor()) {
            proxyServiceParameter.setValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getProxyServiceParameter_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyServiceParameter.Properties.name)) {
            ...
            if (EsbPackage.eINSTANCE.getProxyServiceParameter_Value().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ProxyServiceParameter.Properties.value)) {
                if (msg.getNewValue() != null) {
                ...
                if (EsbViewsRepository.ProxyServiceParameter.Properties.name == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyServiceParameter_Name().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyServiceParameter_Name().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.ProxyServiceParameter.Properties.value == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getProxyServiceParameter_Value().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getProxyServiceParameter_Value().getEAttributeType(), newValue);
                }
