    ...
    private InboundEndpoint create(org.wso2.integrationstudio.gmf.esb.InboundEndpoint visualInboundEndpoint)
        ...
        if (visualInboundEndpoint.getType().getName().equals(CUSTOM)) {
            ...
            for (InboundEndpointParameter inboundEndpointParameter : serviceParameters) {
                ...
                if(inboundEndpointParameter.getInboundEndpointParameterType().equals(KeyType.STATIC) && StringUtils.isNotBlank(value)){
                    inboundEndpoint.addParameter(inboundEndpointParameter.getName(), value);
                } else {
                	RegistryKeyProperty registryKeyProperty = inboundEndpointParameter.getInboundEndpointParameterKey();
        ...
        case JMS:
            ...
            if (StringUtils.isNotBlank(visualInboundEndpoint.getJavaNamingSecurityPrincipal())) {
                addParameterForConfig(inboundEndpoint, InboundEndpointConstants.JMS_JAVA_NAMING_SECURITY_PRINCIPAL,
                        visualInboundEndpoint.getJavaNamingSecurityPrincipal());
            }
            if (StringUtils.isNotBlank(visualInboundEndpoint.getJavaNamingSecurityCredentials())) {
                addParameterForConfig(inboundEndpoint, InboundEndpointConstants.JMS_JAVA_NAMING_SECURITY_CREDENTIALS,
                        visualInboundEndpoint.getJavaNamingSecurityCredentials());
            }
