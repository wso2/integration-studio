 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfOAuthMediatorInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			OAuthMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(OAuthMediatorInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
