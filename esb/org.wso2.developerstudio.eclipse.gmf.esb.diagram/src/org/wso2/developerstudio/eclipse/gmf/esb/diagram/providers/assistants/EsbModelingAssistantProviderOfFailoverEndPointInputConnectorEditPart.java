 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfFailoverEndPointInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			FailoverEndPointInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(FailoverEndPointInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
