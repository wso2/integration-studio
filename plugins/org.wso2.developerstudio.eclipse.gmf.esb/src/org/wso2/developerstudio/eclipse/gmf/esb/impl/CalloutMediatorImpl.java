 ...
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getPathToAxis2xml <em>Path To
 * Axis2xml</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getPathToAxis2Repository <em>Path To
 * Axis2 Repository</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getPayloadType <em>Payload
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getPayloadMessageXpath <em>Payload
 * Message Xpath</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getResultType <em>Result Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getResultMessageXpath <em>Result Message
 * Xpath</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getResultContextProperty <em>Result
 * Context Property</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#isPassHeaders <em>Pass
 * Headers</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getInputConnector <em>Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getOutputConnector <em>Output
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getAddressEndpoint <em>Address
 * Endpoint</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getEndpointType <em>Endpoint
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getPayloadProperty <em>Payload
 * Property</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getSecurityType <em>Security
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getOutboundPolicyKey <em>Outbound Policy
 * Key</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#getInboundPolicyKey <em>Inbound Policy
 * Key</em>}</li>
 ...
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.CalloutMediatorImpl#isInitAxis2ClientOptions <em>Init Axis2
 * Client Options</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CalloutMediatorImpl extends MediatorImpl implements CalloutMediator {
    ...
    public void setServiceURL(String newServiceURL) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__SERVICE_URL,
    ...
    public void setSoapAction(String newSoapAction) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__SOAP_ACTION,
    ...
    public void setPathToAxis2xml(String newPathToAxis2xml) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__PATH_TO_AXIS2XML,
                    oldPathToAxis2xml, pathToAxis2xml));
    }
    ...
    public void setPathToAxis2Repository(String newPathToAxis2Repository) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__PATH_TO_AXIS2_REPOSITORY,
                    oldPathToAxis2Repository, pathToAxis2Repository));
    }
    ...
    public void setPayloadType(CalloutPayloadType newPayloadType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__PAYLOAD_TYPE,
                    oldPayloadType, payloadType));
    }
    ...
    public NotificationChain basicSetPayloadMessageXpath(NamespacedProperty newPayloadMessageXpath,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALLOUT_MEDIATOR__PAYLOAD_MESSAGE_XPATH, oldPayloadMessageXpath, newPayloadMessageXpath);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setPayloadMessageXpath(NamespacedProperty newPayloadMessageXpath) {
        if (newPayloadMessageXpath != payloadMessageXpath) {
            ...
            if (payloadMessageXpath != null)
                msgs = ((InternalEObject) payloadMessageXpath).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALLOUT_MEDIATOR__PAYLOAD_MESSAGE_XPATH, null, msgs);
            if (newPayloadMessageXpath != null)
                msgs = ((InternalEObject) newPayloadMessageXpath).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALLOUT_MEDIATOR__PAYLOAD_MESSAGE_XPATH, null, msgs);
            msgs = basicSetPayloadMessageXpath(newPayloadMessageXpath, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__PAYLOAD_MESSAGE_XPATH,
                    newPayloadMessageXpath, newPayloadMessageXpath));
    }
    ...
    public void setResultType(CalloutResultType newResultType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__RESULT_TYPE,
    ...
    public NotificationChain basicSetResultMessageXpath(NamespacedProperty newResultMessageXpath,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALLOUT_MEDIATOR__RESULT_MESSAGE_XPATH, oldResultMessageXpath, newResultMessageXpath);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setResultMessageXpath(NamespacedProperty newResultMessageXpath) {
        if (newResultMessageXpath != resultMessageXpath) {
            ...
            if (resultMessageXpath != null)
                msgs = ((InternalEObject) resultMessageXpath).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALLOUT_MEDIATOR__RESULT_MESSAGE_XPATH, null, msgs);
            if (newResultMessageXpath != null)
                msgs = ((InternalEObject) newResultMessageXpath).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALLOUT_MEDIATOR__RESULT_MESSAGE_XPATH, null, msgs);
            msgs = basicSetResultMessageXpath(newResultMessageXpath, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__RESULT_MESSAGE_XPATH,
                    newResultMessageXpath, newResultMessageXpath));
    }
    ...
    public void setResultContextProperty(String newResultContextProperty) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__RESULT_CONTEXT_PROPERTY,
                    oldResultContextProperty, resultContextProperty));
    }
    ...
    public void setPassHeaders(boolean newPassHeaders) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__PASS_HEADERS,
                    oldPassHeaders, passHeaders));
    }
    ...
    public NotificationChain basicSetInputConnector(CalloutMediatorInputConnector newInputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALLOUT_MEDIATOR__INPUT_CONNECTOR, oldInputConnector, newInputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newInputConnector != inputConnector) {
            ...
            if (inputConnector != null)
                msgs = ((InternalEObject) inputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALLOUT_MEDIATOR__INPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__INPUT_CONNECTOR,
    ...
    public NotificationChain basicSetOutputConnector(CalloutMediatorOutputConnector newOutputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALLOUT_MEDIATOR__OUTPUT_CONNECTOR, oldOutputConnector, newOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOutputConnector != outputConnector) {
            ...
            if (outputConnector != null)
                msgs = ((InternalEObject) outputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALLOUT_MEDIATOR__OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__OUTPUT_CONNECTOR,
    ...
    public NotificationChain basicSetAddressEndpoint(RegistryKeyProperty newAddressEndpoint, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALLOUT_MEDIATOR__ADDRESS_ENDPOINT, oldAddressEndpoint, newAddressEndpoint);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setAddressEndpoint(RegistryKeyProperty newAddressEndpoint) {
        if (newAddressEndpoint != addressEndpoint) {
            ...
            if (addressEndpoint != null)
                msgs = ((InternalEObject) addressEndpoint).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALLOUT_MEDIATOR__ADDRESS_ENDPOINT, null, msgs);
            if (newAddressEndpoint != null)
                msgs = ((InternalEObject) newAddressEndpoint).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALLOUT_MEDIATOR__ADDRESS_ENDPOINT, null, msgs);
            msgs = basicSetAddressEndpoint(newAddressEndpoint, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__ADDRESS_ENDPOINT,
                    newAddressEndpoint, newAddressEndpoint));
    }
    ...
    public void setEndpointType(CalloutEndpointType newEndpointType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__ENDPOINT_TYPE,
    ...
    public void setPayloadProperty(String newPayloadProperty) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__PAYLOAD_PROPERTY,
                    oldPayloadProperty, payloadProperty));
    }
    ...
    public void setSecurityType(CalloutSecurityType newSecurityType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__SECURITY_TYPE,
                    oldSecurityType, securityType));
    }
    ...
    public NotificationChain basicSetOutboundPolicyKey(RegistryKeyProperty newOutboundPolicyKey,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALLOUT_MEDIATOR__OUTBOUND_POLICY_KEY, oldOutboundPolicyKey, newOutboundPolicyKey);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setOutboundPolicyKey(RegistryKeyProperty newOutboundPolicyKey) {
        if (newOutboundPolicyKey != outboundPolicyKey) {
            ...
            if (outboundPolicyKey != null)
                msgs = ((InternalEObject) outboundPolicyKey).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALLOUT_MEDIATOR__OUTBOUND_POLICY_KEY, null, msgs);
            if (newOutboundPolicyKey != null)
                msgs = ((InternalEObject) newOutboundPolicyKey).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALLOUT_MEDIATOR__OUTBOUND_POLICY_KEY, null, msgs);
            msgs = basicSetOutboundPolicyKey(newOutboundPolicyKey, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__OUTBOUND_POLICY_KEY,
                    newOutboundPolicyKey, newOutboundPolicyKey));
    }
    ...
    public NotificationChain basicSetInboundPolicyKey(RegistryKeyProperty newInboundPolicyKey, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALLOUT_MEDIATOR__INBOUND_POLICY_KEY, oldInboundPolicyKey, newInboundPolicyKey);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setInboundPolicyKey(RegistryKeyProperty newInboundPolicyKey) {
        if (newInboundPolicyKey != inboundPolicyKey) {
            ...
            if (inboundPolicyKey != null)
                msgs = ((InternalEObject) inboundPolicyKey).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALLOUT_MEDIATOR__INBOUND_POLICY_KEY, null, msgs);
            if (newInboundPolicyKey != null)
                msgs = ((InternalEObject) newInboundPolicyKey).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALLOUT_MEDIATOR__INBOUND_POLICY_KEY, null, msgs);
            msgs = basicSetInboundPolicyKey(newInboundPolicyKey, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__INBOUND_POLICY_KEY,
                    newInboundPolicyKey, newInboundPolicyKey));
    }
    ...
    public void setPolicies(CalloutSecurityPolicies newPolicies) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__POLICIES, oldPolicies,
                    policies));
    }
    ...
    public NotificationChain basicSetPolicyKey(RegistryKeyProperty newPolicyKey, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALLOUT_MEDIATOR__POLICY_KEY, oldPolicyKey, newPolicyKey);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newPolicyKey != policyKey) {
            ...
            if (policyKey != null)
                msgs = ((InternalEObject) policyKey).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.CALLOUT_MEDIATOR__POLICY_KEY, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.CALLOUT_MEDIATOR__POLICY_KEY, newPolicyKey,
                    newPolicyKey));
    }
    ...
    public void setInitAxis2ClientOptions(boolean newInitAxis2ClientOptions) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.CALLOUT_MEDIATOR__INIT_AXIS2_CLIENT_OPTIONS, oldInitAxis2ClientOptions,
    ...
    public boolean eIsSet(int featureID) {
        ...
        case EsbPackage.CALLOUT_MEDIATOR__PATH_TO_AXIS2XML:
            return PATH_TO_AXIS2XML_EDEFAULT == null ? pathToAxis2xml != null
                    : !PATH_TO_AXIS2XML_EDEFAULT.equals(pathToAxis2xml);
        case EsbPackage.CALLOUT_MEDIATOR__PATH_TO_AXIS2_REPOSITORY:
            return PATH_TO_AXIS2_REPOSITORY_EDEFAULT == null ? pathToAxis2Repository != null
                    : !PATH_TO_AXIS2_REPOSITORY_EDEFAULT.equals(pathToAxis2Repository);
        case EsbPackage.CALLOUT_MEDIATOR__PAYLOAD_TYPE:
        ...
        case EsbPackage.CALLOUT_MEDIATOR__RESULT_CONTEXT_PROPERTY:
            return RESULT_CONTEXT_PROPERTY_EDEFAULT == null ? resultContextProperty != null
                    : !RESULT_CONTEXT_PROPERTY_EDEFAULT.equals(resultContextProperty);
        case EsbPackage.CALLOUT_MEDIATOR__PASS_HEADERS:
        ...
        case EsbPackage.CALLOUT_MEDIATOR__PAYLOAD_PROPERTY:
            return PAYLOAD_PROPERTY_EDEFAULT == null ? payloadProperty != null
                    : !PAYLOAD_PROPERTY_EDEFAULT.equals(payloadProperty);
        case EsbPackage.CALLOUT_MEDIATOR__SECURITY_TYPE:
