 ...
 * 
 */
public class RuleMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, RuleMediatorPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RuleMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.RuleMediator.Misc.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.RuleMediator.Misc.commentsList,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.RuleMediator.Misc.reverse,
                EsbMessages.RuleMediatorPropertiesEditionPart_ReverseLabel));
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.RuleMediator.Misc.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStatefulSessionCheckbox(Composite parent) {
        ...
        statefulSession.setText(getDescription(EsbViewsRepository.RuleMediator.Misc.statefulSession,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.Misc.statefulSession, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleSessionPropertiesAdvancedTableComposition(Composite parent) {
        ...
        this.ruleSessionProperties.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.Misc.ruleSessionProperties, EsbViewsRepository.SWT_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleMediatorPropertiesEditionPartImpl.this,
    ...
    protected Composite createInputWrapperNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.InputFacts.inputWrapperName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInputNameSpaceText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.InputFacts.inputNameSpace, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleFactsConfigurationAdvancedTableComposition(Composite parent) {
        ...
        this.ruleFactsConfiguration.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.InputFacts.ruleFactsConfiguration, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createOutputWrapperNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.OutputFacts.outputWrapperName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutputNameSpaceText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.OutputFacts.outputNameSpace, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleResultsConfigurationAdvancedTableComposition(Composite parent) {
        ...
        this.ruleResultsConfiguration.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.OutputFacts.ruleResultsConfiguration, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createSourceValueText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.RuleMediator.Source.sourceValue, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTargetValueText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.RuleMediator.Target.targetValue, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTargetActionEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.Target.targetAction, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleSetTypeEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.RuleSet.ruleSetType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleSetURLText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.RuleMediator.RuleSet.ruleSetURL, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleSetSourceTypeEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleSetSourceCodeText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceCode, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
