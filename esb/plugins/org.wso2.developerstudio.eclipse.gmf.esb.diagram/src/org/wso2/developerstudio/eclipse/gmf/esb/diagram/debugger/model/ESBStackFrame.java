...
public class ESBStackFrame extends ESBDebugElement implements IStackFrame {
    ...
    public synchronized void setVariables(PropertyRespondMessage propertyRespondMessage) throws DebugException {
        ...
        if (!processed) {
            ESBVariable textVariable = new ESBVariable(getDebugTarget(), getUITableVariableName(name),
                    propertyRespondMessage.getPropertyValues().toString());
