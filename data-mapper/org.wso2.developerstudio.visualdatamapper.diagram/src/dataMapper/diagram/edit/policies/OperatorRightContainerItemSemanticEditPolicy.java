...
public class OperatorRightContainerItemSemanticEditPolicy extends
	...
	public OperatorRightContainerItemSemanticEditPolicy() {
		super(dataMapper.diagram.providers.DataMapperElementTypes.OperatorRightContainer_3016);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (dataMapper.diagram.providers.DataMapperElementTypes.OperatorRightConnector_3017 == req
				.getElementType()) {
			return getGEFWrapper(new dataMapper.diagram.edit.commands.OperatorRightConnectorCreateCommand(
					req));
		}
