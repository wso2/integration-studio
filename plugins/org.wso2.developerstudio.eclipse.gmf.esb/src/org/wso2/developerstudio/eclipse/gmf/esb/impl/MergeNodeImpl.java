 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.MergeNodeImpl#getFirstInputConnector <em>First Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.MergeNodeImpl#getSecondInputConnector <em>Second Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.MergeNodeImpl#getOutputConnector <em>Output
 * Connector</em>}</li>
 * </ul>
 *
 * @generated
...
public class MergeNodeImpl extends MediatorImpl implements MergeNode {
    ...
    /**
     * The cached value of the '{@link #getSecondInputConnector() <em>Second Input Connector</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public NotificationChain basicSetFirstInputConnector(MergeNodeFirstInputConnector newFirstInputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.MERGE_NODE__FIRST_INPUT_CONNECTOR, oldFirstInputConnector, newFirstInputConnector);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setFirstInputConnector(MergeNodeFirstInputConnector newFirstInputConnector) {
        if (newFirstInputConnector != firstInputConnector) {
            ...
            if (firstInputConnector != null)
                msgs = ((InternalEObject) firstInputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.MERGE_NODE__FIRST_INPUT_CONNECTOR, null, msgs);
            if (newFirstInputConnector != null)
                msgs = ((InternalEObject) newFirstInputConnector).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.MERGE_NODE__FIRST_INPUT_CONNECTOR, null, msgs);
            msgs = basicSetFirstInputConnector(newFirstInputConnector, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.MERGE_NODE__FIRST_INPUT_CONNECTOR,
                    newFirstInputConnector, newFirstInputConnector));
    }
    ...
    public NotificationChain basicSetSecondInputConnector(MergeNodeSecondInputConnector newSecondInputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.MERGE_NODE__SECOND_INPUT_CONNECTOR, oldSecondInputConnector, newSecondInputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setSecondInputConnector(MergeNodeSecondInputConnector newSecondInputConnector) {
        if (newSecondInputConnector != secondInputConnector) {
            ...
            if (secondInputConnector != null)
                msgs = ((InternalEObject) secondInputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.MERGE_NODE__SECOND_INPUT_CONNECTOR, null, msgs);
            if (newSecondInputConnector != null)
                msgs = ((InternalEObject) newSecondInputConnector).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.MERGE_NODE__SECOND_INPUT_CONNECTOR, null, msgs);
            msgs = basicSetSecondInputConnector(newSecondInputConnector, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.MERGE_NODE__SECOND_INPUT_CONNECTOR,
                    newSecondInputConnector, newSecondInputConnector));
    }
    ...
    public NotificationChain basicSetOutputConnector(MergeNodeOutputConnector newOutputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.MERGE_NODE__OUTPUT_CONNECTOR, oldOutputConnector, newOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOutputConnector != outputConnector) {
            ...
            if (outputConnector != null)
                msgs = ((InternalEObject) outputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.MERGE_NODE__OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.MERGE_NODE__OUTPUT_CONNECTOR,
