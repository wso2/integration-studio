 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfRespondMediatorInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			RespondMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(RespondMediatorInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
