 ...
 * 
 */
public class PublishEventMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, PublishEventMediatorPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        CompositionStep propertiesStep = publishEventMediatorStep
                .addStep(EsbViewsRepository.PublishEventMediator.Properties.class);
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.PublishEventMediator.Properties.description,
                EsbMessages.PublishEventMediatorPropertiesEditionPart_DescriptionLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PublishEventMediatorPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(PublishEventMediatorPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.PublishEventMediator.Properties.description,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PublishEventMediator.Properties.description, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.PublishEventMediator.Properties.commentsList,
                EsbMessages.PublishEventMediatorPropertiesEditionPart_CommentsListLabel));
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(),
                        "PublishEventMediator", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(PublishEventMediatorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.PublishEventMediator.Properties.commentsList,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.PublishEventMediator.Properties.reverse,
                EsbMessages.PublishEventMediatorPropertiesEditionPart_ReverseLabel));
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PublishEventMediatorPropertiesEditionPartImpl.this,
                            EsbViewsRepository.PublishEventMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStreamNameText(Composite parent) {
        createDescription(parent, EsbViewsRepository.PublishEventMediator.Properties.streamName,
                EsbMessages.PublishEventMediatorPropertiesEditionPart_StreamNameLabel);
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.streamName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStreamVersionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.PublishEventMediator.Properties.streamVersion,
                EsbMessages.PublishEventMediatorPropertiesEditionPart_StreamVersionLabel);
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PublishEventMediator.Properties.streamVersion, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createEventSinkText(Composite parent) {
        createDescription(parent, EsbViewsRepository.PublishEventMediator.Properties.eventSink,
                EsbMessages.PublishEventMediatorPropertiesEditionPart_EventSinkLabel);
        ...
        eventSink.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PublishEventMediatorPropertiesEditionPartImpl.this,
                            EsbViewsRepository.PublishEventMediator.Properties.eventSink, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, eventSink.getText()));
            }
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.eventSink, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMetaAttributesAdvancedTableComposition(Composite parent) {
        this.metaAttributes = new ReferencesTable(
                getDescription(EsbViewsRepository.PublishEventMediator.Properties.metaAttributes,
                        EsbMessages.PublishEventMediatorPropertiesEditionPart_MetaAttributesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(PublishEventMediatorPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.PublishEventMediator.Properties.metaAttributes,
        ...
        this.metaAttributes.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.metaAttributes, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createCorrelationAttributesAdvancedTableComposition(Composite parent) {
        this.correlationAttributes = new ReferencesTable(
                getDescription(EsbViewsRepository.PublishEventMediator.Properties.correlationAttributes,
                        EsbMessages.PublishEventMediatorPropertiesEditionPart_CorrelationAttributesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(PublishEventMediatorPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.PublishEventMediator.Properties.correlationAttributes,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.correlationAttributes.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.correlationAttributes, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createPayloadAttributesAdvancedTableComposition(Composite parent) {
        this.payloadAttributes = new ReferencesTable(
                getDescription(EsbViewsRepository.PublishEventMediator.Properties.payloadAttributes,
                        EsbMessages.PublishEventMediatorPropertiesEditionPart_PayloadAttributesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(PublishEventMediatorPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.PublishEventMediator.Properties.payloadAttributes,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.payloadAttributes.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.payloadAttributes, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createArbitraryAttributesAdvancedTableComposition(Composite parent) {
        this.arbitraryAttributes = new ReferencesTable(
                getDescription(EsbViewsRepository.PublishEventMediator.Properties.arbitraryAttributes,
                        EsbMessages.PublishEventMediatorPropertiesEditionPart_ArbitraryAttributesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(PublishEventMediatorPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.PublishEventMediator.Properties.arbitraryAttributes,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.arbitraryAttributes.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.arbitraryAttributes, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createAsyncCheckbox(Composite parent) {
        ...
        async.setText(getDescription(EsbViewsRepository.PublishEventMediator.Properties.async,
                EsbMessages.PublishEventMediatorPropertiesEditionPart_AsyncLabel));
        async.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PublishEventMediatorPropertiesEditionPartImpl.this,
                            EsbViewsRepository.PublishEventMediator.Properties.async, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new Boolean(async.getSelection())));
            }
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PublishEventMediator.Properties.async, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAsyncTimeoutText(Composite parent) {
        createDescription(parent, EsbViewsRepository.PublishEventMediator.Properties.asyncTimeout,
                EsbMessages.PublishEventMediatorPropertiesEditionPart_AsyncTimeoutLabel);
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PublishEventMediator.Properties.asyncTimeout, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#setStreamName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#setStreamVersion(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#setEventSink(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#initMetaAttributes(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#addFilterMetaAttributes(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#addBusinessFilterMetaAttributes(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#isContainedInMetaAttributesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#initCorrelationAttributes(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#addFilterCorrelationAttributes(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#addBusinessFilterCorrelationAttributes(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#isContainedInCorrelationAttributesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#initPayloadAttributes(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#addFilterPayloadAttributes(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#addBusinessFilterPayloadAttributes(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#isContainedInPayloadAttributesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#initArbitraryAttributes(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#addFilterArbitraryAttributes(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#addBusinessFilterArbitraryAttributes(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#isContainedInArbitraryAttributesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#setAsync(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.PublishEventMediatorPropertiesEditionPart#setAsyncTimeout(String
     *      newValue)
     * 
     */
