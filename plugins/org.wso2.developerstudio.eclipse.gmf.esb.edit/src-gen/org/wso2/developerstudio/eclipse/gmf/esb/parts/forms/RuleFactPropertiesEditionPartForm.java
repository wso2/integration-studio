 ...
 * 
 */
public class RuleFactPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, RuleFactPropertiesEditionPart {
     ...
     */
    public RuleFactPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createFactTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RuleFact.Properties.factType,
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleFactPropertiesEditionPartForm.this, EsbViewsRepository.RuleFact.Properties.factType,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.RuleFact.Properties.factType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFactCustomTypeText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RuleFact.Properties.factCustomType,
        ...
        factCustomType.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleFactPropertiesEditionPartForm.this,
                            EsbViewsRepository.RuleFact.Properties.factCustomType, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, factCustomType.getText()));
                }
            }
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleFactPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleFact.Properties.factCustomType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFactNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RuleFact.Properties.factName,
        ...
        factName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleFactPropertiesEditionPartForm.this, EsbViewsRepository.RuleFact.Properties.factName,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.RuleFact.Properties.factName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RuleFact.Properties.valueType,
        ...
        valueType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleFactPropertiesEditionPartForm.this, EsbViewsRepository.RuleFact.Properties.valueType,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.RuleFact.Properties.valueType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueLiteralText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RuleFact.Properties.valueLiteral,
        ...
        valueLiteral.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RuleFactPropertiesEditionPartForm.this, EsbViewsRepository.RuleFact.Properties.valueLiteral,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RuleFact.Properties.valueLiteral, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
