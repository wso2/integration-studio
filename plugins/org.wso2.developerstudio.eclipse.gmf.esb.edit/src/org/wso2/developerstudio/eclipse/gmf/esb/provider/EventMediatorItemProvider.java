...
public class EventMediatorItemProvider extends MediatorItemProvider {
    ...
    protected void addTopicTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EventMediator_topicType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EventMediator_topicType_feature",
                                "_UI_EventMediator_type"),
                        EsbPackage.Literals.EVENT_MEDIATOR__TOPIC_TYPE, true, false, false,
    ...
    protected void addStaticTopicPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_EventMediator_staticTopic_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_EventMediator_staticTopic_feature",
                                "_UI_EventMediator_type"),
                        EsbPackage.Literals.EVENT_MEDIATOR__STATIC_TOPIC, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_EventMediator_type")
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.EVENT_MEDIATOR__DYNAMIC_TOPIC,
                EsbFactory.eINSTANCE.createNamespacedProperty()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.EVENT_MEDIATOR__EVENT_EXPRESSION,
                EsbFactory.eINSTANCE.createNamespacedProperty()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.EVENT_MEDIATOR__INPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createEventMediatorInputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.EVENT_MEDIATOR__OUTPUT_CONNECTOR,
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify = childFeature == EsbPackage.Literals.EVENT_MEDIATOR__DYNAMIC_TOPIC
