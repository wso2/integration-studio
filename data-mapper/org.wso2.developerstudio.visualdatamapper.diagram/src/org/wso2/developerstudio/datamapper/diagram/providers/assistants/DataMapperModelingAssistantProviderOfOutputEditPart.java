 ...
 * @generated
 */
public class DataMapperModelingAssistantProviderOfOutputEditPart extends DataMapperModelingAssistantProvider {
	...
	public List<IElementType> getTypesForPopupBar(IAdaptable host) {
		...
		types.add(DataMapperElementTypes.TreeNode_3011);
		return types;
	}
