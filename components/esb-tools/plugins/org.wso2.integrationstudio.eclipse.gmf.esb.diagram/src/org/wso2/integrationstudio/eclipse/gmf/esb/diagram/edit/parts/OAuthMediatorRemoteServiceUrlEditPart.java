 ...
 * @generated
 */
public class OAuthMediatorRemoteServiceUrlEditPart extends CompartmentEditPart implements ITextAwareEditPart {
        ...
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.OAuthMediator_3524, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.OAuthMediatorRemoteServiceUrlEditPart.VISUAL_ID));
        }
        return parser;
    }
