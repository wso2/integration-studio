 ...
 * 
 */
public class CallTemplateParameterPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, CallTemplateParameterPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        CompositionStep propertiesStep = callTemplateParameterStep
                .addStep(EsbViewsRepository.CallTemplateParameter.Properties.class);
    ...
    protected Composite createParameterNameText(Composite parent) {
        Control parameterNameLabel = createDescription(parent,
                EsbViewsRepository.CallTemplateParameter.Properties.parameterName,
                EsbMessages.CallTemplateParameterPropertiesEditionPart_ParameterNameLabel);
        ...
        Control parameterNameHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CallTemplateParameter.Properties.parameterName, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createTemplateParameterTypeEMFComboViewer(Composite parent) {
        Control parameterTypeLabel = createDescription(parent,
                EsbViewsRepository.CallTemplateParameter.Properties.templateParameterType,
                EsbMessages.CallTemplateParameterPropertiesEditionPart_TemplateParameterTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CallTemplateParameterPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.CallTemplateParameter.Properties.templateParameterType,
        ...
        Control parameterTypeHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CallTemplateParameter.Properties.templateParameterType,
                        EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createTemplateParameterTypeEMFComboViewer
        parameterTypeElements = new Control[] { parameterTypeLabel, templateParameterType.getCombo(),
                parameterTypeHelp };
        templateParameterType.addSelectionChangedListener(new ISelectionChangedListener() {
    ...
    protected Composite createParameterValueText(Composite parent) {
        Control parameterValueLabel = createDescription(parent,
                EsbViewsRepository.CallTemplateParameter.Properties.parameterValue,
                EsbMessages.CallTemplateParameterPropertiesEditionPart_ParameterValueLabel);
        ...
        Control parameterValueHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CallTemplateParameter.Properties.parameterValue, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateParameterPropertiesEditionPart#getParameterName()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateParameterPropertiesEditionPart#setParameterName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateParameterPropertiesEditionPart#getTemplateParameterType()
     * 
     */
    public Enumerator getTemplateParameterType() {
        Enumerator selection = (Enumerator) ((StructuredSelection) templateParameterType.getSelection())
                .getFirstElement();
        return selection;
    }
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateParameterPropertiesEditionPart#initTemplateParameterType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateParameterPropertiesEditionPart#setTemplateParameterType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateParameterPropertiesEditionPart#getParameterValue()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallTemplateParameterPropertiesEditionPart#setParameterValue(String
     *      newValue)
     * 
     */
    ...
    protected Composite createParameterExpressionWidget(final Composite parent) {
        Control parameterExpressionLabel = createDescription(parent,
                EsbViewsRepository.CallTemplateParameter.Properties.parameterExpression,
                EsbMessages.CallTemplateParameterPropertiesEditionPart_ParameterExpressionLabel);
        ...
        String initValueExpression = parameterExpression.getPropertyValue().isEmpty() ? "/default/expression"
                : parameterExpression.getPropertyValue();
        ...
        parameterExpressionText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                EEFNameSpacedPropertyEditorDialog nspd = new EEFNameSpacedPropertyEditorDialog(parent.getShell(),
                        SWT.NULL, parameterExpression);
                nspd.open();
                parameterExpressionText.setText(parameterExpression.getPropertyValue());
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        CallTemplateParameterPropertiesEditionPartImpl.this,
                        EsbViewsRepository.CallTemplateParameter.Properties.parameterExpression,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getParameterExpression()));
        ...
        EditingUtils.setID(parameterExpressionText,
        ...
        Control parameterExpressionHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CallTemplateParameter.Properties.parameterExpression,
                        EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
        parameterExpressionElements = new Control[] { parameterExpressionLabel, parameterExpressionText,
                parameterExpressionHelp };
        return parent;
    }
