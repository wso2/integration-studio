...
import org.wso2.integrationstudio.eclipse.gmf.esb.parts.CacheMediatorInputConnectorPropertiesEditionPart;
 ...
 * 
 */
public class CacheMediatorInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, CacheMediatorInputConnectorPropertiesEditionPart {
	 ...
	 * 
	 */
	public CacheMediatorInputConnectorPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(EsbMessages.CacheMediatorInputConnectorPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
		String label = getDescription(EsbViewsRepository.CacheMediatorInputConnector.Properties.incomingLinks, EsbMessages.CacheMediatorInputConnectorPropertiesEditionPart_IncomingLinksLabel);		 
		...
		this.incomingLinks.setHelpText(propertiesEditionComponent.getHelpContent(EsbViewsRepository.CacheMediatorInputConnector.Properties.incomingLinks, EsbViewsRepository.SWT_KIND));
		this.incomingLinks.createControls(parent);
		this.incomingLinks.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CacheMediatorInputConnectorPropertiesEditionPartImpl.this, EsbViewsRepository.CacheMediatorInputConnector.Properties.incomingLinks, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"incomingLinks", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CacheMediatorInputConnectorPropertiesEditionPartImpl.this, EsbViewsRepository.CacheMediatorInputConnector.Properties.incomingLinks,
	...
	protected void moveIncomingLinks(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CacheMediatorInputConnectorPropertiesEditionPartImpl.this, EsbViewsRepository.CacheMediatorInputConnector.Properties.incomingLinks, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		incomingLinks.refresh();
	}
	...
	protected void removeFromIncomingLinks(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CacheMediatorInputConnectorPropertiesEditionPartImpl.this, EsbViewsRepository.CacheMediatorInputConnector.Properties.incomingLinks, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		incomingLinks.refresh();
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.CacheMediatorInputConnectorPropertiesEditionPart#initIncomingLinks(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.CacheMediatorInputConnectorPropertiesEditionPart#updateIncomingLinks()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.CacheMediatorInputConnectorPropertiesEditionPart#addFilterIncomingLinks(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.CacheMediatorInputConnectorPropertiesEditionPart#addBusinessFilterIncomingLinks(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.CacheMediatorInputConnectorPropertiesEditionPart#isContainedInIncomingLinksTable(EObject element)
	 * 
	 */
