...
public class FailoverEndPointPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public FailoverEndPointPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject failoverEndPoint,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.FailoverEndPoint.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        failoverEndPoint.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.FailoverEndPoint.Properties.endPointName))
                basePart.setEndPointName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        failoverEndPoint.getEndPointName()));
            ...
            if (isAccessible(EsbViewsRepository.FailoverEndPoint.Properties.properties_)) {
                propertiesSettings = new ReferencesTableSettings(failoverEndPoint,
            ...
            if (isAccessible(EsbViewsRepository.FailoverEndPoint.Properties.children)) {
                childrenSettings = new ReferencesTableSettings(failoverEndPoint,
            ...
            if (isAccessible(EsbViewsRepository.FailoverEndPoint.Properties.name))
                basePart.setName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, failoverEndPoint.getName()));

            if (isAccessible(EsbViewsRepository.FailoverEndPoint.Properties.outputConnector)) {
                outputConnectorSettings = new ReferencesTableSettings(failoverEndPoint,
            ...
            if (isAccessible(EsbViewsRepository.FailoverEndPoint.Properties.outputConnector)) {
                basePart.addFilterToOutputConnector(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof FailoverEndPointOutputConnector);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.FailoverEndPoint.Properties.description == event.getAffectedEditor()) {
            failoverEndPoint.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.FailoverEndPoint.Properties.endPointName == event.getAffectedEditor()) {
            failoverEndPoint.setEndPointName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.FailoverEndPoint.Properties.name == event.getAffectedEditor()) {
            failoverEndPoint.setName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
        ...
        if (EsbViewsRepository.FailoverEndPoint.Properties.outputConnector == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                ...
                outputConnectorSettings.move(event.getNewIndex(),
                        (FailoverEndPointOutputConnector) event.getNewValue());
            }
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.FailoverEndPoint.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FailoverEndPoint.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getEndPoint_EndPointName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FailoverEndPoint.Properties.endPointName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getFailoverEndPoint_OutputConnector().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.FailoverEndPoint.Properties.outputConnector))
                basePart.updateOutputConnector();
            if (EsbPackage.eINSTANCE.getFailoverEndPoint_BuildMessage().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FailoverEndPoint.Properties.buildMessage))
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.FailoverEndPoint.Properties.buildMessage == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFailoverEndPoint_BuildMessage().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getFailoverEndPoint_BuildMessage().getEAttributeType(), newValue);
                }
