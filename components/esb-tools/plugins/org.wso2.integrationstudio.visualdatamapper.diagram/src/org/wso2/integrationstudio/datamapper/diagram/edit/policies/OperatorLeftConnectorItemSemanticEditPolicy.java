...
import org.wso2.integrationstudio.datamapper.diagram.edit.commands.InNode3CreateCommand;
 ...
 * @generated
 */
public class OperatorLeftConnectorItemSemanticEditPolicy extends DataMapperBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public OperatorLeftConnectorItemSemanticEditPolicy() {
		super(DataMapperElementTypes.OperatorLeftConnector_3014);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (DataMapperElementTypes.InNode_3015 == req.getElementType()) {
			return getGEFWrapper(new InNode3CreateCommand(req));
		}
