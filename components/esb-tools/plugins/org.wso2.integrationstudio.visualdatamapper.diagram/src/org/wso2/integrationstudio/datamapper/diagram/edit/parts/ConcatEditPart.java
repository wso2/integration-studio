...
public class ConcatEditPart extends AbstractOperatorEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.wso2.integrationstudio.datamapper.diagram.edit.policies.ConcatItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new org.wso2.integrationstudio.datamapper.diagram.edit.policies.ConcatCanonicalEditPolicy());
