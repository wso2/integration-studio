 ...
 * 
 */
public class EsbServerPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, EsbServerPropertiesEditionPart {
     ...
     */
    public EsbServerPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createChildrenTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.children = new ReferencesTable(getDescription(EsbViewsRepository.EsbServer.Properties.children,
                EsbMessages.EsbServerPropertiesEditionPart_ChildrenLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(EsbServerPropertiesEditionPartForm.this,
                                        EsbViewsRepository.EsbServer.Properties.children, PropertiesEditionEvent.COMMIT,
        ...
        this.children.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EsbServer.Properties.children, EsbViewsRepository.FORM_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(EsbServerPropertiesEditionPartForm.this,
                                    EsbViewsRepository.EsbServer.Properties.children, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.EsbServer.Properties.type,
                EsbMessages.EsbServerPropertiesEditionPart_TypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EsbServerPropertiesEditionPartForm.this, EsbViewsRepository.EsbServer.Properties.type,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EsbServer.Properties.type, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbServerPropertiesEditionPart#initChildren(EObject current,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbServerPropertiesEditionPart#addFilterChildren(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbServerPropertiesEditionPart#addBusinessFilterChildren(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbServerPropertiesEditionPart#isContainedInChildrenTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EsbServerPropertiesEditionPart#initType(Object input,
     *      Enumerator current)
     */
