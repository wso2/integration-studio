...
public class PersistentWSASEmitterContext extends PersistentContext implements
	...
	public void load(){
		...
		setDefault(PREFERENCE_UNPACK_DATABINDING_CLASSES, WSASEmitterDefaults.isServiceGenerateAll());
		setDefault(PREFERENCE_SWITCH_ON_UNWRAPPING, WSASEmitterDefaults.isServiceGenerateAll());
		//client defaults
	...
	public boolean isSwitchOnUnwrapping() {
		return getValueAsBoolean(PREFERENCE_SWITCH_ON_UNWRAPPING);
	}

	public boolean isUnpackDatabindingClasses() {
		return getValueAsBoolean(PREFERENCE_UNPACK_DATABINDING_CLASSES);
	}

	public void setSwitchOnUnwrapping(boolean unwrap) {
		setValue(PREFERENCE_SWITCH_ON_UNWRAPPING, unwrap);
		
	}

	public void setUnpackDatabindingClasses(boolean unpack) {
		setValue(PREFERENCE_UNPACK_DATABINDING_CLASSES, unpack);
