 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.AbstractCommonTargetImpl#getSequenceType <em>Sequence
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.AbstractCommonTargetImpl#getSequence <em>Sequence</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.AbstractCommonTargetImpl#getSequenceKey <em>Sequence
 * Key</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.AbstractCommonTargetImpl#getEndpointType <em>Endpoint
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.AbstractCommonTargetImpl#getEndpoint <em>Endpoint</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.AbstractCommonTargetImpl#getEndpointKey <em>Endpoint
 * Key</em>}</li>
 * </ul>
 *
 * @generated
...
public class AbstractCommonTargetImpl extends EsbNodeImpl implements AbstractCommonTarget {
    ...
    public void setSequenceType(TargetSequenceType newSequenceType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.ABSTRACT_COMMON_TARGET__SEQUENCE_TYPE,
            ...
            if (sequence != oldSequence) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            EsbPackage.ABSTRACT_COMMON_TARGET__SEQUENCE, oldSequence, sequence));
            }
        }
        return sequence;
    }
    ...
    public void setSequence(MediatorSequence newSequence) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.ABSTRACT_COMMON_TARGET__SEQUENCE,
    ...
    public NotificationChain basicSetSequenceKey(RegistryKeyProperty newSequenceKey, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.ABSTRACT_COMMON_TARGET__SEQUENCE_KEY, oldSequenceKey, newSequenceKey);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newSequenceKey != sequenceKey) {
            ...
            if (sequenceKey != null)
                msgs = ((InternalEObject) sequenceKey).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.ABSTRACT_COMMON_TARGET__SEQUENCE_KEY, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.ABSTRACT_COMMON_TARGET__SEQUENCE_KEY,
    ...
    public void setEndpointType(TargetEndpointType newEndpointType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.ABSTRACT_COMMON_TARGET__ENDPOINT_TYPE,
    ...
    public NotificationChain basicSetEndpoint(EndPoint newEndpoint, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.ABSTRACT_COMMON_TARGET__ENDPOINT, oldEndpoint, newEndpoint);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newEndpoint != endpoint) {
            ...
            if (endpoint != null)
                msgs = ((InternalEObject) endpoint).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.ABSTRACT_COMMON_TARGET__ENDPOINT, null, msgs);
            if (newEndpoint != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.ABSTRACT_COMMON_TARGET__ENDPOINT,
    ...
    public NotificationChain basicSetEndpointKey(RegistryKeyProperty newEndpointKey, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.ABSTRACT_COMMON_TARGET__ENDPOINT_KEY, oldEndpointKey, newEndpointKey);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newEndpointKey != endpointKey) {
            ...
            if (endpointKey != null)
                msgs = ((InternalEObject) endpointKey).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.ABSTRACT_COMMON_TARGET__ENDPOINT_KEY, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.ABSTRACT_COMMON_TARGET__ENDPOINT_KEY,
