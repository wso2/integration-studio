 ...
 * 
 */
public class MessageStorePropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, MessageStorePropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MessageStorePropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.MessageStore.Properties.commentsList,
    ...
    protected Composite createStoreNameText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MessageStorePropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.storeName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStoreTypeEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.storeType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInitialContextFactoryText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.MessageStore.Properties.initialContextFactory, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createProviderURLText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.providerURL, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJndiQueueNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jndiQueueName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createConnectionFactoryText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.connectionFactory, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createUserNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.userName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPasswordText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.password, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCacheConnectionCheckbox(Composite parent) {
        ...
        cacheConnection.setText(getDescription(EsbViewsRepository.MessageStore.Properties.cacheConnection,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.cacheConnection, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJmsSpecVersionEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jmsSpecVersion, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEnableCachingCheckbox(Composite parent) {
        ...
        enableCaching.setText(getDescription(EsbViewsRepository.MessageStore.Properties.enableCaching,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.enableCaching, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createProviderClassText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.providerClass, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRabbitMQServerHostNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.MessageStore.Properties.rabbitMQServerHostName, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRabbitMQServerHostPortText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.MessageStore.Properties.rabbitMQServerHostPort, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRabbitMQQueueNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.rabbitMQQueueName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRabbitMQExchangeNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.MessageStore.Properties.rabbitMQExchangeName, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRoutingKeyText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.routingKey, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRabbitMQUserNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.rabbitMQUserName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRabbitMQPasswordText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.rabbitMQPassword, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createVirtualHostText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.virtualHost, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJdbcDatabaseTableText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jdbcDatabaseTable, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJdbcDriverText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jdbcDriver, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJdbcURLText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.MessageStore.Properties.jdbcURL, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJdbcUserText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jdbcUser, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJdbcPasswordText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jdbcPassword, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJdbcDatasourceNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.jdbcDatasourceName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createParametersAdvancedTableComposition(Composite parent) {
        ...
        this.parameters.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.MessageStore.Properties.parameters, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createEnableProducerGuaranteedDeliveryCheckbox(Composite parent) {
        ...
        enableProducerGuaranteedDelivery
                .setText(getDescription(EsbViewsRepository.MessageStore.Properties.enableProducerGuaranteedDelivery,
    ...
    protected Composite createFailoverMessageStoreText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.MessageStore.Properties.failoverMessageStore, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createResequencepollingText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.resequencepolling, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResequenceDatabaseTableText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.resequenceDatabaseTable, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResequenceDriverText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.resequenceDriver, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResequenceURLText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.resequenceURL, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResequenceUserText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.resequenceUser, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResequencePasswordText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.resequencePassword, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResequenceXpathText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MessageStore.Properties.resequenceXpath, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResequenceXpathAttrFlatComboViewer(Composite parent) {
        ...
        resequenceXpathAttr.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        MessageStorePropertiesEditionPartImpl.this,
                        EsbViewsRepository.MessageStore.Properties.resequenceXpathAttr, PropertiesEditionEvent.CHANGE,
                        PropertiesEditionEvent.SET, null, getResequenceXpathAttr()));
            }
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.MessageStore.Properties.resequenceXpathAttr, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
