...
public enum ESBPropertyScopeType {
    ...
    AXIS2_SCOPE(AXIS2_PROPERTIES_KEY),
    AXIS2_CLIENT_SCOPE(AXIS2_CLIENT_PROPERTIES_KEY),
    TRANSPORT_SCOPE(TRANSPORT_PROPERTIES_KEY),
    SYNAPSE_SCOPE(SYNAPSE_PROPERTIES_KEY),
    OPERATION_SCOPE(OPERATION_PROPERTIES_KEY);
