 ...
 * @generated
 */
public class EntitlementAdviceContainerCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return EsbPackage.eINSTANCE
				.getEntitlementAdviceContainer_MediatorFlow();
	}
	...
	private boolean isMyDiagramElement(View view) {
		return MediatorFlow23EditPart.VISUAL_ID == EsbVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getEntitlementAdviceContainer_3757SemanticChildren((View) getHost()
						.getModel());
