...
public class PlatformUIConstants {
    ...
    public static final String DOCKER_DEFAULT_BASE_TAG = "4.5.0";
    public static final String MI_DEPLOYMENT_TOML_TEMPLATE_VERSION = "4.5.0";
    public static final String EMBEDDED_RUNTIME_DEFAULT_VERSION = "4.5.0";
}
