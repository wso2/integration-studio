 ...
 * 
 */
public class SqlParameterDefinitionPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, SqlParameterDefinitionPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        CompositionStep propertiesStep = sqlParameterDefinitionStep
                .addStep(EsbViewsRepository.SqlParameterDefinition.Properties.class);
    ...
    protected Composite createDataTypeEMFComboViewer(Composite parent) {
        Control dataTypeLabel = createDescription(parent, EsbViewsRepository.SqlParameterDefinition.Properties.dataType,
                EsbMessages.SqlParameterDefinitionPropertiesEditionPart_DataTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SqlParameterDefinitionPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.SqlParameterDefinition.Properties.dataType,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getDataType()));
            }

        });
        dataType.setID(EsbViewsRepository.SqlParameterDefinition.Properties.dataType);
        Control dataTypeHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SqlParameterDefinition.Properties.dataType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueTypeEMFComboViewer(Composite parent) {
        Control valueTypeLabel = createDescription(parent,
                EsbViewsRepository.SqlParameterDefinition.Properties.valueType,
                EsbMessages.SqlParameterDefinitionPropertiesEditionPart_ValueTypeLabel);
        ...
        Control valueTypeHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.SqlParameterDefinition.Properties.valueType, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createValueLiteralText(Composite parent) {
        Control valueLiteralLabel = createDescription(parent,
                ...
                EsbMessages.SqlParameterDefinitionPropertiesEditionPart_ValueLiteralLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SqlParameterDefinitionPropertiesEditionPartImpl.this,
                            EsbViewsRepository.SqlParameterDefinition.Properties.valueLiteral,
        ...
        Control valueLiteralHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.SqlParameterDefinition.Properties.valueLiteral, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlParameterDefinitionPropertiesEditionPart#initDataType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlParameterDefinitionPropertiesEditionPart#setDataType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlParameterDefinitionPropertiesEditionPart#initValueType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlParameterDefinitionPropertiesEditionPart#setValueType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SqlParameterDefinitionPropertiesEditionPart#setValueLiteral(String
     *      newValue)
     * 
     */
    ...
    protected Composite createValueExpression(final Composite parent) {
        Control valueExpressionLabel = createDescription(parent,
                EsbViewsRepository.SqlParameterDefinition.Properties.valueExpression,
                EsbMessages.SqlParameterDefinitionPropertiesEditionPart_ValueExpressionLabel);
    ...
    public void validate() {
        ...
        if (getValueType() != null && getValueType().getName().equals(SqlParameterValueType.LITERAL.getName())) {
            eu.showEntry(valueLiteralElements, false);
                ...
                && getValueType().getName().equals(SqlParameterValueType.EXPRESSION.getName())) {
