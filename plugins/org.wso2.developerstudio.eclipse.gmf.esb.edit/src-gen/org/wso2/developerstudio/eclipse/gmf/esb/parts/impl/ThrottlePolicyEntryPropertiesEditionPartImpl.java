 ...
 * 
 */
public class ThrottlePolicyEntryPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ThrottlePolicyEntryPropertiesEditionPart {
    ...
    protected Composite createThrottleTypeEMFComboViewer(Composite parent) {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ThrottlePolicyEntryPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleType, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createThrottleRangeText(Composite parent) {
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ThrottlePolicyEntryPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleRange,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.ThrottlePolicyEntry.Properties.throttleRange, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAccessTypeEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottlePolicyEntry.Properties.accessType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMaxRequestCountText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.ThrottlePolicyEntry.Properties.maxRequestCount, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createUnitTimeText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottlePolicyEntry.Properties.unitTime, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createProhibitPeriodText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.ThrottlePolicyEntry.Properties.prohibitPeriod, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
