...
import org.wso2.developerstudio.eclipse.gmf.esb.presentation.EEFEvaluatorExpressionEditorDialog;
 ...
 * 
 */
public class ConditionalRouteBranchPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ConditionalRouteBranchPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        CompositionStep propertiesStep = conditionalRouteBranchStep
    ...
    protected Composite createBreakAfterRouteCheckbox(Composite parent) {
        ...
        breakAfterRoute.setText(getDescription(EsbViewsRepository.ConditionalRouteBranch.Properties.breakAfterRoute,
                EsbMessages.ConditionalRouteBranchPropertiesEditionPart_BreakAfterRouteLabel));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ConditionalRouteBranchPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.ConditionalRouteBranch.Properties.breakAfterRoute,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ConditionalRouteBranchPropertiesEditionPart#setBreakAfterRoute(Boolean
     *      newValue)
     * 
     */
    ...
    protected Composite createEvaluatorExpressionWidget(Composite parent) {
        ...
        String initValueExpression = (evaluatorExpression.getEvaluatorValue() == null
                || evaluatorExpression.getEvaluatorValue().isEmpty()) ? "" : evaluatorExpression.getEvaluatorValue();
        ...
        evaluatorExpressionText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        ConditionalRouteBranchPropertiesEditionPartImpl.this,
                        EsbViewsRepository.ConditionalRouteBranch.evaluatorExpression, PropertiesEditionEvent.COMMIT,
                        PropertiesEditionEvent.SET, null, getEvaluatorExpression()));
            }
        ...
        Control evaluatorExpressionHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ConditionalRouteBranch.evaluatorExpression, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
