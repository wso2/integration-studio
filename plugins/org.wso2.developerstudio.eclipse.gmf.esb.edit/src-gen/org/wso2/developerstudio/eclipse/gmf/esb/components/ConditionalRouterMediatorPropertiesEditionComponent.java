...
public class ConditionalRouterMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ConditionalRouterMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject conditionalRouterMediator, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ConditionalRouterMediator.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        conditionalRouterMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.ConditionalRouterMediator.Properties.conditionalRouteBranches)) {
                conditionalRouteBranchesSettings = new ReferencesTableSettings(conditionalRouterMediator,
                ...
                basePart.addFilterToConditionalRouteBranches(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof ConditionalRouteBranch);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ConditionalRouterMediator.Properties.description == event.getAffectedEditor()) {
            conditionalRouterMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.ConditionalRouterMediator.Properties.conditionalRouteBranches == event
                .getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, conditionalRouteBranchesSettings, editingContext.getAdapterFactory());
                ...
                conditionalRouteBranchesSettings.move(event.getNewIndex(),
                        (ConditionalRouteBranch) event.getNewValue());
            }
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.ConditionalRouterMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ConditionalRouterMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ConditionalRouterMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getConditionalRouterMediator_ContinueAfterRoute().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ConditionalRouterMediator.Properties.continueAfterRoute))
                basePart.setContinueAfterRoute((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getConditionalRouterMediator_ConditionalRouteBranches().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.ConditionalRouterMediator.Properties.conditionalRouteBranches))
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.ConditionalRouterMediator.Properties.continueAfterRoute == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getConditionalRouterMediator_ContinueAfterRoute().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getConditionalRouterMediator_ContinueAfterRoute().getEAttributeType(),
                            newValue);
                }
