...
public class MethodArgumentPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public MethodArgumentPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject methodArgument,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.MethodArgument.Properties.propertyValue))
                basePart.setPropertyValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        methodArgument.getPropertyValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.MethodArgument.Properties.propertyName == event.getAffectedEditor()) {
            methodArgument.setPropertyName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.MethodArgument.Properties.propertyValue == event.getAffectedEditor()) {
            methodArgument.setPropertyValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueExpressionProperty_PropertyName().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.MethodArgument.Properties.propertyName)) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueExpressionProperty_PropertyValueType().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.MethodArgument.Properties.propertyValueType))
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueExpressionProperty_PropertyValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MethodArgument.Properties.propertyValue)) {
                if (msg.getNewValue() != null) {
