 ...
 * 
 */
public class MediatorFlowPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, MediatorFlowPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        mediatorFlowStep.addStep(EsbViewsRepository.MediatorFlow.Properties.class)
    ...
    protected Composite createChildrenAdvancedTableComposition(Composite parent) {
        this.children = new ReferencesTable(getDescription(EsbViewsRepository.MediatorFlow.Properties.children,
                EsbMessages.MediatorFlowPropertiesEditionPart_ChildrenLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(MediatorFlowPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.MediatorFlow.Properties.children,
        ...
        this.children.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.MediatorFlow.Properties.children, EsbViewsRepository.SWT_KIND));
        ...
        this.children.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MediatorFlowPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.MediatorFlow.Properties.children, PropertiesEditionEvent.CHANGE,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MediatorFlowPropertiesEditionPart#initChildren(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MediatorFlowPropertiesEditionPart#addFilterChildren(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MediatorFlowPropertiesEditionPart#addBusinessFilterChildren(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MediatorFlowPropertiesEditionPart#isContainedInChildrenTable(EObject
     *      element)
     * 
     */
