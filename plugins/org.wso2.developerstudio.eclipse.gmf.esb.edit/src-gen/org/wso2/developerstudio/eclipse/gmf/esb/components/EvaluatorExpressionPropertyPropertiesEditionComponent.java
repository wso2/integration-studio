...
public class EvaluatorExpressionPropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public EvaluatorExpressionPropertyPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject evaluatorExpressionProperty, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.EvaluatorExpressionProperty.Properties.prettyName))
                basePart.setPrettyName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        evaluatorExpressionProperty.getPrettyName()));

            if (isAccessible(EsbViewsRepository.EvaluatorExpressionProperty.Properties.evaluatorName))
                basePart.setEvaluatorName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        evaluatorExpressionProperty.getEvaluatorName()));

            if (isAccessible(EsbViewsRepository.EvaluatorExpressionProperty.Properties.evaluatorValue))
                basePart.setEvaluatorValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        evaluatorExpressionProperty.getEvaluatorValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.EvaluatorExpressionProperty.Properties.prettyName == event.getAffectedEditor()) {
            evaluatorExpressionProperty.setPrettyName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.EvaluatorExpressionProperty.Properties.evaluatorName == event.getAffectedEditor()) {
            evaluatorExpressionProperty.setEvaluatorName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.EvaluatorExpressionProperty.Properties.evaluatorValue == event.getAffectedEditor()) {
            evaluatorExpressionProperty.setEvaluatorValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEvaluatorExpressionProperty_PrettyName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EvaluatorExpressionProperty.Properties.prettyName)) {
            ...
            if (EsbPackage.eINSTANCE.getEvaluatorExpressionProperty_EvaluatorName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EvaluatorExpressionProperty.Properties.evaluatorName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEvaluatorExpressionProperty_EvaluatorValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EvaluatorExpressionProperty.Properties.evaluatorValue)) {
                if (msg.getNewValue() != null) {
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.EvaluatorExpressionProperty.Properties.prettyName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEvaluatorExpressionProperty_PrettyName().getEAttributeType(),
                                (String) newValue);
                    }
                ...
                if (EsbViewsRepository.EvaluatorExpressionProperty.Properties.evaluatorName == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEvaluatorExpressionProperty_EvaluatorName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getEvaluatorExpressionProperty_EvaluatorName().getEAttributeType(),
                ...
                if (EsbViewsRepository.EvaluatorExpressionProperty.Properties.evaluatorValue == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getEvaluatorExpressionProperty_EvaluatorValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getEvaluatorExpressionProperty_EvaluatorValue().getEAttributeType(),
                            newValue);
                }
