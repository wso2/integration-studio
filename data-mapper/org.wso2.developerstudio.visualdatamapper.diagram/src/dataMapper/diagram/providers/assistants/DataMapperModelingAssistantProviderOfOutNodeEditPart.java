...
public class DataMapperModelingAssistantProviderOfOutNodeEditPart extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((dataMapper.diagram.edit.parts.OutNodeEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			dataMapper.diagram.edit.parts.OutNodeEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget(
				(dataMapper.diagram.edit.parts.OutNodeEditPart) sourceEditPart, targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			dataMapper.diagram.edit.parts.OutNodeEditPart source, IGraphicalEditPart targetEditPart) {
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((dataMapper.diagram.edit.parts.OutNodeEditPart) sourceEditPart,
				relationshipType);
	}
	...
	public List<IElementType> doGetTypesForTarget(
			dataMapper.diagram.edit.parts.OutNodeEditPart source, IElementType relationshipType) {
