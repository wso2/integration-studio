 ...
 * @generated
 */
public class HeaderMediatorValueLiteralEditPart extends CompartmentEditPart implements ITextAwareEditPart {
        ...
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.HeaderMediator_3516, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.HeaderMediatorValueLiteralEditPart.VISUAL_ID));
        }
        return parser;
    }
