 ...
 * 
 */
public class CloneMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, CloneMediatorPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CloneMediator.Properties.description,
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CloneMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CloneMediator.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.CloneMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.CloneMediator.Properties.reverse,
                EsbMessages.CloneMediatorPropertiesEditionPart_ReverseLabel));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CloneMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CloneMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCloneIDText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CloneMediator.Properties.cloneID,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CloneMediator.Properties.cloneID, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSequentialMediationCheckbox(Composite parent) {
        ...
        sequentialMediation.setText(getDescription(EsbViewsRepository.CloneMediator.Properties.sequentialMediation,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CloneMediator.Properties.sequentialMediation, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createContinueParentCheckbox(Composite parent) {
        ...
        continueParent.setText(getDescription(EsbViewsRepository.CloneMediator.Properties.continueParent,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CloneMediator.Properties.continueParent, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTargetsAdvancedTableComposition(Composite parent) {
        ...
        this.targets.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CloneMediator.Properties.targets, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createTargetsOutputConnectorAdvancedTableComposition(Composite parent) {
        ...
        this.targetsOutputConnector.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CloneMediator.Properties.targetsOutputConnector, EsbViewsRepository.SWT_KIND));
