 ...
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SendMediatorImpl#getInputConnector <em>Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SendMediatorImpl#getOutputConnector <em>Output
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SendMediatorImpl#getReceivingSequenceType <em>Receiving
 * Sequence Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SendMediatorImpl#getStaticReceivingSequence <em>Static
 * Receiving Sequence</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SendMediatorImpl#getDynamicReceivingSequence <em>Dynamic
 * Receiving Sequence</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SendMediatorImpl#getEndpointOutputConnector <em>Endpoint
 * Output Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SendMediatorImpl#getMediatorFlow <em>Mediator
 * Flow</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SendMediatorImpl#isSkipSerialization <em>Skip
 * Serialization</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.SendMediatorImpl#isBuildMessageBeforeSending <em>Build
 * Message Before Sending</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SendMediatorImpl extends MediatorImpl implements SendMediator {
    ...
    /**
     * The cached value of the '{@link #getStaticReceivingSequence() <em>Static Receiving Sequence</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getDynamicReceivingSequence() <em>Dynamic Receiving Sequence</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getEndpointOutputConnector() <em>Endpoint Output Connector</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The default value of the '{@link #isBuildMessageBeforeSending() <em>Build Message Before Sending</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    public NotificationChain basicSetInputConnector(SendMediatorInputConnector newInputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SEND_MEDIATOR__INPUT_CONNECTOR, oldInputConnector, newInputConnector);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newInputConnector != inputConnector) {
            ...
            if (inputConnector != null)
                msgs = ((InternalEObject) inputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SEND_MEDIATOR__INPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SEND_MEDIATOR__INPUT_CONNECTOR,
    ...
    public NotificationChain basicSetOutputConnector(SendMediatorOutputConnector newOutputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SEND_MEDIATOR__OUTPUT_CONNECTOR, oldOutputConnector, newOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOutputConnector != outputConnector) {
            ...
            if (outputConnector != null)
                msgs = ((InternalEObject) outputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SEND_MEDIATOR__OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SEND_MEDIATOR__OUTPUT_CONNECTOR,
    ...
    public void setReceivingSequenceType(ReceivingSequenceType newReceivingSequenceType) {
        ...
        receivingSequenceType = newReceivingSequenceType == null ? RECEIVING_SEQUENCE_TYPE_EDEFAULT
                : newReceivingSequenceType;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SEND_MEDIATOR__RECEIVING_SEQUENCE_TYPE,
                    oldReceivingSequenceType, receivingSequenceType));
    }
    ...
    public NotificationChain basicSetStaticReceivingSequence(RegistryKeyProperty newStaticReceivingSequence,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SEND_MEDIATOR__STATIC_RECEIVING_SEQUENCE, oldStaticReceivingSequence,
                    newStaticReceivingSequence);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setStaticReceivingSequence(RegistryKeyProperty newStaticReceivingSequence) {
        if (newStaticReceivingSequence != staticReceivingSequence) {
            ...
            if (staticReceivingSequence != null)
                msgs = ((InternalEObject) staticReceivingSequence).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SEND_MEDIATOR__STATIC_RECEIVING_SEQUENCE, null, msgs);
            if (newStaticReceivingSequence != null)
                msgs = ((InternalEObject) newStaticReceivingSequence).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SEND_MEDIATOR__STATIC_RECEIVING_SEQUENCE, null, msgs);
            msgs = basicSetStaticReceivingSequence(newStaticReceivingSequence, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SEND_MEDIATOR__STATIC_RECEIVING_SEQUENCE,
                    newStaticReceivingSequence, newStaticReceivingSequence));
    }
    ...
    public NotificationChain basicSetDynamicReceivingSequence(NamespacedProperty newDynamicReceivingSequence,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SEND_MEDIATOR__DYNAMIC_RECEIVING_SEQUENCE, oldDynamicReceivingSequence,
                    newDynamicReceivingSequence);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setDynamicReceivingSequence(NamespacedProperty newDynamicReceivingSequence) {
        if (newDynamicReceivingSequence != dynamicReceivingSequence) {
            ...
            if (dynamicReceivingSequence != null)
                msgs = ((InternalEObject) dynamicReceivingSequence).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SEND_MEDIATOR__DYNAMIC_RECEIVING_SEQUENCE, null, msgs);
            if (newDynamicReceivingSequence != null)
                msgs = ((InternalEObject) newDynamicReceivingSequence).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SEND_MEDIATOR__DYNAMIC_RECEIVING_SEQUENCE, null, msgs);
            msgs = basicSetDynamicReceivingSequence(newDynamicReceivingSequence, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SEND_MEDIATOR__DYNAMIC_RECEIVING_SEQUENCE,
                    newDynamicReceivingSequence, newDynamicReceivingSequence));
    }
    ...
    public NotificationChain basicSetEndpointOutputConnector(
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SEND_MEDIATOR__ENDPOINT_OUTPUT_CONNECTOR, oldEndpointOutputConnector,
                    newEndpointOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setEndpointOutputConnector(SendMediatorEndpointOutputConnector newEndpointOutputConnector) {
        if (newEndpointOutputConnector != endpointOutputConnector) {
            ...
            if (endpointOutputConnector != null)
                msgs = ((InternalEObject) endpointOutputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SEND_MEDIATOR__ENDPOINT_OUTPUT_CONNECTOR, null, msgs);
            if (newEndpointOutputConnector != null)
                msgs = ((InternalEObject) newEndpointOutputConnector).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SEND_MEDIATOR__ENDPOINT_OUTPUT_CONNECTOR, null, msgs);
            msgs = basicSetEndpointOutputConnector(newEndpointOutputConnector, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SEND_MEDIATOR__ENDPOINT_OUTPUT_CONNECTOR,
                    newEndpointOutputConnector, newEndpointOutputConnector));
    }
    ...
    public NotificationChain basicSetMediatorFlow(MediatorFlow newMediatorFlow, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SEND_MEDIATOR__MEDIATOR_FLOW, oldMediatorFlow, newMediatorFlow);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newMediatorFlow != mediatorFlow) {
            ...
            if (mediatorFlow != null)
                msgs = ((InternalEObject) mediatorFlow).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.SEND_MEDIATOR__MEDIATOR_FLOW, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SEND_MEDIATOR__MEDIATOR_FLOW,
    ...
    public void setSkipSerialization(boolean newSkipSerialization) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.SEND_MEDIATOR__SKIP_SERIALIZATION,
                    oldSkipSerialization, skipSerialization));
    }
    ...
    public void setBuildMessageBeforeSending(boolean newBuildMessageBeforeSending) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.SEND_MEDIATOR__BUILD_MESSAGE_BEFORE_SENDING, oldBuildMessageBeforeSending,
