 ...
 * 
 */
public class IterateMediatorTargetOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public IterateMediatorTargetOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject iterateMediatorTargetOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.IterateMediatorTargetOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(iterateMediatorTargetOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.IterateMediatorTargetOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
