...
public class CallTemplateParameterPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public CallTemplateParameterPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject callTemplateParameter, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.CallTemplateParameter.Properties.parameterName))
                basePart.setParameterName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
            ...
            if (isAccessible(EsbViewsRepository.CallTemplateParameter.Properties.templateParameterType)) {
                basePart.initTemplateParameterType(
                        EEFUtils.choiceOfValues(callTemplateParameter,
                                EsbPackage.eINSTANCE.getCallTemplateParameter_TemplateParameterType()),
                        callTemplateParameter.getTemplateParameterType());
            }
            if (isAccessible(EsbViewsRepository.CallTemplateParameter.Properties.parameterValue))
                basePart.setParameterValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        callTemplateParameter.getParameterValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.CallTemplateParameter.Properties.parameterName == event.getAffectedEditor()) {
            callTemplateParameter.setParameterName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.CallTemplateParameter.Properties.parameterValue == event.getAffectedEditor()) {
            callTemplateParameter.setParameterValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getCallTemplateParameter_ParameterName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CallTemplateParameter.Properties.parameterName)) {
            ...
            if (EsbPackage.eINSTANCE.getCallTemplateParameter_TemplateParameterType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.CallTemplateParameter.Properties.templateParameterType))
                basePart.setTemplateParameterType((RuleOptionType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCallTemplateParameter_ParameterValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CallTemplateParameter.Properties.parameterValue)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCallTemplateParameter_ParameterExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CallTemplateParameter.Properties.parameterValue)) {
                if (msg.getNewValue() != null) {
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.CallTemplateParameter.Properties.parameterName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCallTemplateParameter_ParameterName().getEAttributeType(),
                                (String) newValue);
                    }
                ...
                if (EsbViewsRepository.CallTemplateParameter.Properties.templateParameterType == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE
                                .getCallTemplateParameter_TemplateParameterType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCallTemplateParameter_TemplateParameterType().getEAttributeType(),
                            newValue);
                }
                if (EsbViewsRepository.CallTemplateParameter.Properties.parameterValue == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCallTemplateParameter_ParameterValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCallTemplateParameter_ParameterValue().getEAttributeType(),
