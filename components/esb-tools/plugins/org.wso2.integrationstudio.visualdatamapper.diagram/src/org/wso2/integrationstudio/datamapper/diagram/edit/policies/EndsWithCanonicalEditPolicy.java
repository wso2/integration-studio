 ...
 * @generated
 */
public class EndsWithCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater
				.getEndsWith_2023SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater
				.getEndsWith_2023SemanticChildren((View) getHost().getModel());
