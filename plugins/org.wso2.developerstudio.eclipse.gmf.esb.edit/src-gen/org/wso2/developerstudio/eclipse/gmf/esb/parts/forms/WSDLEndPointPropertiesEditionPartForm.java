 ...
 * 
 */
public class WSDLEndPointPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, WSDLEndPointPropertiesEditionPart {
     ...
     */
    public WSDLEndPointPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep endpointSuspendStateStep = wSDLEndPointStep
                .addStep(EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.class);
        ...
        CompositionStep endpointTimeoutStateStep = wSDLEndPointStep
                .addStep(EsbViewsRepository.WSDLEndPoint.EndpointTimeoutState.class);
        ...
        CompositionStep failoverStep = wSDLEndPointStep
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.WSDLEndPoint.Properties.commentsList,
                        EsbMessages.WSDLEndPointPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "WSDLEndPoint", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.WSDLEndPoint.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createEndPointNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.Properties.endPointName,
                EsbMessages.WSDLEndPointPropertiesEditionPart_EndPointNameLabel);
        ...
        endPointName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.WSDLEndPoint.Properties.endPointName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, endPointName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Properties.endPointName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAnonymousCheckbox(FormToolkit widgetFactory, Composite parent) {
        anonymous = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.WSDLEndPoint.Properties.anonymous,
                        EsbMessages.WSDLEndPointPropertiesEditionPart_AnonymousLabel),
                SWT.CHECK);
        anonymous.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.WSDLEndPoint.Properties.anonymous, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Properties.anonymous, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(FormToolkit widgetFactory, Composite parent) {
        duplicate = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.WSDLEndPoint.Properties.duplicate,
                        EsbMessages.WSDLEndPointPropertiesEditionPart_DuplicateLabel),
                SWT.CHECK);
        duplicate.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.WSDLEndPoint.Properties.duplicate, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Properties.duplicate, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createReversedCheckbox(FormToolkit widgetFactory, Composite parent) {
        reversed = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.WSDLEndPoint.Properties.reversed,
                        EsbMessages.WSDLEndPointPropertiesEditionPart_ReversedLabel),
                SWT.CHECK);
        reversed.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.WSDLEndPoint.Properties.reversed, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Properties.reversed, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTemplateParametersTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.templateParameters = new ReferencesTable(
                getDescription(EsbViewsRepository.WSDLEndPoint.Properties.templateParameters,
                        EsbMessages.WSDLEndPointPropertiesEditionPart_TemplateParametersLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.WSDLEndPoint.Properties.templateParameters,
        ...
        this.templateParameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Properties.templateParameters, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createInLineCheckbox(FormToolkit widgetFactory, Composite parent) {
        inLine = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.WSDLEndPoint.Basic.inLine,
                EsbMessages.WSDLEndPointPropertiesEditionPart_InLineLabel), SWT.CHECK);
        inLine.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.WSDLEndPoint.Basic.inLine, PropertiesEditionEvent.COMMIT,
        ...
        Control inlineHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Basic.inLine, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFormatEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control formatLabel = createDescription(parent, EsbViewsRepository.WSDLEndPoint.Basic.format,
                EsbMessages.WSDLEndPointPropertiesEditionPart_FormatLabel);
        ...
        format.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartForm.this, EsbViewsRepository.WSDLEndPoint.Basic.format,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getFormat()));
            }

        });
        format.setID(EsbViewsRepository.WSDLEndPoint.Basic.format);
        Control formatHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Basic.format, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTraceEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        traceEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.WSDLEndPoint.Basic.traceEnabled,
                        EsbMessages.WSDLEndPointPropertiesEditionPart_TraceEnabledLabel),
                SWT.CHECK);
        traceEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.WSDLEndPoint.Basic.traceEnabled, PropertiesEditionEvent.COMMIT,
        ...
        Control traceEnabledHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Basic.traceEnabled, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createStatisticsEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        statisticsEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.WSDLEndPoint.Basic.statisticsEnabled,
                        EsbMessages.WSDLEndPointPropertiesEditionPart_StatisticsEnabledLabel),
                SWT.CHECK);
        statisticsEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.WSDLEndPoint.Basic.statisticsEnabled, PropertiesEditionEvent.COMMIT,
        ...
        Control statisticsEnabledHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.WSDLEndPoint.Basic.statisticsEnabled, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createEndpointSuspendStateGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        Section endpointSuspendStateSection = widgetFactory.createSection(filterAdvancedSubPropertiesGroup,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
        endpointSuspendStateSection
                .setText(EsbMessages.WSDLEndPointPropertiesEditionPart_EndpointSuspendStateGroupLabel);
    ...
    protected Composite createSuspendErrorCodesText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendErrorCodes,
                EsbMessages.WSDLEndPointPropertiesEditionPart_SuspendErrorCodesLabel);
    ...
    protected Composite createSuspendInitialDurationText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendInitialDuration,
                EsbMessages.WSDLEndPointPropertiesEditionPart_SuspendInitialDurationLabel);
    ...
    protected Composite createSuspendMaximumDurationText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendMaximumDuration,
                EsbMessages.WSDLEndPointPropertiesEditionPart_SuspendMaximumDurationLabel);
    ...
    protected Composite createSuspendProgressionFactorText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendProgressionFactor,
                EsbMessages.WSDLEndPointPropertiesEditionPart_SuspendProgressionFactorLabel);
    ...
    protected Composite createEndpointTimeoutStateGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        endpointTimeoutStateSection
                .setText(EsbMessages.WSDLEndPointPropertiesEditionPart_EndpointTimeoutStateGroupLabel);
    ...
    protected Composite createRetryErrorCodesText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.EndpointTimeoutState.retryErrorCodes,
                EsbMessages.WSDLEndPointPropertiesEditionPart_RetryErrorCodesLabel);
    ...
    protected Composite createRetryCountText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.EndpointTimeoutState.retryCount,
                EsbMessages.WSDLEndPointPropertiesEditionPart_RetryCountLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.WSDLEndPoint.EndpointTimeoutState.retryCount, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRetryDelayText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.EndpointTimeoutState.retryDelay,
                EsbMessages.WSDLEndPointPropertiesEditionPart_RetryDelayLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.WSDLEndPoint.EndpointTimeoutState.retryDelay, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.properties = new ReferencesTable(getDescription(EsbViewsRepository.WSDLEndPoint.Misc.properties,
                EsbMessages.WSDLEndPointPropertiesEditionPart_PropertiesLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.WSDLEndPoint.Misc.properties, PropertiesEditionEvent.COMMIT,
        ...
        this.properties.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Misc.properties, EsbViewsRepository.FORM_KIND));
        ...
        this.properties.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.WSDLEndPoint.Misc.properties, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createOptimizeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control optimizeLable = createDescription(parent, EsbViewsRepository.WSDLEndPoint.Misc.optimize,
                EsbMessages.WSDLEndPointPropertiesEditionPart_OptimizeLabel);
        ...
        optimize.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartForm.this, EsbViewsRepository.WSDLEndPoint.Misc.optimize,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getOptimize()));
            }

        });
        optimize.setID(EsbViewsRepository.WSDLEndPoint.Misc.optimize);
        Control optimizeHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Misc.optimize, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.WSDLEndPoint.Misc.description,
                EsbMessages.WSDLEndPointPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.WSDLEndPoint.Misc.description, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.WSDLEndPoint.Misc.description, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control descriptionHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Misc.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createWsdlUriText(FormToolkit widgetFactory, Composite parent) {
        Control wsdlUriLabel = createDescription(parent, EsbViewsRepository.WSDLEndPoint.Misc.wsdlUri,
                EsbMessages.WSDLEndPointPropertiesEditionPart_WsdlUriLabel);
        ...
        wsdlUri.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartForm.this, EsbViewsRepository.WSDLEndPoint.Misc.wsdlUri,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, wsdlUri.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.WSDLEndPoint.Misc.wsdlUri, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, wsdlUri.getText()));
                }
            }
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.WSDLEndPoint.Misc.wsdlUri, PropertiesEditionEvent.COMMIT,
                                        PropertiesEditionEvent.SET, null, wsdlUri.getText()));
                }
            }
        });
        ...
        Control wsdlUriHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Misc.wsdlUri, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createServiceText(FormToolkit widgetFactory, Composite parent) {
        Control serviceLabel = createDescription(parent, EsbViewsRepository.WSDLEndPoint.Misc.service,
                EsbMessages.WSDLEndPointPropertiesEditionPart_ServiceLabel);
        ...
        service.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartForm.this, EsbViewsRepository.WSDLEndPoint.Misc.service,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, service.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.WSDLEndPoint.Misc.service, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, service.getText()));
                }
            }
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.WSDLEndPoint.Misc.service, PropertiesEditionEvent.COMMIT,
                                        PropertiesEditionEvent.SET, null, service.getText()));
                }
            }
        });
        ...
        Control serviceHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Misc.service, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPortText(FormToolkit widgetFactory, Composite parent) {
        Control portLabel = createDescription(parent, EsbViewsRepository.WSDLEndPoint.Misc.port,
                EsbMessages.WSDLEndPointPropertiesEditionPart_PortLabel);
        ...
        port.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartForm.this, EsbViewsRepository.WSDLEndPoint.Misc.port,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, port.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.WSDLEndPoint.Misc.port, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, port.getText()));
                }
            }
        ...
        Control portHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Misc.port, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createQosGroup(FormToolkit widgetFactory, final Composite parent) {
        Section qosSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createReliableMessagingEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        reliableMessagingEnabled = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.WSDLEndPoint.Qos.reliableMessagingEnabled,
                                EsbMessages.WSDLEndPointPropertiesEditionPart_ReliableMessagingEnabledLabel),
                        SWT.CHECK);
        reliableMessagingEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.WSDLEndPoint.Qos.reliableMessagingEnabled, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new Boolean(reliableMessagingEnabled.getSelection())));
                validate();
            }
        ...
        Control reliableMessagingEnabledHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.WSDLEndPoint.Qos.reliableMessagingEnabled,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createSecurityEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        securityEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.WSDLEndPoint.Qos.securityEnabled,
                        EsbMessages.WSDLEndPointPropertiesEditionPart_SecurityEnabledLabel),
                SWT.CHECK);
        securityEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.WSDLEndPoint.Qos.securityEnabled, PropertiesEditionEvent.COMMIT,
        ...
        Control securityEnabledHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Qos.securityEnabled, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAddressingEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        addressingEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.WSDLEndPoint.Qos.addressingEnabled,
                        EsbMessages.WSDLEndPointPropertiesEditionPart_AddressingEnabledLabel),
                SWT.CHECK);
        addressingEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.WSDLEndPoint.Qos.addressingEnabled, PropertiesEditionEvent.COMMIT,
        ...
        Control addressingEnabledHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Qos.addressingEnabled, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAddressingVersionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control addressingVersionLabel = createDescription(parent,
                EsbViewsRepository.WSDLEndPoint.Qos.addressingVersion,
                EsbMessages.WSDLEndPointPropertiesEditionPart_AddressingVersionLabel);
        ...
        addressingVersion.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.WSDLEndPoint.Qos.addressingVersion, PropertiesEditionEvent.COMMIT,
        ...
        Control addressingVersionHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Qos.addressingVersion, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createAddressingVersionEMFComboViewer
        addressingVersionElements = new Control[] { addressingVersionLabel, addressingVersion.getCombo(),
    ...
    protected Composite createAddressingSeparateListenerCheckbox(FormToolkit widgetFactory, Composite parent) {
        addressingSeparateListener = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.WSDLEndPoint.Qos.addressingSeparateListener,
                                EsbMessages.WSDLEndPointPropertiesEditionPart_AddressingSeparateListenerLabel),
                        SWT.CHECK);
        addressingSeparateListener.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.WSDLEndPoint.Qos.addressingSeparateListener,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
        ...
        Control addressingSeparateListenerHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.WSDLEndPoint.Qos.addressingSeparateListener, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createAddressingSeparateListenerCheckbox
        addressingSeparateListenerElements = new Control[] { addressingSeparateListener,
    ...
    protected Composite createTimeOutDurationText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.Timeout.timeOutDuration,
                EsbMessages.WSDLEndPointPropertiesEditionPart_TimeOutDurationLabel);
        ...
        timeOutDuration.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.WSDLEndPoint.Timeout.timeOutDuration, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Timeout.timeOutDuration, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTimeOutActionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.Timeout.timeOutAction,
                EsbMessages.WSDLEndPointPropertiesEditionPart_TimeOutActionLabel);
        ...
        timeOutAction.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.WSDLEndPoint.Timeout.timeOutAction, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Timeout.timeOutAction, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    */
    ...
    protected Composite createFailoverNonRetryErrorCodesText(FormToolkit widgetFactory, Composite parent) {
        Control failoverNonRetryErrorCodesLabel = createDescription(parent,
                ...
                EsbMessages.WSDLEndPointPropertiesEditionPart_FailoverNonRetryErrorCodesLabel);
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setEndPointName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setAnonymous(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setDuplicate(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setReversed(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#initTemplateParameters(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#addFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#addBusinessFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#isContainedInTemplateParametersTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#initFormat(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setFormat(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setTraceEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setStatisticsEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setSuspendErrorCodes(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setSuspendInitialDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setSuspendMaximumDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setSuspendProgressionFactor(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setRetryErrorCodes(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setRetryCount(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setRetryDelay(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#initProperties(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#addFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#addBusinessFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#isContainedInPropertiesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#initOptimize(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setOptimize(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setReliableMessagingEnabled(Boolean
     *      newValue)
     * 
     */
    public void setReliableMessagingEnabled(Boolean newValue) {
        ...
        boolean eefElementEditorReadOnlyState = isReadOnly(
                EsbViewsRepository.WSDLEndPoint.Qos.reliableMessagingEnabled);
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setSecurityEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setAddressingEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#initAddressingVersion(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setAddressingVersion(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setAddressingSeparateListener(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setTimeOutDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#initTimeOutAction(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setTimeOutAction(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.WSDLEndPointPropertiesEditionPart#setFailoverNonRetryErrorCodes(String
     *      newValue)
     * 
     */
    ...
    protected Composite createReliableMessagingPolicy(FormToolkit widgetFactory, final Composite parent) {
        Control reliableMessagingPolicyLabel = createDescription(parent,
                EsbViewsRepository.WSDLEndPoint.Qos.reliableMessagingPolicy,
        ...
        String initReliableMessagingPolicy = reliableMessagingPolicy.getKeyValue().isEmpty() ? ""
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, reliableMessagingPolicy,
        ...
        Control reliableMessagingPolicyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.WSDLEndPoint.Qos.reliableMessagingPolicy,
                        EsbViewsRepository.FORM_KIND),
                null);
        reliableMessagingPolicyElements = new Control[] { reliableMessagingPolicyLabel, reliableMessagingPolicyText,
    ...
    protected Composite createSecurityPolicy(FormToolkit widgetFactory, final Composite parent) {
        ...
        securityPolicyText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        WSDLEndPointPropertiesEditionPartForm.this, EsbViewsRepository.WSDLEndPoint.Qos.securityPolicy,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getSecurityPolicy()));
            }
        ...
        securityPolicyText.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, securityPolicy, new ArrayList<NamedEntityDescriptor>());
                    dialog.open();
                    securityPolicyText.setText(securityPolicy.getKeyValue());
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
        ...
        Control securityPolicyHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Qos.securityPolicy, EsbViewsRepository.FORM_KIND),
                null);
    ...
    protected Composite createInboundPolicy(FormToolkit widgetFactory, final Composite parent) {
        ...
        inboundPolicyText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        WSDLEndPointPropertiesEditionPartForm.this, EsbViewsRepository.WSDLEndPoint.Qos.inboundPolicy,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getInboundPolicy()));
            }
        ...
        inboundPolicyText.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, inboundPolicy, new ArrayList<NamedEntityDescriptor>());
                    dialog.open();
                    inboundPolicyText.setText(inboundPolicy.getKeyValue());
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
        ...
        Control inboundPolicyHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Qos.inboundPolicy, EsbViewsRepository.FORM_KIND), null);
    ...
    protected Composite createOutboundPolicy(FormToolkit widgetFactory, final Composite parent) {
        ...
        outboundPolicyText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        WSDLEndPointPropertiesEditionPartForm.this, EsbViewsRepository.WSDLEndPoint.Qos.outboundPolicy,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getOutboundPolicy()));
            }
        ...
        outboundPolicyText.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, outboundPolicy, new ArrayList<NamedEntityDescriptor>());
                    dialog.open();
                    outboundPolicyText.setText(outboundPolicy.getKeyValue());
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartForm.this,
        ...
        Control outboundPolicyHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Qos.outboundPolicy, EsbViewsRepository.FORM_KIND),
                null);
