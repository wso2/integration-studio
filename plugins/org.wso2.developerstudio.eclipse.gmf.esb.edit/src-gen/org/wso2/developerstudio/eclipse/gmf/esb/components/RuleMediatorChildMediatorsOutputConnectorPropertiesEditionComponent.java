 ...
 * 
 */
public class RuleMediatorChildMediatorsOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public RuleMediatorChildMediatorsOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject ruleMediatorChildMediatorsOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(
                ...
                commentMediatorsSettings = new ReferencesTableSettings(ruleMediatorChildMediatorsOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.RuleMediatorChildMediatorsOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
