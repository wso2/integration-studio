 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfSequenceInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			SequenceInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(SequenceInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
	...
	public List<IElementType> doGetTypesForSource(
			SequenceInputConnectorEditPart target, IElementType relationshipType) {
