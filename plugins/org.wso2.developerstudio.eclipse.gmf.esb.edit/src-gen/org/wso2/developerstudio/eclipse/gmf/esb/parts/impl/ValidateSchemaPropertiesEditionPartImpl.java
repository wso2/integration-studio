 ...
 * 
 */
public class ValidateSchemaPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ValidateSchemaPropertiesEditionPart {
    ...
    protected Composite createValidateSchemaKeyTypeEMFComboViewer(Composite parent) {
        Control itemLabel = createDescription(parent,
                EsbViewsRepository.ValidateSchema.Properties.validateSchemaKeyType,
                EsbMessages.ValidateSchemaPropertiesEditionPart_ValidateSchemaKeyTypeLabel);
        validateSchemaKeyType = new EMFComboViewer(parent);
        validateSchemaKeyType.setContentProvider(new ArrayContentProvider());
        validateSchemaKeyType
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ValidateSchemaPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.ValidateSchema.Properties.validateSchemaKeyType,
        ...
        Control itemHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateSchema.Properties.validateSchemaKeyType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSchemaKeyFlatComboViewer(Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.ValidateSchema.Properties.schemaKey,
                EsbMessages.ValidateSchemaPropertiesEditionPart_SchemaKeyLabel);
        schemaKey = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
                .isRequired(EsbViewsRepository.ValidateSchema.Properties.schemaKey, EsbViewsRepository.SWT_KIND));
        ...
        schemaKey.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                propertiesEditionComponent
                        .firePropertiesChanged(new PropertiesEditionEvent(ValidateSchemaPropertiesEditionPartImpl.this,
                                EsbViewsRepository.ValidateSchema.Properties.schemaKey, PropertiesEditionEvent.CHANGE,
                                PropertiesEditionEvent.SET, null, getSchemaKey()));
            }
        ...
        Control itemHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateSchema.Properties.schemaKey, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    public Enumerator getValidateSchemaKeyType() {
        Enumerator selection = (Enumerator) ((StructuredSelection) validateSchemaKeyType.getSelection())
                .getFirstElement();
        return selection;
    }
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateSchemaPropertiesEditionPart#initValidateSchemaKeyType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateSchemaPropertiesEditionPart#setValidateSchemaKeyType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateSchemaPropertiesEditionPart#setSchemaKey(EObject
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateSchemaPropertiesEditionPart#setSchemaKeyButtonMode(ButtonsModeEnum
     *      newValue)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateSchemaPropertiesEditionPart#addFilterSchemaKey(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ValidateSchemaPropertiesEditionPart#addBusinessFilterSchemaKey(ViewerFilter
     *      filter)
     * 
     */
    ...
    protected Composite createDynamicSchemaKeyWidget(final Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.ValidateSchema.Properties.dynamicSchemaKey,
                EsbMessages.ValidateSchemaPropertiesEditionPart_DynamicSchemaKeyLabel);
        ...
        String initValueExpression = dynamicSchemaKey.getPropertyValue().isEmpty() ? "/default/expression"
                : dynamicSchemaKey.getPropertyValue();
        ...
        dynamicSchemaKeyText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        ...
                        EsbViewsRepository.ValidateSchema.Properties.dynamicSchemaKey, PropertiesEditionEvent.COMMIT,
                        PropertiesEditionEvent.SET, null, getDynamicSchemaKey()));
        ...
        dynamicSchemaKeyText.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ValidateSchemaPropertiesEditionPartImpl.this,
                            EsbViewsRepository.ValidateSchema.Properties.dynamicSchemaKey,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getDynamicSchemaKey()));
                }
            }
        ...
        Control itemHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateSchema.Properties.dynamicSchemaKey, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStaticSchemaKeyWidget(Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.ValidateSchema.Properties.staticSchemaKey,
                EsbMessages.ValidateSchemaPropertiesEditionPart_StaticSchemaKeyLabel);
        ...
        staticSchemaKeyText.addMouseListener(new MouseListener() {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent
                        .firePropertiesChanged(new PropertiesEditionEvent(ValidateSchemaPropertiesEditionPartImpl.this,
                                EsbViewsRepository.ValidateSchema.Properties.staticSchemaKey,
                                PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getStaticSchemaKey()));
        ...
        Control itemHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ValidateSchema.Properties.staticSchemaKey, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
