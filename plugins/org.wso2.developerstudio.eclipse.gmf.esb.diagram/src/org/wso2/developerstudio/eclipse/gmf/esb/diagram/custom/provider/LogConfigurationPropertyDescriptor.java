...
public class LogConfigurationPropertyDescriptor extends PropertyDescriptor {
    ...
    public LogConfigurationPropertyDescriptor(Object object, IItemPropertyDescriptor itemPropertyDescriptor) {
    ...
    public CellEditor createPropertyEditor(Composite parent) {
        return new ExtendedDialogCellEditor(parent, getLabelProvider()) {
            ...
            protected Object openDialogBox(Control cellEditorWindow) {
                ...
                // .getEditingDomain()
                ConfigureLogMediatorDialog logMediatorConfigurationDialog = new ConfigureLogMediatorDialog(shell,
                        logMediator, TransactionUtil.getEditingDomain(logMediator));
