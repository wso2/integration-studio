 ...
 */
public class EEFXpathSelectorDialog extends Dialog {
     ...
     *            parent shell.
     */
    public EEFXpathSelectorDialog(Shell parent) {
        super(parent);
    ...
    public static void main(String[] args) {
        EEFXpathSelectorDialog dialog = new EEFXpathSelectorDialog(Display.getDefault().getActiveShell());
        dialog.open();
    }
