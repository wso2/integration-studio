...
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigureSubstringOperatorDialog;

public class SubstringConfigureAction extends AbstractActionHandler {
	 ...
	 */
	public SubstringConfigureAction(IWorkbenchPart part) {
		super(part);
		setId(Messages.SubstringConfigureAction_ActionID);
		setText(Messages.SubstringConfigureAction_ActionText);
		setToolTipText(Messages.SubstringConfigureAction_ToolTip);
