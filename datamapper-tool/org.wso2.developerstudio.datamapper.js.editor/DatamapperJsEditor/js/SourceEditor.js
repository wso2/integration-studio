...
//	//alert(JSON.stringify(res));
	...
	var payload = $('#inputPayload').val();
	var config = $('#sourceEditorTextBox').val();
	var result = ExecuteCustomFunction("map", payload, inputSchema, outputSchema, config);
	var outputTBox = $('#outputPayload');
	outputTBox.val(result);
}