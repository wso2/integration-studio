...
public class DataMapperModelingAssistantProviderOfOutNode3EditPart extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((dataMapper.diagram.edit.parts.OutNode3EditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			dataMapper.diagram.edit.parts.OutNode3EditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget(
				(dataMapper.diagram.edit.parts.OutNode3EditPart) sourceEditPart, targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			dataMapper.diagram.edit.parts.OutNode3EditPart source, IGraphicalEditPart targetEditPart) {
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((dataMapper.diagram.edit.parts.OutNode3EditPart) sourceEditPart,
				relationshipType);
	}
	...
	public List<IElementType> doGetTypesForTarget(
			dataMapper.diagram.edit.parts.OutNode3EditPart source, IElementType relationshipType) {
