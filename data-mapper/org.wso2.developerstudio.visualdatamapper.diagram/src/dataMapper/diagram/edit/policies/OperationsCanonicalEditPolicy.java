 ...
 * @generated
 */
public class OperationsCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return dataMapper.DataMapperPackage.eINSTANCE.getOperations_Concat();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<dataMapper.diagram.part.DataMapperNodeDescriptor> childDescriptors = dataMapper.diagram.part.DataMapperDiagramUpdater
				.getOperations_2004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return dataMapper.diagram.edit.parts.ConcatEditPart.VISUAL_ID == dataMapper.diagram.part.DataMapperVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<dataMapper.diagram.part.DataMapperNodeDescriptor> childDescriptors = dataMapper.diagram.part.DataMapperDiagramUpdater
				.getOperations_2004SemanticChildren((View) getHost().getModel());
