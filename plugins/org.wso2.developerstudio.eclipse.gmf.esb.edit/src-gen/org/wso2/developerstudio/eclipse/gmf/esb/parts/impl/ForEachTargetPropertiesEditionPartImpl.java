 ...
 * 
 */
public class ForEachTargetPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ForEachTargetPropertiesEditionPart {
    ...
    protected Composite createSequenceTypeEMFComboViewer(Composite parent) {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ForEachTargetPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachTarget.Properties.sequenceType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSequenceFlatComboViewer(Composite parent) {
        ...
        sequence = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
                .isRequired(EsbViewsRepository.ForEachTarget.Properties.sequence, EsbViewsRepository.SWT_KIND));
        ...
        sequence.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                propertiesEditionComponent
                        .firePropertiesChanged(new PropertiesEditionEvent(ForEachTargetPropertiesEditionPartImpl.this,
                                EsbViewsRepository.ForEachTarget.Properties.sequence, PropertiesEditionEvent.CHANGE,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachTarget.Properties.sequence, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEndpointTypeEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachTarget.Properties.endpointType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSoapActionText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachTarget.Properties.soapAction, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createToAddressText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachTarget.Properties.toAddress, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
