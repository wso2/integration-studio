 ...
 * @generated
 */
public class UpperCaseCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater.getUpperCase_2011SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater.getUpperCase_2011SemanticChildren((View) getHost().getModel());
