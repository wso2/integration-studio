...
public class LoopBackMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public LoopBackMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject loopBackMediator, String editing_mode) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.LoopBackMediator.Properties.description)) {
