...
public class ClassPropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ClassPropertyPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject classProperty,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ClassProperty.Properties.propertyValue))
                basePart.setPropertyValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        classProperty.getPropertyValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ClassProperty.Properties.propertyName == event.getAffectedEditor()) {
            classProperty.setPropertyName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.ClassProperty.Properties.propertyValue == event.getAffectedEditor()) {
            classProperty.setPropertyValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueExpressionProperty_PropertyName().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.ClassProperty.Properties.propertyName)) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueExpressionProperty_PropertyValueType().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.ClassProperty.Properties.propertyValueType))
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueExpressionProperty_PropertyValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ClassProperty.Properties.propertyValue)) {
                if (msg.getNewValue() != null) {
