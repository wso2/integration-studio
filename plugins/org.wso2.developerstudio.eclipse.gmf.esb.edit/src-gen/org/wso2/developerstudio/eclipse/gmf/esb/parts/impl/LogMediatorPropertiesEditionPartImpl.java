...
public class LogMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, LogMediatorPropertiesEditionPart {
	...
	protected Composite createCommentsListMultiValuedEditor(Composite parent) {
		...
		editCommentsList.setText(getDescription(EsbViewsRepository.LogMediator.Properties.commentsList, EsbMessages.LogMediatorPropertiesEditionPart_CommentsListLabel));
		...
		editCommentsList.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.LogMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(commentsListList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createReverseCheckbox(Composite parent) {
		...
		reverse.setText(getDescription(EsbViewsRepository.LogMediator.Properties.reverse, EsbMessages.LogMediatorPropertiesEditionPart_ReverseLabel));
		reverse.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LogMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.LogMediator.Properties.reverse, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(reverse.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.LogMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
