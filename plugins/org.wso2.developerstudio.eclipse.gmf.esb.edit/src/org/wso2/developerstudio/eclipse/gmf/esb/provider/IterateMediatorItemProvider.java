...
public class IterateMediatorItemProvider extends MediatorItemProvider {
    ...
    protected void addIterateIDPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_IterateMediator_iterateID_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_IterateMediator_iterateID_feature",
                                "_UI_IterateMediator_type"),
                        EsbPackage.Literals.ITERATE_MEDIATOR__ITERATE_ID, true, false, false,
    ...
    protected void addSequentialMediationPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_IterateMediator_sequentialMediation_feature",
                        "_UI_IterateMediator_type"),
                EsbPackage.Literals.ITERATE_MEDIATOR__SEQUENTIAL_MEDIATION, true, false, false,
    ...
    protected void addContinueParentPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_IterateMediator_continueParent_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_IterateMediator_continueParent_feature",
                                "_UI_IterateMediator_type"),
                        EsbPackage.Literals.ITERATE_MEDIATOR__CONTINUE_PARENT, true, false, false,
                        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addPreservePayloadPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_IterateMediator_preservePayload_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_IterateMediator_preservePayload_feature",
                                "_UI_IterateMediator_type"),
                        EsbPackage.Literals.ITERATE_MEDIATOR__PRESERVE_PAYLOAD, true, false, false,
                        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addSequenceTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_IterateMediator_sequenceType_feature",
                        "_UI_IterateMediator_type"),
                EsbPackage.Literals.ITERATE_MEDIATOR__SEQUENCE_TYPE, true, false, false,
    ...
    protected void addSequenceKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_IterateMediator_sequenceKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_IterateMediator_sequenceKey_feature",
                                "_UI_IterateMediator_type"),
                        EsbPackage.Literals.ITERATE_MEDIATOR__SEQUENCE_KEY, true, false, false, null,
    ...
    protected void addSequenceNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_IterateMediator_sequenceName_feature",
                        "_UI_IterateMediator_type"),
                EsbPackage.Literals.ITERATE_MEDIATOR__SEQUENCE_NAME, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_SequencePropertyCategory"), null));
    }
    ...
    /**
     * This returns IterateMediator.png.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated NOT
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/IterateMediator.png"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_IterateMediator_type")
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.ITERATE_MEDIATOR__ITERATE_EXPRESSION,
                EsbFactory.eINSTANCE.createNamespacedProperty()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.ITERATE_MEDIATOR__ATTACH_PATH,
                EsbFactory.eINSTANCE.createNamespacedProperty()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.ITERATE_MEDIATOR__TARGET,
                EsbFactory.eINSTANCE.createIterateTarget()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.ITERATE_MEDIATOR__INPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createIterateMediatorInputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.ITERATE_MEDIATOR__OUTPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createIterateMediatorOutputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.ITERATE_MEDIATOR__TARGET_OUTPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createIterateMediatorTargetOutputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.ITERATE_MEDIATOR__MEDIATOR_FLOW,
                EsbFactory.eINSTANCE.createMediatorFlow()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.ITERATE_MEDIATOR__SEQUENCE_KEY,
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify = childFeature == EsbPackage.Literals.ITERATE_MEDIATOR__ITERATE_EXPRESSION
