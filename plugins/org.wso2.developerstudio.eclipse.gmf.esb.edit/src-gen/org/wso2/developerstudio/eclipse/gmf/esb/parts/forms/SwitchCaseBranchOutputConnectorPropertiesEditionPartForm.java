 ...
 * 
 */
public class SwitchCaseBranchOutputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, SwitchCaseBranchOutputConnectorPropertiesEditionPart {
     ...
     */
    public SwitchCaseBranchOutputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        propertiesSection
                .setText(EsbMessages.SwitchCaseBranchOutputConnectorPropertiesEditionPart_PropertiesGroupLabel);
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SwitchCaseBranchOutputConnectorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SwitchCaseBranchOutputConnector.Properties.commentMediators,
    ...
    protected Composite createCaseRegexText(FormToolkit widgetFactory, Composite parent) {
        ...
        caseRegex.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SwitchCaseBranchOutputConnectorPropertiesEditionPartForm.this, null,
