 ...
 * @generated
 */
public class DataMapperModelingAssistantProviderOfOperatorRightContainerEditPart extends DataMapperModelingAssistantProvider {
	...
	public List<IElementType> getTypesForPopupBar(IAdaptable host) {
		...
		types.add(DataMapperElementTypes.OperatorRightConnector_3017);
		return types;
	}
