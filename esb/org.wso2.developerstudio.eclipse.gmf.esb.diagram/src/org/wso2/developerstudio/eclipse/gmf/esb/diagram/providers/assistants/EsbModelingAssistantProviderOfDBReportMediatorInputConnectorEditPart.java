 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfDBReportMediatorInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			DBReportMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(DBReportMediatorInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
