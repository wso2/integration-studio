...
public class WSDLEndPointTransformer extends AbstractEndpointTransformer {
    ...
    public org.apache.synapse.SynapseArtifact create(WsdlEndpointFormPage wsdlEndpointFormPage)
        ...
        synapseWSDLEP.setCommentsList(wsdlEndpointFormPage.getEndpointCommentList());
     ...
     * @param endpoint
     */
    protected void saveProperties(WsdlEndpointFormPage endpointFormPage,
            org.apache.synapse.endpoints.WSDLEndpoint synapseHttpEP) {
