 ...
 * 
 */
public class CallMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, CallMediatorPropertiesEditionPart {
     ...
     */
    public CallMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionText = createDescription(parent, EsbViewsRepository.CallMediator.Properties.description,
                EsbMessages.CallMediatorPropertiesEditionPart_DescriptionLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.CallMediator.Properties.description, PropertiesEditionEvent.COMMIT,
        ...
        Control descriptionHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.CallMediator.Properties.description, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.CallMediator.Properties.commentsList,
                        EsbMessages.CallMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "CallMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CallMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.CallMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.CallMediator.Properties.reverse,
                EsbMessages.CallMediatorPropertiesEditionPart_ReverseLabel), SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CallMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CallMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CallMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEndpointReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.endpoint = new ReferencesTable(getDescription(EsbViewsRepository.CallMediator.Properties.endpoint,
                EsbMessages.CallMediatorPropertiesEditionPart_EndpointLabel), new ReferencesTableListener() {
        ...
        this.endpoint.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CallMediator.Properties.endpoint, EsbViewsRepository.FORM_KIND));
        ...
        this.endpoint.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CallMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CallMediator.Properties.endpoint, PropertiesEditionEvent.CHANGE,
        ...
        TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(endpoint.getInput(), endpointFilters,
            ...
            public void process(IStructuredSelection selection) {
                for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CallMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CallMediator.Properties.endpoint, PropertiesEditionEvent.COMMIT,
    ...
    protected void moveEndpoint(EObject element, int oldIndex, int newIndex) {
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                CallMediatorPropertiesEditionPartForm.this, EsbViewsRepository.CallMediator.Properties.endpoint,
    ...
    protected Composite createEndpointTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        filterEndpointTypeSubPropertiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent,
                "Endpoint Type", true);
        Control endpointTypeLabel = createDescription(filterEndpointTypeSubPropertiesGroup,
                EsbViewsRepository.CallMediator.Properties.endpointType,
                EsbMessages.CallMediatorPropertiesEditionPart_EndpointTypeLabel);
        ...
        endpointType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CallMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.CallMediator.Properties.endpointType, PropertiesEditionEvent.COMMIT,
        ...
        Control endpointTypeHelp = FormUtils
                .createHelpButton(widgetFactory, filterEndpointTypeSubPropertiesGroup,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.CallMediator.Properties.endpointType, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createEnableBlockingCallsCheckbox(FormToolkit widgetFactory, Composite parent) {
        enableBlockingCalls = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.CallMediator.Properties.enableBlockingCalls,
                        EsbMessages.CallMediatorPropertiesEditionPart_EnableBlockingCallsLabel),
                SWT.CHECK);
        enableBlockingCalls.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CallMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.CallMediator.Properties.enableBlockingCalls,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(enableBlockingCalls.getSelection())));
            }
        ...
        Control enableBlockingCallsHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CallMediator.Properties.enableBlockingCalls, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallMediatorPropertiesEditionPart#addFilterEndpoint(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallMediatorPropertiesEditionPart#addBusinessFilterEndpoint(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallMediatorPropertiesEditionPart#isContainedInEndpointTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallMediatorPropertiesEditionPart#initEndpointType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallMediatorPropertiesEditionPart#setEndpointType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.CallMediatorPropertiesEditionPart#setEnableBlockingCalls(Boolean
     *      newValue)
     * 
     */
    ...
    protected Composite createEndpointRegistryKeyWidget(FormToolkit widgetFactory, final Composite parent) {
        Control endpointRegistryKeyLabel = createDescription(parent,
                EsbViewsRepository.CallMediator.Properties.endpointRegistryKey,
                EsbMessages.CallMediatorPropertiesEditionPart_EndpointRegistryKeyLabel);
        widgetFactory.paintBordersFor(parent);
        if (endpointRegistryKey == null) {
            endpointRegistryKey = EsbFactoryImpl.eINSTANCE.createRegistryKeyProperty();
        }
        String initValueExpression = endpointRegistryKey.getKeyValue().isEmpty() ? ""
                : endpointRegistryKey.getKeyValue();
        ...
        Control endpointRegistryKeyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CallMediator.Properties.endpointRegistryKey, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        endpointRegistryKeyElements = new Control[] { endpointRegistryKeyLabel, endpointRegistryKeyText,
                endpointRegistryKeyHelp };
        return parent;
    }

    protected Composite createEndpointXPathWidget(FormToolkit widgetFactory, final Composite parent) {
        Control endpointXPathLabel = createDescription(parent, EsbViewsRepository.CallMediator.Properties.endpointXpath,
                EsbMessages.CallMediatorPropertiesEditionPart_EndpointXpathLabel);
        widgetFactory.paintBordersFor(parent);
        if (endpointXPath == null) {
            endpointXPath = EsbFactoryImpl.eINSTANCE.createNamespacedProperty();
        }
        String initValueExpression = endpointXPath.getPropertyValue().isEmpty() ? "/default/expression"
                : endpointXPath.getPropertyValue();
        ...
        Control endpointXPathHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.CallMediator.Properties.endpointXpath, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
