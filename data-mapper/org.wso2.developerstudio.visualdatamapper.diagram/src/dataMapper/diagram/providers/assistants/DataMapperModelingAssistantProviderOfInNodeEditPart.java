...
public class DataMapperModelingAssistantProviderOfInNodeEditPart extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((dataMapper.diagram.edit.parts.InNodeEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			dataMapper.diagram.edit.parts.InNodeEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((dataMapper.diagram.edit.parts.InNodeEditPart) targetEditPart,
				relationshipType);
	}
	...
	public List<IElementType> doGetTypesForSource(
			dataMapper.diagram.edit.parts.InNodeEditPart target, IElementType relationshipType) {
