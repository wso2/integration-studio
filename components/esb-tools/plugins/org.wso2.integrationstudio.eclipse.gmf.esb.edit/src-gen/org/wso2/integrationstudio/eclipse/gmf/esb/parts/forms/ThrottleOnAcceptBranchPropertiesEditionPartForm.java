 ...
 * 
 */
public class ThrottleOnAcceptBranchPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ThrottleOnAcceptBranchPropertiesEditionPart {
	 ...
	 */
	public ThrottleOnAcceptBranchPropertiesEditionPartForm() { super(); }
		...
		sequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ThrottleOnAcceptBranchPropertiesEditionPartForm.this, EsbViewsRepository.ThrottleOnAcceptBranch.Properties.sequenceType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getSequenceType()));
			}

		});
		sequenceType.setID(EsbViewsRepository.ThrottleOnAcceptBranch.Properties.sequenceType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.ThrottleOnAcceptBranch.Properties.sequenceType, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
