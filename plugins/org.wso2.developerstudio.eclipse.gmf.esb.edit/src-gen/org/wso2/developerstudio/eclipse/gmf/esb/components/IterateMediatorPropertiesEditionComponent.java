...
public class IterateMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public IterateMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject iterateMediator, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(EsbViewsRepository.IterateMediator.Properties.description))
				basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, iterateMediator.getDescription()));
			...
			if (isAccessible(EsbViewsRepository.IterateMediator.Properties.iterateID))
				basePart.setIterateID(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, iterateMediator.getIterateID()));
			...
			if (isAccessible(EsbViewsRepository.IterateMediator.Properties.sequenceType)) {
				basePart.initSequenceType(EEFUtils.choiceOfValues(iterateMediator, EsbPackage.eINSTANCE.getIterateMediator_SequenceType()), iterateMediator.getSequenceType());
			}
			if (isAccessible(EsbViewsRepository.IterateMediator.Properties.sequenceName))
				basePart.setSequenceName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, iterateMediator.getSequenceName()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (EsbViewsRepository.IterateMediator.Properties.description == event.getAffectedEditor()) {
			iterateMediator.setDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		...
		if (EsbViewsRepository.IterateMediator.Properties.iterateID == event.getAffectedEditor()) {
			iterateMediator.setIterateID((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		...
		if (EsbViewsRepository.IterateMediator.Properties.sequenceName == event.getAffectedEditor()) {
			iterateMediator.setSequenceName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.IterateMediator.Properties.description)) {
			...
			if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.IterateMediator.Properties.commentsList)) {
			...
			if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.IterateMediator.Properties.reverse))
				basePart.setReverse((Boolean)msg.getNewValue());
			
			if (EsbPackage.eINSTANCE.getIterateMediator_IterateID().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.IterateMediator.Properties.iterateID)) {
				if (msg.getNewValue() != null) {
			...
			if (EsbPackage.eINSTANCE.getIterateMediator_SequentialMediation().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.IterateMediator.Properties.sequentialMediation))
				basePart.setSequentialMediation((Boolean)msg.getNewValue());
			
			if (EsbPackage.eINSTANCE.getIterateMediator_ContinueParent().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.IterateMediator.Properties.continueParent))
				basePart.setContinueParent((Boolean)msg.getNewValue());
			
			if (EsbPackage.eINSTANCE.getIterateMediator_PreservePayload().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.IterateMediator.Properties.preservePayload))
				basePart.setPreservePayload((Boolean)msg.getNewValue());
			
			if (EsbPackage.eINSTANCE.getIterateMediator_SequenceType().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(EsbViewsRepository.IterateMediator.Properties.sequenceType))
				basePart.setSequenceType((SequenceType)msg.getNewValue());
			
			if (EsbPackage.eINSTANCE.getIterateMediator_SequenceName().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EsbViewsRepository.IterateMediator.Properties.sequenceName)) {
				if (msg.getNewValue() != null) {
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			EsbPackage.eINSTANCE.getIterateMediator_IterateID(),
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (EsbViewsRepository.IterateMediator.Properties.iterateID == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE.getIterateMediator_IterateID().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getIterateMediator_IterateID().getEAttributeType(), newValue);
				}
				if (EsbViewsRepository.IterateMediator.Properties.sequentialMediation == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE.getIterateMediator_SequentialMediation().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getIterateMediator_SequentialMediation().getEAttributeType(), newValue);
				}
				if (EsbViewsRepository.IterateMediator.Properties.continueParent == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE.getIterateMediator_ContinueParent().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getIterateMediator_ContinueParent().getEAttributeType(), newValue);
				}
				if (EsbViewsRepository.IterateMediator.Properties.preservePayload == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE.getIterateMediator_PreservePayload().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getIterateMediator_PreservePayload().getEAttributeType(), newValue);
				}
				if (EsbViewsRepository.IterateMediator.Properties.sequenceType == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE.getIterateMediator_SequenceType().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getIterateMediator_SequenceType().getEAttributeType(), newValue);
				}
				if (EsbViewsRepository.IterateMediator.Properties.sequenceName == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(EsbPackage.eINSTANCE.getIterateMediator_SequenceName().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(EsbPackage.eINSTANCE.getIterateMediator_SequenceName().getEAttributeType(), newValue);
				}
