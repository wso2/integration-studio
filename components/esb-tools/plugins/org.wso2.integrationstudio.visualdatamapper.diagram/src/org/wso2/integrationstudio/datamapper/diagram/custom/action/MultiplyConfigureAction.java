...
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigureMultiplyOperatorDialog;

public class MultiplyConfigureAction extends AbstractActionHandler {
	 ...
	 */
	public MultiplyConfigureAction(IWorkbenchPart part) {
		super(part);
		setId(Messages.MultiplyConfigureAction_ActionId);
		setText(Messages.MultiplyConfigureAction_ActionText);
		setToolTipText(Messages.MultiplyConfigureAction_ToolTip);
	...
	protected void doRun(IProgressMonitor progressMonitor) {
		...
		Dialog configureConstantDialog = new ConfigureMultiplyOperatorDialog(Display.getDefault().getActiveShell(),
				(Multiply) selectedObj, getEditingDomain());
