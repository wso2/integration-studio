 ...
 * 
 */
public class MethodArgumentPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, MethodArgumentPropertiesEditionPart {
     ...
     */
    public MethodArgumentPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createPropertyNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MethodArgument.Properties.propertyName,
                EsbMessages.MethodArgumentPropertiesEditionPart_PropertyNameLabel);
        ...
        propertyName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.MethodArgument.Properties.propertyName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, propertyName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MethodArgumentPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MethodArgumentPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MethodArgument.Properties.propertyName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertyValueTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MethodArgument.Properties.propertyValueType,
                EsbMessages.MethodArgumentPropertiesEditionPart_PropertyValueTypeLabel);
        ...
        propertyValueType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MethodArgumentPropertiesEditionPartForm.this,
                            EsbViewsRepository.MethodArgument.Properties.propertyValueType,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPropertyValueType()));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.MethodArgument.Properties.propertyValueType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertyValueText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.MethodArgument.Properties.propertyValue,
                EsbMessages.MethodArgumentPropertiesEditionPart_PropertyValueLabel);
        ...
        propertyValue.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MethodArgumentPropertiesEditionPartForm.this,
                            EsbViewsRepository.MethodArgument.Properties.propertyValue, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.MethodArgument.Properties.propertyValue, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MethodArgumentPropertiesEditionPart#setPropertyName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MethodArgumentPropertiesEditionPart#initPropertyValueType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MethodArgumentPropertiesEditionPart#setPropertyValueType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.MethodArgumentPropertiesEditionPart#setPropertyValue(String
     *      newValue)
     * 
     */
