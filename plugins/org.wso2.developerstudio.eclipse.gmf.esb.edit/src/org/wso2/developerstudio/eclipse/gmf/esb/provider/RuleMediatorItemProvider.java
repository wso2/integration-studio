...
public class RuleMediatorItemProvider extends MediatorItemProvider {
    ...
    protected void addRuleSetURLPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_RuleSetURL_feature",
                        "_UI_RuleMediator_type"),
                EsbPackage.Literals.RULE_MEDIATOR__RULE_SET_URL, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_RuleSetPropertyCategory"), null));
    }
    ...
    protected void addRuleSetSourceTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_ruleSetSourceType_feature",
                        "_UI_RuleMediator_type"),
                EsbPackage.Literals.RULE_MEDIATOR__RULE_SET_SOURCE_TYPE, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_RuleSetPropertyCategory"), null));
    }
    ...
    protected void addRuleSetSourceCodePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_ruleSetSourceCode_feature",
                        "_UI_RuleMediator_type"),
                EsbPackage.Literals.RULE_MEDIATOR__RULE_SET_SOURCE_CODE, true, true, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_RuleSetPropertyCategory"), null));
    }
    ...
    protected void addRuleSetSourceKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_RuleMediator_ruleSetSourceKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_ruleSetSourceKey_feature",
                                "_UI_RuleMediator_type"),
                        EsbPackage.Literals.RULE_MEDIATOR__RULE_SET_SOURCE_KEY, true, false, false, null,
                        getString("_UI_RuleSetPropertyCategory"), null));
    }
    ...
    protected void addStatefulSessionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_statefulSession_feature",
                        "_UI_RuleMediator_type"),
                EsbPackage.Literals.RULE_MEDIATOR__STATEFUL_SESSION, true, false, false,
                ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, getString("_UI_RuleSessionPropertyCategory"), null));
    }
    ...
    protected void addRuleSessionPropertiesPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_RuleSessionProperties_feature",
                        "_UI_RuleMediator_type"),
                EsbPackage.Literals.RULE_MEDIATOR__RULE_SESSION_PROPERTIES, true, false, false, null,
                getString("_UI_RuleSessionPropertyCategory"), null));
    }
    ...
    protected void addFactsConfigurationPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_RuleMediator_factsConfiguration_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_factsConfiguration_feature",
                                "_UI_RuleMediator_type"),
                        EsbPackage.Literals.RULE_MEDIATOR__FACTS_CONFIGURATION, true, false, false, null,
    ...
    protected void addResultsConfigurationPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_RuleMediator_resultsConfiguration_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_resultsConfiguration_feature",
                                "_UI_RuleMediator_type"),
                        EsbPackage.Literals.RULE_MEDIATOR__RESULTS_CONFIGURATION, true, false, false, null,
                        getString("_UI_OutputFactsPropertyCategory"), null));
    }
    ...
    protected void addSourceValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_sourceValue_feature",
                        "_UI_RuleMediator_type"),
                EsbPackage.Literals.RULE_MEDIATOR__SOURCE_VALUE, true, false, false,
    ...
    protected void addSourceXpathPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_RuleMediator_sourceXpath_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_sourceXpath_feature",
                                "_UI_RuleMediator_type"),
                        EsbPackage.Literals.RULE_MEDIATOR__SOURCE_XPATH, true, false, true, null,
    ...
    protected void addTargetValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_targetValue_feature",
                        "_UI_RuleMediator_type"),
                EsbPackage.Literals.RULE_MEDIATOR__TARGET_VALUE, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_TargetPropertyCategory"), null));
    }
    ...
    protected void addTargetResultXpathPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_RuleMediator_targetResultXpath_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_targetResultXpath_feature",
                                "_UI_RuleMediator_type"),
                        EsbPackage.Literals.RULE_MEDIATOR__TARGET_RESULT_XPATH, true, false, true, null,
    ...
    protected void addTargetXpathPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_RuleMediator_targetXpath_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_targetXpath_feature",
                                "_UI_RuleMediator_type"),
                        EsbPackage.Literals.RULE_MEDIATOR__TARGET_XPATH, true, false, true, null,
                        getString("_UI_TargetPropertyCategory"), null));
    }
    ...
    protected void addTargetActionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_targetAction_feature",
                        "_UI_RuleMediator_type"),
                EsbPackage.Literals.RULE_MEDIATOR__TARGET_ACTION, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_TargetPropertyCategory"), null));
    }
    ...
    protected void addInputWrapperNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_InputWrapperName_feature",
                        "_UI_RuleMediator_type"),
                EsbPackage.Literals.RULE_MEDIATOR__INPUT_WRAPPER_NAME, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_InputFactsPropertyCategory"), null));
    }
    ...
    protected void addInputNameSpacePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_InputNameSpace_feature",
                        "_UI_RuleMediator_type"),
                EsbPackage.Literals.RULE_MEDIATOR__INPUT_NAME_SPACE, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_InputFactsPropertyCategory"), null));
    }
    ...
    protected void addOutputWrapperNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_OutputWrapperName_feature",
                        "_UI_RuleMediator_type"),
                EsbPackage.Literals.RULE_MEDIATOR__OUTPUT_WRAPPER_NAME, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_OutputFactsPropertyCategory"), null));
    }
    ...
    protected void addOutputNameSpacePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_OutputNameSpace_feature",
                        "_UI_RuleMediator_type"),
                EsbPackage.Literals.RULE_MEDIATOR__OUTPUT_NAME_SPACE, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_OutputFactsPropertyCategory"), null));
    }
    ...
    protected void addRuleSetTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_RuleMediator_RuleSetType_feature",
                        "_UI_RuleMediator_type"),
                EsbPackage.Literals.RULE_MEDIATOR__RULE_SET_TYPE, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_RuleSetPropertyCategory"), null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_RuleMediator_type")
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.RULE_MEDIATOR__RULE_SET_SOURCE_KEY,
                EsbFactory.eINSTANCE.createRegistryKeyProperty()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.RULE_MEDIATOR__RULE_SESSION_PROPERTIES,
                EsbFactory.eINSTANCE.createRuleSessionProperty()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.RULE_MEDIATOR__FACTS_CONFIGURATION,
                EsbFactory.eINSTANCE.createRuleFactsConfiguration()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.RULE_MEDIATOR__RESULTS_CONFIGURATION,
                EsbFactory.eINSTANCE.createRuleResultsConfiguration()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.RULE_MEDIATOR__CHILD_MEDIATORS_CONFIGURATION,
                EsbFactory.eINSTANCE.createRuleChildMediatorsConfiguration()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.RULE_MEDIATOR__INPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createRuleMediatorInputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.RULE_MEDIATOR__OUTPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createRuleMediatorOutputConnector()));

        newChildDescriptors
                .add(createChildParameter(EsbPackage.Literals.RULE_MEDIATOR__CHILD_MEDIATORS_OUTPUT_CONNECTOR,
                        EsbFactory.eINSTANCE.createRuleMediatorChildMediatorsOutputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.RULE_MEDIATOR__MEDIATOR_FLOW,
