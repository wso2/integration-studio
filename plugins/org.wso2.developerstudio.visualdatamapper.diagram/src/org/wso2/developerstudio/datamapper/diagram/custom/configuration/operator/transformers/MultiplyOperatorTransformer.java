    ...
    public String generateScriptForOperation(Class<?> generatorClass, List<DMVariable> inputVariables,
        ...
        if (DifferentLevelArrayMappingConfigGenerator.class.equals(generatorClass)) {
            ...
            if (inputVariables.size() == 0) {
                ...
                operationBuilder.append(CONSTANT_MULTIPLY_SIGN + ScriptGenerationUtil.getPrettyVariableNameInForOperation(inputVariables.get(0),
                        variableTypeMap, parentForLoopBeanStack, true));
                for (int variableIndex = 1; variableIndex < inputVariables.size(); variableIndex++) {
                    operationBuilder.append(CONSTANT_MULTIPLY_SIGN + ScriptGenerationUtil.getPrettyVariableNameInForOperation(
