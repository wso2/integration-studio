 ...
 * 
 */
public class LoadBalanceEndPointWestOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public LoadBalanceEndPointWestOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject loadBalanceEndPointWestOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.LoadBalanceEndPointWestOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(loadBalanceEndPointWestOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.LoadBalanceEndPointWestOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
