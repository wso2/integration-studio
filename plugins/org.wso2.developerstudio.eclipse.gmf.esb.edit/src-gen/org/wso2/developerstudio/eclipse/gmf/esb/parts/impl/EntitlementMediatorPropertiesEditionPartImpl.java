 ...
 * 
 */
public class EntitlementMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EntitlementMediatorPropertiesEditionPart {
	...
	protected Composite createDescriptionText(Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EntitlementMediator.Properties.description, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCommentsListMultiValuedEditor(Composite parent) {
		...
		editCommentsList.setText(getDescription(EsbViewsRepository.EntitlementMediator.Properties.commentsList, EsbMessages.EntitlementMediatorPropertiesEditionPart_CommentsListLabel));
		...
		editCommentsList.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(commentsListList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createReverseCheckbox(Composite parent) {
		...
		reverse.setText(getDescription(EsbViewsRepository.EntitlementMediator.Properties.reverse, EsbMessages.EntitlementMediatorPropertiesEditionPart_ReverseLabel));
		reverse.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.reverse, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(reverse.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EntitlementMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createEntitlementServerURLText(Composite parent) {
		...
		entitlementServerURL.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.entitlementServerURL, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, entitlementServerURL.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EntitlementMediator.Properties.entitlementServerURL, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createUsernameText(Composite parent) {
		...
		username.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.username, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, username.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EntitlementMediator.Properties.username, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPasswordText(Composite parent) {
		...
		password.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.password, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, password.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EntitlementMediator.Properties.password, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCallbackClassNameText(Composite parent) {
		...
		callbackClassName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.callbackClassName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, callbackClassName.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EntitlementMediator.Properties.callbackClassName, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createThriftHostText(Composite parent) {
		...
		thriftHost.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.thriftHost, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, thriftHost.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EntitlementMediator.Properties.thriftHost, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createThriftPortText(Composite parent) {
		...
		thriftPort.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.thriftPort, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, thriftPort.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EntitlementMediator.Properties.thriftPort, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createEntitlementClientTypeEMFComboViewer(Composite parent) {
		...
		entitlementClientType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.entitlementClientType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getEntitlementClientType()));
			}

		});
		entitlementClientType.setID(EsbViewsRepository.EntitlementMediator.Properties.entitlementClientType);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EntitlementMediator.Properties.entitlementClientType, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createOnRejectSequenceTypeEMFComboViewer(Composite parent) {
		...
		onRejectSequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.onRejectSequenceType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getOnRejectSequenceType()));
			}

		});
		onRejectSequenceType.setID(EsbViewsRepository.EntitlementMediator.Properties.onRejectSequenceType);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EntitlementMediator.Properties.onRejectSequenceType, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createOnAcceptSequenceTypeEMFComboViewer(Composite parent) {
		...
		onAcceptSequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.onAcceptSequenceType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getOnAcceptSequenceType()));
			}

		});
		onAcceptSequenceType.setID(EsbViewsRepository.EntitlementMediator.Properties.onAcceptSequenceType);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EntitlementMediator.Properties.onAcceptSequenceType, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createAdviceSequenceTypeEMFComboViewer(Composite parent) {
		...
		adviceSequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.adviceSequenceType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getAdviceSequenceType()));
			}

		});
		adviceSequenceType.setID(EsbViewsRepository.EntitlementMediator.Properties.adviceSequenceType);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EntitlementMediator.Properties.adviceSequenceType, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createObligationsSequenceTypeEMFComboViewer(Composite parent) {
		...
		obligationsSequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.obligationsSequenceType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getObligationsSequenceType()));
			}

		});
		obligationsSequenceType.setID(EsbViewsRepository.EntitlementMediator.Properties.obligationsSequenceType);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EntitlementMediator.Properties.obligationsSequenceType, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCallbackHandlerEMFComboViewer(Composite parent) {
		...
		callbackHandler.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EntitlementMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.EntitlementMediator.Properties.callbackHandler, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getCallbackHandler()));
			}

		});
		callbackHandler.setID(EsbViewsRepository.EntitlementMediator.Properties.callbackHandler);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.EntitlementMediator.Properties.callbackHandler, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
