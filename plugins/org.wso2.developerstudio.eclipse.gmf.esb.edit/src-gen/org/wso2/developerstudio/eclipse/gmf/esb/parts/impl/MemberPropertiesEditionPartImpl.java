 ...
 * 
 */
public class MemberPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, MemberPropertiesEditionPart {
    ...
    protected Composite createHostNameText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MemberPropertiesEditionPartImpl.this, EsbViewsRepository.Member.Properties.hostName,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Member.Properties.hostName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createHttpPortText(Composite parent) {
        ...
        httpPort.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MemberPropertiesEditionPartImpl.this, EsbViewsRepository.Member.Properties.httpPort,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Member.Properties.httpPort, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createHttpsPortText(Composite parent) {
        ...
        httpsPort.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MemberPropertiesEditionPartImpl.this, EsbViewsRepository.Member.Properties.httpsPort,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Member.Properties.httpsPort, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
