 ...
 * @generated NOT
 */
public class OAuthMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, OAuthMediatorPropertiesEditionPart {
     ...
     */
    public OAuthMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.OAuthMediator.Properties.description,
                EsbMessages.OAuthMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.OAuthMediator.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(OAuthMediatorPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            OAuthMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.OAuthMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.OAuthMediator.Properties.commentsList,
                        EsbMessages.OAuthMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "OAuthMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            OAuthMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.OAuthMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        Control[] previousList = propertiesGroup.getChildren();
        reverse = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.OAuthMediator.Properties.reverse,
                EsbMessages.OAuthMediatorPropertiesEditionPart_ReverseLabel), SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(OAuthMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.OAuthMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.OAuthMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRemoteServiceUrlText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.OAuthMediator.Properties.remoteServiceUrl,
                EsbMessages.OAuthMediatorPropertiesEditionPart_RemoteServiceUrlLabel);
        ...
        remoteServiceUrl.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            OAuthMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.OAuthMediator.Properties.remoteServiceUrl, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, remoteServiceUrl.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(OAuthMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.OAuthMediator.Properties.remoteServiceUrl,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    remoteServiceUrl.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.OAuthMediator.Properties.remoteServiceUrl, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createUsernameText(FormToolkit widgetFactory, Composite parent) {
        filterCredentialsSubPropertiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent,
                "Credentials", true);
        createDescription(filterCredentialsSubPropertiesGroup, EsbViewsRepository.OAuthMediator.Properties.username,
                EsbMessages.OAuthMediatorPropertiesEditionPart_UsernameLabel);
        ...
        username.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(OAuthMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.OAuthMediator.Properties.username, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, username.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            OAuthMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.OAuthMediator.Properties.username, PropertiesEditionEvent.FOCUS_CHANGED,
    ...
    protected Composite createPasswordText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.OAuthMediator.Properties.password,
                EsbMessages.OAuthMediatorPropertiesEditionPart_PasswordLabel);
        ...
        password.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(OAuthMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.OAuthMediator.Properties.password, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, password.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            OAuthMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.OAuthMediator.Properties.password, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.OAuthMediator.Properties.password, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.OAuthMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.OAuthMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.OAuthMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.OAuthMediatorPropertiesEditionPart#setRemoteServiceUrl(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.OAuthMediatorPropertiesEditionPart#setUsername(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.OAuthMediatorPropertiesEditionPart#setPassword(String
     *      newValue)
     * 
     */
