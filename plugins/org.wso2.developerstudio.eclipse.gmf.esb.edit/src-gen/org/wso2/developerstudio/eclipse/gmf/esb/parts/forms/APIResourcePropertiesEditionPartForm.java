 ...
 * 
 */
public class APIResourcePropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, APIResourcePropertiesEditionPart {
     ...
     */
    public APIResourcePropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        aPIResourceStep.addStep(EsbViewsRepository.APIResource.Properties.class)
    ...
    protected Composite createInSequenceInputConnectorsTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.inSequenceInputConnectors = new ReferencesTable(
                getDescription(EsbViewsRepository.APIResource.Properties.inSequenceInputConnectors,
                        EsbMessages.APIResourcePropertiesEditionPart_InSequenceInputConnectorsLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(APIResourcePropertiesEditionPartForm.this,
                                        EsbViewsRepository.APIResource.Properties.inSequenceInputConnectors,
        ...
        this.inSequenceInputConnectors.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResource.Properties.inSequenceInputConnectors, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createUrlStyleEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control urlStyleLabel = createDescription(parent, EsbViewsRepository.APIResource.Basic.urlStyle,
                EsbMessages.APIResourcePropertiesEditionPart_UrlStyleLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourcePropertiesEditionPartForm.this, EsbViewsRepository.APIResource.Basic.urlStyle,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getUrlStyle()));
                refresh();
            }

        });
        urlStyle.setID(EsbViewsRepository.APIResource.Basic.urlStyle);
        Control urlStyleHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Basic.urlStyle, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createUriTemplateText(FormToolkit widgetFactory, Composite parent) {
        Control uriTemplateLabel = createDescription(parent, EsbViewsRepository.APIResource.Basic.uriTemplate,
                EsbMessages.APIResourcePropertiesEditionPart_UriTemplateLabel);
        ...
        uriTemplate.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourcePropertiesEditionPartForm.this, EsbViewsRepository.APIResource.Basic.uriTemplate,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourcePropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(APIResourcePropertiesEditionPartForm.this,
                                        EsbViewsRepository.APIResource.Basic.uriTemplate, PropertiesEditionEvent.COMMIT,
        ...
        Control uriTemplateHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Basic.uriTemplate, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createUrlMappingText(FormToolkit widgetFactory, Composite parent) {
        Control urlMappingLabel = createDescription(parent, EsbViewsRepository.APIResource.Basic.urlMapping,
                EsbMessages.APIResourcePropertiesEditionPart_UrlMappingLabel);
        ...
        urlMapping.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourcePropertiesEditionPartForm.this, EsbViewsRepository.APIResource.Basic.urlMapping,
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(APIResourcePropertiesEditionPartForm.this,
                                        EsbViewsRepository.APIResource.Basic.urlMapping, PropertiesEditionEvent.COMMIT,
                                        PropertiesEditionEvent.SET, null, urlMapping.getText()));
                }
            }
        });
        ...
        Control urlMappingHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Basic.urlMapping, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createProtocolEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control protocolLabel = createDescription(parent, EsbViewsRepository.APIResource.Basic.protocol,
                EsbMessages.APIResourcePropertiesEditionPart_ProtocolLabel);
        ...
        protocol.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourcePropertiesEditionPartForm.this, EsbViewsRepository.APIResource.Basic.protocol,
        ...
        Control protocolHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Basic.protocol, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMethodsGroup(FormToolkit widgetFactory, final Composite parent) {
        Section methodsSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createAllowGetCheckbox(FormToolkit widgetFactory, Composite parent) {
        allowGet = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.APIResource.Methods.allowGet,
                EsbMessages.APIResourcePropertiesEditionPart_AllowGetLabel), SWT.CHECK);
        allowGet.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(APIResourcePropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResource.Methods.allowGet, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, new Boolean(allowGet.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Methods.allowGet, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAllowPostCheckbox(FormToolkit widgetFactory, Composite parent) {
        allowPost = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.APIResource.Methods.allowPost,
                EsbMessages.APIResourcePropertiesEditionPart_AllowPostLabel), SWT.CHECK);
        allowPost.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(APIResourcePropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResource.Methods.allowPost, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, new Boolean(allowPost.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Methods.allowPost, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAllowPutCheckbox(FormToolkit widgetFactory, Composite parent) {
        allowPut = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.APIResource.Methods.allowPut,
                EsbMessages.APIResourcePropertiesEditionPart_AllowPutLabel), SWT.CHECK);
        allowPut.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(APIResourcePropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResource.Methods.allowPut, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, new Boolean(allowPut.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Methods.allowPut, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAllowDeleteCheckbox(FormToolkit widgetFactory, Composite parent) {
        allowDelete = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.APIResource.Methods.allowDelete,
                        EsbMessages.APIResourcePropertiesEditionPart_AllowDeleteLabel),
                SWT.CHECK);
        allowDelete.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(APIResourcePropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResource.Methods.allowDelete, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, new Boolean(allowDelete.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResource.Methods.allowDelete, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAllowOptionsCheckbox(FormToolkit widgetFactory, Composite parent) {
        allowOptions = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.APIResource.Methods.allowOptions,
                        EsbMessages.APIResourcePropertiesEditionPart_AllowOptionsLabel),
                SWT.CHECK);
        allowOptions.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(APIResourcePropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResource.Methods.allowOptions, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, new Boolean(allowOptions.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResource.Methods.allowOptions, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAllowHeadCheckbox(FormToolkit widgetFactory, Composite parent) {
        allowHead = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.APIResource.Methods.allowHead,
                EsbMessages.APIResourcePropertiesEditionPart_AllowHeadLabel), SWT.CHECK);
        allowHead.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(APIResourcePropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResource.Methods.allowHead, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, new Boolean(allowHead.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Methods.allowHead, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAllowPatchCheckbox(FormToolkit widgetFactory, Composite parent) {
        allowPatch = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.APIResource.Methods.allowPatch,
                        EsbMessages.APIResourcePropertiesEditionPart_AllowPatchLabel),
                SWT.CHECK);
        allowPatch.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(APIResourcePropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResource.Methods.allowPatch, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, new Boolean(allowPatch.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.APIResource.Methods.allowPatch, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control inSequenceTypeLabel = createDescription(parent,
                EsbViewsRepository.APIResource.InSequence.inSequenceType,
                EsbMessages.APIResourcePropertiesEditionPart_InSequenceTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.APIResource.InSequence.inSequenceType, PropertiesEditionEvent.COMMIT,
        ...
        Control inSequenceHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.APIResource.InSequence.inSequenceType, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createInSequenceNameText(FormToolkit widgetFactory, Composite parent) {
        Control inSequenceNameLabel = createDescription(parent,
                EsbViewsRepository.APIResource.InSequence.inSequenceName,
                EsbMessages.APIResourcePropertiesEditionPart_InSequenceNameLabel);
        ...
        inSequenceName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourcePropertiesEditionPartForm.this,
                            EsbViewsRepository.APIResource.InSequence.inSequenceName, PropertiesEditionEvent.COMMIT,
        ...
        Control inSequenceNameHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.APIResource.InSequence.inSequenceName, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createOutSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control outSequenceTypeLabel = createDescription(parent,
                EsbViewsRepository.APIResource.OutSequence.outSequenceType,
                EsbMessages.APIResourcePropertiesEditionPart_OutSequenceTypeLabel);
        ...
        outSequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourcePropertiesEditionPartForm.this,
                            EsbViewsRepository.APIResource.OutSequence.outSequenceType, PropertiesEditionEvent.COMMIT,
        ...
        Control outSequenceTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.APIResource.OutSequence.outSequenceType,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createOutSequenceTypeEMFComboViewer
        outSequenceTypeElements = new Control[] { outSequenceTypeLabel, outSequenceType.getCombo(),
                outSequenceTypeHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createOutSequenceNameText(FormToolkit widgetFactory, Composite parent) {
        Control outSequenceNameLabel = createDescription(parent,
                EsbViewsRepository.APIResource.OutSequence.outSequenceName,
                EsbMessages.APIResourcePropertiesEditionPart_OutSequenceNameLabel);
        ...
        outSequenceName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourcePropertiesEditionPartForm.this,
                            EsbViewsRepository.APIResource.OutSequence.outSequenceName, PropertiesEditionEvent.COMMIT,
        ...
        Control outSequenceNameHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.APIResource.OutSequence.outSequenceName,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createFaultSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control faultSequenceTypeLabel = createDescription(parent,
                EsbViewsRepository.APIResource.FaultSequence.faultSequenceType,
                EsbMessages.APIResourcePropertiesEditionPart_FaultSequenceTypeLabel);
        ...
        Control faultSequenceTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.APIResource.FaultSequence.faultSequenceType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createFaultSequenceNameText(FormToolkit widgetFactory, Composite parent) {
        Control faultSquenceNameLabel = createDescription(parent,
                EsbViewsRepository.APIResource.FaultSequence.faultSequenceName,
                EsbMessages.APIResourcePropertiesEditionPart_FaultSequenceNameLabel);
        ...
        Control faultSquenceNameHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.APIResource.FaultSequence.faultSequenceName, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#initInSequenceInputConnectors(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#addFilterInSequenceInputConnectors(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#addBusinessFilterInSequenceInputConnectors(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#isContainedInInSequenceInputConnectorsTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#initUrlStyle(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setUrlStyle(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setUriTemplate(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setUrlMapping(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#initProtocol(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setProtocol(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setAllowGet(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setAllowPost(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setAllowPut(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setAllowDelete(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setAllowOptions(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setAllowHead(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setAllowPatch(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#initInSequenceType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setInSequenceType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setInSequenceName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#initOutSequenceType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setOutSequenceType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setOutSequenceName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#initFaultSequenceType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setFaultSequenceType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourcePropertiesEditionPart#setFaultSequenceName(String
     *      newValue)
     * 
     */
    ...
    protected Composite createOutSequenceKey(FormToolkit widgetFactory, final Composite parent) {
        Control outSequenceKeyLabel = createDescription(parent,
                EsbViewsRepository.APIResource.OutSequence.outSequenceKey,
        ...
        Control sequenceKeyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.APIResource.OutSequence.outSequenceKey,
                        EsbViewsRepository.FORM_KIND),
                null);
    ...
    protected Composite createFaultSequenceKey(FormToolkit widgetFactory, final Composite parent) {
        Control sequenceKeyLabel = createDescription(parent,
                EsbViewsRepository.APIResource.FaultSequence.faultSequenceKey,
        ...
        Control sequenceKeyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.APIResource.FaultSequence.faultSequenceKey,
                        EsbViewsRepository.FORM_KIND),
                null);
