 ...
 *//**
    ...
    * <ul>
    * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceSequenceContainerImpl#getInSequence <em>In
    * Sequence</em>}</li>
    * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.ProxyServiceSequenceContainerImpl#getOutSequence <em>Out
    * Sequence</em>}</li>
    * </ul>
    * </p>
    *
 ...
 * EsbPackage.PROXY_SERVICE_SEQUENCE_CONTAINER__IN_SEQUENCE, oldInSequence, newInSequence);
 ...
 * if (inSequence != null)
 * msgs = ((InternalEObject)inSequence).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
 * EsbPackage.PROXY_SERVICE_SEQUENCE_CONTAINER__IN_SEQUENCE, null, msgs);
 * if (newInSequence != null)
 * msgs = ((InternalEObject)newInSequence).eInverseAdd(this, EOPPOSITE_FEATURE_BASE -
 * EsbPackage.PROXY_SERVICE_SEQUENCE_CONTAINER__IN_SEQUENCE, null, msgs);
 * msgs = basicSetInSequence(newInSequence, msgs);
 * if (msgs != null) msgs.dispatch();
 * }
 * else if (eNotificationRequired())
 * eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE_SEQUENCE_CONTAINER__IN_SEQUENCE,
 * newInSequence, newInSequence));
 * }
 * 
 *//**
    * <!-- begin-user-doc -->
 ...
 * if (eNotificationRequired()) {
 * ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
 * EsbPackage.PROXY_SERVICE_SEQUENCE_CONTAINER__OUT_SEQUENCE, oldOutSequence, newOutSequence);
 * if (msgs == null) msgs = notification; else msgs.add(notification);
 * }
 * return msgs;
 * }
 ...
 * NotificationChain msgs = null;
 * if (outSequence != null)
 * msgs = ((InternalEObject)outSequence).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
 * EsbPackage.PROXY_SERVICE_SEQUENCE_CONTAINER__OUT_SEQUENCE, null, msgs);
 * if (newOutSequence != null)
 * msgs = ((InternalEObject)newOutSequence).eInverseAdd(this, EOPPOSITE_FEATURE_BASE -
 * EsbPackage.PROXY_SERVICE_SEQUENCE_CONTAINER__OUT_SEQUENCE, null, msgs);
 * msgs = basicSetOutSequence(newOutSequence, msgs);
 * if (msgs != null) msgs.dispatch();
 * }
 * else if (eNotificationRequired())
 * eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROXY_SERVICE_SEQUENCE_CONTAINER__OUT_SEQUENCE,
 * newOutSequence, newOutSequence));
 * }
 * 
 *//**
    * <!-- begin-user-doc -->
