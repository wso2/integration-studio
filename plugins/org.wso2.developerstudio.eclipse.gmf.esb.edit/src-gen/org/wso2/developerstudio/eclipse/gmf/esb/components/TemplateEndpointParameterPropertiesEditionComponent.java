...
public class TemplateEndpointParameterPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public TemplateEndpointParameterPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject templateEndpointParameter, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.TemplateEndpointParameter.Properties.parameterName))
                basePart.setParameterName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        templateEndpointParameter.getParameterName()));
            ...
            if (isAccessible(EsbViewsRepository.TemplateEndpointParameter.Properties.parameterValue))
                basePart.setParameterValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        templateEndpointParameter.getParameterValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.TemplateEndpointParameter.Properties.parameterName == event.getAffectedEditor()) {
            templateEndpointParameter.setParameterName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.TemplateEndpointParameter.Properties.parameterValue == event.getAffectedEditor()) {
            templateEndpointParameter.setParameterValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getTemplateEndpointParameter_ParameterName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpointParameter.Properties.parameterName)) {
            ...
            if (EsbPackage.eINSTANCE.getTemplateEndpointParameter_ParameterValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.TemplateEndpointParameter.Properties.parameterValue)) {
                if (msg.getNewValue() != null) {
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.TemplateEndpointParameter.Properties.parameterName == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTemplateEndpointParameter_ParameterName().getEAttributeType(),
                                (String) newValue);
                    }
                ...
                if (EsbViewsRepository.TemplateEndpointParameter.Properties.parameterValue == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getTemplateEndpointParameter_ParameterValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getTemplateEndpointParameter_ParameterValue().getEAttributeType(),
