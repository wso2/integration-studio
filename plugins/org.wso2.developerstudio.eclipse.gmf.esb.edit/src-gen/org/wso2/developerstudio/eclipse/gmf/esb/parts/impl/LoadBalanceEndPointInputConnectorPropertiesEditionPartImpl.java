 ...
 * 
 */
public class LoadBalanceEndPointInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, LoadBalanceEndPointInputConnectorPropertiesEditionPart {
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.LoadBalanceEndPointInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(LoadBalanceEndPointInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.LoadBalanceEndPointInputConnector.Properties.incomingLinks,
