 ...
 * 
 */
public class MediatorFlowPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, MediatorFlowPropertiesEditionPart {
     ...
     */
    public MediatorFlowPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createChildrenTableComposition(FormToolkit widgetFactory, Composite parent) {
                ...
                EsbMessages.MediatorFlowPropertiesEditionPart_ChildrenLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(MediatorFlowPropertiesEditionPartForm.this,
        ...
        this.children.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.MediatorFlow.Properties.children, EsbViewsRepository.FORM_KIND));
