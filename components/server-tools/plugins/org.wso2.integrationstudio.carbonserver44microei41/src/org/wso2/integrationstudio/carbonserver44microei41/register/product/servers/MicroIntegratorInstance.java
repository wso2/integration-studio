...
package org.wso2.integrationstudio.carbonserver44microei41.register.product.servers;
...
import org.wso2.integrationstudio.carbonserver44microei41.Activator;
import org.wso2.integrationstudio.carbonserver44microei41.ServerProperties;
import org.wso2.integrationstudio.carbonserver44microei41.monitor.EmbeddedServerConfigurationUtil;
import org.wso2.integrationstudio.carbonserver44microei41.util.CarbonServer44eiUtils;
import org.wso2.integrationstudio.carbonserver44microei41.util.ServerConstants;
...
public class MicroIntegratorInstance {
    ...
    private void setupServer() {
        ...
        IRuntimeType runtimeType410 = ServerCore.findRuntimeType(ServerConstants.WSO2_MI_410_RUNTIME);
        IServerType serverType410 = ServerCore.findServerType(ServerConstants.WSO2_MI_410_SERVER_TYPE);
        ...
        try {
            ...
            for (IServer tempServers : availableServers) {
                if ((tempServers.getServerType().equals(serverType410) && tempServers.getName()
        ...
        try {
            if (!isServerExists) {
                ...
                IRuntimeWorkingCopy runtime = runtimeType410.createRuntime("org.wso2.micro.integrator.runtime41",
                        progressMonitor);
                ...
                server = serverType410.createServer("org.wso2.micro.integrator.server41", null, microIntegratorRuntime,
                        progressMonitor);
