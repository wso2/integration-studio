...
public class TransactionMediatorDeserializer
        extends AbstractEsbNodeDeserializer<AbstractMediator, TransactionMediator> {

    public TransactionMediator createNode(IGraphicalEditPart part, AbstractMediator mediator) {
        Assert.isTrue(mediator instanceof org.apache.synapse.mediators.transaction.TransactionMediator,
        ...
        TransactionMediator visualTransactionMediator = (TransactionMediator) DeserializerUtils.createNode(part,
