 ...
 * @generated
 */
public class OperatorRightContainerCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DataMapperPackage.eINSTANCE.getOperatorRightContainer_RightConnectors();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater.getOperatorRightContainer_3016SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return OperatorRightConnectorEditPart.VISUAL_ID == DataMapperVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater.getOperatorRightContainer_3016SemanticChildren((View) getHost().getModel());
