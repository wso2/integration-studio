 ...
 * 
 */
public class FailoverEndPointInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, FailoverEndPointInputConnectorPropertiesEditionPart {
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.FailoverEndPointInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FailoverEndPointInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.FailoverEndPointInputConnector.Properties.incomingLinks,
