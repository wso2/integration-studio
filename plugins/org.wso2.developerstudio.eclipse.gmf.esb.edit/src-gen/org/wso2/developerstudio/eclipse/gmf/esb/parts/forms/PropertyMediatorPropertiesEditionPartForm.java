 ...
 * 
 */
public class PropertyMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, PropertyMediatorPropertiesEditionPart {
    ...
    protected Composite createPropertyNameEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        ...
        Control propertyNameHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.PropertyMediator.Properties.propertyName,
    ...
    protected Composite createPropertyDataTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        ...
        Control propertyDataTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PropertyMediator.Properties.propertyDataType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertyActionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        ...
        Control propertyActionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.PropertyMediator.Properties.propertyAction,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertyScopeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        ...
        Control propertyScopeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.PropertyMediator.Properties.propertyScope,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createValueTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        filterValuesSubPropertiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent, "Value",
                true);
        Control valueTypeLabel = createDescription(filterValuesSubPropertiesGroup,
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(PropertyMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.PropertyMediator.Properties.valueType,
        ...
        Control valueTypeHelp = FormUtils
                .createHelpButton(widgetFactory, filterValuesSubPropertiesGroup,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.PropertyMediator.Properties.valueType, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createValueText(FormToolkit widgetFactory, Composite parent) {
        ...
        value.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PropertyMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
    ...
    protected Composite createExpressionText(FormToolkit widgetFactory, Composite parent) {
        ...
        Control expressionHelpButton = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.PropertyMediator.Properties.expression,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createNamespacePrefixText(FormToolkit widgetFactory, Composite parent) {
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PropertyMediator.Properties.namespacePrefix, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createNamespaceText(FormToolkit widgetFactory, Composite parent) {
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PropertyMediator.Properties.namespace, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createBoolean_Checkbox(FormToolkit widgetFactory, Composite parent) {
        boolean_ = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.PropertyMediator.Properties.boolean_,
        ...
        Control booleanHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.PropertyMediator.Properties.boolean_, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createOMText(FormToolkit widgetFactory, Composite parent) {
        ...
        Control omHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.PropertyMediator.Properties.oM, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueStringPatternText(FormToolkit widgetFactory, Composite parent) {
        ...
        Control valueStringPatternHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PropertyMediator.Properties.valueStringPattern,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createValueStringCapturingGroupText(FormToolkit widgetFactory, Composite parent) {
        ...
        Control valueStringCapturingGroupHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PropertyMediator.Properties.valueStringCapturingGroup,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createNewPropertyNameText(FormToolkit widgetFactory, Composite parent) {
        ...
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PropertyMediator.Properties.newPropertyName, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        ...
        Control descriptionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.PropertyMediator.Properties.description,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createValueExpressionWidget(FormToolkit widgetFactory, final Composite parent) {
        ...
        Control valueExpressionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
