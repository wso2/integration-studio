...
public class RegistryResourcesUtils {
	...
	public static List<IDeveloperStudioProvider> getRegistryProjectsList(IDeveloperStudioProvider provider,  Map<String, List<String>> filters) {
	...
	public static List<IDeveloperStudioProvider> getChildrenList(IDeveloperStudioProvider provider, Map<String, List<String>> filters) {
		List<IDeveloperStudioProvider> list = new ArrayList<IDeveloperStudioProvider>();
