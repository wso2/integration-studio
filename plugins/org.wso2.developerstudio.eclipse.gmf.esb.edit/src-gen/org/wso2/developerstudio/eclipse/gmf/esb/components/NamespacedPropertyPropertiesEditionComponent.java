...
public class NamespacedPropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public NamespacedPropertyPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject namespacedProperty, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.NamespacedProperty.Properties.prettyName))
                basePart.setPrettyName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        namespacedProperty.getPrettyName()));
            ...
            if (isAccessible(EsbViewsRepository.NamespacedProperty.Properties.propertyName))
                basePart.setPropertyName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        namespacedProperty.getPropertyName()));
            ...
            if (isAccessible(EsbViewsRepository.NamespacedProperty.Properties.propertyValue))
                basePart.setPropertyValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        namespacedProperty.getPropertyValue()));

            if (isAccessible(EsbViewsRepository.NamespacedProperty.Properties.namespaces))
                basePart.setNamespaces(
                        EEFConverterUtil.convertToString(EsbPackage.Literals.MAP, namespacedProperty.getNamespaces()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.NamespacedProperty.Properties.prettyName == event.getAffectedEditor()) {
            namespacedProperty.setPrettyName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.NamespacedProperty.Properties.propertyName == event.getAffectedEditor()) {
            namespacedProperty.setPropertyName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.NamespacedProperty.Properties.propertyValue == event.getAffectedEditor()) {
            namespacedProperty.setPropertyValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.NamespacedProperty.Properties.namespaces == event.getAffectedEditor()) {
            namespacedProperty.setNamespaces((java.util.Map) EEFConverterUtil.createFromString(EsbPackage.Literals.MAP,
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getNamespacedProperty_PrettyName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamespacedProperty.Properties.prettyName)) {
            ...
            if (EsbPackage.eINSTANCE.getNamespacedProperty_PropertyName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamespacedProperty.Properties.propertyName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getNamespacedProperty_PropertyValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamespacedProperty.Properties.propertyValue)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getNamespacedProperty_Namespaces().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamespacedProperty.Properties.namespaces)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getNamespacedProperty_SupportsDynamicXPaths().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamespacedProperty.Properties.supportsDynamicXPaths))
                basePart.setSupportsDynamicXPaths((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getNamespacedProperty_Dynamic().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamespacedProperty.Properties.dynamic))
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.NamespacedProperty.Properties.prettyName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getNamespacedProperty_PrettyName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getNamespacedProperty_PrettyName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.NamespacedProperty.Properties.propertyName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getNamespacedProperty_PropertyName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getNamespacedProperty_PropertyName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.NamespacedProperty.Properties.propertyValue == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getNamespacedProperty_PropertyValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getNamespacedProperty_PropertyValue().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.NamespacedProperty.Properties.namespaces == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getNamespacedProperty_Namespaces().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getNamespacedProperty_Namespaces().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.NamespacedProperty.Properties.supportsDynamicXPaths == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getNamespacedProperty_SupportsDynamicXPaths().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getNamespacedProperty_SupportsDynamicXPaths().getEAttributeType(),
                ...
                if (EsbViewsRepository.NamespacedProperty.Properties.dynamic == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getNamespacedProperty_Dynamic().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getNamespacedProperty_Dynamic().getEAttributeType(), newValue);
                }
