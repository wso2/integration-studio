...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Entitlement Mediator On Accept Branch</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.wso2.developerstudio.eclipse.esb.mediators.impl.EntitlementMediatorOnAcceptBranchImpl#getSequenceType <em>Sequence Type</em>}</li>
 *   <li>{@link org.wso2.developerstudio.eclipse.esb.mediators.impl.EntitlementMediatorOnAcceptBranchImpl#getSequenceKey <em>Sequence Key</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EntitlementMediatorOnAcceptBranchImpl extends MediatorBranchImpl implements EntitlementMediatorOnAcceptBranch {
	/**
	 ...
	 *
	 */
	protected EntitlementMediatorOnAcceptBranchImpl() {
		super();
		// Sequence key.
	...
	protected EClass eStaticClass() {
		return MediatorsPackage.Literals.ENTITLEMENT_MEDIATOR_ON_ACCEPT_BRANCH;
	}
	...
	public void setSequenceType(EntitlementSequence newSequenceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorsPackage.ENTITLEMENT_MEDIATOR_ON_ACCEPT_BRANCH__SEQUENCE_TYPE, oldSequenceType, sequenceType));
	}
	...
	public RegistryKeyProperty getSequenceKey() {
		if (sequenceKey != null && sequenceKey.eIsProxy()) {
			...
			if (sequenceKey != oldSequenceKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MediatorsPackage.ENTITLEMENT_MEDIATOR_ON_ACCEPT_BRANCH__SEQUENCE_KEY, oldSequenceKey, sequenceKey));
			}
		}
		return sequenceKey;
	}
	...
	public void setSequenceKey(RegistryKeyProperty newSequenceKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediatorsPackage.ENTITLEMENT_MEDIATOR_ON_ACCEPT_BRANCH__SEQUENCE_KEY, oldSequenceKey, sequenceKey));
	}
...
} //EntitlementMediatorOnAcceptBranchImpl
