    ...
    protected Control createDialogArea(Composite parent) {
        ...
        treeViewer.setContentProvider(new ITreeContentProvider() {
            ...
            private Object[] createTreeItemList(Object o) {
                ...
                } else if (o instanceof IIntegrationStudioProvider || o instanceof IIntegrationStudioProviderData) {
                    IIntegrationStudioProvider provider = o instanceof IIntegrationStudioProvider
                            ? (IIntegrationStudioProvider) o
            ...
            private boolean isChildElementsPresent(IIntegrationStudioProvider provider) {
                IIntegrationStudioElement[] resources = provider.getElements(getFilters());
                IIntegrationStudioProvider[] categories = provider.getCategories(getFilters());
