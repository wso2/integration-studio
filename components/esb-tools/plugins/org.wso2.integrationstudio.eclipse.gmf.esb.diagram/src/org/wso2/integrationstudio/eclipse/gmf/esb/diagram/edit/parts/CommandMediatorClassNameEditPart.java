 ...
 * @generated
 */
public class CommandMediatorClassNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
        ...
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.CommandMediator_3511, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.parts.CommandMediatorClassNameEditPart.VISUAL_ID));
        }
        return parser;
    }
