...
public class RouterTargetContainerPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public RouterTargetContainerPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject routerTargetContainer, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.RouterTargetContainer.Properties.routePattern))
                basePart.setRoutePattern(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        routerTargetContainer.getRoutePattern()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.RouterTargetContainer.Properties.routePattern == event.getAffectedEditor()) {
            routerTargetContainer.setRoutePattern((java.lang.String) EEFConverterUtil
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getRouterTargetContainer_BreakAfterRoute().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RouterTargetContainer.Properties.breakAfterRoute))
                basePart.setBreakAfterRoute((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getRouterTargetContainer_RoutePattern().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RouterTargetContainer.Properties.routePattern)) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.RouterTargetContainer.Properties.breakAfterRoute == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRouterTargetContainer_BreakAfterRoute().getEAttributeType(),
                                (String) newValue);
                    }
                ...
                if (EsbViewsRepository.RouterTargetContainer.Properties.routePattern == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRouterTargetContainer_RoutePattern().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRouterTargetContainer_RoutePattern().getEAttributeType(), newValue);
                }
