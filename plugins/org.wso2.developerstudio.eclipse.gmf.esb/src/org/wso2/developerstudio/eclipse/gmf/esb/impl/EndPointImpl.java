...
public abstract class EndPointImpl extends EsbElementImpl implements EndPoint {
    ...
    public void setEndPointName(String newEndPointName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.END_POINT__END_POINT_NAME, oldEndPointName,
                    endPointName));
    }
    ...
    public void setAnonymous(boolean newAnonymous) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.END_POINT__ANONYMOUS, oldAnonymous,
                    anonymous));
    }
    ...
    public void setDuplicate(boolean newDuplicate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.END_POINT__DUPLICATE, oldDuplicate,
                    duplicate));
    }
    ...
    public EList<EndPointProperty> getProperties() {
        if (properties == null) {
            properties = new EObjectContainmentEList<EndPointProperty>(EndPointProperty.class, this,
                    EsbPackage.END_POINT__PROPERTIES);
        }
        return properties;
    }
    ...
    public void setReversed(boolean newReversed) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.END_POINT__REVERSED, oldReversed,
                    reversed));
    }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case EsbPackage.END_POINT__END_POINT_NAME:
            return END_POINT_NAME_EDEFAULT == null ? endPointName != null
                    : !END_POINT_NAME_EDEFAULT.equals(endPointName);
        case EsbPackage.END_POINT__ANONYMOUS:
