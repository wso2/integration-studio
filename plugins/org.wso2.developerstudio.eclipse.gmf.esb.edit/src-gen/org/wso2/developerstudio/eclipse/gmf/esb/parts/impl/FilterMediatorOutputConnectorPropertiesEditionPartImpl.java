 ...
 * 
 */
public class FilterMediatorOutputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, FilterMediatorOutputConnectorPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        CompositionSequence filterMediatorOutputConnectorStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        filterMediatorOutputConnectorStep.addStep(EsbViewsRepository.FilterMediatorOutputConnector.Properties.class)
    ...
    protected Composite createCommentMediatorsAdvancedTableComposition(Composite parent) {
        this.commentMediators = new ReferencesTable(
                getDescription(EsbViewsRepository.FilterMediatorOutputConnector.Properties.commentMediators,
                        EsbMessages.FilterMediatorOutputConnectorPropertiesEditionPart_CommentMediatorsLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(FilterMediatorOutputConnectorPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.FilterMediatorOutputConnector.Properties.commentMediators,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FilterMediatorOutputConnectorPropertiesEditionPart#initCommentMediators(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FilterMediatorOutputConnectorPropertiesEditionPart#addFilterCommentMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FilterMediatorOutputConnectorPropertiesEditionPart#addBusinessFilterCommentMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.FilterMediatorOutputConnectorPropertiesEditionPart#isContainedInCommentMediatorsTable(EObject
     *      element)
     * 
     */
