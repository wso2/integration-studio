 ...
 * 
 */
public class PayloadFactoryArgumentPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, PayloadFactoryArgumentPropertiesEditionPart {
     ...
     */
    public PayloadFactoryArgumentPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createArgumentTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        ...
        Control argumentTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
    ...
    protected Composite createArgumentValueText(FormToolkit widgetFactory, Composite parent) {
        ...
        argumentValue.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(PayloadFactoryArgumentPropertiesEditionPartForm.this,
                                    EsbViewsRepository.PayloadFactoryArgument.Properties.argumentValue,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PayloadFactoryArgumentPropertiesEditionPartForm.this, null,
        ...
        Control argumentValueHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PayloadFactoryArgument.Properties.argumentValue,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createEvaluatorEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        ...
        Control evaluatorHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PayloadFactoryArgument.Properties.evaluator, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createLiteralCheckbox(FormToolkit widgetFactory, Composite parent) {
        literal = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.PayloadFactoryArgument.Properties.literal,
        ...
        Control literalHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.PayloadFactoryArgument.Properties.literal,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
