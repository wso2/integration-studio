...
public class CloneMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public CloneMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject cloneMediator,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.CloneMediator.Properties.cloneID))
                basePart.setCloneID(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, cloneMediator.getCloneID()));
            ...
            if (isAccessible(EsbViewsRepository.CloneMediator.Properties.targets)) {
                targetsSettings = new ReferencesTableSettings(cloneMediator,
            ...
            if (isAccessible(EsbViewsRepository.CloneMediator.Properties.targetsOutputConnector)) {
                targetsOutputConnectorSettings = new ReferencesTableSettings(cloneMediator,
                ...
                basePart.addFilterToTargetsOutputConnector(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof CloneMediatorTargetOutputConnector);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.CloneMediator.Properties.description == event.getAffectedEditor()) {
            cloneMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.CloneMediator.Properties.cloneID == event.getAffectedEditor()) {
            cloneMediator.setCloneID((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
        ...
        if (EsbViewsRepository.CloneMediator.Properties.targets == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, targetsSettings, editingContext.getAdapterFactory());
        ...
        if (EsbViewsRepository.CloneMediator.Properties.targetsOutputConnector == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, targetsOutputConnectorSettings, editingContext.getAdapterFactory());
                PropertiesEditingProvider provider = (PropertiesEditingProvider) editingContext.getAdapterFactory()
                        .adapt(semanticObject, PropertiesEditingProvider.class);
                if (provider != null) {
                    PropertiesEditingPolicy policy = provider.getPolicy(context);
                ...
                targetsOutputConnectorSettings.move(event.getNewIndex(),
                        (CloneMediatorTargetOutputConnector) event.getNewValue());
            }
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.CloneMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CloneMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CloneMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCloneMediator_CloneID().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CloneMediator.Properties.cloneID)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCloneMediator_SequentialMediation().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CloneMediator.Properties.sequentialMediation))
                basePart.setSequentialMediation((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCloneMediator_ContinueParent().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CloneMediator.Properties.continueParent))
                basePart.setContinueParent((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCloneMediator_Targets().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.CloneMediator.Properties.targets))
                basePart.updateTargets();
            if (EsbPackage.eINSTANCE.getCloneMediator_TargetsOutputConnector().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.CloneMediator.Properties.targetsOutputConnector))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getCloneMediator_CloneID(),
                EsbPackage.eINSTANCE.getCloneMediator_SequentialMediation(),
                EsbPackage.eINSTANCE.getCloneMediator_ContinueParent(), EsbPackage.eINSTANCE.getCloneMediator_Targets(),
                EsbPackage.eINSTANCE.getCloneMediator_TargetsOutputConnector());
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.CloneMediator.Properties.cloneID == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCloneMediator_CloneID().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getCloneMediator_CloneID().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CloneMediator.Properties.sequentialMediation == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCloneMediator_SequentialMediation().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCloneMediator_SequentialMediation().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CloneMediator.Properties.continueParent == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCloneMediator_ContinueParent().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCloneMediator_ContinueParent().getEAttributeType(), newValue);
                }
