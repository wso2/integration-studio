 ...
 * @generated NOT
 */
public class ConditionalRouterMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ConditionalRouterMediatorPropertiesEditionPart {
     ...
     */
    public ConditionalRouterMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = conditionalRouterMediatorStep
                .addStep(EsbViewsRepository.ConditionalRouterMediator.Properties.class);
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ConditionalRouterMediator.Properties.description,
                EsbMessages.ConditionalRouterMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ConditionalRouterMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ConditionalRouterMediator.Properties.description,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ConditionalRouterMediatorPropertiesEditionPartForm.this, null,
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.ConditionalRouterMediator.Properties.commentsList,
                                EsbMessages.ConditionalRouterMediatorPropertiesEditionPart_CommentsListLabel),
                        SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(),
                        "ConditionalRouterMediator", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ConditionalRouterMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ConditionalRouterMediator.Properties.commentsList,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ConditionalRouterMediator.Properties.reverse,
                        EsbMessages.ConditionalRouterMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ConditionalRouterMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ConditionalRouterMediator.Properties.reverse,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.ConditionalRouterMediator.Properties.reverse, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createContinueAfterRouteCheckbox(FormToolkit widgetFactory, Composite parent) {
        continueAfterRoute = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.ConditionalRouterMediator.Properties.continueAfterRoute,
                                EsbMessages.ConditionalRouterMediatorPropertiesEditionPart_ContinueAfterRouteLabel),
                        SWT.CHECK);
        continueAfterRoute.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ConditionalRouterMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ConditionalRouterMediator.Properties.continueAfterRoute,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(continueAfterRoute.getSelection())));
            }
        ...
        EditingUtils.setID(continueAfterRoute,
                EsbViewsRepository.ConditionalRouterMediator.Properties.continueAfterRoute);
    ...
    protected Composite createConditionalRouteBranchesTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.conditionalRouteBranches = new ReferencesTable(
                getDescription(EsbViewsRepository.ConditionalRouterMediator.Properties.conditionalRouteBranches,
                        EsbMessages.ConditionalRouterMediatorPropertiesEditionPart_ConditionalRouteBranchesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                ConditionalRouterMediatorPropertiesEditionPartForm.this,
                                EsbViewsRepository.ConditionalRouterMediator.Properties.conditionalRouteBranches,
        ...
        this.conditionalRouteBranches.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ConditionalRouterMediator.Properties.conditionalRouteBranches,
                EsbViewsRepository.FORM_KIND));
        ...
        conditionalRouteBranches
                .setID(EsbViewsRepository.ConditionalRouterMediator.Properties.conditionalRouteBranches);
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ConditionalRouterMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ConditionalRouterMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ConditionalRouterMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ConditionalRouterMediatorPropertiesEditionPart#setContinueAfterRoute(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ConditionalRouterMediatorPropertiesEditionPart#initConditionalRouteBranches(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ConditionalRouterMediatorPropertiesEditionPart#addFilterConditionalRouteBranches(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ConditionalRouterMediatorPropertiesEditionPart#addBusinessFilterConditionalRouteBranches(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ConditionalRouterMediatorPropertiesEditionPart#isContainedInConditionalRouteBranchesTable(EObject
     *      element)
     * 
     */
