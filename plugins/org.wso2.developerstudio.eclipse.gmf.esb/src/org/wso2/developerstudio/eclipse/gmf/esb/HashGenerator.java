...
public enum HashGenerator implements Enumerator {
     ...
     * @ordered
     */
    CARBON_MEDIATOR_CACHE_DIGEST_DOMHASH_GENERATOR(0, "CARBON_MEDIATOR_CACHE_DIGEST_DOMHASH_GENERATOR",
     ...
     * @generated
     */
    private static final HashGenerator[] VALUES_ARRAY = new HashGenerator[] {
            CARBON_MEDIATOR_CACHE_DIGEST_DOMHASH_GENERATOR, };
    ...
    public static HashGenerator get(int value) {
        switch (value) {
        case CARBON_MEDIATOR_CACHE_DIGEST_DOMHASH_GENERATOR_VALUE:
            return CARBON_MEDIATOR_CACHE_DIGEST_DOMHASH_GENERATOR;
        }
        return null;
    }
