...
public class ESBEditorGlobalActionHandlerProvider extends AbstractGlobalActionHandlerProvider {
    ...
    public IGlobalActionHandler getGlobalActionHandler(final IGlobalActionHandlerContext context) {
        ...
        if (!getHandlerList().containsKey(context.getActivePart())) {
            getHandlerList().put(context.getActivePart(), new ESBEditorClipboardSupportGlobalActionHandler());
        ...
        return (ESBEditorClipboardSupportGlobalActionHandler) getHandlerList().get(context.getActivePart());
    }
