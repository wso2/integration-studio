 ...
 * @generated
 */
public class NTLMMediatorDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
     ...
     * @generated
     */
    public NTLMMediatorDescriptionEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.NTLMMediator_3797, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.NTLMMediatorDescriptionEditPart.VISUAL_ID));
        }
        return parser;
    }
