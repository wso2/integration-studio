...
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigureGlobalVariableOperatorDialog;

public class GlobalVariableConfigureAction extends AbstractActionHandler {
	 ...
	 */
	public GlobalVariableConfigureAction(IWorkbenchPart part) {
		super(part);
		setId("configure-global-variable-operator-action-id");
		setText("Configure Global Variable Operator");
		setToolTipText("Configure Global Variable Operator Attributes");
	...
	protected void doRun(IProgressMonitor progressMonitor) {
		...
		Dialog configureGlobalVariableDialog = new ConfigureGlobalVariableOperatorDialog(
				Display.getDefault().getActiveShell(), (GlobalVariable) selectedObj, getEditingDomain(), selectedEP);
		configureGlobalVariableDialog.create();
		configureGlobalVariableDialog.open();
	}
