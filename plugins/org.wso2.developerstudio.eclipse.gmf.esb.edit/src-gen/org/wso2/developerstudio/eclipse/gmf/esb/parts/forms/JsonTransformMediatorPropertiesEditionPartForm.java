 ...
 * 
 */
public class JsonTransformMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, JsonTransformMediatorPropertiesEditionPart {
     ...
     */
    public JsonTransformMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = jsonTransformMediatorStep
                .addStep(EsbViewsRepository.JsonTransformMediator.Properties.class);
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.JsonTransformMediator.Properties.commentsList,
                        EsbMessages.JsonTransformMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(),
                        "JsonTransformMediator", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(JsonTransformMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.JsonTransformMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        ...
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.JsonTransformMediator.Properties.reverse,
                        EsbMessages.JsonTransformMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.JsonTransformMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.JsonTransformMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJsonTransformPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.jsonTransformProperties = new ReferencesTable(
                getDescription(EsbViewsRepository.JsonTransformMediator.Properties.jsonTransformProperties,
                        EsbMessages.JsonTransformMediatorPropertiesEditionPart_JsonTransformPropertiesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(JsonTransformMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.JsonTransformMediator.Properties.jsonTransformProperties,
        ...
        this.jsonTransformProperties.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.JsonTransformMediator.Properties.jsonTransformProperties,
    ...
    protected Composite createSchemaRegistryKeyWidget(FormToolkit widgetFactory, final Composite parent) {
        Control schemaRegistryKeyLabel = createDescription(parent,
                EsbViewsRepository.JsonTransformMediator.Properties.schema,
                EsbMessages.JsonTransformMediatorPropertiesEditionPart_SchemaLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.JsonTransformMediator.Properties.schema, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
        return parent;
    }

    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.JsonTransformMediator.Properties.description,
                EsbMessages.JsonTransformMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            JsonTransformMediatorPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.JsonTransformMediator.Properties.description, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.JsonTransformMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.JsonTransformMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.JsonTransformMediatorPropertiesEditionPart#initJsonTransformProperties(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.JsonTransformMediatorPropertiesEditionPart#addFilterJsonTransformProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.JsonTransformMediatorPropertiesEditionPart#addBusinessFilterJsonTransformProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.JsonTransformMediatorPropertiesEditionPart#isContainedInJsonTransformPropertiesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.JsonTransformMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
