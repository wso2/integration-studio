...
public class APIResourcePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public APIResourcePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject aPIResource,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.APIResource.Properties.inSequenceInputConnectors)) {
                inSequenceInputConnectorsSettings = new ReferencesTableSettings(aPIResource,
            ...
            if (isAccessible(EsbViewsRepository.APIResource.Basic.urlStyle)) {
                basePart.initUrlStyle(
                        EEFUtils.choiceOfValues(aPIResource, EsbPackage.eINSTANCE.getAPIResource_UrlStyle()),
                        aPIResource.getUrlStyle());
            }
            if (isAccessible(EsbViewsRepository.APIResource.Basic.uriTemplate))
                basePart.setUriTemplate(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, aPIResource.getUriTemplate()));

            if (isAccessible(EsbViewsRepository.APIResource.Basic.urlMapping))
                basePart.setUrlMapping(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, aPIResource.getUrlMapping()));

            if (isAccessible(EsbViewsRepository.APIResource.Basic.protocol)) {
                basePart.initProtocol(
                        EEFUtils.choiceOfValues(aPIResource, EsbPackage.eINSTANCE.getAPIResource_Protocol()),
                        aPIResource.getProtocol());
            }
            ...
            if (isAccessible(EsbViewsRepository.APIResource.InSequence.inSequenceType)) {
                basePart.initInSequenceType(
                        EEFUtils.choiceOfValues(aPIResource, EsbPackage.eINSTANCE.getAPIResource_InSequenceType()),
                        aPIResource.getInSequenceType());
            }
            ...
            if (isAccessible(EsbViewsRepository.APIResource.OutSequence.outSequenceType)) {
                basePart.initOutSequenceType(
                        EEFUtils.choiceOfValues(aPIResource, EsbPackage.eINSTANCE.getAPIResource_OutSequenceType()),
                        aPIResource.getOutSequenceType());
            }
            if (isAccessible(EsbViewsRepository.APIResource.OutSequence.outSequenceName))
                basePart.setOutSequenceName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        aPIResource.getOutSequenceName()));
            ...
            if (isAccessible(EsbViewsRepository.APIResource.FaultSequence.faultSequenceType)) {
                basePart.initFaultSequenceType(
                        EEFUtils.choiceOfValues(aPIResource, EsbPackage.eINSTANCE.getAPIResource_FaultSequenceType()),
                        aPIResource.getFaultSequenceType());
            }
            if (isAccessible(EsbViewsRepository.APIResource.FaultSequence.faultSequenceName))
                basePart.setFaultSequenceName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        aPIResource.getFaultSequenceName()));
                ...
                basePart.addFilterToInSequenceInputConnectors(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof APIResourceInSequenceInputConnector);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.APIResource.Properties.inSequenceInputConnectors == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                ...
                inSequenceInputConnectorsSettings.move(event.getNewIndex(),
                        (APIResourceInSequenceInputConnector) event.getNewValue());
            }
        }
        ...
        if (EsbViewsRepository.APIResource.Basic.uriTemplate == event.getAffectedEditor()) {
            aPIResource.setUriTemplate((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.APIResource.Basic.urlMapping == event.getAffectedEditor()) {
            aPIResource.setUrlMapping((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.APIResource.InSequence.inSequenceName == event.getAffectedEditor()) {
            aPIResource.setInSequenceName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.APIResource.OutSequence.outSequenceName == event.getAffectedEditor()) {
            aPIResource.setOutSequenceName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.APIResource.FaultSequence.faultSequenceName == event.getAffectedEditor()) {
            aPIResource.setFaultSequenceName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAPIResource_InSequenceInputConnectors().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.APIResource.Properties.inSequenceInputConnectors))
                basePart.updateInSequenceInputConnectors();
            if (EsbPackage.eINSTANCE.getAPIResource_UrlStyle().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.APIResource.Basic.urlStyle))
                basePart.setUrlStyle((ApiResourceUrlStyle) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAPIResource_UriTemplate().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResource.Basic.uriTemplate)) {
            ...
            if (EsbPackage.eINSTANCE.getAPIResource_UrlMapping().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResource.Basic.urlMapping)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAPIResource_Protocol().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.APIResource.Basic.protocol))
                basePart.setProtocol((Protocol) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAPIResource_AllowGet().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResource.Methods.allowGet))
                basePart.setAllowGet((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAPIResource_AllowPost().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResource.Methods.allowPost))
                basePart.setAllowPost((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAPIResource_AllowPut().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResource.Methods.allowPut))
                basePart.setAllowPut((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAPIResource_AllowDelete().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResource.Methods.allowDelete))
                basePart.setAllowDelete((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAPIResource_AllowOptions().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResource.Methods.allowOptions))
                basePart.setAllowOptions((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAPIResource_AllowHead().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResource.Methods.allowHead))
                basePart.setAllowHead((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAPIResource_AllowPatch().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResource.Methods.allowPatch))
                basePart.setAllowPatch((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAPIResource_InSequenceType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.APIResource.InSequence.inSequenceType))
                basePart.setInSequenceType((SequenceType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAPIResource_InSequenceName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResource.InSequence.inSequenceName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAPIResource_OutSequenceType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.APIResource.OutSequence.outSequenceType))
                basePart.setOutSequenceType((SequenceType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAPIResource_OutSequenceName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResource.OutSequence.outSequenceName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAPIResource_FaultSequenceType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.APIResource.FaultSequence.faultSequenceType))
                basePart.setFaultSequenceType((SequenceType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getAPIResource_FaultSequenceName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.APIResource.FaultSequence.faultSequenceName)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                EsbPackage.eINSTANCE.getAPIResource_InSequenceInputConnectors(),
                EsbPackage.eINSTANCE.getAPIResource_UrlStyle(), EsbPackage.eINSTANCE.getAPIResource_UriTemplate(),
                EsbPackage.eINSTANCE.getAPIResource_UrlMapping(), EsbPackage.eINSTANCE.getAPIResource_Protocol(),
                EsbPackage.eINSTANCE.getAPIResource_AllowGet(), EsbPackage.eINSTANCE.getAPIResource_AllowPost(),
                EsbPackage.eINSTANCE.getAPIResource_AllowPut(), EsbPackage.eINSTANCE.getAPIResource_AllowDelete(),
                EsbPackage.eINSTANCE.getAPIResource_AllowOptions(), EsbPackage.eINSTANCE.getAPIResource_AllowHead(),
                EsbPackage.eINSTANCE.getAPIResource_AllowPatch(), EsbPackage.eINSTANCE.getAPIResource_InSequenceType(),
                ...
                if (EsbViewsRepository.APIResource.Basic.urlStyle == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_UrlStyle().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getAPIResource_UrlStyle().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.Basic.uriTemplate == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_UriTemplate().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getAPIResource_UriTemplate().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.Basic.urlMapping == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_UrlMapping().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getAPIResource_UrlMapping().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.Basic.protocol == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_Protocol().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getAPIResource_Protocol().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.Methods.allowGet == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_AllowGet().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getAPIResource_AllowGet().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.Methods.allowPost == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_AllowPost().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getAPIResource_AllowPost().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.Methods.allowPut == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_AllowPut().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getAPIResource_AllowPut().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.Methods.allowDelete == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_AllowDelete().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getAPIResource_AllowDelete().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.Methods.allowOptions == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_AllowOptions().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getAPIResource_AllowOptions().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.Methods.allowHead == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_AllowHead().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getAPIResource_AllowHead().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.Methods.allowPatch == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_AllowPatch().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getAPIResource_AllowPatch().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.InSequence.inSequenceType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_InSequenceType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAPIResource_InSequenceType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.InSequence.inSequenceName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_InSequenceName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAPIResource_InSequenceName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.OutSequence.outSequenceType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_OutSequenceType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAPIResource_OutSequenceType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.OutSequence.outSequenceName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_OutSequenceName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAPIResource_OutSequenceName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.FaultSequence.faultSequenceType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_FaultSequenceType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAPIResource_FaultSequenceType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.APIResource.FaultSequence.faultSequenceName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getAPIResource_FaultSequenceName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getAPIResource_FaultSequenceName().getEAttributeType(), newValue);
                }
