 ...
 * 
 */
public class DefaultEndPointPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, DefaultEndPointPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        CompositionStep endpointSuspendStateStep = defaultEndPointStep
                .addStep(EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.class);
        ...
        endpointSuspendStateStep
                .addStep(EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendInitialDuration);
        endpointSuspendStateStep
                .addStep(EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendMaximumDuration);
        endpointSuspendStateStep
                .addStep(EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendProgressionFactor);

        CompositionStep endpointTimeoutStateStep = defaultEndPointStep
                .addStep(EsbViewsRepository.DefaultEndPoint.EndpointTimeoutState.class);
        ...
        defaultEndPointStep.addStep(EsbViewsRepository.DefaultEndPoint.FailoverErrorCodes.class)
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.DefaultEndPoint.Basic.commentsList,
                EsbMessages.DefaultEndPointPropertiesEditionPart_CommentsListLabel));
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "DefaultEndPoint", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.DefaultEndPoint.Basic.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createEndPointNameText(Composite parent) {
        createDescription(parent, EsbViewsRepository.DefaultEndPoint.Basic.endPointName,
                EsbMessages.DefaultEndPointPropertiesEditionPart_EndPointNameLabel);
        ...
        endPointName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            DefaultEndPointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.DefaultEndPoint.Basic.endPointName, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.Basic.endPointName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAnonymousCheckbox(Composite parent) {
        ...
        anonymous.setText(getDescription(EsbViewsRepository.DefaultEndPoint.Basic.anonymous,
                EsbMessages.DefaultEndPointPropertiesEditionPart_AnonymousLabel));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DefaultEndPointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.DefaultEndPoint.Basic.anonymous, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.DefaultEndPoint.Basic.anonymous, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInLineCheckbox(Composite parent) {
        ...
        inLine.setText(getDescription(EsbViewsRepository.DefaultEndPoint.Basic.inLine,
                EsbMessages.DefaultEndPointPropertiesEditionPart_InLineLabel));
        inLine.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DefaultEndPointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.DefaultEndPoint.Basic.inLine, PropertiesEditionEvent.COMMIT,
        ...
        Control inlineHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.DefaultEndPoint.Basic.inLine, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(Composite parent) {
        ...
        duplicate.setText(getDescription(EsbViewsRepository.DefaultEndPoint.Basic.duplicate,
                EsbMessages.DefaultEndPointPropertiesEditionPart_DuplicateLabel));
        duplicate.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DefaultEndPointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.DefaultEndPoint.Basic.duplicate, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.DefaultEndPoint.Basic.duplicate, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createReversedCheckbox(Composite parent) {
        ...
        reversed.setText(getDescription(EsbViewsRepository.DefaultEndPoint.Basic.reversed,
                EsbMessages.DefaultEndPointPropertiesEditionPart_ReversedLabel));
        reversed.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DefaultEndPointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.DefaultEndPoint.Basic.reversed, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.DefaultEndPoint.Basic.reversed, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFormatEMFComboViewer(Composite parent) {
        Control formatLabel = createDescription(parent, EsbViewsRepository.DefaultEndPoint.Basic.format,
                EsbMessages.DefaultEndPointPropertiesEditionPart_FormatLabel);
        ...
        format.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DefaultEndPointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.DefaultEndPoint.Basic.format, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getFormat()));
            }

        });
        format.setID(EsbViewsRepository.DefaultEndPoint.Basic.format);
        Control formatHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.DefaultEndPoint.Basic.format, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTemplateParametersAdvancedTableComposition(Composite parent) {
        this.templateParameters = new ReferencesTable(
                getDescription(EsbViewsRepository.DefaultEndPoint.Basic.templateParameters,
                        EsbMessages.DefaultEndPointPropertiesEditionPart_TemplateParametersLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(DefaultEndPointPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.DefaultEndPoint.Basic.templateParameters,
        ...
        this.templateParameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.Basic.templateParameters, EsbViewsRepository.SWT_KIND));
        ...
        this.templateParameters.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            DefaultEndPointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.DefaultEndPoint.Basic.templateParameters, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createStatisticsEnabledCheckbox(Composite parent) {
        ...
        statisticsEnabled.setText(getDescription(EsbViewsRepository.DefaultEndPoint.Basic.statisticsEnabled,
                EsbMessages.DefaultEndPointPropertiesEditionPart_StatisticsEnabledLabel));
        statisticsEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            DefaultEndPointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.DefaultEndPoint.Basic.statisticsEnabled, PropertiesEditionEvent.COMMIT,
        ...
        Control statEnableHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.Basic.statisticsEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTraceEnabledCheckbox(Composite parent) {
        ...
        traceEnabled.setText(getDescription(EsbViewsRepository.DefaultEndPoint.Basic.traceEnabled,
                EsbMessages.DefaultEndPointPropertiesEditionPart_TraceEnabledLabel));
        traceEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            DefaultEndPointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.DefaultEndPoint.Basic.traceEnabled, PropertiesEditionEvent.COMMIT,
        ...
        Control tracingEnabledHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.Basic.traceEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEndpointSuspendStateGroup(Composite parent) {
        ...
        endpointSuspendStateGroup
                .setText(EsbMessages.DefaultEndPointPropertiesEditionPart_EndpointSuspendStateGroupLabel);
    ...
    protected Composite createSuspendErrorCodesText(Composite parent) {
        Control suspendErrorCodesLabel = createDescription(parent,
                ...
                EsbMessages.DefaultEndPointPropertiesEditionPart_SuspendErrorCodesLabel);
        ...
        Control suspendErrorCodesHelp = SWTUtils.createHelpButton(parent,
    ...
    protected Composite createSuspendInitialDurationText(Composite parent) {
        Control suspendInitialDurationLabel = createDescription(parent,
                ...
                EsbMessages.DefaultEndPointPropertiesEditionPart_SuspendInitialDurationLabel);
        ...
        Control suspendInitialDurationHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendInitialDuration,
                        EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createSuspendMaximumDurationText(Composite parent) {
        Control suspendMaximumDurationLabel = createDescription(parent,
                ...
                EsbMessages.DefaultEndPointPropertiesEditionPart_SuspendMaximumDurationLabel);
        ...
        Control suspendMaximumDurationHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendMaximumDuration,
                        EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createSuspendProgressionFactorText(Composite parent) {
        Control suspendProgressionFactorLabel = createDescription(parent,
                ...
                EsbMessages.DefaultEndPointPropertiesEditionPart_SuspendProgressionFactorLabel);
        ...
        Control suspendProgressionFactorHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DefaultEndPoint.EndpointSuspendState.suspendProgressionFactor,
                        EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createEndpointTimeoutStateGroup(Composite parent) {
        ...
        endpointTimeoutStateGroup
                .setText(EsbMessages.DefaultEndPointPropertiesEditionPart_EndpointTimeoutStateGroupLabel);
    ...
    protected Composite createRetryErrorCodesText(Composite parent) {
        Control retryErrorCodesLabel = createDescription(parent,
                ...
                EsbMessages.DefaultEndPointPropertiesEditionPart_RetryErrorCodesLabel);
        ...
        Control retryErrorCodesHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DefaultEndPoint.EndpointTimeoutState.retryErrorCodes,
                        EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRetryCountText(Composite parent) {
        Control retryCountLabel = createDescription(parent,
                ...
                EsbMessages.DefaultEndPointPropertiesEditionPart_RetryCountLabel);
        ...
        Control retryCountHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.EndpointTimeoutState.retryCount, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRetryDelayText(Composite parent) {
        Control retryDelayLabel = createDescription(parent,
                ...
                EsbMessages.DefaultEndPointPropertiesEditionPart_RetryDelayLabel);
        ...
        Control retryDelayHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.EndpointTimeoutState.retryDelay, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesAdvancedTableComposition(Composite parent) {
        ...
        this.properties = new ReferencesTable(
                getDescription(EsbViewsRepository.DefaultEndPoint.Misc.properties,
                        EsbMessages.DefaultEndPointPropertiesEditionPart_PropertiesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(DefaultEndPointPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.DefaultEndPoint.Misc.properties,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
                        properties.refresh();
                    }
        ...
        this.properties.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.DefaultEndPoint.Misc.properties, EsbViewsRepository.SWT_KIND));
        ...
        this.properties.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DefaultEndPointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.DefaultEndPoint.Misc.properties, PropertiesEditionEvent.CHANGE,
                                    PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
    ...
    protected Composite createOptimizeEMFComboViewer(Composite parent) {
        Control optimizeLabel = createDescription(parent, EsbViewsRepository.DefaultEndPoint.Misc.optimize,
                EsbMessages.DefaultEndPointPropertiesEditionPart_OptimizeLabel);
        ...
        optimize.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DefaultEndPointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.DefaultEndPoint.Misc.optimize, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getOptimize()));
            }

        });
        optimize.setID(EsbViewsRepository.DefaultEndPoint.Misc.optimize);
        Control optimizeHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.DefaultEndPoint.Misc.optimize, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.DefaultEndPoint.Misc.description,
                EsbMessages.DefaultEndPointPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DefaultEndPointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.DefaultEndPoint.Misc.description, PropertiesEditionEvent.COMMIT,
        ...
        Control descriptionHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.Misc.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createReliableMessagingEnabledCheckbox(Composite parent) {
        ...
        reliableMessagingEnabled.setText(getDescription(EsbViewsRepository.DefaultEndPoint.QoS.reliableMessagingEnabled,
                EsbMessages.DefaultEndPointPropertiesEditionPart_ReliableMessagingEnabledLabel));
        reliableMessagingEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DefaultEndPointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.DefaultEndPoint.QoS.reliableMessagingEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
        ...
        Control reliableMessagingEnabledHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DefaultEndPoint.QoS.reliableMessagingEnabled, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createSecurityEnabledCheckbox(Composite parent) {
        ...
        securityEnabled.setText(getDescription(EsbViewsRepository.DefaultEndPoint.QoS.securityEnabled,
                EsbMessages.DefaultEndPointPropertiesEditionPart_SecurityEnabledLabel));
        securityEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            DefaultEndPointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.DefaultEndPoint.QoS.securityEnabled, PropertiesEditionEvent.COMMIT,
        ...
        Control securityEnabledHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.QoS.securityEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressingEnabledCheckbox(Composite parent) {
        ...
        addressingEnabled.setText(getDescription(EsbViewsRepository.DefaultEndPoint.QoS.addressingEnabled,
                EsbMessages.DefaultEndPointPropertiesEditionPart_AddressingEnabledLabel));
        addressingEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            DefaultEndPointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.DefaultEndPoint.QoS.addressingEnabled, PropertiesEditionEvent.COMMIT,
        ...
        Control addressingEnabledHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.QoS.addressingEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressingSeparateListenerCheckbox(Composite parent) {
        ...
        addressingSeparateListener
                .setText(getDescription(EsbViewsRepository.DefaultEndPoint.QoS.addressingSeparateListener,
                        EsbMessages.DefaultEndPointPropertiesEditionPart_AddressingSeparateListenerLabel));
        addressingSeparateListener.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DefaultEndPointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.DefaultEndPoint.QoS.addressingSeparateListener,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
        ...
        Control addressingSeparateListenerHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DefaultEndPoint.QoS.addressingSeparateListener, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAddressingVersionEMFComboViewer(Composite parent) {
        Control addressingVersionLabel = createDescription(parent,
                EsbViewsRepository.DefaultEndPoint.QoS.addressingVersion,
                EsbMessages.DefaultEndPointPropertiesEditionPart_AddressingVersionLabel);
        ...
        addressingVersion.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            DefaultEndPointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.DefaultEndPoint.QoS.addressingVersion, PropertiesEditionEvent.COMMIT,
        ...
        Control addressingVersionHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.QoS.addressingVersion, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTimeOutDurationText(Composite parent) {
        Control timeOutDurationLabel = createDescription(parent,
                ...
                EsbMessages.DefaultEndPointPropertiesEditionPart_TimeOutDurationLabel);
        ...
        timeOutDuration.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            DefaultEndPointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.DefaultEndPoint.Timeout.timeOutDuration, PropertiesEditionEvent.COMMIT,
        ...
        Control timeOutDurationHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.Timeout.timeOutDuration, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTimeOutActionEMFComboViewer(Composite parent) {
        Control timeOutActionLabel = createDescription(parent, EsbViewsRepository.DefaultEndPoint.Timeout.timeOutAction,
                EsbMessages.DefaultEndPointPropertiesEditionPart_TimeOutActionLabel);
        ...
        timeOutAction.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            DefaultEndPointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.DefaultEndPoint.Timeout.timeOutAction, PropertiesEditionEvent.COMMIT,
        ...
        Control timeOutActionHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.Timeout.timeOutAction, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFailoverNonRetryErrorCodesText(Composite parent) {
        Control failoverNonRetryErrorCodesLabel = createDescription(parent,
                ...
                EsbMessages.DefaultEndPointPropertiesEditionPart_FailoverNonRetryErrorCodesLabel);
        ...
        Control failoverNonRetryErrorCodesHelp = SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DefaultEndPoint.FailoverErrorCodes.failoverNonRetryErrorCodes,
                        EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setEndPointName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setAnonymous(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setInLine(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setDuplicate(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setReversed(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#initFormat(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setFormat(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#initTemplateParameters(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#addFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#addBusinessFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#isContainedInTemplateParametersTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setStatisticsEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setTraceEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setSuspendErrorCodes(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setSuspendInitialDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setSuspendMaximumDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setSuspendProgressionFactor(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setRetryErrorCodes(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setRetryCount(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setRetryDelay(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#initProperties(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#addFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#addBusinessFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#isContainedInPropertiesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#initOptimize(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setOptimize(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setReliableMessagingEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setSecurityEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setAddressingEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setAddressingSeparateListener(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#initAddressingVersion(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setAddressingVersion(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setTimeOutDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#initTimeOutAction(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setTimeOutAction(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DefaultEndPointPropertiesEditionPart#setFailoverNonRetryErrorCodes(String
     *      newValue)
     * 
     */
    ...
    protected Composite createInboundPolicy(Composite parent) {
        ...
        Control inboundPolicyHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.QoS.inboundPolicy, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutboundPolicy(Composite parent) {
        ...
        Control outboundPolicyHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.QoS.outboundPolicy, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSecurityPolicy(Composite parent) {
        ...
        Control securityPolicyHelp = SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DefaultEndPoint.QoS.securityPolicy, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
