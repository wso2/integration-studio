...
import org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart;
 ...
 * 
 */
public class APIResourceEndpointPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, APIResourceEndpointPropertiesEditionPart {
     ...
     */
    public APIResourceEndpointPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = aPIResourceEndpointStep
                .addStep(EsbViewsRepository.APIResourceEndpoint.Properties.class);
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResourceEndpoint.Properties.description,
                EsbMessages.APIResourceEndpointPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(APIResourceEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResourceEndpoint.Properties.description,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourceEndpointPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResourceEndpoint.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.APIResourceEndpoint.Properties.commentsList,
                        EsbMessages.APIResourceEndpointPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(),
                        "APIResourceEndpoint", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(APIResourceEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResourceEndpoint.Properties.commentsList,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createEndPointNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResourceEndpoint.Properties.endPointName,
                EsbMessages.APIResourceEndpointPropertiesEditionPart_EndPointNameLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.APIResourceEndpoint.Properties.endPointName, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAnonymousCheckbox(FormToolkit widgetFactory, Composite parent) {
        anonymous = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.APIResourceEndpoint.Properties.anonymous,
                        EsbMessages.APIResourceEndpointPropertiesEditionPart_AnonymousLabel),
                SWT.CHECK);
        anonymous.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourceEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.APIResourceEndpoint.Properties.anonymous, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResourceEndpoint.Properties.anonymous, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInLineCheckbox(FormToolkit widgetFactory, Composite parent) {
        inLine = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.APIResourceEndpoint.Properties.inLine,
                        EsbMessages.APIResourceEndpointPropertiesEditionPart_InLineLabel),
                SWT.CHECK);
        inLine.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourceEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.APIResourceEndpoint.Properties.inLine, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResourceEndpoint.Properties.inLine, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(FormToolkit widgetFactory, Composite parent) {
        duplicate = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.APIResourceEndpoint.Properties.duplicate,
                        EsbMessages.APIResourceEndpointPropertiesEditionPart_DuplicateLabel),
                SWT.CHECK);
        duplicate.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourceEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.APIResourceEndpoint.Properties.duplicate, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResourceEndpoint.Properties.duplicate, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.properties = new ReferencesTable(
                getDescription(EsbViewsRepository.APIResourceEndpoint.Properties.properties_,
                        EsbMessages.APIResourceEndpointPropertiesEditionPart_PropertiesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(APIResourceEndpointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.APIResourceEndpoint.Properties.properties_,
        ...
        this.properties.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResourceEndpoint.Properties.properties_, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createReversedCheckbox(FormToolkit widgetFactory, Composite parent) {
        reversed = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.APIResourceEndpoint.Properties.reversed,
                        EsbMessages.APIResourceEndpointPropertiesEditionPart_ReversedLabel),
                SWT.CHECK);
        reversed.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourceEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.APIResourceEndpoint.Properties.reversed, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResourceEndpoint.Properties.reversed, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createReliableMessagingEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        reliableMessagingEnabled = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.APIResourceEndpoint.Properties.reliableMessagingEnabled,
                                EsbMessages.APIResourceEndpointPropertiesEditionPart_ReliableMessagingEnabledLabel),
                        SWT.CHECK);
        reliableMessagingEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(APIResourceEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResourceEndpoint.Properties.reliableMessagingEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createSecurityEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        securityEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.APIResourceEndpoint.Properties.securityEnabled,
                        EsbMessages.APIResourceEndpointPropertiesEditionPart_SecurityEnabledLabel),
                SWT.CHECK);
        securityEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(APIResourceEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResourceEndpoint.Properties.securityEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResourceEndpoint.Properties.securityEnabled, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressingEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        addressingEnabled = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.APIResourceEndpoint.Properties.addressingEnabled,
                                EsbMessages.APIResourceEndpointPropertiesEditionPart_AddressingEnabledLabel),
                        SWT.CHECK);
        addressingEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(APIResourceEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResourceEndpoint.Properties.addressingEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createAddressingVersionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResourceEndpoint.Properties.addressingVersion,
                EsbMessages.APIResourceEndpointPropertiesEditionPart_AddressingVersionLabel);
        ...
        addressingVersion.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourceEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.APIResourceEndpoint.Properties.addressingVersion,
    ...
    protected Composite createAddressingSeparateListenerCheckbox(FormToolkit widgetFactory, Composite parent) {
        addressingSeparateListener = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.APIResourceEndpoint.Properties.addressingSeparateListener,
                        EsbMessages.APIResourceEndpointPropertiesEditionPart_AddressingSeparateListenerLabel),
                SWT.CHECK);
        addressingSeparateListener.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(APIResourceEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResourceEndpoint.Properties.addressingSeparateListener,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createTimeOutDurationText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResourceEndpoint.Properties.timeOutDuration,
                EsbMessages.APIResourceEndpointPropertiesEditionPart_TimeOutDurationLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResourceEndpoint.Properties.timeOutDuration, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTimeOutActionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResourceEndpoint.Properties.timeOutAction,
                EsbMessages.APIResourceEndpointPropertiesEditionPart_TimeOutActionLabel);
        ...
        timeOutAction.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourceEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.APIResourceEndpoint.Properties.timeOutAction,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.APIResourceEndpoint.Properties.timeOutAction, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRetryErrorCodesText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResourceEndpoint.Properties.retryErrorCodes,
                EsbMessages.APIResourceEndpointPropertiesEditionPart_RetryErrorCodesLabel);
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResourceEndpoint.Properties.retryErrorCodes, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRetryCountText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResourceEndpoint.Properties.retryCount,
                EsbMessages.APIResourceEndpointPropertiesEditionPart_RetryCountLabel);
        ...
        retryCount.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourceEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.APIResourceEndpoint.Properties.retryCount, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResourceEndpoint.Properties.retryCount, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRetryDelayText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResourceEndpoint.Properties.retryDelay,
                EsbMessages.APIResourceEndpointPropertiesEditionPart_RetryDelayLabel);
        ...
        retryDelay.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourceEndpointPropertiesEditionPartForm.this,
                            EsbViewsRepository.APIResourceEndpoint.Properties.retryDelay, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResourceEndpoint.Properties.retryDelay, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSuspendErrorCodesText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResourceEndpoint.Properties.suspendErrorCodes,
                EsbMessages.APIResourceEndpointPropertiesEditionPart_SuspendErrorCodesLabel);
    ...
    protected Composite createSuspendInitialDurationText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResourceEndpoint.Properties.suspendInitialDuration,
                EsbMessages.APIResourceEndpointPropertiesEditionPart_SuspendInitialDurationLabel);
    ...
    protected Composite createSuspendMaximumDurationText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResourceEndpoint.Properties.suspendMaximumDuration,
                EsbMessages.APIResourceEndpointPropertiesEditionPart_SuspendMaximumDurationLabel);
    ...
    protected Composite createSuspendProgressionFactorText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResourceEndpoint.Properties.suspendProgressionFactor,
                EsbMessages.APIResourceEndpointPropertiesEditionPart_SuspendProgressionFactorLabel);
    ...
    protected Composite createFormatEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResourceEndpoint.Properties.format,
                EsbMessages.APIResourceEndpointPropertiesEditionPart_FormatLabel);
        ...
        format.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(APIResourceEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResourceEndpoint.Properties.format,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResourceEndpoint.Properties.format, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOptimizeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.APIResourceEndpoint.Properties.optimize,
                EsbMessages.APIResourceEndpointPropertiesEditionPart_OptimizeLabel);
        ...
        optimize.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(APIResourceEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResourceEndpoint.Properties.optimize,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResourceEndpoint.Properties.optimize, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTemplateParametersTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.templateParameters = new ReferencesTable(
                getDescription(EsbViewsRepository.APIResourceEndpoint.Properties.templateParameters,
                        EsbMessages.APIResourceEndpointPropertiesEditionPart_TemplateParametersLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(APIResourceEndpointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.APIResourceEndpoint.Properties.templateParameters,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.templateParameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.APIResourceEndpoint.Properties.templateParameters, EsbViewsRepository.FORM_KIND));
    ...
    protected Composite createStatisticsEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        statisticsEnabled = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.APIResourceEndpoint.Properties.statisticsEnabled,
                                EsbMessages.APIResourceEndpointPropertiesEditionPart_StatisticsEnabledLabel),
                        SWT.CHECK);
        statisticsEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(APIResourceEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResourceEndpoint.Properties.statisticsEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createTraceEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        traceEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.APIResourceEndpoint.Properties.traceEnabled,
                        EsbMessages.APIResourceEndpointPropertiesEditionPart_TraceEnabledLabel),
                SWT.CHECK);
        traceEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(APIResourceEndpointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.APIResourceEndpoint.Properties.traceEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.APIResourceEndpoint.Properties.traceEnabled, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getDescription()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getCommentsList()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getEndPointName()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setEndPointName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getAnonymous()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setAnonymous(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getInLine()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setInLine(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getDuplicate()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setDuplicate(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#initProperties(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#updateProperties()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#addFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#addBusinessFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#isContainedInPropertiesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getReversed()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setReversed(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getReliableMessagingEnabled()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setReliableMessagingEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getSecurityEnabled()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setSecurityEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getAddressingEnabled()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setAddressingEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getAddressingVersion()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#initAddressingVersion(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setAddressingVersion(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getAddressingSeparateListener()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setAddressingSeparateListener(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getTimeOutDuration()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setTimeOutDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getTimeOutAction()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#initTimeOutAction(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setTimeOutAction(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getRetryErrorCodes()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setRetryErrorCodes(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getRetryCount()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setRetryCount(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getRetryDelay()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setRetryDelay(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getSuspendErrorCodes()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setSuspendErrorCodes(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getSuspendInitialDuration()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setSuspendInitialDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getSuspendMaximumDuration()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setSuspendMaximumDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getSuspendProgressionFactor()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setSuspendProgressionFactor(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getFormat()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#initFormat(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setFormat(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getOptimize()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#initOptimize(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setOptimize(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#initTemplateParameters(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#updateTemplateParameters()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#addFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#addBusinessFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#isContainedInTemplateParametersTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getStatisticsEnabled()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setStatisticsEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#getTraceEnabled()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.APIResourceEndpointPropertiesEditionPart#setTraceEnabled(Boolean
     *      newValue)
     * 
     */
