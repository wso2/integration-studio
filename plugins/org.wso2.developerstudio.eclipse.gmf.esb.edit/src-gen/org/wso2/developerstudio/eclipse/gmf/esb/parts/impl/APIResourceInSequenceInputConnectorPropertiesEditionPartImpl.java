 ...
 * 
 */
public class APIResourceInSequenceInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, APIResourceInSequenceInputConnectorPropertiesEditionPart {
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.APIResourceInSequenceInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            APIResourceInSequenceInputConnectorPropertiesEditionPartImpl.this,
                            EsbViewsRepository.APIResourceInSequenceInputConnector.Properties.incomingLinks,
    ...
    protected void moveIncomingLinks(EObject element, int oldIndex, int newIndex) {
        propertiesEditionComponent.firePropertiesChanged(
                new PropertiesEditionEvent(APIResourceInSequenceInputConnectorPropertiesEditionPartImpl.this,
                        EsbViewsRepository.APIResourceInSequenceInputConnector.Properties.incomingLinks,
