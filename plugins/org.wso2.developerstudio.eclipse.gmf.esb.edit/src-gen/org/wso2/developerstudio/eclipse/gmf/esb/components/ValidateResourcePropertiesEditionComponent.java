...
public class ValidateResourcePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ValidateResourcePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject validateResource,
            String editing_mode) {
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ValidateResource.Properties.location == event.getAffectedEditor()) {
            validateResource.setLocation((java.lang.String) EEFConverterUtil
