...
public class XSLTMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public XSLTMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject xSLTMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.XSLTMediator.Properties.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, xSLTMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.XSLTMediator.Properties.xsltSchemaKeyType)) {
                basePart.initXsltSchemaKeyType(
                        EEFUtils.choiceOfValues(xSLTMediator, EsbPackage.eINSTANCE.getXSLTMediator_XsltSchemaKeyType()),
                        xSLTMediator.getXsltSchemaKeyType());
            }
            if (isAccessible(EsbViewsRepository.XSLTMediator.Properties.properties_)) {
                propertiesSettings = new ReferencesTableSettings(xSLTMediator,
            ...
            if (isAccessible(EsbViewsRepository.XSLTMediator.Properties.features)) {
                featuresSettings = new ReferencesTableSettings(xSLTMediator,
            ...
            if (isAccessible(EsbViewsRepository.XSLTMediator.Properties.resources)) {
                resourcesSettings = new ReferencesTableSettings(xSLTMediator,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.XSLTMediator.Properties.description == event.getAffectedEditor()) {
            xSLTMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.XSLTMediator.Properties.features == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, featuresSettings, editingContext.getAdapterFactory());
                PropertiesEditingProvider provider = (PropertiesEditingProvider) editingContext.getAdapterFactory()
                        .adapt(semanticObject, PropertiesEditingProvider.class);
                if (provider != null) {
                    PropertiesEditingPolicy policy = provider.getPolicy(context);
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.XSLTMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.XSLTMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.XSLTMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getXSLTMediator_XsltSchemaKeyType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.XSLTMediator.Properties.xsltSchemaKeyType))
                basePart.setXsltSchemaKeyType((KeyType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getXSLTMediator_Properties().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.XSLTMediator.Properties.properties_))
                basePart.updateProperties();
            if (EsbPackage.eINSTANCE.getXSLTMediator_Features().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.XSLTMediator.Properties.features))
                basePart.updateFeatures();
            if (EsbPackage.eINSTANCE.getXSLTMediator_Resources().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.XSLTMediator.Properties.resources))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getXSLTMediator_XsltSchemaKeyType(),
                EsbPackage.eINSTANCE.getXSLTMediator_Properties(), EsbPackage.eINSTANCE.getXSLTMediator_Features(),
                EsbPackage.eINSTANCE.getXSLTMediator_Resources(), EsbPackage.eINSTANCE.getXSLTMediator_SourceXPath(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.XSLTMediator.Properties.xsltSchemaKeyType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getXSLTMediator_XsltSchemaKeyType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getXSLTMediator_XsltSchemaKeyType().getEAttributeType(), newValue);
                }
