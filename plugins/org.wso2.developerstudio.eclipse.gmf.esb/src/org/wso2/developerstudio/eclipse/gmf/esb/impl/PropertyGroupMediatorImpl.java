 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.PropertyGroupMediatorImpl#getInputConnector <em>Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.PropertyGroupMediatorImpl#getOutputConnector <em>Output
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.PropertyGroupMediatorImpl#getProperties
 * <em>Properties</em>}</li>
 * </ul>
 *
 * @generated
...
public class PropertyGroupMediatorImpl extends MediatorImpl implements PropertyGroupMediator {
     ...
     * @generated
     */
    public NotificationChain basicSetInputConnector(PropertyGroupMediatorInputConnector newInputConnector,
            NotificationChain msgs) {
        PropertyGroupMediatorInputConnector oldInputConnector = inputConnector;
        inputConnector = newInputConnector;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROPERTY_GROUP_MEDIATOR__INPUT_CONNECTOR, oldInputConnector, newInputConnector);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newInputConnector != inputConnector) {
            ...
            if (inputConnector != null)
                msgs = ((InternalEObject) inputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROPERTY_GROUP_MEDIATOR__INPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROPERTY_GROUP_MEDIATOR__INPUT_CONNECTOR,
     ...
     * @generated
     */
    public NotificationChain basicSetOutputConnector(PropertyGroupMediatorOutputConnector newOutputConnector,
            NotificationChain msgs) {
        PropertyGroupMediatorOutputConnector oldOutputConnector = outputConnector;
        outputConnector = newOutputConnector;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.PROPERTY_GROUP_MEDIATOR__OUTPUT_CONNECTOR, oldOutputConnector, newOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOutputConnector != outputConnector) {
            ...
            if (outputConnector != null)
                msgs = ((InternalEObject) outputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.PROPERTY_GROUP_MEDIATOR__OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PROPERTY_GROUP_MEDIATOR__OUTPUT_CONNECTOR,
    ...
    public EList<PropertyMediator> getProperties() {
        if (properties == null) {
            properties = new EObjectContainmentEList<PropertyMediator>(PropertyMediator.class, this,
                    EsbPackage.PROPERTY_GROUP_MEDIATOR__PROPERTIES);
        }
        return properties;
    }
