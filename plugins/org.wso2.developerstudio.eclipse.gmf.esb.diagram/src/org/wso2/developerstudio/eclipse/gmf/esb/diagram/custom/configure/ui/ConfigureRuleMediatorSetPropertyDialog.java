...
public class ConfigureRuleMediatorSetPropertyDialog extends Dialog {
    ...
    public ConfigureRuleMediatorSetPropertyDialog(Shell parentShell, RuleMediator ruleMediator) {
        super(parentShell);
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        ruleSetPropTable = new Table(container, SWT.BORDER | SWT.FULL_SELECTION | SWT.HIDE_SELECTION);
        ...
        addBtn.addListener(SWT.Selection, new Listener() {
            ...
            public void handleEvent(Event event) {
                ...
                TableItem item = bindRuleSetProperty(EsbFactory.eINSTANCE.createRuleSetCreationProperty());
    ...
    private TableItem bindRuleSetProperty(RuleSetCreationProperty ruleSetProperty) {

        TableItem item = new TableItem(ruleSetPropTable, SWT.NONE);
        item.setText(new String[] { ruleSetProperty.getPropertyName(), ruleSetProperty.getPropertyValue() });
    ...
    private void unbindRuleSetProperty(int selectedIndex) {
        ...
        RuleSetCreationProperty setProp = (RuleSetCreationProperty) item.getData();
        ...
        for (TableItem item : ruleSetPropTable.getItems()) {
            ...
            if (setProp.eContainer() == null) {
                ...
                if (!item.getText(0).equals(setProp.getPropertyName())) {
                    SetCommand setTypeCmd = new SetCommand(editingDomain, setProp,
