 ...
 * 
 */
public class FastXSLTMediatorInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, FastXSLTMediatorInputConnectorPropertiesEditionPart {
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.FastXSLTMediatorInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FastXSLTMediatorInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.FastXSLTMediatorInputConnector.Properties.incomingLinks,
