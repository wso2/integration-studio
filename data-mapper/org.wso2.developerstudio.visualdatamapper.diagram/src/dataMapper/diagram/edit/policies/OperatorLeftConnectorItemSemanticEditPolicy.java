 ...
 * @generated
 */
public class OperatorLeftConnectorItemSemanticEditPolicy extends
	...
	public OperatorLeftConnectorItemSemanticEditPolicy() {
		super(dataMapper.diagram.providers.DataMapperElementTypes.OperatorLeftConnector_3014);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (dataMapper.diagram.providers.DataMapperElementTypes.InNode_3015 == req.getElementType()) {
			return getGEFWrapper(new dataMapper.diagram.edit.commands.InNode3CreateCommand(req));
		}
