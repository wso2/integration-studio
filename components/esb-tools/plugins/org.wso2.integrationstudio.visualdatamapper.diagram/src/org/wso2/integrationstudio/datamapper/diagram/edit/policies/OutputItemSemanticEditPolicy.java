...
import org.wso2.integrationstudio.datamapper.diagram.edit.commands.TreeNode3CreateCommand;
 ...
 * @generated
 */
public class OutputItemSemanticEditPolicy extends DataMapperBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public OutputItemSemanticEditPolicy() {
		super(DataMapperElementTypes.Output_2003);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (DataMapperElementTypes.TreeNode_3011 == req.getElementType()) {
			return getGEFWrapper(new TreeNode3CreateCommand(req));
		}
