 ...
 * 
 */
public class FilterMediatorInputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, FilterMediatorInputConnectorPropertiesEditionPart {
     ...
     */
    public FilterMediatorInputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createIncomingLinksReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.incomingLinks = new ReferencesTable(
                getDescription(EsbViewsRepository.FilterMediatorInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FilterMediatorInputConnectorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.FilterMediatorInputConnector.Properties.incomingLinks,
