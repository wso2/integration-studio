...
public class BuilderMediatorOutputConectorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public BuilderMediatorOutputConectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject builderMediatorOutputConector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.BuilderMediatorOutputConector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(builderMediatorOutputConector,
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getOutputConnector_CommentMediators().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.BuilderMediatorOutputConector.Properties.commentMediators))
