 ...
 * 
 */
public class ProxyInSequenceInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ProxyInSequenceInputConnectorPropertiesEditionPart {
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.ProxyInSequenceInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyInSequenceInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.ProxyInSequenceInputConnector.Properties.incomingLinks,
