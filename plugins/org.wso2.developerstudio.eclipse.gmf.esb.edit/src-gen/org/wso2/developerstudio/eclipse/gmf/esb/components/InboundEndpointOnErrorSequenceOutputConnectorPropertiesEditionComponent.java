 ...
 * 
 */
public class InboundEndpointOnErrorSequenceOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public InboundEndpointOnErrorSequenceOutputConnectorPropertiesEditionComponent(
            PropertiesEditingContext editingContext, EObject inboundEndpointOnErrorSequenceOutputConnector,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(
                ...
                commentMediatorsSettings = new ReferencesTableSettings(inboundEndpointOnErrorSequenceOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.InboundEndpointOnErrorSequenceOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
