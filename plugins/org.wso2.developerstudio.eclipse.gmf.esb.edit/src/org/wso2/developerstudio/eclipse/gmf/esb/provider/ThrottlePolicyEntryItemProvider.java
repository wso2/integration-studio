...
public class ThrottlePolicyEntryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addThrottleTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_ThrottlePolicyEntry_throttleType_feature",
                        "_UI_ThrottlePolicyEntry_type"),
                EsbPackage.Literals.THROTTLE_POLICY_ENTRY__THROTTLE_TYPE, true, false, false,
    ...
    protected void addThrottleRangePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_ThrottlePolicyEntry_throttleRange_feature",
                        "_UI_ThrottlePolicyEntry_type"),
                EsbPackage.Literals.THROTTLE_POLICY_ENTRY__THROTTLE_RANGE, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addAccessTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ThrottlePolicyEntry_accessType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ThrottlePolicyEntry_accessType_feature",
                                "_UI_ThrottlePolicyEntry_type"),
                        EsbPackage.Literals.THROTTLE_POLICY_ENTRY__ACCESS_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addMaxRequestCountPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_ThrottlePolicyEntry_maxRequestCount_feature",
                        "_UI_ThrottlePolicyEntry_type"),
                EsbPackage.Literals.THROTTLE_POLICY_ENTRY__MAX_REQUEST_COUNT, true, false, false,
    ...
    protected void addUnitTimePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ThrottlePolicyEntry_unitTime_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ThrottlePolicyEntry_unitTime_feature",
                                "_UI_ThrottlePolicyEntry_type"),
                        EsbPackage.Literals.THROTTLE_POLICY_ENTRY__UNIT_TIME, true, false, false,
                        ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    protected void addProhibitPeriodPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description", "_UI_ThrottlePolicyEntry_prohibitPeriod_feature",
                        "_UI_ThrottlePolicyEntry_type"),
                EsbPackage.Literals.THROTTLE_POLICY_ENTRY__PROHIBIT_PERIOD, true, false, false,
                ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ThrottlePolicyEntry_type")
