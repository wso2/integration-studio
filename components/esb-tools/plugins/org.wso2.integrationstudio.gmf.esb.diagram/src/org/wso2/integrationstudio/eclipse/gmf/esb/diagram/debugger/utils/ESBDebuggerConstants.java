...
public class ESBDebuggerConstants {
    ...
    public static final String ESB_BREAKPOINT_ACTION_ID = "org.wos2.integrationstudio.eclipse.esb.debugger.breakpoint.action";
    public static final String ESB_BREAKPOINT_DELETE_ALL_ACTION_ID = "org.wos2.integrationstudio.eclipse.esb.debugger.breakpoint.delete.all.action";
    public static final String ESB_BREAKPOINT_REPOPULATE_ACTION_ID = "org.wos2.integrationstudio.eclipse.esb.debugger.breakpoint.repopulate.action";
    public static final String ESB_SKIPPOINT_COMMAND_LABEL = "Toggle Skip Point";
    public static final String ESB_SKIPPOINT_ACTION_ID = "org.wos2.integrationstudio.eclipse.esb.debugger.skippoint.action";
    ...
    public static final String ESB_WIRE_LOG_POINT_ACTION_ID = "org.wos2.integrationstudio.eclipse.esb.debugger.wire.logs.action";
    ...
    public static final String ESB_SHOW_WIRE_LOGS_ACTION_ID = "org.wos2.integrationstudio.eclipse.esb.debugger.show.wire.logs.action";
