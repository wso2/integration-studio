 ...
 * <ul>
 *   <li>{@link dataMapper.OperatorLeftConnector#getInNode <em>In Node</em>}</li>
 * </ul>
 * </p>
 *
 * @see dataMapper.DataMapperPackage#getOperatorLeftConnector()
 * @model
 * @generated
 */
public interface OperatorLeftConnector extends EObject {
	 ...
	 * @see dataMapper.DataMapperPackage#getOperatorLeftConnector_InNode()
	...
	/**
	 * Sets the value of the '{@link dataMapper.OperatorLeftConnector#getInNode <em>In Node</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
