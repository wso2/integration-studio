...
public class EventMediatorTransformer extends AbstractEsbNodeTransformer {
    ...
    public void transformWithinSequence(TransformationInfo information, EsbNode subject, SequenceMediator sequence)
        ...
        try {
            ...
            doTransformWithinSequence(information, ((EventMediator) subject).getOutputConnector().getOutgoingLink(),
                    sequence);
        } catch (JaxenException e) {
            throw new TransformerException(e);
        }
...

        {
            if (visualEvent.getEventExpression() != null
                ...
                if (visualEvent.getEventExpression().getNamespaces() != null) {
                    Map<String, String> map = visualEvent.getEventExpression().getNamespaces();
