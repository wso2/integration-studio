 ...
 * 
 */
public class TransactionMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, TransactionMediatorPropertiesEditionPart {
	 ...
	 * 
	 */
	public TransactionMediatorPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(EsbMessages.TransactionMediatorPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createDescriptionText(Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransactionMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.TransactionMediator.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.TransactionMediator.Properties.description, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCommentsListMultiValuedEditor(Composite parent) {
		...
		editCommentsList.setText(getDescription(EsbViewsRepository.TransactionMediator.Properties.commentsList, EsbMessages.TransactionMediatorPropertiesEditionPart_CommentsListLabel));
		...
		editCommentsList.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransactionMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.TransactionMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(commentsListList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createReverseCheckbox(Composite parent) {
		...
		reverse.setText(getDescription(EsbViewsRepository.TransactionMediator.Properties.reverse, EsbMessages.TransactionMediatorPropertiesEditionPart_ReverseLabel));
		reverse.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransactionMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.TransactionMediator.Properties.reverse, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(reverse.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.TransactionMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createActionEMFComboViewer(Composite parent) {
		...
		action.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TransactionMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.TransactionMediator.Properties.action, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getAction()));
			}

		});
		action.setID(EsbViewsRepository.TransactionMediator.Properties.action);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.TransactionMediator.Properties.action, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.TransactionMediatorPropertiesEditionPart#getDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.TransactionMediatorPropertiesEditionPart#setDescription(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.TransactionMediatorPropertiesEditionPart#getCommentsList()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.TransactionMediatorPropertiesEditionPart#setCommentsList(EList newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.TransactionMediatorPropertiesEditionPart#getReverse()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.TransactionMediatorPropertiesEditionPart#setReverse(Boolean newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.TransactionMediatorPropertiesEditionPart#getAction()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.TransactionMediatorPropertiesEditionPart#initAction(Object input, Enumerator current)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.TransactionMediatorPropertiesEditionPart#setAction(Enumerator newValue)
	 * 
	 */
