 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RecipientListEndPointImpl#getInputConnector <em>Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RecipientListEndPointImpl#getOutputConnector <em>Output
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RecipientListEndPointImpl#getWestOutputConnector <em>West
 * Output Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RecipientListEndPointImpl#getEndpointType <em>Endpoint
 * Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RecipientListEndPointImpl#getEndpointsValue <em>Endpoints
 * Value</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RecipientListEndPointImpl#getEndpointsExpression
 * <em>Endpoints Expression</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RecipientListEndPointImpl#getMaxCache <em>Max
 * Cache</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.RecipientListEndPointImpl#getMediatorFlow <em>Mediator
 * Flow</em>}</li>
 * </ul>
 *
 * @generated
...
public class RecipientListEndPointImpl extends ParentEndPointImpl implements RecipientListEndPoint {
    ...
    public NotificationChain basicSetInputConnector(RecipientListEndPointInputConnector newInputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.RECIPIENT_LIST_END_POINT__INPUT_CONNECTOR, oldInputConnector, newInputConnector);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newInputConnector != inputConnector) {
            ...
            if (inputConnector != null)
                msgs = ((InternalEObject) inputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.RECIPIENT_LIST_END_POINT__INPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.RECIPIENT_LIST_END_POINT__INPUT_CONNECTOR,
    ...
    public EList<RecipientListEndPointOutputConnector> getOutputConnector() {
        if (outputConnector == null) {
            outputConnector = new EObjectContainmentEList<RecipientListEndPointOutputConnector>(
                    RecipientListEndPointOutputConnector.class, this,
                    EsbPackage.RECIPIENT_LIST_END_POINT__OUTPUT_CONNECTOR);
        }
    ...
    public NotificationChain basicSetWestOutputConnector(
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.RECIPIENT_LIST_END_POINT__WEST_OUTPUT_CONNECTOR, oldWestOutputConnector,
        ...
        if (newWestOutputConnector != westOutputConnector) {
            ...
            if (westOutputConnector != null)
                msgs = ((InternalEObject) westOutputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.RECIPIENT_LIST_END_POINT__WEST_OUTPUT_CONNECTOR, null,
                        msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.RECIPIENT_LIST_END_POINT__WEST_OUTPUT_CONNECTOR, newWestOutputConnector,
                    newWestOutputConnector));
    }
    ...
    public void setEndpointType(RecipientListEndpointType newEndpointType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.RECIPIENT_LIST_END_POINT__ENDPOINT_TYPE,
    ...
    public void setEndpointsValue(String newEndpointsValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.RECIPIENT_LIST_END_POINT__ENDPOINTS_VALUE,
                    oldEndpointsValue, endpointsValue));
    }
    ...
    public NotificationChain basicSetEndpointsExpression(NamespacedProperty newEndpointsExpression,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.RECIPIENT_LIST_END_POINT__ENDPOINTS_EXPRESSION, oldEndpointsExpression,
                    newEndpointsExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setEndpointsExpression(NamespacedProperty newEndpointsExpression) {
        if (newEndpointsExpression != endpointsExpression) {
            ...
            if (endpointsExpression != null)
                msgs = ((InternalEObject) endpointsExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.RECIPIENT_LIST_END_POINT__ENDPOINTS_EXPRESSION, null, msgs);
            if (newEndpointsExpression != null)
                msgs = ((InternalEObject) newEndpointsExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.RECIPIENT_LIST_END_POINT__ENDPOINTS_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.RECIPIENT_LIST_END_POINT__ENDPOINTS_EXPRESSION, newEndpointsExpression,
                    newEndpointsExpression));
    }
    ...
    public void setMaxCache(int newMaxCache) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.RECIPIENT_LIST_END_POINT__MAX_CACHE,
                    oldMaxCache, maxCache));
    }
    ...
    public NotificationChain basicSetMediatorFlow(MediatorFlow newMediatorFlow, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.RECIPIENT_LIST_END_POINT__MEDIATOR_FLOW, oldMediatorFlow, newMediatorFlow);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newMediatorFlow != mediatorFlow) {
            ...
            if (mediatorFlow != null)
                msgs = ((InternalEObject) mediatorFlow).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.RECIPIENT_LIST_END_POINT__MEDIATOR_FLOW, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.RECIPIENT_LIST_END_POINT__MEDIATOR_FLOW,
    ...
    public boolean eIsSet(int featureID) {
        ...
        case EsbPackage.RECIPIENT_LIST_END_POINT__ENDPOINTS_VALUE:
            return ENDPOINTS_VALUE_EDEFAULT == null ? endpointsValue != null
                    : !ENDPOINTS_VALUE_EDEFAULT.equals(endpointsValue);
        case EsbPackage.RECIPIENT_LIST_END_POINT__ENDPOINTS_EXPRESSION:
