...
package org.wso2.integrationstudio.gmf.esb.diagram.custom.layout;
...
import org.wso2.integrationstudio.gmf.esb.diagram.custom.DroppableElement;
...
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.APIResourceInSequenceInputConnectorEditPart;
...
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.CloneTargetContainerEditPart;
...
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.EsbServerContentsCompartmentEditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.EsbServerEditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.FilterFailContainerEditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.FilterMediatorEditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.FilterPassContainerEditPart;
...
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.MediatorFlow6EditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.MediatorFlowEditPart;
...
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment18EditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment21EditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment22EditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment23EditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment24EditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment25EditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment26EditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment29EditPart;
...
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.MediatorFlowMediatorFlowCompartment6EditPart;
...
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.ProxyInSequenceInputConnectorEditPart;
...
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.ProxyServiceContainerEditPart;
...
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.SwitchCaseContainerEditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.SwitchCaseParentContainerEditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.SwitchDefaultContainerEditPart;
...
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.TemplateTemplateCompartmentEditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.ThrottleMediatorEditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.ThrottleOnAcceptContainerEditPart;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.ThrottleOnRejectContainerEditPart;
...
public class XYRepossition {
    ...
    private static void resizeSimpleMediator(IGraphicalEditPart editpart) {
        ...
        for (Object child : children) {
            if (child instanceof CompartmentEditPart) {
                WrappingLabel descriptionLabel = (WrappingLabel) ((CompartmentEditPart) child).getFigure();
    ...
    private static void resizeComplexEndpointEditPart(IGraphicalEditPart parent) {
        ...
        if (newCompartmentHeight > bounds.height) {
            ...
            ((GraphicalEditPart) parent.getParent().getParent()).getFigure().setBounds(bounds);
            ((GraphicalEditPart) parent.getParent().getParent()).setLayoutConstraint(parent.getParent(),
                    ((GraphicalEditPart) parent.getParent()).getFigure(), bounds);
    ...
    private static void resizeProxyServiceEditPart(IGraphicalEditPart parent) {
        ...
        ProxyServiceSequenceAndEndpointContainerEditPart seqAndEPContainerEditPart = (ProxyServiceSequenceAndEndpointContainerEditPart) proxyServiceContainerEditPart
                .getChildren().get(0);
        MediatorFlowEditPart mediatorFlowEditPart = (MediatorFlowEditPart) seqAndEPContainerEditPart.getChildren()
                .get(0);
        ...
        for (int i = 0; i < inOutSeqChildren; ++i) {
            if (inAndOutSeqEditPart.getChildren().get(i) instanceof AbstractMediator) {
                Rectangle childBounds = ((GraphicalEditPart) inAndOutSeqEditPart.getChildren().get(i)).getFigure()
                        .getBounds();
                AbstractMediator childMediator = (AbstractMediator) inAndOutSeqEditPart.getChildren().get(i);
        ...
        if (!mainSequence) {
            ...
            for (int i = 0; i < faultSeqChildren; i++) {
                Rectangle childBounds = ((GraphicalEditPart) faulSeqEditPart.getChildren().get(i)).getFigure()
                        .getBounds();
        ...
        ((GraphicalEditPart) seqAndEPContainerEditPart).getFigure().setBounds(mediatorFlowConstraints);
        ...
        if (!mainSequence) {
            ...
            ((GraphicalEditPart) proxyServiceFaultContainerEditPart).setLayoutConstraint(mediatorFlow6EditPart,
                    ((GraphicalEditPart) mediatorFlow6EditPart).getFigure(), faultContainerConstraints);
            ((GraphicalEditPart) proxyServiceFaultContainerEditPart).getFigure().setBounds(faultContainerConstraints);

            // Resize ProxyServiceFaultContainerEditPart (fault sequence).
            ((GraphicalEditPart) proxyServiceContainerEditPart).setLayoutConstraint(proxyServiceFaultContainerEditPart,
                    ((GraphicalEditPart) proxyServiceFaultContainerEditPart).getFigure(), faultContainerConstraints);
            proxyServiceFaultContainerEditPart.getFigure()
                    .setMinimumSize(new Dimension(faultContainerConstraints.width, faultContainerConstraints.height));
            ((GraphicalEditPart) proxyServiceContainerEditPart).getFigure().setBounds(faultContainerConstraints);
        }

        // Resize ProxyServiceContainerEditPart.
        ((GraphicalEditPart) proxyServiceEditPart).setLayoutConstraint(proxyServiceContainerEditPart,
                ((GraphicalEditPart) proxyServiceContainerEditPart).getFigure(), proxyServiceContainerConstraints);

        // Resize ProxyServiceEditPart.
        ((GraphicalEditPart) parent.getParent().getParent().getParent().getParent().getParent()).setLayoutConstraint(
                proxyServiceEditPart, ((GraphicalEditPart) proxyServiceEditPart).getFigure(), proxyConstraints);
    ...
    private static void resizeComplexMediator(IGraphicalEditPart parent) {
        ...
        if (parent instanceof MediatorFlowMediatorFlowCompartment7EditPart
            ...
            maxCompartmentWidth = getMaxCompartmentWidth(
        ...
        ((GraphicalEditPart) parent.getParent().getParent()).setLayoutConstraint(parent.getParent(),
                ((GraphicalEditPart) parent.getParent()).getFigure(), constraints);
        ...
        if (mediator instanceof complexFiguredAbstractMediator) {
            if (mediator instanceof FilterMediatorEditPart || mediator instanceof ThrottleMediatorEditPart
                    || mediator instanceof CloneMediatorEditPart || mediator instanceof EntitlementMediatorEditPart) {

                boundsHeight = getMultipleCompartmentComplexMediatorHeight(
                        (GraphicalEditPart) parent.getParent().getParent().getParent())
                        + (2 * COMPLEX_MEDIATOR_COMPARTMENT_GAP);
                ((GraphicalEditPart) parent.getParent().getParent()).getFigure().setMinimumSize(new Dimension(x, y));
                resizeCompartments((GraphicalEditPart) parent.getParent().getParent().getParent(), x);
            } else if (mediator instanceof SwitchMediatorEditPart) {
                boundsHeight = getMultipleCompartmentComplexMediatorHeight(
                        (GraphicalEditPart) parent.getParent().getParent().getParent().getParent())
                        + (2 * COMPLEX_MEDIATOR_COMPARTMENT_GAP);
                ((GraphicalEditPart) parent.getParent().getParent()).getFigure().setMinimumSize(new Dimension(x, y));
                resizeCompartments((GraphicalEditPart) parent.getParent().getParent().getParent().getParent(), x);
            } else {
                if (noOfChildren == 0) {
                    /*
        ...
        if (editPart instanceof AbstractMediatorFlowCompartmentEditPart) {
            ...
            while (node instanceof AbstractMediator || node instanceof AbstractEndpoint) {
                ...
                if (editPart instanceof MediatorFlowMediatorFlowCompartment5EditPart) {
                    ...
                    verticalSpacing = 20;
                } else if ((editPart instanceof MediatorFlowMediatorFlowCompartment25EditPart)
                        || (editPart instanceof MediatorFlowMediatorFlowCompartment26EditPart)) {
                    verticalSpacing = 0;
                } else {
                    verticalSpacing = 10;
                }
                        ...
                        if (editPart instanceof MediatorFlowMediatorFlowCompartmentEditPart) {
                            ...
                            if (i == 0) {
                                if (editPart instanceof MediatorFlowMediatorFlowCompartment7EditPart
                                    ...
                                    x = ((IGraphicalEditPart) editPart.getParent().getParent().getParent().getParent())
                                            .getFigure().getBounds().width - COMPLEX_MEDIATOR_LEFT_RECTANGLE_WIDTH
                                    ...
                                    x = ((IGraphicalEditPart) editPart.getParent().getParent().getParent().getParent()
                                            .getParent()).getFigure().getBounds().width
                                            - COMPLEX_MEDIATOR_LEFT_RECTANGLE_WIDTH - arrowAndtwoConnectorsLength
                                            - nodeFigureWdith;
                                } else {
                                    x = ((IGraphicalEditPart) editPart.getParent().getParent()).getFigure()
                                            .getBounds().width - COMPLEX_MEDIATOR_LEFT_RECTANGLE_WIDTH
                                            - arrowAndtwoConnectorsLength - nodeFigureWdith;
                                }
                ...
                if (editPart instanceof MediatorFlowMediatorFlowCompartment6EditPart) {
                    ...
                    if (targetConnections != null) {
                        if (targetConnections.size() != 0) {
                            node = (ShapeNodeEditPart) ((EsbLinkEditPart) nodeInputConnector.getTargetConnections()
                                    .get(0)).getSource().getParent();
                        } else {
                            break;
                        }
                    }

                } else if ((editPart instanceof MediatorFlowMediatorFlowCompartmentEditPart) && reversed) {
                    ...
                    if (nodeOPconector != null) {
                        ...
                        if (sourceConnections != null) {
                            if (sourceConnections.size() != 0 && !((((EsbLinkEditPart) sourceConnections.get(0))
                                    .getTarget() instanceof ProxyInSequenceInputConnectorEditPart)
                                    || (((EsbLinkEditPart) sourceConnections.get(0))
                                            .getTarget() instanceof APIResourceInSequenceInputConnectorEditPart))) {
    ...
    private static ShapeNodeEditPart getLeftMostNodeFromEditPart(IGraphicalEditPart parent) {
        ...
        if (first instanceof FilterPassContainerEditPart || first instanceof FilterFailContainerEditPart
                || first instanceof ThrottleOnAcceptContainerEditPart
                || first instanceof ThrottleOnRejectContainerEditPart || first instanceof SwitchCaseContainerEditPart
                || first instanceof SwitchDefaultContainerEditPart || first instanceof CloneTargetContainerEditPart
            ...
            if (first instanceof SwitchCaseContainerEditPart) {
                ...
                firstOutputConnector = EditorUtils.getMediatorAdditionalOutputConnectors(mediatorEditPart)
                        .get(editPartIndex);
            } else if (first instanceof SwitchDefaultContainerEditPart) {
                mediatorEditPart = (ShapeNodeEditPart) first.getParent().getParent().getParent();
                firstOutputConnector = EditorUtils.getMediatorAdditionalOutputConnectors(mediatorEditPart).get(1);
            } else {
            ...
            if (faultInputConnector != null) {
                if (faultInputConnector.getTargetConnections() != null) {
                    if (faultInputConnector.getTargetConnections().size() != 0) {
                        node = (ShapeNodeEditPart) ((EsbLinkEditPart) faultInputConnector.getTargetConnections().get(0))
                                .getSource().getParent();
                    }
                }
            }
            ...
            if (firstOutputConnector != null) {
                if (firstOutputConnector.getSourceConnections() != null) {
                    if (firstOutputConnector.getSourceConnections().size() != 0) {
                        node = (ShapeNodeEditPart) ((EsbLinkEditPart) firstOutputConnector.getSourceConnections()
                                .get(0)).getTarget().getParent();
                    }
                }
            }
        }
    ...
    private static ShapeNodeEditPart getRightMostNodeOfOutSequence(IGraphicalEditPart parent) {
        ...
        if (parent instanceof MediatorFlowMediatorFlowCompartmentEditPart) {
            ...
            if (outSequenceOutputConnector != null && outSequenceOutputConnector.getSourceConnections().size() > 0) {
                node = (ShapeNodeEditPart) ((EsbLinkEditPart) outSequenceOutputConnector.getSourceConnections().get(0))
                        .getTarget().getParent();
            }
        }
    ...
    private static ShapeNodeEditPart getLeftMostNodeOfOutSequence(IGraphicalEditPart parent) {
        ...
        if (parent instanceof MediatorFlowMediatorFlowCompartmentEditPart) {
            ...
            if (outSequenceInputConnector != null && outSequenceInputConnector.getTargetConnections().size() > 0) {
                node = (ShapeNodeEditPart) ((EsbLinkEditPart) outSequenceInputConnector.getTargetConnections().get(0))
                        .getSource().getParent();
            } else {
                /*
                ...
                if (outputConnector.getSourceConnections().size() > 0) {
                    ...
                    while (outputConnector != null && outputConnector.getSourceConnections().size() > 0) {
                        target = (ShapeNodeEditPart) ((EsbLinkEditPart) outputConnector.getSourceConnections().get(0))
                                .getTarget().getParent();
    ...
    private static int getMaxCompartmentWidth(GraphicalEditPart mainContainer) {
        ...
        if (mainContainer instanceof SwitchMediatorContainerEditPart) {
            List<EditPart> caseEditParts = ((SwitchCaseParentContainerEditPart) mainContainer.getChildren().get(0))
                    .getChildren();
            List<EditPart> defaultEditParts = ((SwitchDefaultParentContainerEditPart) mainContainer.getChildren()
                    .get(1)).getChildren();
        ...
        for (EditPart child : children) {
            List<EditPart> childMediatorEditparts = ((GraphicalEditPart) ((GraphicalEditPart) child.getChildren()
            ...
            for (EditPart mediatorEditpart : childMediatorEditparts) {
                compartmentWidth += ((IGraphicalEditPart) mediatorEditpart).getFigure().getBounds().width + ARRWO_LENGTH
                        + 2 * CONNECTOR_LENGTH;
            }
    ...
    private static void resizeCompartments(GraphicalEditPart mainContainer, int maxWidth) {
        ...
        for (EditPart child : children) {
            ...
            ((GraphicalEditPart) child).getFigure().setMinimumSize(new Dimension(maxWidth, compartmentHeight));
        }
    }
     ...
     */
    private static void arrangeInSequenceInputConnectors(EditPart mediatorFlowMediatorFlowCompartmentEditPart) {
        ...
        for (Object child : children) {
            if (child instanceof ProxyInSequenceInputConnectorEditPart
                ...
                if (inSequenceInputConnector.getTargetConnections().size() > 0) {
                    EsbLinkEditPart targetConnection = (EsbLinkEditPart) inSequenceInputConnector.getTargetConnections()
                            .get(0);

                    AbstractConnectorEditPart source = (AbstractConnectorEditPart) targetConnection.getSource();

                    Rectangle sendMediatorOutputConnectorBounds = source.getFigure().getBounds().getCopy();
                    ...
                    ((AbstractBorderedShapeEditPart) baseFigureEditpart).getBorderedFigure().getBorderItemContainer()
                            .add(inSequenceInputConnector.getFigure(), inputLocator);
                }
            }
        }
