 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfTemplateEndpointInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			TemplateEndpointInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(TemplateEndpointInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
