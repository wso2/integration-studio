 ...
 * @generated NOT
 */
public class DataMapperMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, DataMapperMediatorPropertiesEditionPart {
     ...
     */
    public DataMapperMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = dataMapperMediatorStep
                .addStep(EsbViewsRepository.DataMapperMediator.Properties.class);
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.DataMapperMediator.Properties.description,
                EsbMessages.DataMapperMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.DataMapperMediator.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DataMapperMediatorPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            DataMapperMediatorPropertiesEditionPartForm.this, null,
        ...
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DataMapperMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.DataMapperMediator.Properties.commentsList,
                        EsbMessages.DataMapperMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(),
                        "DataMapperMediator", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DataMapperMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.DataMapperMediator.Properties.commentsList,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.DataMapperMediator.Properties.reverse,
                        EsbMessages.DataMapperMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            DataMapperMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.DataMapperMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.DataMapperMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInputTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        inputTypePropertiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent, "Input Type", true);
        Control itemLabel = createDescription(inputTypePropertiesGroup,
                EsbViewsRepository.DataMapperMediator.Properties.inputType,
                EsbMessages.DataMapperMediatorPropertiesEditionPart_InputTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DataMapperMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.DataMapperMediator.Properties.inputType,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getInputType()));
            }

        });
        inputType.setID(EsbViewsRepository.DataMapperMediator.Properties.inputType);
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, inputTypePropertiesGroup,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.DataMapperMediator.Properties.inputType,
    ...
    protected Composite createConfigurationLocalPathText(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent,
                ...
                EsbMessages.DataMapperMediatorPropertiesEditionPart_ConfigurationLocalPathLabel);
                ...
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DataMapperMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.DataMapperMediator.Properties.configurationLocalPath,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    configurationLocalPath.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DataMapperMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.DataMapperMediator.Properties.configurationLocalPath,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
        ...
        EditingUtils.setID(configurationLocalPath,
                EsbViewsRepository.DataMapperMediator.Properties.configurationLocalPath);
        ...
        configurationLocalPath.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                ...
                EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(view.getShell(),
                        SWT.NULL, configurationLocalPathRegistryKey, new ArrayList<NamedEntityDescriptor>());
                dialog.open();
    ...
    protected Composite createInputSchemaLocalPathText(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(inputTypePropertiesGroup,
                ...
                EsbMessages.DataMapperMediatorPropertiesEditionPart_InputSchemaLocalPathLabel);
        ...
        inputSchemaLocalPath.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                ...
                EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(view.getShell(),
                        SWT.NULL, inputSchemaLocalPathRegistryKey, new ArrayList<NamedEntityDescriptor>());
                dialog.open();
    ...
    protected Composite createOutputSchemaLocalPathText(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(outputTypePropertiesGroup,
                EsbViewsRepository.DataMapperMediator.Properties.outputSchemaLocalPath,
                EsbMessages.DataMapperMediatorPropertiesEditionPart_OutputSchemaLocalPathLabel);
        ...
        EditingUtils.setID(outputSchemaLocalPath,
                EsbViewsRepository.DataMapperMediator.Properties.outputSchemaLocalPath);
        EditingUtils.setEEFtype(outputSchemaLocalPath, "eef::Text"); //$NON-NLS-1$
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, outputTypePropertiesGroup,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.DataMapperMediator.Properties.outputSchemaLocalPath,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        ...
        outputSchemaLocalPath.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                ...
                EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(view.getShell(),
                        SWT.NULL, outputSchemaLocalPathRegistryKey, new ArrayList<NamedEntityDescriptor>());
                dialog.open();
    ...
    protected Composite createOutputTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        outputTypePropertiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent, "Output Type",
                true);
        Control itemLabel = createDescription(outputTypePropertiesGroup,
                EsbViewsRepository.DataMapperMediator.Properties.outputType,
                EsbMessages.DataMapperMediatorPropertiesEditionPart_OutputTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DataMapperMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.DataMapperMediator.Properties.outputType,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getOutputType()));
            }

        });
        outputType.setID(EsbViewsRepository.DataMapperMediator.Properties.outputType);
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, outputTypePropertiesGroup,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.DataMapperMediator.Properties.outputType,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DataMapperMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DataMapperMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DataMapperMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DataMapperMediatorPropertiesEditionPart#initInputType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DataMapperMediatorPropertiesEditionPart#setInputType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DataMapperMediatorPropertiesEditionPart#setConfigurationLocalPath(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DataMapperMediatorPropertiesEditionPart#setInputSchemaLocalPath(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DataMapperMediatorPropertiesEditionPart#setOutputSchemaLocalPath(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DataMapperMediatorPropertiesEditionPart#initOutputType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.DataMapperMediatorPropertiesEditionPart#setOutputType(Enumerator
     *      newValue)
     * 
     */
