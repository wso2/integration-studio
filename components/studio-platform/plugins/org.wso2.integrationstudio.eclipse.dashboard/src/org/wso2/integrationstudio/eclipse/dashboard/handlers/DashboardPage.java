...
public class DashboardPage extends FormPage {
	...
	private IntegrationStudioProviderUtils devStudioUtils = new IntegrationStudioProviderUtils();
	static {
	...
	private void createSamples(IManagedForm managedForm, Composite composite) {
		List<IIntegrationStudioSampleContributor> samples = ExtensionPointHandler.getSamples();
		for (IIntegrationStudioSampleContributor contributor : samples) {
	...
	private void createSampleLink(IManagedForm managedForm, Composite composite,
			final IIntegrationStudioSampleContributor contributor) {
	...
	private void createProject(IIntegrationStudioSampleContributor contributor) {
