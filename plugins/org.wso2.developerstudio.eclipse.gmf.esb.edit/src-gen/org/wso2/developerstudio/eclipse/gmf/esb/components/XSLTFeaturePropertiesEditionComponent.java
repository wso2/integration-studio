...
public class XSLTFeaturePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public XSLTFeaturePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject xSLTFeature,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.XSLTFeature.Properties.featureName))
                basePart.setFeatureName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, xSLTFeature.getFeatureName()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.XSLTFeature.Properties.featureName == event.getAffectedEditor()) {
            xSLTFeature.setFeatureName((java.lang.String) EEFConverterUtil
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractBooleanFeature_FeatureName().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.XSLTFeature.Properties.featureName)) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractBooleanFeature_FeatureEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.XSLTFeature.Properties.featureEnabled))
