...
public class ParentEndPointPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ParentEndPointPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject parentEndPoint,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ParentEndPoint.Properties.endPointName))
                basePart.setEndPointName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        parentEndPoint.getEndPointName()));
            ...
            if (isAccessible(EsbViewsRepository.ParentEndPoint.Properties.properties_)) {
                propertiesSettings = new ReferencesTableSettings(parentEndPoint,
            ...
            if (isAccessible(EsbViewsRepository.ParentEndPoint.Properties.children)) {
                childrenSettings = new ReferencesTableSettings(parentEndPoint,
            ...
            if (isAccessible(EsbViewsRepository.ParentEndPoint.Properties.name))
                basePart.setName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, parentEndPoint.getName()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ParentEndPoint.Properties.description == event.getAffectedEditor()) {
            parentEndPoint.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.ParentEndPoint.Properties.endPointName == event.getAffectedEditor()) {
            parentEndPoint.setEndPointName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.ParentEndPoint.Properties.name == event.getAffectedEditor()) {
            parentEndPoint.setName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.ParentEndPoint.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ParentEndPoint.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getEndPoint_EndPointName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.ParentEndPoint.Properties.endPointName)) {
                if (msg.getNewValue() != null) {
