...
public class APIResourceEndpointItemProvider extends AbstractEndPointItemProvider {
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_APIResourceEndpoint_type")
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.API_RESOURCE_ENDPOINT__INPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createAPIResourceEndpointInputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.API_RESOURCE_ENDPOINT__OUTPUT_CONNECTOR,
