 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.BeanMediatorImpl#getInputConnector <em>Input
 * Connector</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.BeanMediatorImpl#getOutputConnector <em>Output
 * Connector</em>}</li>
 ...
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.BeanMediatorImpl#getValueLiteral <em>Value
 * Literal</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.BeanMediatorImpl#getValueExpression <em>Value
 * Expression</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.BeanMediatorImpl#getTargetType <em>Target Type</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.BeanMediatorImpl#getTargetLiteral <em>Target
 * Literal</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.BeanMediatorImpl#getTargetExpression <em>Target
 * Expression</em>}</li>
 * </ul>
 *
 * @generated
...
public class BeanMediatorImpl extends MediatorImpl implements BeanMediator {
    ...
    public NotificationChain basicSetInputConnector(BeanMediatorInputConnector newInputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.BEAN_MEDIATOR__INPUT_CONNECTOR, oldInputConnector, newInputConnector);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newInputConnector != inputConnector) {
            ...
            if (inputConnector != null)
                msgs = ((InternalEObject) inputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.BEAN_MEDIATOR__INPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.BEAN_MEDIATOR__INPUT_CONNECTOR,
    ...
    public NotificationChain basicSetOutputConnector(BeanMediatorOutputConnector newOutputConnector,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.BEAN_MEDIATOR__OUTPUT_CONNECTOR, oldOutputConnector, newOutputConnector);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newOutputConnector != outputConnector) {
            ...
            if (outputConnector != null)
                msgs = ((InternalEObject) outputConnector).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.BEAN_MEDIATOR__OUTPUT_CONNECTOR, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.BEAN_MEDIATOR__OUTPUT_CONNECTOR,
    ...
    public void setProperty(String newProperty) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.BEAN_MEDIATOR__PROPERTY, oldProperty,
                    property));
    }
    ...
    public void setValueType(PropertyValueType newValueType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.BEAN_MEDIATOR__VALUE_TYPE, oldValueType,
                    valueType));
    }
    ...
    public void setValueLiteral(String newValueLiteral) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.BEAN_MEDIATOR__VALUE_LITERAL,
    ...
    public NotificationChain basicSetValueExpression(NamespacedProperty newValueExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.BEAN_MEDIATOR__VALUE_EXPRESSION, oldValueExpression, newValueExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newValueExpression != valueExpression) {
            ...
            if (valueExpression != null)
                msgs = ((InternalEObject) valueExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.BEAN_MEDIATOR__VALUE_EXPRESSION, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.BEAN_MEDIATOR__VALUE_EXPRESSION,
    ...
    public void setTargetType(PropertyValueType newTargetType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.BEAN_MEDIATOR__TARGET_TYPE, oldTargetType,
                    targetType));
    }
    ...
    public void setTargetLiteral(String newTargetLiteral) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.BEAN_MEDIATOR__TARGET_LITERAL,
                    oldTargetLiteral, targetLiteral));
    }
    ...
    public NotificationChain basicSetTargetExpression(NamespacedProperty newTargetExpression, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    EsbPackage.BEAN_MEDIATOR__TARGET_EXPRESSION, oldTargetExpression, newTargetExpression);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setTargetExpression(NamespacedProperty newTargetExpression) {
        if (newTargetExpression != targetExpression) {
            ...
            if (targetExpression != null)
                msgs = ((InternalEObject) targetExpression).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.BEAN_MEDIATOR__TARGET_EXPRESSION, null, msgs);
            if (newTargetExpression != null)
                msgs = ((InternalEObject) newTargetExpression).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - EsbPackage.BEAN_MEDIATOR__TARGET_EXPRESSION, null, msgs);
            msgs = basicSetTargetExpression(newTargetExpression, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.BEAN_MEDIATOR__TARGET_EXPRESSION,
    ...
    public boolean eIsSet(int featureID) {
        ...
        case EsbPackage.BEAN_MEDIATOR__TARGET_LITERAL:
            return TARGET_LITERAL_EDEFAULT == null ? targetLiteral != null
                    : !TARGET_LITERAL_EDEFAULT.equals(targetLiteral);
        case EsbPackage.BEAN_MEDIATOR__TARGET_EXPRESSION:
