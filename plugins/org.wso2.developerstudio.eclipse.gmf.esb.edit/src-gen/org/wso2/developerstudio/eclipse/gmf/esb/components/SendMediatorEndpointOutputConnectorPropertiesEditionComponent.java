 ...
 * 
 */
public class SendMediatorEndpointOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public SendMediatorEndpointOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject sendMediatorEndpointOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.SendMediatorEndpointOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(sendMediatorEndpointOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.SendMediatorEndpointOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getOutputConnector_CommentMediators().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.SendMediatorEndpointOutputConnector.Properties.commentMediators))
