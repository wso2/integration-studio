 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfMergeNodeFirstInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			MergeNodeFirstInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(MergeNodeFirstInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
