...
package org.wso2.developerstudio.eclipse.artifact.cep.execution_plan.validators;
...
public class Execution_planFieldController extends AbstractFieldController {
	...
	public void validate(String modelProperty, Object value, ProjectDataModel model)
		...
		if (modelProperty.equals("eventexecution_plan.name")) {
		     CommonFieldValidator.validateArtifactName(value);
			if (value != null) {
				String resource = value.toString();
				Execution_planModel epModel = (Execution_planModel) model;
				if (epModel != null) {
					IContainer resLocation = epModel.getExecution_planSaveLocation();
					if (resLocation != null) {
...
//			List<OMElement> availableEventstreamList = ((Execution_planModel) model).getAvailableEventstreamList();
