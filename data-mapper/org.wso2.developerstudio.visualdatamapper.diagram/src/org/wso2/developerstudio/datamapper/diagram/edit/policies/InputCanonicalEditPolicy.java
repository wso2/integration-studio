...
public class InputCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DataMapperPackage.eINSTANCE.getInput_TreeNode();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater.getInput_2002SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return TreeNodeEditPart.VISUAL_ID == DataMapperVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater.getInput_2002SemanticChildren((View) getHost().getModel());
