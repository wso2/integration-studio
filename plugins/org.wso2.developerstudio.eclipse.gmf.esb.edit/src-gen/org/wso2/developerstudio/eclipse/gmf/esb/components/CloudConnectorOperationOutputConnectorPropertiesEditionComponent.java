 ...
 * 
 */
public class CloudConnectorOperationOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public CloudConnectorOperationOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject cloudConnectorOperationOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.CloudConnectorOperationOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(cloudConnectorOperationOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.CloudConnectorOperationOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
