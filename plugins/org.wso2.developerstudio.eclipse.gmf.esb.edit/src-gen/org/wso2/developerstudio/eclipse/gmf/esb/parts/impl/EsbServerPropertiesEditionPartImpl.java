 ...
 * 
 */
public class EsbServerPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, EsbServerPropertiesEditionPart {
    ...
    protected Composite createChildrenAdvancedTableComposition(Composite parent) {
                ...
                EsbMessages.EsbServerPropertiesEditionPart_ChildrenLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(EsbServerPropertiesEditionPartImpl.this,
        ...
        this.children.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EsbServer.Properties.children, EsbViewsRepository.SWT_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(EsbServerPropertiesEditionPartImpl.this,
    ...
    protected Composite createTypeEMFComboViewer(Composite parent) {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EsbServerPropertiesEditionPartImpl.this, EsbViewsRepository.EsbServer.Properties.type,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EsbServer.Properties.type, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
