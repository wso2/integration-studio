 ...
 * 
 */
public class TaskPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, TaskPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartImpl.this, EsbViewsRepository.Task.Properties.description,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent
                                .firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.Task.Properties.commentsList,
    ...
    protected Composite createTaskNameText(Composite parent) {
        ...
        taskName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartImpl.this, EsbViewsRepository.Task.Properties.taskName,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.taskName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTaskGroupText(Composite parent) {
        ...
        taskGroup.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartImpl.this, EsbViewsRepository.Task.Properties.taskGroup,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.taskGroup, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTriggerTypeEMFComboViewer(Composite parent) {
        ...
        triggerType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartImpl.this, EsbViewsRepository.Task.Properties.triggerType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.triggerType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCountText(Composite parent) {
        ...
        count.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartImpl.this, EsbViewsRepository.Task.Properties.count,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.count, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createIntervalText(Composite parent) {
        ...
        interval.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartImpl.this, EsbViewsRepository.Task.Properties.interval,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.interval, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCronText(Composite parent) {
        ...
        cron.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartImpl.this, EsbViewsRepository.Task.Properties.cron,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.cron, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPinnedServersText(Composite parent) {
        ...
        pinnedServers.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartImpl.this, EsbViewsRepository.Task.Properties.pinnedServers,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.pinnedServers, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTaskImplementationText(Composite parent) {
        ...
        taskImplementation.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TaskPropertiesEditionPartImpl.this, EsbViewsRepository.Task.Properties.taskImplementation,
        ...
        taskImplementation.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                TaskPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.Task.Properties.taskImplementation, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTaskPropertiesAdvancedTableComposition(Composite parent) {
        this.taskProperties = new ReferencesTable(getDescription(EsbViewsRepository.Task.Properties.taskProperties,
                EsbMessages.TaskPropertiesEditionPart_TaskPropertiesLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                TaskPropertiesEditionPartImpl.this, EsbViewsRepository.Task.Properties.taskProperties,
        ...
        this.taskProperties.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Task.Properties.taskProperties, EsbViewsRepository.SWT_KIND));
