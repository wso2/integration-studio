 ...
 * 
 */
public class EsbSequencePropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, EsbSequencePropertiesEditionPart {
    ...
    protected Composite createNameText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EsbSequencePropertiesEditionPartImpl.this, EsbViewsRepository.EsbSequence.Properties.name,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(EsbSequencePropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EsbSequence.Properties.name, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createChildMediatorsAdvancedTableComposition(Composite parent) {
        ...
        this.childMediators.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EsbSequence.Properties.childMediators, EsbViewsRepository.SWT_KIND));
        ...
        this.childMediators.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EsbSequencePropertiesEditionPartImpl.this,
