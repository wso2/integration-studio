 ...
 * under the License.
 */
package org.wso2.developerstudio.datamapper.diagram.xslt;

import org.wso2.developerstudio.datamapper.diagram.xslt.config.DataMapperSchemaProcessor;
import org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTStyleSheetWriter;
...
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.CUSTOM_FUNCTION;
...
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.ENDS_WITH;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.EXTENSION_ELEMENT_PREFIXES;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.EXTENSION_ELEMENT_PREFIXES_VALUES;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.EXTENSION_ELEMENT_PREFIXES_VALUES_WITHOUT_PROPERTY;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.FLOOR;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.FUNCTION_DEFINITION;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.GLOBAL_VARIABLE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.IF_ELSE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.INPUT;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.ITEMS_TYPE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.LOWERCASE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.MATCH;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.MATCH_LOWER_CASE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.MAX;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.MIN;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.MULTIPLY;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.NAME;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.NOT;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.NUMBER_TYPE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.OBJECT_TYPE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.OPERATOR_TYPE;
...
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.RUN_TIME_PROPERTIES;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.SCOPE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.SELECT;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.SET_PRECISION;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.SLASH;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.SPLIT;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.STARTS_WITH;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.STRING_LENGTH;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.STRING_TO_BOOLEAN;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.STRING_TO_NUMBER;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.STRING_TYPE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.SUBSTRING;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.SUBTRACT;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.TEST;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.TO_STRING;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.TREE_NODE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.TRIM;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.TYPE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.UPPERCASE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.VERSION;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XMLNS_OWN;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XMLNS_XS;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XMLNS_XSL;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XSL_ATTRIBUTE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XSLT_FUNCTION_DECLARE_URI;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XSLT_VERSION;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XSL_FOR_EACH;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XSL_FUNCTION;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XSL_IF;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XSL_NAMESPACE_URI;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XSL_PARAM;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XSL_STYLESHEET;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XSL_TEMPLATE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XSL_VALUE_OF;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XSL_VARIABLE;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.XS_NAMESPACE_URI;
import static org.wso2.developerstudio.datamapper.diagram.xslt.config.XSLTGeneratorConstants.NOT_XSLT_COMPATIBLE;
