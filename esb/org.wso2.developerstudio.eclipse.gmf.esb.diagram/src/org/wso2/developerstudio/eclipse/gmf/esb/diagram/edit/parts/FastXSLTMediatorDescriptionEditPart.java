 ...
 * @generated
 */
public class FastXSLTMediatorDescriptionEditPart extends CompartmentEditPart
		...
		if (parser == null) {
			parser = EsbParserProvider
					.getParser(
							...
							getParserElement(),
							EsbVisualIDRegistry
									.getType(org.wso2.developerstudio.eclipse.gmf.esb.diagram.edit.parts.FastXSLTMediatorDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
