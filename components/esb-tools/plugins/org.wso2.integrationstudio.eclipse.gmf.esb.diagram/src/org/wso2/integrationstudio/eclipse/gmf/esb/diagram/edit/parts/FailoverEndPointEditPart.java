...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.FailoverEndPointCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.FailoverEndPointItemSemanticEditPolicy;
...
public class FailoverEndPointEditPart extends ComplexFiguredAbstractEndpoint {
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new FailoverEndPointFigure(new Color(null, 255, 255, 255)) {
    ...
    public class FailoverEndPointFigure extends EsbGraphicalShapeWithLabel {
        ...
        public String getIconPath() {
            return "icons/ico20/failover-endpoint.png";
        }
