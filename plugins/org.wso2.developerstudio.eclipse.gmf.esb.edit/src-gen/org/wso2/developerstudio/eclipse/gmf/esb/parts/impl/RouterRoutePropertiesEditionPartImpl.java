 ...
 * 
 */
public class RouterRoutePropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, RouterRoutePropertiesEditionPart {
    ...
    protected Composite createBreakAfterRouteCheckbox(Composite parent) {
        ...
        breakAfterRoute.setText(getDescription(EsbViewsRepository.RouterRoute.Properties.breakAfterRoute,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RouterRoutePropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterRoute.Properties.breakAfterRoute, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRouteExpressionFlatComboViewer(Composite parent) {
        ...
        routeExpression = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
                .isRequired(EsbViewsRepository.RouterRoute.Properties.routeExpression, EsbViewsRepository.SWT_KIND));
        ...
        routeExpression.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                propertiesEditionComponent
                        .firePropertiesChanged(new PropertiesEditionEvent(RouterRoutePropertiesEditionPartImpl.this,
                                EsbViewsRepository.RouterRoute.Properties.routeExpression,
                                PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getRouteExpression()));
            }
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterRoute.Properties.routeExpression, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRoutePatternText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterRoute.Properties.routePattern, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
