...
import org.wso2.integrationstudio.datamapper.diagram.edit.commands.OutNode3CreateCommand;
...
public class OperatorRightConnectorItemSemanticEditPolicy extends DataMapperBaseItemSemanticEditPolicy {
	 ...
	 * @generated
	 */
	public OperatorRightConnectorItemSemanticEditPolicy() {
		super(DataMapperElementTypes.OperatorRightConnector_3017);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (DataMapperElementTypes.OutNode_3018 == req.getElementType()) {
			return getGEFWrapper(new OutNode3CreateCommand(req));
		}
