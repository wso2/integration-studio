 ...
 * @generated
 */
public class AbsoluteValueCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater
				.getAbsoluteValue_2020SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater
				.getAbsoluteValue_2020SemanticChildren((View) getHost().getModel());
