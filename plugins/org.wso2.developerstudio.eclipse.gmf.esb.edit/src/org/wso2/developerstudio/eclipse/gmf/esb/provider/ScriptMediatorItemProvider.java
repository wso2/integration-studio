...
public class ScriptMediatorItemProvider extends MediatorItemProvider {
    ...
    protected void addScriptTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ScriptMediator_scriptType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ScriptMediator_scriptType_feature",
                                "_UI_ScriptMediator_type"),
                        EsbPackage.Literals.SCRIPT_MEDIATOR__SCRIPT_TYPE, true, false, false,
    ...
    protected void addScriptLanguagePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ScriptMediator_scriptLanguage_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ScriptMediator_scriptLanguage_feature",
                                "_UI_ScriptMediator_type"),
                        EsbPackage.Literals.SCRIPT_MEDIATOR__SCRIPT_LANGUAGE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addMediateFunctionPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ScriptMediator_mediateFunction_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ScriptMediator_mediateFunction_feature",
                                "_UI_ScriptMediator_type"),
                        EsbPackage.Literals.SCRIPT_MEDIATOR__MEDIATE_FUNCTION, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addScriptDynamicKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ScriptMediator_scriptDynamicKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ScriptMediator_scriptDynamicKey_feature",
                                "_UI_ScriptMediator_type"),
                        EsbPackage.Literals.SCRIPT_MEDIATOR__SCRIPT_DYNAMIC_KEY, true, false, false, null, null, null));
    }
    ...
    protected void addKeyTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ScriptMediator_keyType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ScriptMediator_keyType_feature",
                                "_UI_ScriptMediator_type"),
                        EsbPackage.Literals.SCRIPT_MEDIATOR__KEY_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addScriptStaticKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ScriptMediator_scriptStaticKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ScriptMediator_scriptStaticKey_feature",
                                "_UI_ScriptMediator_type"),
                        EsbPackage.Literals.SCRIPT_MEDIATOR__SCRIPT_STATIC_KEY, true, false, false, null, null, null));
    }
    ...
    protected void addScriptKeysPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ScriptMediator_scriptKeys_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ScriptMediator_scriptKeys_feature",
                                "_UI_ScriptMediator_type"),
                        EsbPackage.Literals.SCRIPT_MEDIATOR__SCRIPT_KEYS, true, false, false, null, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ScriptMediator_type")
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.SCRIPT_MEDIATOR__SCRIPT_DYNAMIC_KEY,
                EsbFactory.eINSTANCE.createNamespacedProperty()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.SCRIPT_MEDIATOR__INPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createScriptMediatorInputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.SCRIPT_MEDIATOR__OUTPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createScriptMediatorOutputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.SCRIPT_MEDIATOR__SCRIPT_STATIC_KEY,
                EsbFactory.eINSTANCE.createRegistryKeyProperty()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.SCRIPT_MEDIATOR__SCRIPT_KEYS,
                EsbFactory.eINSTANCE.createRegistryKeyProperty()));
    }
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify = childFeature == EsbPackage.Literals.SCRIPT_MEDIATOR__SCRIPT_STATIC_KEY
