 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfXSLTMediatorOutputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnSource(
			XSLTMediatorOutputConnectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(XSLTMediatorOutputConnectorEditPart) sourceEditPart,
				targetEditPart);
	}
