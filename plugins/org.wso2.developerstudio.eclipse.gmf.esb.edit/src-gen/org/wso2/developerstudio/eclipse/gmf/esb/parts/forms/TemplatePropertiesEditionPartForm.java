 ...
 * 
 */
public class TemplatePropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, TemplatePropertiesEditionPart {
     ...
     */
    public TemplatePropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.Template.Properties.description,
                EsbMessages.TemplatePropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplatePropertiesEditionPartForm.this, EsbViewsRepository.Template.Properties.description,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplatePropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                ...
                                EsbViewsRepository.Template.Properties.description, PropertiesEditionEvent.COMMIT,
        ...
        Control descriptionHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Template.Properties.description, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.Template.Properties.commentsList,
                        EsbMessages.TemplatePropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "Template", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(TemplatePropertiesEditionPartForm.this,
                                    EsbViewsRepository.Template.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
        Control nameLabel = createDescription(parent, EsbViewsRepository.Template.Properties.name,
                EsbMessages.TemplatePropertiesEditionPart_NameLabel);
        ...
        name.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplatePropertiesEditionPartForm.this, EsbViewsRepository.Template.Properties.name,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(TemplatePropertiesEditionPartForm.this,
                                    EsbViewsRepository.Template.Properties.name, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control nameHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Template.Properties.name, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTemplateTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control templateTypeLabel = createDescription(parent, EsbViewsRepository.Template.Properties.templateType,
                EsbMessages.TemplatePropertiesEditionPart_TemplateTypeLabel);
        ...
        templateType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            TemplatePropertiesEditionPartForm.this, EsbViewsRepository.Template.Properties.templateType,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getTemplateType()));
            }
        ...
        Control templateTypeHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Template.Properties.templateType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createParametersTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.parameters = new ReferencesTable(getDescription(EsbViewsRepository.Template.Properties.parameters,
                EsbMessages.TemplatePropertiesEditionPart_ParametersLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(TemplatePropertiesEditionPartForm.this,
                                        EsbViewsRepository.Template.Properties.parameters,
        ...
        this.parameters.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Template.Properties.parameters, EsbViewsRepository.FORM_KIND));
        ...
        this.parameters.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(TemplatePropertiesEditionPartForm.this,
                                    EsbViewsRepository.Template.Properties.parameters, PropertiesEditionEvent.CHANGE,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplatePropertiesEditionPart#initTemplateType(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplatePropertiesEditionPart#setTemplateType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplatePropertiesEditionPart#initParameters(EObject current,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplatePropertiesEditionPart#addFilterParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplatePropertiesEditionPart#addBusinessFilterParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.TemplatePropertiesEditionPart#isContainedInParametersTable(EObject
     *      element)
     * 
     */
