...
public class FilterMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public FilterMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject filterMediator,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.FilterMediator.Properties.conditionType)) {
                basePart.initConditionType(
                        EEFUtils.choiceOfValues(filterMediator, EsbPackage.eINSTANCE.getFilterMediator_ConditionType()),
                        filterMediator.getConditionType());
            }
            if (isAccessible(EsbViewsRepository.FilterMediator.Properties.regex))
                basePart.setRegex(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, filterMediator.getRegex()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.FilterMediator.Properties.description == event.getAffectedEditor()) {
            filterMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.FilterMediator.Properties.regex == event.getAffectedEditor()) {
            filterMediator.setRegex((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.FilterMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FilterMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FilterMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getFilterMediator_ConditionType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.FilterMediator.Properties.conditionType))
                basePart.setConditionType((FilterMediatorConditionType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getFilterMediator_Regex().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.FilterMediator.Properties.regex)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getFilterMediator_ConditionType(),
                EsbPackage.eINSTANCE.getFilterMediator_Regex(), EsbPackage.eINSTANCE.getFilterMediator_Source(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.FilterMediator.Properties.conditionType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFilterMediator_ConditionType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getFilterMediator_ConditionType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.FilterMediator.Properties.regex == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getFilterMediator_Regex().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getFilterMediator_Regex().getEAttributeType(), newValue);
                }
