...
import org.wso2.integrationstudio.gmf.esb.parts.MethodArgumentPropertiesEditionPart;
 ...
 * 
 */
public class MethodArgumentPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, MethodArgumentPropertiesEditionPart {
	 ...
	 */
	public MethodArgumentPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public MethodArgumentPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(EsbMessages.MethodArgumentPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createPropertyNameText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, EsbViewsRepository.MethodArgument.Properties.propertyName, EsbMessages.MethodArgumentPropertiesEditionPart_PropertyNameLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							MethodArgumentPropertiesEditionPartForm.this,
		...
		propertyName.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MethodArgumentPropertiesEditionPartForm.this, EsbViewsRepository.MethodArgument.Properties.propertyName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, propertyName.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MethodArgument.Properties.propertyName, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyValueTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, EsbViewsRepository.MethodArgument.Properties.propertyValueType, EsbMessages.MethodArgumentPropertiesEditionPart_PropertyValueTypeLabel);
		...
		propertyValueType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MethodArgumentPropertiesEditionPartForm.this, EsbViewsRepository.MethodArgument.Properties.propertyValueType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPropertyValueType()));
			}

		});
		propertyValueType.setID(EsbViewsRepository.MethodArgument.Properties.propertyValueType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MethodArgument.Properties.propertyValueType, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyValueText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, EsbViewsRepository.MethodArgument.Properties.propertyValue, EsbMessages.MethodArgumentPropertiesEditionPart_PropertyValueLabel);
		...
		propertyValue.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							MethodArgumentPropertiesEditionPartForm.this,
							EsbViewsRepository.MethodArgument.Properties.propertyValue,
		...
		propertyValue.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(MethodArgumentPropertiesEditionPartForm.this, EsbViewsRepository.MethodArgument.Properties.propertyValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, propertyValue.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.MethodArgument.Properties.propertyValue, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.MethodArgumentPropertiesEditionPart#getPropertyName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.MethodArgumentPropertiesEditionPart#setPropertyName(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.MethodArgumentPropertiesEditionPart#getPropertyValueType()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.MethodArgumentPropertiesEditionPart#initPropertyValueType(Object input, Enumerator current)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.MethodArgumentPropertiesEditionPart#setPropertyValueType(Enumerator newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.MethodArgumentPropertiesEditionPart#getPropertyValue()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.gmf.esb.parts.MethodArgumentPropertiesEditionPart#setPropertyValue(String newValue)
	 * 
	 */
