...
public class ConcatCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(dataMapper.DataMapperPackage.eINSTANCE.getConcat_InNode());
			myFeaturesToSynchronize.add(dataMapper.DataMapperPackage.eINSTANCE.getConcat_OutNode());
		}
