...
public class ConfigureTemplateEndpointParameterDialog extends Dialog {
    ...
    public ConfigureTemplateEndpointParameterDialog(Shell parentShell, TemplateEndpoint templateEndpoint,
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        newParamButton.addListener(SWT.Selection, new Listener() {
            public void handleEvent(Event event) {
                TableItem item = bindPram(EsbFactory.eINSTANCE.createTemplateEndpointParameter());
    ...
    private void unbindParam(int itemIndex) {
        ...
        if (param.eContainer() != null) {
            RemoveCommand removeCmd = new RemoveCommand(editingDomain, templateEndpoint,
                    EsbPackage.Literals.TEMPLATE_ENDPOINT__PARAMETERS, param);
    ...
    protected void okPressed() {
        for (TableItem item : paramTable.getItems()) {
            ...
            if (param.eContainer() == null) {
                ...
                AddCommand addCmd = new AddCommand(editingDomain, templateEndpoint,
                        EsbPackage.Literals.TEMPLATE_ENDPOINT__PARAMETERS, param);
                ...
                if (param.getParameterName() != null && !param.getParameterName().equals(item.getText(0))) {
                    SetCommand setCmd = new SetCommand(editingDomain, param,
                            EsbPackage.Literals.TEMPLATE_ENDPOINT_PARAMETER__PARAMETER_NAME, item.getText(0));
                ...
                if (param.getParameterValue() == null || !param.getParameterValue().equals(item.getText(1))) {
                    ...
                    SetCommand setCmd = new SetCommand(editingDomain, param,
                            EsbPackage.Literals.TEMPLATE_ENDPOINT_PARAMETER__PARAMETER_VALUE, item.getText(1));
                    getResultCommand().append(setCmd);
                }
            }
        }
