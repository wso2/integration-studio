 ...
 * 
 */
public class ThrottlePolicyConfigurationPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ThrottlePolicyConfigurationPropertiesEditionPart {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ThrottlePolicyConfigurationPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                ThrottlePolicyConfigurationPropertiesEditionPartImpl.this,
                                EsbViewsRepository.ThrottlePolicyConfiguration.Properties.maxConcurrentAccessCount,
                                PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                maxConcurrentAccessCount.getText()));
                }
    ...
    protected Composite createPolicyEntriesAdvancedTableComposition(Composite parent) {
        ...
        this.policyEntries.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottlePolicyConfiguration.Properties.policyEntries, EsbViewsRepository.SWT_KIND));
