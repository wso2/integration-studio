 ...
 * 
 */
public class CommentMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, CommentMediatorPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            CommentMediatorPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(CommentMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CommentMediator.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.CommentMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.CommentMediator.Properties.reverse,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CommentMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentTextText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CommentMediator.Properties.commentText, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
