 ...
 * 
 */
public class ValidateMediatorOnFailOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public ValidateMediatorOnFailOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject validateMediatorOnFailOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ValidateMediatorOnFailOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(validateMediatorOnFailOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ValidateMediatorOnFailOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
