...
public class DynamicServer44Microei44ExtensionGenerator {
    private static IIntegrationStudioLog log = Logger.getLog(Activator.PLUGIN_ID);

    private static final String MASTER_TOKEN = "masterToken";
    private static final String SERVER_MI_STREAM_LOCATION = "resources/streams/server44microei44.xml";
    private static final String SERVER_VERSION_CARBON = "carbon.server.44microei44";
