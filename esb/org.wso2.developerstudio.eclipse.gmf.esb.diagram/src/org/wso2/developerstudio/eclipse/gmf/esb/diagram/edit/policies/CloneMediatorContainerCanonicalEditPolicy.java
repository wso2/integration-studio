 ...
 * @generated
 */
public class CloneMediatorContainerCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return EsbPackage.eINSTANCE
				.getCloneMediatorContainer_CloneTargetContainer();
	}
	...
	private boolean isMyDiagramElement(View view) {
		return CloneTargetContainerEditPart.VISUAL_ID == EsbVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getCloneMediatorContainer_3603SemanticChildren((View) getHost()
						.getModel());
