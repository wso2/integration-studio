 ...
 * 
 */
public class EvaluatorExpressionPropertyPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, EvaluatorExpressionPropertyPropertiesEditionPart {
     ...
     */
    public EvaluatorExpressionPropertyPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        CompositionSequence evaluatorExpressionPropertyStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        CompositionStep propertiesStep = evaluatorExpressionPropertyStep
                .addStep(EsbViewsRepository.EvaluatorExpressionProperty.Properties.class);
    ...
    protected Composite createPrettyNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.EvaluatorExpressionProperty.Properties.prettyName,
                EsbMessages.EvaluatorExpressionPropertyPropertiesEditionPart_PrettyNameLabel);
        ...
        prettyName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(EvaluatorExpressionPropertyPropertiesEditionPartForm.this,
                                    EsbViewsRepository.EvaluatorExpressionProperty.Properties.prettyName,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EvaluatorExpressionPropertyPropertiesEditionPartForm.this, null,
    ...
    protected Composite createEvaluatorNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.EvaluatorExpressionProperty.Properties.evaluatorName,
                EsbMessages.EvaluatorExpressionPropertyPropertiesEditionPart_EvaluatorNameLabel);
    ...
    protected Composite createEvaluatorValueText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.EvaluatorExpressionProperty.Properties.evaluatorValue,
                EsbMessages.EvaluatorExpressionPropertyPropertiesEditionPart_EvaluatorValueLabel);
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EvaluatorExpressionPropertyPropertiesEditionPart#setPrettyName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EvaluatorExpressionPropertyPropertiesEditionPart#setEvaluatorName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EvaluatorExpressionPropertyPropertiesEditionPart#setEvaluatorValue(String
     *      newValue)
     * 
     */
