 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfAddressEndPointInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			AddressEndPointInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(AddressEndPointInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
