 ...
 * 
 */
public class FilterMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, FilterMediatorPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.FilterMediator.Properties.description,
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            FilterMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FilterMediator.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.FilterMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.FilterMediator.Properties.reverse,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(FilterMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FilterMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createConditionTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.FilterMediator.Properties.conditionType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.FilterMediator.Properties.conditionType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRegexText(Composite parent) {
        createDescription(parent, EsbViewsRepository.FilterMediator.Properties.regex,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.FilterMediator.Properties.regex, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
