...
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigureSetPrecisionOperatorDialog;

public class SetPrecisionConfigureAction extends AbstractActionHandler {
	 ...
	 */
	public SetPrecisionConfigureAction(IWorkbenchPart part) {
		super(part);
		setId(Messages.SetPrecisionConfigureAction_ActionId0);
		setText(Messages.SetPrecisionConfigureAction_ActionIdActionText);
		setToolTipText(Messages.SetPrecisionConfigureAction_ActionIdToolTip);
