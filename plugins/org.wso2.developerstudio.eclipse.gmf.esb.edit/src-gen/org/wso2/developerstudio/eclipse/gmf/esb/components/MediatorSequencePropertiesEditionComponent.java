...
public class MediatorSequencePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public MediatorSequencePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject mediatorSequence,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.MediatorSequence.Properties.sequenceName))
                basePart.setSequenceName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        mediatorSequence.getSequenceName()));

            if (isAccessible(EsbViewsRepository.MediatorSequence.Properties.mediators)) {
                mediatorsSettings = new ReferencesTableSettings(mediatorSequence,
            ...
            if (isAccessible(EsbViewsRepository.MediatorSequence.Properties.onError)) {
                // init part
                onErrorSettings = new EObjectFlatComboSettings(mediatorSequence,
            ...
            if (isAccessible(EsbViewsRepository.MediatorSequence.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        mediatorSequence.getDescription()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.MediatorSequence.Properties.sequenceName == event.getAffectedEditor()) {
            mediatorSequence.setSequenceName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.MediatorSequence.Properties.description == event.getAffectedEditor()) {
            mediatorSequence.setDescription((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getMediatorSequence_Anonymous().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MediatorSequence.Properties.anonymous))
                basePart.setAnonymous((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getMediatorSequence_SequenceName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MediatorSequence.Properties.sequenceName)) {
            ...
            if (EsbPackage.eINSTANCE.getMediatorSequence_Mediators().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.MediatorSequence.Properties.mediators))
                basePart.updateMediators();
            if (EsbPackage.eINSTANCE.getMediatorSequence_OnError().equals(msg.getFeature()) && basePart != null
                    && isAccessible(EsbViewsRepository.MediatorSequence.Properties.onError))
                basePart.setOnError((EObject) msg.getNewValue());
            if (EsbPackage.eINSTANCE.getMediatorSequence_Description().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MediatorSequence.Properties.description)) {
                if (msg.getNewValue() != null) {
                ...
                if (EsbViewsRepository.MediatorSequence.Properties.anonymous == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMediatorSequence_Anonymous().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMediatorSequence_Anonymous().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MediatorSequence.Properties.sequenceName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMediatorSequence_SequenceName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMediatorSequence_SequenceName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.MediatorSequence.Properties.description == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMediatorSequence_Description().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMediatorSequence_Description().getEAttributeType(), newValue);
                }
