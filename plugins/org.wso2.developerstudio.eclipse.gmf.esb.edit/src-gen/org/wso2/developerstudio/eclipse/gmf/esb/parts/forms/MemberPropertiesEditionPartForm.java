 ...
 * 
 */
public class MemberPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, MemberPropertiesEditionPart {
     ...
     */
    public MemberPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createHostNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Member.Properties.hostName,
                EsbMessages.MemberPropertiesEditionPart_HostNameLabel);
        ...
        hostName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MemberPropertiesEditionPartForm.this, EsbViewsRepository.Member.Properties.hostName,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, hostName.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(MemberPropertiesEditionPartForm.this,
                                    EsbViewsRepository.Member.Properties.hostName, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, hostName.getText()));
                }
            }
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MemberPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Member.Properties.hostName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createHttpPortText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Member.Properties.httpPort,
                EsbMessages.MemberPropertiesEditionPart_HttpPortLabel);
        ...
        httpPort.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MemberPropertiesEditionPartForm.this, EsbViewsRepository.Member.Properties.httpPort,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, httpPort.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(MemberPropertiesEditionPartForm.this,
                                    EsbViewsRepository.Member.Properties.httpPort, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, httpPort.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Member.Properties.httpPort, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createHttpsPortText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Member.Properties.httpsPort,
                EsbMessages.MemberPropertiesEditionPart_HttpsPortLabel);
        ...
        httpsPort.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            MemberPropertiesEditionPartForm.this, EsbViewsRepository.Member.Properties.httpsPort,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Member.Properties.httpsPort, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
