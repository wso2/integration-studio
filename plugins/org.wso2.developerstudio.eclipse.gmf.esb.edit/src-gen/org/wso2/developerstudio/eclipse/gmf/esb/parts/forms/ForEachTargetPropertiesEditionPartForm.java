 ...
 * 
 */
public class ForEachTargetPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ForEachTargetPropertiesEditionPart {
     ...
     */
    public ForEachTargetPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ForEachTarget.Properties.sequenceType,
                EsbMessages.ForEachTargetPropertiesEditionPart_SequenceTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.ForEachTarget.Properties.sequenceType, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachTarget.Properties.sequenceType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSequenceFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
        createDescription(parent, EsbViewsRepository.ForEachTarget.Properties.sequence,
                EsbMessages.ForEachTargetPropertiesEditionPart_SequenceLabel);
        sequence = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
                .isRequired(EsbViewsRepository.ForEachTarget.Properties.sequence, EsbViewsRepository.FORM_KIND));
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ForEachTargetPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ForEachTarget.Properties.sequence, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachTarget.Properties.sequence, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEndpointTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ForEachTarget.Properties.endpointType,
                EsbMessages.ForEachTargetPropertiesEditionPart_EndpointTypeLabel);
        ...
        endpointType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ForEachTargetPropertiesEditionPartForm.this,
                            EsbViewsRepository.ForEachTarget.Properties.endpointType, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachTarget.Properties.endpointType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSoapActionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ForEachTarget.Properties.soapAction,
                EsbMessages.ForEachTargetPropertiesEditionPart_SoapActionLabel);
        ...
        soapAction.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ForEachTargetPropertiesEditionPartForm.this,
                            EsbViewsRepository.ForEachTarget.Properties.soapAction, PropertiesEditionEvent.COMMIT,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ForEachTargetPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachTarget.Properties.soapAction, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createToAddressText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ForEachTarget.Properties.toAddress,
                EsbMessages.ForEachTargetPropertiesEditionPart_ToAddressLabel);
        ...
        toAddress.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ForEachTargetPropertiesEditionPartForm.this,
                            EsbViewsRepository.ForEachTarget.Properties.toAddress, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, toAddress.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ForEachTargetPropertiesEditionPartForm.this,
                            EsbViewsRepository.ForEachTarget.Properties.toAddress, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachTarget.Properties.toAddress, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachTargetPropertiesEditionPart#initSequenceType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachTargetPropertiesEditionPart#setSequenceType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachTargetPropertiesEditionPart#setSequence(EObject
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachTargetPropertiesEditionPart#setSequenceButtonMode(ButtonsModeEnum
     *      newValue)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachTargetPropertiesEditionPart#addFilterSequence(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachTargetPropertiesEditionPart#addBusinessFilterSequence(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachTargetPropertiesEditionPart#initEndpointType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachTargetPropertiesEditionPart#setEndpointType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachTargetPropertiesEditionPart#setSoapAction(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachTargetPropertiesEditionPart#setToAddress(String
     *      newValue)
     * 
     */
