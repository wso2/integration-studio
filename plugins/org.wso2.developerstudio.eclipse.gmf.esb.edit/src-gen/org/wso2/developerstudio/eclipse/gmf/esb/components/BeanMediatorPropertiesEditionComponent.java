...
public class BeanMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public BeanMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject beanMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.BeanMediator.Properties.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, beanMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.BeanMediator.Properties.class_))
                basePart.setClass_(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, beanMediator.getClass_()));

            if (isAccessible(EsbViewsRepository.BeanMediator.Properties.action)) {
                basePart.initAction(
                        EEFUtils.choiceOfValues(beanMediator, EsbPackage.eINSTANCE.getBeanMediator_Action()),
            ...
            if (isAccessible(EsbViewsRepository.BeanMediator.Properties.property))
                basePart.setProperty(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, beanMediator.getProperty()));

            if (isAccessible(EsbViewsRepository.BeanMediator.Properties.valueType)) {
                basePart.initValueType(
                        EEFUtils.choiceOfValues(beanMediator, EsbPackage.eINSTANCE.getBeanMediator_ValueType()),
                        beanMediator.getValueType());
            }
            if (isAccessible(EsbViewsRepository.BeanMediator.Properties.valueLiteral))
                basePart.setValueLiteral(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        beanMediator.getValueLiteral()));

            if (isAccessible(EsbViewsRepository.BeanMediator.Properties.targetType)) {
                basePart.initTargetType(
                        EEFUtils.choiceOfValues(beanMediator, EsbPackage.eINSTANCE.getBeanMediator_TargetType()),
                        beanMediator.getTargetType());
            }
            if (isAccessible(EsbViewsRepository.BeanMediator.Properties.targetLiteral))
                basePart.setTargetLiteral(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        beanMediator.getTargetLiteral()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.BeanMediator.Properties.description == event.getAffectedEditor()) {
            beanMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.BeanMediator.Properties.class_ == event.getAffectedEditor()) {
            beanMediator.setClass((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
        ...
        if (EsbViewsRepository.BeanMediator.Properties.var == event.getAffectedEditor()) {
            beanMediator.setVar((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.BeanMediator.Properties.property == event.getAffectedEditor()) {
            beanMediator.setProperty((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.BeanMediator.Properties.valueLiteral == event.getAffectedEditor()) {
            beanMediator.setValueLiteral((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.BeanMediator.Properties.targetLiteral == event.getAffectedEditor()) {
            beanMediator.setTargetLiteral((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.BeanMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.BeanMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.BeanMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getBeanMediator_Class().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.BeanMediator.Properties.class_)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getBeanMediator_Action().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.BeanMediator.Properties.action))
                basePart.setAction((BeanMediatorAction) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getBeanMediator_Var().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.BeanMediator.Properties.var)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getBeanMediator_Property().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.BeanMediator.Properties.property)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getBeanMediator_ValueType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.BeanMediator.Properties.valueType))
                basePart.setValueType((PropertyValueType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getBeanMediator_ValueLiteral().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.BeanMediator.Properties.valueLiteral)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getBeanMediator_TargetType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.BeanMediator.Properties.targetType))
                basePart.setTargetType((PropertyValueType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getBeanMediator_TargetLiteral().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.BeanMediator.Properties.targetLiteral)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getBeanMediator_TargetExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.BeanMediator.Properties.targetExpression)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getBeanMediator_ValueExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.BeanMediator.Properties.valueExpression)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getBeanMediator_Class(),
                EsbPackage.eINSTANCE.getBeanMediator_Action(), EsbPackage.eINSTANCE.getBeanMediator_Var(),
                EsbPackage.eINSTANCE.getBeanMediator_Property(), EsbPackage.eINSTANCE.getBeanMediator_ValueType(),
                EsbPackage.eINSTANCE.getBeanMediator_ValueLiteral(), EsbPackage.eINSTANCE.getBeanMediator_TargetType(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.BeanMediator.Properties.class_ == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getBeanMediator_Class().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getBeanMediator_Class().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.BeanMediator.Properties.action == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getBeanMediator_Action().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getBeanMediator_Action().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.BeanMediator.Properties.var == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getBeanMediator_Var().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getBeanMediator_Var().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.BeanMediator.Properties.property == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getBeanMediator_Property().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getBeanMediator_Property().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.BeanMediator.Properties.valueType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getBeanMediator_ValueType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getBeanMediator_ValueType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.BeanMediator.Properties.valueLiteral == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getBeanMediator_ValueLiteral().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getBeanMediator_ValueLiteral().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.BeanMediator.Properties.targetType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getBeanMediator_TargetType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getBeanMediator_TargetType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.BeanMediator.Properties.targetLiteral == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getBeanMediator_TargetLiteral().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getBeanMediator_TargetLiteral().getEAttributeType(), newValue);
                }
