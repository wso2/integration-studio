...
public class RuleSetCreationPropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public RuleSetCreationPropertyPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject ruleSetCreationProperty, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.RuleSetCreationProperty.Properties.propertyName))
                basePart.setPropertyName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        ruleSetCreationProperty.getPropertyName()));
            ...
            if (isAccessible(EsbViewsRepository.RuleSetCreationProperty.Properties.propertyValue))
                basePart.setPropertyValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        ruleSetCreationProperty.getPropertyValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.RuleSetCreationProperty.Properties.propertyName == event.getAffectedEditor()) {
            ruleSetCreationProperty.setPropertyName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.RuleSetCreationProperty.Properties.propertyValue == event.getAffectedEditor()) {
            ruleSetCreationProperty.setPropertyValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueProperty_PropertyName().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.RuleSetCreationProperty.Properties.propertyName)) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractNameValueProperty_PropertyValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleSetCreationProperty.Properties.propertyValue)) {
                if (msg.getNewValue() != null) {
