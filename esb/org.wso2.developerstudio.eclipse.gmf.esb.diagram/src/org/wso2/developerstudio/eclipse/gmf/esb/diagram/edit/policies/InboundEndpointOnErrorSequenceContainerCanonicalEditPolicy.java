 ...
 * @generated
 */
public class InboundEndpointOnErrorSequenceContainerCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return EsbPackage.eINSTANCE
				.getInboundEndpointOnErrorSequenceContainer_MediatorFlow();
	}
	...
	private boolean isMyDiagramElement(View view) {
		return MediatorFlow26EditPart.VISUAL_ID == EsbVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<EsbNodeDescriptor> childDescriptors = EsbDiagramUpdater
				.getInboundEndpointOnErrorSequenceContainer_3775SemanticChildren((View) getHost()
						.getModel());
