...
public class TreeNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new dataMapper.diagram.edit.policies.DataMapperTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = dataMapper.diagram.providers.DataMapperParserProvider.getParser(
					dataMapper.diagram.providers.DataMapperElementTypes.TreeNode_3002,
					getParserElement(), dataMapper.diagram.part.DataMapperVisualIDRegistry
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					dataMapper.diagram.edit.parts.DataMapperEditPartFactory
