...
public class CommandMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public CommandMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject commandMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.CommandMediator.Properties.description))
                basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        commandMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.CommandMediator.Properties.className))
                basePart.setClassName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        commandMediator.getClassName()));

            if (isAccessible(EsbViewsRepository.CommandMediator.Properties.properties_)) {
                propertiesSettings = new ReferencesTableSettings(commandMediator,
                ...
                basePart.addFilterToProperties(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof CommandProperty);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.CommandMediator.Properties.description == event.getAffectedEditor()) {
            commandMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.CommandMediator.Properties.className == event.getAffectedEditor()) {
            commandMediator.setClassName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.CommandMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CommandMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CommandMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCommandMediator_ClassName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CommandMediator.Properties.className)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCommandMediator_Properties().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.CommandMediator.Properties.properties_))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getCommandMediator_ClassName(),
                EsbPackage.eINSTANCE.getCommandMediator_Properties());
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.CommandMediator.Properties.className == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCommandMediator_ClassName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCommandMediator_ClassName().getEAttributeType(), newValue);
                }
