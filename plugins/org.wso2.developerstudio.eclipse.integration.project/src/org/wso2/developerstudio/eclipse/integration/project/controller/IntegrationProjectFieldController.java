 ...
 */
package org.wso2.developerstudio.eclipse.integration.project.controller;
...
public class IntegrationProjectFieldController extends AbstractFieldController {
	...
	public void validate(String modelProperty, Object value, ProjectDataModel model)
		...
		}else if (modelProperty.equals("integrationConfig.location")){
			if (value == null) {
