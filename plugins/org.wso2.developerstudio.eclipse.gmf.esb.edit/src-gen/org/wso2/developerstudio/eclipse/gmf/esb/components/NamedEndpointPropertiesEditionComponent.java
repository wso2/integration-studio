...
public class NamedEndpointPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public NamedEndpointPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject namedEndpoint,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.properties_)) {
                propertiesSettings = new ReferencesTableSettings(namedEndpoint,
            ...
            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.addressingVersion)) {
                basePart.initAddressingVersion(
                        EEFUtils.choiceOfValues(namedEndpoint,
                                EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingVersion()),
                        namedEndpoint.getAddressingVersion());
            }
            ...
            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.timeOutDuration))
                basePart.setTimeOutDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        namedEndpoint.getTimeOutDuration()));
            ...
            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.timeOutAction)) {
                basePart.initTimeOutAction(
                        ...
                        namedEndpoint.getTimeOutAction());
            }
            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.retryErrorCodes))
                basePart.setRetryErrorCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        namedEndpoint.getRetryErrorCodes()));

            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.retryCount)) {
                basePart.setRetryCount(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, namedEndpoint.getRetryCount()));
            }

            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.retryDelay)) {
                basePart.setRetryDelay(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG, namedEndpoint.getRetryDelay()));
            }
            ...
            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.suspendErrorCodes))
                basePart.setSuspendErrorCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        namedEndpoint.getSuspendErrorCodes()));
            ...
            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.suspendInitialDuration)) {
                basePart.setSuspendInitialDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        namedEndpoint.getSuspendInitialDuration()));
            }
            ...
            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.suspendMaximumDuration)) {
                basePart.setSuspendMaximumDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        namedEndpoint.getSuspendMaximumDuration()));
            }
            ...
            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.suspendProgressionFactor)) {
                basePart.setSuspendProgressionFactor(EEFConverterUtil.convertToString(EcorePackage.Literals.EFLOAT,
                        namedEndpoint.getSuspendProgressionFactor()));
            }

            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.format)) {
                basePart.initFormat(
                        EEFUtils.choiceOfValues(namedEndpoint, EsbPackage.eINSTANCE.getAbstractEndPoint_Format()),
                        namedEndpoint.getFormat());
            }
            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.optimize)) {
                basePart.initOptimize(
                        EEFUtils.choiceOfValues(namedEndpoint, EsbPackage.eINSTANCE.getAbstractEndPoint_Optimize()),
                        namedEndpoint.getOptimize());
            }
            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.templateParameters)) {
                templateParametersSettings = new ReferencesTableSettings(namedEndpoint,
            ...
            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.name))
                basePart.setName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, namedEndpoint.getName()));

            if (isAccessible(EsbViewsRepository.NamedEndpoint.Properties.referringEndpointType)) {
                basePart.initReferringEndpointType(
                        EEFUtils.choiceOfValues(namedEndpoint,
                                EsbPackage.eINSTANCE.getNamedEndpoint_ReferringEndpointType()),
                        namedEndpoint.getReferringEndpointType());
            }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.NamedEndpoint.Properties.description == event.getAffectedEditor()) {
            namedEndpoint.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.NamedEndpoint.Properties.endPointName == event.getAffectedEditor()) {
            namedEndpoint.setEndPointName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.NamedEndpoint.Properties.timeOutDuration == event.getAffectedEditor()) {
            namedEndpoint.setTimeOutDuration((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.NamedEndpoint.Properties.name == event.getAffectedEditor()) {
            namedEndpoint.setName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getEndPoint_EndPointName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.endPointName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_ReliableMessagingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.reliableMessagingEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SecurityEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.securityEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.addressingEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingVersion().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.addressingVersion))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingSeparateListener().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.addressingSeparateListener))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.timeOutDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.timeOutAction))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryErrorCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.retryErrorCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryCount().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.retryCount)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryDelay().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.retryDelay)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendErrorCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.suspendErrorCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendInitialDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.suspendInitialDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendMaximumDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.suspendMaximumDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendProgressionFactor().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.suspendProgressionFactor)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_Format().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.format))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_Optimize().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.optimize))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TemplateParameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.templateParameters))
                basePart.updateTemplateParameters();
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_StatisticsEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.statisticsEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TraceEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.traceEnabled))
                basePart.setTraceEnabled((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getNamedEndpoint_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.name)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getNamedEndpoint_ReferringEndpointType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.NamedEndpoint.Properties.referringEndpointType))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getAbstractEndPoint_TraceEnabled(), EsbPackage.eINSTANCE.getNamedEndpoint_Name(),
                EsbPackage.eINSTANCE.getNamedEndpoint_ReferringEndpointType(),
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.NamedEndpoint.Properties.addressingSeparateListener == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                ...
                if (EsbViewsRepository.NamedEndpoint.Properties.name == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getNamedEndpoint_Name().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getNamedEndpoint_Name().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.NamedEndpoint.Properties.referringEndpointType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getNamedEndpoint_ReferringEndpointType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getNamedEndpoint_ReferringEndpointType().getEAttributeType(),
