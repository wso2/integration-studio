...
import org.wso2.integrationstudio.datamapper.diagram.custom.util.AbsoluteBorderedItemLocator;
...
public class TreeNodeEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new org.wso2.integrationstudio.datamapper.diagram.edit.policies.TreeNodeItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new org.wso2.integrationstudio.datamapper.diagram.edit.policies.TreeNodeCanonicalEditPolicy());
	...
	private boolean createOutNode(EditPart childEditPart) {
		...
		getBorderedFigure().getBorderItemContainer().repaint();
		return true;
	}
	...
	protected NodeFigure createMainFigure() {
		...
		Figure iep = (Figure)((InputEditPart)this.getParent()).getContentPane();
	...
	public class TreeNodeFigure extends RectangleFigure {
		...
		private static final String ORG_WSO2_DEVELOPERSTUDIO_VISUALDATAMAPPER_DIAGRAM = "org.wso2.integrationstudio.visualdatamapper.diagram";
		...
		private void createContents() {
			...
			ImageFigure attributeImg = new ImageFigure(imageHolder.getArrayImage());
			...
			// getModel()).getElement()).getName()).split(",")[1];
			/*
			 * int count = Integer.parseInt((((TreeNode) ((View)
