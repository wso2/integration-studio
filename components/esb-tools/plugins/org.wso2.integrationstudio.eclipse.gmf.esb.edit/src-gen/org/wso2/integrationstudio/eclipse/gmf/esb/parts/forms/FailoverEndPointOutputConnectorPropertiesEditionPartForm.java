...
import org.wso2.integrationstudio.eclipse.gmf.esb.parts.FailoverEndPointOutputConnectorPropertiesEditionPart;
 ...
 * 
 */
public class FailoverEndPointOutputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, FailoverEndPointOutputConnectorPropertiesEditionPart {
	 ...
	 */
	public FailoverEndPointOutputConnectorPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public FailoverEndPointOutputConnectorPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(EsbMessages.FailoverEndPointOutputConnectorPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createCommentMediatorsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.commentMediators = new ReferencesTable(getDescription(EsbViewsRepository.FailoverEndPointOutputConnector.Properties.commentMediators, EsbMessages.FailoverEndPointOutputConnectorPropertiesEditionPart_CommentMediatorsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FailoverEndPointOutputConnectorPropertiesEditionPartForm.this, EsbViewsRepository.FailoverEndPointOutputConnector.Properties.commentMediators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				commentMediators.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FailoverEndPointOutputConnectorPropertiesEditionPartForm.this, EsbViewsRepository.FailoverEndPointOutputConnector.Properties.commentMediators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				commentMediators.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FailoverEndPointOutputConnectorPropertiesEditionPartForm.this, EsbViewsRepository.FailoverEndPointOutputConnector.Properties.commentMediators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				commentMediators.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FailoverEndPointOutputConnectorPropertiesEditionPartForm.this, EsbViewsRepository.FailoverEndPointOutputConnector.Properties.commentMediators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				commentMediators.refresh();
			}
		...
		this.commentMediators.setHelpText(propertiesEditionComponent.getHelpContent(EsbViewsRepository.FailoverEndPointOutputConnector.Properties.commentMediators, EsbViewsRepository.FORM_KIND));
		...
		this.commentMediators.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FailoverEndPointOutputConnectorPropertiesEditionPartForm.this, EsbViewsRepository.FailoverEndPointOutputConnector.Properties.commentMediators, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.FailoverEndPointOutputConnectorPropertiesEditionPart#initCommentMediators(EObject current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.FailoverEndPointOutputConnectorPropertiesEditionPart#updateCommentMediators()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.FailoverEndPointOutputConnectorPropertiesEditionPart#addFilterCommentMediators(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.FailoverEndPointOutputConnectorPropertiesEditionPart#addBusinessFilterCommentMediators(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.FailoverEndPointOutputConnectorPropertiesEditionPart#isContainedInCommentMediatorsTable(EObject element)
	 * 
	 */
