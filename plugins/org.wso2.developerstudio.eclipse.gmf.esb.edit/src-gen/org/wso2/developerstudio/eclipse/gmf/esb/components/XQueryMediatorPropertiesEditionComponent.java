...
public class XQueryMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public XQueryMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject xQueryMediator,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.XQueryMediator.Properties.variables)) {
                variablesSettings = new ReferencesTableSettings(xQueryMediator,
            ...
            if (isAccessible(EsbViewsRepository.XQueryMediator.Properties.scriptKeyType)) {
                basePart.initScriptKeyType(
                        EEFUtils.choiceOfValues(xQueryMediator, EsbPackage.eINSTANCE.getXQueryMediator_ScriptKeyType()),
                        xQueryMediator.getScriptKeyType());
            }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.XQueryMediator.Properties.description == event.getAffectedEditor()) {
            xQueryMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.XQueryMediator.Properties.variables == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, variablesSettings, editingContext.getAdapterFactory());
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.XQueryMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.XQueryMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.XQueryMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getXQueryMediator_Variables().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.XQueryMediator.Properties.variables))
                basePart.updateVariables();
            if (EsbPackage.eINSTANCE.getXQueryMediator_ScriptKeyType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.XQueryMediator.Properties.scriptKeyType))
            ...
            if (EsbPackage.eINSTANCE.getXQueryMediator_TargetXPath().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.XQueryMediator.Properties.targetXPath)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getXQueryMediator_DynamicScriptKey().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.XQueryMediator.Properties.dynamicScriptKey)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getXQueryMediator_Variables(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.XQueryMediator.Properties.scriptKeyType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getXQueryMediator_ScriptKeyType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getXQueryMediator_ScriptKeyType().getEAttributeType(), newValue);
                }
