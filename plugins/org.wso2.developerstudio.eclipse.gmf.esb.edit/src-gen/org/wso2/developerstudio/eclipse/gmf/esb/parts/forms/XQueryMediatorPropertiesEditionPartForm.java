 ...
 * 
 */
public class XQueryMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, XQueryMediatorPropertiesEditionPart {
     ...
     */
    public XQueryMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.XQueryMediator.Properties.commentsList,
                        EsbMessages.XQueryMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "XQueryMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.XQueryMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.XQueryMediator.Properties.reverse,
                        EsbMessages.XQueryMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(XQueryMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.XQueryMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.XQueryMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createVariablesTableComposition(FormToolkit widgetFactory, Composite parent) {
        filterVariablesSubPropetiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent, "Variables",
                true);
        Control[] previousControls = filterVariablesSubPropetiesGroup.getChildren();

        this.variables = new ReferencesTable(getDescription(EsbViewsRepository.XQueryMediator.Properties.variables,
                EsbMessages.XQueryMediatorPropertiesEditionPart_VariablesLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(XQueryMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.XQueryMediator.Properties.variables,
        ...
        this.variables.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.XQueryMediator.Properties.variables, EsbViewsRepository.FORM_KIND));
        ...
        this.variables.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            XQueryMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.XQueryMediator.Properties.variables, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createScriptKeyTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control scriptKeyTypeLabel = createDescription(parent,
                EsbViewsRepository.XQueryMediator.Properties.scriptKeyType,
                EsbMessages.XQueryMediatorPropertiesEditionPart_ScriptKeyTypeLabel);
        ...
        scriptKeyType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            XQueryMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.XQueryMediator.Properties.scriptKeyType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getScriptKeyType()));
                validate();
            }

        });
        scriptKeyType.setID(EsbViewsRepository.XQueryMediator.Properties.scriptKeyType);
        Control scriptKeyTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.XQueryMediator.Properties.scriptKeyType,
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.XQueryMediator.Properties.description,
                EsbMessages.XQueryMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            XQueryMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.XQueryMediator.Properties.description, PropertiesEditionEvent.COMMIT,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            XQueryMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control descriptionHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.XQueryMediator.Properties.description, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryMediatorPropertiesEditionPart#initVariables(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryMediatorPropertiesEditionPart#addFilterVariables(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryMediatorPropertiesEditionPart#addBusinessFilterVariables(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryMediatorPropertiesEditionPart#isContainedInVariablesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryMediatorPropertiesEditionPart#initScriptKeyType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryMediatorPropertiesEditionPart#setScriptKeyType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XQueryMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
    ...
    protected Composite createStaticScriptKey(FormToolkit widgetFactory, final Composite parent) {
        Control staticScriptKeyLabel = createDescription(parent,
                EsbViewsRepository.XQueryMediator.Properties.staticScriptKey,
        ...
        Control staticScriptKeyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.XQueryMediator.Properties.staticScriptKey,
                        EsbViewsRepository.FORM_KIND),
                null);
    ...
    protected Composite createTargetXPath(FormToolkit widgetFactory, final Composite parent) {
        ...
        Control targetXPathHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.XQueryMediator.Properties.targetXPath, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createDynamicScriptKey(FormToolkit widgetFactory, final Composite parent) {
        Control dynamicScriptKeyLabel = createDescription(parent,
                EsbViewsRepository.XQueryMediator.Properties.dynamicScriptKey,
        ...
        String initDynamicScriptKey = dynamicScriptKey.getPropertyValue().isEmpty() ? ""
                : dynamicScriptKey.getPropertyValue();
        ...
        dynamicScriptKeyText.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                EEFNameSpacedPropertyEditorDialog nspd = new EEFNameSpacedPropertyEditorDialog(parent.getShell(),
                        SWT.NULL, dynamicScriptKey);
                dynamicScriptKey = nspd.open();
                dynamicScriptKeyText.setText(dynamicScriptKey.getPropertyValue());
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        XQueryMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.XQueryMediator.Properties.dynamicScriptKey, PropertiesEditionEvent.COMMIT,
                        PropertiesEditionEvent.SET, null, getDynamicScriptKey()));
            }
        });
        ...
        Control dynamicScriptKeyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.XQueryMediator.Properties.dynamicScriptKey,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
