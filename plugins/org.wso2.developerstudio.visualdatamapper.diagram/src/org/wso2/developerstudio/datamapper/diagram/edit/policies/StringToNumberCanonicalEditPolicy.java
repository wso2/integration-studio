 ...
 * @generated
 */
public class StringToNumberCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater
				.getStringToNumber_2037SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater
				.getStringToNumber_2037SemanticChildren((View) getHost().getModel());
