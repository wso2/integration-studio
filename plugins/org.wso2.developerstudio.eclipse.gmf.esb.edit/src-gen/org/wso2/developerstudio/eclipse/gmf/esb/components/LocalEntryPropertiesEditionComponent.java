...
public class LocalEntryPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public LocalEntryPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject localEntry,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.LocalEntry.Properties.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, localEntry.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.LocalEntry.Properties.entryName))
                basePart.setEntryName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, localEntry.getEntryName()));

            if (isAccessible(EsbViewsRepository.LocalEntry.Properties.localEntryType)) {
                basePart.initLocalEntryType(
                        EEFUtils.choiceOfValues(localEntry, EsbPackage.eINSTANCE.getLocalEntry_LocalEntryType()),
                        localEntry.getLocalEntryType());
            }
            if (isAccessible(EsbViewsRepository.LocalEntry.Properties.valueLiteral))
                basePart.setValueLiteral(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, localEntry.getValueLiteral()));

            if (isAccessible(EsbViewsRepository.LocalEntry.Properties.valueXML))
                basePart.setValueXML(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, localEntry.getValueXML()));

            if (isAccessible(EsbViewsRepository.LocalEntry.Properties.valueURL))
                basePart.setValueURL(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, localEntry.getValueURL()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.LocalEntry.Properties.description == event.getAffectedEditor()) {
            localEntry.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.LocalEntry.Properties.entryName == event.getAffectedEditor()) {
            localEntry.setEntryName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
        ...
        if (EsbViewsRepository.LocalEntry.Properties.valueLiteral == event.getAffectedEditor()) {
            localEntry.setValueLiteral((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.LocalEntry.Properties.valueXML == event.getAffectedEditor()) {
            localEntry.setValueXML((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.LocalEntry.Properties.valueURL == event.getAffectedEditor()) {
            localEntry.setValueURL((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.LocalEntry.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LocalEntry.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getLocalEntry_EntryName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LocalEntry.Properties.entryName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getLocalEntry_LocalEntryType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.LocalEntry.Properties.localEntryType))
                basePart.setLocalEntryType((LocalEntryValueType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getLocalEntry_ValueLiteral().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LocalEntry.Properties.valueLiteral)) {
                if (msg.getNewValue() != null) {
                    basePart.setValueLiteral(
                            EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, msg.getNewValue()));
                } else {
            ...
            if (EsbPackage.eINSTANCE.getLocalEntry_ValueXML().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LocalEntry.Properties.valueXML)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getLocalEntry_ValueURL().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.LocalEntry.Properties.valueURL)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getLocalEntry_EntryName(), EsbPackage.eINSTANCE.getLocalEntry_LocalEntryType(),
                EsbPackage.eINSTANCE.getLocalEntry_ValueLiteral(), EsbPackage.eINSTANCE.getLocalEntry_ValueXML(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.LocalEntry.Properties.entryName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getLocalEntry_EntryName().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getLocalEntry_EntryName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.LocalEntry.Properties.localEntryType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getLocalEntry_LocalEntryType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getLocalEntry_LocalEntryType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.LocalEntry.Properties.valueLiteral == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getLocalEntry_ValueLiteral().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getLocalEntry_ValueLiteral().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.LocalEntry.Properties.valueXML == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getLocalEntry_ValueXML().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getLocalEntry_ValueXML().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.LocalEntry.Properties.valueURL == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getLocalEntry_ValueURL().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getLocalEntry_ValueURL().getEAttributeType(), newValue);
                }
