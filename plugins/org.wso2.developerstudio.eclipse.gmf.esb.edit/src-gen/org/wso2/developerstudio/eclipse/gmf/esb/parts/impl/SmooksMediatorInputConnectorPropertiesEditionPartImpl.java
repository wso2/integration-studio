 ...
 * 
 */
public class SmooksMediatorInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, SmooksMediatorInputConnectorPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        CompositionSequence smooksMediatorInputConnectorStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        smooksMediatorInputConnectorStep.addStep(EsbViewsRepository.SmooksMediatorInputConnector.Properties.class)
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.SmooksMediatorInputConnector.Properties.incomingLinks,
                EsbMessages.SmooksMediatorInputConnectorPropertiesEditionPart_IncomingLinksLabel);
        ...
        this.incomingLinks.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SmooksMediatorInputConnector.Properties.incomingLinks, EsbViewsRepository.SWT_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SmooksMediatorInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.SmooksMediatorInputConnector.Properties.incomingLinks,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorInputConnectorPropertiesEditionPart#addFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorInputConnectorPropertiesEditionPart#addBusinessFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorInputConnectorPropertiesEditionPart#isContainedInIncomingLinksTable(EObject
     *      element)
     * 
     */
