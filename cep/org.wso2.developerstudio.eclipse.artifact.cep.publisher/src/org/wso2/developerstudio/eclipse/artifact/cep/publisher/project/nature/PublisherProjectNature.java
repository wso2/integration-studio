 ...
 */
package org.wso2.developerstudio.eclipse.artifact.cep.publisher.project.nature;
...
public class PublisherProjectNature extends AbstractWSO2ProjectNature {
	...
	public void updatePom() throws Exception {
		...
		Plugin pluginEntry = MavenUtils.createPluginEntry(mavenProject,
				...
				MavenConstants.WSO2_CEP_PUBLISHER_VERSION, true);
