...
import org.wso2.integrationstudio.datamapper.diagram.edit.policies.GlobalVariableCanonicalEditPolicy;
import org.wso2.integrationstudio.datamapper.diagram.edit.policies.GlobalVariableItemSemanticEditPolicy;

/**
 * @generated NOT
 */
public class GlobalVariableEditPart extends AbstractOperatorEditPart {
	...
	* @generated
	*/
	public GlobalVariableEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GlobalVariableItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new GlobalVariableCanonicalEditPolicy());
	...
	*/
	...
	public class GlobalVariableFigure extends OperatorRectangle {
		...
		public IFigure getToolTip() {
			return new Label("GlobalVariable Operation");
		}
