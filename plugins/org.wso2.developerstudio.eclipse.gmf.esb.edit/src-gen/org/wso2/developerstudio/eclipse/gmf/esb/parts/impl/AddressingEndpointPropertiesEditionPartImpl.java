 ...
 * 
 */
public class AddressingEndpointPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, AddressingEndpointPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        CompositionStep propertiesStep = addressingEndpointStep
                .addStep(EsbViewsRepository.AddressingEndpoint.Properties.class);
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressingEndpoint.Properties.description,
                EsbMessages.AddressingEndpointPropertiesEditionPart_DescriptionLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressingEndpointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.AddressingEndpoint.Properties.description, PropertiesEditionEvent.COMMIT,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(AddressingEndpointPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.AddressingEndpoint.Properties.commentsList,
                EsbMessages.AddressingEndpointPropertiesEditionPart_CommentsListLabel));
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(),
                        "AddressingEndpoint", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressingEndpointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.AddressingEndpoint.Properties.commentsList,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createEndPointNameText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressingEndpoint.Properties.endPointName,
                EsbMessages.AddressingEndpointPropertiesEditionPart_EndPointNameLabel);
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.endPointName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAnonymousCheckbox(Composite parent) {
        ...
        anonymous.setText(getDescription(EsbViewsRepository.AddressingEndpoint.Properties.anonymous,
                EsbMessages.AddressingEndpointPropertiesEditionPart_AnonymousLabel));
        anonymous.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressingEndpointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.AddressingEndpoint.Properties.anonymous, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.anonymous, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInLineCheckbox(Composite parent) {
        ...
        inLine.setText(getDescription(EsbViewsRepository.AddressingEndpoint.Properties.inLine,
                EsbMessages.AddressingEndpointPropertiesEditionPart_InLineLabel));
        inLine.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressingEndpointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.AddressingEndpoint.Properties.inLine, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.inLine, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(Composite parent) {
        ...
        duplicate.setText(getDescription(EsbViewsRepository.AddressingEndpoint.Properties.duplicate,
                EsbMessages.AddressingEndpointPropertiesEditionPart_DuplicateLabel));
        duplicate.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressingEndpointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.AddressingEndpoint.Properties.duplicate, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.duplicate, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesAdvancedTableComposition(Composite parent) {
        this.properties = new ReferencesTable(
                getDescription(EsbViewsRepository.AddressingEndpoint.Properties.properties_,
                        EsbMessages.AddressingEndpointPropertiesEditionPart_PropertiesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(AddressingEndpointPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.AddressingEndpoint.Properties.properties_,
        ...
        this.properties.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.properties_, EsbViewsRepository.SWT_KIND));
        ...
        this.properties.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressingEndpointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.AddressingEndpoint.Properties.properties_, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createReversedCheckbox(Composite parent) {
        ...
        reversed.setText(getDescription(EsbViewsRepository.AddressingEndpoint.Properties.reversed,
                EsbMessages.AddressingEndpointPropertiesEditionPart_ReversedLabel));
        reversed.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressingEndpointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.AddressingEndpoint.Properties.reversed, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.reversed, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createReliableMessagingEnabledCheckbox(Composite parent) {
        ...
        reliableMessagingEnabled
                .setText(getDescription(EsbViewsRepository.AddressingEndpoint.Properties.reliableMessagingEnabled,
                        EsbMessages.AddressingEndpointPropertiesEditionPart_ReliableMessagingEnabledLabel));
        reliableMessagingEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressingEndpointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.AddressingEndpoint.Properties.reliableMessagingEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createSecurityEnabledCheckbox(Composite parent) {
        ...
        securityEnabled.setText(getDescription(EsbViewsRepository.AddressingEndpoint.Properties.securityEnabled,
                EsbMessages.AddressingEndpointPropertiesEditionPart_SecurityEnabledLabel));
        securityEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressingEndpointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.AddressingEndpoint.Properties.securityEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(securityEnabled.getSelection())));
            }
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressingEndpoint.Properties.securityEnabled, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createAddressingEnabledCheckbox(Composite parent) {
        ...
        addressingEnabled.setText(getDescription(EsbViewsRepository.AddressingEndpoint.Properties.addressingEnabled,
                EsbMessages.AddressingEndpointPropertiesEditionPart_AddressingEnabledLabel));
        addressingEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressingEndpointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.AddressingEndpoint.Properties.addressingEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.addressingEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressingVersionEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressingEndpoint.Properties.addressingVersion,
                EsbMessages.AddressingEndpointPropertiesEditionPart_AddressingVersionLabel);
        ...
        addressingVersion.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressingEndpointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.AddressingEndpoint.Properties.addressingVersion,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.addressingVersion, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressingSeparateListenerCheckbox(Composite parent) {
        ...
        addressingSeparateListener
                .setText(getDescription(EsbViewsRepository.AddressingEndpoint.Properties.addressingSeparateListener,
                        EsbMessages.AddressingEndpointPropertiesEditionPart_AddressingSeparateListenerLabel));
        addressingSeparateListener.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressingEndpointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.AddressingEndpoint.Properties.addressingSeparateListener,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createTimeOutDurationText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressingEndpoint.Properties.timeOutDuration,
                EsbMessages.AddressingEndpointPropertiesEditionPart_TimeOutDurationLabel);
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressingEndpoint.Properties.timeOutDuration, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createTimeOutActionEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressingEndpoint.Properties.timeOutAction,
                EsbMessages.AddressingEndpointPropertiesEditionPart_TimeOutActionLabel);
        ...
        timeOutAction.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressingEndpointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.AddressingEndpoint.Properties.timeOutAction,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getTimeOutAction()));
            }
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressingEndpoint.Properties.timeOutAction, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRetryErrorCodesText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressingEndpoint.Properties.retryErrorCodes,
                EsbMessages.AddressingEndpointPropertiesEditionPart_RetryErrorCodesLabel);
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressingEndpoint.Properties.retryErrorCodes, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRetryCountText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressingEndpoint.Properties.retryCount,
                EsbMessages.AddressingEndpointPropertiesEditionPart_RetryCountLabel);
        ...
        retryCount.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressingEndpointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.AddressingEndpoint.Properties.retryCount, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.retryCount, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRetryDelayText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressingEndpoint.Properties.retryDelay,
                EsbMessages.AddressingEndpointPropertiesEditionPart_RetryDelayLabel);
        ...
        retryDelay.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressingEndpointPropertiesEditionPartImpl.this,
                            EsbViewsRepository.AddressingEndpoint.Properties.retryDelay, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.retryDelay, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSuspendErrorCodesText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressingEndpoint.Properties.suspendErrorCodes,
                EsbMessages.AddressingEndpointPropertiesEditionPart_SuspendErrorCodesLabel);
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.suspendErrorCodes, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSuspendInitialDurationText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressingEndpoint.Properties.suspendInitialDuration,
                EsbMessages.AddressingEndpointPropertiesEditionPart_SuspendInitialDurationLabel);
    ...
    protected Composite createSuspendMaximumDurationText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressingEndpoint.Properties.suspendMaximumDuration,
                EsbMessages.AddressingEndpointPropertiesEditionPart_SuspendMaximumDurationLabel);
    ...
    protected Composite createSuspendProgressionFactorText(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressingEndpoint.Properties.suspendProgressionFactor,
                EsbMessages.AddressingEndpointPropertiesEditionPart_SuspendProgressionFactorLabel);
    ...
    protected Composite createFormatEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressingEndpoint.Properties.format,
                EsbMessages.AddressingEndpointPropertiesEditionPart_FormatLabel);
        ...
        format.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressingEndpointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.AddressingEndpoint.Properties.format,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.format, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOptimizeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressingEndpoint.Properties.optimize,
                EsbMessages.AddressingEndpointPropertiesEditionPart_OptimizeLabel);
        ...
        optimize.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressingEndpointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.AddressingEndpoint.Properties.optimize,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.optimize, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTemplateParametersAdvancedTableComposition(Composite parent) {
        this.templateParameters = new ReferencesTable(
                getDescription(EsbViewsRepository.AddressingEndpoint.Properties.templateParameters,
                        EsbMessages.AddressingEndpointPropertiesEditionPart_TemplateParametersLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(AddressingEndpointPropertiesEditionPartImpl.this,
                                        EsbViewsRepository.AddressingEndpoint.Properties.templateParameters,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.templateParameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.templateParameters, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createStatisticsEnabledCheckbox(Composite parent) {
        ...
        statisticsEnabled.setText(getDescription(EsbViewsRepository.AddressingEndpoint.Properties.statisticsEnabled,
                EsbMessages.AddressingEndpointPropertiesEditionPart_StatisticsEnabledLabel));
        statisticsEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressingEndpointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.AddressingEndpoint.Properties.statisticsEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.statisticsEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTraceEnabledCheckbox(Composite parent) {
        ...
        traceEnabled.setText(getDescription(EsbViewsRepository.AddressingEndpoint.Properties.traceEnabled,
                EsbMessages.AddressingEndpointPropertiesEditionPart_TraceEnabledLabel));
        traceEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressingEndpointPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.AddressingEndpoint.Properties.traceEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(traceEnabled.getSelection())));
            }
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressingEndpoint.Properties.traceEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getDescription()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getCommentsList()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getEndPointName()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setEndPointName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getAnonymous()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setAnonymous(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getInLine()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setInLine(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getDuplicate()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setDuplicate(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#initProperties(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#updateProperties()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#addFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#addBusinessFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#isContainedInPropertiesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getReversed()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setReversed(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getReliableMessagingEnabled()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setReliableMessagingEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getSecurityEnabled()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setSecurityEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getAddressingEnabled()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setAddressingEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getAddressingVersion()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#initAddressingVersion(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setAddressingVersion(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getAddressingSeparateListener()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setAddressingSeparateListener(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getTimeOutDuration()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setTimeOutDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getTimeOutAction()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#initTimeOutAction(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setTimeOutAction(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getRetryErrorCodes()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setRetryErrorCodes(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getRetryCount()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setRetryCount(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getRetryDelay()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setRetryDelay(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getSuspendErrorCodes()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setSuspendErrorCodes(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getSuspendInitialDuration()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setSuspendInitialDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getSuspendMaximumDuration()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setSuspendMaximumDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getSuspendProgressionFactor()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setSuspendProgressionFactor(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getFormat()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#initFormat(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setFormat(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getOptimize()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#initOptimize(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setOptimize(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#initTemplateParameters(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#updateTemplateParameters()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#addFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#addBusinessFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#isContainedInTemplateParametersTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getStatisticsEnabled()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setStatisticsEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#getTraceEnabled()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressingEndpointPropertiesEditionPart#setTraceEnabled(Boolean
     *      newValue)
     * 
     */
