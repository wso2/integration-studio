 ...
 * 
 */
public class ThrottleMediatorOnRejectOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public ThrottleMediatorOnRejectOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject throttleMediatorOnRejectOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.ThrottleMediatorOnRejectOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(throttleMediatorOnRejectOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.ThrottleMediatorOnRejectOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
