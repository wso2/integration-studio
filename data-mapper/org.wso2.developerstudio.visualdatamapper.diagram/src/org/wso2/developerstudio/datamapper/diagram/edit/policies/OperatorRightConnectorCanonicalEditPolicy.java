 ...
 * @generated
 */
public class OperatorRightConnectorCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DataMapperPackage.eINSTANCE.getOperatorRightConnector_OutNode();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater.getOperatorRightConnector_3017SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return OutNode3EditPart.VISUAL_ID == DataMapperVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DataMapperNodeDescriptor> childDescriptors = DataMapperDiagramUpdater.getOperatorRightConnector_3017SemanticChildren((View) getHost().getModel());
