 ...
 * 
 */
public class SynapseAPIPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, SynapseAPIPropertiesEditionPart {
    ...
    protected Composite createHandlersAdvancedTableComposition(Composite parent) {
                ...
                EsbMessages.SynapseAPIPropertiesEditionPart_HandlersLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(SynapseAPIPropertiesEditionPartImpl.this,
        ...
        this.handlers.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SynapseAPI.Handler.handlers, EsbViewsRepository.SWT_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SynapseAPIPropertiesEditionPartImpl.this,
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.SynapseAPI.Handler.Properties.commentsList,
    ...
    protected Composite createApiNameText(Composite parent) {
        createDescription(parent, EsbViewsRepository.SynapseAPI.Handler.Properties.apiName,
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SynapseAPIPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SynapseAPI.Handler.Properties.apiName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createContextText(Composite parent) {
        createDescription(parent, EsbViewsRepository.SynapseAPI.Handler.Properties.context,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SynapseAPI.Handler.Properties.context, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createHostNameText(Composite parent) {
        createDescription(parent, EsbViewsRepository.SynapseAPI.Handler.Properties.hostName,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SynapseAPI.Handler.Properties.hostName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPortText(Composite parent) {
        createDescription(parent, EsbViewsRepository.SynapseAPI.Handler.Properties.port,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SynapseAPI.Handler.Properties.port, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResourcesAdvancedTableComposition(Composite parent) {
        ...
        this.resources.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SynapseAPI.Handler.Properties.resources, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createVersionTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.SynapseAPI.Handler.Properties.versionType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SynapseAPI.Handler.Properties.versionType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createVersionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.SynapseAPI.Handler.Properties.version,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SynapseAPI.Handler.Properties.version, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTraceEnabledCheckbox(Composite parent) {
        ...
        traceEnabled.setText(getDescription(EsbViewsRepository.SynapseAPI.Handler.Properties.traceEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SynapseAPI.Handler.Properties.traceEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStatisticsEnabledCheckbox(Composite parent) {
        ...
        statisticsEnabled.setText(getDescription(EsbViewsRepository.SynapseAPI.Handler.Properties.statisticsEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SynapseAPI.Handler.Properties.statisticsEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.SynapseAPI.Handler.Properties.description,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SynapseAPI.Handler.Properties.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
