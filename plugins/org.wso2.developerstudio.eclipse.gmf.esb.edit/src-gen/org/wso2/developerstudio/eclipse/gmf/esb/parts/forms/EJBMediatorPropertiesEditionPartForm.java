 ...
 * 
 */
public class EJBMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, EJBMediatorPropertiesEditionPart {
     ...
     */
    public EJBMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        ...
        createDescription(parent, EsbViewsRepository.EJBMediator.Properties.description,
                EsbMessages.EJBMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.EJBMediator.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EJBMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.EJBMediator.Properties.description, PropertiesEditionEvent.FOCUS_CHANGED,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EJBMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EJBMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.EJBMediator.Properties.commentsList,
                        EsbMessages.EJBMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "EJBMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EJBMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.EJBMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.EJBMediator.Properties.reverse,
                EsbMessages.EJBMediatorPropertiesEditionPart_ReverseLabel), SWT.CHECK);
                ...
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(EJBMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.EJBMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EJBMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createBeanstalkText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.EJBMediator.Properties.beanstalk,
                EsbMessages.EJBMediatorPropertiesEditionPart_BeanstalkLabel);
        ...
        beanstalk.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(EJBMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.EJBMediator.Properties.beanstalk, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, beanstalk.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EJBMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.EJBMediator.Properties.beanstalk, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, beanstalk.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EJBMediator.Properties.beanstalk, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createClass_Text(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.EJBMediator.Properties.class_,
                EsbMessages.EJBMediatorPropertiesEditionPart_Class_Label);
        ...
        class_.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EJBMediatorPropertiesEditionPartForm.this, EsbViewsRepository.EJBMediator.Properties.class_,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(EJBMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.EJBMediator.Properties.class_, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EJBMediator.Properties.class_, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMethodText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.EJBMediator.Properties.method,
                EsbMessages.EJBMediatorPropertiesEditionPart_MethodLabel);
        ...
        method.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EJBMediatorPropertiesEditionPartForm.this, EsbViewsRepository.EJBMediator.Properties.method,
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(EJBMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.EJBMediator.Properties.method, PropertiesEditionEvent.COMMIT,
                                        PropertiesEditionEvent.SET, null, method.getText()));
                }
            }
        });
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EJBMediator.Properties.method, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
        ...
        sessionIdType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EJBMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.EJBMediator.Properties.sessionIdType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getSessionIdType()));
            }

        });
        sessionIdType.setID(EsbViewsRepository.EJBMediator.Properties.sessionIdType);
        FormUtils
                .createHelpButton(widgetFactory, filterSessionSubPropertiesGroup,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.EJBMediator.Properties.sessionIdType, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createSessionIdLiteralText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = filterSessionSubPropertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.EJBMediator.Properties.sessionIdLiteral,
                EsbMessages.EJBMediatorPropertiesEditionPart_SessionIdLiteralLabel);
        ...
        sessionIdLiteral.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EJBMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.EJBMediator.Properties.sessionIdLiteral, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, sessionIdLiteral.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(EJBMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.EJBMediator.Properties.sessionIdLiteral,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
                                    sessionIdLiteral.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EJBMediator.Properties.sessionIdLiteral, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRemoveCheckbox(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        remove = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.EJBMediator.Properties.remove,
                EsbMessages.EJBMediatorPropertiesEditionPart_RemoveLabel), SWT.CHECK);
        remove.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(EJBMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.EJBMediator.Properties.remove, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, new Boolean(remove.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EJBMediator.Properties.remove, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTargetText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.EJBMediator.Properties.target,
                EsbMessages.EJBMediatorPropertiesEditionPart_TargetLabel);
        ...
        target.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EJBMediatorPropertiesEditionPartForm.this, EsbViewsRepository.EJBMediator.Properties.target,
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(EJBMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.EJBMediator.Properties.target, PropertiesEditionEvent.COMMIT,
                                        PropertiesEditionEvent.SET, null, target.getText()));
                }
            }
        });
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EJBMediator.Properties.target, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createJNDINameText(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        createDescription(parent, EsbViewsRepository.EJBMediator.Properties.jNDIName,
                EsbMessages.EJBMediatorPropertiesEditionPart_JNDINameLabel);
        ...
        jNDIName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(EJBMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.EJBMediator.Properties.jNDIName, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, jNDIName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EJBMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.EJBMediator.Properties.jNDIName, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, jNDIName.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EJBMediator.Properties.jNDIName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMethodArgumentsTableComposition(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        this.methodArguments = new ReferencesTable(
                getDescription(EsbViewsRepository.EJBMediator.Properties.methodArguments,
                        EsbMessages.EJBMediatorPropertiesEditionPart_MethodArgumentsLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(EJBMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.EJBMediator.Properties.methodArguments,
        ...
        this.methodArguments.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EJBMediator.Properties.methodArguments, EsbViewsRepository.FORM_KIND));
        ...
        this.methodArguments.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EJBMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.EJBMediator.Properties.methodArguments, PropertiesEditionEvent.CHANGE,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EJBMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EJBMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EJBMediatorPropertiesEditionPart#setBeanstalk(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EJBMediatorPropertiesEditionPart#initSessionIdType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EJBMediatorPropertiesEditionPart#setSessionIdType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EJBMediatorPropertiesEditionPart#setSessionIdLiteral(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EJBMediatorPropertiesEditionPart#initMethodArguments(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EJBMediatorPropertiesEditionPart#addFilterMethodArguments(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EJBMediatorPropertiesEditionPart#addBusinessFilterMethodArguments(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EJBMediatorPropertiesEditionPart#isContainedInMethodArgumentsTable(EObject
     *      element)
     * 
     */
    ...
    protected Composite createSessionIDExpressionWidget(FormToolkit widgetFactory, final Composite parent) {
        Control sessionIdExpressionLabel = createDescription(parent,
                EsbViewsRepository.EJBMediator.Properties.sessionIdExpression,
        ...
        Control sessionIdExpressionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.EJBMediator.Properties.sessionIdExpression,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        sessionIDExpressionElements = new Control[] { sessionIdExpressionLabel, sessionIdExpressionText,
                sessionIdExpressionHelp };
        return parent;
