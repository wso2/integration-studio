 ...
 *   <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.PublishEventMediatorImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PublishEventMediatorImpl extends MediatorImpl implements PublishEventMediator {
	 ...
	 * @ordered
	 */
	protected PublishEventAttributes attributes;
	...
	public PublishEventAttributes getAttributes() {
		if (attributes != null && attributes.eIsProxy()) {
			...
			attributes = (PublishEventAttributes)eResolveProxy(oldAttributes);
			if (attributes != oldAttributes) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EsbPackage.PUBLISH_EVENT_MEDIATOR__ATTRIBUTES, oldAttributes, attributes));
			}
		}
		return attributes;
	}
	 ...
	 * @generated
	 */
	public PublishEventAttributes basicGetAttributes() {
		return attributes;
	}
	 ...
	 * @generated
	 */
	public void setAttributes(PublishEventAttributes newAttributes) {
		PublishEventAttributes oldAttributes = attributes;
		attributes = newAttributes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EsbPackage.PUBLISH_EVENT_MEDIATOR__ATTRIBUTES, oldAttributes, attributes));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EsbPackage.PUBLISH_EVENT_MEDIATOR__EVENT_SINK:
				return getEventSink();
			case EsbPackage.PUBLISH_EVENT_MEDIATOR__ATTRIBUTES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EsbPackage.PUBLISH_EVENT_MEDIATOR__EVENT_SINK:
				...
				return;
			case EsbPackage.PUBLISH_EVENT_MEDIATOR__ATTRIBUTES:
				setAttributes((PublishEventAttributes)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case EsbPackage.PUBLISH_EVENT_MEDIATOR__EVENT_SINK:
				...
				return;
			case EsbPackage.PUBLISH_EVENT_MEDIATOR__ATTRIBUTES:
				setAttributes((PublishEventAttributes)null);
				return;
		}
