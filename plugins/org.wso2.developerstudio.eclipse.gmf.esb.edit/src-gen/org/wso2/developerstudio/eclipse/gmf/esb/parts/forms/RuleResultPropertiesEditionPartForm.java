 ...
 * 
 */
public class RuleResultPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, RuleResultPropertiesEditionPart {
	 ...
	 */
	public RuleResultPropertiesEditionPartForm() { super(); }
		...
		resultType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RuleResultPropertiesEditionPartForm.this, EsbViewsRepository.RuleResult.Properties.resultType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getResultType()));
			}

		});
		resultType.setID(EsbViewsRepository.RuleResult.Properties.resultType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.RuleResult.Properties.resultType, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createResultCustomTypeText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, resultCustomType.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(
									RuleResultPropertiesEditionPartForm.this,
									EsbViewsRepository.RuleResult.Properties.resultCustomType,
									PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST,
									null, resultCustomType.getText()));
				}
			}
		...
		resultCustomType.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RuleResultPropertiesEditionPartForm.this, EsbViewsRepository.RuleResult.Properties.resultCustomType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, resultCustomType.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.RuleResult.Properties.resultCustomType, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createResultNameText(FormToolkit widgetFactory, Composite parent) {
		...
		resultName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RuleResultPropertiesEditionPartForm.this,
							EsbViewsRepository.RuleResult.Properties.resultName,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, resultName.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(
									RuleResultPropertiesEditionPartForm.this,
									EsbViewsRepository.RuleResult.Properties.resultName,
									PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST,
									null, resultName.getText()));
				}
			}
		...
		resultName.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RuleResultPropertiesEditionPartForm.this, EsbViewsRepository.RuleResult.Properties.resultName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, resultName.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.RuleResult.Properties.resultName, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createValueTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		valueType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RuleResultPropertiesEditionPartForm.this, EsbViewsRepository.RuleResult.Properties.valueType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getValueType()));
			}

		});
		valueType.setID(EsbViewsRepository.RuleResult.Properties.valueType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.RuleResult.Properties.valueType, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createValueLiteralText(FormToolkit widgetFactory, Composite parent) {
		...
		valueLiteral.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RuleResultPropertiesEditionPartForm.this,
							EsbViewsRepository.RuleResult.Properties.valueLiteral,
		...
		valueLiteral.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RuleResultPropertiesEditionPartForm.this, EsbViewsRepository.RuleResult.Properties.valueLiteral, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, valueLiteral.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.RuleResult.Properties.valueLiteral, EsbViewsRepository.FORM_KIND), null); //$NON-NLS-1$
