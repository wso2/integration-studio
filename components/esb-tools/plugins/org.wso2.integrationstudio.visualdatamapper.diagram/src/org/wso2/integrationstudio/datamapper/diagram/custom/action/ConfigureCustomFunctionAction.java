...
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigureCustomFunctionOperatorDialog;

public class ConfigureCustomFunctionAction extends AbstractActionHandler {
	 ...
	 */
	public ConfigureCustomFunctionAction(IWorkbenchPart part) {
		super(part);
	...
	protected void doRun(IProgressMonitor progressMonitor) {
		...
		Dialog configureCustomFunction = new ConfigureCustomFunctionOperatorDialog(Display.getDefault().getActiveShell(),
				(CustomFunction) selectedObj, getEditingDomain(),selectedEP);
