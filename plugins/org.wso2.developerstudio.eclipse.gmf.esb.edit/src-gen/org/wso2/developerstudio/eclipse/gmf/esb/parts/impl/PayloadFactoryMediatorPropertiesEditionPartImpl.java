 ...
 * 
 */
public class PayloadFactoryMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, PayloadFactoryMediatorPropertiesEditionPart {
    ...
    protected Composite createPayloadFormatEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.PayloadFactoryMediator.Properties.payloadFormat,
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            PayloadFactoryMediatorPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PayloadFactoryMediator.Properties.payloadFormat, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPayloadText(Composite parent) {
        createDescription(parent, EsbViewsRepository.PayloadFactoryMediator.Properties.payload,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PayloadFactoryMediator.Properties.payload, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createArgsAdvancedTableComposition(Composite parent) {
                ...
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(PayloadFactoryMediatorPropertiesEditionPartImpl.this,
        ...
        this.args.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PayloadFactoryMediator.Properties.args, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createMediaTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.PayloadFactoryMediator.Properties.mediaType,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PayloadFactoryMediator.Properties.mediaType, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.PayloadFactoryMediator.Properties.description,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.PayloadFactoryMediator.Properties.description, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.PayloadFactoryMediator.Properties.commentsList,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.PayloadFactoryMediator.Properties.reverse,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.PayloadFactoryMediator.Properties.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
