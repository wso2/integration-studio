 ...
 * 
 */
public class ThrottleMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ThrottleMediatorPropertiesEditionPart {
     ...
     */
    public ThrottleMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep throttlePolicyStep = throttleMediatorStep
                .addStep(EsbViewsRepository.ThrottleMediator.ThrottlePolicy.class);
    ...
    protected Composite createGeneralGroup(FormToolkit widgetFactory, final Composite parent) {
        Section generalSection = widgetFactory.createSection(parent,
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ThrottleMediator.General.commentsList,
                        EsbMessages.ThrottleMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "ThrottleMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.ThrottleMediator.General.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.ThrottleMediator.General.reverse,
                EsbMessages.ThrottleMediatorPropertiesEditionPart_ReverseLabel), SWT.CHECK);
                ...
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ThrottleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ThrottleMediator.General.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottleMediator.General.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createGroupIdText(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.ThrottleMediator.General.groupId,
                EsbMessages.ThrottleMediatorPropertiesEditionPart_GroupIdLabel);
        ...
        groupId.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ThrottleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ThrottleMediator.General.groupId, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, groupId.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ThrottleMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ThrottleMediator.General.groupId, PropertiesEditionEvent.FOCUS_CHANGED,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ThrottleMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottleMediator.General.groupId, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.ThrottleMediator.Misc.description,
                EsbMessages.ThrottleMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ThrottleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ThrottleMediator.Misc.description, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ThrottleMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ThrottleMediator.Misc.description, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottleMediator.Misc.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOnAcceptGroup(FormToolkit widgetFactory, final Composite parent) {
        Section onAcceptSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createOnRejectGroup(FormToolkit widgetFactory, final Composite parent) {
        Section onRejectsection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createOnAcceptBranchsequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent,
                EsbViewsRepository.ThrottleMediator.OnAccept.onAcceptBranchsequenceType,
                EsbMessages.ThrottleMediatorPropertiesEditionPart_OnAcceptBranchsequenceTypeLabel);
        ...
        onAcceptBranchSequenceTypeElements = new Control[] { itemLabel, onAcceptBranchsequenceType.getCombo(),
                itemHelp };
        onAcceptBranchsequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
    ...
    // FIXME INVALID CASE INTO template public additionalImplementation(editor : ViewElement, pec :
    // PropertiesEditionComponent, inputPEC : PropertiesEditionComponent) in Form Impl for ViewElement onReject
    ...
    protected Composite createOnRejectBranchsequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent,
                EsbViewsRepository.ThrottleMediator.OnReject.onRejectBranchsequenceType,
                EsbMessages.ThrottleMediatorPropertiesEditionPart_OnRejectBranchsequenceTypeLabel);
        ...
        onRejectBranchSequenceTypeElements = new Control[] { itemLabel, onRejectBranchsequenceType.getCombo(),
                itemHelp };
        onRejectBranchsequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
    ...
    protected Composite createThrottlePolicyGroup(FormToolkit widgetFactory, final Composite parent) {
        Section throttlePolicySection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createPolicyTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyType,
                EsbMessages.ThrottleMediatorPropertiesEditionPart_PolicyTypeLabel);
        ...
        policyType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ThrottleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyType,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPolicyType()));
            }

        });
        policyType.setID(EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyType);
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMaxConcurrentAccessCountText(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent,
                ...
                EsbMessages.ThrottleMediatorPropertiesEditionPart_MaxConcurrentAccessCountLabel);
                ...
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ThrottleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ThrottleMediator.ThrottlePolicy.maxConcurrentAccessCount,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    maxConcurrentAccessCount.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ThrottleMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.ThrottleMediator.ThrottlePolicy.maxConcurrentAccessCount,
        ...
        EditingUtils.setID(maxConcurrentAccessCount,
                EsbViewsRepository.ThrottleMediator.ThrottlePolicy.maxConcurrentAccessCount);
    ...
    protected Composite createPolicyEntriesTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.policyEntries = new ReferencesTable(
                getDescription(EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyEntries,
                        EsbMessages.ThrottleMediatorPropertiesEditionPart_PolicyEntriesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ThrottleMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyEntries,
        ...
        this.policyEntries.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyEntries, EsbViewsRepository.FORM_KIND));
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#setGroupId(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
    ...
    public Enumerator getOnAcceptBranchsequenceType() {
        Enumerator selection = (Enumerator) ((StructuredSelection) onAcceptBranchsequenceType.getSelection())
                .getFirstElement();
        return selection;
    }
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#initOnAcceptBranchsequenceType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#setOnAcceptBranchsequenceType(Enumerator
     *      newValue)
     * 
     */
    ...
    public Enumerator getOnRejectBranchsequenceType() {
        Enumerator selection = (Enumerator) ((StructuredSelection) onRejectBranchsequenceType.getSelection())
                .getFirstElement();
        return selection;
    }
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#initOnRejectBranchsequenceType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#setOnRejectBranchsequenceType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#initPolicyType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#setPolicyType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#setMaxConcurrentAccessCount(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#initPolicyEntries(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#addFilterPolicyEntries(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#addBusinessFilterPolicyEntries(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleMediatorPropertiesEditionPart#isContainedInPolicyEntriesTable(EObject
     *      element)
     * 
     */
    ...
    protected Composite createPolicyKey(FormToolkit widgetFactory, Composite parent) {
        Control policyKeyLabel = createDescription(parent, EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyKey,
                EsbMessages.ThrottleMediatorPropertiesEditionPart_PolicyKeyLabel);
        widgetFactory.paintBordersFor(parent);
        if (policyKey == null) {
        ...
        Control sequenceKeyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.ThrottleMediator.ThrottlePolicy.policyKey,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createOnRejectBranchSequenceKey(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent,
                ...
                EsbMessages.ThrottleMediatorPropertiesEditionPart_OnRejectBranchSequenceKeyLabel);
        widgetFactory.paintBordersFor(parent);
        if (onRejectBranchSequenceKey == null) {
            onRejectBranchSequenceKey = EsbFactoryImpl.eINSTANCE.createRegistryKeyProperty();
        }
        String initValueExpression = onRejectBranchSequenceKey.getKeyValue().isEmpty() ? ""
                : onRejectBranchSequenceKey.getKeyValue();
        ...
        EditingUtils.setID(onRejectBranchSequenceKeyText,
                EsbViewsRepository.ThrottleMediator.OnReject.onRejectBranchSequenceKey);
    ...
    protected Composite createOnAcceptBranchSequenceKey(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent,
                ...
                EsbMessages.ThrottleMediatorPropertiesEditionPart_OnAcceptBranchSequenceKeyLabel);
        widgetFactory.paintBordersFor(parent);
        if (onAcceptBranchSequenceKey == null) {
            onAcceptBranchSequenceKey = EsbFactoryImpl.eINSTANCE.createRegistryKeyProperty();
        }
        String initValueExpression = onAcceptBranchSequenceKey.getKeyValue().isEmpty() ? ""
                : onAcceptBranchSequenceKey.getKeyValue();
        ...
        EditingUtils.setID(onAcceptBranchSequenceKeyText,
                EsbViewsRepository.ThrottleMediator.OnAccept.onAcceptBranchSequenceKey);
    ...
    public void validate() {
        ...
        epv.clearElements(
                new Composite[] { generalGroup, miscGroup, onAcceptGroup, onRejectGroup, throttlePolicyGroup });
