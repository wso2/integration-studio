...
public class OAuthMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public OAuthMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject oAuthMediator,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.OAuthMediator.Properties.remoteServiceUrl))
                basePart.setRemoteServiceUrl(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        oAuthMediator.getRemoteServiceUrl()));

            if (isAccessible(EsbViewsRepository.OAuthMediator.Properties.username))
                basePart.setUsername(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, oAuthMediator.getUsername()));

            if (isAccessible(EsbViewsRepository.OAuthMediator.Properties.password))
                basePart.setPassword(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, oAuthMediator.getPassword()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.OAuthMediator.Properties.description == event.getAffectedEditor()) {
            oAuthMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.OAuthMediator.Properties.remoteServiceUrl == event.getAffectedEditor()) {
            oAuthMediator.setRemoteServiceUrl((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.OAuthMediator.Properties.username == event.getAffectedEditor()) {
            oAuthMediator.setUsername((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.OAuthMediator.Properties.password == event.getAffectedEditor()) {
            oAuthMediator.setPassword((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.OAuthMediator.Properties.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.OAuthMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.OAuthMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getOAuthMediator_RemoteServiceUrl().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.OAuthMediator.Properties.remoteServiceUrl)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getOAuthMediator_Username().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.OAuthMediator.Properties.username)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getOAuthMediator_Password().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.OAuthMediator.Properties.password)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getOAuthMediator_RemoteServiceUrl(),
                EsbPackage.eINSTANCE.getOAuthMediator_Username(), EsbPackage.eINSTANCE.getOAuthMediator_Password());
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.OAuthMediator.Properties.remoteServiceUrl == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getOAuthMediator_RemoteServiceUrl().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getOAuthMediator_RemoteServiceUrl().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.OAuthMediator.Properties.username == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getOAuthMediator_Username().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getOAuthMediator_Username().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.OAuthMediator.Properties.password == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getOAuthMediator_Password().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getOAuthMediator_Password().getEAttributeType(), newValue);
                }
