 ...
 * 
 */
public class SequencePropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, SequencePropertiesEditionPart {
     ...
     */
    public SequencePropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.Sequence.Properties.description,
                EsbMessages.SequencePropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencePropertiesEditionPartForm.this, EsbViewsRepository.Sequence.Properties.description,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencePropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                ...
                                EsbViewsRepository.Sequence.Properties.description, PropertiesEditionEvent.COMMIT,
        ...
        Control descriptionHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Sequence.Properties.description, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.Sequence.Properties.commentsList,
                        EsbMessages.SequencePropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "Sequence", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SequencePropertiesEditionPartForm.this,
                                    EsbViewsRepository.Sequence.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.Sequence.Properties.reverse,
                EsbMessages.SequencePropertiesEditionPart_ReverseLabel), SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SequencePropertiesEditionPartForm.this,
                                    EsbViewsRepository.Sequence.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Sequence.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Sequence.Properties.name,
                EsbMessages.SequencePropertiesEditionPart_NameLabel);
        ...
        name.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencePropertiesEditionPartForm.this, EsbViewsRepository.Sequence.Properties.name,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SequencePropertiesEditionPartForm.this,
                                    EsbViewsRepository.Sequence.Properties.name, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Sequence.Properties.name, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createKeyText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.Sequence.Properties.key,
                EsbMessages.SequencePropertiesEditionPart_KeyLabel);
        ...
        key.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencePropertiesEditionPartForm.this, EsbViewsRepository.Sequence.Properties.key,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, key.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SequencePropertiesEditionPartForm.this,
                                    EsbViewsRepository.Sequence.Properties.key, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, key.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Sequence.Properties.key, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutputConnectorTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.outputConnector = new ReferencesTable(
                getDescription(EsbViewsRepository.Sequence.Properties.outputConnector,
                        EsbMessages.SequencePropertiesEditionPart_OutputConnectorLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(SequencePropertiesEditionPartForm.this,
                                        EsbViewsRepository.Sequence.Properties.outputConnector,
        ...
        this.outputConnector.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Sequence.Properties.outputConnector, EsbViewsRepository.FORM_KIND));
        ...
        this.outputConnector.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencePropertiesEditionPartForm.this,
                            EsbViewsRepository.Sequence.Properties.outputConnector, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createIncludedMediatorsTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.includedMediators = new ReferencesTable(
                getDescription(EsbViewsRepository.Sequence.Properties.includedMediators,
                        EsbMessages.SequencePropertiesEditionPart_IncludedMediatorsLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(SequencePropertiesEditionPartForm.this,
                                        EsbViewsRepository.Sequence.Properties.includedMediators,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
        ...
        this.includedMediators.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.Sequence.Properties.includedMediators, EsbViewsRepository.FORM_KIND));
        ...
        this.includedMediators.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencePropertiesEditionPartForm.this,
                            EsbViewsRepository.Sequence.Properties.includedMediators, PropertiesEditionEvent.CHANGE,
                            PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
    ...
    protected Composite createReceiveSequenceCheckbox(FormToolkit widgetFactory, Composite parent) {
        receiveSequence = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.Sequence.Properties.receiveSequence,
                        EsbMessages.SequencePropertiesEditionPart_ReceiveSequenceLabel),
                SWT.CHECK);
        receiveSequence.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencePropertiesEditionPartForm.this,
                            EsbViewsRepository.Sequence.Properties.receiveSequence, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, new Boolean(receiveSequence.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.Sequence.Properties.receiveSequence, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(FormToolkit widgetFactory, Composite parent) {
        duplicate = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.Sequence.Properties.duplicate,
                EsbMessages.SequencePropertiesEditionPart_DuplicateLabel), SWT.CHECK);
        duplicate.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(SequencePropertiesEditionPartForm.this,
                                    EsbViewsRepository.Sequence.Properties.duplicate, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.Sequence.Properties.duplicate, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createReferringSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        referingSequenceSubsection = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent,
                "Refering Sequence", true);
        Control referringSequenceTypeLable = createDescription(referingSequenceSubsection,
                EsbViewsRepository.Sequence.Properties.referringSequenceType,
                EsbMessages.SequencePropertiesEditionPart_ReferringSequenceTypeLabel);
        ...
        referringSequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SequencePropertiesEditionPartForm.this,
                            EsbViewsRepository.Sequence.Properties.referringSequenceType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getReferringSequenceType()));
            }

        });
        referringSequenceType.setID(EsbViewsRepository.Sequence.Properties.referringSequenceType);
        Control referringSequenceTypeHelp = FormUtils.createHelpButton(widgetFactory, referingSequenceSubsection,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.Sequence.Properties.referringSequenceType,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencePropertiesEditionPart#initOutputConnector(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencePropertiesEditionPart#addFilterOutputConnector(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencePropertiesEditionPart#addBusinessFilterOutputConnector(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencePropertiesEditionPart#isContainedInOutputConnectorTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencePropertiesEditionPart#initIncludedMediators(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencePropertiesEditionPart#addFilterIncludedMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencePropertiesEditionPart#addBusinessFilterIncludedMediators(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencePropertiesEditionPart#isContainedInIncludedMediatorsTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencePropertiesEditionPart#setReceiveSequence(Boolean
     *      newValue)
     * 
     */
    ...
    public Enumerator getReferringSequenceType() {
        Enumerator selection = (Enumerator) ((StructuredSelection) referringSequenceType.getSelection())
                .getFirstElement();
        return selection;
    }
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencePropertiesEditionPart#initReferringSequenceType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SequencePropertiesEditionPart#setReferringSequenceType(Enumerator
     *      newValue)
     * 
     */
    ...
    protected Composite createStaticReferenceKey(FormToolkit widgetFactory, Composite parent) {
        Control staticReferenceKeyLabel = createDescription(parent,
                EsbViewsRepository.Sequence.Properties.staticReferenceKey, "Static Reference Key");
        widgetFactory.paintBordersFor(parent);
    ...
    protected Composite createDynamicReferenceKey(FormToolkit widgetFactory, final Composite parent) {
        ...
        EditingUtils.setID(dynamicReferenceKeyText, EsbViewsRepository.Sequence.Properties.dynamicReferenceKey);
        ...
        Control dynamicReferenceKeyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.Sequence.Properties.dynamicReferenceKey,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    private void openDynamicReferenceKeyNamespacedPropertyEditor(final Composite parent) {
        ...
        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                SequencePropertiesEditionPartForm.this, EsbViewsRepository.Sequence.Properties.dynamicReferenceKey,
