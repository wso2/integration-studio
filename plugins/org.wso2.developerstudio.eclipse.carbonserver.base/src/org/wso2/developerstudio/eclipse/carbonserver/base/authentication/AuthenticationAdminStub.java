...
public class AuthenticationAdminStub extends org.apache.axis2.client.Stub {
	...
	private void populateFaults() {
		...
		faultMessageMap.put(new org.apache.axis2.client.FaultMapKey(
		                                                            new javax.xml.namespace.QName(
		                                                                                          ...
		                                                                                          "AuthenticationException"),
		                                                            "logout"),
		                    "org.wso2.developerstudio.eclipse.carbonserver.base.authentication.AuthenticationAdminStub$AuthenticationExceptionE");
		...
		_operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
			public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
				try {
					...
					callback.receiveResultlogin(getLoginResponse_return((org.wso2.developerstudio.eclipse.carbonserver.base.authentication.AuthenticationAdminStub.LoginResponse) object));
	...
	public static class ExtensionMapper {
		...
		public static java.lang.Object getTypeObject(java.lang.String namespaceURI, java.lang.String typeName,
			...
			if ("http://authentication.services.core.carbon.wso2.org".equals(namespaceURI) &&
	...
	public static class AuthenticationExceptionE implements org.apache.axis2.databinding.ADBBean {
		...
		public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
			...
			if (localAuthenticationExceptionTracker) {
				...
				elementList.add(localAuthenticationException == null ? null : localAuthenticationException);
			}
		...
		public static class Factory {
			 ...
			 */
			public static AuthenticationExceptionE parse(javax.xml.stream.XMLStreamReader reader)
			                                                                                     throws java.lang.Exception {
				AuthenticationExceptionE object = new AuthenticationExceptionE();
					...
					if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
						...
						if (fullTypeName != null) {
							...
							if (!"AuthenticationException".equals(type)) {
								...
								return (AuthenticationExceptionE) ExtensionMapper.getTypeObject(nsUri, type, reader);
							}
		...
		public static class Factory {
			...
			public static LoginResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				...
				try {
					...
					if (reader.isStartElement() &&
					    new javax.xml.namespace.QName("http://authentication.services.core.carbon.wso2.org", "return").equals(reader.getName())) {
	...
	public static class AuthenticationException extends Exception implements org.apache.axis2.databinding.ADBBean {
		/*
			...
			if (localExceptionTracker) {
				...
				if (localException != null) {
					if (localException instanceof org.apache.axis2.databinding.ADBBean) {
						...
						writeStartElement(null, "http://authentication.services.core.carbon.wso2.org", "Exception",
						                  xmlWriter);
		...
		public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
			...
			attribList.add(new javax.xml.namespace.QName("http://common.core.carbon.wso2.org/xsd",
			                                             "AuthenticationException"));
			if (localExceptionTracker) {
				elementList.add(new javax.xml.namespace.QName("http://authentication.services.core.carbon.wso2.org",
				                                              "Exception"));
		...
		public static class Factory {
			 ...
			 * end element of its outer element
			 */
			public static AuthenticationException parse(javax.xml.stream.XMLStreamReader reader)
			                                                                                    throws java.lang.Exception {
					...
					if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
						...
						if (fullTypeName != null) {
							...
							if (!"AuthenticationException".equals(type)) {
								// find namespace for the prefix
								java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
								return (AuthenticationException) ExtensionMapper.getTypeObject(nsUri, type, reader);
							}
	...
	public static class Login implements org.apache.axis2.databinding.ADBBean {
		...
		public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
			...
			if (localPasswordTracker) {
				...
				elementList.add(localPassword == null
				                                     ? null
			...
			if (localRemoteAddressTracker) {
				...
				elementList.add(localRemoteAddress == null
				                                          ? null
		...
		public static class Factory {
			...
			public static Login parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				...
				try {
					...
					if (reader.isStartElement() &&
					    new javax.xml.namespace.QName("http://authentication.services.core.carbon.wso2.org", "username").equals(reader.getName())) {
					...
					if (reader.isStartElement() &&
					    new javax.xml.namespace.QName("http://authentication.services.core.carbon.wso2.org", "password").equals(reader.getName())) {
	...
	private org.apache.axiom.om.OMElement toOM(org.wso2.developerstudio.eclipse.carbonserver.base.authentication.AuthenticationAdminStub.AuthenticationExceptionE param,
	...
	private org.apache.axiom.om.OMElement toOM(org.wso2.developerstudio.eclipse.carbonserver.base.authentication.AuthenticationAdminStub.Login param,
	                                           boolean optimizeContent) throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.om.OMElement toOM(org.wso2.developerstudio.eclipse.carbonserver.base.authentication.AuthenticationAdminStub.LoginResponse param,
	                                           boolean optimizeContent) throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
		...
		try {
			org.wso2.developerstudio.eclipse.carbonserver.base.authentication.AuthenticationAdminStub.Login wrappedType =
			                                                                                                              new org.wso2.developerstudio.eclipse.carbonserver.base.authentication.AuthenticationAdminStub.Login();
			...
			emptyEnvelope.getBody()
			             .addChild(wrappedType.getOMElement(org.wso2.developerstudio.eclipse.carbonserver.base.authentication.AuthenticationAdminStub.Login.MY_QNAME,
			                                                factory));
	...
	private boolean getLoginResponse_return(org.wso2.developerstudio.eclipse.carbonserver.base.authentication.AuthenticationAdminStub.LoginResponse wrappedType) {
