 ...
 * 
 */
public class WSDLEndPointPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, WSDLEndPointPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        ...
        wSDLEndPointStep.addStep(EsbViewsRepository.WSDLEndPoint.FailoverErrorCodes.class)
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.WSDLEndPoint.Properties.commentsList,
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartImpl.this,
    ...
    protected Composite createEndPointNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Properties.endPointName, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAnonymousCheckbox(Composite parent) {
        ...
        anonymous.setText(getDescription(EsbViewsRepository.WSDLEndPoint.Properties.anonymous,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(WSDLEndPointPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Properties.anonymous, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(Composite parent) {
        ...
        duplicate.setText(getDescription(EsbViewsRepository.WSDLEndPoint.Properties.duplicate,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Properties.duplicate, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createReversedCheckbox(Composite parent) {
        ...
        reversed.setText(getDescription(EsbViewsRepository.WSDLEndPoint.Properties.reversed,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Properties.reversed, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTemplateParametersAdvancedTableComposition(Composite parent) {
        ...
        this.templateParameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Properties.templateParameters, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createInLineCheckbox(Composite parent) {
        ...
        inLine.setText(getDescription(EsbViewsRepository.WSDLEndPoint.Basic.inLine,
                EsbMessages.WSDLEndPointPropertiesEditionPart_InLineLabel));
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Basic.inLine, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFormatEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.Basic.format,
        ...
        format.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartImpl.this, EsbViewsRepository.WSDLEndPoint.Basic.format,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Basic.format, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTraceEnabledCheckbox(Composite parent) {
        ...
        traceEnabled.setText(getDescription(EsbViewsRepository.WSDLEndPoint.Basic.traceEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Basic.traceEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStatisticsEnabledCheckbox(Composite parent) {
        ...
        statisticsEnabled.setText(getDescription(EsbViewsRepository.WSDLEndPoint.Basic.statisticsEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Basic.statisticsEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRetryCountText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.WSDLEndPoint.EndpointTimeoutState.retryCount, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRetryDelayText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.WSDLEndPoint.EndpointTimeoutState.retryDelay, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesAdvancedTableComposition(Composite parent) {
        ...
        this.properties.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Misc.properties, EsbViewsRepository.SWT_KIND));
    ...
    protected Composite createOptimizeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.Misc.optimize,
        ...
        optimize.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartImpl.this, EsbViewsRepository.WSDLEndPoint.Misc.optimize,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Misc.optimize, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.Misc.description,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Misc.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createWsdlUriText(Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.Misc.wsdlUri,
        ...
        wsdlUri.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartImpl.this, EsbViewsRepository.WSDLEndPoint.Misc.wsdlUri,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Misc.wsdlUri, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createServiceText(Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.Misc.service,
        ...
        service.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartImpl.this, EsbViewsRepository.WSDLEndPoint.Misc.service,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Misc.service, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPortText(Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.Misc.port,
        ...
        port.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            WSDLEndPointPropertiesEditionPartImpl.this, EsbViewsRepository.WSDLEndPoint.Misc.port,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.WSDLEndPoint.Misc.port, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createReliableMessagingEnabledCheckbox(Composite parent) {
        ...
        reliableMessagingEnabled.setText(getDescription(EsbViewsRepository.WSDLEndPoint.Qos.reliableMessagingEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Qos.reliableMessagingEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSecurityEnabledCheckbox(Composite parent) {
        ...
        securityEnabled.setText(getDescription(EsbViewsRepository.WSDLEndPoint.Qos.securityEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Qos.securityEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressingEnabledCheckbox(Composite parent) {
        ...
        addressingEnabled.setText(getDescription(EsbViewsRepository.WSDLEndPoint.Qos.addressingEnabled,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Qos.addressingEnabled, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressingVersionEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.Qos.addressingVersion,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Qos.addressingVersion, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAddressingSeparateListenerCheckbox(Composite parent) {
        ...
        addressingSeparateListener
                .setText(getDescription(EsbViewsRepository.WSDLEndPoint.Qos.addressingSeparateListener,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.WSDLEndPoint.Qos.addressingSeparateListener, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createTimeOutDurationText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Timeout.timeOutDuration, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTimeOutActionEMFComboViewer(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.WSDLEndPoint.Timeout.timeOutAction, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFailoverNonRetryErrorCodesText(Composite parent) {
        createDescription(parent, EsbViewsRepository.WSDLEndPoint.FailoverErrorCodes.failoverNonRetryErrorCodes,
