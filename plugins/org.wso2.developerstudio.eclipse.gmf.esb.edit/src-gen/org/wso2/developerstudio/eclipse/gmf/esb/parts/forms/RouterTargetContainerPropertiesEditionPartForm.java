...
import org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterTargetContainerPropertiesEditionPart;
 ...
 * 
 */
public class RouterTargetContainerPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, RouterTargetContainerPropertiesEditionPart {
     ...
     */
    public RouterTargetContainerPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = routerTargetContainerStep
                .addStep(EsbViewsRepository.RouterTargetContainer.Properties.class);
    ...
    protected Composite createBreakAfterRouteCheckbox(FormToolkit widgetFactory, Composite parent) {
        breakAfterRoute = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.RouterTargetContainer.Properties.breakAfterRoute,
                                EsbMessages.RouterTargetContainerPropertiesEditionPart_BreakAfterRouteLabel),
                        SWT.CHECK);
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RouterTargetContainerPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RouterTargetContainer.Properties.breakAfterRoute,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(breakAfterRoute.getSelection())));
            }
    ...
    protected Composite createRoutePatternText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RouterTargetContainer.Properties.routePattern,
                EsbMessages.RouterTargetContainerPropertiesEditionPart_RoutePatternLabel);
        ...
        routePattern.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RouterTargetContainerPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.RouterTargetContainer.Properties.routePattern, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterTargetContainerPropertiesEditionPart#getBreakAfterRoute()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterTargetContainerPropertiesEditionPart#setBreakAfterRoute(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterTargetContainerPropertiesEditionPart#getRoutePattern()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterTargetContainerPropertiesEditionPart#setRoutePattern(String
     *      newValue)
     * 
     */
