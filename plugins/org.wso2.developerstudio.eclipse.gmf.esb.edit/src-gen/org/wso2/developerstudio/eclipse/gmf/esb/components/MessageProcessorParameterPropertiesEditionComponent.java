...
public class MessageProcessorParameterPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public MessageProcessorParameterPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject messageProcessorParameter, String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.MessageProcessorParameter.Properties.parameterName))
                basePart.setParameterName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessorParameter.getParameterName()));
            ...
            if (isAccessible(EsbViewsRepository.MessageProcessorParameter.Properties.parameterValue))
                basePart.setParameterValue(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        messageProcessorParameter.getParameterValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.MessageProcessorParameter.Properties.parameterName == event.getAffectedEditor()) {
            messageProcessorParameter.setParameterName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.MessageProcessorParameter.Properties.parameterValue == event.getAffectedEditor()) {
            messageProcessorParameter.setParameterValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessorParameter_ParameterName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessorParameter.Properties.parameterName)) {
            ...
            if (EsbPackage.eINSTANCE.getMessageProcessorParameter_ParameterValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.MessageProcessorParameter.Properties.parameterValue)) {
                if (msg.getNewValue() != null) {
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.MessageProcessorParameter.Properties.parameterName == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessorParameter_ParameterName().getEAttributeType(),
                                (String) newValue);
                    }
                ...
                if (EsbViewsRepository.MessageProcessorParameter.Properties.parameterValue == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getMessageProcessorParameter_ParameterValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getMessageProcessorParameter_ParameterValue().getEAttributeType(),
