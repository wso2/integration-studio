 ...
 * 
 */
public class SmooksMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, SmooksMediatorPropertiesEditionPart {
     ...
     */
    public SmooksMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        smooksMediatorStep.addStep(EsbViewsRepository.SmooksMediator.Misc.class)
    ...
    protected Composite createInputGroup(FormToolkit widgetFactory, final Composite parent) {
        Section inputSection = widgetFactory.createSection(parent,
    ...
    protected Composite createInputTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control inputTypeLabel = createDescription(parent, EsbViewsRepository.SmooksMediator.Input.inputType,
                EsbMessages.SmooksMediatorPropertiesEditionPart_InputTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SmooksMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SmooksMediator.Input.inputType, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getInputType()));
            }

        });
        inputType.setID(EsbViewsRepository.SmooksMediator.Input.inputType);
        Control inputTypeHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SmooksMediator.Input.inputType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createOutputGroup(FormToolkit widgetFactory, final Composite parent) {
        Section outputSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createOutputTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control outputTypeLabel = createDescription(parent, EsbViewsRepository.SmooksMediator.Output.outputType,
                EsbMessages.SmooksMediatorPropertiesEditionPart_OutputTypeLabel);
        ...
        outputType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SmooksMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SmooksMediator.Output.outputType, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, getOutputType()));
            }

        });
        outputType.setID(EsbViewsRepository.SmooksMediator.Output.outputType);
        Control outputTypeHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SmooksMediator.Output.outputType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createOutputPropertyText(FormToolkit widgetFactory, Composite parent) {
        Control outputPropertyLabel = createDescription(parent, EsbViewsRepository.SmooksMediator.Output.outputProperty,
                EsbMessages.SmooksMediatorPropertiesEditionPart_OutputPropertyLabel);
        ...
        outputProperty.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.SmooksMediator.Output.outputProperty, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, outputProperty.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SmooksMediatorPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SmooksMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control outputPropertyHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.SmooksMediator.Output.outputProperty, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createOutputActionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control outputActionLabel = createDescription(parent, EsbViewsRepository.SmooksMediator.Output.outputAction,
                EsbMessages.SmooksMediatorPropertiesEditionPart_OutputActionLabel);
        ...
        outputAction.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SmooksMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.SmooksMediator.Output.outputAction, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getOutputAction()));
            }

        });
        outputAction.setID(EsbViewsRepository.SmooksMediator.Output.outputAction);
        Control outputActionHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SmooksMediator.Output.outputAction, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createOutputMethodEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control outputMethodLabel = createDescription(parent, EsbViewsRepository.SmooksMediator.Output.outputMethod,
                EsbMessages.SmooksMediatorPropertiesEditionPart_OutputMethodLabel);
        ...
        outputMethod.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SmooksMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.SmooksMediator.Output.outputMethod, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getOutputMethod()));
                refresh();
            }

        });
        outputMethod.setID(EsbViewsRepository.SmooksMediator.Output.outputMethod);
        Control outputMethodHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SmooksMediator.Output.outputMethod, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.SmooksMediator.Properties.commentsList,
                        EsbMessages.SmooksMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "SmooksMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SmooksMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.SmooksMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.SmooksMediator.Properties.reverse,
                        EsbMessages.SmooksMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SmooksMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SmooksMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SmooksMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createKeyGroup(FormToolkit widgetFactory, final Composite parent) {
        Section keySection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.SmooksMediator.Misc.description,
                EsbMessages.SmooksMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SmooksMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SmooksMediator.Misc.description, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SmooksMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.SmooksMediator.Misc.description, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control descriptionHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.SmooksMediator.Misc.description, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorPropertiesEditionPart#initInputType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorPropertiesEditionPart#setInputType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorPropertiesEditionPart#initOutputType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorPropertiesEditionPart#setOutputType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorPropertiesEditionPart#setOutputProperty(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorPropertiesEditionPart#initOutputAction(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorPropertiesEditionPart#setOutputAction(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorPropertiesEditionPart#initOutputMethod(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorPropertiesEditionPart#setOutputMethod(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SmooksMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
    ...
    protected Composite createConfigurationKey(FormToolkit widgetFactory, final Composite parent) {
        Control configurationKeyLabel = createDescription(parent,
                EsbViewsRepository.SmooksMediator.Key.configurationKey,
            ...
            public void keyReleased(KeyEvent e) {
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    EEFRegistryKeyPropertyEditorDialog dialog = new EEFRegistryKeyPropertyEditorDialog(
                            parent.getShell(), SWT.NULL, configurationKey, new ArrayList<NamedEntityDescriptor>());
                    dialog.open();
                    configurationKeyText.setText(configurationKey.getKeyValue());
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            SmooksMediatorPropertiesEditionPartForm.this,
    ...
    protected Composite createInputExpression(FormToolkit widgetFactory, final Composite parent) {
        Control inputExpressionLabel = createDescription(parent,
                EsbViewsRepository.SmooksMediator.Input.inputExpresssion,
        ...
        String initInputExpression = inputExpression.getPropertyValue().isEmpty() ? ""
                : inputExpression.getPropertyValue();
        ...
        inputExpressionText.addMouseListener(new MouseAdapter() {
            ...
            public void mouseDown(MouseEvent event) {
                EEFNameSpacedPropertyEditorDialog nspd = new EEFNameSpacedPropertyEditorDialog(parent.getShell(),
                        SWT.NULL, inputExpression);
                inputExpression = nspd.open();
                inputExpressionText.setText(inputExpression.getPropertyValue());
                propertiesEditionComponent
                        .firePropertiesChanged(new PropertiesEditionEvent(SmooksMediatorPropertiesEditionPartForm.this,
                                EsbViewsRepository.SmooksMediator.Input.inputExpresssion, PropertiesEditionEvent.COMMIT,
                                PropertiesEditionEvent.SET, null, getInputExpression()));
            }
        ...
        Control inputExpressionHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.SmooksMediator.Input.inputExpresssion, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createOutputExpression(FormToolkit widgetFactory, final Composite parent) {
        Control outputExpressionLabel = createDescription(parent,
                EsbViewsRepository.SmooksMediator.Output.outputExpression,
        ...
        String initOutputExpression = outputExpression.getPropertyValue().isEmpty() ? ""
                : outputExpression.getPropertyValue();
        ...
        outputExpressionText.addMouseListener(new MouseAdapter() {
            ...
            public void mouseDown(MouseEvent event) {
                EEFNameSpacedPropertyEditorDialog nspd = new EEFNameSpacedPropertyEditorDialog(parent.getShell(),
                        SWT.NULL, outputExpression);
                outputExpression = nspd.open();
                outputExpressionText.setText(outputExpression.getPropertyValue());
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        SmooksMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.SmooksMediator.Output.outputExpression, PropertiesEditionEvent.COMMIT,
                        PropertiesEditionEvent.SET, null, getOutputExpression()));
            }
        ...
        Control outputExpressionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.SmooksMediator.Output.outputExpression,
