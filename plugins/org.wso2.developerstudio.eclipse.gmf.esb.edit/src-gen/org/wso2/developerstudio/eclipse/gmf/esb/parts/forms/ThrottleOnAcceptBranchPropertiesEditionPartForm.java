 ...
 * 
 */
public class ThrottleOnAcceptBranchPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ThrottleOnAcceptBranchPropertiesEditionPart {
     ...
     */
    public ThrottleOnAcceptBranchPropertiesEditionPartForm() {
        super();
    }
     ...
     * 
     */
    public ThrottleOnAcceptBranchPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        throttleOnAcceptBranchStep.addStep(EsbViewsRepository.ThrottleOnAcceptBranch.Properties.class)
    ...
    protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        propertiesSection.setText(EsbMessages.ThrottleOnAcceptBranchPropertiesEditionPart_PropertiesGroupLabel);
    ...
    protected Composite createSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.ThrottleOnAcceptBranch.Properties.sequenceType,
                EsbMessages.ThrottleOnAcceptBranchPropertiesEditionPart_SequenceTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ThrottleOnAcceptBranchPropertiesEditionPartForm.this,
                            EsbViewsRepository.ThrottleOnAcceptBranch.Properties.sequenceType,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottleOnAcceptBranch.Properties.sequenceType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleOnAcceptBranchPropertiesEditionPart#initSequenceType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ThrottleOnAcceptBranchPropertiesEditionPart#setSequenceType(Enumerator
     *      newValue)
     * 
     */
