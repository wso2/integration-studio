...
public class CustomValidatorImpl extends EObjectImpl implements CustomValidator {
	 ...
	 * @generated
	 */
	public EList<CustomValidatorPropertyList> getProperties() {
		return getMixed().list(DsPackage.Literals.CUSTOM_VALIDATOR__PROPERTIES);
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, DsPackage.CUSTOM_VALIDATOR__MIXED);
		}
		return mixed;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DsPackage.CUSTOM_VALIDATOR__PROPERTIES:
				getProperties().clear();
				getProperties().addAll((Collection<? extends CustomValidatorPropertyList>)newValue);
				return;
			case DsPackage.CUSTOM_VALIDATOR__MIXED:
