...
public class GetIDEInformationFunction extends AbstractWebEditorFunction{
	...
	public GetIDEInformationFunction(AbstractWebBasedEditor editor) {
		super(editor, Constants.IDE_GET_INFORMATION_FUNCTION);
	}
	
	@Override
	public Object function(Object[] arguments) {
		String value = "Not Resolved";
		if (arguments != null && arguments.length > 0) {
			String key = (String)arguments[0];
			if (key.equals("EditorName")) {
				value = editorInput.getName();
			}
		}
		return value;
	}
