 ...
 * 
 */
public class JsonTransformMediatorOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public JsonTransformMediatorOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject jsonTransformMediatorOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.JsonTransformMediatorOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(jsonTransformMediatorOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.JsonTransformMediatorOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
