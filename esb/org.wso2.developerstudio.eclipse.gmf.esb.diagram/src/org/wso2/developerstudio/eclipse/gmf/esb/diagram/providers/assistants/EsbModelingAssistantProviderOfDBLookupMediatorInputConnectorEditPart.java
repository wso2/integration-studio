 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfDBLookupMediatorInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			DBLookupMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(DBLookupMediatorInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
