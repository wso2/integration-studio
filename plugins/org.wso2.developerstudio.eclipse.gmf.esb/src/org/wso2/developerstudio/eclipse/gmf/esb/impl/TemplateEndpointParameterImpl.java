 ...
 * </p>
 * <ul>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.TemplateEndpointParameterImpl#getParameterName <em>Parameter
 * Name</em>}</li>
 * <li>{@link org.wso2.developerstudio.eclipse.gmf.esb.impl.TemplateEndpointParameterImpl#getParameterValue
...
public class TemplateEndpointParameterImpl extends EsbNodeImpl implements TemplateEndpointParameter {
    ...
    public void setParameterName(String newParameterName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.TEMPLATE_ENDPOINT_PARAMETER__PARAMETER_NAME, oldParameterName, parameterName));
    }
    ...
    public void setParameterValue(String newParameterValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EsbPackage.TEMPLATE_ENDPOINT_PARAMETER__PARAMETER_VALUE, oldParameterValue, parameterValue));
    }
