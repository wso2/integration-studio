...
import org.wso2.integrationstudio.datamapper.diagram.edit.commands.TreeNodeCreateCommand;
 ...
 * @generated
 */
public class InputItemSemanticEditPolicy extends DataMapperBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public InputItemSemanticEditPolicy() {
		super(DataMapperElementTypes.Input_2002);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (DataMapperElementTypes.TreeNode_3002 == req.getElementType()) {
			return getGEFWrapper(new TreeNodeCreateCommand(req));
		}
