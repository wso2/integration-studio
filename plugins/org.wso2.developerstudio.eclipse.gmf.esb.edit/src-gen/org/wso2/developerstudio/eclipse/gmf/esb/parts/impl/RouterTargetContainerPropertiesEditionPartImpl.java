 ...
 * 
 */
public class RouterTargetContainerPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, RouterTargetContainerPropertiesEditionPart {
    ...
    protected Composite createBreakAfterRouteCheckbox(Composite parent) {
        ...
        breakAfterRoute.setText(getDescription(EsbViewsRepository.RouterTargetContainer.Properties.breakAfterRoute,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RouterTargetContainerPropertiesEditionPartImpl.this,
    ...
    protected Composite createRoutePatternText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RouterTargetContainerPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.RouterTargetContainer.Properties.routePattern, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
