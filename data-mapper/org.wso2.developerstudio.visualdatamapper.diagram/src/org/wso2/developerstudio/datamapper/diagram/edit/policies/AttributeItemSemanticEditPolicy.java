...
import org.wso2.developerstudio.datamapper.diagram.edit.commands.InNodeCreateCommand;
import org.wso2.developerstudio.datamapper.diagram.edit.commands.OutNodeCreateCommand;
 ...
 * @generated
 */
public class AttributeItemSemanticEditPolicy extends DataMapperBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public AttributeItemSemanticEditPolicy() {
		super(DataMapperElementTypes.Attribute_3004);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (DataMapperElementTypes.InNode_3005 == req.getElementType()) {
			return getGEFWrapper(new InNodeCreateCommand(req));
		}
		if (DataMapperElementTypes.OutNode_3006 == req.getElementType()) {
