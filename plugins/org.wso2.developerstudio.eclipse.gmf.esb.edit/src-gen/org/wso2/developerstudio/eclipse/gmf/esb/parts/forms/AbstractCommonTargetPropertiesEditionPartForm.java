 ...
 * 
 */
public class AbstractCommonTargetPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, AbstractCommonTargetPropertiesEditionPart {
     ...
     */
    public AbstractCommonTargetPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = abstractCommonTargetStep
                .addStep(EsbViewsRepository.AbstractCommonTarget.Properties.class);
    ...
    protected Composite createSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.AbstractCommonTarget.Properties.sequenceType,
                EsbMessages.AbstractCommonTargetPropertiesEditionPart_SequenceTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AbstractCommonTargetPropertiesEditionPartForm.this,
                            EsbViewsRepository.AbstractCommonTarget.Properties.sequenceType,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AbstractCommonTarget.Properties.sequenceType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createSequenceFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
        createDescription(parent, EsbViewsRepository.AbstractCommonTarget.Properties.sequence,
                EsbMessages.AbstractCommonTargetPropertiesEditionPart_SequenceLabel);
        sequence = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
                .isRequired(EsbViewsRepository.AbstractCommonTarget.Properties.sequence, EsbViewsRepository.FORM_KIND));
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AbstractCommonTargetPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AbstractCommonTarget.Properties.sequence,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getSequence()));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AbstractCommonTarget.Properties.sequence, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEndpointTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.AbstractCommonTarget.Properties.endpointType,
                EsbMessages.AbstractCommonTargetPropertiesEditionPart_EndpointTypeLabel);
        ...
        endpointType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AbstractCommonTargetPropertiesEditionPartForm.this,
                            EsbViewsRepository.AbstractCommonTarget.Properties.endpointType,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AbstractCommonTarget.Properties.endpointType, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AbstractCommonTargetPropertiesEditionPart#initSequenceType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AbstractCommonTargetPropertiesEditionPart#setSequenceType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AbstractCommonTargetPropertiesEditionPart#setSequence(EObject
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AbstractCommonTargetPropertiesEditionPart#setSequenceButtonMode(ButtonsModeEnum
     *      newValue)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AbstractCommonTargetPropertiesEditionPart#addFilterSequence(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AbstractCommonTargetPropertiesEditionPart#addBusinessFilterSequence(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AbstractCommonTargetPropertiesEditionPart#initEndpointType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AbstractCommonTargetPropertiesEditionPart#setEndpointType(Enumerator
     *      newValue)
     * 
     */
