package org.wso2.maven.registry.filter;
...
/**
 * This is the Maven Mojo used for generating a pom for a registry filter artifact 
 * from the old CApp project structure
 * 
 * @goal pom-gen
 * 
 */
public class RegistryFilterPOMGenMojo extends AbstractBundlePOMGenMojo {
	/**
	...
	private static final String ARTIFACT_TYPE="lib/registry/filter";
