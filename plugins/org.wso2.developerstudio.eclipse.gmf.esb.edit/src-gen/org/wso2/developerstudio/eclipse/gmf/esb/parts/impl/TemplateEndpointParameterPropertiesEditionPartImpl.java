 ...
 * 
 */
public class TemplateEndpointParameterPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, TemplateEndpointParameterPropertiesEditionPart {
	 ...
	 * 
	 */
	public TemplateEndpointParameterPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(EsbMessages.TemplateEndpointParameterPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createParameterNameText(Composite parent) {
		...
		parameterName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TemplateEndpointParameterPropertiesEditionPartImpl.this, EsbViewsRepository.TemplateEndpointParameter.Properties.parameterName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, parameterName.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.TemplateEndpointParameter.Properties.parameterName, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createParameterValueText(Composite parent) {
		...
		parameterValue.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TemplateEndpointParameterPropertiesEditionPartImpl.this, EsbViewsRepository.TemplateEndpointParameter.Properties.parameterValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, parameterValue.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.TemplateEndpointParameter.Properties.parameterValue, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
