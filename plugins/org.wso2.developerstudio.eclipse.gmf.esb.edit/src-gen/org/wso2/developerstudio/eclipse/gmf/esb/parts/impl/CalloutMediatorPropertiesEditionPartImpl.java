 ...
 * 
 */
public class CalloutMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, CalloutMediatorPropertiesEditionPart {
    ...
    protected Composite createDescriptionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CalloutMediator.Misc.description,
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(CalloutMediatorPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                CalloutMediatorPropertiesEditionPartImpl.this,
                                EsbViewsRepository.CalloutMediator.Misc.description, PropertiesEditionEvent.COMMIT,
                                PropertiesEditionEvent.SET, null, description.getText()));
                }
            }
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CalloutMediator.Misc.description, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(Composite parent) {
        ...
        editCommentsList.setText(getDescription(EsbViewsRepository.CalloutMediator.Misc.commentsList,
    ...
    protected Composite createReverseCheckbox(Composite parent) {
        ...
        reverse.setText(getDescription(EsbViewsRepository.CalloutMediator.Misc.reverse,
                EsbMessages.CalloutMediatorPropertiesEditionPart_ReverseLabel));
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CalloutMediator.Misc.reverse, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPassHeadersCheckbox(Composite parent) {
        ...
        passHeaders.setText(getDescription(EsbViewsRepository.CalloutMediator.Misc.passHeaders,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CalloutMediator.Misc.passHeaders, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEndpointTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.CalloutMediator.Service.endpointType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CalloutMediator.Service.endpointType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSoapActionText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CalloutMediator.Service.soapAction,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CalloutMediator.Service.soapAction, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPathToAxis2RepositoryText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CalloutMediator.Service.pathToAxis2Repository,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CalloutMediator.Service.pathToAxis2Repository, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPathToAxis2xmlText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CalloutMediator.Service.pathToAxis2xml,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CalloutMediator.Service.pathToAxis2xml, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInitAxis2ClientOptionsCheckbox(Composite parent) {
        ...
        initAxis2ClientOptions.setText(getDescription(EsbViewsRepository.CalloutMediator.Service.initAxis2ClientOptions,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CalloutMediator.Service.initAxis2ClientOptions, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createServiceURLText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CalloutMediator.Service.serviceURL,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CalloutMediator.Service.serviceURL, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPayloadTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.CalloutMediator.Source.payloadType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CalloutMediator.Source.payloadType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createPayloadPropertyText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CalloutMediator.Source.payloadProperty,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CalloutMediator.Source.payloadProperty, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResultTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.CalloutMediator.Target.resultType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.CalloutMediator.Target.resultType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createResultContextPropertyText(Composite parent) {
        createDescription(parent, EsbViewsRepository.CalloutMediator.Target.resultContextProperty,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.CalloutMediator.Target.resultContextProperty, EsbViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPoliciesEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.CalloutMediator.WS.policies,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CalloutMediator.WS.policies, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSecurityTypeEMFComboViewer(Composite parent) {
        createDescription(parent, EsbViewsRepository.CalloutMediator.WS.securityType,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.CalloutMediator.WS.securityType, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
