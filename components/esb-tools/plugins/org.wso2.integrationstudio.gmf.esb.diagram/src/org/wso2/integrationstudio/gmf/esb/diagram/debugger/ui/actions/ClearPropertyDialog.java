 ...
 *
 */
public class ClearPropertyDialog extends TitleAreaDialog {
    ...
    public void create() {
        super.create();
        setTitle(Messages.ClearPropertyDialog_MessageMediationPropertyClearShellTitle);
        setMessage(Messages.ClearPropertyDialog_Description, IMessageProvider.INFORMATION);
    }
