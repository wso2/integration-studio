 ...
 * @generated NOT
 */
public class BAMMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, BAMMediatorPropertiesEditionPart {
     ...
     */
    public BAMMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.BAMMediator.Properties.description,
                EsbMessages.BAMMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.BAMMediator.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            BAMMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.BAMMediator.Properties.description, PropertiesEditionEvent.FOCUS_CHANGED,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            BAMMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.BAMMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.BAMMediator.Properties.commentsList,
                        EsbMessages.BAMMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "BAMMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            BAMMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.BAMMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        Control[] previousList = propertiesGroup.getChildren();
        reverse = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.BAMMediator.Properties.reverse,
                EsbMessages.BAMMediatorPropertiesEditionPart_ReverseLabel), SWT.CHECK);
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(BAMMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.BAMMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.BAMMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createServerProfileText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.BAMMediator.Properties.serverProfile,
                EsbMessages.BAMMediatorPropertiesEditionPart_ServerProfileLabel);
        ...
        serverProfile.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            BAMMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.BAMMediator.Properties.serverProfile, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, serverProfile.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(BAMMediatorPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.BAMMediator.Properties.serverProfile, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createStreamNameText(FormToolkit widgetFactory, Composite parent) {
        filterStreamSubPropertiesGroup = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent, "Stream",
                true);
        createDescription(filterStreamSubPropertiesGroup, EsbViewsRepository.BAMMediator.Properties.streamName,
                EsbMessages.BAMMediatorPropertiesEditionPart_StreamNameLabel);
        ...
        streamName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(BAMMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.BAMMediator.Properties.streamName, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, streamName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            BAMMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.BAMMediator.Properties.streamName, PropertiesEditionEvent.FOCUS_CHANGED,
                            PropertiesEditionEvent.FOCUS_LOST, null, streamName.getText()));
                }
            }
        ...
        FormUtils.createHelpButton(widgetFactory, filterStreamSubPropertiesGroup, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.BAMMediator.Properties.streamName, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createStreamVersionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.BAMMediator.Properties.streamVersion,
                EsbMessages.BAMMediatorPropertiesEditionPart_StreamVersionLabel);
        ...
        streamVersion.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            BAMMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.BAMMediator.Properties.streamVersion, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, streamVersion.getText()));
                    propertiesEditionComponent
                            .firePropertiesChanged(new PropertiesEditionEvent(BAMMediatorPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.BAMMediator.Properties.streamVersion, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BAMMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BAMMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BAMMediatorPropertiesEditionPart#setServerProfile(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BAMMediatorPropertiesEditionPart#setStreamName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.BAMMediatorPropertiesEditionPart#setStreamVersion(String
     *      newValue)
     * 
     */
