 ...
 * 
 */
public class AddressEndPointPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, AddressEndPointPropertiesEditionPart {
     ...
     */
    public AddressEndPointPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep endpointSuspendStateStep = addressEndPointStep
                .addStep(EsbViewsRepository.AddressEndPoint.EndpointSuspendState.class);
        endpointSuspendStateStep.addStep(EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendErrorCodes);
        endpointSuspendStateStep
                .addStep(EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendInitialDuration);
        endpointSuspendStateStep
                .addStep(EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendMaximumDuration);
        endpointSuspendStateStep
                .addStep(EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendProgressionFactor);

        CompositionStep endpointTimeoutStateStep = addressEndPointStep
                .addStep(EsbViewsRepository.AddressEndPoint.EndpointTimeoutState.class);
        ...
        CompositionStep failoverStep = addressEndPointStep
                .addStep(EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.class);
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.AddressEndPoint.Basic.commentsList,
                        EsbMessages.AddressEndPointPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "AddressEndPoint", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.AddressEndPoint.Basic.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createEndPointNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.AddressEndPoint.Basic.endPointName,
                EsbMessages.AddressEndPointPropertiesEditionPart_EndPointNameLabel);
        ...
        endPointName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.AddressEndPoint.Basic.endPointName, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, endPointName.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.AddressEndPoint.Basic.endPointName, PropertiesEditionEvent.FOCUS_CHANGED,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.Basic.endPointName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createAnonymousCheckbox(FormToolkit widgetFactory, Composite parent) {
        anonymous = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.AddressEndPoint.Basic.anonymous,
                        EsbMessages.AddressEndPointPropertiesEditionPart_AnonymousLabel),
                SWT.CHECK);
                ...
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AddressEndPoint.Basic.anonymous, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.Basic.anonymous, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createInLineCheckbox(FormToolkit widgetFactory, Composite parent) {
        inLine = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.AddressEndPoint.Basic.inLine,
                EsbMessages.AddressEndPointPropertiesEditionPart_InLineLabel), SWT.CHECK);
        inLine.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AddressEndPoint.Basic.inLine, PropertiesEditionEvent.COMMIT,
        ...
        Control inlineHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Basic.inLine, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDuplicateCheckbox(FormToolkit widgetFactory, Composite parent) {
        duplicate = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.AddressEndPoint.Basic.duplicate,
                        EsbMessages.AddressEndPointPropertiesEditionPart_DuplicateLabel),
                SWT.CHECK);
        duplicate.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AddressEndPoint.Basic.duplicate, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.Basic.duplicate, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createReversedCheckbox(FormToolkit widgetFactory, Composite parent) {
        reversed = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.AddressEndPoint.Basic.reversed,
                EsbMessages.AddressEndPointPropertiesEditionPart_ReversedLabel), SWT.CHECK);
        reversed.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AddressEndPoint.Basic.reversed, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Basic.reversed, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createFormatEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control formatLabel = createDescription(parent, EsbViewsRepository.AddressEndPoint.Basic.format,
                EsbMessages.AddressEndPointPropertiesEditionPart_FormatLabel);
        ...
        format.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AddressEndPoint.Basic.format, PropertiesEditionEvent.COMMIT,
        ...
        Control formatHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Basic.format, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTemplateParametersTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.templateParameters = new ReferencesTable(
                getDescription(EsbViewsRepository.AddressEndPoint.Basic.templateParameters,
                        EsbMessages.AddressEndPointPropertiesEditionPart_TemplateParametersLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.AddressEndPoint.Basic.templateParameters,
        ...
        this.templateParameters.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.AddressEndPoint.Basic.templateParameters, EsbViewsRepository.FORM_KIND));
        ...
        this.templateParameters.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.AddressEndPoint.Basic.templateParameters, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createStatisticsEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        statisticsEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.AddressEndPoint.Basic.statisticsEnabled,
                        EsbMessages.AddressEndPointPropertiesEditionPart_StatisticsEnabledLabel),
                SWT.CHECK);
        statisticsEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.AddressEndPoint.Basic.statisticsEnabled, PropertiesEditionEvent.COMMIT,
        ...
        Control statEnableHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.AddressEndPoint.Basic.statisticsEnabled,
    ...
    protected Composite createTraceEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        traceEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.AddressEndPoint.Basic.traceEnabled,
                        EsbMessages.AddressEndPointPropertiesEditionPart_TraceEnabledLabel),
                SWT.CHECK);
        traceEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.AddressEndPoint.Basic.traceEnabled, PropertiesEditionEvent.COMMIT,
        ...
        Control tracingEnabledHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Basic.traceEnabled, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createURIText(FormToolkit widgetFactory, Composite parent) {
        Control URILabel = createDescription(parent, EsbViewsRepository.AddressEndPoint.Basic.uRI,
                EsbMessages.AddressEndPointPropertiesEditionPart_URILabel);
        ...
        uRI.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartForm.this, EsbViewsRepository.AddressEndPoint.Basic.uRI,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, uRI.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AddressEndPoint.Basic.uRI, PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, uRI.getText()));
                }
            }
            ...
            public void keyPressed(KeyEvent e) {
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.AddressEndPoint.Basic.uRI, PropertiesEditionEvent.COMMIT,
                                        PropertiesEditionEvent.SET, null, uRI.getText()));
                }
            }
        });
        EditingUtils.setID(uRI, EsbViewsRepository.AddressEndPoint.Basic.uRI);
        EditingUtils.setEEFtype(uRI, "eef::Text"); //$NON-NLS-1$
        Control URIHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Basic.uRI, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createEndpointSuspendStateGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        endpointSuspendStateSection
                .setText(EsbMessages.AddressEndPointPropertiesEditionPart_EndpointSuspendStateGroupLabel);
    ...
    protected Composite createSuspendErrorCodesText(FormToolkit widgetFactory, Composite parent) {
        Control suspendErrorCodesLabel = createDescription(parent,
                EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendErrorCodes,
                EsbMessages.AddressEndPointPropertiesEditionPart_SuspendErrorCodesLabel);
        ...
        EditingUtils.setID(suspendErrorCodes,
                EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendErrorCodes);
        EditingUtils.setEEFtype(suspendErrorCodes, "eef::Text"); //$NON-NLS-1$
        Control suspendErrorCodesHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendErrorCodes,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createSuspendErrorCodesText
        suspendErrorCodesTypeElements = new Control[] { suspendErrorCodesLabel, suspendErrorCodes,
                suspendErrorCodesHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createSuspendInitialDurationText(FormToolkit widgetFactory, Composite parent) {
        Control suspendInitialDurationLabel = createDescription(parent,
                EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendInitialDuration,
                EsbMessages.AddressEndPointPropertiesEditionPart_SuspendInitialDurationLabel);
        ...
        Control suspendInitialDurationHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendInitialDuration,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createSuspendMaximumDurationText(FormToolkit widgetFactory, Composite parent) {
        Control suspendMaximumDurationLabel = createDescription(parent,
                EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendMaximumDuration,
                EsbMessages.AddressEndPointPropertiesEditionPart_SuspendMaximumDurationLabel);
        ...
        Control suspendMaximumDurationHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendMaximumDuration,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createSuspendProgressionFactorText(FormToolkit widgetFactory, Composite parent) {
        Control suspendProgressionFactorLabel = createDescription(parent,
                EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendProgressionFactor,
                EsbMessages.AddressEndPointPropertiesEditionPart_SuspendProgressionFactorLabel);
        ...
        Control suspendProgressionFactorHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressEndPoint.EndpointSuspendState.suspendProgressionFactor,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createEndpointTimeoutStateGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        endpointTimeoutStateSection
                .setText(EsbMessages.AddressEndPointPropertiesEditionPart_EndpointTimeoutStateGroupLabel);
    ...
    protected Composite createRetryErrorCodesText(FormToolkit widgetFactory, Composite parent) {
        Control retryErrorCodesLabel = createDescription(parent,
                EsbViewsRepository.AddressEndPoint.EndpointTimeoutState.retryErrorCodes,
                EsbMessages.AddressEndPointPropertiesEditionPart_RetryErrorCodesLabel);
        ...
        Control retryErrorCodesHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressEndPoint.EndpointTimeoutState.retryErrorCodes,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRetryCountText(FormToolkit widgetFactory, Composite parent) {
        Control retryCountLabel = createDescription(parent,
                EsbViewsRepository.AddressEndPoint.EndpointTimeoutState.retryCount,
                EsbMessages.AddressEndPointPropertiesEditionPart_RetryCountLabel);
        ...
        Control retryCountHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressEndPoint.EndpointTimeoutState.retryCount,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRetryDelayText(FormToolkit widgetFactory, Composite parent) {
        Control retryDelayLabel = createDescription(parent,
                EsbViewsRepository.AddressEndPoint.EndpointTimeoutState.retryDelay,
                EsbMessages.AddressEndPointPropertiesEditionPart_RetryDelayLabel);
        ...
        Control retryDelayHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressEndPoint.EndpointTimeoutState.retryDelay,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.properties = new ReferencesTable(
                getDescription(EsbViewsRepository.AddressEndPoint.Misc.properties,
                        EsbMessages.AddressEndPointPropertiesEditionPart_PropertiesLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                        EsbViewsRepository.AddressEndPoint.Misc.properties,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
                        properties.refresh();
                    }
        ...
        this.properties.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Misc.properties, EsbViewsRepository.FORM_KIND));
        ...
        this.properties.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AddressEndPoint.Misc.properties, PropertiesEditionEvent.CHANGE,
                                    PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
    ...
    protected Composite createOptimizeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control optimizeLabel = createDescription(parent, EsbViewsRepository.AddressEndPoint.Misc.optimize,
                EsbMessages.AddressEndPointPropertiesEditionPart_OptimizeLabel);
        ...
        optimize.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AddressEndPoint.Misc.optimize, PropertiesEditionEvent.COMMIT,
        ...
        Control optimizeHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Misc.optimize, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.AddressEndPoint.Misc.description,
                EsbMessages.AddressEndPointPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AddressEndPoint.Misc.description, PropertiesEditionEvent.COMMIT,
                                    PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.AddressEndPoint.Misc.description, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control descriptionHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.Misc.description, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createReliableMessagingEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        reliableMessagingEnabled = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.AddressEndPoint.QoS.reliableMessagingEnabled,
                                EsbMessages.AddressEndPointPropertiesEditionPart_ReliableMessagingEnabledLabel),
                        SWT.CHECK);
        reliableMessagingEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AddressEndPoint.QoS.reliableMessagingEnabled,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
        ...
        Control reliableMessagingEnabledHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressEndPoint.QoS.reliableMessagingEnabled, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createSecurityEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        securityEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.AddressEndPoint.QoS.securityEnabled,
                        EsbMessages.AddressEndPointPropertiesEditionPart_SecurityEnabledLabel),
                SWT.CHECK);
        securityEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.AddressEndPoint.QoS.securityEnabled, PropertiesEditionEvent.COMMIT,
        ...
        Control securityEnabledHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.AddressEndPoint.QoS.securityEnabled, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createAddressingEnabledCheckbox(FormToolkit widgetFactory, Composite parent) {
        addressingEnabled = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.AddressEndPoint.QoS.addressingEnabled,
                        EsbMessages.AddressEndPointPropertiesEditionPart_AddressingEnabledLabel),
                SWT.CHECK);
        addressingEnabled.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.AddressEndPoint.QoS.addressingEnabled, PropertiesEditionEvent.COMMIT,
        ...
        Control addressingEnabledHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.AddressEndPoint.QoS.addressingEnabled, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createAddressingVersionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control addressingVersionLabel = createDescription(parent,
                EsbViewsRepository.AddressEndPoint.QoS.addressingVersion,
                EsbMessages.AddressEndPointPropertiesEditionPart_AddressingVersionLabel);
        ...
        addressingVersion.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.AddressEndPoint.QoS.addressingVersion, PropertiesEditionEvent.COMMIT,
        ...
        Control addressingVersionHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.AddressEndPoint.QoS.addressingVersion, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createAddressingSeparateListenerCheckbox(FormToolkit widgetFactory, Composite parent) {
        addressingSeparateListener = widgetFactory
                .createButton(parent,
                        getDescription(EsbViewsRepository.AddressEndPoint.QoS.addressingSeparateListener,
                                EsbMessages.AddressEndPointPropertiesEditionPart_AddressingSeparateListenerLabel),
                        SWT.CHECK);
        addressingSeparateListener.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AddressEndPoint.QoS.addressingSeparateListener,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createTimeOutDurationText(FormToolkit widgetFactory, Composite parent) {
        Control timeOutDurationLabel = createDescription(parent,
                EsbViewsRepository.AddressEndPoint.Timeout.timeOutDuration,
                EsbMessages.AddressEndPointPropertiesEditionPart_TimeOutDurationLabel);
        ...
        timeOutDuration.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.AddressEndPoint.Timeout.timeOutDuration, PropertiesEditionEvent.COMMIT,
        ...
        Control timeOutDurationHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.AddressEndPoint.Timeout.timeOutDuration,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createTimeOutActionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control timeOutActionLabel = createDescription(parent, EsbViewsRepository.AddressEndPoint.Timeout.timeOutAction,
                EsbMessages.AddressEndPointPropertiesEditionPart_TimeOutActionLabel);
        ...
        timeOutAction.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.AddressEndPoint.Timeout.timeOutAction, PropertiesEditionEvent.COMMIT,
        ...
        Control timeOutActionHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.AddressEndPoint.Timeout.timeOutAction, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    */
    protected Composite createFailoverErrorCodesGroup(FormToolkit widgetFactory, final Composite parent) {
        Section failoverErrorCodesSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
        failoverErrorCodesSection
                .setText(EsbMessages.AddressEndPointPropertiesEditionPart_FailoverErrorCodesGroupLabel);
    ...
    protected Composite createFailoverTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control failoverTypeLabel = createDescription(parent,
                EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.failoverType,
                EsbMessages.AddressEndPointPropertiesEditionPart_FailoverTypeLabel);
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            AddressEndPointPropertiesEditionPartForm.this,
                            EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.failoverType,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getFailoverType()));
                    ...
                    } else if (getFailoverType().getName()
                            .equals(EndPointFailoverRetryType.NON_RETRY_ERROR_CODES.getName())) {
        ...
        Control failoverTypeHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.failoverType,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createFailoverRetryErrorCodesText(FormToolkit widgetFactory, Composite parent) {
        Control failoverRetryErrorCodesLabel = createDescription(parent,
                EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.failoverRetryErrorCodes,
                EsbMessages.AddressEndPointPropertiesEditionPart_FailoverRetryErrorCodesLabel);
                ...
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.failoverRetryErrorCodes,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    failoverRetryErrorCodes.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
                                    EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.failoverRetryErrorCodes,
                                    PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
        ...
        EditingUtils.setID(failoverRetryErrorCodes,
                EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.failoverRetryErrorCodes);
        EditingUtils.setEEFtype(failoverRetryErrorCodes, "eef::Text"); //$NON-NLS-1$
        Control failoverRetryErrorCodesHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.failoverRetryErrorCodes,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createFailoverRetryErrorCodesText
        failoverRetryErrorCodesElements = new Control[] { failoverRetryErrorCodesLabel, failoverRetryErrorCodes,
                failoverRetryErrorCodesHelp };
        // End of user code
        return parent;
    }
    ...
    protected Composite createFailoverNonRetryErrorCodesText(FormToolkit widgetFactory, Composite parent) {
        Control failoverNonRetryErrorCodesLabel = createDescription(parent,
                EsbViewsRepository.AddressEndPoint.FailoverErrorCodes.failoverNonRetryErrorCodes,
                EsbMessages.AddressEndPointPropertiesEditionPart_FailoverNonRetryErrorCodesLabel);
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setEndPointName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setAnonymous(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setInLine(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setDuplicate(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setReversed(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#initFormat(Object input,
     *      Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setFormat(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#initTemplateParameters(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#addFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#addBusinessFilterTemplateParameters(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#isContainedInTemplateParametersTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setStatisticsEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setTraceEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setSuspendErrorCodes(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setSuspendInitialDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setSuspendMaximumDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setSuspendProgressionFactor(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setRetryErrorCodes(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setRetryCount(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setRetryDelay(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#initProperties(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#addFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#addBusinessFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#isContainedInPropertiesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#initOptimize(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setOptimize(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setReliableMessagingEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setSecurityEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setAddressingEnabled(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#initAddressingVersion(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setAddressingVersion(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setAddressingSeparateListener(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setTimeOutDuration(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#initTimeOutAction(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setTimeOutAction(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#initFailoverType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setFailoverType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setFailoverRetryErrorCodes(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.AddressEndPointPropertiesEditionPart#setFailoverNonRetryErrorCodes(String
     *      newValue)
     * 
     */
    ...
    protected Composite createReliableMessagingPolicy(FormToolkit widgetFactory, Composite parent) {
        ...
        Control reliableMessagingPolicyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.AddressEndPoint.QoS.reliableMessagingPolicy, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createInboundPolicy(FormToolkit widgetFactory, Composite parent) {
        Control inboundPolicyLabel = createDescription(parent, EsbViewsRepository.AddressEndPoint.QoS.inboundPolicy,
        ...
        inboundPolicyText.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                ...
                propertiesEditionComponent
                        .firePropertiesChanged(new PropertiesEditionEvent(AddressEndPointPropertiesEditionPartForm.this,
        ...
        Control inboundPolicyHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.QoS.inboundPolicy, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createOutboundPolicy(FormToolkit widgetFactory, Composite parent) {
        Control outboundPolicyLabel = createDescription(parent, EsbViewsRepository.AddressEndPoint.QoS.outboundPolicy,
        ...
        Control outboundPolicyHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.QoS.outboundPolicy, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createSecurityPolicy(FormToolkit widgetFactory, Composite parent) {
        Control securityPolicyLabel = createDescription(parent, EsbViewsRepository.AddressEndPoint.QoS.securityPolicy,
        ...
        Control securityPolicyHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.AddressEndPoint.QoS.securityPolicy, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
