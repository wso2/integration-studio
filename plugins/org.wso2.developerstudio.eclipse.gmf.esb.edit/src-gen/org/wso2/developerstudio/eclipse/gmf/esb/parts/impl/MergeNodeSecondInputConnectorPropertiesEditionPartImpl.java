 ...
 * 
 */
public class MergeNodeSecondInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, MergeNodeSecondInputConnectorPropertiesEditionPart {
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.MergeNodeSecondInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(MergeNodeSecondInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.MergeNodeSecondInputConnector.Properties.incomingLinks,
