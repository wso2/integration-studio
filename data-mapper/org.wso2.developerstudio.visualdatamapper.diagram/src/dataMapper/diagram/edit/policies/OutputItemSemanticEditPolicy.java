...
public class OutputItemSemanticEditPolicy extends
	...
	public OutputItemSemanticEditPolicy() {
		super(dataMapper.diagram.providers.DataMapperElementTypes.Output_2003);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (dataMapper.diagram.providers.DataMapperElementTypes.TreeNode_3011 == req
				.getElementType()) {
			return getGEFWrapper(new dataMapper.diagram.edit.commands.TreeNode3CreateCommand(req));
		}
