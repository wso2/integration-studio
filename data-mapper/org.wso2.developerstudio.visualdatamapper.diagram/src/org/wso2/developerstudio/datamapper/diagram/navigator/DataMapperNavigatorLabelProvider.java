 ...
 * @generated
 */
public class DataMapperNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider, ITreePathLabelProvider {

	/**
	 * @generated
	 */
	static {
		DataMapperDiagramEditorPlugin.getInstance().getImageRegistry().put("Navigator?UnknownElement", ImageDescriptor.getMissingImageDescriptor()); //$NON-NLS-1$
		DataMapperDiagramEditorPlugin.getInstance().getImageRegistry().put("Navigator?ImageNotFound", ImageDescriptor.getMissingImageDescriptor()); //$NON-NLS-1$
	}
	...
	public Image getImage(View view) {
		switch (DataMapperVisualIDRegistry.getVisualID(view)) {
			case DataMapperRootEditPart.VISUAL_ID :
				return getImage("Navigator?Diagram?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?DataMapperRoot", DataMapperElementTypes.DataMapperRoot_1000); //$NON-NLS-1$
			case InputEditPart.VISUAL_ID :
				return getImage("Navigator?TopLevelNode?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?Input", DataMapperElementTypes.Input_2002); //$NON-NLS-1$
			case OutputEditPart.VISUAL_ID :
				return getImage("Navigator?TopLevelNode?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?Output", DataMapperElementTypes.Output_2003); //$NON-NLS-1$
			case EqualEditPart.VISUAL_ID :
				return getImage("Navigator?TopLevelNode?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?Equal", DataMapperElementTypes.Equal_2005); //$NON-NLS-1$
			case ConcatEditPart.VISUAL_ID :
				return getImage("Navigator?TopLevelNode?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?Concat", DataMapperElementTypes.Concat_2006); //$NON-NLS-1$
			case SplitEditPart.VISUAL_ID :
				return getImage("Navigator?TopLevelNode?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?Split", DataMapperElementTypes.Split_2007); //$NON-NLS-1$
			case ConstantEditPart.VISUAL_ID :
				return getImage("Navigator?TopLevelNode?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?Constant", DataMapperElementTypes.Constant_2008); //$NON-NLS-1$
			case LowerCaseEditPart.VISUAL_ID :
				return getImage("Navigator?TopLevelNode?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?LowerCase", DataMapperElementTypes.LowerCase_2009); //$NON-NLS-1$
			case ContainsEditPart.VISUAL_ID :
				return getImage("Navigator?TopLevelNode?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?Contains", DataMapperElementTypes.Contains_2010); //$NON-NLS-1$
			case UpperCaseEditPart.VISUAL_ID :
				return getImage("Navigator?TopLevelNode?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?UpperCase", DataMapperElementTypes.UpperCase_2011); //$NON-NLS-1$
			case TreeNodeEditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?TreeNode", DataMapperElementTypes.TreeNode_3002); //$NON-NLS-1$
			case TreeNode2EditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?TreeNode", DataMapperElementTypes.TreeNode_3003); //$NON-NLS-1$
			case AttributeEditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?Attribute", DataMapperElementTypes.Attribute_3004); //$NON-NLS-1$
			case InNodeEditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?InNode", DataMapperElementTypes.InNode_3005); //$NON-NLS-1$
			case OutNodeEditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?OutNode", DataMapperElementTypes.OutNode_3006); //$NON-NLS-1$
			case ElementEditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?Element", DataMapperElementTypes.Element_3007); //$NON-NLS-1$
			case InNode2EditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?InNode", DataMapperElementTypes.InNode_3008); //$NON-NLS-1$
			case OutNode2EditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?OutNode", DataMapperElementTypes.OutNode_3009); //$NON-NLS-1$
			case TreeNode3EditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?TreeNode", DataMapperElementTypes.TreeNode_3011); //$NON-NLS-1$
			case OperatorBasicContainerEditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?OperatorBasicContainer", DataMapperElementTypes.OperatorBasicContainer_3012); //$NON-NLS-1$
			case OperatorLeftContainerEditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?OperatorLeftContainer", DataMapperElementTypes.OperatorLeftContainer_3013); //$NON-NLS-1$
			case OperatorLeftConnectorEditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?OperatorLeftConnector", DataMapperElementTypes.OperatorLeftConnector_3014); //$NON-NLS-1$
			case InNode3EditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?InNode", DataMapperElementTypes.InNode_3015); //$NON-NLS-1$
			case OperatorRightContainerEditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?OperatorRightContainer", DataMapperElementTypes.OperatorRightContainer_3016); //$NON-NLS-1$
			case OperatorRightConnectorEditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?OperatorRightConnector", DataMapperElementTypes.OperatorRightConnector_3017); //$NON-NLS-1$
			case OutNode3EditPart.VISUAL_ID :
				return getImage("Navigator?Node?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?OutNode", DataMapperElementTypes.OutNode_3018); //$NON-NLS-1$
			case DataMapperLinkEditPart.VISUAL_ID :
				return getImage("Navigator?Link?http:///org/wso2/developerstudio/eclipse/gmf/datamapper?DataMapperLink", DataMapperElementTypes.DataMapperLink_4001); //$NON-NLS-1$
		}
	...
	private String getAttribute_3004Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DataMapperDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 3004); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getTreeNode_3003Text(View view) {
		TreeNode domainModelElement = (TreeNode) view.getElement();
		if (domainModelElement != null) {
			return domainModelElement.getName();
		} else {
			DataMapperDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 3003); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getTreeNode_3002Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DataMapperDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 3002); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getElement_3007Text(View view) {
		Element domainModelElement = (Element) view.getElement();
		if (domainModelElement != null) {
			return domainModelElement.getName();
		} else {
			DataMapperDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 3007); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getTreeNode_3011Text(View view) {
		...
		if (domainModelElement != null) {
			...
			DataMapperDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 3011); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
