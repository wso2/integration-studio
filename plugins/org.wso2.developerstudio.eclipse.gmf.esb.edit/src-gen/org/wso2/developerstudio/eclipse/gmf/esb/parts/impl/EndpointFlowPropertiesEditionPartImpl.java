 ...
 * 
 */
public class EndpointFlowPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, EndpointFlowPropertiesEditionPart {
    ...
    protected Composite createChildrenAdvancedTableComposition(Composite parent) {
                ...
                EsbMessages.EndpointFlowPropertiesEditionPart_ChildrenLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(EndpointFlowPropertiesEditionPartImpl.this,
        ...
        this.children.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EndpointFlow.Properties.children, EsbViewsRepository.SWT_KIND));
