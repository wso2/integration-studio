 ...
 * 
 */
public class ForEachMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ForEachMediatorPropertiesEditionPart {
     ...
     */
    public ForEachMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = forEachMediatorStep
                .addStep(EsbViewsRepository.ForEachMediator.Properties.class);
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.ForEachMediator.Properties.description,
                EsbMessages.ForEachMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.ForEachMediator.Properties.description, PropertiesEditionEvent.COMMIT,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ForEachMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ForEachMediator.Properties.commentsList,
                        EsbMessages.ForEachMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "ForEachMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ForEachMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ForEachMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.ForEachMediator.Properties.reverse,
                        EsbMessages.ForEachMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ForEachMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ForEachMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createForEachIDText(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.ForEachMediator.Properties.forEachID,
                EsbMessages.ForEachMediatorPropertiesEditionPart_ForEachIDLabel);
        ...
        forEachID.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ForEachMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ForEachMediator.Properties.forEachID, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, forEachID.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ForEachMediatorPropertiesEditionPartForm.this,
        ...
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachMediator.Properties.forEachID, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSequenceGroup(FormToolkit widgetFactory, final Composite parent) {
        Section sequenceSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
    ...
    protected Composite createSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.ForEachMediator.Sequence.sequenceType,
                EsbMessages.ForEachMediatorPropertiesEditionPart_SequenceTypeLabel);
        ...
        sequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ForEachMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ForEachMediator.Sequence.sequenceType, PropertiesEditionEvent.COMMIT,
        ...
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachMediator.Sequence.sequenceType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createSequenceNameText(FormToolkit widgetFactory, Composite parent) {
        Control itemLabel = createDescription(parent, EsbViewsRepository.ForEachMediator.Sequence.sequenceName,
                EsbMessages.ForEachMediatorPropertiesEditionPart_SequenceNameLabel);
        ...
        sequenceName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ForEachMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.ForEachMediator.Sequence.sequenceName, PropertiesEditionEvent.COMMIT,
        ...
        Control itemHelp = FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ForEachMediator.Sequence.sequenceName, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachMediatorPropertiesEditionPart#getDescription()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachMediatorPropertiesEditionPart#getCommentsList()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachMediatorPropertiesEditionPart#getReverse()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachMediatorPropertiesEditionPart#getForEachID()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachMediatorPropertiesEditionPart#setForEachID(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachMediatorPropertiesEditionPart#getSequenceType()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachMediatorPropertiesEditionPart#initSequenceType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachMediatorPropertiesEditionPart#setSequenceType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachMediatorPropertiesEditionPart#getSequenceName()
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.ForEachMediatorPropertiesEditionPart#setSequenceName(String
     *      newValue)
     * 
     */
    ...
    protected Composite createsequenceKeyWidget(FormToolkit widgetFactory, Composite parent) {
        Control sequenceKeyLabel = createDescription(parent, EsbViewsRepository.ForEachMediator.Sequence.sequenceKey,
                EsbMessages.ForEachMediatorPropertiesEditionPart_SequenceKeyLabel);
        widgetFactory.paintBordersFor(parent);
        if (sequenceKey == null) {
        ...
        Control sequenceKeyHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.ForEachMediator.Sequence.sequenceKey, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createForEachExpressionWidget(FormToolkit widgetFactory, final Composite parent) {
        Control forEachExpressionLabel = createDescription(parent,
                EsbViewsRepository.ForEachMediator.Properties.forEachExpression,
                EsbMessages.ForEachMediatorPropertiesEditionPart_ForEachExpressionLabel);
        widgetFactory.paintBordersFor(parent);
        if (forEachExpression == null) {
            forEachExpression = EsbFactoryImpl.eINSTANCE.createNamespacedProperty();
        }
        String initValueExpression = forEachExpression.getPropertyValue().isEmpty() ? ""
                : forEachExpression.getPropertyValue();
        ...
        Control forEachExpressionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.ForEachMediator.Properties.forEachExpression, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        forEachExpressionElements = new Control[] { forEachExpressionLabel, forEachExpressionText,
                forEachExpressionHelp };
        return parent;
    }
