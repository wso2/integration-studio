...
public class RuleMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public RuleMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject ruleMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.RuleMediator.Misc.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, ruleMediator.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.RuleMediator.RuleSet.ruleSetURL))
                basePart.setRuleSetURL(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, ruleMediator.getRuleSetURL()));

            if (isAccessible(EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceType)) {
                basePart.initRuleSetSourceType(
                        EEFUtils.choiceOfValues(ruleMediator, EsbPackage.eINSTANCE.getRuleMediator_RuleSetSourceType()),
                        ruleMediator.getRuleSetSourceType());
            }
            if (isAccessible(EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceCode))
                basePart.setRuleSetSourceCode(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        ruleMediator.getRuleSetSourceCode()));
            ...
            if (isAccessible(EsbViewsRepository.RuleMediator.Misc.ruleSessionProperties)) {
                ruleSessionPropertiesSettings = new ReferencesTableSettings(ruleMediator,
            ...
            if (isAccessible(EsbViewsRepository.RuleMediator.Source.sourceValue))
                basePart.setSourceValue(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, ruleMediator.getSourceValue()));

            if (isAccessible(EsbViewsRepository.RuleMediator.Target.targetValue))
                basePart.setTargetValue(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, ruleMediator.getTargetValue()));

            if (isAccessible(EsbViewsRepository.RuleMediator.Target.targetAction)) {
                basePart.initTargetAction(
                        EEFUtils.choiceOfValues(ruleMediator, EsbPackage.eINSTANCE.getRuleMediator_TargetAction()),
                        ruleMediator.getTargetAction());
            }
            if (isAccessible(EsbViewsRepository.RuleMediator.InputFacts.inputWrapperName))
                basePart.setInputWrapperName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        ruleMediator.getInputWrapperName()));

            if (isAccessible(EsbViewsRepository.RuleMediator.InputFacts.inputNameSpace))
                basePart.setInputNameSpace(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        ruleMediator.getInputNameSpace()));

            if (isAccessible(EsbViewsRepository.RuleMediator.OutputFacts.outputWrapperName))
                basePart.setOutputWrapperName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        ruleMediator.getOutputWrapperName()));

            if (isAccessible(EsbViewsRepository.RuleMediator.OutputFacts.outputNameSpace))
                basePart.setOutputNameSpace(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        ruleMediator.getOutputNameSpace()));

            if (isAccessible(EsbViewsRepository.RuleMediator.RuleSet.ruleSetType)) {
                basePart.initRuleSetType(
                        EEFUtils.choiceOfValues(ruleMediator, EsbPackage.eINSTANCE.getRuleMediator_RuleSetType()),
                        ruleMediator.getRuleSetType());
            }
                ...
                basePart.addFilterToRuleSessionProperties(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof RuleSessionProperty);
                    }
            ...
            if (isAccessible(EsbViewsRepository.RuleMediator.InputFacts.ruleFactsConfiguration)) {
                basePart.addFilterToRuleFactsConfiguration(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof RuleFactsConfiguration);
                    }
            ...
            if (isAccessible(EsbViewsRepository.RuleMediator.OutputFacts.ruleResultsConfiguration)) {
                basePart.addFilterToRuleResultsConfiguration(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof RuleResultsConfiguration);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.RuleMediator.Misc.description == event.getAffectedEditor()) {
            ruleMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.RuleMediator.RuleSet.ruleSetURL == event.getAffectedEditor()) {
            ruleMediator.setRuleSetURL((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceCode == event.getAffectedEditor()) {
            ruleMediator.setRuleSetSourceCode((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.RuleMediator.Misc.ruleSessionProperties == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, ruleSessionPropertiesSettings, editingContext.getAdapterFactory());
        ...
        if (EsbViewsRepository.RuleMediator.Source.sourceValue == event.getAffectedEditor()) {
            ruleMediator.setSourceValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.RuleMediator.Target.targetValue == event.getAffectedEditor()) {
            ruleMediator.setTargetValue((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.RuleMediator.InputFacts.inputWrapperName == event.getAffectedEditor()) {
            ruleMediator.setInputWrapperName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.RuleMediator.InputFacts.inputNameSpace == event.getAffectedEditor()) {
            ruleMediator.setInputNameSpace((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.RuleMediator.OutputFacts.outputWrapperName == event.getAffectedEditor()) {
            ruleMediator.setOutputWrapperName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.RuleMediator.OutputFacts.outputNameSpace == event.getAffectedEditor()) {
            ruleMediator.setOutputNameSpace((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.RuleMediator.InputFacts.ruleFactsConfiguration == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, ruleFactsConfigurationSettings, editingContext.getAdapterFactory());
                PropertiesEditingProvider provider = (PropertiesEditingProvider) editingContext.getAdapterFactory()
                        .adapt(semanticObject, PropertiesEditingProvider.class);
                if (provider != null) {
                    PropertiesEditingPolicy policy = provider.getPolicy(context);
        ...
        if (EsbViewsRepository.RuleMediator.OutputFacts.ruleResultsConfiguration == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext,
                        this, ruleResultsConfigurationSettings, editingContext.getAdapterFactory());
                PropertiesEditingProvider provider = (PropertiesEditingProvider) editingContext.getAdapterFactory()
                        .adapt(semanticObject, PropertiesEditingProvider.class);
                if (provider != null) {
                    PropertiesEditingPolicy policy = provider.getPolicy(context);
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.RuleMediator.Misc.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.Misc.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.Misc.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getRuleMediator_RuleSetURL().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.RuleSet.ruleSetURL)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRuleMediator_RuleSetSourceType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceType))
                basePart.setRuleSetSourceType((RuleSourceType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getRuleMediator_RuleSetSourceCode().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceCode)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRuleMediator_StatefulSession().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.Misc.statefulSession))
                basePart.setStatefulSession((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getRuleMediator_RuleSessionProperties().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.RuleMediator.Misc.ruleSessionProperties))
                basePart.updateRuleSessionProperties();
            if (EsbPackage.eINSTANCE.getRuleMediator_SourceValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.Source.sourceValue)) {
                if (msg.getNewValue() != null) {
                    basePart.setSourceValue(
                            EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, msg.getNewValue()));
                } else {
            ...
            if (EsbPackage.eINSTANCE.getRuleMediator_TargetValue().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.Target.targetValue)) {
                if (msg.getNewValue() != null) {
                    basePart.setTargetValue(
                            EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, msg.getNewValue()));
                } else {
            ...
            if (EsbPackage.eINSTANCE.getRuleMediator_TargetAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.RuleMediator.Target.targetAction))
                basePart.setTargetAction((RuleActions) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getRuleMediator_InputWrapperName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.InputFacts.inputWrapperName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRuleMediator_InputNameSpace().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.InputFacts.inputNameSpace)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRuleMediator_OutputWrapperName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.OutputFacts.outputWrapperName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRuleMediator_OutputNameSpace().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.OutputFacts.outputNameSpace)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRuleMediator_RuleSetType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.RuleMediator.RuleSet.ruleSetType))
                basePart.setRuleSetType((RuleType) msg.getNewValue());

            // Start of user code for ruleSetSourceKey live update
            if (EsbPackage.eINSTANCE.getRuleMediator_RuleSetSourceKey().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceKey)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRuleMediator_TargetResultXpath().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.Target.targetResultXPath)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRuleMediator_TargetXpath().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.Target.targetXPath)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRuleMediator_SourceXpath().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.RuleMediator.Source.sourceXPath)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getRuleMediator_FactsConfiguration().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.RuleMediator.InputFacts.ruleFactsConfiguration))
                basePart.updateRuleFactsConfiguration();
            if (EsbPackage.eINSTANCE.getRuleMediator_ResultsConfiguration().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.RuleMediator.OutputFacts.ruleResultsConfiguration))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getRuleMediator_RuleSetURL(),
                ...
                EsbPackage.eINSTANCE.getRuleMediator_RuleSessionProperties(),
                EsbPackage.eINSTANCE.getRuleMediator_SourceValue(), EsbPackage.eINSTANCE.getRuleMediator_TargetValue(),
                ...
                EsbPackage.eINSTANCE.getRuleMediator_TargetXpath(), EsbPackage.eINSTANCE.getRuleMediator_SourceXpath(),
                EsbPackage.eINSTANCE.getRuleMediator_FactsConfiguration(),
                EsbPackage.eINSTANCE.getRuleMediator_ResultsConfiguration());
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.RuleMediator.RuleSet.ruleSetURL == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleMediator_RuleSetURL().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getRuleMediator_RuleSetURL().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleMediator_RuleSetSourceType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRuleMediator_RuleSetSourceType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleMediator.RuleSet.ruleSetSourceCode == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleMediator_RuleSetSourceCode().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRuleMediator_RuleSetSourceCode().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleMediator.Misc.statefulSession == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleMediator_StatefulSession().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRuleMediator_StatefulSession().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleMediator.Source.sourceValue == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleMediator_SourceValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getRuleMediator_SourceValue().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleMediator.Target.targetValue == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleMediator_TargetValue().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getRuleMediator_TargetValue().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleMediator.Target.targetAction == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleMediator_TargetAction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRuleMediator_TargetAction().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleMediator.InputFacts.inputWrapperName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleMediator_InputWrapperName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRuleMediator_InputWrapperName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleMediator.InputFacts.inputNameSpace == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleMediator_InputNameSpace().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRuleMediator_InputNameSpace().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleMediator.OutputFacts.outputWrapperName == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleMediator_OutputWrapperName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRuleMediator_OutputWrapperName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleMediator.OutputFacts.outputNameSpace == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleMediator_OutputNameSpace().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getRuleMediator_OutputNameSpace().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.RuleMediator.RuleSet.ruleSetType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getRuleMediator_RuleSetType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getRuleMediator_RuleSetType().getEAttributeType(), newValue);
                }
