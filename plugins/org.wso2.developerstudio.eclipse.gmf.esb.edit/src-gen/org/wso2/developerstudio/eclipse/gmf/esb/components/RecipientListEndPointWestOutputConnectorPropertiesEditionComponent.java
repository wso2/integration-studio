 ...
 * 
 */
public class RecipientListEndPointWestOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public RecipientListEndPointWestOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject recipientListEndPointWestOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.RecipientListEndPointWestOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(recipientListEndPointWestOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.RecipientListEndPointWestOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
