...
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigureStartsWithOperatorDialog;

public class StartsWithConfigureAction extends AbstractActionHandler {
	 ...
	 */
	public StartsWithConfigureAction(IWorkbenchPart part) {
		super(part);
		setId(Messages.StartsWithConfigureAction_ActionID);
		setText(Messages.StartsWithConfigureAction_ActionText);
		setToolTipText(Messages.StartsWithConfigureAction_ToolTip);
	...
	protected void doRun(IProgressMonitor progressMonitor) {
		...
		Dialog configureConstantDialog = new ConfigureStartsWithOperatorDialog(Display.getDefault().getActiveShell(),
				(StartsWith) selectedObj, getEditingDomain(),selectedEP);
