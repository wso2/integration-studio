...
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.TemplateEndpointCanonicalEditPolicy;
import org.wso2.integrationstudio.eclipse.gmf.esb.diagram.edit.policies.TemplateEndpointItemSemanticEditPolicy;
...
public class TemplateEndpointEditPart extends AbstractEndpoint {
    ...
    protected IFigure createNodeShape() {
        return primaryShape = new TemplateEndpointFigure(new Color(null, 255, 255, 255)) {
    ...
    public class TemplateEndpointFigure extends EsbGraphicalShapeWithLabel {
        ...
        public String getIconPath() {
            return "icons/ico20/template-endpoint.png";
        }
