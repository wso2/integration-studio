...
public class CommandPropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public CommandPropertyPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject commandProperty,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.CommandProperty.Properties.propertyName))
                basePart.setPropertyName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        commandProperty.getPropertyName()));

            if (isAccessible(EsbViewsRepository.CommandProperty.Properties.valueType)) {
                basePart.initValueType(
                        EEFUtils.choiceOfValues(commandProperty, EsbPackage.eINSTANCE.getCommandProperty_ValueType()),
                        commandProperty.getValueType());
            }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.CommandProperty.Properties.propertyName == event.getAffectedEditor()) {
            commandProperty.setPropertyName((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.CommandProperty.Properties.valueLiteral == event.getAffectedEditor()) {
            commandProperty.setValueLiteral((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.CommandProperty.Properties.valueContextPropertyName == event.getAffectedEditor()) {
            commandProperty.setValueContextPropertyName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getCommandProperty_PropertyName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CommandProperty.Properties.propertyName)) {
            ...
            if (EsbPackage.eINSTANCE.getCommandProperty_ValueType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.CommandProperty.Properties.valueType))
                basePart.setValueType((CommandPropertyValueType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCommandProperty_ValueLiteral().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CommandProperty.Properties.valueLiteral)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCommandProperty_ValueContextPropertyName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.CommandProperty.Properties.valueContextPropertyName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getCommandProperty_ContextAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.CommandProperty.Properties.contextAction))
                basePart.setContextAction((CommandPropertyContextAction) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getCommandProperty_MessageAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.CommandProperty.Properties.messageAction))
            ...
            if (EsbPackage.eINSTANCE.getCommandProperty_ValueMessageElementXpath().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
        ...
        if (event.getNewValue() != null) {
            try {
                if (EsbViewsRepository.CommandProperty.Properties.propertyName == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCommandProperty_PropertyName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCommandProperty_PropertyName().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CommandProperty.Properties.valueType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCommandProperty_ValueType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCommandProperty_ValueType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CommandProperty.Properties.valueLiteral == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCommandProperty_ValueLiteral().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCommandProperty_ValueLiteral().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CommandProperty.Properties.valueContextPropertyName == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCommandProperty_ValueContextPropertyName().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCommandProperty_ValueContextPropertyName().getEAttributeType(),
                ...
                if (EsbViewsRepository.CommandProperty.Properties.contextAction == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCommandProperty_ContextAction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCommandProperty_ContextAction().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.CommandProperty.Properties.messageAction == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getCommandProperty_MessageAction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getCommandProperty_MessageAction().getEAttributeType(), newValue);
                }
