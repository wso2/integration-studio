 ...
 * 
 */
public class JsonTransformMediatorPropertyPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, JsonTransformMediatorPropertyPropertiesEditionPart {
     ...
     */
    public JsonTransformMediatorPropertyPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        CompositionSequence jsonTransformMediatorPropertyStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        CompositionStep propertiesStep = jsonTransformMediatorPropertyStep
                .addStep(EsbViewsRepository.JsonTransformMediatorProperty.Properties.class);
    ...
    protected Composite createPropertyNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyName,
                EsbMessages.JsonTransformMediatorPropertyPropertiesEditionPart_PropertyNameLabel);
        ...
        propertyName.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(JsonTransformMediatorPropertyPropertiesEditionPartForm.this,
                                    EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyName,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            JsonTransformMediatorPropertyPropertiesEditionPartForm.this, null,
    ...
    protected Composite createPropertyValueText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.JsonTransformMediatorProperty.Properties.propertyValue,
                EsbMessages.JsonTransformMediatorPropertyPropertiesEditionPart_PropertyValueLabel);
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.JsonTransformMediatorPropertyPropertiesEditionPart#setPropertyName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.JsonTransformMediatorPropertyPropertiesEditionPart#setPropertyValue(String
     *      newValue)
     * 
     */
