 ...
 * 
 */
public class URLRewriteRuleActionPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, URLRewriteRuleActionPropertiesEditionPart {
     ...
     */
    public URLRewriteRuleActionPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createRuleActionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.URLRewriteRuleAction.Properties.ruleAction,
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(URLRewriteRuleActionPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.URLRewriteRuleAction.Properties.ruleAction, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRuleFragmentEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.URLRewriteRuleAction.Properties.ruleFragment,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.URLRewriteRuleAction.Properties.ruleFragment, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createRuleOptionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.URLRewriteRuleAction.Properties.ruleOption,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.URLRewriteRuleAction.Properties.ruleOption, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createActionValueText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.URLRewriteRuleAction.Properties.actionValue,
        ...
        actionValue.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            URLRewriteRuleActionPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.URLRewriteRuleAction.Properties.actionValue, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createActionRegexText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.URLRewriteRuleAction.Properties.actionRegex,
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.URLRewriteRuleAction.Properties.actionRegex, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
