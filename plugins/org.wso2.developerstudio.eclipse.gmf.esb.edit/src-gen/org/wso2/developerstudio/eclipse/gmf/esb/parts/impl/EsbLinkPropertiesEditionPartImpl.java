 ...
 * 
 */
public class EsbLinkPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, EsbLinkPropertiesEditionPart {
    ...
    protected Composite createSourceFlatComboViewer(Composite parent) {
        ...
        source = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
                .isRequired(EsbViewsRepository.EsbLink.Properties.source, EsbViewsRepository.SWT_KIND));
        ...
        source.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        EsbLinkPropertiesEditionPartImpl.this, EsbViewsRepository.EsbLink.Properties.source,
                        PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getSource()));
            }
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EsbLink.Properties.source, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTargetFlatComboViewer(Composite parent) {
        ...
        target = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
                .isRequired(EsbViewsRepository.EsbLink.Properties.target, EsbViewsRepository.SWT_KIND));
        ...
        target.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        EsbLinkPropertiesEditionPartImpl.this, EsbViewsRepository.EsbLink.Properties.target,
                        PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getTarget()));
            }
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.EsbLink.Properties.target, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
