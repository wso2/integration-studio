 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfProxyInputConnectorEditPart extends
	...
	public List<IElementType> doGetRelTypesOnTarget(
			ProxyInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(ProxyInputConnectorEditPart) targetEditPart, relationshipType);
	}
	...
	public List<IElementType> doGetTypesForSource(
			ProxyInputConnectorEditPart target, IElementType relationshipType) {
