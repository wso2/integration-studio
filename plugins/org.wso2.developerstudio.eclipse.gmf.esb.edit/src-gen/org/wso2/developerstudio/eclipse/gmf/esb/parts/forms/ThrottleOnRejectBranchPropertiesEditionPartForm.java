 ...
 * 
 */
public class ThrottleOnRejectBranchPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ThrottleOnRejectBranchPropertiesEditionPart {
     ...
     */
    public ThrottleOnRejectBranchPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ThrottleOnRejectBranchPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ThrottleOnRejectBranch.Properties.sequenceType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
