...
public class EndPointPropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public EndPointPropertyPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject endPointProperty,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.EndPointProperty.Properties.name))
                basePart.setName(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, endPointProperty.getName()));

            if (isAccessible(EsbViewsRepository.EndPointProperty.Properties.value))
                basePart.setValue(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, endPointProperty.getValue()));

            if (isAccessible(EsbViewsRepository.EndPointProperty.Properties.scope)) {
                basePart.initScope(
                        EEFUtils.choiceOfValues(endPointProperty, EsbPackage.eINSTANCE.getEndPointProperty_Scope()),
                        endPointProperty.getScope());
            }
            if (isAccessible(EsbViewsRepository.EndPointProperty.Properties.valueType)) {
                basePart.initValueType(
                        EEFUtils.choiceOfValues(endPointProperty, EsbPackage.eINSTANCE.getEndPointProperty_ValueType()),
                        endPointProperty.getValueType());
            }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.EndPointProperty.Properties.name == event.getAffectedEditor()) {
            endPointProperty.setName((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.EndPointProperty.Properties.value == event.getAffectedEditor()) {
            endPointProperty.setValue((java.lang.String) EEFConverterUtil
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEndPointProperty_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EndPointProperty.Properties.name)) {
            ...
            if (EsbPackage.eINSTANCE.getEndPointProperty_Value().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.EndPointProperty.Properties.value)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEndPointProperty_Scope().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.EndPointProperty.Properties.scope))
                basePart.setScope((EndPointPropertyScope) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getEndPointProperty_ValueType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.EndPointProperty.Properties.valueType))
                basePart.setValueType((PropertyValueType) msg.getNewValue());

            // Start of user code for valueExpression live update
            if (EsbPackage.eINSTANCE.getEndPointProperty_ValueExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                EsbPackage.eINSTANCE.getEndPointProperty_Name(), EsbPackage.eINSTANCE.getEndPointProperty_Value(),
                EsbPackage.eINSTANCE.getEndPointProperty_Scope(), EsbPackage.eINSTANCE.getEndPointProperty_ValueType(),
    ...
    public boolean isRequired(Object key, int kind) {
        return key == EsbViewsRepository.EndPointProperty.Properties.name
                || key == EsbViewsRepository.EndPointProperty.Properties.value
                || key == EsbViewsRepository.EndPointProperty.Properties.scope;
    }
                ...
                if (EsbViewsRepository.EndPointProperty.Properties.name == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEndPointProperty_Name().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getEndPointProperty_Name().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EndPointProperty.Properties.value == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEndPointProperty_Value().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getEndPointProperty_Value().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EndPointProperty.Properties.scope == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEndPointProperty_Scope().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getEndPointProperty_Scope().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.EndPointProperty.Properties.valueType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getEndPointProperty_ValueType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getEndPointProperty_ValueType().getEAttributeType(), newValue);
                }
