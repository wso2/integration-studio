...
import org.wso2.integrationstudio.eclipse.gmf.esb.parts.ProxyOutSequenceOutputConnectorPropertiesEditionPart;
 ...
 * 
 */
public class ProxyOutSequenceOutputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ProxyOutSequenceOutputConnectorPropertiesEditionPart {
	 ...
	 * 
	 */
	public ProxyOutSequenceOutputConnectorPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(EsbMessages.ProxyOutSequenceOutputConnectorPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createCommentMediatorsAdvancedTableComposition(Composite parent) {
		this.commentMediators = new ReferencesTable(getDescription(EsbViewsRepository.ProxyOutSequenceOutputConnector.Properties.commentMediators, EsbMessages.ProxyOutSequenceOutputConnectorPropertiesEditionPart_CommentMediatorsLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProxyOutSequenceOutputConnectorPropertiesEditionPartImpl.this, EsbViewsRepository.ProxyOutSequenceOutputConnector.Properties.commentMediators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				commentMediators.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProxyOutSequenceOutputConnectorPropertiesEditionPartImpl.this, EsbViewsRepository.ProxyOutSequenceOutputConnector.Properties.commentMediators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				commentMediators.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProxyOutSequenceOutputConnectorPropertiesEditionPartImpl.this, EsbViewsRepository.ProxyOutSequenceOutputConnector.Properties.commentMediators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				commentMediators.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProxyOutSequenceOutputConnectorPropertiesEditionPartImpl.this, EsbViewsRepository.ProxyOutSequenceOutputConnector.Properties.commentMediators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				commentMediators.refresh();
			}
		...
		this.commentMediators.setHelpText(propertiesEditionComponent.getHelpContent(EsbViewsRepository.ProxyOutSequenceOutputConnector.Properties.commentMediators, EsbViewsRepository.SWT_KIND));
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.ProxyOutSequenceOutputConnectorPropertiesEditionPart#initCommentMediators(EObject current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.ProxyOutSequenceOutputConnectorPropertiesEditionPart#updateCommentMediators()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.ProxyOutSequenceOutputConnectorPropertiesEditionPart#addFilterCommentMediators(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.ProxyOutSequenceOutputConnectorPropertiesEditionPart#addBusinessFilterCommentMediators(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.wso2.integrationstudio.eclipse.gmf.esb.parts.ProxyOutSequenceOutputConnectorPropertiesEditionPart#isContainedInCommentMediatorsTable(EObject element)
	 * 
	 */
