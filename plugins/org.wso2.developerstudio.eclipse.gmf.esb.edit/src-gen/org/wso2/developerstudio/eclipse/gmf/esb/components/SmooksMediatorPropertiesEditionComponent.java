...
public class SmooksMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public SmooksMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject smooksMediator,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.SmooksMediator.Input.inputType)) {
                basePart.initInputType(
                        EEFUtils.choiceOfValues(smooksMediator, EsbPackage.eINSTANCE.getSmooksMediator_InputType()),
                        smooksMediator.getInputType());
            }
            if (isAccessible(EsbViewsRepository.SmooksMediator.Output.outputType)) {
                basePart.initOutputType(
                        EEFUtils.choiceOfValues(smooksMediator, EsbPackage.eINSTANCE.getSmooksMediator_OutputType()),
                        smooksMediator.getOutputType());
            }
            if (isAccessible(EsbViewsRepository.SmooksMediator.Output.outputProperty))
                basePart.setOutputProperty(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        smooksMediator.getOutputProperty()));

            if (isAccessible(EsbViewsRepository.SmooksMediator.Output.outputAction)) {
                basePart.initOutputAction(
                        EEFUtils.choiceOfValues(smooksMediator, EsbPackage.eINSTANCE.getSmooksMediator_OutputAction()),
                        smooksMediator.getOutputAction());
            }
            if (isAccessible(EsbViewsRepository.SmooksMediator.Output.outputMethod)) {
                basePart.initOutputMethod(
                        EEFUtils.choiceOfValues(smooksMediator, EsbPackage.eINSTANCE.getSmooksMediator_OutputMethod()),
                        smooksMediator.getOutputMethod());
            }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.SmooksMediator.Misc.description == event.getAffectedEditor()) {
            smooksMediator.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.SmooksMediator.Output.outputProperty == event.getAffectedEditor()) {
            smooksMediator.setOutputProperty((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.SmooksMediator.Misc.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SmooksMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SmooksMediator.Properties.reverse))
                basePart.setReverse((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getSmooksMediator_InputType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.SmooksMediator.Input.inputType))
                basePart.setInputType((SmooksIODataType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getSmooksMediator_OutputType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.SmooksMediator.Output.outputType))
                basePart.setOutputType((SmooksOutputDataType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getSmooksMediator_OutputProperty().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SmooksMediator.Output.outputProperty)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getSmooksMediator_OutputAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.SmooksMediator.Output.outputAction))
                basePart.setOutputAction((ExpressionAction) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getSmooksMediator_OutputMethod().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.SmooksMediator.Output.outputMethod))
                basePart.setOutputMethod((OutputMethod) msg.getNewValue());

            // Start of user code for inputExpression live update
            if (EsbPackage.eINSTANCE.getSmooksMediator_InputExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SmooksMediator.Input.inputExpresssion)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getSmooksMediator_OutputExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SmooksMediator.Output.outputExpression)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getMediator_Reverse(), EsbPackage.eINSTANCE.getSmooksMediator_InputType(),
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.SmooksMediator.Input.inputType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSmooksMediator_InputType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getSmooksMediator_InputType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SmooksMediator.Output.outputType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSmooksMediator_OutputType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getSmooksMediator_OutputType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SmooksMediator.Output.outputProperty == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSmooksMediator_OutputProperty().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getSmooksMediator_OutputProperty().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SmooksMediator.Output.outputAction == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSmooksMediator_OutputAction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getSmooksMediator_OutputAction().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SmooksMediator.Output.outputMethod == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSmooksMediator_OutputMethod().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getSmooksMediator_OutputMethod().getEAttributeType(), newValue);
                }
