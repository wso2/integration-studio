 ...
 * 
 */
public class EnqueueMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, EnqueueMediatorPropertiesEditionPart {
     ...
     */
    public EnqueueMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = enqueueMediatorStep
                .addStep(EsbViewsRepository.EnqueueMediator.Properties.class);
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.EnqueueMediator.Properties.description,
                EsbMessages.EnqueueMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.EnqueueMediator.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(EnqueueMediatorPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EnqueueMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control descriptionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.EnqueueMediator.Properties.description,
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.EnqueueMediator.Properties.commentsList,
                        EsbMessages.EnqueueMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "EnqueueMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EnqueueMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.EnqueueMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.EnqueueMediator.Properties.reverse,
                        EsbMessages.EnqueueMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EnqueueMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.EnqueueMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EnqueueMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createExecutorText(FormToolkit widgetFactory, Composite parent) {
        Control executorLabel = createDescription(parent, EsbViewsRepository.EnqueueMediator.Properties.executor,
                EsbMessages.EnqueueMediatorPropertiesEditionPart_ExecutorLabel);
        ...
        executor.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EnqueueMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.EnqueueMediator.Properties.executor, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, executor.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(EnqueueMediatorPropertiesEditionPartForm.this,
        ...
        Control executorHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.EnqueueMediator.Properties.executor, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createPriorityText(FormToolkit widgetFactory, Composite parent) {
        Control priorityLabel = createDescription(parent, EsbViewsRepository.EnqueueMediator.Properties.priority,
                EsbMessages.EnqueueMediatorPropertiesEditionPart_PriorityLabel);
        ...
        priority.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EnqueueMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.EnqueueMediator.Properties.priority, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, priority.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(EnqueueMediatorPropertiesEditionPartForm.this,
        ...
        Control priorityHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.EnqueueMediator.Properties.priority, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EnqueueMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EnqueueMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EnqueueMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EnqueueMediatorPropertiesEditionPart#setExecutor(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.EnqueueMediatorPropertiesEditionPart#setPriority(String
     *      newValue)
     * 
     */
    ...
    protected Composite createSequenceKey(FormToolkit widgetFactory, final Composite parent) {
            ...
            public void mouseDown(MouseEvent e) {
                ...
                propertiesEditionComponent
                        .firePropertiesChanged(new PropertiesEditionEvent(EnqueueMediatorPropertiesEditionPartForm.this,
                                EsbViewsRepository.EnqueueMediator.Properties.sequenceKey,
        ...
        Control sequenceKeyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.EnqueueMediator.Properties.sequenceKey,
                        EsbViewsRepository.FORM_KIND),
                null);
