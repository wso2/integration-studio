...
public class AggregateMediatorDeserializer extends AbstractEsbNodeDeserializer<AbstractMediator, AggregateMediator> {
    ...
    public AggregateMediator createNode(IGraphicalEditPart part, AbstractMediator mediator)
        ...
        Assert.isTrue(mediator instanceof org.apache.synapse.mediators.eip.aggregator.AggregateMediator,
                "Invalid Mediator.");
        ...
        org.wso2.developerstudio.eclipse.gmf.esb.AggregateMediator visualAggregateMediator = (org.wso2.developerstudio.eclipse.gmf.esb.AggregateMediator) DeserializerUtils
        ...
        executeSetValueCommand(AGGREGATE_MEDIATOR__COMPLETION_TIMEOUT,
                (aggregateMediator.getCompletionTimeoutMillis() / 1000));
        ...
        if (aggregateMediator.getMaxMessagesToComplete() != null) {
            ...
            if (maxMsg.getKeyValue() != null && DeserializerUtils.isInteger(maxMsg.getKeyValue())) {
                ...
                executeSetValueCommand(AGGREGATE_MEDIATOR__COMPLETION_MAX_MESSAGES_VALUE,
                        Integer.parseInt(maxMsg.getKeyValue()));

            } else if (maxMsg.getExpression() != null) {

                // vishualAggrigate.setCompletionMaxMessagesType(CompletionMessagesType.EXPRESSION);
                executeSetValueCommand(AGGREGATE_MEDIATOR__COMPLETION_MAX_MESSAGES_TYPE,
                        CompletionMessagesType.EXPRESSION);
        ...
        if (aggregateMediator.getMinMessagesToComplete() != null) {
            ...
            if (minMsg.getKeyValue() != null && DeserializerUtils.isInteger(minMsg.getKeyValue())) {
                ...
                executeSetValueCommand(AGGREGATE_MEDIATOR__COMPLETION_MIN_MESSAGES_VALUE,
                        Integer.parseInt(minMsg.getKeyValue()));

            } else if (minMsg.getExpression() != null) {

                // vishualAggrigate.setCompletionMinMessagesType(CompletionMessagesType.EXPRESSION);
                executeSetValueCommand(AGGREGATE_MEDIATOR__COMPLETION_MIN_MESSAGES_TYPE,
                        CompletionMessagesType.EXPRESSION);
        ...
        if (aggregateMediator.getOnCompleteSequenceRef() != null) {
            ...
            deserializeSequence((IGraphicalEditPart) mediatorFlow.getChildren().get(0),
                    aggregateMediator.getOnCompleteSequence(), visualAggregateMediator.getOnCompleteOutputConnector());
