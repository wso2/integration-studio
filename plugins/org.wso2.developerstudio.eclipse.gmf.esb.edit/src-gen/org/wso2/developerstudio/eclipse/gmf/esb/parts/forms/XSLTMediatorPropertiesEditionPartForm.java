 ...
 * 
 */
public class XSLTMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, XSLTMediatorPropertiesEditionPart {
     ...
     */
    public XSLTMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        Control descriptionLabel = createDescription(parent, EsbViewsRepository.XSLTMediator.Properties.description,
                EsbMessages.XSLTMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.XSLTMediator.Properties.description, PropertiesEditionEvent.COMMIT,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            XSLTMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        Control descriptionHelp = FormUtils
                .createHelpButton(widgetFactory, parent,
                        propertiesEditionComponent.getHelpContent(
                                EsbViewsRepository.XSLTMediator.Properties.description, EsbViewsRepository.FORM_KIND),
                        null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.XSLTMediator.Properties.commentsList,
                        EsbMessages.XSLTMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "XSLTMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            XSLTMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.XSLTMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent, getDescription(EsbViewsRepository.XSLTMediator.Properties.reverse,
                EsbMessages.XSLTMediatorPropertiesEditionPart_ReverseLabel), SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(XSLTMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.XSLTMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.XSLTMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createXsltSchemaKeyTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        xsltSchemaKeySubsection = EEFPropertyViewUtil.createSubsectionGroup(widgetFactory, parent, "XSLT Schema Key",
                true);
        Control XSLTSchemaTypeLabel = createDescription(xsltSchemaKeySubsection,
                EsbViewsRepository.XSLTMediator.Properties.xsltSchemaKeyType,
                EsbMessages.XSLTMediatorPropertiesEditionPart_XsltSchemaKeyTypeLabel);
        ...
        xsltSchemaKeyType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            XSLTMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.XSLTMediator.Properties.xsltSchemaKeyType, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, getXsltSchemaKeyType()));
            }

        });
        xsltSchemaKeyType.setID(EsbViewsRepository.XSLTMediator.Properties.xsltSchemaKeyType);
        Control XSLTSchemaTypeHelp = FormUtils.createHelpButton(widgetFactory, xsltSchemaKeySubsection,
                propertiesEditionComponent.getHelpContent(EsbViewsRepository.XSLTMediator.Properties.xsltSchemaKeyType,
                        EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
        // Start of user code for createXsltSchemaKeyTypeEMFComboViewer
        XSLTSchemaTypeElements = new Control[] { XSLTSchemaTypeLabel, xsltSchemaKeyType.getCombo(),
                XSLTSchemaTypeHelp };
        xsltSchemaKeyType.addSelectionChangedListener(new ISelectionChangedListener() {
    ...
    protected Composite createPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
        ...
        this.properties = new ReferencesTable(getDescription(EsbViewsRepository.XSLTMediator.Properties.properties_,
                EsbMessages.XSLTMediatorPropertiesEditionPart_PropertiesLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(XSLTMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.XSLTMediator.Properties.properties_,
        ...
        this.properties.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.XSLTMediator.Properties.properties_, EsbViewsRepository.FORM_KIND));
        ...
        this.properties.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            XSLTMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.XSLTMediator.Properties.properties_, PropertiesEditionEvent.CHANGE,
    ...
    protected Composite createFeaturesTableComposition(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        this.features = new ReferencesTable(getDescription(EsbViewsRepository.XSLTMediator.Properties.features,
                EsbMessages.XSLTMediatorPropertiesEditionPart_FeaturesLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(XSLTMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.XSLTMediator.Properties.features,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
                        features.refresh();
                    }
        ...
        this.features.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.XSLTMediator.Properties.features, EsbViewsRepository.FORM_KIND));
        ...
        this.features.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(XSLTMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.XSLTMediator.Properties.features, PropertiesEditionEvent.CHANGE,
                                    PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
    ...
    protected Composite createResourcesTableComposition(FormToolkit widgetFactory, Composite parent) {
        Control[] previousControls = propertiesGroup.getChildren();
        this.resources = new ReferencesTable(getDescription(EsbViewsRepository.XSLTMediator.Properties.resources,
                EsbMessages.XSLTMediatorPropertiesEditionPart_ResourcesLabel), new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(XSLTMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.XSLTMediator.Properties.resources,
                                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
                        resources.refresh();
                    }
        ...
        this.resources.setHelpText(propertiesEditionComponent
                .getHelpContent(EsbViewsRepository.XSLTMediator.Properties.resources, EsbViewsRepository.FORM_KIND));
        ...
        this.resources.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(XSLTMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.XSLTMediator.Properties.resources, PropertiesEditionEvent.CHANGE,
                                    PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
                }
            }
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#initXsltSchemaKeyType(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#setXsltSchemaKeyType(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#initProperties(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#addFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#addBusinessFilterProperties(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#isContainedInPropertiesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#initFeatures(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#addFilterFeatures(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#addBusinessFilterFeatures(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#isContainedInFeaturesTable(EObject
     *      element)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#initResources(EObject
     *      current, EReference containingFeature, EReference feature)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#addFilterResources(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#addBusinessFilterResources(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.XSLTMediatorPropertiesEditionPart#isContainedInResourcesTable(EObject
     *      element)
     * 
     */
    ...
    protected Composite createXSLTStaticSchemaKeyWidget(FormToolkit widgetFactory, Composite parent) {
        ...
        XSLTStaticSchemaKeyText.addMouseListener(new MouseAdapter() {
            ...
            public void mouseDown(MouseEvent event) {
                ...
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        XSLTMediatorPropertiesEditionPartForm.this,
                        EsbViewsRepository.XSLTMediator.Properties.xSLTStaticSchemaKey, PropertiesEditionEvent.COMMIT,
                        PropertiesEditionEvent.SET, null, getXSLTStaticSchemaKey()));
            }
        ...
        Control sequenceKeyHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.XSLTMediator.Properties.xSLTStaticSchemaKey, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createXSLTDynamicSchemaKeyWidget(FormToolkit widgetFactory, final Composite parent) {
        Control expressionPathLabel = createDescription(parent,
                EsbViewsRepository.XSLTMediator.Properties.xSLTDynamicSchemaKey, "XSLT Dynamic Schema Key");
        widgetFactory.paintBordersFor(parent);
        ...
        Control expressionHelp = FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
