...
import static org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.EditPartConstants.DATAMAPPER_MEDIATOR_ICON_PATH;
...
import org.wso2.integrationstudio.gmf.esb.diagram.custom.dialogs.DialogDisplayUtils;
import org.wso2.integrationstudio.gmf.esb.diagram.custom.dialogs.ESBDataMapperConfigurationDialog;
...
import org.wso2.integrationstudio.gmf.esb.diagram.edit.policies.DataMapperMediatorCanonicalEditPolicy;
import org.wso2.integrationstudio.gmf.esb.diagram.edit.policies.DataMapperMediatorItemSemanticEditPolicy;
...
public class DataMapperMediatorEditPart extends FixedSizedAbstractMediator {
    ...
    private Class<?>[] type;
    private static Map<String, IIntegrationStudioElement> importListMap;
     ...
     */
    public static String getConfigurationLocalPath(IIntegrationStudioProviderData[] providerProjectsList,
            Map<String, List<String>> filters, String configName) {
        ...
        for (IIntegrationStudioProviderData data : providerProjectsList) {
            ...
            for (IIntegrationStudioProvider registryProject : registryProjectsList) {
                ...
                for (IIntegrationStudioProvider child : childrenList) {
                    IIntegrationStudioElement childElement = child.getElements(filters)[0];
