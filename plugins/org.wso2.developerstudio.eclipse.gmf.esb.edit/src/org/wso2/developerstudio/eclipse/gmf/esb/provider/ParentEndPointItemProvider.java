...
public class ParentEndPointItemProvider extends EndPointItemProvider {
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_ParentEndPoint_name_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_ParentEndPoint_name_feature",
                                "_UI_ParentEndPoint_type"),
                        EsbPackage.Literals.PARENT_END_POINT__NAME, true, false, false,
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ParentEndPoint_type")
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.PARENT_END_POINT__CHILDREN,
