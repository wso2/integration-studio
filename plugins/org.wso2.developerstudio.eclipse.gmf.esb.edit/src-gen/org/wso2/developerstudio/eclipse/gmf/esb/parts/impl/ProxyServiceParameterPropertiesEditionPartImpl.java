 ...
 * 
 */
public class ProxyServiceParameterPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ProxyServiceParameterPropertiesEditionPart {
    ...
    protected Composite createNameText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ProxyServiceParameterPropertiesEditionPartImpl.this,
                ...
                if (!EEFPropertyViewUtil.isReservedKeyCombination(e)) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                                ProxyServiceParameterPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyServiceParameter.Properties.name, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.ProxyServiceParameter.Properties.value, EsbViewsRepository.SWT_KIND), null); // $NON-NLS-1$
