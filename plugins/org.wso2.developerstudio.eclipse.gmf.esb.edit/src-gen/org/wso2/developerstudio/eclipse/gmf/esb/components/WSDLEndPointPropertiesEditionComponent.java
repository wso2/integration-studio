...
public class WSDLEndPointPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public WSDLEndPointPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject wSDLEndPoint,
            String editing_mode) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.WSDLEndPoint.Misc.description))
                basePart.setDescription(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, wSDLEndPoint.getDescription()));
            ...
            if (isAccessible(EsbViewsRepository.WSDLEndPoint.Misc.properties)) {
                propertiesSettings = new ReferencesTableSettings(wSDLEndPoint,
            ...
            if (isAccessible(EsbViewsRepository.WSDLEndPoint.Qos.addressingVersion)) {
                basePart.initAddressingVersion(
                        EEFUtils.choiceOfValues(wSDLEndPoint,
                                EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingVersion()),
                        wSDLEndPoint.getAddressingVersion());
            }
            ...
            if (isAccessible(EsbViewsRepository.WSDLEndPoint.Timeout.timeOutDuration))
                basePart.setTimeOutDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        wSDLEndPoint.getTimeOutDuration()));

            if (isAccessible(EsbViewsRepository.WSDLEndPoint.Timeout.timeOutAction)) {
                basePart.initTimeOutAction(
                        EEFUtils.choiceOfValues(wSDLEndPoint, EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutAction()),
                        wSDLEndPoint.getTimeOutAction());
            }
            if (isAccessible(EsbViewsRepository.WSDLEndPoint.EndpointTimeoutState.retryErrorCodes))
                basePart.setRetryErrorCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        wSDLEndPoint.getRetryErrorCodes()));

            if (isAccessible(EsbViewsRepository.WSDLEndPoint.EndpointTimeoutState.retryCount)) {
                basePart.setRetryCount(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, wSDLEndPoint.getRetryCount()));
            }

            if (isAccessible(EsbViewsRepository.WSDLEndPoint.EndpointTimeoutState.retryDelay)) {
                basePart.setRetryDelay(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG, wSDLEndPoint.getRetryDelay()));
            }
            ...
            if (isAccessible(EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendErrorCodes))
                basePart.setSuspendErrorCodes(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        wSDLEndPoint.getSuspendErrorCodes()));
            ...
            if (isAccessible(EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendInitialDuration)) {
                basePart.setSuspendInitialDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        wSDLEndPoint.getSuspendInitialDuration()));
            }
            ...
            if (isAccessible(EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendMaximumDuration)) {
                basePart.setSuspendMaximumDuration(EEFConverterUtil.convertToString(EcorePackage.Literals.ELONG,
                        wSDLEndPoint.getSuspendMaximumDuration()));
            }
            ...
            if (isAccessible(EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendProgressionFactor)) {
                basePart.setSuspendProgressionFactor(EEFConverterUtil.convertToString(EcorePackage.Literals.EFLOAT,
                        wSDLEndPoint.getSuspendProgressionFactor()));
            }

            if (isAccessible(EsbViewsRepository.WSDLEndPoint.Basic.format)) {
                basePart.initFormat(
                        EEFUtils.choiceOfValues(wSDLEndPoint, EsbPackage.eINSTANCE.getAbstractEndPoint_Format()),
                        wSDLEndPoint.getFormat());
            }
            if (isAccessible(EsbViewsRepository.WSDLEndPoint.Misc.optimize)) {
                basePart.initOptimize(
                        EEFUtils.choiceOfValues(wSDLEndPoint, EsbPackage.eINSTANCE.getAbstractEndPoint_Optimize()),
                        wSDLEndPoint.getOptimize());
            }
            if (isAccessible(EsbViewsRepository.WSDLEndPoint.Properties.templateParameters)) {
                templateParametersSettings = new ReferencesTableSettings(wSDLEndPoint,
            ...
            if (isAccessible(EsbViewsRepository.WSDLEndPoint.Misc.wsdlUri))
                basePart.setWsdlUri(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, wSDLEndPoint.getWsdlUri()));

            if (isAccessible(EsbViewsRepository.WSDLEndPoint.Misc.service))
                basePart.setService(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, wSDLEndPoint.getService()));

            if (isAccessible(EsbViewsRepository.WSDLEndPoint.Misc.port))
                basePart.setPort(
                        EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, wSDLEndPoint.getPort()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.WSDLEndPoint.Misc.description == event.getAffectedEditor()) {
            wSDLEndPoint.setDescription((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.WSDLEndPoint.Properties.endPointName == event.getAffectedEditor()) {
            wSDLEndPoint.setEndPointName((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.WSDLEndPoint.Timeout.timeOutDuration == event.getAffectedEditor()) {
            wSDLEndPoint.setTimeOutDuration((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendErrorCodes == event.getAffectedEditor()) {
            wSDLEndPoint.setSuspendErrorCodes((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendInitialDuration == event.getAffectedEditor()) {
            wSDLEndPoint.setSuspendInitialDuration((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        if (EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendMaximumDuration == event.getAffectedEditor()) {
            wSDLEndPoint.setSuspendMaximumDuration(
                    (EEFConverterUtil.createLongFromString(EcorePackage.Literals.ELONG, (String) event.getNewValue())));
        }
        if (EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendProgressionFactor == event
                .getAffectedEditor()) {
            wSDLEndPoint.setSuspendProgressionFactor((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.WSDLEndPoint.Misc.wsdlUri == event.getAffectedEditor()) {
            wSDLEndPoint.setWsdlUri((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.WSDLEndPoint.Misc.service == event.getAffectedEditor()) {
            wSDLEndPoint.setService((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
        if (EsbViewsRepository.WSDLEndPoint.Misc.port == event.getAffectedEditor()) {
            wSDLEndPoint.setPort((java.lang.String) EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING,
                    (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Misc.description)) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getEndPoint_EndPointName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Properties.endPointName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_ReliableMessagingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Qos.reliableMessagingEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SecurityEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Qos.securityEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Qos.addressingEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingVersion().equals(msg.getFeature())
                    ...
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Qos.addressingVersion))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_AddressingSeparateListener().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Qos.addressingSeparateListener))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Timeout.timeOutDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TimeOutAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Timeout.timeOutAction))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryErrorCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.EndpointTimeoutState.retryErrorCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryCount().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.EndpointTimeoutState.retryCount)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_RetryDelay().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.EndpointTimeoutState.retryDelay)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendErrorCodes().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendErrorCodes)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendInitialDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendInitialDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendMaximumDuration().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendMaximumDuration)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_SuspendProgressionFactor().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendProgressionFactor)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_Format().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Basic.format))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_Optimize().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Misc.optimize))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TemplateParameters().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Properties.templateParameters))
                basePart.updateTemplateParameters();
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_StatisticsEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Basic.statisticsEnabled))
            ...
            if (EsbPackage.eINSTANCE.getAbstractEndPoint_TraceEnabled().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Basic.traceEnabled))
                basePart.setTraceEnabled((Boolean) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getWSDLEndPoint_WsdlUri().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Misc.wsdlUri)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getWSDLEndPoint_Service().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Misc.service)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getWSDLEndPoint_Port().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.WSDLEndPoint.Misc.port)) {
                if (msg.getNewValue() != null) {
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getAbstractEndPoint_TraceEnabled(), EsbPackage.eINSTANCE.getWSDLEndPoint_WsdlUri(),
                EsbPackage.eINSTANCE.getWSDLEndPoint_Service(), EsbPackage.eINSTANCE.getWSDLEndPoint_Port(),
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                ...
                if (EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendErrorCodes == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendInitialDuration == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.WSDLEndPoint.EndpointSuspendState.suspendMaximumDuration == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                ...
                if (EsbViewsRepository.WSDLEndPoint.Misc.wsdlUri == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getWSDLEndPoint_WsdlUri().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getWSDLEndPoint_WsdlUri().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.WSDLEndPoint.Misc.service == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getWSDLEndPoint_Service().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getWSDLEndPoint_Service().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.WSDLEndPoint.Misc.port == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getWSDLEndPoint_Port().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getWSDLEndPoint_Port().getEAttributeType(), newValue);
                }
                // Start of user code for failover error codes
                if (EsbViewsRepository.WSDLEndPoint.FailoverErrorCodes.failoverNonRetryErrorCodes == event
                        .getAffectedEditor()) {
