 ...
 * 
 */
public class RouterMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, RouterMediatorPropertiesEditionPart {
     ...
     */
    public RouterMediatorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RouterMediator.Properties.description,
                EsbMessages.RouterMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.RouterMediator.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RouterMediatorPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RouterMediatorPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.RouterMediator.Properties.commentsList,
                        EsbMessages.RouterMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(), "RouterMediator", //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RouterMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RouterMediator.Properties.commentsList, PropertiesEditionEvent.COMMIT,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.RouterMediator.Properties.reverse,
                        EsbMessages.RouterMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RouterMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RouterMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createContinueAfterRoutingCheckbox(FormToolkit widgetFactory, Composite parent) {
        continueAfterRouting = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.RouterMediator.Properties.continueAfterRouting,
                        EsbMessages.RouterMediatorPropertiesEditionPart_ContinueAfterRoutingLabel),
                SWT.CHECK);
        continueAfterRouting.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RouterMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RouterMediator.Properties.continueAfterRouting,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(continueAfterRouting.getSelection())));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterMediator.Properties.continueAfterRouting, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTargetOutputConnectorTableComposition(FormToolkit widgetFactory, Composite parent) {
        this.targetOutputConnector = new ReferencesTable(
                getDescription(EsbViewsRepository.RouterMediator.Properties.targetOutputConnector,
                        EsbMessages.RouterMediatorPropertiesEditionPart_TargetOutputConnectorLabel),
                new ReferencesTableListener() {
                    public void handleAdd() {
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(RouterMediatorPropertiesEditionPartForm.this,
                                        EsbViewsRepository.RouterMediator.Properties.targetOutputConnector,
        ...
        this.targetOutputConnector.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RouterMediator.Properties.targetOutputConnector, EsbViewsRepository.FORM_KIND));
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterMediatorPropertiesEditionPart#setContinueAfterRouting(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterMediatorPropertiesEditionPart#initTargetOutputConnector(EObject
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterMediatorPropertiesEditionPart#addFilterTargetOutputConnector(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterMediatorPropertiesEditionPart#addBusinessFilterTargetOutputConnector(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RouterMediatorPropertiesEditionPart#isContainedInTargetOutputConnectorTable(EObject
     *      element)
     * 
     */
