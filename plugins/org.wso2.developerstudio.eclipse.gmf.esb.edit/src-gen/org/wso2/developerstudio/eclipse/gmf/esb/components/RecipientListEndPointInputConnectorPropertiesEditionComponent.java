 ...
 * 
 */
public class RecipientListEndPointInputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public RecipientListEndPointInputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject recipientListEndPointInputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.RecipientListEndPointInputConnector.Properties.incomingLinks)) {
                incomingLinksSettings = new ReferencesTableSettings(recipientListEndPointInputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.RecipientListEndPointInputConnector.Properties.incomingLinks == event
                .getAffectedEditor()) {
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getInputConnector_IncomingLinks().equals(msg.getFeature())
                    && isAccessible(EsbViewsRepository.RecipientListEndPointInputConnector.Properties.incomingLinks))
