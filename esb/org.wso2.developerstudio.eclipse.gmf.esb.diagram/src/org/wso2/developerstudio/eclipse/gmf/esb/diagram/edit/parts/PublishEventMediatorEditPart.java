 ...
 * @generated
 */
public class PublishEventMediatorEditPart extends AbstractBorderedShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PublishEventMediatorStreamNameEditPart) {
			((PublishEventMediatorStreamNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigurePublishEventMediatorIdFigure());
			return true;
		}
		if (childEditPart instanceof PublishEventMediatorInputConnectorEditPart) {
			...
			getBorderedFigure().getBorderItemContainer().add(
					((PublishEventMediatorInputConnectorEditPart) childEditPart).getFigure(), locator);
			return true;
		}
		if (childEditPart instanceof PublishEventMediatorOutputConnectorEditPart) {
			...
			getBorderedFigure().getBorderItemContainer().add(
					((PublishEventMediatorOutputConnectorEditPart) childEditPart).getFigure(), locator);
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class PublishEventMediatorFigure extends EsbGraphicalShape {

		/**
		 * @generated
		 */
		private WrappingLabel fFigurePublishEventMediatorIdFigure;
		...
		private void createContents() {
			...
			this.add(publishEventPropertyLabel0);

			fFigurePublishEventMediatorIdFigure = new WrappingLabel();

			fFigurePublishEventMediatorIdFigure.setText("<...>");

			this.add(fFigurePublishEventMediatorIdFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigurePublishEventMediatorIdFigure() {
			return fFigurePublishEventMediatorIdFigure;
		}
	 ...
	 * @generated
	 */
	static final Color THIS_FORE = new Color(null, 230, 230, 230);
