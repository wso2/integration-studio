 ...
 */
package org.wso2.developerstudio.eclipse.wso2plugin.sample.validator;
...
public class PluginProjectFiledController extends AbstractFieldController{
	...
	public void validate(String modelProperty, Object value,
		...
		if(modelProperty.equals("pluginProjectClass.name")){
			CommonFieldValidator.validateJavaClassNameField(value);
		} else if (modelProperty.equals("pluginProjectClass.package.name")) {
