...
public class ConfigureTemplateParametersDialog extends Dialog {
        ...
        newParameterButton = new Button(container, SWT.NONE);
        {
            ...
            newParameterButton.addListener(SWT.Selection, new Listener() {
                public void handleEvent(Event event) {
                    TemplateParameter parameter = EsbFactory.eINSTANCE.createTemplateParameter();
    ...
    private void unbindParameter(int itemIndex) {
        ...
        if (null != Parameter.eContainer()) {
            RemoveCommand removeCmd = new RemoveCommand(editingDomain, template,
    ...
    protected void okPressed() {
        ...
        for (TableItem item : parametersTable.getItems()) {
            ...
            if (null == Parameter.eContainer()) {
                ...
                AddCommand addCmd = new AddCommand(editingDomain, template, EsbPackage.Literals.TEMPLATE__PARAMETERS,
                        Parameter);
                ...
                if (!Parameter.getName().equals(item.getText(0))) {
                    SetCommand setCmd = new SetCommand(editingDomain, Parameter,
                            EsbPackage.Literals.TEMPLATE_PARAMETER__NAME, item.getText(0));
