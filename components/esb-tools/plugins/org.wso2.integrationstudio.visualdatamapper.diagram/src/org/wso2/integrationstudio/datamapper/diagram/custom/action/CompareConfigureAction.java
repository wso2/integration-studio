...
import org.wso2.integrationstudio.datamapper.diagram.custom.dialogs.ConfigureCompareOperatorDialog;

public class CompareConfigureAction extends AbstractActionHandler {
	 ...
	 */
	public CompareConfigureAction(IWorkbenchPart part) {
		super(part);
		setId("configure-compare-operator-action-id");
		setText("Configure Compare Operator");
		setToolTipText("Configure Compare Operator Attributes");
