 ...
 * 
 */
public class SwitchMediatorInputConnectorPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, SwitchMediatorInputConnectorPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        CompositionSequence switchMediatorInputConnectorStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        switchMediatorInputConnectorStep.addStep(EsbViewsRepository.SwitchMediatorInputConnector.Properties.class)
    ...
    protected Composite createIncomingLinksAdvancedReferencesTable(Composite parent) {
        String label = getDescription(EsbViewsRepository.SwitchMediatorInputConnector.Properties.incomingLinks,
                EsbMessages.SwitchMediatorInputConnectorPropertiesEditionPart_IncomingLinksLabel);
        ...
        this.incomingLinks.setHelpText(propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.SwitchMediatorInputConnector.Properties.incomingLinks, EsbViewsRepository.SWT_KIND));
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SwitchMediatorInputConnectorPropertiesEditionPartImpl.this,
                                    EsbViewsRepository.SwitchMediatorInputConnector.Properties.incomingLinks,
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SwitchMediatorInputConnectorPropertiesEditionPart#addFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SwitchMediatorInputConnectorPropertiesEditionPart#addBusinessFilterIncomingLinks(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.SwitchMediatorInputConnectorPropertiesEditionPart#isContainedInIncomingLinksTable(EObject
     *      element)
     * 
     */
