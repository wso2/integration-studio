...
public class SequenceItemProvider extends MediatorItemProvider {
        ...
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Sequence_name_feature",
                                "_UI_Sequence_type"),
                        EsbPackage.Literals.SEQUENCE__NAME, true, false, false,
    ...
    protected void addKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Sequence_key_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Sequence_key_feature",
                                "_UI_Sequence_type"),
                        EsbPackage.Literals.SEQUENCE__KEY, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addReceiveSequencePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Sequence_receiveSequence_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Sequence_receiveSequence_feature",
                                "_UI_Sequence_type"),
                        EsbPackage.Literals.SEQUENCE__RECEIVE_SEQUENCE, true, false, false,
    ...
    protected void addDuplicatePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Sequence_duplicate_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Sequence_duplicate_feature",
                                "_UI_Sequence_type"),
                        EsbPackage.Literals.SEQUENCE__DUPLICATE, true, false, false,
                        ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addReferringSequenceTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Sequence_referringSequenceType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Sequence_referringSequenceType_feature",
                                "_UI_Sequence_type"),
                        EsbPackage.Literals.SEQUENCE__REFERRING_SEQUENCE_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addDynamicReferenceKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Sequence_dynamicReferenceKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Sequence_dynamicReferenceKey_feature",
                                "_UI_Sequence_type"),
                        EsbPackage.Literals.SEQUENCE__DYNAMIC_REFERENCE_KEY, true, false, false, null, null, null));
    }
    ...
    protected void addStaticReferenceKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Sequence_staticReferenceKey_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Sequence_staticReferenceKey_feature",
                                "_UI_Sequence_type"),
                        EsbPackage.Literals.SEQUENCE__STATIC_REFERENCE_KEY, true, false, false, null, null, null));
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.SEQUENCE__INPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createSequenceInputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.SEQUENCE__OUTPUT_CONNECTOR,
                EsbFactory.eINSTANCE.createSequenceOutputConnector()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.SEQUENCE__INCLUDED_MEDIATORS,
        ...
        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.SEQUENCE__DYNAMIC_REFERENCE_KEY,
                EsbFactory.eINSTANCE.createNamespacedProperty()));

        newChildDescriptors.add(createChildParameter(EsbPackage.Literals.SEQUENCE__STATIC_REFERENCE_KEY,
