 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfRouterMediatorInputConnectorEditPart
	...
	public List<IElementType> doGetRelTypesOnTarget(
			RouterMediatorInputConnectorEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(RouterMediatorInputConnectorEditPart) targetEditPart,
				relationshipType);
	}
