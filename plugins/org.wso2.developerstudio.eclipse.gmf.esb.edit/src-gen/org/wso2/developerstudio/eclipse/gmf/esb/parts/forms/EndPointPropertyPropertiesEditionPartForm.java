 ...
 * 
 */
public class EndPointPropertyPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, EndPointPropertyPropertiesEditionPart {
     ...
     */
    public EndPointPropertyPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.EndPointProperty.Properties.name,
        ...
        name.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(EndPointPropertyPropertiesEditionPartForm.this,
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            EsbViewsRepository.EndPointProperty.Properties.name, PropertiesEditionEvent.FOCUS_CHANGED,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EndPointPropertyPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EndPointProperty.Properties.name, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.EndPointProperty.Properties.value,
        ...
        value.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            EndPointPropertyPropertiesEditionPartForm.this,
                            EsbViewsRepository.EndPointProperty.Properties.value, PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EndPointProperty.Properties.value, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createScopeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.EndPointProperty.Properties.scope,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EndPointProperty.Properties.scope, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createValueTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.EndPointProperty.Properties.valueType,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.EndPointProperty.Properties.valueType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
