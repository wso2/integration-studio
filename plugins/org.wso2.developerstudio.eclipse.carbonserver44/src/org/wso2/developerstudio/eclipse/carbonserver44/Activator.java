...
public class Activator extends AbstractUIPlugin {
	...
	public static final String PLUGIN_ID = "org.wso2.developerstudio.eclipse.carbonserver44";
	...
	public void start(BundleContext context) throws Exception {
		super.start(context);
		plugin = this;
		System.out.println("org.wso2.developerstudio.eclipse.carbonserver44");
