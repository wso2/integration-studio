 ...
 * 
 */
public class RMSequenceMediatorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, RMSequenceMediatorPropertiesEditionPart {
     ...
     */
    public RMSequenceMediatorPropertiesEditionPartForm() {
        super();
    }
     ...
     * 
     */
    public RMSequenceMediatorPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = rMSequenceMediatorStep
                .addStep(EsbViewsRepository.RMSequenceMediator.Properties.class);
        ...
        composer = new PartComposer(rMSequenceMediatorStep) {
            ...
            public Composite addToPart(Composite parent, Object key) {
                ...
                if (key == EsbViewsRepository.RMSequenceMediator.Properties.rmSpecVersion) {
                    return createRmSpecVersionEMFComboViewer(widgetFactory, parent);
                }
    ...
    protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        propertiesSection.setText(EsbMessages.RMSequenceMediatorPropertiesEditionPart_PropertiesGroupLabel);
    ...
    protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RMSequenceMediator.Properties.description,
                EsbMessages.RMSequenceMediatorPropertiesEditionPart_DescriptionLabel);
        ...
        description.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RMSequenceMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RMSequenceMediator.Properties.description, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, description.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RMSequenceMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RMSequenceMediator.Properties.description,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RMSequenceMediatorPropertiesEditionPartForm.this, null,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RMSequenceMediator.Properties.description, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createCommentsListMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editCommentsList = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.RMSequenceMediator.Properties.commentsList,
                        EsbMessages.RMSequenceMediatorPropertiesEditionPart_CommentsListLabel),
                SWT.NONE);
        ...
        editCommentsList.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(commentsList.getShell(),
                        "RMSequenceMediator", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
                ...
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(RMSequenceMediatorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.RMSequenceMediator.Properties.commentsList,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
    ...
    protected Composite createReverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        reverse = widgetFactory.createButton(parent,
                getDescription(EsbViewsRepository.RMSequenceMediator.Properties.reverse,
                        EsbMessages.RMSequenceMediatorPropertiesEditionPart_ReverseLabel),
                SWT.CHECK);
        reverse.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RMSequenceMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RMSequenceMediator.Properties.reverse, PropertiesEditionEvent.COMMIT,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RMSequenceMediator.Properties.reverse, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createRmSpecVersionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RMSequenceMediator.Properties.rmSpecVersion,
                EsbMessages.RMSequenceMediatorPropertiesEditionPart_RmSpecVersionLabel);
        ...
        rmSpecVersion.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RMSequenceMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RMSequenceMediator.Properties.rmSpecVersion,
                            PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getRmSpecVersion()));
            }
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        EsbViewsRepository.RMSequenceMediator.Properties.rmSpecVersion, EsbViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createSequenceTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, EsbViewsRepository.RMSequenceMediator.Properties.sequenceType,
                EsbMessages.RMSequenceMediatorPropertiesEditionPart_SequenceTypeLabel);
        ...
        sequenceType.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            RMSequenceMediatorPropertiesEditionPartForm.this,
                            EsbViewsRepository.RMSequenceMediator.Properties.sequenceType,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                EsbViewsRepository.RMSequenceMediator.Properties.sequenceType, EsbViewsRepository.FORM_KIND), null); // $NON-NLS-1$
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RMSequenceMediatorPropertiesEditionPart#setDescription(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RMSequenceMediatorPropertiesEditionPart#setCommentsList(EList
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RMSequenceMediatorPropertiesEditionPart#setReverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RMSequenceMediatorPropertiesEditionPart#initRmSpecVersion(Object
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RMSequenceMediatorPropertiesEditionPart#setRmSpecVersion(Enumerator
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RMSequenceMediatorPropertiesEditionPart#initSequenceType(Object
     *      input, Enumerator current)
     */
     ...
     * {@inheritDoc}
     * 
     * @see org.wso2.developerstudio.eclipse.gmf.esb.parts.RMSequenceMediatorPropertiesEditionPart#setSequenceType(Enumerator
     *      newValue)
     * 
     */
