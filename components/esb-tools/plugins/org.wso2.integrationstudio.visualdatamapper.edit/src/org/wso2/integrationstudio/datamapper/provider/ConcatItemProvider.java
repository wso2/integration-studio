 ...
 * {@link org.wso2.integrationstudio.datamapper.Concat} object. <!--
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Concat_delimiter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Concat_delimiter_feature", "_UI_Concat_type"),
				 DataMapperPackage.Literals.CONCAT__DELIMITER,
				 true,
				 false,
				 false,
