...
public class PropertyText extends Composite {
    ...
    private void openPropertyDialog(int index) {
        ...
        if (object instanceof NamespacedProperty) {
            ...
            NamespacedPropertyEditorDialog dialog = new NamespacedPropertyEditorDialog(getShell(), namespacedProperty);
            dialog.open();
            if (dialog.isSaved()) {
            ...
            EvaluatorExpressionEditorDialog dialog = new EvaluatorExpressionEditorDialog(getShell(), expression);
            dialog.create();
