...
public class ExecutionPlanFieldController extends AbstractFieldController {
	...
	public void validate(String modelProperty, Object value, ProjectDataModel model)
		...
		if (modelProperty.equals(ExecutionPlanConstants.WIZARD_OPTION_EXECUTIONPLAN_NAME)) {
		...
		} else if (modelProperty.equals(ExecutionPlanConstants.WIZARD_OPTION_EXECUTIONPLAN_IMPORT_LOCATION)) {
			 CommonFieldValidator.validateImportFile(value);
		}  else if (modelProperty.equals(ExecutionPlanConstants.WIZARD_OPTION_EXECUTIONPLAN_SAVE_LOCATION)) {
	...
	public boolean isReadOnlyField(String modelProperty, ProjectDataModel model) {
		...
		if (modelProperty.equals(ExecutionPlanConstants.WIZARD_OPTION_EXECUTIONPLAN_SAVE_LOCATION)) {
			readOnlyField = true;
		}
