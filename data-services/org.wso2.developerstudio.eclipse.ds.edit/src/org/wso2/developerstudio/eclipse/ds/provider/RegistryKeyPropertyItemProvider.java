...
/**
 * This is the item provider adapter for a {@link org.wso2.developerstudio.eclipse.ds.RegistryKeyProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegistryKeyPropertyItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RegistryKeyProperty_key_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RegistryKeyProperty_key_feature", "_UI_RegistryKeyProperty_type"),
				 DsPackage.Literals.REGISTRY_KEY_PROPERTY__KEY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((RegistryKeyProperty)object).getKey();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RegistryKeyProperty.class)) {
			case DsPackage.REGISTRY_KEY_PROPERTY__KEY:
