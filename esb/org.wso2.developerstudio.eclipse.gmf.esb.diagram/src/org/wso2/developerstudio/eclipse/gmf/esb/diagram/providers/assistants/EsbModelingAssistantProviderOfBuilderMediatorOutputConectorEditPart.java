 ...
 * @generated
 */
public class EsbModelingAssistantProviderOfBuilderMediatorOutputConectorEditPart
	...
	public List<IElementType> doGetRelTypesOnSource(
			BuilderMediatorOutputConectorEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(BuilderMediatorOutputConectorEditPart) sourceEditPart,
				targetEditPart);
	}
