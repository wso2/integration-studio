 ...
 * @generated
 */
public class DSSMediatorDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
    ...
    * @generated
    */
    public DSSMediatorDescriptionEditPart(View view) {
        super(view);
    }
    ...
    */
    public IParser getParser() {
        if (parser == null) {
            parser = EsbParserProvider.getParser(EsbElementTypes.DSSMediator_3794, getParserElement(),
                    EsbVisualIDRegistry.getType(
                            org.wso2.integrationstudio.gmf.esb.diagram.edit.parts.DSSMediatorDescriptionEditPart.VISUAL_ID));
        }
        return parser;
    }
