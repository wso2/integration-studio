...
public class ImageHolder {
	...
	private ImageHolder() {
		...
		ImageDescriptor cloneMediatorImgDesc = EsbDiagramEditorPlugin.getBundledImageDescriptor(CLONE_MEDIATOR_ICON_PATH);
		ImageDescriptor entitlementMediatorImgDesc = EsbDiagramEditorPlugin.getBundledImageDescriptor(ENTITLEMENT_MEDIATOR_ICON_PATH);
		ImageDescriptor filterMediatorImgDesc = EsbDiagramEditorPlugin.getBundledImageDescriptor(FILTER_MEDIATOR_ICON_PATH);
		ImageDescriptor switchMediatorImgDesc = EsbDiagramEditorPlugin.getBundledImageDescriptor(SWITCH_MEDIATOR_ICON_PATH);
		ImageDescriptor aggregateMediatorImgDesc = EsbDiagramEditorPlugin.getBundledImageDescriptor(AGGREGATE_MEDIATOR_ICON_PATH);
		...
		ImageDescriptor cacheMediatorImgDesc = EsbDiagramEditorPlugin.getBundledImageDescriptor(CACHE_MEDIATOR_ICON_PATH);
		ImageDescriptor sendMediatorImgDesc = EsbDiagramEditorPlugin.getBundledImageDescriptor(SEND_MEDIATOR_ICON_PATH);
		ImageDescriptor validateMediatorImgDesc = EsbDiagramEditorPlugin.getBundledImageDescriptor(VALIDATE_MEDIATOR_ICON_PATH);
		ImageDescriptor iterateMediatorImgDesc = EsbDiagramEditorPlugin.getBundledImageDescriptor(ITERATE_MEDIATOR_ICON_PATH);
		ImageDescriptor forEachMediatorImgDesc = EsbDiagramEditorPlugin.getBundledImageDescriptor(FOREACH_MEDIATOR_ICON_PATH);
		ImageDescriptor ruleMediatorImgDesc = EsbDiagramEditorPlugin.getBundledImageDescriptor(RULE_MEDIATOR_ICON_PATH);
		ImageDescriptor throttleMediatorImgDesc = EsbDiagramEditorPlugin.getBundledImageDescriptor(THROTTLE_MEDIATOR_ICON_PATH);
