...
public class HeaderMediatorPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public HeaderMediatorPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject headerMediator,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.HeaderMediator.Properties.headerAction)) {
                basePart.initHeaderAction(
                        EEFUtils.choiceOfValues(headerMediator, EsbPackage.eINSTANCE.getHeaderMediator_HeaderAction()),
                        headerMediator.getHeaderAction());
            }
            if (isAccessible(EsbViewsRepository.HeaderMediator.Properties.valueType)) {
                basePart.initValueType(
                        EEFUtils.choiceOfValues(headerMediator, EsbPackage.eINSTANCE.getHeaderMediator_ValueType()),
                        headerMediator.getValueType());
            }
            if (isAccessible(EsbViewsRepository.HeaderMediator.Properties.scope)) {
                basePart.initScope(
                        EEFUtils.choiceOfValues(headerMediator, EsbPackage.eINSTANCE.getHeaderMediator_Scope()),
                        headerMediator.getScope());
            }
            if (isAccessible(EsbViewsRepository.HeaderMediator.Properties.valueLiteral))
                basePart.setValueLiteral(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        headerMediator.getValueLiteral()));

            if (isAccessible(EsbViewsRepository.HeaderMediator.Properties.valueInline))
                basePart.setValueInline(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        headerMediator.getValueInline()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.HeaderMediator.Properties.valueLiteral == event.getAffectedEditor()) {
            headerMediator.setValueLiteral((java.lang.String) EEFConverterUtil
        ...
        if (EsbViewsRepository.HeaderMediator.Properties.valueInline == event.getAffectedEditor()) {
            headerMediator.setValueInline((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
        ...
        if (EsbViewsRepository.HeaderMediator.Properties.description == event.getAffectedEditor()) {
            headerMediator.setDescription((java.lang.String) EEFConverterUtil
                    .createFromString(EcorePackage.Literals.ESTRING, (String) event.getNewValue()));
        }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getHeaderMediator_HeaderAction().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.HeaderMediator.Properties.headerAction))
                basePart.setHeaderAction((HeaderAction) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getHeaderMediator_ValueType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.HeaderMediator.Properties.valueType))
                basePart.setValueType((HeaderValueType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getHeaderMediator_Scope().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.HeaderMediator.Properties.scope))
                basePart.setScope((ScopeType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getHeaderMediator_ValueLiteral().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HeaderMediator.Properties.valueLiteral)) {
            ...
            if (EsbPackage.eINSTANCE.getHeaderMediator_ValueInline().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HeaderMediator.Properties.valueInline)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getHeaderMediator_HeaderName().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HeaderMediator.Properties.headerName)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getHeaderMediator_ValueExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HeaderMediator.Properties.valueExpression)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_Description().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HeaderMediator.Properties.description)) {
                if (msg.getNewValue() != null) {
            ...
            if (EsbPackage.eINSTANCE.getEsbElement_CommentsList().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HeaderMediator.Properties.commentsList)) {
            ...
            if (EsbPackage.eINSTANCE.getMediator_Reverse().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.HeaderMediator.Properties.reverse))
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                ...
                EsbPackage.eINSTANCE.getHeaderMediator_ValueType(), EsbPackage.eINSTANCE.getHeaderMediator_Scope(),
                ...
                if (EsbViewsRepository.HeaderMediator.Properties.headerAction == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getHeaderMediator_HeaderAction().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getHeaderMediator_HeaderAction().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.HeaderMediator.Properties.valueType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getHeaderMediator_ValueType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getHeaderMediator_ValueType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.HeaderMediator.Properties.scope == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getHeaderMediator_Scope().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE
                            .validate(EsbPackage.eINSTANCE.getHeaderMediator_Scope().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.HeaderMediator.Properties.valueLiteral == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getHeaderMediator_ValueLiteral().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getHeaderMediator_ValueLiteral().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.HeaderMediator.Properties.valueInline == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getHeaderMediator_ValueInline().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getHeaderMediator_ValueInline().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.HeaderMediator.Properties.description == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
