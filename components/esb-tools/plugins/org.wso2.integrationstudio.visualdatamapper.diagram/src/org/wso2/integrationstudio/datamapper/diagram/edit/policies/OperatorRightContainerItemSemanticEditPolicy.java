...
import org.wso2.integrationstudio.datamapper.diagram.edit.commands.OperatorRightConnectorCreateCommand;
...
public class OperatorRightContainerItemSemanticEditPolicy extends DataMapperBaseItemSemanticEditPolicy {
	 ...
	 * @generated
	 */
	public OperatorRightContainerItemSemanticEditPolicy() {
		super(DataMapperElementTypes.OperatorRightContainer_3016);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (DataMapperElementTypes.OperatorRightConnector_3017 == req.getElementType()) {
			return getGEFWrapper(new OperatorRightConnectorCreateCommand(req));
		}
