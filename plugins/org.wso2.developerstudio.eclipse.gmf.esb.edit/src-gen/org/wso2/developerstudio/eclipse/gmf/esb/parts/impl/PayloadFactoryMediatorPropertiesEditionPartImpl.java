...
public class PayloadFactoryMediatorPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, PayloadFactoryMediatorPropertiesEditionPart {
    ...
    createDescription(parent, EsbViewsRepository.PayloadFactoryMediator.Properties.templateType, EsbMessages.PayloadFactoryMediatorPropertiesEditionPart_TemplateTypeLabel);
    ...
    templateType.addSelectionChangedListener(new ISelectionChangedListener() {
      ...
      public void selectionChanged(SelectionChangedEvent event) {
        if (propertiesEditionComponent != null)
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PayloadFactoryMediatorPropertiesEditionPartImpl.this, EsbViewsRepository.PayloadFactoryMediator.Properties.templateType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getTemplateType()));
      }

    });
    templateType.setID(EsbViewsRepository.PayloadFactoryMediator.Properties.templateType);
    SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EsbViewsRepository.PayloadFactoryMediator.Properties.templateType, EsbViewsRepository.SWT_KIND), null); //$NON-NLS-1$
