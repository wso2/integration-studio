...
public class InboundEndpointGroupBox extends RoundedRectangle {
	...
	private void createContents() {
		...
		imageRectangle.setBackgroundColor(new Color(null, 173, 169, 110));
		...
		esbNodeTypeNameRectangle.setBackgroundColor(new Color(null, 173, 169, 110));
	...
	private RoundedRectangle createInnerRectangle(RoundedRectangle leftRectangle) {
		...
		innerRect.setBackgroundColor(new Color(null, 173, 169, 110));
