 ...
 * @generated
 */
public class LowerCaseItemSemanticEditPolicy extends
		dataMapper.diagram.edit.policies.DataMapperBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public LowerCaseItemSemanticEditPolicy() {
		super(dataMapper.diagram.providers.DataMapperElementTypes.LowerCase_2009);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (dataMapper.diagram.providers.DataMapperElementTypes.OperatorBasicContainer_3012 == req
				.getElementType()) {
			return getGEFWrapper(new dataMapper.diagram.edit.commands.OperatorBasicContainerCreateCommand(
					req));
		}
