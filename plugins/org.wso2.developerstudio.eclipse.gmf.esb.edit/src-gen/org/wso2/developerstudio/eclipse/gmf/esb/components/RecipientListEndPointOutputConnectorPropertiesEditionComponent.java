 ...
 * 
 */
public class RecipientListEndPointOutputConnectorPropertiesEditionComponent
     ...
     * 
     */
    public RecipientListEndPointOutputConnectorPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject recipientListEndPointOutputConnector, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.RecipientListEndPointOutputConnector.Properties.commentMediators)) {
                commentMediatorsSettings = new ReferencesTableSettings(recipientListEndPointOutputConnector,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.RecipientListEndPointOutputConnector.Properties.commentMediators == event
                .getAffectedEditor()) {
