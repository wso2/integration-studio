...
public class SqlParameterDefinitionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public SqlParameterDefinitionPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject sqlParameterDefinition, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(EsbViewsRepository.SqlParameterDefinition.Properties.dataType)) {
                basePart.initDataType(
                        EEFUtils.choiceOfValues(sqlParameterDefinition,
                                EsbPackage.eINSTANCE.getSqlParameterDefinition_DataType()),
                        sqlParameterDefinition.getDataType());
            }
            if (isAccessible(EsbViewsRepository.SqlParameterDefinition.Properties.valueType)) {
                basePart.initValueType(
                        ...
                        sqlParameterDefinition.getValueType());
            }
            if (isAccessible(EsbViewsRepository.SqlParameterDefinition.Properties.valueLiteral))
                basePart.setValueLiteral(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING,
                        sqlParameterDefinition.getValueLiteral()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (EsbViewsRepository.SqlParameterDefinition.Properties.valueLiteral == event.getAffectedEditor()) {
            sqlParameterDefinition.setValueLiteral((java.lang.String) EEFConverterUtil
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (EsbPackage.eINSTANCE.getSqlParameterDefinition_DataType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.SqlParameterDefinition.Properties.dataType))
                basePart.setDataType((SqlParameterDataType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getSqlParameterDefinition_ValueType().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject)
                    && isAccessible(EsbViewsRepository.SqlParameterDefinition.Properties.valueType))
                basePart.setValueType((SqlParameterValueType) msg.getNewValue());

            if (EsbPackage.eINSTANCE.getSqlParameterDefinition_ValueLiteral().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SqlParameterDefinition.Properties.valueLiteral)) {
            ...
            if (EsbPackage.eINSTANCE.getSqlParameterDefinition_ValueExpression().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(EsbViewsRepository.SqlParameterDefinition.Properties.valueExpression)) {
                if (msg.getNewValue() != null) {
                ...
                if (EsbViewsRepository.SqlParameterDefinition.Properties.dataType == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSqlParameterDefinition_DataType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getSqlParameterDefinition_DataType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SqlParameterDefinition.Properties.valueType == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSqlParameterDefinition_ValueType().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getSqlParameterDefinition_ValueType().getEAttributeType(), newValue);
                }
                if (EsbViewsRepository.SqlParameterDefinition.Properties.valueLiteral == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                EsbPackage.eINSTANCE.getSqlParameterDefinition_ValueLiteral().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            EsbPackage.eINSTANCE.getSqlParameterDefinition_ValueLiteral().getEAttributeType(),
