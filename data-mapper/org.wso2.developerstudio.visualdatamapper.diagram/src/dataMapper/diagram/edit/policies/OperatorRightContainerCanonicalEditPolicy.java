...
public class OperatorRightContainerCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return dataMapper.DataMapperPackage.eINSTANCE.getOperatorRightContainer_RightConnectors();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<dataMapper.diagram.part.DataMapperNodeDescriptor> childDescriptors = dataMapper.diagram.part.DataMapperDiagramUpdater
				.getOperatorRightContainer_3016SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return dataMapper.diagram.edit.parts.OperatorRightConnectorEditPart.VISUAL_ID == dataMapper.diagram.part.DataMapperVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<dataMapper.diagram.part.DataMapperNodeDescriptor> childDescriptors = dataMapper.diagram.part.DataMapperDiagramUpdater
				.getOperatorRightContainer_3016SemanticChildren((View) getHost().getModel());
