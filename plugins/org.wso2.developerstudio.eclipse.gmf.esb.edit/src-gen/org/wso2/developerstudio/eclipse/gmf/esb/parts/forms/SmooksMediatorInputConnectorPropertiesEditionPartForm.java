 ...
 * 
 */
public class SmooksMediatorInputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, SmooksMediatorInputConnectorPropertiesEditionPart {
     ...
     */
    public SmooksMediatorInputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createIncomingLinksReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.incomingLinks = new ReferencesTable(
                getDescription(EsbViewsRepository.SmooksMediatorInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SmooksMediatorInputConnectorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SmooksMediatorInputConnector.Properties.incomingLinks,
