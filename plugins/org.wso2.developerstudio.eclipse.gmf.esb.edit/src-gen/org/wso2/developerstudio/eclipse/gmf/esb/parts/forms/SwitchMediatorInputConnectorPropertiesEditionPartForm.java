 ...
 * 
 */
public class SwitchMediatorInputConnectorPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, SwitchMediatorInputConnectorPropertiesEditionPart {
     ...
     */
    public SwitchMediatorInputConnectorPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createIncomingLinksReferencesTable(FormToolkit widgetFactory, Composite parent) {
        this.incomingLinks = new ReferencesTable(
                getDescription(EsbViewsRepository.SwitchMediatorInputConnector.Properties.incomingLinks,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (e.item != null && e.item.getData() instanceof EObject) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(SwitchMediatorInputConnectorPropertiesEditionPartForm.this,
                                    EsbViewsRepository.SwitchMediatorInputConnector.Properties.incomingLinks,
